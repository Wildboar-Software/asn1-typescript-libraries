...
import { id_swb_pkc_best_cert_path } from '../SCVP-2009/id-swb-pkc-best-cert-path.va';
export { id_swb_pkc_best_cert_path } from '../SCVP-2009/id-swb-pkc-best-cert-path.va';
