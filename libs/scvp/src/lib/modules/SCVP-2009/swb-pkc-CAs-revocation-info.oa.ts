...
import { id_swb_pkc_CAs_revocation_info } from '../SCVP-2009/id-swb-pkc-CAs-revocation-info.va';
export { id_swb_pkc_CAs_revocation_info } from '../SCVP-2009/id-swb-pkc-CAs-revocation-info.va';
