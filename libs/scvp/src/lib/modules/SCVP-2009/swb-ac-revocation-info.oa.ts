...
import { id_swb_ac_revocation_info } from '../SCVP-2009/id-swb-ac-revocation-info.va';
export { id_swb_ac_revocation_info } from '../SCVP-2009/id-swb-ac-revocation-info.va';
