...
function _encode_RCASRnMsgContent (value: RCASRnMsgContent, elGetter: $.ASN1Encoder<RCASRnMsgContent>) {
    if (!_cached_encoder_for_RCASRnMsgContent) { _cached_encoder_for_RCASRnMsgContent = function (value: RCASRnMsgContent, elGetter: $.ASN1Encoder<RCASRnMsgContent>): _Element {
