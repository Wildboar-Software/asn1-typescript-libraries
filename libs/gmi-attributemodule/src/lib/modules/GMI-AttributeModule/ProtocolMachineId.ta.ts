 ...
 */
export
function _decode_ProtocolMachineId (el: _Element) {
    if (!_cached_decoder_for_ProtocolMachineId) { _cached_decoder_for_ProtocolMachineId = $._decodeGraphicString; }
 ...
 */
export
function _encode_ProtocolMachineId (value: ProtocolMachineId, elGetter: $.ASN1Encoder<ProtocolMachineId>) {
    if (!_cached_encoder_for_ProtocolMachineId) { _cached_encoder_for_ProtocolMachineId = $._encodeGraphicString; }
