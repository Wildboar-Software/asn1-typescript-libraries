 ...
 */
export
function _decode_ParamOptions (el: _Element) {
    if (!_cached_decoder_for_ParamOptions) { _cached_decoder_for_ParamOptions = $._decodeEnumerated; }
 ...
 */
export
function _encode_ParamOptions (value: ParamOptions, elGetter: $.ASN1Encoder<ParamOptions>) {
    if (!_cached_encoder_for_ParamOptions) { _cached_encoder_for_ParamOptions = $._encodeEnumerated; }
