...
import { PlatformConfiguration, _decode_PlatformConfiguration, _encode_PlatformConfiguration } from "../PlatformCertificateProfile/PlatformConfiguration.ta";
export { PlatformConfiguration, _decode_PlatformConfiguration, _encode_PlatformConfiguration } from "../PlatformCertificateProfile/PlatformConfiguration.ta";
import { tcg_at_platformConfiguration_v2 } from "../PlatformCertificateProfile/tcg-at-platformConfiguration-v2.va";
export { tcg_at_platformConfiguration_v2 } from "../PlatformCertificateProfile/tcg-at-platformConfiguration-v2.va";
