...
import { COMMITMENT_QUALIFIER } from "../ETS-ElectronicSignatureFormats-ExplicitSyntax97/COMMITMENT-QUALIFIER.oca";
export { COMMITMENT_QUALIFIER } from "../ETS-ElectronicSignatureFormats-ExplicitSyntax97/COMMITMENT-QUALIFIER.oca";
