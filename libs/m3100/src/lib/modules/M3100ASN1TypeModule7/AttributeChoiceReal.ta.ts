...
export function _decode_AttributeChoiceReal(el: _Element) {
  if (!_cached_decoder_for_AttributeChoiceReal) {
    _cached_decoder_for_AttributeChoiceReal = function (
      ...
      return new AttributeChoiceReal(attributeName, minimumValue, maximumValue);
    };
  }
    ...
    _cached_encoder_for_AttributeChoiceReal = function (
      ...
      return $._encodeSequence(
        ([] as (_Element | undefined)[])
          .concat([
            /* REQUIRED   */ $._encodeGraphicString(value.attributeName, $.BER),
            /* REQUIRED   */ $._encodeReal(value.minimumValue, $.BER),
            /* REQUIRED   */ $._encodeReal(value.maximumValue, $.BER),
          ])
