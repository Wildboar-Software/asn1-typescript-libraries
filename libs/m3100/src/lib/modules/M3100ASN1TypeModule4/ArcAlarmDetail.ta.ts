...
export const _root_component_type_list_1_spec_for_ArcAlarmDetail: $.ComponentSpec[] = [
  ,
  ,
  ,/* FIXME: problem COULD_NOT_RESOLVE_TYPE_DEF */
/* FIXME: alarmStatus COULD_NOT_RESOLVE_TYPE_DEF */
/* FIXME: perceivedSeverity COULD_NOT_RESOLVE_TYPE_DEF */
    ...
    _cached_encoder_for_ArcAlarmDetail = function (
      ...
      return $._encodeSequence(
        ([] as (_Element | undefined)[])
          .concat([
            /* REQUIRED   */ _encode_ProbableCause(value.problem, $.BER),
            /* REQUIRED   */ _encode_AlarmStatus(value.alarmStatus, $.BER),
