...
export const _root_component_type_list_1_spec_for_BridgeRollArg_Item: $.ComponentSpec[] = [
  ...
  ,
  ,
  /* FIXME: xc COULD_NOT_RESOLVE_TYPE_DEF */ /* FIXME: bridgeRollFromTp COULD_NOT_RESOLVE_TYPE_DEF */ /* FIXME: bridgeRollToTp COULD_NOT_RESOLVE_TYPE_DEF */ new $.ComponentSpec(
    'bridgeRollOperation',
    false,
    ...
    _cached_encoder_for_BridgeRollArg_Item = function (
      ...
      return $._encodeSequence(
        ([] as (_Element | undefined)[])
          .concat([
            /* REQUIRED   */ _encode_ObjectInstance(value.xc, $.BER),
