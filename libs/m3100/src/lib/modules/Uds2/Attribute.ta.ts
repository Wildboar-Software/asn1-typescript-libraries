...
} from '../Uds2/StreetAddress.ta';
export {
  StreetAddress,
  _decode_StreetAddress,
  _encode_StreetAddress,
} from '../Uds2/StreetAddress.ta';
import { HouseId, _decode_HouseId, _encode_HouseId } from '../Uds2/HouseId.ta';
export { HouseId, _decode_HouseId, _encode_HouseId } from '../Uds2/HouseId.ta';
import {
  GivenName,
  _decode_GivenName,
  _encode_GivenName,
} from '../Uds2/GivenName.ta';
export {
  GivenName,
  _decode_GivenName,
  _encode_GivenName,
} from '../Uds2/GivenName.ta';
import { Title, _decode_Title, _encode_Title } from '../Uds2/Title.ta';
export { Title, _decode_Title, _encode_Title } from '../Uds2/Title.ta';
import {
  Description,
  _decode_Description,
  _encode_Description,
} from '../Uds2/Description.ta';
export {
  Description,
  _decode_Description,
  _encode_Description,
...
import {
  ...
  _decode_OrAddress,
  _encode_OrAddress,
} from '../Uds2/OrAddress.ta';
export {
  OrAddress,
  _decode_OrAddress,
  _encode_OrAddress,
} from '../Uds2/OrAddress.ta';
import { Mail, _decode_Mail, _encode_Mail } from '../Uds2/Mail.ta';
export { Mail, _decode_Mail, _encode_Mail } from '../Uds2/Mail.ta';
import { Url, _decode_Url, _encode_Url } from '../Uds2/Url.ta';
export { Url, _decode_Url, _encode_Url } from '../Uds2/Url.ta';
import {
  CommService,
  _decode_CommService,
  _encode_CommService,
} from '../Uds2/CommService.ta';
export {
  CommService,
  _decode_CommService,
  _encode_CommService,
