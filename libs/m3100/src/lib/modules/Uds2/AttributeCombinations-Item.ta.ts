...
import { Cor, _decode_Cor, _encode_Cor } from '../Uds2/Cor.ta';
export { Cor, _decode_Cor, _encode_Cor } from '../Uds2/Cor.ta';
import {
  AttributeCombinations,
  _decode_AttributeCombinations,
  _encode_AttributeCombinations,
} from '../Uds2/AttributeCombinations.ta';
export {
  AttributeCombinations,
  _decode_AttributeCombinations,
  _encode_AttributeCombinations,
...
/* START_OF_SYMBOL_DEFINITION AttributeCombinations_Item */
/**
 * @summary AttributeCombinations_Item
 * @description
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 * AttributeCombinations-Item ::= CHOICE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 */
export type AttributeCombinations_Item =
  | { attributeType: AttributeType } /* CHOICE_ALT_ROOT */
  | { or: Cor } /* CHOICE_ALT_ROOT */
  | { not: AttributeCombinations } /* CHOICE_ALT_ROOT */;
/* END_OF_SYMBOL_DEFINITION AttributeCombinations_Item */

/* START_OF_SYMBOL_DEFINITION _cached_decoder_for_AttributeCombinations_Item */
let _cached_decoder_for_AttributeCombinations_Item: $.ASN1Decoder<AttributeCombinations_Item> | null = null;
/* END_OF_SYMBOL_DEFINITION _cached_decoder_for_AttributeCombinations_Item */

/* START_OF_SYMBOL_DEFINITION _decode_AttributeCombinations_Item */
/**
 * @summary Decodes an ASN.1 element into a(n) AttributeCombinations_Item
 * @function
 * @param {_Element} el The element being decoded.
 * @returns {AttributeCombinations_Item} The decoded data structure.
 */
export function _decode_AttributeCombinations_Item(el: _Element) {
  if (!_cached_decoder_for_AttributeCombinations_Item) {
    _cached_decoder_for_AttributeCombinations_Item = $._decode_inextensible_choice<AttributeCombinations_Item>(
      {
  ...
  return _cached_decoder_for_AttributeCombinations_Item(el);
}
/* END_OF_SYMBOL_DEFINITION _decode_AttributeCombinations_Item */

/* START_OF_SYMBOL_DEFINITION _cached_encoder_for_AttributeCombinations_Item */
let _cached_encoder_for_AttributeCombinations_Item: $.ASN1Encoder<AttributeCombinations_Item> | null = null;
/* END_OF_SYMBOL_DEFINITION _cached_encoder_for_AttributeCombinations_Item */

/* START_OF_SYMBOL_DEFINITION _encode_AttributeCombinations_Item */
/**
 * @summary Encodes a(n) AttributeCombinations_Item into an ASN.1 Element.
 * @function
 * @param {value} el The element being decoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The AttributeCombinations_Item, encoded as an ASN.1 Element.
 */
export function _encode_AttributeCombinations_Item(
  value: AttributeCombinations_Item,
  elGetter: $.ASN1Encoder<AttributeCombinations_Item>
) {
  if (!_cached_encoder_for_AttributeCombinations_Item) {
    _cached_encoder_for_AttributeCombinations_Item = $._encode_choice<AttributeCombinations_Item>(
      {
  ...
  return _cached_encoder_for_AttributeCombinations_Item(value, elGetter);
}

/* END_OF_SYMBOL_DEFINITION _encode_AttributeCombinations_Item */
