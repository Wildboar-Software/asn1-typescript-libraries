...
import { Cand, _decode_Cand, _encode_Cand } from '../Uds2/Cand.ta';
export { Cand, _decode_Cand, _encode_Cand } from '../Uds2/Cand.ta';
import {
...
/* START_OF_SYMBOL_DEFINITION Cor_Item */
/**
 * @summary Cor_Item
 * @description
 *
 ...
 *
 * ```asn1
 * Cor-Item ::= CHOICE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 */
export type Cor_Item =
  | { attributeType: AttributeType } /* CHOICE_ALT_ROOT */
  | { and: Cand } /* CHOICE_ALT_ROOT */
  | { not: AttributeCombinations } /* CHOICE_ALT_ROOT */;
/* END_OF_SYMBOL_DEFINITION Cor_Item */

/* START_OF_SYMBOL_DEFINITION _cached_decoder_for_Cor_Item */
let _cached_decoder_for_Cor_Item: $.ASN1Decoder<Cor_Item> | null = null;
/* END_OF_SYMBOL_DEFINITION _cached_decoder_for_Cor_Item */

/* START_OF_SYMBOL_DEFINITION _decode_Cor_Item */
/**
 * @summary Decodes an ASN.1 element into a(n) Cor_Item
 * @function
 * @param {_Element} el The element being decoded.
 * @returns {Cor_Item} The decoded data structure.
 */
export function _decode_Cor_Item(el: _Element) {
  if (!_cached_decoder_for_Cor_Item) {
    _cached_decoder_for_Cor_Item = $._decode_inextensible_choice<Cor_Item>({
      'CONTEXT 0': ['attributeType', _decode_AttributeType],
      'CONTEXT 1': ['and', _decode_Cand],
      'CONTEXT 2': ['not', _decode_AttributeCombinations],
    });
  }
  return _cached_decoder_for_Cor_Item(el);
}
/* END_OF_SYMBOL_DEFINITION _decode_Cor_Item */

/* START_OF_SYMBOL_DEFINITION _cached_encoder_for_Cor_Item */
let _cached_encoder_for_Cor_Item: $.ASN1Encoder<Cor_Item> | null = null;
/* END_OF_SYMBOL_DEFINITION _cached_encoder_for_Cor_Item */

/* START_OF_SYMBOL_DEFINITION _encode_Cor_Item */
/**
 * @summary Encodes a(n) Cor_Item into an ASN.1 Element.
 * @function
 * @param {value} el The element being decoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The Cor_Item, encoded as an ASN.1 Element.
 */
export function _encode_Cor_Item(
  value: Cor_Item,
  elGetter: $.ASN1Encoder<Cor_Item>
) {
  if (!_cached_encoder_for_Cor_Item) {
    _cached_encoder_for_Cor_Item = $._encode_choice<Cor_Item>(
      {
  ...
  return _cached_encoder_for_Cor_Item(value, elGetter);
}

/* END_OF_SYMBOL_DEFINITION _encode_Cor_Item */
