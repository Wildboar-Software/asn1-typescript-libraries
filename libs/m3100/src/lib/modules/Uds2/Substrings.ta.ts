...
} from '../Uds2/StateOrProvinceSub.ta';
export {
  StateOrProvinceSub,
  _decode_StateOrProvinceSub,
  _encode_StateOrProvinceSub,
...
} from '../Uds2/BusinessCategorySub.ta';
export {
  BusinessCategorySub,
  _decode_BusinessCategorySub,
  _encode_BusinessCategorySub,
...
} from '../Uds2/SubscriberNameSub.ta';
export {
  SubscriberNameSub,
  _decode_SubscriberNameSub,
  _encode_SubscriberNameSub,
...
} from '../Uds2/SecondFamilyNameSub.ta';
export {
  SecondFamilyNameSub,
  _decode_SecondFamilyNameSub,
  _encode_SecondFamilyNameSub,
...
} from '../Uds2/OrAddressSub.ta';
export {
  OrAddressSub,
  _decode_OrAddressSub,
  _encode_OrAddressSub,
} from '../Uds2/OrAddressSub.ta';
import { MailSub, _decode_MailSub, _encode_MailSub } from '../Uds2/MailSub.ta';
export { MailSub, _decode_MailSub, _encode_MailSub } from '../Uds2/MailSub.ta';
import { UrlSub, _decode_UrlSub, _encode_UrlSub } from '../Uds2/UrlSub.ta';
export { UrlSub, _decode_UrlSub, _encode_UrlSub } from '../Uds2/UrlSub.ta';
