 ...
 */
export function _decode_Count(el: _Element) {
  if (!_cached_decoder_for_Count) {
    _cached_decoder_for_Count = $._decodeInteger;
  }
 ...
 */
export function _encode_Count(value: Count, elGetter: $.ASN1Encoder<Count>) {
  if (!_cached_encoder_for_Count) {
    _cached_encoder_for_Count = $._encodeInteger;
  }
