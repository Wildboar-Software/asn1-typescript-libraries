...
export const _root_component_type_list_1_spec_for_ProtectedXC: $.ComponentSpec[] = [
  ,
  ,/* FIXME: conProtGroup COULD_NOT_RESOLVE_TYPE_DEF */
/* FIXME: conProtA COULD_NOT_RESOLVE_TYPE_DEF */
/* FIXME: conProtB COULD_NOT_RESOLVE_TYPE_DEF */
];
    ...
    _cached_encoder_for_ProtectedXC = function (
      ...
      return $._encodeSequence(
        ([] as (_Element | undefined)[])
          .concat([
            /* REQUIRED   */ _encode_ObjectInstance(value.conProtGroup, $.BER),
            /* REQUIRED   */ _encode_ObjectInstance(value.conProtA, $.BER),
            /* REQUIRED   */ _encode_ObjectInstance(value.conProtB, $.BER),
          ])
