...
export class CoincidentUnprotectedUnidirectionalConnections {
  ...
  public static _from_object(
    ...
    return new CoincidentUnprotectedUnidirectionalConnections(_o.xcA, _o.xcB);
  }
}
...
export const _root_component_type_list_1_spec_for_CoincidentUnprotectedUnidirectionalConnections: $.ComponentSpec[] = [
  ,/* FIXME: xcA COULD_NOT_RESOLVE_TYPE_DEF */
/* FIXME: xcB COULD_NOT_RESOLVE_TYPE_DEF */
];
...
export function _decode_CoincidentUnprotectedUnidirectionalConnections(
  ...
  return _cached_decoder_for_CoincidentUnprotectedUnidirectionalConnections(el);
}
    ...
    _cached_encoder_for_CoincidentUnprotectedUnidirectionalConnections = function (
      ...
      return $._encodeSequence(
        ([] as (_Element | undefined)[])
          .concat([
            /* REQUIRED   */ _encode_ObjectInstance(value.xcA, $.BER),
            /* REQUIRED   */ _encode_ObjectInstance(value.xcB, $.BER),
          ])
