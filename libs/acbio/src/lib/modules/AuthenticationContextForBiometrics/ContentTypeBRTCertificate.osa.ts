...
import { brtCertificate } from '../AuthenticationContextForBiometrics/brtCertificate.oa';
export { brtCertificate } from '../AuthenticationContextForBiometrics/brtCertificate.oa';
import type {
    CONTENT_TYPE,
