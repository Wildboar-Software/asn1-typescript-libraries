...
} from '../MSGeneralAttributeTypes/ReportSummary.ta';
export {
    ReportSummary,
    _enum_for_ReportSummary,
    ReportSummary_no_report_requested /* IMPORTED_LONG_ENUMERATION_ITEM */,
...
import { id_att_ac_report_summary } from '../MSObjectIdentifiers/id-att-ac-report-summary.va';
export { id_att_ac_report_summary } from '../MSObjectIdentifiers/id-att-ac-report-summary.va';
