...
import { id_att_recipient_names } from '../MSObjectIdentifiers/id-att-recipient-names.va';
export { id_att_recipient_names } from '../MSObjectIdentifiers/id-att-recipient-names.va';
