...
} from '../MTSAbstractService/OriginatorCertificate.ta';
export {
    OriginatorCertificate,
    _decode_OriginatorCertificate,
    _encode_OriginatorCertificate,
} from '../MTSAbstractService/OriginatorCertificate.ta';
import { id_att_originator_certificate } from '../MSObjectIdentifiers/id-att-originator-certificate.va';
export { id_att_originator_certificate } from '../MSObjectIdentifiers/id-att-originator-certificate.va';
