...
} from '../MTSAbstractService/ReportingDLName.ta';
export {
    ReportingDLName,
    _decode_ReportingDLName,
    _encode_ReportingDLName,
...
import { id_att_reporting_DL_name } from '../MSObjectIdentifiers/id-att-reporting-DL-name.va';
export { id_att_reporting_DL_name } from '../MSObjectIdentifiers/id-att-reporting-DL-name.va';
