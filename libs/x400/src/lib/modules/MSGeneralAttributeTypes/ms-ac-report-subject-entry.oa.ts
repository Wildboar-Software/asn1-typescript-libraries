...
import { id_att_ac_report_subject_entry } from '../MSObjectIdentifiers/id-att-ac-report-subject-entry.va';
export { id_att_ac_report_subject_entry } from '../MSObjectIdentifiers/id-att-ac-report-subject-entry.va';
