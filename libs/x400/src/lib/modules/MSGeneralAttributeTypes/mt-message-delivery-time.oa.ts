...
import { id_att_message_delivery_time } from '../MSObjectIdentifiers/id-att-message-delivery-time.va';
export { id_att_message_delivery_time } from '../MSObjectIdentifiers/id-att-message-delivery-time.va';
