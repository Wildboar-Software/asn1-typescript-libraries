...
import { id_att_this_recipient_name } from '../MSObjectIdentifiers/id-att-this-recipient-name.va';
export { id_att_this_recipient_name } from '../MSObjectIdentifiers/id-att-this-recipient-name.va';
