...
import { id_att_message_security_label } from '../MSObjectIdentifiers/id-att-message-security-label.va';
export { id_att_message_security_label } from '../MSObjectIdentifiers/id-att-message-security-label.va';
