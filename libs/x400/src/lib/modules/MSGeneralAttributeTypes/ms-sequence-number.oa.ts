...
import { id_att_sequence_number } from '../MSObjectIdentifiers/id-att-sequence-number.va';
export { id_att_sequence_number } from '../MSObjectIdentifiers/id-att-sequence-number.va';
