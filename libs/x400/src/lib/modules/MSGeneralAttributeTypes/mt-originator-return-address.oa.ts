...
} from '../MTSAbstractService/OriginatorReturnAddress.ta';
export {
    OriginatorReturnAddress,
    _decode_OriginatorReturnAddress,
    _encode_OriginatorReturnAddress,
} from '../MTSAbstractService/OriginatorReturnAddress.ta';
import { id_att_originator_return_address } from '../MSObjectIdentifiers/id-att-originator-return-address.va';
export { id_att_originator_return_address } from '../MSObjectIdentifiers/id-att-originator-return-address.va';
