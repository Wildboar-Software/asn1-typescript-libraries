...
import { id_att_report_delivery_envelope } from '../MSObjectIdentifiers/id-att-report-delivery-envelope.va';
export { id_att_report_delivery_envelope } from '../MSObjectIdentifiers/id-att-report-delivery-envelope.va';
