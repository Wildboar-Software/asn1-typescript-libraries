...
import { id_att_deferred_delivery_time } from '../MSObjectIdentifiers/id-att-deferred-delivery-time.va';
export { id_att_deferred_delivery_time } from '../MSObjectIdentifiers/id-att-deferred-delivery-time.va';
