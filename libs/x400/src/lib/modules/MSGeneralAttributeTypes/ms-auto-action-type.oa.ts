...
import { id_att_auto_action_type } from '../MSObjectIdentifiers/id-att-auto-action-type.va';
export { id_att_auto_action_type } from '../MSObjectIdentifiers/id-att-auto-action-type.va';
