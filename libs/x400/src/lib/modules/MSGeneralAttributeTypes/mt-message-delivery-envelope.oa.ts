...
import { id_att_message_delivery_envelope } from '../MSObjectIdentifiers/id-att-message-delivery-envelope.va';
export { id_att_message_delivery_envelope } from '../MSObjectIdentifiers/id-att-message-delivery-envelope.va';
