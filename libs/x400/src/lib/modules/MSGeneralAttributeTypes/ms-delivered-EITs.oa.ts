...
import { id_att_delivered_EITs } from '../MSObjectIdentifiers/id-att-delivered-EITs.va';
export { id_att_delivered_EITs } from '../MSObjectIdentifiers/id-att-delivered-EITs.va';
