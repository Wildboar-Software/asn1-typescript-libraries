...
} from '../MTSAbstractService/ProbeOriginAuthenticationCheck.ta';
export {
    ProbeOriginAuthenticationCheck,
    _decode_ProbeOriginAuthenticationCheck,
    _encode_ProbeOriginAuthenticationCheck,
} from '../MTSAbstractService/ProbeOriginAuthenticationCheck.ta';
import { id_att_probe_origin_authentication_check } from '../MSObjectIdentifiers/id-att-probe-origin-authentication-check.va';
export { id_att_probe_origin_authentication_check } from '../MSObjectIdentifiers/id-att-probe-origin-authentication-check.va';
