...
import { id_at_routing_collective_name } from '../MHSRoutingObjectIdentifiers/id-at-routing-collective-name.va';
export { id_at_routing_collective_name } from '../MHSRoutingObjectIdentifiers/id-at-routing-collective-name.va';
