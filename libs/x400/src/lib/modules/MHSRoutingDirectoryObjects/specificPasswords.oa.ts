...
} from '../MHSRoutingDirectoryObjects/SpecificPassword.ta';
export {
    SpecificPassword,
    _decode_SpecificPassword,
    _encode_SpecificPassword,
} from '../MHSRoutingDirectoryObjects/SpecificPassword.ta';
import { id_at_specific_passwords } from '../MHSRoutingObjectIdentifiers/id-at-specific-passwords.va';
export { id_at_specific_passwords } from '../MHSRoutingObjectIdentifiers/id-at-specific-passwords.va';
