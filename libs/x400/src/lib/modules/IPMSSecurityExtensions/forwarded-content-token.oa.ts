 ...
 *
 * @constant
 * @type {EXTENSION<ForwardedContentToken>}
 * @implements {EXTENSION<ForwardedContentToken>}
 */
export const forwarded_content_token: EXTENSION<ForwardedContentToken> = {
    class: 'EXTENSION',
    decoderFor: {
