...
import { err_message_submission_identifier_invalid } from '../MTSAccessProtocol/err-message-submission-identifier-invalid.va';
export { err_message_submission_identifier_invalid } from '../MTSAccessProtocol/err-message-submission-identifier-invalid.va';
