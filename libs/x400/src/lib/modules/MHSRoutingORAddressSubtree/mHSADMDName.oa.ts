...
import { id_at_mhs_admd_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-admd-name.va';
export { id_at_mhs_admd_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-admd-name.va';
