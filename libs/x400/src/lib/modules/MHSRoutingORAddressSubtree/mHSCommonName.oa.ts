...
import { id_oc_mhs_common_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-common-name.va';
export { id_oc_mhs_common_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-common-name.va';
