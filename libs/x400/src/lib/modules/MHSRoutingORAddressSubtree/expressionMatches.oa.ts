...
} from '../MHSRoutingORAddressSubtree/ExpressionMatches.ta';
export {
    ExpressionMatches,
    _decode_ExpressionMatches,
    _encode_ExpressionMatches,
} from '../MHSRoutingORAddressSubtree/ExpressionMatches.ta';
import { id_at_mhs_expression_matches } from '../MHSRoutingObjectIdentifiers/id-at-mhs-expression-matches.va';
export { id_at_mhs_expression_matches } from '../MHSRoutingObjectIdentifiers/id-at-mhs-expression-matches.va';
