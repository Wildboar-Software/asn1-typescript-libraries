...
import { id_oc_mhs_network_address } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-network-address.va';
export { id_oc_mhs_network_address } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-network-address.va';
