...
import { id_at_mhs_common_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-common-name.va';
export { id_at_mhs_common_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-common-name.va';
