...
import { id_mr_msstring_list_match } from '../MSObjectIdentifiers/id-mr-msstring-list-match.va';
export { id_mr_msstring_list_match } from '../MSObjectIdentifiers/id-mr-msstring-list-match.va';
