...
import { id_mr_ms_single_substring_list_match } from '../MSObjectIdentifiers/id-mr-ms-single-substring-list-match.va';
export { id_mr_ms_single_substring_list_match } from '../MSObjectIdentifiers/id-mr-ms-single-substring-list-match.va';
