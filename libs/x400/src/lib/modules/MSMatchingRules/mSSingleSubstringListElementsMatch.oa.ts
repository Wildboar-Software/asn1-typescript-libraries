...
import { id_mr_ms_single_substring_list_elements_match } from '../MSObjectIdentifiers/id-mr-ms-single-substring-list-elements-match.va';
export { id_mr_ms_single_substring_list_elements_match } from '../MSObjectIdentifiers/id-mr-ms-single-substring-list-elements-match.va';
