...
import { id_bat_edi_body_part } from '../EDIMSObjectIdentifiers/id-bat-edi-body-part.va';
export { id_bat_edi_body_part } from '../EDIMSObjectIdentifiers/id-bat-edi-body-part.va';
