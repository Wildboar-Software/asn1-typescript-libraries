...
import { id_bat_message_parameters } from '../EDIMSObjectIdentifiers/id-bat-message-parameters.va';
export { id_bat_message_parameters } from '../EDIMSObjectIdentifiers/id-bat-message-parameters.va';
