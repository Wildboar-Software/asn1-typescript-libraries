...
import { id_cat_forwarding_edims } from '../EDIMSObjectIdentifiers/id-cat-forwarding-edims.va';
export { id_cat_forwarding_edims } from '../EDIMSObjectIdentifiers/id-cat-forwarding-edims.va';
