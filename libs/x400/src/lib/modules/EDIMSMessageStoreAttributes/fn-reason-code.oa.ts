...
import { id_nat_fn_reason_code } from '../EDIMSObjectIdentifiers/id-nat-fn-reason-code.va';
export { id_nat_fn_reason_code } from '../EDIMSObjectIdentifiers/id-nat-fn-reason-code.va';
