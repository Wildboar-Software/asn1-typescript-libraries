...
import { id_nat_forwarded_to } from '../EDIMSObjectIdentifiers/id-nat-forwarded-to.va';
export { id_nat_forwarded_to } from '../EDIMSObjectIdentifiers/id-nat-forwarded-to.va';
