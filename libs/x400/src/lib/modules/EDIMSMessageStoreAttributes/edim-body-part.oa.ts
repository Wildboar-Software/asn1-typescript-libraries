...
import { id_bat_edim_body_part } from '../EDIMSObjectIdentifiers/id-bat-edim-body-part.va';
export { id_bat_edim_body_part } from '../EDIMSObjectIdentifiers/id-bat-edim-body-part.va';
