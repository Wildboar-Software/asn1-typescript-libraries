...
import {
    ...
    _decode_Body,
    _encode_Body,
} from '../EDIMSInformationObjects/Body.ta';
export {
    Body,
    _decode_Body,
    _encode_Body,
} from '../EDIMSInformationObjects/Body.ta';
import { id_bat_body } from '../EDIMSObjectIdentifiers/id-bat-body.va';
export { id_bat_body } from '../EDIMSObjectIdentifiers/id-bat-body.va';
