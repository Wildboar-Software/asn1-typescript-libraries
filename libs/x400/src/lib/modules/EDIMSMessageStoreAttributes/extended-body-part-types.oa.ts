...
import { id_bat_extended_body_part_types } from '../EDIMSObjectIdentifiers/id-bat-extended-body-part-types.va';
export { id_bat_extended_body_part_types } from '../EDIMSObjectIdentifiers/id-bat-extended-body-part-types.va';
