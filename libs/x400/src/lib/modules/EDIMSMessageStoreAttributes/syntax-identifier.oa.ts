...
import { id_hat_syntax_identifier } from '../EDIMSObjectIdentifiers/id-hat-syntax-identifier.va';
export { id_hat_syntax_identifier } from '../EDIMSObjectIdentifiers/id-hat-syntax-identifier.va';
