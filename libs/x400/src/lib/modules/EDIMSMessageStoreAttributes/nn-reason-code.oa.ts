...
import { id_nat_nn_reason_code } from '../EDIMSObjectIdentifiers/id-nat-nn-reason-code.va';
export { id_nat_nn_reason_code } from '../EDIMSObjectIdentifiers/id-nat-nn-reason-code.va';
