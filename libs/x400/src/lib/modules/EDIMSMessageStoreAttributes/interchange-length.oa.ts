...
} from '../EDIMSMessageStoreAttributes/InterchangeLength.ta';
export {
    InterchangeLength,
    _decode_InterchangeLength,
    _encode_InterchangeLength,
...
import { id_bat_interchange_length } from '../EDIMSObjectIdentifiers/id-bat-interchange-length.va';
export { id_bat_interchange_length } from '../EDIMSObjectIdentifiers/id-bat-interchange-length.va';
