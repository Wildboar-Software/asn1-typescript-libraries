...
import { dl_reset_originator } from '../MHSDirectoryObjectsAndAttributes/dl-reset-originator.oa';
export { dl_reset_originator } from '../MHSDirectoryObjectsAndAttributes/dl-reset-originator.oa';
