...
} from '../MHSDirectoryObjectsAndAttributes/DLSubmitPermission.ta';
export {
    DLSubmitPermission,
    _decode_DLSubmitPermission,
    _encode_DLSubmitPermission,
} from '../MHSDirectoryObjectsAndAttributes/DLSubmitPermission.ta';
import { id_at_mhs_dl_submit_permissions } from '../MHSObjectIdentifiers/id-at-mhs-dl-submit-permissions.va';
export { id_at_mhs_dl_submit_permissions } from '../MHSObjectIdentifiers/id-at-mhs-dl-submit-permissions.va';
