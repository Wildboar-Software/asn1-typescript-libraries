...
import { mhs_deliverable_classes } from '../MHSDirectoryObjectsAndAttributes/mhs-deliverable-classes.oa';
export { mhs_deliverable_classes } from '../MHSDirectoryObjectsAndAttributes/mhs-deliverable-classes.oa';
...
import { id_oc_mhs_user_agent } from '../MHSObjectIdentifiers/id-oc-mhs-user-agent.va';
export { id_oc_mhs_user_agent } from '../MHSObjectIdentifiers/id-oc-mhs-user-agent.va';
