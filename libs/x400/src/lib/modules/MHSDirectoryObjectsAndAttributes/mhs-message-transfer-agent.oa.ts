...
import { id_oc_mhs_message_transfer_agent } from '../MHSObjectIdentifiers/id-oc-mhs-message-transfer-agent.va';
export { id_oc_mhs_message_transfer_agent } from '../MHSObjectIdentifiers/id-oc-mhs-message-transfer-agent.va';
