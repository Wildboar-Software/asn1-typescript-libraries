...
import { id_at_mhs_supported_attributes } from '../MHSObjectIdentifiers/id-at-mhs-supported-attributes.va';
export { id_at_mhs_supported_attributes } from '../MHSObjectIdentifiers/id-at-mhs-supported-attributes.va';
import {
    AttributeType,
