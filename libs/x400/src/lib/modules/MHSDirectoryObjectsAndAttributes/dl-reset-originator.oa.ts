...
import { id_con_dl_reset_originator } from '../MHSObjectIdentifiers/id-con-dl-reset-originator.va';
export { id_con_dl_reset_originator } from '../MHSObjectIdentifiers/id-con-dl-reset-originator.va';
