...
} from '../MHSDirectoryObjectsAndAttributes/AddressCapabilities.ta';
export {
    AddressCapabilities,
    _decode_AddressCapabilities,
    _encode_AddressCapabilities,
} from '../MHSDirectoryObjectsAndAttributes/AddressCapabilities.ta';
import { addressCapabilitiesMatch } from '../MHSDirectoryObjectsAndAttributes/addressCapabilitiesMatch.oa';
export { addressCapabilitiesMatch } from '../MHSDirectoryObjectsAndAttributes/addressCapabilitiesMatch.oa';
import { id_at_mhs_or_addresses_with_capabilities } from '../MHSObjectIdentifiers/id-at-mhs-or-addresses-with-capabilities.va';
export { id_at_mhs_or_addresses_with_capabilities } from '../MHSObjectIdentifiers/id-at-mhs-or-addresses-with-capabilities.va';
