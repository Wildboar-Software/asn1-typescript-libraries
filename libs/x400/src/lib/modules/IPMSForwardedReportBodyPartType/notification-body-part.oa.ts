...
import { notification_body_part_parameters } from '../IPMSForwardedReportBodyPartType/notification-body-part-parameters.oa';
export { notification_body_part_parameters } from '../IPMSForwardedReportBodyPartType/notification-body-part-parameters.oa';
import { notification_body_part_data } from '../IPMSForwardedReportBodyPartType/notification-body-part-data.oa';
export { notification_body_part_data } from '../IPMSForwardedReportBodyPartType/notification-body-part-data.oa';
