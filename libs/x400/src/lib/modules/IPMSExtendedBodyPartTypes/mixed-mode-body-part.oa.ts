...
import { mixed_mode_body_part_data } from '../IPMSExtendedBodyPartTypes/mixed-mode-body-part-data.oa';
export { mixed_mode_body_part_data } from '../IPMSExtendedBodyPartTypes/mixed-mode-body-part-data.oa';
