...
import { nationally_defined_body_part_data } from '../IPMSExtendedBodyPartTypes/nationally-defined-body-part-data.oa';
export { nationally_defined_body_part_data } from '../IPMSExtendedBodyPartTypes/nationally-defined-body-part-data.oa';
