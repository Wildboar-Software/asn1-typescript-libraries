...
} from '../MSAbstractService/MSProbeSubmissionArgument.ta';
export {
    MSProbeSubmissionArgument,
    _decode_MSProbeSubmissionArgument,
    _encode_MSProbeSubmissionArgument,
...
} from '../MSAbstractService/MSProbeSubmissionResult.ta';
export {
    MSProbeSubmissionResult,
    _decode_MSProbeSubmissionResult,
    _encode_MSProbeSubmissionResult,
...
import { op_ms_probe_submission } from '../MSAccessProtocol/op-ms-probe-submission.va';
export { op_ms_probe_submission } from '../MSAccessProtocol/op-ms-probe-submission.va';
