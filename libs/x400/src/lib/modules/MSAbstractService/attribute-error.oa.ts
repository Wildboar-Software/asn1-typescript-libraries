...
} from '../MSAbstractService/attribute-error-ParameterType.ta';
export {
    attribute_error_ParameterType,
    _decode_attribute_error_ParameterType,
    _encode_attribute_error_ParameterType,
} from '../MSAbstractService/attribute-error-ParameterType.ta';
import { err_attribute_error } from '../MSAccessProtocol/err-attribute-error.va';
export { err_attribute_error } from '../MSAccessProtocol/err-attribute-error.va';
