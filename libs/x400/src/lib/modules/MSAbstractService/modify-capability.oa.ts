...
import { id_ext_modify_capability } from '../MSObjectIdentifiers/id-ext-modify-capability.va';
export { id_ext_modify_capability } from '../MSObjectIdentifiers/id-ext-modify-capability.va';
