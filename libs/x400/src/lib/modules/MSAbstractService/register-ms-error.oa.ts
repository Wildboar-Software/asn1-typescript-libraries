...
} from '../MSAbstractService/register-ms-error-ParameterType.ta';
export {
    register_ms_error_ParameterType,
    _decode_register_ms_error_ParameterType,
    _encode_register_ms_error_ParameterType,
} from '../MSAbstractService/register-ms-error-ParameterType.ta';
import { err_register_ms_error } from '../MSAccessProtocol/err-register-ms-error.va';
export { err_register_ms_error } from '../MSAccessProtocol/err-register-ms-error.va';
