...
import {
    ...
    _decode_IPMLocation,
    _encode_IPMLocation,
} from '../IPMSMessageStoreAttributes/IPMLocation.ta';
export {
    IPMLocation,
    _decode_IPMLocation,
    _encode_IPMLocation,
...
import { id_cat_related_ipms } from '../IPMSObjectIdentifiers/id-cat-related-ipms.va';
export { id_cat_related_ipms } from '../IPMSObjectIdentifiers/id-cat-related-ipms.va';
