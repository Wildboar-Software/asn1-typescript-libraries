...
import { id_nat_non_receipt_reason } from '../IPMSObjectIdentifiers/id-nat-non-receipt-reason.va';
export { id_nat_non_receipt_reason } from '../IPMSObjectIdentifiers/id-nat-non-receipt-reason.va';
