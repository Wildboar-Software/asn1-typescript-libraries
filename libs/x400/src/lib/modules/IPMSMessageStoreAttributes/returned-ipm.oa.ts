...
import { id_nat_returned_ipm } from '../IPMSObjectIdentifiers/id-nat-returned-ipm.va';
export { id_nat_returned_ipm } from '../IPMSObjectIdentifiers/id-nat-returned-ipm.va';
