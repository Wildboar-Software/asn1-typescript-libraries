...
} from '../IPMSMessageStoreAttributes/CorrelatedDeliveredReplies.ta';
export {
    CorrelatedDeliveredReplies,
    _decode_CorrelatedDeliveredReplies,
    _encode_CorrelatedDeliveredReplies,
} from '../IPMSMessageStoreAttributes/CorrelatedDeliveredReplies.ta';
import { id_cat_correlated_delivered_replies } from '../IPMSObjectIdentifiers/id-cat-correlated-delivered-replies.va';
export { id_cat_correlated_delivered_replies } from '../IPMSObjectIdentifiers/id-cat-correlated-delivered-replies.va';
