...
import { id_bat_videotex_body_parts } from '../IPMSObjectIdentifiers/id-bat-videotex-body-parts.va';
export { id_bat_videotex_body_parts } from '../IPMSObjectIdentifiers/id-bat-videotex-body-parts.va';
