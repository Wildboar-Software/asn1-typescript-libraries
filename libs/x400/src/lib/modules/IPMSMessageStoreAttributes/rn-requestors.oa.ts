...
import { id_hat_rn_requestors } from '../IPMSObjectIdentifiers/id-hat-rn-requestors.va';
export { id_hat_rn_requestors } from '../IPMSObjectIdentifiers/id-hat-rn-requestors.va';
