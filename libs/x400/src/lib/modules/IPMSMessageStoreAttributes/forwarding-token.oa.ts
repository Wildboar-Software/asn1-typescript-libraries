...
import { id_hat_forwarding_token } from '../IPMSObjectIdentifiers/id-hat-forwarding-token.va';
export { id_hat_forwarding_token } from '../IPMSObjectIdentifiers/id-hat-forwarding-token.va';
