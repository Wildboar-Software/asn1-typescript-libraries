...
import { id_bat_encrypted_parameters } from '../IPMSObjectIdentifiers/id-bat-encrypted-parameters.va';
export { id_bat_encrypted_parameters } from '../IPMSObjectIdentifiers/id-bat-encrypted-parameters.va';
