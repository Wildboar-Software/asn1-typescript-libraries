...
import { id_cat_forwarded_ipms } from '../IPMSObjectIdentifiers/id-cat-forwarded-ipms.va';
export { id_cat_forwarded_ipms } from '../IPMSObjectIdentifiers/id-cat-forwarded-ipms.va';
