...
import { id_bat_ia5_text_body_parts } from '../IPMSObjectIdentifiers/id-bat-ia5-text-body-parts.va';
export { id_bat_ia5_text_body_parts } from '../IPMSObjectIdentifiers/id-bat-ia5-text-body-parts.va';
