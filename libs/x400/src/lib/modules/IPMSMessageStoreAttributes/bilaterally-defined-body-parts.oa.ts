...
import { id_bat_bilaterally_defined_body_parts } from '../IPMSObjectIdentifiers/id-bat-bilaterally-defined-body-parts.va';
export { id_bat_bilaterally_defined_body_parts } from '../IPMSObjectIdentifiers/id-bat-bilaterally-defined-body-parts.va';
