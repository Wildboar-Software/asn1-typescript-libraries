...
import { id_hat_nrn_requestors } from '../IPMSObjectIdentifiers/id-hat-nrn-requestors.va';
export { id_hat_nrn_requestors } from '../IPMSObjectIdentifiers/id-hat-nrn-requestors.va';
