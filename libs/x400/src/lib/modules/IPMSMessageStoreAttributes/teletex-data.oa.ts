...
import { id_bat_teletex_data } from '../IPMSObjectIdentifiers/id-bat-teletex-data.va';
export { id_bat_teletex_data } from '../IPMSObjectIdentifiers/id-bat-teletex-data.va';
