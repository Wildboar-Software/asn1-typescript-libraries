...
import { id_hat_body_part_encryption_token } from '../IPMSObjectIdentifiers/id-hat-body-part-encryption-token.va';
export { id_hat_body_part_encryption_token } from '../IPMSObjectIdentifiers/id-hat-body-part-encryption-token.va';
