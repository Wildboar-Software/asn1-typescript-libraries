...
import { id_cat_obsoleted_ipms } from '../IPMSObjectIdentifiers/id-cat-obsoleted-ipms.va';
export { id_cat_obsoleted_ipms } from '../IPMSObjectIdentifiers/id-cat-obsoleted-ipms.va';
