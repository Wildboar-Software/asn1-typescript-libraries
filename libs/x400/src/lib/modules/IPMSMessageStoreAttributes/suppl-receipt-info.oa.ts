...
import { id_nat_suppl_receipt_info } from '../IPMSObjectIdentifiers/id-nat-suppl-receipt-info.va';
export { id_nat_suppl_receipt_info } from '../IPMSObjectIdentifiers/id-nat-suppl-receipt-info.va';
