...
import { id_bat_mixed_mode_body_parts } from '../IPMSObjectIdentifiers/id-bat-mixed-mode-body-parts.va';
export { id_bat_mixed_mode_body_parts } from '../IPMSObjectIdentifiers/id-bat-mixed-mode-body-parts.va';
