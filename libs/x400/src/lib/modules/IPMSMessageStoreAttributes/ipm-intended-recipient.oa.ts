...
import { id_nat_ipm_intended_recipient } from '../IPMSObjectIdentifiers/id-nat-ipm-intended-recipient.va';
export { id_nat_ipm_intended_recipient } from '../IPMSObjectIdentifiers/id-nat-ipm-intended-recipient.va';
