...
import {
    ...
    _decode_ClassList,
    _encode_ClassList,
} from "../SIOsAccessControl-MODULE/ClassList.ta";
import {
    SecurityCategories,
...
export class Clearance {
    constructor(
         ...
         * @readonly
         */
        readonly securityCategories: OPTIONAL<SecurityCategories>
    ) {}
    ...
    public static _from_object(
        ...
        return new Clearance(_o.policyId, _o.classList, _o.securityCategories);
    }
...
export function _decode_Clearance(el: _Element) {
    if (!_cached_decoder_for_Clearance) {
        _cached_decoder_for_Clearance = function (el: _Element): Clearance {
            ...
            let securityCategories: OPTIONAL<SecurityCategories>;
            ...
            const callbacks: $.DecodingMap = {
                ...
                securityCategories: (_el: _Element): void => {
                    securityCategories = $._decode_implicit<SecurityCategories>(
                        () => _decode_SecurityCategories
                    )(_el);
                },
            };
