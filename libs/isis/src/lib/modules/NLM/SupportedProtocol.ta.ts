...
export class SupportedProtocol {
  ...
  public static _from_object(
    ...
    return new SupportedProtocol(_o.protocol, _o.versions, _o.defectsRepaired);
  }
}
      ...
      const callbacks: $.DecodingMap = {
        ...
        versions: (_el: _Element): void => {
          versions = $._decode_implicit<ProtocolVersion[]>(() =>
            $._decodeSetOf<ProtocolVersion>(() => _decode_ProtocolVersion)
          )(_el);
        },
        defectsRepaired: (_el: _Element): void => {
          defectsRepaired = $._decode_implicit<OBJECT_IDENTIFIER[]>(() =>
            $._decodeSetOf<OBJECT_IDENTIFIER>(() => $._decodeObjectIdentifier)
          )(_el);
        },
      };
