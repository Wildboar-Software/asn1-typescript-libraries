    ...
    _cached_decoder_for_DefaultTCA = function (el: _Element): DefaultTCA {
      ...
      const callbacks: $.DecodingMap = {
        subscription: (_el: _Element): void => {
          subscription = $._decode_implicit<BOOLEAN>(() => $._decodeBoolean)(
            _el
          );
        },
      ...
      return $._encodeSequence(
        ([] as (_Element | undefined)[])
          .concat([
            ...
            /* IF_ABSENT  */ value.supportedThroughClasses === undefined
              ? undefined
              : $._encode_implicit(
                  _TagClass.context,
                  1,
                  () => $._encodeSetOf<INTEGER>(() => $._encodeInteger, $.BER),
                  $.BER
                )(value.supportedThroughClasses, $.BER),
            /* IF_ABSENT  */ value.selectedThroughputClasses === undefined
              ? undefined
              : $._encode_implicit(
                  _TagClass.context,
                  2,
