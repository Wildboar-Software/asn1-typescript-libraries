 ...
 * ```
 */
export type SNPAAddress = NLM.SNPAAddress; // DefinedType
...
export function _decode_SNPAAddress(el: _Element) {
  if (!_cached_decoder_for_SNPAAddress) {
    _cached_decoder_for_SNPAAddress = NLM._decode_SNPAAddress;
  }
...
export function _encode_SNPAAddress(
  ...
  if (!_cached_encoder_for_SNPAAddress) {
    _cached_encoder_for_SNPAAddress = NLM._encode_SNPAAddress;
  }
