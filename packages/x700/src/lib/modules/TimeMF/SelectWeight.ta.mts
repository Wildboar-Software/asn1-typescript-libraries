 ...
 * @description
 *
 * Weight used to compute NTP selection dispersion (REAL
 * 0..1). Syntax of `selectWeight`. ITU-T Rec. X.743 (06/98)
 * [§B.3.14](https://www.itu.int/rec/T-REC-X.743-199806-I), A.5.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
