 ...
 */
export function _decode_Generic64BitCounter(el: _Element) {
    if (!_cached_decoder_for_Generic64BitCounter) {
        _cached_decoder_for_Generic64BitCounter = $._decodeInteger;
    }
 ...
 */
export function _encode_Generic64BitCounter(
    value: Generic64BitCounter,
    elGetter: $.ASN1Encoder<Generic64BitCounter>
) {
    if (!_cached_encoder_for_Generic64BitCounter) {
        _cached_encoder_for_Generic64BitCounter = $._encodeInteger;
    }
