 ...
 * @description
 *
 * One conditional package: template label and `PRESENT IF` condition
 * string. ITU-T Rec. X.750 (10/96)
...
export class ConditionalPackages_Item {
    constructor(
         ...
         * @description
         *
         * `PRESENT IF` condition from the managed object class template.
         * @public
         * @readonly
         */
