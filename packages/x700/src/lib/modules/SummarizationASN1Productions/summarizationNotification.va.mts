...
/* START_OF_SYMBOL_DEFINITION summarizationNotification */
/**
 ...
 * @constant
 */
export const summarizationNotification: OBJECT_IDENTIFIER = new _OID(
    [/* ms */ 9, /* function */ 2, /* part13 */ 13, /* notification */ 10],
    joint_iso_ccitt
);
/* END_OF_SYMBOL_DEFINITION summarizationNotification */
