...
/* START_OF_SYMBOL_DEFINITION summarizationAttribute */
/**
 ...
 * @constant
 */
export const summarizationAttribute: OBJECT_IDENTIFIER = new _OID(
    [/* ms */ 9, /* function */ 2, /* part13 */ 13, /* attribute */ 7],
    joint_iso_ccitt
);
/* END_OF_SYMBOL_DEFINITION summarizationAttribute */
