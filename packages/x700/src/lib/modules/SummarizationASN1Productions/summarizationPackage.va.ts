...
/* START_OF_SYMBOL_DEFINITION summarizationPackage */
/**
 ...
 * @constant
 */
export const summarizationPackage: OBJECT_IDENTIFIER = new _OID(
    [/* ms */ 9, /* function */ 2, /* part13 */ 13, /* package */ 4],
    joint_iso_ccitt
);
/* END_OF_SYMBOL_DEFINITION summarizationPackage */
