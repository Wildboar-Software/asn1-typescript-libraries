 ...
 * @description
 *
 * Parameter templates associated with the represented element.
 * Multi-valued `TemplateLabel`. Uses `directoryStringFirstComponentMatch`
 * (case-ignore); some matches can fail an exact-case test (X.750 B.2 IMPORTS
 * note). ID
 * `{mkmDirectoryAttributeType 32}`. ITU-T Rec. X.750 (10/96)
