...
import { directoryStringFirstComponentMatch } from '@wildboar/x500/src/lib/modules/SelectedAttributeTypes/directoryStringFirstComponentMatch.oa.js';
export { directoryStringFirstComponentMatch } from '@wildboar/x500/src/lib/modules/SelectedAttributeTypes/directoryStringFirstComponentMatch.oa.js';
 ...
 */
export const withAttribute: ATTRIBUTE<TemplateLabel> = {
    class: 'ATTRIBUTE',
    decoderFor: {
