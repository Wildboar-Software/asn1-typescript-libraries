...
} from '../DefinitionASN1Module/NamingObjectClass.ta.js';
export {
    NamingObjectClass,
    _decode_NamingObjectClass,
    _encode_NamingObjectClass,
...
/* START_OF_SYMBOL_DEFINITION subordinateObjectClass */
/**
 ...
 */
export const subordinateObjectClass: ATTRIBUTE<NamingObjectClass> = {
    class: 'ATTRIBUTE',
    decoderFor: {
...
/* END_OF_SYMBOL_DEFINITION subordinateObjectClass */
