...
import {
    MatchesFor,
    MatchesFor_equality /* IMPORTED_LONG_NAMED_BIT */,
    equality /* IMPORTED_SHORT_NAMED_BIT */,
    MatchesFor_ordering /* IMPORTED_LONG_NAMED_BIT */,
    ordering /* IMPORTED_SHORT_NAMED_BIT */,
    MatchesFor_substrings /* IMPORTED_LONG_NAMED_BIT */,
    substrings /* IMPORTED_SHORT_NAMED_BIT */,
    MatchesFor_setComparison /* IMPORTED_LONG_NAMED_BIT */,
    setComparison /* IMPORTED_SHORT_NAMED_BIT */,
    MatchesFor_setIntersection /* IMPORTED_LONG_NAMED_BIT */,
    setIntersection /* IMPORTED_SHORT_NAMED_BIT */,
    _decode_MatchesFor,
    _encode_MatchesFor,
} from '../DefinitionASN1Module/MatchesFor.ta.js';
export {
    MatchesFor,
    MatchesFor_equality /* IMPORTED_LONG_NAMED_BIT */,
    equality /* IMPORTED_SHORT_NAMED_BIT */,
