 ...
 * @description
 *
 * Immediate superclasses of a managed object class. Multi-valued
 * `TemplateLabel`. Uses `directoryStringFirstComponentMatch` (case-ignore);
 * some matches can fail an exact-case test (X.750 B.2 IMPORTS note). ID
 * `{mkmDirectoryAttributeType 19}`.
