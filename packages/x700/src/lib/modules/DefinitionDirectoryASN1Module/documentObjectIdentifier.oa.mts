 ...
 * @description
 *
 * Object identifier of the represented document (Directory syntax is
 * OID, not the CMIP `OptionallyRegisteredAs` choice). ID
 * `{mkmDirectoryAttributeType 23}`. ITU-T Rec. X.750 (10/96)
 ...
 */
export const documentObjectIdentifier: ATTRIBUTE<OBJECT_IDENTIFIER> = {
    class: 'ATTRIBUTE',
    decoderFor: {
