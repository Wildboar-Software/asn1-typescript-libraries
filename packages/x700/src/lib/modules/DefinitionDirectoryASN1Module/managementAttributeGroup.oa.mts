 ...
 * @description
 *
 * Directory auxiliary for a GDMO attribute-group template. MUST CONTAIN
 * `groupElements`, `fixed`, `description`, and `registeredAs`. ID
 * `{mkmDirectoryObjectClass 11}`. ITU-T Rec. X.750 (10/96)
