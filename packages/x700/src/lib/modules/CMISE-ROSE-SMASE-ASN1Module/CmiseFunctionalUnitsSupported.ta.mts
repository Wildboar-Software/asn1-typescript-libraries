 ...
 * @description
 *
 * Syntax of the X.727 `cmiseFunctionalUnitsSupported`
 * attribute (`{crsAttribute 4}`) on `cmise`: CMISE functional
 * units supported by the ASE. ITU-T Rec. X.727 (03/99)
 * [§7.4](https://www.itu.int/rec/T-REC-X.727-199903-I),
 * Annex A.
 *
 * ### ASN.1 Definition:
 *
