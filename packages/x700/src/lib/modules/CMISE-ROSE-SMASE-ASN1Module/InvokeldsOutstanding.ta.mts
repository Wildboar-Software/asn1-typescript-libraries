 ...
 * @description
 *
 * Syntax of the X.727 `invokeIdsOutstanding` attribute
 * (`{crsAttribute 5}`) on `cmiseInvocation`: invoke ids
 * issued in confirmed mode for which a confirmation has not
 * been received. ITU-T Rec. X.727 (03/99)
