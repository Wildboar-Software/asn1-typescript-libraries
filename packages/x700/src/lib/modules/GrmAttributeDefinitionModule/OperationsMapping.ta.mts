 ...
 * @description
 *
 * GRM `OPERATIONS MAPPING`: each pair maps one relationship management
 * operation or notification to one or more systems management
 * operations. ITU-T Rec. X.750 Amd.1 (10/97)
