...
export { serviceReportCause } from '../SecurityAuditTrailDefinitions/serviceReportCause.va.mjs';

/* START_OF_SYMBOL_DEFINITION serviceFailure */
/**
 ...
 * @constant
 */
export const serviceFailure: ServiceReportCause = new _OID(
    [4],
    serviceReportCause
);
/* END_OF_SYMBOL_DEFINITION serviceFailure */
