...
function _encode_ProximitySupport_unitsSupported_Item_private (value: ProximitySupport_unitsSupported_Item_private, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_implicit(_TagClass.context, 0, () => $._encodeInteger, $.BER)(value.unit, $.BER),
            /* IF_ABSENT  */ ((value.description === undefined) ? undefined : $._encode_explicit(_TagClass.context, 1, () => _encode_HumanString, $.BER)(value.description, $.BER))
        ],
