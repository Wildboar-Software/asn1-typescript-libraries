# Cryptographic Information Framework (CIF) PDUs in TypeScript

ASN.1 data structures based on the ASN.1 definitions in ISO/IEC 7816-15
(Cryptographic information application / PKCS #15).
...
This module is ESM-only. Import from `@wildboar/cif`. Per-module
...
(Cursor Grok 4.6) on 14 September 2026.
