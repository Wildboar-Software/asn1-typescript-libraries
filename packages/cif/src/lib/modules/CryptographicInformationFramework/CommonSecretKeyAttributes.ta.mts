 ...
 * @description
 * 
 * Secret-key subclass attributes. ISO/IEC 7816-15:2016 §8.2.12.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class CommonSecretKeyAttributes {
    constructor (
         ...
         * @summary `keyLen`.
         * @description
         * Key length in bits when the algorithm has a variable length. ISO/IEC
         * 7816-15:2016 §8.2.12.
         * @public
         * @readonly
         */
...
function _encode_CommonSecretKeyAttributes (value: CommonSecretKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CommonSecretKeyAttributes) { _cached_encoder_for_CommonSecretKeyAttributes = function (value: CommonSecretKeyAttributes): _Element {
