 ...
 * @description
 * 
 * EC public-key attributes. ISO/IEC 7816-15:2016 §8.5.3.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 ...
 */
export
class PublicECKeyAttributes {
    constructor (
        /**
         * @summary `value`.
         * @description
         * `ObjectValue` of `ECPublicKeyChoice` or a card-specific EC public
         * key. ISO/IEC 7816-15:2016 §8.5.3.
         * @public
         * @readonly
         */
     ...
     */
    public static _from_object (_o: { [_K in keyof (PublicECKeyAttributes)]: (PublicECKeyAttributes)[_K] }): PublicECKeyAttributes {
        return new PublicECKeyAttributes(_o.value, _o.keyInfo, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_PublicECKeyAttributes: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_PublicECKeyAttributes: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PublicECKeyAttributes: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PublicECKeyAttributes (el: _Element): PublicECKeyAttributes {
    if (!_cached_decoder_for_PublicECKeyAttributes) { _cached_decoder_for_PublicECKeyAttributes = function (el: _Element): PublicECKeyAttributes {
    let value!: ObjectValue<ECPublicKeyChoice>;
    let keyInfo: OPTIONAL<KeyInfo<Parameters, PublicKeyOperations>>;
    let _unrecognizedExtensionsList: _Element[] = [];
    const callbacks: $.DecodingMap = {
        "value": (_el: _Element): void => { value = _get_decoder_for_ObjectValue<ECPublicKeyChoice>(_decode_ECPublicKeyChoice)(_el); },
 ...
 */
export
function _encode_PublicECKeyAttributes (value: PublicECKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PublicECKeyAttributes) { _cached_encoder_for_PublicECKeyAttributes = function (value: PublicECKeyAttributes): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _get_encoder_for_ObjectValue<ECPublicKeyChoice>(_encode_ECPublicKeyChoice)(value.value, $.BER),
