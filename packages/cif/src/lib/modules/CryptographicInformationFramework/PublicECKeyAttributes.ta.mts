...
function _encode_PublicECKeyAttributes (value: PublicECKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PublicECKeyAttributes) { _cached_encoder_for_PublicECKeyAttributes = function (value: PublicECKeyAttributes, elGetter: $.ASN1Encoder<PublicECKeyAttributes>): _Element {
