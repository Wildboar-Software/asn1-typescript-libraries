 ...
 */
export
class SPKICertificateAttributes {
    constructor (
        /**
         * @summary `value`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (SPKICertificateAttributes)]: (SPKICertificateAttributes)[_K] }): SPKICertificateAttributes {
        return new SPKICertificateAttributes(_o.value, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_SPKICertificateAttributes: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_SPKICertificateAttributes: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SPKICertificateAttributes: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SPKICertificateAttributes (el: _Element): SPKICertificateAttributes {
    if (!_cached_decoder_for_SPKICertificateAttributes) { _cached_decoder_for_SPKICertificateAttributes = function (el: _Element): SPKICertificateAttributes {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new _ConstructionError("SPKICertificateAttributes contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_SPKICertificateAttributes (value: SPKICertificateAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SPKICertificateAttributes) { _cached_encoder_for_SPKICertificateAttributes = function (value: SPKICertificateAttributes, elGetter: $.ASN1Encoder<SPKICertificateAttributes>): _Element {
