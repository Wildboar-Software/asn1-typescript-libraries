 ...
 * @description
 * 
 * PGP certificate (IETF RFC 4880). ISO/IEC 7816-15:2016 §8.7.5.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class PGPCertificateAttributes {
    constructor (
         ...
         * @summary `value`.
         * @description
         * `ReferencedValue` to the PGP certificate file or URL. ISO/IEC
         * 7816-15:2016 §8.7.5.
         * @public
         * @readonly
         */
...
function _encode_PGPCertificateAttributes (value: PGPCertificateAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PGPCertificateAttributes) { _cached_encoder_for_PGPCertificateAttributes = function (value: PGPCertificateAttributes): _Element {
