 ...
 */
export
function _decode_RSAPublicKeyChoice (el: _Element): RSAPublicKeyChoice {
    if (!_cached_decoder_for_RSAPublicKeyChoice) { _cached_decoder_for_RSAPublicKeyChoice = $._decode_extensible_choice<RSAPublicKeyChoice>({
 ...
 */
export
function _encode_RSAPublicKeyChoice (value: RSAPublicKeyChoice, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RSAPublicKeyChoice) { _cached_encoder_for_RSAPublicKeyChoice = $._encode_choice<RSAPublicKeyChoice>({
