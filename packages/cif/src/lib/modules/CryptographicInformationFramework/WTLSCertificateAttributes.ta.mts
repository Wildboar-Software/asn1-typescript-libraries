...
function _encode_WTLSCertificateAttributes (value: WTLSCertificateAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_WTLSCertificateAttributes) { _cached_encoder_for_WTLSCertificateAttributes = function (value: WTLSCertificateAttributes, elGetter: $.ASN1Encoder<WTLSCertificateAttributes>): _Element {
