...
// export { DSAPublicKeyChoice, _decode_DSAPublicKeyChoice, _encode_DSAPublicKeyChoice } from "../CryptographicInformationFramework/DSAPublicKeyChoice.ta.mjs";
...
function _encode_PublicDSAKeyAttributes (value: PublicDSAKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PublicDSAKeyAttributes) { _cached_encoder_for_PublicDSAKeyAttributes = function (value: PublicDSAKeyAttributes, elGetter: $.ASN1Encoder<PublicDSAKeyAttributes>): _Element {
