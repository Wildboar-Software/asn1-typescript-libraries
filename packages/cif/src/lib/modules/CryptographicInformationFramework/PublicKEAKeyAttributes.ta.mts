...
function _encode_PublicKEAKeyAttributes (value: PublicKEAKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PublicKEAKeyAttributes) { _cached_encoder_for_PublicKEAKeyAttributes = function (value: PublicKEAKeyAttributes, elGetter: $.ASN1Encoder<PublicKEAKeyAttributes>): _Element {
