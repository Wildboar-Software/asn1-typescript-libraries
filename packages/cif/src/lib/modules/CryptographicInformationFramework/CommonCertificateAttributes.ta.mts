...
function _encode_CommonCertificateAttributes (value: CommonCertificateAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CommonCertificateAttributes) { _cached_encoder_for_CommonCertificateAttributes = function (value: CommonCertificateAttributes): _Element {
