...
import { IrisInformation_eye, _enum_for_IrisInformation_eye, IrisInformation_eye_left /* IMPORTED_LONG_ENUMERATION_ITEM */, left /* IMPORTED_SHORT_ENUMERATION_ITEM */, IrisInformation_eye_right /* IMPORTED_LONG_ENUMERATION_ITEM */, right /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_IrisInformation_eye, _encode_IrisInformation_eye } from "../CryptographicInformationFramework/IrisInformation-eye.ta.mjs";
...
function _encode_IrisInformation (value: IrisInformation, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_IrisInformation) { _cached_encoder_for_IrisInformation = function (value: IrisInformation, elGetter: $.ASN1Encoder<IrisInformation>): _Element {
