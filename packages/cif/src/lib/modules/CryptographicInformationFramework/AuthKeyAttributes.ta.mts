...
class AuthKeyAttributes {
     ...
     */
    public static _from_object (_o: { [_K in keyof (AuthKeyAttributes)]: (AuthKeyAttributes)[_K] }): AuthKeyAttributes {
 ...
 */
export
const _root_component_type_list_1_spec_for_AuthKeyAttributes: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_AuthKeyAttributes: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AuthKeyAttributes: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AuthKeyAttributes (el: _Element): AuthKeyAttributes {
    if (!_cached_decoder_for_AuthKeyAttributes) { _cached_decoder_for_AuthKeyAttributes = function (el: _Element): AuthKeyAttributes {
    let derivedKey: OPTIONAL<BOOLEAN> = AuthKeyAttributes._default_value_for_derivedKey;
    let authKeyId!: Identifier;
    let _unrecognizedExtensionsList: _Element[] = [];
    const callbacks: $.DecodingMap = {
        "derivedKey": (_el: _Element): void => { derivedKey = $._decodeBoolean(_el); },
        "authKeyId": (_el: _Element): void => { authKeyId = _decode_Identifier(_el); }
    };
 ...
 */
export
function _encode_AuthKeyAttributes (value: AuthKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AuthKeyAttributes) { _cached_encoder_for_AuthKeyAttributes = function (value: AuthKeyAttributes, elGetter: $.ASN1Encoder<AuthKeyAttributes>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_DEFAULT */ (value.derivedKey === undefined || $.deepEq(value.derivedKey, AuthKeyAttributes._default_value_for_derivedKey) ? undefined : $._encodeBoolean(value.derivedKey, $.BER)),
