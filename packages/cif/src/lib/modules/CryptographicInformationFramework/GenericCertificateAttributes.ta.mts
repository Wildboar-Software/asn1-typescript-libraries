...
import { AllowedCertificates } from "../CryptographicInformationFramework/AllowedCertificates.osa.mjs";
...
function _encode_GenericCertificateAttributes (value: GenericCertificateAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GenericCertificateAttributes) { _cached_encoder_for_GenericCertificateAttributes = function (value: GenericCertificateAttributes, elGetter: $.ASN1Encoder<GenericCertificateAttributes>): _Element {
