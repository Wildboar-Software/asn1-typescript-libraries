 ...
 * 
 * ```asn1
 * Path-efidOrTagChoice-appTagRef ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_Path_efidOrTagChoice_appTagRef (value: Path_efidOrTagChoice_appTagRef, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Path_efidOrTagChoice_appTagRef) { _cached_encoder_for_Path_efidOrTagChoice_appTagRef = function (value: Path_efidOrTagChoice_appTagRef, elGetter: $.ASN1Encoder<Path_efidOrTagChoice_appTagRef>): _Element {
