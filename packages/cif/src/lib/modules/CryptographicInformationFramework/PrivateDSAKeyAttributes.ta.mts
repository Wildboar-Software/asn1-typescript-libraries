 ...
 * @description
 * 
 * DSA private-key attributes. ISO/IEC 7816-15:2016 §8.4.5.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class PrivateDSAKeyAttributes {
    constructor (
         ...
         * be specified. ISO/IEC 7816-15:2016 §8.4. DSA.
         * @public
         * @readonly
         */
        readonly value: Path,
...
function _encode_PrivateDSAKeyAttributes (value: PrivateDSAKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PrivateDSAKeyAttributes) { _cached_encoder_for_PrivateDSAKeyAttributes = function (value: PrivateDSAKeyAttributes): _Element {
