...
class X509AttributeCertificateAttributes {
     ...
     */
    public static _from_object (_o: { [_K in keyof (X509AttributeCertificateAttributes)]: (X509AttributeCertificateAttributes)[_K] }): X509AttributeCertificateAttributes {
 ...
 */
export
const _root_component_type_list_1_spec_for_X509AttributeCertificateAttributes: $.ComponentSpec[] = [
    new $.ComponentSpec("value", false, $.hasAnyTag),
    new $.ComponentSpec("issuer", true, $.hasTag(_TagClass.universal, 16)),
    new $.ComponentSpec("serialNumber", true, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("attrTypes", true, $.hasTag(_TagClass.context, 0))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_X509AttributeCertificateAttributes: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_X509AttributeCertificateAttributes: $.ComponentSpec[] = [
 ...
 */
export
function _decode_X509AttributeCertificateAttributes (el: _Element): X509AttributeCertificateAttributes {
    if (!_cached_decoder_for_X509AttributeCertificateAttributes) { _cached_decoder_for_X509AttributeCertificateAttributes = function (el: _Element): X509AttributeCertificateAttributes {
    ...
    const callbacks: $.DecodingMap = {
        "value": (_el: _Element): void => { value = _get_decoder_for_ObjectValue<AttributeCertificate>(_decode_AttributeCertificate)(_el); },
        "issuer": (_el: _Element): void => { issuer = _decode_GeneralNames(_el); },
        "serialNumber": (_el: _Element): void => { serialNumber = _decode_CertificateSerialNumber(_el); },
        "attrTypes": (_el: _Element): void => { attrTypes = $._decode_implicit<OBJECT_IDENTIFIER[]>(() => $._decodeSequenceOf<OBJECT_IDENTIFIER>(() => $._decodeObjectIdentifier))(_el); }
    };
 ...
 */
export
function _encode_X509AttributeCertificateAttributes (value: X509AttributeCertificateAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_X509AttributeCertificateAttributes) { _cached_encoder_for_X509AttributeCertificateAttributes = function (value: X509AttributeCertificateAttributes, elGetter: $.ASN1Encoder<X509AttributeCertificateAttributes>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _get_encoder_for_ObjectValue<AttributeCertificate>(_encode_AttributeCertificate)(value.value, $.BER),
            /* IF_ABSENT  */ ((value.issuer === undefined) ? undefined : _encode_GeneralNames(value.issuer, $.BER)),
            /* IF_ABSENT  */ ((value.serialNumber === undefined) ? undefined : _encode_CertificateSerialNumber(value.serialNumber, $.BER)),
            /* IF_ABSENT  */ ((value.attrTypes === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => $._encodeSequenceOf<OBJECT_IDENTIFIER>(() => $._encodeObjectIdentifier, $.BER), $.BER)(value.attrTypes, $.BER))
        ],
