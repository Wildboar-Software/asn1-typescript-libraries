...
function _encode_BiometricInformationTemplate_templateAndMaxBitLength (value: BiometricInformationTemplate_templateAndMaxBitLength, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BiometricInformationTemplate_templateAndMaxBitLength) { _cached_encoder_for_BiometricInformationTemplate_templateAndMaxBitLength = function (value: BiometricInformationTemplate_templateAndMaxBitLength): _Element {
