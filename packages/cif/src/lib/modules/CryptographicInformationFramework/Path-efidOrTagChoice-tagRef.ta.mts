 ...
 * @description
 * 
 * Tag plus optional EF path when the CDE is a data object. ISO/IEC 7816-15:2016
 * §8.2.5.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * Path-efidOrTagChoice-tagRef ::= SEQUENCE {
 *     tag         OCTET STRING,
...
class Path_efidOrTagChoice_tagRef {
    constructor (
         ...
         * @summary `tag`.
         * @description
         * Data-object tag. ISO/IEC 7816-15:2016 §8.2.5.
         * @public
         * @readonly
         */
         ...
         * @summary `efidOrPath`.
         * @description
         * Optional EF that contains the tagged object. ISO/IEC 7816-15:2016
         * §8.2.5.
         * @public
         * @readonly
         */
...
function _encode_Path_efidOrTagChoice_tagRef (value: Path_efidOrTagChoice_tagRef, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Path_efidOrTagChoice_tagRef) { _cached_encoder_for_Path_efidOrTagChoice_tagRef = function (value: Path_efidOrTagChoice_tagRef): _Element {
