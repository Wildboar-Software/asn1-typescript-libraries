...
function _encode_InternalAuthObjectAttributes (value: InternalAuthObjectAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_InternalAuthObjectAttributes) { _cached_encoder_for_InternalAuthObjectAttributes = function (value: InternalAuthObjectAttributes): _Element {
