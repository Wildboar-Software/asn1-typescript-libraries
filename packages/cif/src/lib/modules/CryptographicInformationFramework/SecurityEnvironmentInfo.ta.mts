...
function _encode_SecurityEnvironmentInfo (value: SecurityEnvironmentInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SecurityEnvironmentInfo) { _cached_encoder_for_SecurityEnvironmentInfo = function (value: SecurityEnvironmentInfo, elGetter: $.ASN1Encoder<SecurityEnvironmentInfo>): _Element {
