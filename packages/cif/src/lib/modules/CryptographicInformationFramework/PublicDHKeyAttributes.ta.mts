...
// export { DHPublicKeyChoice, _decode_DHPublicKeyChoice, _encode_DHPublicKeyChoice } from "../CryptographicInformationFramework/DHPublicKeyChoice.ta.mjs";
...
function _encode_PublicDHKeyAttributes (value: PublicDHKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PublicDHKeyAttributes) { _cached_encoder_for_PublicDHKeyAttributes = function (value: PublicDHKeyAttributes, elGetter: $.ASN1Encoder<PublicDHKeyAttributes>): _Element {
