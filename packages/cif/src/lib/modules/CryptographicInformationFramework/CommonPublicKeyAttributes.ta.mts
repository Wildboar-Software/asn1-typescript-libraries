...
function _encode_CommonPublicKeyAttributes (value: CommonPublicKeyAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CommonPublicKeyAttributes) { _cached_encoder_for_CommonPublicKeyAttributes = function (value: CommonPublicKeyAttributes, elGetter: $.ASN1Encoder<CommonPublicKeyAttributes>): _Element {
