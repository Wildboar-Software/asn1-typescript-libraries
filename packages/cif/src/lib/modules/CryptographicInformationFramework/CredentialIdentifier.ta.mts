...
class CredentialIdentifier {
     ...
     */
    public static _from_object (_o: { [_K in keyof (CredentialIdentifier)]: (CredentialIdentifier)[_K] }): CredentialIdentifier {
 ...
 */
export
const _root_component_type_list_1_spec_for_CredentialIdentifier: $.ComponentSpec[] = [
    new $.ComponentSpec("idType", false, $.hasTag(_TagClass.universal, 2)),
 ...
 */
export
const _root_component_type_list_2_spec_for_CredentialIdentifier: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_CredentialIdentifier: $.ComponentSpec[] = [
 ...
 */
export
function _decode_CredentialIdentifier (el: _Element): CredentialIdentifier {
    if (!_cached_decoder_for_CredentialIdentifier) { _cached_decoder_for_CredentialIdentifier = function (el: _Element): CredentialIdentifier {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("CredentialIdentifier contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_CredentialIdentifier (value: CredentialIdentifier, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CredentialIdentifier) { _cached_encoder_for_CredentialIdentifier = function (value: CredentialIdentifier, elGetter: $.ASN1Encoder<CredentialIdentifier>): _Element {
