 ...
 */
export
type KeyDerivationMethod = OBJECT_IDENTIFIER; // ObjectIdentifierType
 ...
 */
export
function _decode_KeyDerivationMethod (el: _Element): KeyDerivationMethod {
    if (!_cached_decoder_for_KeyDerivationMethod) { _cached_decoder_for_KeyDerivationMethod = $._decodeObjectIdentifier; }
 ...
 */
export
function _encode_KeyDerivationMethod (value: KeyDerivationMethod, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_KeyDerivationMethod) { _cached_encoder_for_KeyDerivationMethod = $._encodeObjectIdentifier; }
