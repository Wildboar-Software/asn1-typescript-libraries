...
import { dhHybrid2 } from "../ANSI-X9-42/dhHybrid2.va.mjs";
// export { dhHybrid2 } from "../ANSI-X9-42/dhHybrid2.va.mjs";
 ...
 */
export
const Schemes_Union4_Intersection0_Element: KEY_AGREEMENT<SchemeParameters> = {
    class: "ALGORITHM-ID",
    decoderFor: {
