 ...
 */
export
type Counter = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_Counter (el: _Element): Counter {
    if (!_cached_decoder_for_Counter) { _cached_decoder_for_Counter = $._decodeOctetString; }
 ...
 */
export
function _encode_Counter (value: Counter, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Counter) { _cached_encoder_for_Counter = $._encodeOctetString; }
