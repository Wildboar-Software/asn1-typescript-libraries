 ...
 */
export
type DiffieHellmanPublicNumber = INTEGER;
 ...
 */
export
function _decode_DiffieHellmanPublicNumber (el: _Element): DiffieHellmanPublicNumber {
    if (!_cached_decoder_for_DiffieHellmanPublicNumber) { _cached_decoder_for_DiffieHellmanPublicNumber = $._decodeInteger; }
 ...
 */
export
function _encode_DiffieHellmanPublicNumber (value: DiffieHellmanPublicNumber, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DiffieHellmanPublicNumber) { _cached_encoder_for_DiffieHellmanPublicNumber = $._encodeInteger; }
