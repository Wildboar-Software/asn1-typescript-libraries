...
import { Counter, _decode_Counter, _encode_Counter } from "../ANSI-X9-42/Counter.ta.mjs";
// export { Counter, _decode_Counter, _encode_Counter } from "../ANSI-X9-42/Counter.ta.mjs";
 ...
 */
export
const KeySpecificAlgorithms_Union0_Intersection0_Element: ALGORITHM_ID<Counter> = {
    class: "ALGORITHM-ID",
    decoderFor: {
