...
import { BaseDistance, _decode_BaseDistance, _encode_BaseDistance } from "../AttributeCertificateDefinitions/BaseDistance.ta.mjs";
// export { BaseDistance, _decode_BaseDistance, _encode_BaseDistance } from "../AttributeCertificateDefinitions/BaseDistance.ta.mjs";
...
class GeneralSubtree {
    ...
    public static _from_object (_o: { [_K in keyof (GeneralSubtree)]: (GeneralSubtree)[_K] }): GeneralSubtree {
        return new GeneralSubtree(_o.base, _o.minimum, _o.maximum, _o._unrecognizedExtensionsList);
    }
