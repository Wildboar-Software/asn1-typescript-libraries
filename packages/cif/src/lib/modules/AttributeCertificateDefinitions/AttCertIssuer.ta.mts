...
class AttCertIssuer {
     ...
     */
    public static _from_object (_o: { [_K in keyof (AttCertIssuer)]: (AttCertIssuer)[_K] }): AttCertIssuer {
 ...
 */
export
const _root_component_type_list_1_spec_for_AttCertIssuer: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_AttCertIssuer: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AttCertIssuer: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AttCertIssuer (el: _Element): AttCertIssuer {
    if (!_cached_decoder_for_AttCertIssuer) { _cached_decoder_for_AttCertIssuer = $._decode_implicit<AttCertIssuer>(() => function (el: _Element): AttCertIssuer {
 ...
 */
export
function _encode_AttCertIssuer (value: AttCertIssuer, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AttCertIssuer) { _cached_encoder_for_AttCertIssuer = $._encode_implicit(_TagClass.context, 0, () => function (value: AttCertIssuer, elGetter: $.ASN1Encoder<AttCertIssuer>): _Element {
