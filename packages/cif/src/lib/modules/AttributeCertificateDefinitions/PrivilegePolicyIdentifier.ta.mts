 ...
 */
export
class PrivilegePolicyIdentifier {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (PrivilegePolicyIdentifier)]: (PrivilegePolicyIdentifier)[_K] }): PrivilegePolicyIdentifier {
        return new PrivilegePolicyIdentifier(_o.privilegePolicy, _o.privPolSyntax, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_PrivilegePolicyIdentifier: $.ComponentSpec[] = [
    new $.ComponentSpec("privilegePolicy", false, $.hasTag(_TagClass.universal, 6)),
    new $.ComponentSpec("privPolSyntax", false, $.hasAnyTag)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_PrivilegePolicyIdentifier: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PrivilegePolicyIdentifier: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PrivilegePolicyIdentifier (el: _Element): PrivilegePolicyIdentifier {
    if (!_cached_decoder_for_PrivilegePolicyIdentifier) { _cached_decoder_for_PrivilegePolicyIdentifier = function (el: _Element): PrivilegePolicyIdentifier {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("PrivilegePolicyIdentifier contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_PrivilegePolicyIdentifier (value: PrivilegePolicyIdentifier, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PrivilegePolicyIdentifier) { _cached_encoder_for_PrivilegePolicyIdentifier = function (value: PrivilegePolicyIdentifier, elGetter: $.ASN1Encoder<PrivilegePolicyIdentifier>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_PrivilegePolicy(value.privilegePolicy, $.BER),
            /* REQUIRED   */ _encode_InfoSyntax(value.privPolSyntax, $.BER)
        ],
