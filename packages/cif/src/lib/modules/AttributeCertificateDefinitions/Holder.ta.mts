...
class Holder {
     ...
     * @returns {Holder}
     */
    public static _from_object (_o: { [_K in keyof (Holder)]: (Holder)[_K] }): Holder {
 ...
 */
export
const _root_component_type_list_1_spec_for_Holder: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_Holder: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_Holder: $.ComponentSpec[] = [
 ...
 */
export
function _decode_Holder (el: _Element): Holder {
    if (!_cached_decoder_for_Holder) { _cached_decoder_for_Holder = function (el: _Element): Holder {
 ...
 */
export
function _encode_Holder (value: Holder, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Holder) { _cached_encoder_for_Holder = function (value: Holder, elGetter: $.ASN1Encoder<Holder>): _Element {
