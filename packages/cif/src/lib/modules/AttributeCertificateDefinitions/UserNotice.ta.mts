...
import { NoticeReference, _decode_NoticeReference, _encode_NoticeReference } from "../AttributeCertificateDefinitions/NoticeReference.ta.mjs";
// export { NoticeReference, _decode_NoticeReference, _encode_NoticeReference } from "../AttributeCertificateDefinitions/NoticeReference.ta.mjs";
import { DisplayText, _decode_DisplayText, _encode_DisplayText } from "../AttributeCertificateDefinitions/DisplayText.ta.mjs";
// export { DisplayText, _decode_DisplayText, _encode_DisplayText } from "../AttributeCertificateDefinitions/DisplayText.ta.mjs";
...
const _root_component_type_list_1_spec_for_UserNotice: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("explicitText", true, $.or($.hasTag(_TagClass.universal, 26), $.hasTag(_TagClass.universal, 30), $.hasTag(_TagClass.universal, 12)))
];
