...
class AttributeCertificateExactAssertion {
     ...
     */
    public static _from_object (_o: { [_K in keyof (AttributeCertificateExactAssertion)]: (AttributeCertificateExactAssertion)[_K] }): AttributeCertificateExactAssertion {
        return new AttributeCertificateExactAssertion(_o.serialNumber, _o.issuer, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_AttributeCertificateExactAssertion: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_AttributeCertificateExactAssertion: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AttributeCertificateExactAssertion: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AttributeCertificateExactAssertion (el: _Element): AttributeCertificateExactAssertion {
    if (!_cached_decoder_for_AttributeCertificateExactAssertion) { _cached_decoder_for_AttributeCertificateExactAssertion = function (el: _Element): AttributeCertificateExactAssertion {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("AttributeCertificateExactAssertion contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_AttributeCertificateExactAssertion (value: AttributeCertificateExactAssertion, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AttributeCertificateExactAssertion) { _cached_encoder_for_AttributeCertificateExactAssertion = function (value: AttributeCertificateExactAssertion, elGetter: $.ASN1Encoder<AttributeCertificateExactAssertion>): _Element {
    ...
    return _cached_encoder_for_AttributeCertificateExactAssertion(value, elGetter);
}
