 ...
 */
export
const roleSpecCertIdentifier: EXTENSION<RoleSpecCertIdentifierSyntax> = {
    class: "EXTENSION",
    decoderFor: {
    ...
    "&id": _OID.fromParts([id_ce_roleSpecCertIdentifier,]) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
