...
// export { id_mr_attDescriptorMatch } from "../AttributeCertificateDefinitions/id-mr-attDescriptorMatch.va.mjs";
 ...
 */
export
const attDescriptor: MATCHING_RULE<AttributeDescriptorSyntax> = {
    class: "MATCHING-RULE",
    decoderFor: {
