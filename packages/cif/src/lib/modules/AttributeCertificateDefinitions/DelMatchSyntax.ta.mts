...
class DelMatchSyntax {
     ...
     */
    public static _from_object (_o: { [_K in keyof (DelMatchSyntax)]: (DelMatchSyntax)[_K] }): DelMatchSyntax {
        return new DelMatchSyntax(_o.firstIssuer, _o.lastHolder, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_DelMatchSyntax: $.ComponentSpec[] = [
    new $.ComponentSpec("firstIssuer", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("lastHolder", false, $.hasTag(_TagClass.universal, 16))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_DelMatchSyntax: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_DelMatchSyntax: $.ComponentSpec[] = [
 ...
 */
export
function _decode_DelMatchSyntax (el: _Element): DelMatchSyntax {
    if (!_cached_decoder_for_DelMatchSyntax) { _cached_decoder_for_DelMatchSyntax = function (el: _Element): DelMatchSyntax {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("DelMatchSyntax contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_DelMatchSyntax (value: DelMatchSyntax, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DelMatchSyntax) { _cached_encoder_for_DelMatchSyntax = function (value: DelMatchSyntax, elGetter: $.ASN1Encoder<DelMatchSyntax>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_AttCertIssuer(value.firstIssuer, $.BER),
            /* REQUIRED   */ _encode_Holder(value.lastHolder, $.BER)
        ],
