 ...
 */
export
type PrivilegePolicy = OBJECT_IDENTIFIER; // ObjectIdentifierType
 ...
 */
export
function _decode_PrivilegePolicy (el: _Element): PrivilegePolicy {
    if (!_cached_decoder_for_PrivilegePolicy) { _cached_decoder_for_PrivilegePolicy = $._decodeObjectIdentifier; }
 ...
 */
export
function _encode_PrivilegePolicy (value: PrivilegePolicy, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PrivilegePolicy) { _cached_encoder_for_PrivilegePolicy = $._encodeObjectIdentifier; }
