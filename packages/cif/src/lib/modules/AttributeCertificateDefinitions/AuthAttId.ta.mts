 ...
 */
export
function _decode_AuthAttId (el: _Element): AuthAttId {
    if (!_cached_decoder_for_AuthAttId) { _cached_decoder_for_AuthAttId = _decode_IssuerSerial; }
 ...
 */
export
function _encode_AuthAttId (value: AuthAttId, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AuthAttId) { _cached_encoder_for_AuthAttId = _encode_IssuerSerial; }
