...
import { DelMatchSyntax, _decode_DelMatchSyntax, _encode_DelMatchSyntax } from "../AttributeCertificateDefinitions/DelMatchSyntax.ta.mjs";
// export { DelMatchSyntax, _decode_DelMatchSyntax, _encode_DelMatchSyntax } from "../AttributeCertificateDefinitions/DelMatchSyntax.ta.mjs";
 ...
 */
export
const delegationPathMatch: MATCHING_RULE<DelMatchSyntax> = {
    class: "MATCHING-RULE",
    decoderFor: {
