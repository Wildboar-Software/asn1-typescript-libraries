 ...
 */
export
type AttributeDescription = UTF8String; // UTF8String
...
function _decode_AttributeDescription (el: _Element): AttributeDescription {
    if (!_cached_decoder_for_AttributeDescription) { _cached_decoder_for_AttributeDescription = $._decodeUTF8String; }
...
function _encode_AttributeDescription (value: AttributeDescription, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AttributeDescription) { _cached_encoder_for_AttributeDescription = $._encodeUTF8String; }
