 ...
 */
export
const eeAttrCertificateRevocationList: ATTRIBUTE<CertificateList> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "EEAttrCertificateRevocationList" ] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "X.509 EEAttr certificate revocation list" /* OBJECT_FIELD_SETTING */,
