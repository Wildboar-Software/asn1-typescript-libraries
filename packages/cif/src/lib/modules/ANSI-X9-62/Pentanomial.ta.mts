...
class Pentanomial {
     ...
     * @returns {Pentanomial}
     */
    public static _from_object (_o: { [_K in keyof (Pentanomial)]: (Pentanomial)[_K] }): Pentanomial {
 ...
 */
export
const _root_component_type_list_1_spec_for_Pentanomial: $.ComponentSpec[] = [
    new $.ComponentSpec("k1", false, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("k2", false, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("k3", false, $.hasTag(_TagClass.universal, 2))
];
...
function _decode_Pentanomial (el: _Element): Pentanomial {
    ...
    if (sequence.length < 3) {
        throw new _ConstructionError("Pentanomial contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "k1";
    sequence[1].name = "k2";
    sequence[2].name = "k3";
 ...
 */
export
function _encode_Pentanomial (value: Pentanomial, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Pentanomial) { _cached_encoder_for_Pentanomial = function (value: Pentanomial, elGetter: $.ASN1Encoder<Pentanomial>): _Element {
