...
import { ECParameters_version, ECParameters_version_ecpVerl /* IMPORTED_LONG_NAMED_INTEGER */, ecpVerl /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_ECParameters_version, _encode_ECParameters_version } from "../ANSI-X9-62/ECParameters-version.ta.mjs";
// export { ECParameters_version, ECParameters_version_ecpVerl /* IMPORTED_LONG_NAMED_INTEGER */, ecpVerl /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_ECParameters_version, _encode_ECParameters_version } from "../ANSI-X9-62/ECParameters-version.ta.mjs";
import { FieldID, _decode_FieldID, _encode_FieldID } from "../ANSI-X9-62/FieldID.ta.mjs";
// export { FieldID, _decode_FieldID, _encode_FieldID } from "../ANSI-X9-62/FieldID.ta.mjs";
...
class ECParameters {
     ...
     */
    public static _from_object (_o: { [_K in keyof (ECParameters)]: (ECParameters)[_K] }): ECParameters {
        return new ECParameters(_o.version, _o.fieldID, _o.curve, _o.base, _o.order, _o.cofactor, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ECParameters: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ECParameters: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ECParameters: $.ComponentSpec[] = [
...
function _decode_ECParameters (el: _Element): ECParameters {
    if (!_cached_decoder_for_ECParameters) { _cached_decoder_for_ECParameters = function (el: _Element): ECParameters {
    ...
    const callbacks: $.DecodingMap = {
        "version": (_el: _Element): void => { version = _decode_ECParameters_version(_el); },
 ...
 */
export
function _encode_ECParameters (value: ECParameters, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ECParameters) { _cached_encoder_for_ECParameters = function (value: ECParameters, elGetter: $.ASN1Encoder<ECParameters>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ECParameters_version(value.version, $.BER),
