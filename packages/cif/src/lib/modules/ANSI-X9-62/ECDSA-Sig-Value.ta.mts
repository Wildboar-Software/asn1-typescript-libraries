...
function _decode_ECDSA_Sig_Value (el: _Element): ECDSA_Sig_Value {
    ...
    if (sequence.length < 2) {
        throw new _ConstructionError("ECDSA-Sig-Value contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "r";
    sequence[1].name = "s";
    let r!: INTEGER;
 ...
 */
export
function _encode_ECDSA_Sig_Value (value: ECDSA_Sig_Value, elGetter: $.ASN1Encoder<any>): _Element {
