 ...
 */
export
function _decode_FieldElement (el: _Element): FieldElement {
    if (!_cached_decoder_for_FieldElement) { _cached_decoder_for_FieldElement = $._decodeOctetString; }
 ...
 */
export
function _encode_FieldElement (value: FieldElement, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FieldElement) { _cached_encoder_for_FieldElement = $._encodeOctetString; }
