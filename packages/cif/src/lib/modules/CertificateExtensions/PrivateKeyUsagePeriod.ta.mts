...
class PrivateKeyUsagePeriod {
     ...
     */
    public static _from_object (_o: { [_K in keyof (PrivateKeyUsagePeriod)]: (PrivateKeyUsagePeriod)[_K] }): PrivateKeyUsagePeriod {
        return new PrivateKeyUsagePeriod(_o.notBefore, _o.notAfter, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_PrivateKeyUsagePeriod: $.ComponentSpec[] = [
    new $.ComponentSpec("notBefore", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("notAfter", true, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_PrivateKeyUsagePeriod: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PrivateKeyUsagePeriod: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PrivateKeyUsagePeriod (el: _Element): PrivateKeyUsagePeriod {
    if (!_cached_decoder_for_PrivateKeyUsagePeriod) { _cached_decoder_for_PrivateKeyUsagePeriod = function (el: _Element): PrivateKeyUsagePeriod {
    let notBefore: OPTIONAL<GeneralizedTime>;
    let notAfter: OPTIONAL<GeneralizedTime>;
    let _unrecognizedExtensionsList: _Element[] = [];
    const callbacks: $.DecodingMap = {
        "notBefore": (_el: _Element): void => { notBefore = $._decode_implicit<GeneralizedTime>(() => $._decodeGeneralizedTime)(_el); },
        "notAfter": (_el: _Element): void => { notAfter = $._decode_implicit<GeneralizedTime>(() => $._decodeGeneralizedTime)(_el); }
    };
...
function _encode_PrivateKeyUsagePeriod (value: PrivateKeyUsagePeriod, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.notAfter === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => $._encodeGeneralizedTime, $.BER)(value.notAfter, $.BER))
        ],
