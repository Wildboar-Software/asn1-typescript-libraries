 ...
 */
export
const certificateListExactMatch: MATCHING_RULE<CertificateListExactAssertion> = {
    class: "MATCHING-RULE",
    decoderFor: {
    ...
    "&ldapName": [ "certificateListExactMatch" ] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "X.509 Certificate List Exact Match" /* OBJECT_FIELD_SETTING */,
