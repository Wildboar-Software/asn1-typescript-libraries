...
import { AltName, _decode_AltName, _encode_AltName } from "../CertificateExtensions/AltName.ta.mjs";
// export { AltName, _decode_AltName, _encode_AltName } from "../CertificateExtensions/AltName.ta.mjs";
...
class EnhancedCertificateAssertion {
     ...
     */
    public static _from_object (_o: { [_K in keyof (EnhancedCertificateAssertion)]: (EnhancedCertificateAssertion)[_K] }): EnhancedCertificateAssertion {
        return new EnhancedCertificateAssertion(_o.serialNumber, _o.issuer, _o.subjectKeyIdentifier, _o.authorityKeyIdentifier, _o.certificateValid, _o.privateKeyValid, _o.subjectPublicKeyAlgID, _o.keyUsage, _o.subjectAltName, _o.policy, _o.pathToName, _o.subject, _o.nameConstraints, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_EnhancedCertificateAssertion: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("pathToName", true, $.hasTag(_TagClass.context, 10)),
 ...
 */
export
const _root_component_type_list_2_spec_for_EnhancedCertificateAssertion: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_EnhancedCertificateAssertion: $.ComponentSpec[] = [
 ...
 */
export
function _decode_EnhancedCertificateAssertion (el: _Element): EnhancedCertificateAssertion {
    if (!_cached_decoder_for_EnhancedCertificateAssertion) { _cached_decoder_for_EnhancedCertificateAssertion = function (el: _Element): EnhancedCertificateAssertion {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "subjectAltName": (_el: _Element): void => { subjectAltName = $._decode_implicit<AltName>(() => _decode_AltName)(_el); },
        "policy": (_el: _Element): void => { policy = $._decode_implicit<CertPolicySet>(() => _decode_CertPolicySet)(_el); },
        "pathToName": (_el: _Element): void => { pathToName = $._decode_implicit<GeneralNames>(() => _decode_GeneralNames)(_el); },
 ...
 */
export
function _encode_EnhancedCertificateAssertion (value: EnhancedCertificateAssertion, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EnhancedCertificateAssertion) { _cached_encoder_for_EnhancedCertificateAssertion = function (value: EnhancedCertificateAssertion, elGetter: $.ASN1Encoder<EnhancedCertificateAssertion>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.issuer === undefined) ? undefined : $._encode_explicit(_TagClass.context, 1, () => _encode_Name, $.BER)(value.issuer, $.BER)),
            ...
            /* IF_ABSENT  */ ((value.subjectAltName === undefined) ? undefined : $._encode_implicit(_TagClass.context, 8, () => _encode_AltName, $.BER)(value.subjectAltName, $.BER)),
            ...
            /* IF_ABSENT  */ ((value.pathToName === undefined) ? undefined : $._encode_implicit(_TagClass.context, 10, () => _encode_GeneralNames, $.BER)(value.pathToName, $.BER)),
            /* IF_ABSENT  */ ((value.subject === undefined) ? undefined : $._encode_explicit(_TagClass.context, 11, () => _encode_Name, $.BER)(value.subject, $.BER)),
