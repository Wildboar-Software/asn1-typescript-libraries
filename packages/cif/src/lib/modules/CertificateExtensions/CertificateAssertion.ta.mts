...
function _decode_CertificateAssertion (el: _Element): CertificateAssertion {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "pathToName": (_el: _Element): void => { pathToName = $._decode_explicit<Name>(() => _decode_Name)(_el); },
...
function _encode_CertificateAssertion (value: CertificateAssertion, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.pathToName === undefined) ? undefined : $._encode_explicit(_TagClass.context, 10, () => _encode_Name, $.BER)(value.pathToName, $.BER)),
