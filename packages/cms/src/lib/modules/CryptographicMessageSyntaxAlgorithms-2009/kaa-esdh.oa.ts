...
import { id_alg_ESDH } from "../CryptographicMessageSyntaxAlgorithms-2009/id-alg-ESDH.va";
import {
    KeyWrapAlgorithm,
...
export { id_alg_ESDH } from "../CryptographicMessageSyntaxAlgorithms-2009/id-alg-ESDH.va";
export {
    KeyWrapAlgorithm,
    _decode_KeyWrapAlgorithm,
    _encode_KeyWrapAlgorithm,
