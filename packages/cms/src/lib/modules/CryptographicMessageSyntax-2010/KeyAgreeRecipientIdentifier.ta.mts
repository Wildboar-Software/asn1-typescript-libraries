 ...
 * @description
 *
 * CHOICE identifying a key-agreement recipient by issuer+serial or
 * `RecipientKeyIdentifier` ([RFC 5652 §6.2.2](https://datatracker.ietf.org/doc/html/rfc5652#section-6.2.2)).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
