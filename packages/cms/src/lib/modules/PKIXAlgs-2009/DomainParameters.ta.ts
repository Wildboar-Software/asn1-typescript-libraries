...
} from "../PKIXAlgs-2009/ValidationParams.ta.js";
export {
    ValidationParams,
    _decode_ValidationParams,
    _encode_ValidationParams,
...
export class DomainParameters {
    constructor(
         ...
         * @readonly
         */
        readonly validationParams: OPTIONAL<ValidationParams>
    ) {}
...
export function _decode_DomainParameters(el: _Element) {
    if (!_cached_decoder_for_DomainParameters) {
        _cached_decoder_for_DomainParameters = function (
            ...
            let validationParams: OPTIONAL<ValidationParams>;
            ...
            const callbacks: $.DecodingMap = {
                ...
                validationParams: (_el: _Element): void => {
