...
import { ecdsa_with_SHA512 } from "../PKIXAlgs-2009/ecdsa-with-SHA512.va.mjs";
 ...
 * @description
 *
 * SIGNATURE-ALGORITHM for ECDSA-with-SHA-512 ([RFC 5758 §3.2](https://datatracker.ietf.org/doc/html/rfc5758#section-3.2)).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
