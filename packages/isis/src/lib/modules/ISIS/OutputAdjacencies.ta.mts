 ...
 * @description
 *
 * Set of local distinguished names of Adjacency or Reachable Address managed
 * objects that are the forwarding next hops for a destination under a given
 * metric.
 *
 * (ISO/IEC 10589:2002 clauses 11.2.9 and 11.3.1).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
