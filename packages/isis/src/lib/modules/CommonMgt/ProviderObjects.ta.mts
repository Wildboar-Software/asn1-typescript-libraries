 ...
 * @description
 *
 * Set of local distinguished names of provider-side objects (`localSapNames`,
 * `providerEntityNames`, `underlyingConnectionNames`). Only the
 * localDistinguishedName form of ObjectInstance is used.
 *
