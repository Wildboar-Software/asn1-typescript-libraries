 ...
 */
export function _decode_AdditionalText(el: _Element) {
    if (!_cached_decoder_for_AdditionalText) {
        _cached_decoder_for_AdditionalText = $._decodeGraphicString;
    }
 ...
 */
export function _encode_AdditionalText(
    value: AdditionalText,
    elGetter: $.ASN1Encoder<AdditionalText>
) {
    if (!_cached_encoder_for_AdditionalText) {
        _cached_encoder_for_AdditionalText = $._encodeGraphicString;
    }
