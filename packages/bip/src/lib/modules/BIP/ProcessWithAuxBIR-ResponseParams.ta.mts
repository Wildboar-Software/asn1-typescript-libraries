 ...
 * @description
 *
 * Parameters of a `processWithAuxBIR` response BIP message
 * (slave→master) for `BioAPI_ProcessWithAuxBIR`. Maps to
 * BioAPI `ProcessedBIR` via clause 20. X.1083 §16.33.6.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
