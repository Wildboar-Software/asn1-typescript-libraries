 ...
 * added on init/link, local or remote `RegisterBSP`, or
 * `bspRegistrationEvent`; deleted on unregister, matching
 * registration-with-update, or deletion of the hosting
 * `VisibleEndpoints` row. ITU-T Rec. X.1083 (11/2007)
 ...
 */
export function _decode_VisibleBSPRegistrations(el: _Element): VisibleBSPRegistrations {
