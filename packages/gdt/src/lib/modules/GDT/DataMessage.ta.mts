...
class DataMessage {
     ...
     * @returns {DataMessage}
     */
    public static _from_object (_o: { [_K in keyof (DataMessage)]: (DataMessage)[_K] }): DataMessage {
        return new DataMessage(_o.payload_type, _o.payload, _o.params, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_DataMessage: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_DataMessage: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_DataMessage: $.ComponentSpec[] = [
 ...
 */
export
function _decode_DataMessage (el: _Element): DataMessage {
    if (!_cached_decoder_for_DataMessage) { _cached_decoder_for_DataMessage = function (el: _Element): DataMessage {
 ...
 */
export
function _encode_DataMessage (value: DataMessage, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DataMessage) { _cached_encoder_for_DataMessage = function (value: DataMessage, elGetter: $.ASN1Encoder<DataMessage>): _Element {
