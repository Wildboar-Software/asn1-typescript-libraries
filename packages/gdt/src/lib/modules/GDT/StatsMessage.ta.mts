...
import { StatsAction, StatsAction_sa_request /* IMPORTED_LONG_NAMED_INTEGER */, sa_request /* IMPORTED_SHORT_NAMED_INTEGER */, StatsAction_sa_result /* IMPORTED_LONG_NAMED_INTEGER */, sa_result /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_StatsAction, _encode_StatsAction } from "../GDT/StatsAction.ta.mjs";
