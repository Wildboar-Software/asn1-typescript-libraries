...
import { AuthAction, AuthAction_aa_auth_request /* IMPORTED_LONG_NAMED_INTEGER */, aa_auth_request /* IMPORTED_SHORT_NAMED_INTEGER */, AuthAction_aa_auth_result /* IMPORTED_LONG_NAMED_INTEGER */, aa_auth_result /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_AuthAction, _encode_AuthAction } from "../GDT/AuthAction.ta.mjs";
