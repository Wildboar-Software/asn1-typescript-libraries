 ...
 * 
 * ```asn1
 * V8bisDiag-Item-cLR ::= SEQUENCE {cLRSequence  V59String}
 * ```
 * 
 * @class
 */
...
const _root_component_type_list_1_spec_for_V8bisDiag_Item_cLR: $.ComponentSpec[] = [
    new $.ComponentSpec("cLRSequence", false, $.hasTag(_TagClass.context, 0))
];
...
function _encode_V8bisDiag_Item_cLR (value: V8bisDiag_Item_cLR, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_V8bisDiag_Item_cLR) { _cached_encoder_for_V8bisDiag_Item_cLR = function (value: V8bisDiag_Item_cLR): _Element {
