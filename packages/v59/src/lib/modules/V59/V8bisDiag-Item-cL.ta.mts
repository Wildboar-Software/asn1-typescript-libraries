 ...
 * @description
 *
 * CL exchanged sequence. ITU-T Rec. V.59 (11/2000) §6.8.2.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class V8bisDiag_Item_cL {
    constructor (
         ...
         * @description
         *
         * CL sequence transmitted or received. Hex `dataSequence` (§6.2.2):
         * first bit in time is the LSB of each hex word; omit start/stop/fill
         * bits and CRCs; `;` delimits N-bit words. Tag-ID `0806`. ITU-T Rec.
         * V.59 (11/2000) §6.8.2.
         * @public
         * @readonly
         */
