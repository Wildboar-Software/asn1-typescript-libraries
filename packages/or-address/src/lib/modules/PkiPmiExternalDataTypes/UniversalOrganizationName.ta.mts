 ...
 * @description
 *
 * `UniversalOrganizationName`. An organization-name is a standard attribute that
 * identifies an organization. The value of an organization-name is a Printable String,
