 ...
 * @description
 *
 * `UniversalPhysicalDeliveryOrganizationName`. An organization-name is a standard
 * attribute that identifies an organization. The value of an organization-name is a
 * Printable String, Teletex String, Universal String, or a combination of these types.
 * See ITU-T X.402 (1999), §18.3.9.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
