 ...
 *     reserved103 [103] BOOLEAN OPTIONAL -- Tag '9F67' reserved for SGP.32 [97]
 * }
 * ```
 * 
 * @class
...
class UpdateMetadataRequest {
    ...
    public static _from_object (_o: { [_K in keyof (UpdateMetadataRequest)]: (UpdateMetadataRequest)[_K] }): UpdateMetadataRequest {
        return new UpdateMetadataRequest(_o.serviceProviderName, _o.profileName, _o.iconType, _o.icon, _o.profilePolicyRules, _o.serviceSpecificDataStoredInEuicc, _o.reserved103);
    }
...
const _root_component_type_list_1_spec_for_UpdateMetadataRequest: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("reserved103", true, $.hasTag(_TagClass.context, 103))
];
...
function _decode_UpdateMetadataRequest (el: _Element): UpdateMetadataRequest {
    ...
    let reserved103: OPTIONAL<BOOLEAN>;
    const callbacks: $.DecodingMap = {
        ...
        "reserved103": (_el: _Element): void => { reserved103 = $._decode_implicit<BOOLEAN>(() => $._decodeBoolean)(_el); }
    };
...
function _encode_UpdateMetadataRequest (value: UpdateMetadataRequest, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.reserved103 === undefined) ? undefined : $._encode_implicit(_TagClass.context, 103, () => $._encodeBoolean, $.BER)(value.reserved103, $.BER))
        ],
