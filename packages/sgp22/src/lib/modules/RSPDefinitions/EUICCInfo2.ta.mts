...
import { IoTSpecificInfo, _decode_IoTSpecificInfo, _encode_IoTSpecificInfo } from "../RSPDefinitions/IoTSpecificInfo.ta.mjs";
// export { IoTSpecificInfo, _decode_IoTSpecificInfo, _encode_IoTSpecificInfo } from "../RSPDefinitions/IoTSpecificInfo.ta.mjs";
 ...
 *     lpaMode [16] LpaMode OPTIONAL, -- not used by this version of SGP.22
 *     euiccCiPKIdListForSigningV3 [17] SEQUENCE OF SubjectKeyIdentifier OPTIONAL, -- not used by this version of SGP.22
 *     additionalEuiccInfo [18] OCTET STRING (SIZE(0..32)) OPTIONAL,    -- not used by this version of SGP.22
 *     highestSvn [19] VersionType OPTIONAL, -- not used by this version of SGP.22 
...
class EUICCInfo2 {
    constructor (
         ...
         * @readonly
         */
        readonly lpaMode: OPTIONAL<LpaMode>,
        /**
...
const _root_component_type_list_1_spec_for_EUICCInfo2: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("uiccCapability", false, $.hasTag(_TagClass.context, 5)),
    ...
    new $.ComponentSpec("lpaMode", true, $.hasTag(_TagClass.context, 16)),
