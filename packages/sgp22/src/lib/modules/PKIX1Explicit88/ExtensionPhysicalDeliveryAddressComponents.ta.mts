 ...
 */
export
function _decode_ExtensionPhysicalDeliveryAddressComponents (el: _Element): ExtensionPhysicalDeliveryAddressComponents {
    if (!_cached_decoder_for_ExtensionPhysicalDeliveryAddressComponents) { _cached_decoder_for_ExtensionPhysicalDeliveryAddressComponents = _decode_PDSParameter; }
 ...
 */
export
function _encode_ExtensionPhysicalDeliveryAddressComponents (value: ExtensionPhysicalDeliveryAddressComponents, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ExtensionPhysicalDeliveryAddressComponents) { _cached_encoder_for_ExtensionPhysicalDeliveryAddressComponents = _encode_PDSParameter; }
    return _cached_encoder_for_ExtensionPhysicalDeliveryAddressComponents(value, elGetter);
}
