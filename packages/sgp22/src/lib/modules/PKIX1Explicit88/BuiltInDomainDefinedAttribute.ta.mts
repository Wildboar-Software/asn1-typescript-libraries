...
class BuiltInDomainDefinedAttribute {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BuiltInDomainDefinedAttribute)]: (BuiltInDomainDefinedAttribute)[_K] }): BuiltInDomainDefinedAttribute {
 ...
 */
export
const _root_component_type_list_1_spec_for_BuiltInDomainDefinedAttribute: $.ComponentSpec[] = [
    new $.ComponentSpec("type", false, $.hasTag(_TagClass.universal, 19)),
    new $.ComponentSpec("value", false, $.hasTag(_TagClass.universal, 19))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BuiltInDomainDefinedAttribute: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BuiltInDomainDefinedAttribute: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BuiltInDomainDefinedAttribute (el: _Element): BuiltInDomainDefinedAttribute {
    if (!_cached_decoder_for_BuiltInDomainDefinedAttribute) { _cached_decoder_for_BuiltInDomainDefinedAttribute = function (el: _Element): BuiltInDomainDefinedAttribute {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BuiltInDomainDefinedAttribute contained only " + sequence.length.toString() + " elements.");
    }
...
function _encode_BuiltInDomainDefinedAttribute (value: BuiltInDomainDefinedAttribute, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ $._encodePrintableString(value.value, $.BER)
        ],
