 ...
 */
export
function _decode_OrganizationalUnitName (el: _Element): OrganizationalUnitName {
    if (!_cached_decoder_for_OrganizationalUnitName) { _cached_decoder_for_OrganizationalUnitName = $._decodePrintableString; }
 ...
 */
export
function _encode_OrganizationalUnitName (value: OrganizationalUnitName, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_OrganizationalUnitName) { _cached_encoder_for_OrganizationalUnitName = $._encodePrintableString; }
