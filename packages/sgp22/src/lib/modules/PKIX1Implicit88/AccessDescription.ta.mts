...
class AccessDescription {
     ...
     */
    public static _from_object (_o: { [_K in keyof (AccessDescription)]: (AccessDescription)[_K] }): AccessDescription {
 ...
 */
export
const _root_component_type_list_1_spec_for_AccessDescription: $.ComponentSpec[] = [
    new $.ComponentSpec("accessMethod", false, $.hasTag(_TagClass.universal, 6)),
    new $.ComponentSpec("accessLocation", false, $.hasAnyTag)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_AccessDescription: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AccessDescription: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AccessDescription (el: _Element): AccessDescription {
    if (!_cached_decoder_for_AccessDescription) { _cached_decoder_for_AccessDescription = function (el: _Element): AccessDescription {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("AccessDescription contained only " + sequence.length.toString() + " elements.");
    }
...
function _encode_AccessDescription (value: AccessDescription, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ _encode_GeneralName(value.accessLocation, $.BER)
        ],
