...
import { id_att_dfr_previous_versions } from "../DFRObjectIdentifiers/id-att-dfr-previous-versions.va.mjs";
// export { id_att_dfr_previous_versions } from "../DFRObjectIdentifiers/id-att-dfr-previous-versions.va.mjs";
 ...
 */
export
const dfr_previous_versions: ATTRIBUTE<DfrUniquePermanentIdentifier> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_dfr_previous_versions /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
