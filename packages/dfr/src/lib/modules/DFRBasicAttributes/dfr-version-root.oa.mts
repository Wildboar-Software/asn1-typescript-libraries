...
import { id_att_dfr_version_root } from "../DFRObjectIdentifiers/id-att-dfr-version-root.va.mjs";
// export { id_att_dfr_version_root } from "../DFRObjectIdentifiers/id-att-dfr-version-root.va.mjs";
import {
    octetStringMatch,
 ...
 */
export
const dfr_version_root: ATTRIBUTE<DfrUniquePermanentIdentifier> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_dfr_version_root /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
