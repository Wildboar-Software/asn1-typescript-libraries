...
import { id_att_document_date_and_time } from "../DFRObjectIdentifiers/id-att-document-date-and-time.va.mjs";
// export { id_att_document_date_and_time } from "../DFRObjectIdentifiers/id-att-document-date-and-time.va.mjs";
import {
 ...
 */
export
const document_date_and_time: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_document_date_and_time /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
