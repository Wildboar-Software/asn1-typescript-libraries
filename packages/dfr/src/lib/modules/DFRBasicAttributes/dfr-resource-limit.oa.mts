...
import { id_att_dfr_resource_limit } from "../DFRObjectIdentifiers/id-att-dfr-resource-limit.va.mjs";
// export { id_att_dfr_resource_limit } from "../DFRObjectIdentifiers/id-att-dfr-resource-limit.va.mjs";
 ...
 */
export
const dfr_resource_limit: ATTRIBUTE<INTEGER> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": $._decodeInteger,
    },
    ...
    "&id": id_att_dfr_resource_limit /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
