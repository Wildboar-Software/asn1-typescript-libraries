...
import { id_att_dfr_external_location } from "../DFRObjectIdentifiers/id-att-dfr-external-location.va.mjs";
// export { id_att_dfr_external_location } from "../DFRObjectIdentifiers/id-att-dfr-external-location.va.mjs";
 ...
 */
export
const dfr_external_location: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_dfr_external_location /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
