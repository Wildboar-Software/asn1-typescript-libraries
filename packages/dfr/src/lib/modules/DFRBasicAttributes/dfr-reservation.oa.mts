...
import { id_att_dfr_reservation } from "../DFRObjectIdentifiers/id-att-dfr-reservation.va.mjs";
// export { id_att_dfr_reservation } from "../DFRObjectIdentifiers/id-att-dfr-reservation.va.mjs";
 ...
 * 
 * @constant
 * @type {ATTRIBUTE<Reservation>}
 * @implements {ATTRIBUTE<Reservation>}
 */
export
const dfr_reservation: ATTRIBUTE<Reservation> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Reservation,
    },
    encoderFor: {
        "&Type": _encode_Reservation,
    },
    "&single-valued": true /* OBJECT_FIELD_SETTING */,
    "&id": id_att_dfr_reservation /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
