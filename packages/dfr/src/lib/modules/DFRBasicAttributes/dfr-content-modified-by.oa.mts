...
import { id_att_dfr_content_modified_by } from "../DFRObjectIdentifiers/id-att-dfr-content-modified-by.va.mjs";
// export { id_att_dfr_content_modified_by } from "../DFRObjectIdentifiers/id-att-dfr-content-modified-by.va.mjs";


/**
 * @summary dfr_content_modified_by
 * @description
 *
 * User who last modified content. Extended-read only. Not copied by Copy.
 * ISO/IEC 10166-1:1991 §9.2.26.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 ...
 */
export
const dfr_content_modified_by: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_dfr_content_modified_by /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
