...
import { id_att_dfr_content_create_date_and_time } from "../DFRObjectIdentifiers/id-att-dfr-content-create-date-and-time.va.mjs";
// export { id_att_dfr_content_create_date_and_time } from "../DFRObjectIdentifiers/id-att-dfr-content-create-date-and-time.va.mjs";
import {
 ...
 */
export
const dfr_content_create_date_and_time: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_dfr_content_create_date_and_time /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
