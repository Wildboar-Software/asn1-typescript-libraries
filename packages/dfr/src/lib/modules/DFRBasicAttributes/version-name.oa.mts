...
import { id_att_version_name } from "../DFRObjectIdentifiers/id-att-version-name.va.mjs";
// export { id_att_version_name } from "../DFRObjectIdentifiers/id-att-version-name.va.mjs";
 ...
 */
export
const version_name: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_version_name /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
