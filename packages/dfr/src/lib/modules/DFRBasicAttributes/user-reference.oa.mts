...
import { id_att_user_reference } from "../DFRObjectIdentifiers/id-att-user-reference.va.mjs";
// export { id_att_user_reference } from "../DFRObjectIdentifiers/id-att-user-reference.va.mjs";
 ...
 */
export
const user_reference: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_user_reference /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
