...
class AE_title {
     ...
     * @returns {AE_title}
     */
    public static _from_object (_o: { [_K in keyof (AE_title)]: (AE_title)[_K] }): AE_title {
 ...
 */
export
const _root_component_type_list_1_spec_for_AE_title: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_AE_title: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AE_title: $.ComponentSpec[] = [
...
function _decode_AE_title (el: _Element): AE_title {
    if (!_cached_decoder_for_AE_title) { _cached_decoder_for_AE_title = function (el: _Element): AE_title {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("AE-title contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "ap";
    sequence[1].name = "ae";
    let ap!: AP_title;
...
function _encode_AE_title (value: AE_title, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AE_title) { _cached_encoder_for_AE_title = function (value: AE_title, elGetter: $.ASN1Encoder<AE_title>): _Element {
