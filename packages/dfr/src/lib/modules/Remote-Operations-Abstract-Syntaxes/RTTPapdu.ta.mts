 ...
 */
export
function _decode_RTTPapdu (el: _Element): RTTPapdu {
    if (!_cached_decoder_for_RTTPapdu) { _cached_decoder_for_RTTPapdu = $._decodeInteger; }
 ...
 */
export
function _encode_RTTPapdu (value: RTTPapdu, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RTTPapdu) { _cached_encoder_for_RTTPapdu = $._encodeInteger; }
