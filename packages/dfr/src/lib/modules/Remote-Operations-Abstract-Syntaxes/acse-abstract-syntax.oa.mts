 ...
 */
export
const acse_abstract_syntax: ABSTRACT_SYNTAX<ACSE_apdu> = {
    ...
    "&id": _OID.fromParts([/* association-control */ 2, /* abstract-syntax */ 1, /* apdus */ 0, /* version1 */ 1,], joint_iso_itu_t) /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
