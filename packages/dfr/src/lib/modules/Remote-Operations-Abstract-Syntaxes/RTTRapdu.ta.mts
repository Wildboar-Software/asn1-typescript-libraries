 ...
 */
export
type RTTRapdu = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_RTTRapdu (el: _Element): RTTRapdu {
    if (!_cached_decoder_for_RTTRapdu) { _cached_decoder_for_RTTRapdu = $._decodeOctetString; }
 ...
 */
export
function _encode_RTTRapdu (value: RTTRapdu, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RTTRapdu) { _cached_encoder_for_RTTRapdu = $._encodeOctetString; }
