...
import { id_att_creation_date_and_time } from "../DFRObjectIdentifiers/id-att-creation-date-and-time.va.mjs";
// export { id_att_creation_date_and_time } from "../DFRObjectIdentifiers/id-att-creation-date-and-time.va.mjs";
import {
...
/**
 * @summary creation_date_and_time
 * @description
 *
 * When the document was created (not DFR store-create time). May be taken from
 * the ODA Document Profile (ISO 8613-4). User-assigned, copied by Copy.
 * ISO/IEC 10166-1:1991 §9.3.6.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 ...
 *     SINGLE VALUE            TRUE
 *     ID                      id-att-creation-date-and-time
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const creation_date_and_time: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_creation_date_and_time /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
