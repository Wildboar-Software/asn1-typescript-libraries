...
import { id_att_superseded_documents } from "../DFRObjectIdentifiers/id-att-superseded-documents.va.mjs";
// export { id_att_superseded_documents } from "../DFRObjectIdentifiers/id-att-superseded-documents.va.mjs";
 ...
 *     ID                      id-att-superseded-documents
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const superseded_documents: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_superseded_documents /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
