...
import { id_att_organizations } from "../DFRObjectIdentifiers/id-att-organizations.va.mjs";
// export { id_att_organizations } from "../DFRObjectIdentifiers/id-att-organizations.va.mjs";
 ...
 */
export
const organizations: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_organizations /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
