...
import { id_att_document_type } from "../DFRObjectIdentifiers/id-att-document-type.va.mjs";
// export { id_att_document_type } from "../DFRObjectIdentifiers/id-att-document-type.va.mjs";
 ...
 */
export
const document_type: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_document_type /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
