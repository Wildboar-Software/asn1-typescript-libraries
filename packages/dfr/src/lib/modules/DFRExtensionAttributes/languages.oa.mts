...
import { id_att_languages } from "../DFRObjectIdentifiers/id-att-languages.va.mjs";
// export { id_att_languages } from "../DFRObjectIdentifiers/id-att-languages.va.mjs";
 ...
 * @description
 *
 * Primary language(s) of the content. Multi-valued. May be taken from the ODA
 ...
 */
export
const languages: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_languages /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
