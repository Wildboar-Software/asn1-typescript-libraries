...
import { id_att_user_specific_codes } from "../DFRObjectIdentifiers/id-att-user-specific-codes.va.mjs";
// export { id_att_user_specific_codes } from "../DFRObjectIdentifiers/id-att-user-specific-codes.va.mjs";


/**
 * @summary user_specific_codes
 * @description
 *
 * User codes (contract, project, budget, …). Multi-valued. May be taken from
 * the ODA Document Profile (ISO 8613-4). User-assigned, copied by Copy.
 * ISO/IEC 10166-1:1991 §9.3.14.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 ...
 */
export
const user_specific_codes: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_user_specific_codes /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
