...
import { id_att_subject } from "../DFRObjectIdentifiers/id-att-subject.va.mjs";
// export { id_att_subject } from "../DFRObjectIdentifiers/id-att-subject.va.mjs";
 ...
 * @description
 *
 * Subject of the object. Single-valued. May be taken from the ODA Document
 ...
 */
export
const subject: ATTRIBUTE<CharacterData> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_subject /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
