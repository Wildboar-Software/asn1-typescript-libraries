...
import { id_att_revision_date_and_time } from "../DFRObjectIdentifiers/id-att-revision-date-and-time.va.mjs";
// export { id_att_revision_date_and_time } from "../DFRObjectIdentifiers/id-att-revision-date-and-time.va.mjs";
import {
 ...
 *     SINGLE VALUE            TRUE
 *     ID                      id-att-revision-date-and-time
 * }
 * ```
 * 
 * @constant
 ...
 */
export
const revision_date_and_time: ATTRIBUTE<GeneralizedTime> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": id_att_revision_date_and_time /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
