...
import { id_att_preparers } from "../DFRObjectIdentifiers/id-att-preparers.va.mjs";
// export { id_att_preparers } from "../DFRObjectIdentifiers/id-att-preparers.va.mjs";
 ...
 */
export
const preparers: ATTRIBUTE<Person> = {
    class: "ATTRIBUTE",
    decoderFor: {
        "&Type": _decode_Person,
    },
    ...
    "&id": id_att_preparers /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
