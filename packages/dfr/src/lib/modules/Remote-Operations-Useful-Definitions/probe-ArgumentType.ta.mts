...
class probe_ArgumentType {
     ...
     */
    public static _from_object (_o: { [_K in keyof (probe_ArgumentType)]: (probe_ArgumentType)[_K] }): probe_ArgumentType {
 ...
 */
export
const _root_component_type_list_1_spec_for_probe_ArgumentType: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_probe_ArgumentType: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_probe_ArgumentType: $.ComponentSpec[] = [
 ...
 */
export
function _decode_probe_ArgumentType (el: _Element): probe_ArgumentType {
    if (!_cached_decoder_for_probe_ArgumentType) { _cached_decoder_for_probe_ArgumentType = function (el: _Element): probe_ArgumentType {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new _ConstructionError("probe-ArgumentType contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "invokeId";
    let invokeId!: InvokeId;
    invokeId = $._decode_explicit<InvokeId>(() => _decode_InvokeId)(sequence[0]);
    return new probe_ArgumentType(
        invokeId,
 ...
 */
export
function _encode_probe_ArgumentType (value: probe_ArgumentType, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_probe_ArgumentType) { _cached_encoder_for_probe_ArgumentType = function (value: probe_ArgumentType, elGetter: $.ASN1Encoder<probe_ArgumentType>): _Element {
