...
import { CancelProblem, _enum_for_CancelProblem, CancelProblem_unknownOperation /* IMPORTED_LONG_ENUMERATION_ITEM */, unknownOperation /* IMPORTED_SHORT_ENUMERATION_ITEM */, CancelProblem_tooLate /* IMPORTED_LONG_ENUMERATION_ITEM */, tooLate /* IMPORTED_SHORT_ENUMERATION_ITEM */, CancelProblem_operationNotCancellable /* IMPORTED_LONG_ENUMERATION_ITEM */, operationNotCancellable /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_CancelProblem, _encode_CancelProblem } from "../Remote-Operations-Useful-Definitions/CancelProblem.ta.mjs";
// export { CancelProblem, _enum_for_CancelProblem, CancelProblem_unknownOperation /* IMPORTED_LONG_ENUMERATION_ITEM */, unknownOperation /* IMPORTED_SHORT_ENUMERATION_ITEM */, CancelProblem_tooLate /* IMPORTED_LONG_ENUMERATION_ITEM */, tooLate /* IMPORTED_SHORT_ENUMERATION_ITEM */, CancelProblem_operationNotCancellable /* IMPORTED_LONG_ENUMERATION_ITEM */, operationNotCancellable /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_CancelProblem, _encode_CancelProblem } from "../Remote-Operations-Useful-Definitions/CancelProblem.ta.mjs";
...
function _decode_cancelFailed_ParameterType (el: _Element): cancelFailed_ParameterType {
    ...
    const callbacks: $.DecodingMap = {
        "problem": (_el: _Element): void => { problem = $._decode_implicit<CancelProblem>(() => _decode_CancelProblem)(_el); },
...
function _encode_cancelFailed_ParameterType (value: cancelFailed_ParameterType, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSet(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_implicit(_TagClass.context, 0, () => _encode_CancelProblem, $.BER)(value.problem, $.BER),
