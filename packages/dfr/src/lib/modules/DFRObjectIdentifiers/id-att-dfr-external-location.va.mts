...
/**
 * @summary id_att_dfr_external_location
 * @description
 *
 * Attribute type OID of `dfr-external-location`. ISO/IEC 10166-1:1991 §9.2.17,
 * Annex B.
 *
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const id_att_dfr_external_location: ID = _OID.fromParts([
    16,
], id_dfr_bas_att);
