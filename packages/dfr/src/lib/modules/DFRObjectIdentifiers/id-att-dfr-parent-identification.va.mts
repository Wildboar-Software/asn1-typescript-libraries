...
/**
 * @summary id_att_dfr_parent_identification
 * @description
 *
 * Attribute type OID of `dfr-parent-identification`. ISO/IEC 10166-1:1991
 * §9.2.6, Annex B.
 *
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const id_att_dfr_parent_identification: ID = _OID.fromParts([
    5,
], id_dfr_bas_att);
