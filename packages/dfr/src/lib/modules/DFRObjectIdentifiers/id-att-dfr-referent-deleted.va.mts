...
/**
 * @summary id_att_dfr_referent_deleted
 * @description
 *
 * Attribute type OID of `dfr-referent-deleted`. ISO/IEC 10166-1:1991 §9.2.7,
 * Annex B.
 *
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const id_att_dfr_referent_deleted: ID = _OID.fromParts([
    6,
], id_dfr_bas_att);
