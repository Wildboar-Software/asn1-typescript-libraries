...
/**
 * @summary id_att_creation_date_and_time
 * @description
 *
 * Attribute type OID of `creation-date-and-time`. ISO/IEC 10166-1:1991 §9.3.6,
 * Annex B.
 *
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const id_att_creation_date_and_time: ID = _OID.fromParts([
    5,
], id_dfr_ext_att);
