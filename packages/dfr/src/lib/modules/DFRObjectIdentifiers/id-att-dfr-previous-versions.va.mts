...
/**
 * @summary id_att_dfr_previous_versions
 * @description
 *
 * Attribute type OID of `dfr-previous-versions`. ISO/IEC 10166-1:1991 §9.2.14,
 * Annex B.
 *
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const id_att_dfr_previous_versions: ID = _OID.fromParts([
    13,
], id_dfr_bas_att);
