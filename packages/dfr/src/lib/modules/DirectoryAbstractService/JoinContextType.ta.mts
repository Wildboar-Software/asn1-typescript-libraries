 ...
 */
export
type JoinContextType = OBJECT_IDENTIFIER; // ObjectClassFieldType
 ...
 */
export
function _decode_JoinContextType (el: _Element): JoinContextType {
    if (!_cached_decoder_for_JoinContextType) { _cached_decoder_for_JoinContextType = $._decodeObjectIdentifier; }
 ...
 */
export
function _encode_JoinContextType (value: JoinContextType, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_JoinContextType) { _cached_encoder_for_JoinContextType = $._encodeObjectIdentifier; }
