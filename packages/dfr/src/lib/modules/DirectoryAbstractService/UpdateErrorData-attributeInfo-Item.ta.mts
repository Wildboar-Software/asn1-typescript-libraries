 ...
 */
export
type UpdateErrorData_attributeInfo_Item =
 ...
 */
export
function _decode_UpdateErrorData_attributeInfo_Item (el: _Element): UpdateErrorData_attributeInfo_Item {
    if (!_cached_decoder_for_UpdateErrorData_attributeInfo_Item) { _cached_decoder_for_UpdateErrorData_attributeInfo_Item = $._decode_extensible_choice<UpdateErrorData_attributeInfo_Item>({
 ...
 */
export
function _encode_UpdateErrorData_attributeInfo_Item (value: UpdateErrorData_attributeInfo_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UpdateErrorData_attributeInfo_Item) { _cached_encoder_for_UpdateErrorData_attributeInfo_Item = $._encode_choice<UpdateErrorData_attributeInfo_Item>({
    "attributeType": _encode_AttributeType,
    "attribute": _encode_Attribute,
}, $.BER); }
    return _cached_encoder_for_UpdateErrorData_attributeInfo_Item(value, elGetter);
}
