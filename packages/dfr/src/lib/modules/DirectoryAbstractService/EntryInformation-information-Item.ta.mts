 ...
 */
export
function _decode_EntryInformation_information_Item (el: _Element): EntryInformation_information_Item {
    if (!_cached_decoder_for_EntryInformation_information_Item) { _cached_decoder_for_EntryInformation_information_Item = $._decode_extensible_choice<EntryInformation_information_Item>({
 ...
 */
export
function _encode_EntryInformation_information_Item (value: EntryInformation_information_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EntryInformation_information_Item) { _cached_encoder_for_EntryInformation_information_Item = $._encode_choice<EntryInformation_information_Item>({
    "attributeType": _encode_AttributeType,
    "attribute": _encode_Attribute,
}, $.BER); }
    return _cached_encoder_for_EntryInformation_information_Item(value, elGetter);
}
