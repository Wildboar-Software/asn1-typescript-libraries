...
class ServiceErrorData {
     ...
     */
    public static _from_object (_o: { [_K in keyof (ServiceErrorData)]: (ServiceErrorData)[_K] }): ServiceErrorData {
        return new ServiceErrorData(_o.problem, _o._unrecognizedExtensionsList, _o.securityParameters, _o.performer, _o.aliasDereferenced, _o.notification);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ServiceErrorData: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ServiceErrorData: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ServiceErrorData: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ServiceErrorData (el: _Element): ServiceErrorData {
    if (!_cached_decoder_for_ServiceErrorData) { _cached_decoder_for_ServiceErrorData = function (el: _Element): ServiceErrorData {
    /* START_OF_SET_COMPONENT_DECLARATIONS */
    let problem!: ServiceProblem;
    let _unrecognizedExtensionsList: _Element[] = [];
    let securityParameters: OPTIONAL<SecurityParameters>;
    let performer: OPTIONAL<DistinguishedName>;
    let aliasDereferenced: OPTIONAL<BOOLEAN> = ServiceErrorData._default_value_for_aliasDereferenced;
    let notification: OPTIONAL<Attribute[]>;
    /* END_OF_SET_COMPONENT_DECLARATIONS */
    /* START_OF_CALLBACKS_MAP */
    const callbacks: $.DecodingMap = {
        "problem": (_el: _Element): void => { problem = $._decode_explicit<ServiceProblem>(() => _decode_ServiceProblem)(_el); },
 ...
 */
export
function _encode_ServiceErrorData (value: ServiceErrorData, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ServiceErrorData) { _cached_encoder_for_ServiceErrorData = function (value: ServiceErrorData, elGetter: $.ASN1Encoder<ServiceErrorData>): _Element {
    return $._encodeSet(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_ServiceProblem, $.BER)(value.problem, $.BER)
        ],
        ...
        [
            ...
            /* IF_DEFAULT */ (value.aliasDereferenced === undefined || $.deepEq(value.aliasDereferenced, ServiceErrorData._default_value_for_aliasDereferenced) ? undefined : $._encode_explicit(_TagClass.context, 28, () => $._encodeBoolean, $.BER)(value.aliasDereferenced, $.BER)),
