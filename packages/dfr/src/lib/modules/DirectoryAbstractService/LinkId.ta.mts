 ...
 */
export
function _decode_LinkId (el: _Element): LinkId {
    if (!_cached_decoder_for_LinkId) { _cached_decoder_for_LinkId = $._decodeInteger; }
 ...
 */
export
function _encode_LinkId (value: LinkId, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_LinkId) { _cached_encoder_for_LinkId = $._encodeInteger; }
