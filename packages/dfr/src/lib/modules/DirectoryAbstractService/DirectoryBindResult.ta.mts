...
import { PwdResponseValue, _decode_PwdResponseValue, _encode_PwdResponseValue } from "../DirectoryAbstractService/PwdResponseValue.ta.mjs";
// export { PwdResponseValue, _decode_PwdResponseValue, _encode_PwdResponseValue } from "../DirectoryAbstractService/PwdResponseValue.ta.mjs";
...
class DirectoryBindResult {
     ...
     */
    public static _from_object (_o: { [_K in keyof (DirectoryBindResult)]: (DirectoryBindResult)[_K] }): DirectoryBindResult {
        return new DirectoryBindResult(_o.credentials, _o.versions, _o.pwdResponseValue, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_DirectoryBindResult: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_DirectoryBindResult: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_DirectoryBindResult: $.ComponentSpec[] = [
    new $.ComponentSpec("pwdResponseValue", true, $.hasTag(_TagClass.context, 2))
];
 ...
 */
export
function _decode_DirectoryBindResult (el: _Element): DirectoryBindResult {
    if (!_cached_decoder_for_DirectoryBindResult) { _cached_decoder_for_DirectoryBindResult = function (el: _Element): DirectoryBindResult {
    /* START_OF_SET_COMPONENT_DECLARATIONS */
    let credentials: OPTIONAL<Credentials>;
    let versions: OPTIONAL<Versions> = DirectoryBindResult._default_value_for_versions;
    ...
    const callbacks: $.DecodingMap = {
        ...
        "pwdResponseValue": (_el: _Element): void => { pwdResponseValue = $._decode_explicit<PwdResponseValue>(() => _decode_PwdResponseValue)(_el); }
    };
 ...
 */
export
function _encode_DirectoryBindResult (value: DirectoryBindResult, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DirectoryBindResult) { _cached_encoder_for_DirectoryBindResult = function (value: DirectoryBindResult, elGetter: $.ASN1Encoder<DirectoryBindResult>): _Element {
    return $._encodeSet(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_DEFAULT */ (value.versions === undefined || $.deepEq(value.versions, DirectoryBindResult._default_value_for_versions) ? undefined : $._encode_explicit(_TagClass.context, 1, () => _encode_Versions, $.BER)(value.versions, $.BER))
        ],
        [
            /* IF_ABSENT  */ ((value.pwdResponseValue === undefined) ? undefined : $._encode_explicit(_TagClass.context, 2, () => _encode_PwdResponseValue, $.BER)(value.pwdResponseValue, $.BER))
        ],
