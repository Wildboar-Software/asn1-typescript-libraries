 ...
 */
export
type SimpleCredentials_validity_time1 =
 ...
 */
export
function _decode_SimpleCredentials_validity_time1 (el: _Element): SimpleCredentials_validity_time1 {
    if (!_cached_decoder_for_SimpleCredentials_validity_time1) { _cached_decoder_for_SimpleCredentials_validity_time1 = $._decode_inextensible_choice<SimpleCredentials_validity_time1>({
 ...
 */
export
function _encode_SimpleCredentials_validity_time1 (value: SimpleCredentials_validity_time1, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SimpleCredentials_validity_time1) { _cached_encoder_for_SimpleCredentials_validity_time1 = $._encode_choice<SimpleCredentials_validity_time1>({
    "utc": $._encodeUTCTime,
    "gt": $._encodeGeneralizedTime,
}, $.BER); }
    return _cached_encoder_for_SimpleCredentials_validity_time1(value, elGetter);
}
