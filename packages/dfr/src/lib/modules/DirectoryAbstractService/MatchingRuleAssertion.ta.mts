...
class MatchingRuleAssertion {
     ...
     */
    public static _from_object (_o: { [_K in keyof (MatchingRuleAssertion)]: (MatchingRuleAssertion)[_K] }): MatchingRuleAssertion {
        return new MatchingRuleAssertion(_o.matchingRule, _o.type_, _o.matchValue, _o.dnAttributes, _o._unrecognizedExtensionsList);
    }
     ...
     * @method
     */
    public static get _default_value_for_dnAttributes () { return false; }
}
 ...
 */
export
const _root_component_type_list_1_spec_for_MatchingRuleAssertion: $.ComponentSpec[] = [
    new $.ComponentSpec("matchingRule", false, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("type", true, $.hasTag(_TagClass.context, 2)),
    new $.ComponentSpec("matchValue", false, $.hasTag(_TagClass.context, 3)),
    new $.ComponentSpec("dnAttributes", true, $.hasTag(_TagClass.context, 4))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_MatchingRuleAssertion: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_MatchingRuleAssertion: $.ComponentSpec[] = [
 ...
 */
export
function _decode_MatchingRuleAssertion (el: _Element): MatchingRuleAssertion {
    if (!_cached_decoder_for_MatchingRuleAssertion) { _cached_decoder_for_MatchingRuleAssertion = function (el: _Element): MatchingRuleAssertion {
    let matchingRule!: OBJECT_IDENTIFIER[];
    let type_: OPTIONAL<AttributeType>;
    let matchValue!: _Element;
    let dnAttributes: OPTIONAL<BOOLEAN> = MatchingRuleAssertion._default_value_for_dnAttributes;
    let _unrecognizedExtensionsList: _Element[] = [];
    const callbacks: $.DecodingMap = {
        "matchingRule": (_el: _Element): void => { matchingRule = $._decode_explicit<OBJECT_IDENTIFIER[]>(() => $._decodeSetOf<OBJECT_IDENTIFIER>(() => $._decodeObjectIdentifier))(_el); },
        "type": (_el: _Element): void => { type_ = $._decode_explicit<AttributeType>(() => _decode_AttributeType)(_el); },
        "matchValue": (_el: _Element): void => { matchValue = $._decode_explicit<_Element>(() => $._decodeAny)(_el); },
        "dnAttributes": (_el: _Element): void => { dnAttributes = $._decode_explicit<BOOLEAN>(() => $._decodeBoolean)(_el); }
    };
 ...
 */
export
function _encode_MatchingRuleAssertion (value: MatchingRuleAssertion, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MatchingRuleAssertion) { _cached_encoder_for_MatchingRuleAssertion = function (value: MatchingRuleAssertion, elGetter: $.ASN1Encoder<MatchingRuleAssertion>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 1, () => $._encodeSetOf<OBJECT_IDENTIFIER>(() => $._encodeObjectIdentifier, $.BER), $.BER)(value.matchingRule, $.BER),
            /* IF_ABSENT  */ ((value.type_ === undefined) ? undefined : $._encode_explicit(_TagClass.context, 2, () => _encode_AttributeType, $.BER)(value.type_, $.BER)),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 3, () => $._encodeAny, $.BER)(value.matchValue, $.BER),
            /* IF_DEFAULT */ (value.dnAttributes === undefined || $.deepEq(value.dnAttributes, MatchingRuleAssertion._default_value_for_dnAttributes) ? undefined : $._encode_explicit(_TagClass.context, 4, () => $._encodeBoolean, $.BER)(value.dnAttributes, $.BER))
        ],
