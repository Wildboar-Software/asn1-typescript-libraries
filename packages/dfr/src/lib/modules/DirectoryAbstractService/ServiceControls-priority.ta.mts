 ...
 */
export
type ServiceControls_priority = INTEGER;
 ...
 */
export
const low: ServiceControls_priority = ServiceControls_priority_low; /* SHORT_NAMED_INTEGER_VALUE */
 ...
 */
export
const medium: ServiceControls_priority = ServiceControls_priority_medium; /* SHORT_NAMED_INTEGER_VALUE */
 ...
 */
export
const high: ServiceControls_priority = ServiceControls_priority_high; /* SHORT_NAMED_INTEGER_VALUE */
 ...
 */
export
function _decode_ServiceControls_priority (el: _Element): ServiceControls_priority {
    if (!_cached_decoder_for_ServiceControls_priority) { _cached_decoder_for_ServiceControls_priority = $._decodeInteger; }
 ...
 */
export
function _encode_ServiceControls_priority (value: ServiceControls_priority, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ServiceControls_priority) { _cached_encoder_for_ServiceControls_priority = $._encodeInteger; }
