...
import { AbandonResultData, _decode_AbandonResultData, _encode_AbandonResultData } from "../DirectoryAbstractService/AbandonResultData.ta.mjs";
// export { AbandonResultData, _decode_AbandonResultData, _encode_AbandonResultData } from "../DirectoryAbstractService/AbandonResultData.ta.mjs";
...
type AbandonResult =
    ...
    | { information: OPTIONALLY_PROTECTED_SEQ<AbandonResultData> } /* CHOICE_ALT_ROOT */
...
function _decode_AbandonResult (el: _Element): AbandonResult {
    if (!_cached_decoder_for_AbandonResult) { _cached_decoder_for_AbandonResult = $._decode_extensible_choice<AbandonResult>({
    "UNIVERSAL 5": [ "null_", $._decodeNull ],
    "// FIXME: COULD_NOT_COMPILE_TAG_KEY": [ "information", _get_decoder_for_OPTIONALLY_PROTECTED_SEQ<AbandonResultData>(_decode_AbandonResultData) ]
}); }
...
function _encode_AbandonResult (value: AbandonResult, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AbandonResult) { _cached_encoder_for_AbandonResult = $._encode_choice<AbandonResult>({
    "null_": $._encodeNull,
