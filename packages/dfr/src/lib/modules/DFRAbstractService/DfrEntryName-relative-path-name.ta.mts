...
function _encode_DfrEntryName_relative_path_name (value: DfrEntryName_relative_path_name, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DfrEntryName_relative_path_name) { _cached_encoder_for_DfrEntryName_relative_path_name = function (value: DfrEntryName_relative_path_name, elGetter: $.ASN1Encoder<DfrEntryName_relative_path_name>): _Element {
