...
function _encode_EntryModification_add_values_from (value: EntryModification_add_values_from, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EntryModification_add_values_from) { _cached_encoder_for_EntryModification_add_values_from = function (value: EntryModification_add_values_from, elGetter: $.ASN1Encoder<EntryModification_add_values_from>): _Element {
