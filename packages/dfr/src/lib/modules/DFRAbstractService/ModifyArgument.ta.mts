 ...
 * @description
 *
 * `entry` and `modifications` required; `destination`, `position`, and
 * `reference-qos` absent. External `entry` is not applicable. ISO/IEC
 * 10166-1:1991 §8.2.6.1.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class ModifyArgument {
    constructor (
         ...
         * @description
         *
         * Constrained absent on Modify. ISO/IEC 10166-1:1991 §8.1.5.3,
         * §8.2.6.1.
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Constrained absent on Modify. ISO/IEC 10166-1:1991 §8.1.5.4,
         * §8.2.6.1.
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Constrained absent on Modify. ISO/IEC 10166-1:1991 §8.2.6.1.
         * @public
         * @readonly
         */
     ...
     */
    public static _from_object (_o: { [_K in keyof (ModifyArgument)]: (ModifyArgument)[_K] }): ModifyArgument {
        return new ModifyArgument(_o.object_class, _o.entry, _o.destination, _o.position, _o.modifications, _o.selection, _o.reference_qos, _o.task_id, _o.reservation, _o.error_handling, _o.priority, _o.privileges);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ModifyArgument: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ModifyArgument: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ModifyArgument: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ModifyArgument (el: _Element): ModifyArgument {
    if (!_cached_decoder_for_ModifyArgument) { _cached_decoder_for_ModifyArgument = function (el: _Element): ModifyArgument {
    ...
    let error_handling: OPTIONAL<ErrorHandlingMode> = ModifyArgument._default_value_for_error_handling;
    let priority: OPTIONAL<Priority> = ModifyArgument._default_value_for_priority;
 ...
 */
export
function _encode_ModifyArgument (value: ModifyArgument, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ModifyArgument) { _cached_encoder_for_ModifyArgument = function (value: ModifyArgument): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_DEFAULT */ (value.error_handling === undefined || $.deepEq(value.error_handling, ModifyArgument._default_value_for_error_handling) ? undefined : $._encode_explicit(_TagClass.context, 28, () => _encode_ErrorHandlingMode, $.BER)(value.error_handling, $.BER)),
            /* IF_DEFAULT */ (value.priority === undefined || $.deepEq(value.priority, ModifyArgument._default_value_for_priority) ? undefined : $._encode_implicit(_TagClass.context, 29, () => _encode_Priority, $.BER)(value.priority, $.BER)),
