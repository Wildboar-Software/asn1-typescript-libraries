 ...
 */
export
function _decode_DeleteResult (el: _Element): DeleteResult {
    if (!_cached_decoder_for_DeleteResult) { _cached_decoder_for_DeleteResult = $._decodeNull; }
 ...
 */
export
function _encode_DeleteResult (value: DeleteResult, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DeleteResult) { _cached_encoder_for_DeleteResult = $._encodeNull; }
