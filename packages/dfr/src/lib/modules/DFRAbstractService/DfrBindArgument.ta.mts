...
function _encode_DfrBindArgument (value: DfrBindArgument, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DfrBindArgument) { _cached_encoder_for_DfrBindArgument = function (value: DfrBindArgument, elGetter: $.ASN1Encoder<DfrBindArgument>): _Element {
