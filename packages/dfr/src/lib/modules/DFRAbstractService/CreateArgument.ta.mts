 ...
 * @description
 *
 * Create argument: `object-class` and `destination` required; `entry` and
 * `reference-qos` absent. If both `attributes` and `modifications` are given,
 * attributes apply first, then content, then modifications (ISO/IEC
 * 10166-1:1991/Cor.1:1994 §8.2.1.1). `attributes` and `content` must not both
 * be used with modifications that also supply content. ISO/IEC 10166-1:1991
 * §8.2.1.1.
 *
 * ### ASN.1 Definition:
 * 
...
class CreateArgument {
    constructor (
         ...
         * @description
         *
         * Constrained absent on Create. ISO/IEC 10166-1:1991 §8.2.1.1.
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Primary way to supply attributes. Combined with modifications, this
         * is applied first. ISO/IEC 10166-1:1991 §8.2.1.1; ISO/IEC
         ...
         * @description
         *
         * Primary way to supply content. Must not be combined with
         * content-bearing modifications. Required for a reference; forbidden
         * for a group or SRL. ISO/IEC 10166-1:1991 §8.2.1.
         * @public
         * @readonly
         */
