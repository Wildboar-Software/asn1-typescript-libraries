...
class ReserveArgument {
     ...
     * @description
     * 
     * This takes an `object` and converts it to a `ReserveArgument`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `ReserveArgument`.
     * @returns {ReserveArgument}
     */
    public static _from_object (_o: { [_K in keyof (ReserveArgument)]: (ReserveArgument)[_K] }): ReserveArgument {
        return new ReserveArgument(_o.entry, _o.task_id, _o.reservation, _o.error_handling, _o.priority, _o.privileges);
    }
...
/**
 * @summary The Leading Root Component Types of ReserveArgument
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_ReserveArgument: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of ReserveArgument
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_ReserveArgument: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of ReserveArgument
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_ReserveArgument: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_ReserveArgument: $.ASN1Decoder<ReserveArgument> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) ReserveArgument
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_ReserveArgument (el: _Element): ReserveArgument {
    if (!_cached_decoder_for_ReserveArgument) { _cached_decoder_for_ReserveArgument = function (el: _Element): ReserveArgument {
    let entry!: DfrEntryName;
    let task_id: OPTIONAL<TaskId>;
    let reservation: OPTIONAL<Reservation>;
    let error_handling: OPTIONAL<ErrorHandlingMode> = ReserveArgument._default_value_for_error_handling;
    let priority: OPTIONAL<Priority> = ReserveArgument._default_value_for_priority;
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_ReserveArgument,
        _extension_additions_list_spec_for_ReserveArgument,
        _root_component_type_list_2_spec_for_ReserveArgument,
        undefined,
    );
    return new ReserveArgument(
        entry,
        task_id,
        reservation,
        error_handling,
    ...
    return _cached_decoder_for_ReserveArgument(el);
}

let _cached_encoder_for_ReserveArgument: $.ASN1Encoder<ReserveArgument> | null = null;

/**
 * @summary Encodes a(n) ReserveArgument into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The ReserveArgument, encoded as an ASN.1 Element.
 */
export
function _encode_ReserveArgument (value: ReserveArgument, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReserveArgument) { _cached_encoder_for_ReserveArgument = function (value: ReserveArgument, elGetter: $.ASN1Encoder<ReserveArgument>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_DEFAULT */ (value.error_handling === undefined || $.deepEq(value.error_handling, ReserveArgument._default_value_for_error_handling) ? undefined : $._encode_explicit(_TagClass.context, 28, () => _encode_ErrorHandlingMode, $.BER)(value.error_handling, $.BER)),
            /* IF_DEFAULT */ (value.priority === undefined || $.deepEq(value.priority, ReserveArgument._default_value_for_priority) ? undefined : $._encode_implicit(_TagClass.context, 29, () => _encode_Priority, $.BER)(value.priority, $.BER)),
    ...
    return _cached_encoder_for_ReserveArgument(value, elGetter);
}
