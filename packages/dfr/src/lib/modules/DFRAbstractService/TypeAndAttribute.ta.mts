...
function _encode_TypeAndAttribute (value: TypeAndAttribute, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TypeAndAttribute) { _cached_encoder_for_TypeAndAttribute = function (value: TypeAndAttribute, elGetter: $.ASN1Encoder<TypeAndAttribute>): _Element {
