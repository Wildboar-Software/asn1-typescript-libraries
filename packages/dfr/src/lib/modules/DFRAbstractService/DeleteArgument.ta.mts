 ...
 * @description
 *
 * Identifies the entry to delete. No reservation or error-handling components.
 * ISO/IEC 10166-1:1991 §8.2.2.1.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class DeleteArgument {
    constructor (
         ...
         * @description
         *
         * Local name of the entry to delete. Group delete is recursive and
         * needs sufficient rights on every descendant. Deleting a reference
         * does not affect the referent. ISO/IEC 10166-1:1991 §8.2.2.
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Constrained absent. ISO/IEC 10166-1:1991 §8.2.2.1.
         * @public
         * @readonly
         */
...
function _encode_DeleteArgument (value: DeleteArgument, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DeleteArgument) { _cached_encoder_for_DeleteArgument = function (value: DeleteArgument): _Element {
