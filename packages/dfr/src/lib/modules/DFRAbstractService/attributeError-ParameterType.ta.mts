...
function _encode_attributeError_ParameterType (value: attributeError_ParameterType, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_attributeError_ParameterType) { _cached_encoder_for_attributeError_ParameterType = function (value: attributeError_ParameterType, elGetter: $.ASN1Encoder<attributeError_ParameterType>): _Element {
