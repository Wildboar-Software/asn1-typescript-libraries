...
function _encode_CommonListSearchArguments (value: CommonListSearchArguments, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CommonListSearchArguments) { _cached_encoder_for_CommonListSearchArguments = function (value: CommonListSearchArguments, elGetter: $.ASN1Encoder<CommonListSearchArguments>): _Element {
