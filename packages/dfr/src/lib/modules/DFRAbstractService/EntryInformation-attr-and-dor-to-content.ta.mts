 ...
 * @description
 *
 * Attributes plus a DOR to the object's content (documents). ISO/IEC
 * 10166-1:1991 §8.1.5.6.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
function _encode_EntryInformation_attr_and_dor_to_content (value: EntryInformation_attr_and_dor_to_content, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EntryInformation_attr_and_dor_to_content) { _cached_encoder_for_EntryInformation_attr_and_dor_to_content = function (value: EntryInformation_attr_and_dor_to_content): _Element {
