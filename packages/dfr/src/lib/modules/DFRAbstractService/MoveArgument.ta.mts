...
import { CommonUpdateArguments, _decode_CommonUpdateArguments, _encode_CommonUpdateArguments } from "../DFRAbstractService/CommonUpdateArguments.ta.mjs";
...
class MoveArgument {
     ...
     * @description
     * 
     * This takes an `object` and converts it to a `MoveArgument`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `MoveArgument`.
     * @returns {MoveArgument}
     */
    public static _from_object (_o: { [_K in keyof (MoveArgument)]: (MoveArgument)[_K] }): MoveArgument {
        return new MoveArgument(_o.object_class, _o.entry, _o.destination, _o.position, _o.modifications, _o.selection, _o.reference_qos, _o.task_id, _o.reservation, _o.error_handling, _o.priority, _o.privileges);
    }
...
/**
 * @summary The Leading Root Component Types of MoveArgument
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_MoveArgument: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of MoveArgument
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_MoveArgument: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of MoveArgument
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_MoveArgument: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_MoveArgument: $.ASN1Decoder<MoveArgument> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) MoveArgument
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_MoveArgument (el: _Element): MoveArgument {
    if (!_cached_decoder_for_MoveArgument) { _cached_decoder_for_MoveArgument = function (el: _Element): MoveArgument {
    ...
    let error_handling: OPTIONAL<ErrorHandlingMode> = MoveArgument._default_value_for_error_handling;
    let priority: OPTIONAL<Priority> = MoveArgument._default_value_for_priority;
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_MoveArgument,
        _extension_additions_list_spec_for_MoveArgument,
        _root_component_type_list_2_spec_for_MoveArgument,
        undefined,
    );
    return new MoveArgument(
        object_class,
        entry,
        destination,
        position,
    ...
    return _cached_decoder_for_MoveArgument(el);
}

let _cached_encoder_for_MoveArgument: $.ASN1Encoder<MoveArgument> | null = null;

/**
 * @summary Encodes a(n) MoveArgument into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The MoveArgument, encoded as an ASN.1 Element.
 */
export
function _encode_MoveArgument (value: MoveArgument, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MoveArgument) { _cached_encoder_for_MoveArgument = function (value: MoveArgument, elGetter: $.ASN1Encoder<MoveArgument>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_DEFAULT */ (value.error_handling === undefined || $.deepEq(value.error_handling, MoveArgument._default_value_for_error_handling) ? undefined : $._encode_explicit(_TagClass.context, 28, () => _encode_ErrorHandlingMode, $.BER)(value.error_handling, $.BER)),
            /* IF_DEFAULT */ (value.priority === undefined || $.deepEq(value.priority, MoveArgument._default_value_for_priority) ? undefined : $._encode_implicit(_TagClass.context, 29, () => _encode_Priority, $.BER)(value.priority, $.BER)),
    ...
    return _cached_encoder_for_MoveArgument(value, elGetter);
}
