# Document Filing and Retrieval (DFR) PDUs in TypeScript

ASN.1 data structures and PDUs based on the ASN.1 definitions in
ISO/IEC 10166 (Document Filing and Retrieval) and ISO/IEC 10031-2
(Distributed-office-applications — Referenced Data Transfer).
...
(Cursor Grok 4.6) on 13 September 2026.
