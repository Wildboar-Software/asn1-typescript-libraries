...
function _decode_Timestamp (el: _Element): Timestamp {
    if (!_cached_decoder_for_Timestamp) { _cached_decoder_for_Timestamp = $._decodeInteger; }
...
function _encode_Timestamp (value: Timestamp, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Timestamp) { _cached_encoder_for_Timestamp = $._encodeInteger; }
