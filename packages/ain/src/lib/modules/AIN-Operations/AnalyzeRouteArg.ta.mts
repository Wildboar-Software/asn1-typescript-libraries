...
class AnalyzeRouteArg {
    constructor (
         ...
         * @readonly
         */
        readonly genericDigitsList: OPTIONAL<GenericDigitsList>,
        /**
    ...
    /**
     * @summary Restructures an object into a AnalyzeRouteArg
     * @description
     * 
     * This takes an `object` and converts it to a `AnalyzeRouteArg`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `AnalyzeRouteArg`.
     * @returns {AnalyzeRouteArg}
     */
    public static _from_object (_o: { [_K in keyof (AnalyzeRouteArg)]: (AnalyzeRouteArg)[_K] }): AnalyzeRouteArg {
        return new AnalyzeRouteArg(_o.chargeNumber, _o.callingPartyID, _o.chargePartyStationType, _o.calledPartyID, _o.outpulseNumber, _o.tcm, _o.primaryTrunkGroup, _o.alternateTrunkGroup, _o.secondAlternateTrunkGroup, _o.carrier, _o.alternateCarrier, _o.secondAlternateCarrier, _o.passiveLegTreatment, _o.redirectingPartyID, _o.primaryBillingIndicator, _o.alternateBillingIndicator, _o.secondAlternateBillingIndicator, _o.overflowBillingIndicator, _o.aMAAlternateBillingNumber, _o.aMABusinessCustomerID, _o.aMALineNumberList, _o.aMAslpID, _o.aMADigitsDialedWCList, _o.amp1, _o.amp2, _o.serviceProviderID, _o.serviceContext, _o.aMABillingFeature, _o.aMASequenceNumber, _o.redirectionInformation, _o.carrierUsage, _o.extensionParameter, _o.genericAddressList, _o.networkSpecificFacilities, _o.callingPartyBGID, _o.forwardCallIndicator, _o.aMAServiceProviderID, _o.prefix, _o.genericDigitsList, _o.applyRestrictions, _o.displayText, _o.genericName);
    }
...
/**
 * @summary The Leading Root Component Types of AnalyzeRouteArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_AnalyzeRouteArg: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("aMAslpID", false, $.hasTag(_TagClass.context, 10)),
    ...
    new $.ComponentSpec("genericDigitsList", true, $.hasTag(_TagClass.context, 150)),
...
/**
 * @summary The Trailing Root Component Types of AnalyzeRouteArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_AnalyzeRouteArg: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of AnalyzeRouteArg
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_AnalyzeRouteArg: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_AnalyzeRouteArg: $.ASN1Decoder<AnalyzeRouteArg> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) AnalyzeRouteArg
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_AnalyzeRouteArg (el: _Element): AnalyzeRouteArg {
    if (!_cached_decoder_for_AnalyzeRouteArg) { _cached_decoder_for_AnalyzeRouteArg = function (el: _Element): AnalyzeRouteArg {
    ...
    let genericDigitsList: OPTIONAL<GenericDigitsList>;
    ...
    const callbacks: $.DecodingMap = {
        ...
        "genericDigitsList": (_el: _Element): void => { genericDigitsList = _decode_GenericDigitsList(_el); },
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_AnalyzeRouteArg,
        _extension_additions_list_spec_for_AnalyzeRouteArg,
        _root_component_type_list_2_spec_for_AnalyzeRouteArg,
        undefined,
    );
    return new AnalyzeRouteArg(
        chargeNumber,
        callingPartyID,
    ...
    return _cached_decoder_for_AnalyzeRouteArg(el);
}

let _cached_encoder_for_AnalyzeRouteArg: $.ASN1Encoder<AnalyzeRouteArg> | null = null;

/**
 * @summary Encodes a(n) AnalyzeRouteArg into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The AnalyzeRouteArg, encoded as an ASN.1 Element.
 */
export
function _encode_AnalyzeRouteArg (value: AnalyzeRouteArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AnalyzeRouteArg) { _cached_encoder_for_AnalyzeRouteArg = function (value: AnalyzeRouteArg, elGetter: $.ASN1Encoder<AnalyzeRouteArg>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ $._encode_implicit(_TagClass.context, 10, () => _encode_AMAslpID, $.BER)(value.aMAslpID, $.BER),
            ...
            /* IF_ABSENT  */ ((value.genericDigitsList === undefined) ? undefined : _encode_GenericDigitsList(value.genericDigitsList, $.BER)),
    ...
    return _cached_encoder_for_AnalyzeRouteArg(value, elGetter);
}
