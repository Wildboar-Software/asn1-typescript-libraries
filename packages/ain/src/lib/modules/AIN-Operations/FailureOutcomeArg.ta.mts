...
class FailureOutcomeArg {
    ...
    /**
     * @summary Restructures an object into a FailureOutcomeArg
     * @description
     * 
     * This takes an `object` and converts it to a `FailureOutcomeArg`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `FailureOutcomeArg`.
     * @returns {FailureOutcomeArg}
     */
    public static _from_object (_o: { [_K in keyof (FailureOutcomeArg)]: (FailureOutcomeArg)[_K] }): FailureOutcomeArg {
        return new FailureOutcomeArg(_o.userID, _o.bearerCapability, _o.notificationIndicator, _o.ccID, _o.legID, _o.bCMType, _o.pointInCall, _o.failureCause, _o.amp1, _o.amp2, _o.extensionParameter);
    }
...
/**
 * @summary The Leading Root Component Types of FailureOutcomeArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_FailureOutcomeArg: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of FailureOutcomeArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_FailureOutcomeArg: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of FailureOutcomeArg
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_FailureOutcomeArg: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_FailureOutcomeArg: $.ASN1Decoder<FailureOutcomeArg> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) FailureOutcomeArg
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_FailureOutcomeArg (el: _Element): FailureOutcomeArg {
    if (!_cached_decoder_for_FailureOutcomeArg) { _cached_decoder_for_FailureOutcomeArg = function (el: _Element): FailureOutcomeArg {
    let userID!: UserID;
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_FailureOutcomeArg,
        _extension_additions_list_spec_for_FailureOutcomeArg,
        _root_component_type_list_2_spec_for_FailureOutcomeArg,
        undefined,
    );
    return new FailureOutcomeArg(
        userID,
        bearerCapability,
    ...
    return _cached_decoder_for_FailureOutcomeArg(el);
}

let _cached_encoder_for_FailureOutcomeArg: $.ASN1Encoder<FailureOutcomeArg> | null = null;

/**
 * @summary Encodes a(n) FailureOutcomeArg into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The FailureOutcomeArg, encoded as an ASN.1 Element.
 */
export
function _encode_FailureOutcomeArg (value: FailureOutcomeArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FailureOutcomeArg) { _cached_encoder_for_FailureOutcomeArg = function (value: FailureOutcomeArg, elGetter: $.ASN1Encoder<FailureOutcomeArg>): _Element {
    ...
    return _cached_encoder_for_FailureOutcomeArg(value, elGetter);
}
