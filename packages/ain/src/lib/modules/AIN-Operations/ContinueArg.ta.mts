...
class ContinueArg {
    ...
    /**
     * @summary Restructures an object into a ContinueArg
     * @description
     * 
     * This takes an `object` and converts it to a `ContinueArg`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `ContinueArg`.
     * @returns {ContinueArg}
     */
    public static _from_object (_o: { [_K in keyof (ContinueArg)]: (ContinueArg)[_K] }): ContinueArg {
        return new ContinueArg(_o.primaryBillingIndicator, _o.aMAAlternateBillingNumber, _o.aMABusinessCustomerID, _o.aMALineNumberList, _o.aMAslpID, _o.aMADigitsDialedWCList, _o.amp1, _o.amp2, _o.serviceProviderID, _o.serviceContext, _o.aMABillingFeature, _o.aMASequenceNumber, _o.extensionParameter, _o.aMAserviceProviderID);
    }
...
/**
 * @summary The Leading Root Component Types of ContinueArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_ContinueArg: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of ContinueArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_ContinueArg: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of ContinueArg
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_ContinueArg: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_ContinueArg: $.ASN1Decoder<ContinueArg> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) ContinueArg
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_ContinueArg (el: _Element): ContinueArg {
    if (!_cached_decoder_for_ContinueArg) { _cached_decoder_for_ContinueArg = function (el: _Element): ContinueArg {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_ContinueArg,
        _extension_additions_list_spec_for_ContinueArg,
        _root_component_type_list_2_spec_for_ContinueArg,
        undefined,
    );
    return new ContinueArg(
    ...
    return _cached_decoder_for_ContinueArg(el);
}

let _cached_encoder_for_ContinueArg: $.ASN1Encoder<ContinueArg> | null = null;

/**
 * @summary Encodes a(n) ContinueArg into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The ContinueArg, encoded as an ASN.1 Element.
 */
export
function _encode_ContinueArg (value: ContinueArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ContinueArg) { _cached_encoder_for_ContinueArg = function (value: ContinueArg, elGetter: $.ASN1Encoder<ContinueArg>): _Element {
    ...
    return _cached_encoder_for_ContinueArg(value, elGetter);
}
