...
class TMidCallArg {
    ...
    /**
     * @summary Restructures an object into a TMidCallArg
     * @description
     * 
     * This takes an `object` and converts it to a `TMidCallArg`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `TMidCallArg`.
     * @returns {TMidCallArg}
     */
    public static _from_object (_o: { [_K in keyof (TMidCallArg)]: (TMidCallArg)[_K] }): TMidCallArg {
        return new TMidCallArg(_o.userID, _o.bearerCapability, _o.calledPartyID, _o.triggerCriteriaType, _o.legID, _o.pointInCall, _o.ccID, _o.featureActivatorID, _o.chargeNumber, _o.callingPartyID, _o.callingPartyBGID, _o.chargePartyStationType, _o.carrier, _o.accessCode, _o.collectedAddressInfo, _o.collectedDigits, _o.verticalServiceCode, _o.aCGEncountered, _o.notificationIndicator, _o.amp1, _o.amp2, _o.extensionParameter, _o.aMASequenceNumber);
    }
...
/**
 * @summary The Leading Root Component Types of TMidCallArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_TMidCallArg: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of TMidCallArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_TMidCallArg: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of TMidCallArg
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_TMidCallArg: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_TMidCallArg: $.ASN1Decoder<TMidCallArg> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) TMidCallArg
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_TMidCallArg (el: _Element): TMidCallArg {
    if (!_cached_decoder_for_TMidCallArg) { _cached_decoder_for_TMidCallArg = function (el: _Element): TMidCallArg {
    let userID!: UserID;
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_TMidCallArg,
        _extension_additions_list_spec_for_TMidCallArg,
        _root_component_type_list_2_spec_for_TMidCallArg,
        undefined,
    );
    return new TMidCallArg(
        userID,
        bearerCapability,
        calledPartyID,
        triggerCriteriaType,
    ...
    return _cached_decoder_for_TMidCallArg(el);
}

let _cached_encoder_for_TMidCallArg: $.ASN1Encoder<TMidCallArg> | null = null;

/**
 * @summary Encodes a(n) TMidCallArg into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The TMidCallArg, encoded as an ASN.1 Element.
 */
export
function _encode_TMidCallArg (value: TMidCallArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TMidCallArg) { _cached_encoder_for_TMidCallArg = function (value: TMidCallArg, elGetter: $.ASN1Encoder<TMidCallArg>): _Element {
    ...
    return _cached_encoder_for_TMidCallArg(value, elGetter);
}
