...
class OfferCallArg {
    ...
    /**
     * @summary Restructures an object into a OfferCallArg
     * @description
     * 
     * This takes an `object` and converts it to a `OfferCallArg`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `OfferCallArg`.
     * @returns {OfferCallArg}
     */
    public static _from_object (_o: { [_K in keyof (OfferCallArg)]: (OfferCallArg)[_K] }): OfferCallArg {
        return new OfferCallArg(_o.callingPartyID, _o.controllingLegTreatment, _o.displayText, _o.primaryBillingIndicator, _o.aMAAlternateBillingNumber, _o.aMABusinessCustomerID, _o.aMALineNumberList, _o.aMAslpID, _o.aMADigitsDialedWCList, _o.amp1, _o.amp2, _o.serviceProviderID, _o.serviceContext, _o.aMABillingFeature, _o.aMASequenceNumber, _o.extensionParameter, _o.aMAserviceProviderID, _o.genericName);
    }
...
/**
 * @summary The Leading Root Component Types of OfferCallArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_OfferCallArg: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of OfferCallArg
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_OfferCallArg: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of OfferCallArg
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_OfferCallArg: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_OfferCallArg: $.ASN1Decoder<OfferCallArg> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) OfferCallArg
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_OfferCallArg (el: _Element): OfferCallArg {
    if (!_cached_decoder_for_OfferCallArg) { _cached_decoder_for_OfferCallArg = function (el: _Element): OfferCallArg {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_OfferCallArg,
        _extension_additions_list_spec_for_OfferCallArg,
        _root_component_type_list_2_spec_for_OfferCallArg,
        undefined,
    );
    return new OfferCallArg(
        callingPartyID,
    ...
    return _cached_decoder_for_OfferCallArg(el);
}

let _cached_encoder_for_OfferCallArg: $.ASN1Encoder<OfferCallArg> | null = null;

/**
 * @summary Encodes a(n) OfferCallArg into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The OfferCallArg, encoded as an ASN.1 Element.
 */
export
function _encode_OfferCallArg (value: OfferCallArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_OfferCallArg) { _cached_encoder_for_OfferCallArg = function (value: OfferCallArg, elGetter: $.ASN1Encoder<OfferCallArg>): _Element {
    ...
    return _cached_encoder_for_OfferCallArg(value, elGetter);
}
