# Spam Control Protocol (SCPP) PDUs in TypeScript

ASN.1 data structures and PDUs based on the ASN.1 definitions in
[ITU-T Recommendation X.1243](https://www.itu.int/rec/T-REC-X.1243), which
defines the Spam Control Protocol (SCPP) for Interconnection of Gateways
to Combat Spam (IGCS).
