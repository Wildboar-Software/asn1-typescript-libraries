...
class TeletexDomainDefinedAttribute {
     ...
     */
    public static _from_object (_o: { [_K in keyof (TeletexDomainDefinedAttribute)]: (TeletexDomainDefinedAttribute)[_K] }): TeletexDomainDefinedAttribute {
 ...
 */
export
const _root_component_type_list_1_spec_for_TeletexDomainDefinedAttribute: $.ComponentSpec[] = [
    new $.ComponentSpec("type", false, $.hasTag(_TagClass.universal, 20)),
    new $.ComponentSpec("value", false, $.hasTag(_TagClass.universal, 20))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_TeletexDomainDefinedAttribute: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_TeletexDomainDefinedAttribute: $.ComponentSpec[] = [
 ...
 */
export
function _decode_TeletexDomainDefinedAttribute (el: _Element): TeletexDomainDefinedAttribute {
    if (!_cached_decoder_for_TeletexDomainDefinedAttribute) { _cached_decoder_for_TeletexDomainDefinedAttribute = function (el: _Element): TeletexDomainDefinedAttribute {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("TeletexDomainDefinedAttribute contained only " + sequence.length.toString() + " elements.");
    }
...
function _encode_TeletexDomainDefinedAttribute (value: TeletexDomainDefinedAttribute, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ $._encodeTeletexString(value.value, $.BER)
        ],
