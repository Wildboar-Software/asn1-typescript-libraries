...
class PDSParameter {
     ...
     */
    public static _from_object (_o: { [_K in keyof (PDSParameter)]: (PDSParameter)[_K] }): PDSParameter {
 ...
 */
export
const _root_component_type_list_1_spec_for_PDSParameter: $.ComponentSpec[] = [
    new $.ComponentSpec("printable-string", true, $.hasTag(_TagClass.universal, 19)),
 ...
 */
export
const _root_component_type_list_2_spec_for_PDSParameter: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PDSParameter: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PDSParameter (el: _Element): PDSParameter {
    if (!_cached_decoder_for_PDSParameter) { _cached_decoder_for_PDSParameter = function (el: _Element): PDSParameter {
    ...
    const callbacks: $.DecodingMap = {
        "printable-string": (_el: _Element): void => { printable_string = $._decodePrintableString(_el); },
