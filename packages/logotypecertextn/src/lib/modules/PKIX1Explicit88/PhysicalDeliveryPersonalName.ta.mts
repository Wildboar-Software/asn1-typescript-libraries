 ...
 */
export
function _decode_PhysicalDeliveryPersonalName (el: _Element): PhysicalDeliveryPersonalName {
    if (!_cached_decoder_for_PhysicalDeliveryPersonalName) { _cached_decoder_for_PhysicalDeliveryPersonalName = _decode_PDSParameter; }
 ...
 */
export
function _encode_PhysicalDeliveryPersonalName (value: PhysicalDeliveryPersonalName, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PhysicalDeliveryPersonalName) { _cached_encoder_for_PhysicalDeliveryPersonalName = _encode_PDSParameter; }
