...
function _decode_NetworkAddress (el: _Element): NetworkAddress {
    if (!_cached_decoder_for_NetworkAddress) { _cached_decoder_for_NetworkAddress = _decode_X121Address; }
...
function _encode_NetworkAddress (value: NetworkAddress, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_NetworkAddress) { _cached_encoder_for_NetworkAddress = _encode_X121Address; }
