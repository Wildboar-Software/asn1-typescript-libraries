...
/* START_OF_SYMBOL_DEFINITION invalidCalledNumber */
/**
 * @summary invalidCalledNumber
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 * @implements {ERROR}
 */
export const invalidCalledNumber: ERROR = {
    class: 'ERROR',
    decoderFor: {
...
/* END_OF_SYMBOL_DEFINITION invalidCalledNumber */
