 ...
 * @description
 *
 * Transaction-sublayer abort cause, `[APPLICATION 10]`,
 * constrained to `0..127`. Shall be present when the Abort
 * is generated by the Transaction sublayer (Table 7 note b).
 * Named values (Table 12): unrecognized message type (0),
 * unrecognized Transaction ID (1), badly formatted
 * Transaction Portion (2), incorrect Transaction Portion
 * (3), resource limitation (4). ITU-T Rec. Q.773 (06/97)
