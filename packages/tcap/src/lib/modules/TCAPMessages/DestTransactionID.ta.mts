 ...
 * @description
 *
 * Destination Transaction ID: 1–4 octets,
 * `[APPLICATION 9]` — the peer's originating ID. Present on
 * End, Continue, and Abort; absent on Unidirectional and
 * Begin. OCTET STRING must be primitive (§4.1.1). ITU-T Rec.
 * Q.773 (06/97)
 ...
 */
export function _decode_DestTransactionID(el: _Element): DestTransactionID {
