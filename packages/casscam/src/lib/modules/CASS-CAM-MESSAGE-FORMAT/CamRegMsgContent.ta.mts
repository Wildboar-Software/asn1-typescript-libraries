...
function _encode_CamRegMsgContent (value: CamRegMsgContent, elGetter: $.ASN1Encoder<CamRegMsgContent>) {
    if (!_cached_encoder_for_CamRegMsgContent) { _cached_encoder_for_CamRegMsgContent = function (value: CamRegMsgContent, elGetter: $.ASN1Encoder<CamRegMsgContent>): _Element {
