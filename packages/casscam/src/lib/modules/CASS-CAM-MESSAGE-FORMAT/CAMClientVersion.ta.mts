...
const _root_component_type_list_1_spec_for_CAMClientVersion: $.ComponentSpec[] = [
    new $.ComponentSpec("hWVersion", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("sWversion", false, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("cAMClientInfo", false, $.hasTag(_TagClass.context, 2))
];
 ...
 */
export
function _decode_CAMClientVersion (el: _Element): CAMClientVersion {
 ...
 */
export
function _encode_CAMClientVersion (value: CAMClientVersion, elGetter: $.ASN1Encoder<CAMClientVersion>): _Element {
