...
function _encode_RenewCnfMsgContent (value: RenewCnfMsgContent, elGetter: $.ASN1Encoder<RenewCnfMsgContent>) {
    if (!_cached_encoder_for_RenewCnfMsgContent) { _cached_encoder_for_RenewCnfMsgContent = function (value: RenewCnfMsgContent, elGetter: $.ASN1Encoder<RenewCnfMsgContent>): _Element {
