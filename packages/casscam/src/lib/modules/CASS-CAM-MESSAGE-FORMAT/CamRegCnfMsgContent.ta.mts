 ...
 */
export
function _decode_CamRegCnfMsgContent (el: _Element): CamRegCnfMsgContent {
 ...
 */
export
function _encode_CamRegCnfMsgContent (value: CamRegCnfMsgContent, elGetter: $.ASN1Encoder<CamRegCnfMsgContent>): _Element {
