...
function _encode_CamRegCnfMsgContent (value: CamRegCnfMsgContent, elGetter: $.ASN1Encoder<CamRegCnfMsgContent>) {
    if (!_cached_encoder_for_CamRegCnfMsgContent) { _cached_encoder_for_CamRegCnfMsgContent = function (value: CamRegCnfMsgContent, elGetter: $.ASN1Encoder<CamRegCnfMsgContent>): _Element {
