...
export { NoticeReference, _decode_NoticeReference, _encode_NoticeReference } from "../ETS-ElectronicSignatureFormats-ExplicitSyntax97/NoticeReference.ta.mjs";
...
export { DisplayText, _decode_DisplayText, _encode_DisplayText } from "../ETS-ElectronicSignatureFormats-ExplicitSyntax97/DisplayText.ta.mjs";
...
function _encode_SPUserNotice (value: SPUserNotice, elGetter: $.ASN1Encoder<SPUserNotice>) {
    if (!_cached_encoder_for_SPUserNotice) { _cached_encoder_for_SPUserNotice = function (value: SPUserNotice, elGetter: $.ASN1Encoder<SPUserNotice>): _Element {
