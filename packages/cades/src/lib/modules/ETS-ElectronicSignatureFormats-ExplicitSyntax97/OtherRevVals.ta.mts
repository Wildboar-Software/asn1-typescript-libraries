...
import { OTHER_REVOCATION_VAL } from "../ETS-ElectronicSignatureFormats-ExplicitSyntax97/OTHER-REVOCATION-VAL.oca.mjs";
export { OTHER_REVOCATION_VAL } from "../ETS-ElectronicSignatureFormats-ExplicitSyntax97/OTHER-REVOCATION-VAL.oca.mjs";
import { OTHER_REVOCATION_REF } from "../ETS-ElectronicSignatureFormats-ExplicitSyntax97/OTHER-REVOCATION-REF.oca.mjs";
export { OTHER_REVOCATION_REF } from "../ETS-ElectronicSignatureFormats-ExplicitSyntax97/OTHER-REVOCATION-REF.oca.mjs";
...
function _encode_OtherRevVals (value: OtherRevVals, elGetter: $.ASN1Encoder<OtherRevVals>) {
    if (!_cached_encoder_for_OtherRevVals) { _cached_encoder_for_OtherRevVals = function (value: OtherRevVals, elGetter: $.ASN1Encoder<OtherRevVals>): _Element {
