 ...
 */
export
function _decode_ClaimedAttributes (el: _Element): ClaimedAttributes {
 ...
 */
export
function _encode_ClaimedAttributes (value: ClaimedAttributes, elGetter: $.ASN1Encoder<ClaimedAttributes>): _Element {
