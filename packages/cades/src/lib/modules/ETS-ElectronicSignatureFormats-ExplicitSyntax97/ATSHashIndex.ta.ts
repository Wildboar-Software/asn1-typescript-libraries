...
import {
    id_sha256,
} from "@wildboar/x500/src/lib/modules/AlgorithmObjectIdentifiers/id-sha256.va.js";
...
function _encode_ATSHashIndex (value: ATSHashIndex, elGetter: $.ASN1Encoder<ATSHashIndex>) {
    if (!_cached_encoder_for_ATSHashIndex) { _cached_encoder_for_ATSHashIndex = function (value: ATSHashIndex, elGetter: $.ASN1Encoder<ATSHashIndex>): _Element {
