...
/* START_OF_SYMBOL_DEFINITION Version_v0 */
/**
 * @summary Version_v0
 * @constant
 * @type {number}
 */
export const Version_v0: Version = 0; /* LONG_NAMED_INTEGER_VALUE */
/* END_OF_SYMBOL_DEFINITION Version_v0 */
 ...
 * @type {number}
 */
export const v0: Version = Version_v0; /* SHORT_NAMED_INTEGER_VALUE */
