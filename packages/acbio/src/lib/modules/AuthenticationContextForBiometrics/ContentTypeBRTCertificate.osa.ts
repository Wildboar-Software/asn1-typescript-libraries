...
import { brtCertificate } from '../AuthenticationContextForBiometrics/brtCertificate.oa.js';
export { brtCertificate } from '../AuthenticationContextForBiometrics/brtCertificate.oa.js';
import type {
    CONTENT_TYPE,
