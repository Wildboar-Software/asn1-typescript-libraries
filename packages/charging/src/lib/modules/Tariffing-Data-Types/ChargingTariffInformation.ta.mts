...
function _encode_ChargingTariffInformation (value: ChargingTariffInformation, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ChargingTariffInformation) { _cached_encoder_for_ChargingTariffInformation = function (value: ChargingTariffInformation, elGetter: $.ASN1Encoder<ChargingTariffInformation>): _Element {
