 ...
 * @description
 *
 * Reads named attributes of objects in the selected group.
 * Same field pattern as F-READ-ATTRIB (ISO 8571-3:1988 §16.1).
 ...
 */
export function _decode_F_GROUP_LIST_request(el: _Element): F_GROUP_LIST_request {
