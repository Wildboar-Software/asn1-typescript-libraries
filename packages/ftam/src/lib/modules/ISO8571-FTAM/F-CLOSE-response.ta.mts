 ...
 * @description
 *
 * Confirm of F-CLOSE. Open always terminates. EFS `action-result`
 * is success or permanent error. Read or write FU; P-DATA.
 * ISO 8571-3:1988 §17.2 Table 22; ISO 8571-4:1988 Table 3.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
...
export class F_CLOSE_response {
  constructor(
     ...
     * @description
     *
     * EFS: success or permanent error. Open terminates regardless.
     * Default `success`. ISO 8571-3:1988 §17.2.2.1.
     *
     * @public
     * @readonly
     */
 ...
 */
export function _decode_F_CLOSE_response(el: _Element): F_CLOSE_response {
