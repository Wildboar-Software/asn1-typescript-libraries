 ...
 * @description
 *
 * IFS checkpoint acknowledgement (ISO 8571-3:1988 §25): data before
 * the marked point has been received and secured; no earlier point
 * will be requested in F-RESTART. Identifier 1..999998; the first
 * in a BDT is 1, then +1 (ISO 8571-3:1988 §23.2). ISO 8571-4:1988
 * Figure 9 has no F-CHECK FPDU — 1988 carries this on P-SYNC-MINOR
 * with no additional syntax. This SEQUENCE is a later/internal
 * encoding.
 *
 * ### ASN.1 Definition:
 *
