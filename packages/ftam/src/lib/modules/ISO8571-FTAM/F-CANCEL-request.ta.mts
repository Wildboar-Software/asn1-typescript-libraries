 ...
 * @description
 *
 * Either user may cancel during data transfer after F-READ/F-WRITE.
 * Preferred over F-U-ABORT in the EFS data phase (ISO 8571-3:1988
 * §14.3 note). File stays open; result of interrupted operations is
 * undefined. ISO 8571-3:1988 §24.6 Table 38.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
...
export class F_CANCEL_request {
  constructor(
     ...
     * @description
     *
     * Together with diagnostic, the reason for the cancel. Default
     * `success`. ISO 8571-3:1988 §13.2, §24.6.2.1.
     *
     * @public
     * @readonly
     */
     ...
     * @description
     *
     * Together with action-result, the reason for the cancel
     * (ISO 8571-3:1988 §13.13, §24.6.2.3).
     *
     * @public
     * @readonly
     */
