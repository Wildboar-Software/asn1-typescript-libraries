...
/* START_OF_SYMBOL_DEFINITION F_CHANGE_LINK_ATTRIB_response */
/**
...
/* END_OF_SYMBOL_DEFINITION F_CHANGE_LINK_ATTRIB_response */

/* START_OF_SYMBOL_DEFINITION _root_component_type_list_1_spec_for_F_CHANGE_LINK_ATTRIB_response */
/**
...
/* END_OF_SYMBOL_DEFINITION _root_component_type_list_1_spec_for_F_CHANGE_LINK_ATTRIB_response */

/* START_OF_SYMBOL_DEFINITION _root_component_type_list_2_spec_for_F_CHANGE_LINK_ATTRIB_response */
/**
...
/* END_OF_SYMBOL_DEFINITION _root_component_type_list_2_spec_for_F_CHANGE_LINK_ATTRIB_response */

/* START_OF_SYMBOL_DEFINITION _extension_additions_list_spec_for_F_CHANGE_LINK_ATTRIB_response */
/**
...
/* END_OF_SYMBOL_DEFINITION _extension_additions_list_spec_for_F_CHANGE_LINK_ATTRIB_response */

/* START_OF_SYMBOL_DEFINITION _cached_decoder_for_F_CHANGE_LINK_ATTRIB_response */
let _cached_decoder_for_F_CHANGE_LINK_ATTRIB_response: $.ASN1Decoder<F_CHANGE_LINK_ATTRIB_response> | null = null;
/* END_OF_SYMBOL_DEFINITION _cached_decoder_for_F_CHANGE_LINK_ATTRIB_response */

/* START_OF_SYMBOL_DEFINITION _decode_F_CHANGE_LINK_ATTRIB_response */
/**
 ...
 */
export function _decode_F_CHANGE_LINK_ATTRIB_response(el: _Element) {
  if (!_cached_decoder_for_F_CHANGE_LINK_ATTRIB_response) {
    _cached_decoder_for_F_CHANGE_LINK_ATTRIB_response = function (
      ...
      return new F_CHANGE_LINK_ATTRIB_response /* SEQUENCE_CONSTRUCTOR_CALL */(
        action_result,
        attributes,
        diagnostic
      );
...
/* END_OF_SYMBOL_DEFINITION _decode_F_CHANGE_LINK_ATTRIB_response */

/* START_OF_SYMBOL_DEFINITION _cached_encoder_for_F_CHANGE_LINK_ATTRIB_response */
let _cached_encoder_for_F_CHANGE_LINK_ATTRIB_response: $.ASN1Encoder<F_CHANGE_LINK_ATTRIB_response> | null = null;
/* END_OF_SYMBOL_DEFINITION _cached_encoder_for_F_CHANGE_LINK_ATTRIB_response */

/* START_OF_SYMBOL_DEFINITION _encode_F_CHANGE_LINK_ATTRIB_response */
/**
...
/* END_OF_SYMBOL_DEFINITION _encode_F_CHANGE_LINK_ATTRIB_response */
