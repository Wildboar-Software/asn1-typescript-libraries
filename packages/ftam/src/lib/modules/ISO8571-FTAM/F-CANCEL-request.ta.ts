...
} from '../ISO8571-FTAM/Request-Type.ta.js';
export {
  Request_Type,
  _decode_Request_Type,
  _encode_Request_Type,
...
/* START_OF_SYMBOL_DEFINITION F_CANCEL_request */
/**
 * @summary F_CANCEL_request
 * @description
 *
 * ### ASN.1 Definition:
 *
...
export class F_CANCEL_request {
  ...
  /**
   * @summary Restructures an object into a F_CANCEL_request
   * @description
   *
   * This takes an `object` and converts it to a `F_CANCEL_request`.
   *
   * @public
   * @static
   * @method
   * @param {Object} _o An object having all of the keys and values of a `F_CANCEL_request`.
   * @returns {F_CANCEL_request}
   */
  public static _from_object(
    _o: { [_K in keyof F_CANCEL_request]: F_CANCEL_request[_K] }
  ): F_CANCEL_request {
...
/* END_OF_SYMBOL_DEFINITION F_CANCEL_request */

/* START_OF_SYMBOL_DEFINITION _root_component_type_list_1_spec_for_F_CANCEL_request */
/**
 * @summary The Leading Root Component Types of F_CANCEL_request
 * @description
 *
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_F_CANCEL_request: $.ComponentSpec[] = [
  new $.ComponentSpec(
    'action-result',
    true,
...
/* END_OF_SYMBOL_DEFINITION _root_component_type_list_1_spec_for_F_CANCEL_request */

/* START_OF_SYMBOL_DEFINITION _root_component_type_list_2_spec_for_F_CANCEL_request */
/**
 * @summary The Trailing Root Component Types of F_CANCEL_request
 * @description
 *
 ...
 * @constant
 */
export const _root_component_type_list_2_spec_for_F_CANCEL_request: $.ComponentSpec[] = [];
/* END_OF_SYMBOL_DEFINITION _root_component_type_list_2_spec_for_F_CANCEL_request */

/* START_OF_SYMBOL_DEFINITION _extension_additions_list_spec_for_F_CANCEL_request */
/**
 * @summary The Extension Addition Component Types of F_CANCEL_request
 * @description
 *
 ...
 * @constant
 */
export const _extension_additions_list_spec_for_F_CANCEL_request: $.ComponentSpec[] = [];
/* END_OF_SYMBOL_DEFINITION _extension_additions_list_spec_for_F_CANCEL_request */

/* START_OF_SYMBOL_DEFINITION _cached_decoder_for_F_CANCEL_request */
let _cached_decoder_for_F_CANCEL_request: $.ASN1Decoder<F_CANCEL_request> | null = null;
/* END_OF_SYMBOL_DEFINITION _cached_decoder_for_F_CANCEL_request */

/* START_OF_SYMBOL_DEFINITION _decode_F_CANCEL_request */
/**
 * @summary Decodes an ASN.1 element into a(n) F_CANCEL_request
 * @function
...
export function _decode_F_CANCEL_request(el: _Element) {
  if (!_cached_decoder_for_F_CANCEL_request) {
    _cached_decoder_for_F_CANCEL_request = function (
      ...
      $._parse_sequence(
        el,
        callbacks,
        _root_component_type_list_1_spec_for_F_CANCEL_request,
        _extension_additions_list_spec_for_F_CANCEL_request,
  ...
  return _cached_decoder_for_F_CANCEL_request(el);
}
/* END_OF_SYMBOL_DEFINITION _decode_F_CANCEL_request */

/* START_OF_SYMBOL_DEFINITION _cached_encoder_for_F_CANCEL_request */
let _cached_encoder_for_F_CANCEL_request: $.ASN1Encoder<F_CANCEL_request> | null = null;
/* END_OF_SYMBOL_DEFINITION _cached_encoder_for_F_CANCEL_request */

/* START_OF_SYMBOL_DEFINITION _encode_F_CANCEL_request */
/**
 * @summary Encodes a(n) F_CANCEL_request into an ASN.1 Element.
 * @function
 * @param {value} el The element being decoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The F_CANCEL_request, encoded as an ASN.1 Element.
 */
export function _encode_F_CANCEL_request(
      ...
      return $._encodeSequence(
        ([] as (_Element | undefined)[])
          .concat([
            ...
            /* REQUIRED   */ _encode_Request_Type(value.request_type, $.BER),
  ...
  return _cached_encoder_for_F_CANCEL_request(value, elGetter);
}

/* END_OF_SYMBOL_DEFINITION _encode_F_CANCEL_request */
