 ...
 * @description
 *
 * Restart a BDT after a class I error (IFS; restart-data-transfer
 * FU). Checkpoint identifier: 0 = beginning of FADU; 1..999998;
 * one past the last checkpoint = end of transfer.
