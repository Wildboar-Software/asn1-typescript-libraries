 ...
 */
export
function _decode_PosteRestanteAddress (el: _Element): PosteRestanteAddress {
    if (!_cached_decoder_for_PosteRestanteAddress) { _cached_decoder_for_PosteRestanteAddress = _decode_PDSParameter; }
 ...
 */
export
function _encode_PosteRestanteAddress (value: PosteRestanteAddress, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PosteRestanteAddress) { _cached_encoder_for_PosteRestanteAddress = _encode_PDSParameter; }
