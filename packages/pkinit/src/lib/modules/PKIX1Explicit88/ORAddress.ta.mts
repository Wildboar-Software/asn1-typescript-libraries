...
class ORAddress {
     ...
     * @returns {ORAddress}
     */
    public static _from_object (_o: { [_K in keyof (ORAddress)]: (ORAddress)[_K] }): ORAddress {
 ...
 */
export
const _root_component_type_list_1_spec_for_ORAddress: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ORAddress: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ORAddress: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ORAddress (el: _Element): ORAddress {
    if (!_cached_decoder_for_ORAddress) { _cached_decoder_for_ORAddress = function (el: _Element): ORAddress {
    ...
    const callbacks: $.DecodingMap = {
        "built-in-standard-attributes": (_el: _Element): void => { built_in_standard_attributes = _decode_BuiltInStandardAttributes(_el); },
        "built-in-domain-defined-attributes": (_el: _Element): void => { built_in_domain_defined_attributes = _decode_BuiltInDomainDefinedAttributes(_el); },
        "extension-attributes": (_el: _Element): void => { extension_attributes = _decode_ExtensionAttributes(_el); }
    };
...
function _encode_ORAddress (value: ORAddress, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.built_in_domain_defined_attributes === undefined) ? undefined : _encode_BuiltInDomainDefinedAttributes(value.built_in_domain_defined_attributes, $.BER)),
            /* IF_ABSENT  */ ((value.extension_attributes === undefined) ? undefined : _encode_ExtensionAttributes(value.extension_attributes, $.BER))
        ],
