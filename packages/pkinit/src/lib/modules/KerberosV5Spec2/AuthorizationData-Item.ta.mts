...
class AuthorizationData_Item {
     ...
     */
    public static _from_object (_o: { [_K in keyof (AuthorizationData_Item)]: (AuthorizationData_Item)[_K] }): AuthorizationData_Item {
 ...
 */
export
const _root_component_type_list_1_spec_for_AuthorizationData_Item: $.ComponentSpec[] = [
    new $.ComponentSpec("ad-type", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("ad-data", false, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_AuthorizationData_Item: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AuthorizationData_Item: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AuthorizationData_Item (el: _Element): AuthorizationData_Item {
    if (!_cached_decoder_for_AuthorizationData_Item) { _cached_decoder_for_AuthorizationData_Item = function (el: _Element): AuthorizationData_Item {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("AuthorizationData-Item contained only " + sequence.length.toString() + " elements.");
    }
    ...
    ad_data = $._decode_explicit<OCTET_STRING>(() => $._decodeOctetString)(sequence[1]);
 ...
 */
export
function _encode_AuthorizationData_Item (value: AuthorizationData_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AuthorizationData_Item) { _cached_encoder_for_AuthorizationData_Item = function (value: AuthorizationData_Item, elGetter: $.ASN1Encoder<AuthorizationData_Item>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_Int32, $.BER)(value.ad_type, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 1, () => $._encodeOctetString, $.BER)(value.ad_data, $.BER)
        ],
