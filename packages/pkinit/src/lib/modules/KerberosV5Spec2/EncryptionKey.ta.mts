...
class EncryptionKey {
     ...
     */
    public static _from_object (_o: { [_K in keyof (EncryptionKey)]: (EncryptionKey)[_K] }): EncryptionKey {
 ...
 */
export
const _root_component_type_list_1_spec_for_EncryptionKey: $.ComponentSpec[] = [
    new $.ComponentSpec("keytype", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("keyvalue", false, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_EncryptionKey: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_EncryptionKey: $.ComponentSpec[] = [
 ...
 */
export
function _decode_EncryptionKey (el: _Element): EncryptionKey {
    if (!_cached_decoder_for_EncryptionKey) { _cached_decoder_for_EncryptionKey = function (el: _Element): EncryptionKey {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("EncryptionKey contained only " + sequence.length.toString() + " elements.");
    }
    ...
    keyvalue = $._decode_explicit<OCTET_STRING>(() => $._decodeOctetString)(sequence[1]);
 ...
 */
export
function _encode_EncryptionKey (value: EncryptionKey, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EncryptionKey) { _cached_encoder_for_EncryptionKey = function (value: EncryptionKey, elGetter: $.ASN1Encoder<EncryptionKey>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_Int32, $.BER)(value.keytype, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 1, () => $._encodeOctetString, $.BER)(value.keyvalue, $.BER)
        ],
