...
class TYPED_DATA_Item {
     ...
     */
    public static _from_object (_o: { [_K in keyof (TYPED_DATA_Item)]: (TYPED_DATA_Item)[_K] }): TYPED_DATA_Item {
 ...
 */
export
const _root_component_type_list_1_spec_for_TYPED_DATA_Item: $.ComponentSpec[] = [
    new $.ComponentSpec("data-type", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("data-value", true, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_TYPED_DATA_Item: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_TYPED_DATA_Item: $.ComponentSpec[] = [
 ...
 */
export
function _decode_TYPED_DATA_Item (el: _Element): TYPED_DATA_Item {
    if (!_cached_decoder_for_TYPED_DATA_Item) { _cached_decoder_for_TYPED_DATA_Item = function (el: _Element): TYPED_DATA_Item {
    let data_type!: Int32;
    let data_value: OPTIONAL<OCTET_STRING>;
    const callbacks: $.DecodingMap = {
        "data-type": (_el: _Element): void => { data_type = $._decode_explicit<Int32>(() => _decode_Int32)(_el); },
        "data-value": (_el: _Element): void => { data_value = $._decode_explicit<OCTET_STRING>(() => $._decodeOctetString)(_el); }
    };
 ...
 */
export
function _encode_TYPED_DATA_Item (value: TYPED_DATA_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TYPED_DATA_Item) { _cached_encoder_for_TYPED_DATA_Item = function (value: TYPED_DATA_Item, elGetter: $.ASN1Encoder<TYPED_DATA_Item>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_Int32, $.BER)(value.data_type, $.BER),
            /* IF_ABSENT  */ ((value.data_value === undefined) ? undefined : $._encode_explicit(_TagClass.context, 1, () => $._encodeOctetString, $.BER)(value.data_value, $.BER))
        ],
