...
class HostAddress {
     ...
     * @returns {HostAddress}
     */
    public static _from_object (_o: { [_K in keyof (HostAddress)]: (HostAddress)[_K] }): HostAddress {
 ...
 */
export
const _root_component_type_list_1_spec_for_HostAddress: $.ComponentSpec[] = [
    new $.ComponentSpec("addr-type", false, $.hasTag(_TagClass.context, 0)),
 ...
 */
export
const _root_component_type_list_2_spec_for_HostAddress: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_HostAddress: $.ComponentSpec[] = [
 ...
 */
export
function _decode_HostAddress (el: _Element): HostAddress {
    if (!_cached_decoder_for_HostAddress) { _cached_decoder_for_HostAddress = function (el: _Element): HostAddress {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("HostAddress contained only " + sequence.length.toString() + " elements.");
    }
    ...
    address = $._decode_explicit<OCTET_STRING>(() => $._decodeOctetString)(sequence[1]);
 ...
 */
export
function _encode_HostAddress (value: HostAddress, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_HostAddress) { _cached_encoder_for_HostAddress = function (value: HostAddress, elGetter: $.ASN1Encoder<HostAddress>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_Int32, $.BER)(value.addr_type, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 1, () => $._encodeOctetString, $.BER)(value.address, $.BER)
        ],
