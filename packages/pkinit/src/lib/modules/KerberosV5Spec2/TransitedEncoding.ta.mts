...
class TransitedEncoding {
     ...
     */
    public static _from_object (_o: { [_K in keyof (TransitedEncoding)]: (TransitedEncoding)[_K] }): TransitedEncoding {
 ...
 */
export
const _root_component_type_list_1_spec_for_TransitedEncoding: $.ComponentSpec[] = [
    new $.ComponentSpec("tr-type", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("contents", false, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_TransitedEncoding: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_TransitedEncoding: $.ComponentSpec[] = [
 ...
 */
export
function _decode_TransitedEncoding (el: _Element): TransitedEncoding {
    if (!_cached_decoder_for_TransitedEncoding) { _cached_decoder_for_TransitedEncoding = function (el: _Element): TransitedEncoding {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("TransitedEncoding contained only " + sequence.length.toString() + " elements.");
    }
    ...
    contents = $._decode_explicit<OCTET_STRING>(() => $._decodeOctetString)(sequence[1]);
    return new TransitedEncoding(
        tr_type,
        contents,
 ...
 */
export
function _encode_TransitedEncoding (value: TransitedEncoding, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TransitedEncoding) { _cached_encoder_for_TransitedEncoding = function (value: TransitedEncoding, elGetter: $.ASN1Encoder<TransitedEncoding>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_Int32, $.BER)(value.tr_type, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 1, () => $._encodeOctetString, $.BER)(value.contents, $.BER)
        ],
