...
class AD_AND_OR {
     ...
     * @returns {AD_AND_OR}
     */
    public static _from_object (_o: { [_K in keyof (AD_AND_OR)]: (AD_AND_OR)[_K] }): AD_AND_OR {
 ...
 */
export
const _root_component_type_list_1_spec_for_AD_AND_OR: $.ComponentSpec[] = [
    new $.ComponentSpec("condition-count", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("elements", false, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_AD_AND_OR: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AD_AND_OR: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AD_AND_OR (el: _Element): AD_AND_OR {
    if (!_cached_decoder_for_AD_AND_OR) { _cached_decoder_for_AD_AND_OR = function (el: _Element): AD_AND_OR {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("AD-AND-OR contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "condition-count";
    sequence[1].name = "elements";
    let condition_count!: Int32;
    let elements!: AuthorizationData;
    condition_count = $._decode_explicit<Int32>(() => _decode_Int32)(sequence[0]);
    elements = $._decode_explicit<AuthorizationData>(() => _decode_AuthorizationData)(sequence[1]);
    return new AD_AND_OR(
        condition_count,
        elements,
 ...
 */
export
function _encode_AD_AND_OR (value: AD_AND_OR, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AD_AND_OR) { _cached_encoder_for_AD_AND_OR = function (value: AD_AND_OR, elGetter: $.ASN1Encoder<AD_AND_OR>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_Int32, $.BER)(value.condition_count, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 1, () => _encode_AuthorizationData, $.BER)(value.elements, $.BER)
        ],
