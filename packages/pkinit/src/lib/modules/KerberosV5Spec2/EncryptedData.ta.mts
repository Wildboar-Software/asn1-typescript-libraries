...
const _root_component_type_list_1_spec_for_EncryptedData: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("kvno", true, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("cipher", false, $.hasTag(_TagClass.context, 2))
];
...
function _decode_EncryptedData (el: _Element): EncryptedData {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "kvno": (_el: _Element): void => { kvno = $._decode_explicit<UInt32>(() => _decode_UInt32)(_el); },
        "cipher": (_el: _Element): void => { cipher = $._decode_explicit<OCTET_STRING>(() => $._decodeOctetString)(_el); }
    };
...
function _encode_EncryptedData (value: EncryptedData, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.kvno === undefined) ? undefined : $._encode_explicit(_TagClass.context, 1, () => _encode_UInt32, $.BER)(value.kvno, $.BER)),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 2, () => $._encodeOctetString, $.BER)(value.cipher, $.BER)
        ],
