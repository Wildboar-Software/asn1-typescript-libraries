...
class LastReq_Item {
     ...
     */
    public static _from_object (_o: { [_K in keyof (LastReq_Item)]: (LastReq_Item)[_K] }): LastReq_Item {
 ...
 */
export
const _root_component_type_list_1_spec_for_LastReq_Item: $.ComponentSpec[] = [
    new $.ComponentSpec("lr-type", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("lr-value", false, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_LastReq_Item: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_LastReq_Item: $.ComponentSpec[] = [
 ...
 */
export
function _decode_LastReq_Item (el: _Element): LastReq_Item {
    if (!_cached_decoder_for_LastReq_Item) { _cached_decoder_for_LastReq_Item = function (el: _Element): LastReq_Item {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("LastReq-Item contained only " + sequence.length.toString() + " elements.");
    }
    ...
    lr_value = $._decode_explicit<KerberosTime>(() => _decode_KerberosTime)(sequence[1]);
    return new LastReq_Item(
        lr_type,
        lr_value,
 ...
 */
export
function _encode_LastReq_Item (value: LastReq_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_LastReq_Item) { _cached_encoder_for_LastReq_Item = function (value: LastReq_Item, elGetter: $.ASN1Encoder<LastReq_Item>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_Int32, $.BER)(value.lr_type, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 1, () => _encode_KerberosTime, $.BER)(value.lr_value, $.BER)
        ],
