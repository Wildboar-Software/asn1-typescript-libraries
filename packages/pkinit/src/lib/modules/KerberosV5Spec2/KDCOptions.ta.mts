 ...
 */
export
type KDCOptions = KerberosFlags; // DefinedType
 ...
 */
export
function _decode_KDCOptions (el: _Element): KDCOptions {
    if (!_cached_decoder_for_KDCOptions) { _cached_decoder_for_KDCOptions = _decode_KerberosFlags; }
 ...
 */
export
function _encode_KDCOptions (value: KDCOptions, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_KDCOptions) { _cached_encoder_for_KDCOptions = _encode_KerberosFlags; }
