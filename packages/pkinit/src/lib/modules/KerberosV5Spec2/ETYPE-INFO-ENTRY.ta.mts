...
class ETYPE_INFO_ENTRY {
     ...
     */
    public static _from_object (_o: { [_K in keyof (ETYPE_INFO_ENTRY)]: (ETYPE_INFO_ENTRY)[_K] }): ETYPE_INFO_ENTRY {
 ...
 */
export
const _root_component_type_list_1_spec_for_ETYPE_INFO_ENTRY: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ETYPE_INFO_ENTRY: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ETYPE_INFO_ENTRY: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ETYPE_INFO_ENTRY (el: _Element): ETYPE_INFO_ENTRY {
    if (!_cached_decoder_for_ETYPE_INFO_ENTRY) { _cached_decoder_for_ETYPE_INFO_ENTRY = function (el: _Element): ETYPE_INFO_ENTRY {
    let etype!: Int32;
    let salt: OPTIONAL<OCTET_STRING>;
    const callbacks: $.DecodingMap = {
        "etype": (_el: _Element): void => { etype = $._decode_explicit<Int32>(() => _decode_Int32)(_el); },
        "salt": (_el: _Element): void => { salt = $._decode_explicit<OCTET_STRING>(() => $._decodeOctetString)(_el); }
    };
 ...
 */
export
function _encode_ETYPE_INFO_ENTRY (value: ETYPE_INFO_ENTRY, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ETYPE_INFO_ENTRY) { _cached_encoder_for_ETYPE_INFO_ENTRY = function (value: ETYPE_INFO_ENTRY, elGetter: $.ASN1Encoder<ETYPE_INFO_ENTRY>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => _encode_Int32, $.BER)(value.etype, $.BER),
            /* IF_ABSENT  */ ((value.salt === undefined) ? undefined : $._encode_explicit(_TagClass.context, 1, () => $._encodeOctetString, $.BER)(value.salt, $.BER))
        ],
