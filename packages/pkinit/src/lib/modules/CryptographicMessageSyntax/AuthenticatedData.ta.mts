...
import { CMSVersion, _decode_CMSVersion, _encode_CMSVersion } from "../CryptographicMessageSyntax/CMSVersion.ta.mjs";
// export { CMSVersion, CMSVersion_v0 /* IMPORTED_LONG_NAMED_INTEGER */, v0 /* IMPORTED_SHORT_NAMED_INTEGER */, CMSVersion_v1 /* IMPORTED_LONG_NAMED_INTEGER */, v1 /* IMPORTED_SHORT_NAMED_INTEGER */, CMSVersion_v2 /* IMPORTED_LONG_NAMED_INTEGER */, v2 /* IMPORTED_SHORT_NAMED_INTEGER */, CMSVersion_v3 /* IMPORTED_LONG_NAMED_INTEGER */, v3 /* IMPORTED_SHORT_NAMED_INTEGER */, CMSVersion_v4 /* IMPORTED_LONG_NAMED_INTEGER */, v4 /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_CMSVersion, _encode_CMSVersion } from "../CryptographicMessageSyntax/CMSVersion.ta.mjs";
import { OriginatorInfo, _decode_OriginatorInfo, _encode_OriginatorInfo } from "../CryptographicMessageSyntax/OriginatorInfo.ta.mjs";
// export { OriginatorInfo, _decode_OriginatorInfo, _encode_OriginatorInfo } from "../CryptographicMessageSyntax/OriginatorInfo.ta.mjs";
import { RecipientInfos, _decode_RecipientInfos, _encode_RecipientInfos } from "../CryptographicMessageSyntax/RecipientInfos.ta.mjs";
// export { RecipientInfos, _decode_RecipientInfos, _encode_RecipientInfos } from "../CryptographicMessageSyntax/RecipientInfos.ta.mjs";
import { MessageAuthenticationCodeAlgorithm, _decode_MessageAuthenticationCodeAlgorithm, _encode_MessageAuthenticationCodeAlgorithm } from "../CryptographicMessageSyntax/MessageAuthenticationCodeAlgorithm.ta.mjs";
// export { MessageAuthenticationCodeAlgorithm, _decode_MessageAuthenticationCodeAlgorithm, _encode_MessageAuthenticationCodeAlgorithm } from "../CryptographicMessageSyntax/MessageAuthenticationCodeAlgorithm.ta.mjs";
import { DigestAlgorithmIdentifier, _decode_DigestAlgorithmIdentifier, _encode_DigestAlgorithmIdentifier } from "../CryptographicMessageSyntax/DigestAlgorithmIdentifier.ta.mjs";
// export { DigestAlgorithmIdentifier, _decode_DigestAlgorithmIdentifier, _encode_DigestAlgorithmIdentifier } from "../CryptographicMessageSyntax/DigestAlgorithmIdentifier.ta.mjs";
import { EncapsulatedContentInfo, _decode_EncapsulatedContentInfo, _encode_EncapsulatedContentInfo } from "../CryptographicMessageSyntax/EncapsulatedContentInfo.ta.mjs";
// export { EncapsulatedContentInfo, _decode_EncapsulatedContentInfo, _encode_EncapsulatedContentInfo } from "../CryptographicMessageSyntax/EncapsulatedContentInfo.ta.mjs";
import { AuthAttributes, _decode_AuthAttributes, _encode_AuthAttributes } from "../CryptographicMessageSyntax/AuthAttributes.ta.mjs";
// export { AuthAttributes, _decode_AuthAttributes, _encode_AuthAttributes } from "../CryptographicMessageSyntax/AuthAttributes.ta.mjs";
import { MessageAuthenticationCode, _decode_MessageAuthenticationCode, _encode_MessageAuthenticationCode } from "../CryptographicMessageSyntax/MessageAuthenticationCode.ta.mjs";
// export { MessageAuthenticationCode, _decode_MessageAuthenticationCode, _encode_MessageAuthenticationCode } from "../CryptographicMessageSyntax/MessageAuthenticationCode.ta.mjs";
import { UnauthAttributes, _decode_UnauthAttributes, _encode_UnauthAttributes } from "../CryptographicMessageSyntax/UnauthAttributes.ta.mjs";
// export { UnauthAttributes, _decode_UnauthAttributes, _encode_UnauthAttributes } from "../CryptographicMessageSyntax/UnauthAttributes.ta.mjs";
...
class AuthenticatedData {
    ...
    public static _from_object (_o: { [_K in keyof (AuthenticatedData)]: (AuthenticatedData)[_K] }): AuthenticatedData {
        return new AuthenticatedData(_o.version, _o.originatorInfo, _o.recipientInfos, _o.macAlgorithm, _o.digestAlgorithm, _o.encapContentInfo, _o.authenticatedAttributes, _o.mac, _o.unauthenticatedAttributes);
    }
...
const _root_component_type_list_1_spec_for_AuthenticatedData: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("authenticatedAttributes", true, $.hasTag(_TagClass.context, 2)),
    new $.ComponentSpec("mac", false, $.hasTag(_TagClass.universal, 4)),
    new $.ComponentSpec("unauthenticatedAttributes", true, $.hasTag(_TagClass.context, 3))
];
...
function _decode_AuthenticatedData (el: _Element): AuthenticatedData {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "authenticatedAttributes": (_el: _Element): void => { authenticatedAttributes = $._decode_implicit<AuthAttributes>(() => _decode_AuthAttributes)(_el); },
        "mac": (_el: _Element): void => { mac = _decode_MessageAuthenticationCode(_el); },
        "unauthenticatedAttributes": (_el: _Element): void => { unauthenticatedAttributes = $._decode_implicit<UnauthAttributes>(() => _decode_UnauthAttributes)(_el); }
    };
...
function _encode_AuthenticatedData (value: AuthenticatedData, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.authenticatedAttributes === undefined) ? undefined : $._encode_implicit(_TagClass.context, 2, () => _encode_AuthAttributes, $.BER)(value.authenticatedAttributes, $.BER)),
            /* REQUIRED   */ _encode_MessageAuthenticationCode(value.mac, $.BER),
            /* IF_ABSENT  */ ((value.unauthenticatedAttributes === undefined) ? undefined : $._encode_implicit(_TagClass.context, 3, () => _encode_UnauthAttributes, $.BER)(value.unauthenticatedAttributes, $.BER))
        ],
