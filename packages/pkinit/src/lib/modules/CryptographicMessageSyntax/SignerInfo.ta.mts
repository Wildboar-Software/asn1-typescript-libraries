...
import { SignerIdentifier, _decode_SignerIdentifier, _encode_SignerIdentifier } from "../CryptographicMessageSyntax/SignerIdentifier.ta.mjs";
// export { SignerIdentifier, _decode_SignerIdentifier, _encode_SignerIdentifier } from "../CryptographicMessageSyntax/SignerIdentifier.ta.mjs";
...
import { SignedAttributes, _decode_SignedAttributes, _encode_SignedAttributes } from "../CryptographicMessageSyntax/SignedAttributes.ta.mjs";
// export { SignedAttributes, _decode_SignedAttributes, _encode_SignedAttributes } from "../CryptographicMessageSyntax/SignedAttributes.ta.mjs";
import { SignatureAlgorithmIdentifier, _decode_SignatureAlgorithmIdentifier, _encode_SignatureAlgorithmIdentifier } from "../CryptographicMessageSyntax/SignatureAlgorithmIdentifier.ta.mjs";
// export { SignatureAlgorithmIdentifier, _decode_SignatureAlgorithmIdentifier, _encode_SignatureAlgorithmIdentifier } from "../CryptographicMessageSyntax/SignatureAlgorithmIdentifier.ta.mjs";
import { SignatureValue, _decode_SignatureValue, _encode_SignatureValue } from "../CryptographicMessageSyntax/SignatureValue.ta.mjs";
// export { SignatureValue, _decode_SignatureValue, _encode_SignatureValue } from "../CryptographicMessageSyntax/SignatureValue.ta.mjs";
import { UnsignedAttributes, _decode_UnsignedAttributes, _encode_UnsignedAttributes } from "../CryptographicMessageSyntax/UnsignedAttributes.ta.mjs";
// export { UnsignedAttributes, _decode_UnsignedAttributes, _encode_UnsignedAttributes } from "../CryptographicMessageSyntax/UnsignedAttributes.ta.mjs";
...
const _root_component_type_list_1_spec_for_SignerInfo: $.ComponentSpec[] = [
    ...
    /* FIXME: signatureAlgorithm COULD_NOT_RESOLVE_TYPE_DEF */,
...
function _decode_SignerInfo (el: _Element): SignerInfo {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "sid": (_el: _Element): void => { sid = _decode_SignerIdentifier(_el); },
        "digestAlgorithm": (_el: _Element): void => { digestAlgorithm = _decode_DigestAlgorithmIdentifier(_el); },
        "signedAttrs": (_el: _Element): void => { signedAttrs = $._decode_implicit<SignedAttributes>(() => _decode_SignedAttributes)(_el); },
        "signatureAlgorithm": (_el: _Element): void => { signatureAlgorithm = _decode_SignatureAlgorithmIdentifier(_el); },
        "signature": (_el: _Element): void => { signature = _decode_SignatureValue(_el); },
        "unsignedAttrs": (_el: _Element): void => { unsignedAttrs = $._decode_implicit<UnsignedAttributes>(() => _decode_UnsignedAttributes)(_el); }
    };
...
function _encode_SignerInfo (value: SignerInfo, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.signedAttrs === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => _encode_SignedAttributes, $.BER)(value.signedAttrs, $.BER)),
            ...
            /* IF_ABSENT  */ ((value.unsignedAttrs === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => _encode_UnsignedAttributes, $.BER)(value.unsignedAttrs, $.BER))
        ],
