 ...
 */
export
type CertificateRevocationLists = CertificateList[]; // SetOfType
 ...
 */
export
function _decode_CertificateRevocationLists (el: _Element): CertificateRevocationLists {
    if (!_cached_decoder_for_CertificateRevocationLists) { _cached_decoder_for_CertificateRevocationLists = $._decodeSetOf<CertificateList>(() => _decode_CertificateList); }
 ...
 */
export
function _encode_CertificateRevocationLists (value: CertificateRevocationLists, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CertificateRevocationLists) { _cached_encoder_for_CertificateRevocationLists = $._encodeSetOf<CertificateList>(() => _encode_CertificateList, $.BER); }
