 ...
 */
export
type KeyWrapAlgorithm = AlgorithmIdentifier; // DefinedType
 ...
 */
export
function _decode_KeyWrapAlgorithm (el: _Element): KeyWrapAlgorithm {
 ...
 */
export
function _encode_KeyWrapAlgorithm (value: KeyWrapAlgorithm, elGetter: $.ASN1Encoder<any>): _Element {
