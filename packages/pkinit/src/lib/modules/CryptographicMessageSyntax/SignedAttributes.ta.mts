...
function _decode_SignedAttributes (el: _Element): SignedAttributes {
    if (!_cached_decoder_for_SignedAttributes) { _cached_decoder_for_SignedAttributes = $._decodeSetOf<Attribute>(() => _decode_Attribute); }
...
function _encode_SignedAttributes (value: SignedAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SignedAttributes) { _cached_encoder_for_SignedAttributes = $._encodeSetOf<Attribute>(() => _encode_Attribute, $.BER); }
