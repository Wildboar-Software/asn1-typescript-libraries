 ...
 */
export
type MessageAuthenticationCodeAlgorithm = AlgorithmIdentifier; // DefinedType
 ...
 */
export
function _decode_MessageAuthenticationCodeAlgorithm (el: _Element): MessageAuthenticationCodeAlgorithm {
 ...
 */
export
function _encode_MessageAuthenticationCodeAlgorithm (value: MessageAuthenticationCodeAlgorithm, elGetter: $.ASN1Encoder<any>): _Element {
