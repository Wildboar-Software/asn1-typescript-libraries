 ...
 */
export
type UnprotectedAttributes = Attribute[]; // SetOfType
 ...
 */
export
function _decode_UnprotectedAttributes (el: _Element): UnprotectedAttributes {
    if (!_cached_decoder_for_UnprotectedAttributes) { _cached_decoder_for_UnprotectedAttributes = $._decodeSetOf<Attribute>(() => _decode_Attribute); }
 ...
 */
export
function _encode_UnprotectedAttributes (value: UnprotectedAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnprotectedAttributes) { _cached_encoder_for_UnprotectedAttributes = $._encodeSetOf<Attribute>(() => _encode_Attribute, $.BER); }
