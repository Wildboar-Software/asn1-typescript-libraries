...
import { EncryptedContentInfo, _decode_EncryptedContentInfo, _encode_EncryptedContentInfo } from "../CryptographicMessageSyntax/EncryptedContentInfo.ta.mjs";
// export { EncryptedContentInfo, _decode_EncryptedContentInfo, _encode_EncryptedContentInfo } from "../CryptographicMessageSyntax/EncryptedContentInfo.ta.mjs";
import { UnprotectedAttributes, _decode_UnprotectedAttributes, _encode_UnprotectedAttributes } from "../CryptographicMessageSyntax/UnprotectedAttributes.ta.mjs";
// export { UnprotectedAttributes, _decode_UnprotectedAttributes, _encode_UnprotectedAttributes } from "../CryptographicMessageSyntax/UnprotectedAttributes.ta.mjs";
...
class EnvelopedData {
    ...
    public static _from_object (_o: { [_K in keyof (EnvelopedData)]: (EnvelopedData)[_K] }): EnvelopedData {
        return new EnvelopedData(_o.version, _o.originatorInfo, _o.recipientInfos, _o.encryptedContentInfo, _o.unprotectedAttrs);
    }
...
function _decode_EnvelopedData (el: _Element): EnvelopedData {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "unprotectedAttrs": (_el: _Element): void => { unprotectedAttrs = $._decode_implicit<UnprotectedAttributes>(() => _decode_UnprotectedAttributes)(_el); }
    };
...
function _encode_EnvelopedData (value: EnvelopedData, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.unprotectedAttrs === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => _encode_UnprotectedAttributes, $.BER)(value.unprotectedAttrs, $.BER))
        ],
