...
} from '../CBEFF-SMARTCARD-BIDO/BiometricHeaderTemplate.ta.js';
export {
  BiometricHeaderTemplate,
  _decode_BiometricHeaderTemplate,
  _encode_BiometricHeaderTemplate,
        ...
        function (el: _Element): BiometricInformationTemplate {
          ...
          const callbacks: $.DecodingMap = {
            ...
            referenceDataQualifier: (_el: _Element): void => {
              referenceDataQualifier = $._decode_implicit<OCTET_STRING>(
                () => $._decodeOctetString
              )(_el);
            },
            biometricHeaderTemplate: (_el: _Element): void => {
              biometricHeaderTemplate = $._decode_implicit<BiometricHeaderTemplate>(
                () => _decode_BiometricHeaderTemplate
              )(_el);
            },
        ...
        function (
          ...
          return $._encodeSet(
            ([] as (_Element | undefined)[])
              .concat([
                /* IF_ABSENT  */ value.algorithmReference === undefined
                  ? undefined
                  : $._encode_implicit(
                      _TagClass.context,
                      0,
                ...
                /* IF_ABSENT  */ value.referenceDataQualifier === undefined
                  ? undefined
                  : $._encode_implicit(
                      _TagClass.context,
                      3,
                ...
                /* IF_ABSENT  */ value.bdbReferenceData === undefined
                  ? undefined
                  : $._encode_implicit(
                      _TagClass.application,
                      46,
