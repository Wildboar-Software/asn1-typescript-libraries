# Telebiometric Security Mechanism (TSM) PDUs in TypeScript

ASN.1 data structures based on the ASN.1 definitions in ITU-T Recommendation
X.1084, which specifies the Telebiometric Security Mechanism (TSM).
...
AI (Cursor Grok 4.6) on 7 September 2026.
