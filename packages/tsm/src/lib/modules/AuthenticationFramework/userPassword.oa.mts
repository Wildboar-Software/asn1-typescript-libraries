...
// export { id_at_userPassword } from "../AuthenticationFramework/id-at-userPassword.va.mjs";
 ...
 */
export
const userPassword: ATTRIBUTE<OCTET_STRING> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "userPassword" ] /* OBJECT_FIELD_SETTING */,
