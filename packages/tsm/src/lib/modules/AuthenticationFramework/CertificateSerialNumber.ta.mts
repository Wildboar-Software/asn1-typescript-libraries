 ...
 */
export
function _decode_CertificateSerialNumber (el: _Element): CertificateSerialNumber {
    if (!_cached_decoder_for_CertificateSerialNumber) { _cached_decoder_for_CertificateSerialNumber = $._decodeInteger; }
 ...
 */
export
function _encode_CertificateSerialNumber (value: CertificateSerialNumber, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CertificateSerialNumber) { _cached_encoder_for_CertificateSerialNumber = $._encodeInteger; }
