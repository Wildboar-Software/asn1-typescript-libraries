...
import { OidOrAttr, _decode_OidOrAttr, _encode_OidOrAttr } from "../AuthenticationFramework/OidOrAttr.ta.mjs";
// export { OidOrAttr, _decode_OidOrAttr, _encode_OidOrAttr } from "../AuthenticationFramework/OidOrAttr.ta.mjs";
 ...
 */
export
class SupportedPublicKeyAlgorithms {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (SupportedPublicKeyAlgorithms)]: (SupportedPublicKeyAlgorithms)[_K] }): SupportedPublicKeyAlgorithms {
        return new SupportedPublicKeyAlgorithms(_o.algorithmIdentifier, _o.minKeySize, _o.extensions, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_SupportedPublicKeyAlgorithms: $.ComponentSpec[] = [
    new $.ComponentSpec("algorithmIdentifier", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("minKeySize", false, $.hasTag(_TagClass.universal, 2), undefined, undefined),
 ...
 */
export
const _root_component_type_list_2_spec_for_SupportedPublicKeyAlgorithms: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SupportedPublicKeyAlgorithms: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SupportedPublicKeyAlgorithms (el: _Element): SupportedPublicKeyAlgorithms {
    if (!_cached_decoder_for_SupportedPublicKeyAlgorithms) { _cached_decoder_for_SupportedPublicKeyAlgorithms = function (el: _Element): SupportedPublicKeyAlgorithms {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "minKeySize": (_el: _Element): void => { minKeySize = $._decodeInteger(_el); },
        "extensions": (_el: _Element): void => { extensions = $._decode_explicit<OidOrAttr[]>(() => $._decodeSequenceOf<OidOrAttr>(() => _decode_OidOrAttr))(_el); }
    };
 ...
 */
export
function _encode_SupportedPublicKeyAlgorithms (value: SupportedPublicKeyAlgorithms, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SupportedPublicKeyAlgorithms) { _cached_encoder_for_SupportedPublicKeyAlgorithms = function (value: SupportedPublicKeyAlgorithms, elGetter: $.ASN1Encoder<SupportedPublicKeyAlgorithms>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.algorithmIdentifier, $.BER),
            /* REQUIRED   */ $._encodeInteger(value.minKeySize, $.BER),
            /* IF_ABSENT  */ ((value.extensions === undefined) ? undefined : $._encode_explicit(_TagClass.context, 0, () => $._encodeSequenceOf<OidOrAttr>(() => _encode_OidOrAttr, $.BER), $.BER)(value.extensions, $.BER))
        ],
