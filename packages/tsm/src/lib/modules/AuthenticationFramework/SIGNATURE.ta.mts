...
class SIGNATURE {
     ...
     * @returns {SIGNATURE}
     */
    public static _from_object (_o: { [_K in keyof (SIGNATURE)]: (SIGNATURE)[_K] }): SIGNATURE {
        return new SIGNATURE(_o.algorithmIdentifier, _o.signature, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_SIGNATURE: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_SIGNATURE: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SIGNATURE: $.ComponentSpec[] = [
...
function _decode_SIGNATURE (el: _Element): SIGNATURE {
    if (!_cached_decoder_for_SIGNATURE) { _cached_decoder_for_SIGNATURE = function (el: _Element): SIGNATURE {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("SIGNATURE contained only " + sequence.length.toString() + " elements.");
    }
...
function _encode_SIGNATURE (value: SIGNATURE, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SIGNATURE) { _cached_encoder_for_SIGNATURE = function (value: SIGNATURE, elGetter: $.ASN1Encoder<SIGNATURE>): _Element {
