...
// export { id_at_deltaRevocationList } from "../AuthenticationFramework/id-at-deltaRevocationList.va.mjs";
 ...
 */
export
const deltaRevocationList: ATTRIBUTE<CertificateList> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "deltaRevocationList" ] /* OBJECT_FIELD_SETTING */,
