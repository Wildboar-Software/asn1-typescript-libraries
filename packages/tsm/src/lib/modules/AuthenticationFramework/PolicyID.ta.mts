 ...
 */
export
function _decode_PolicyID (el: _Element): PolicyID {
    if (!_cached_decoder_for_PolicyID) { _cached_decoder_for_PolicyID = _decode_CertPolicyId; }
 ...
 */
export
function _encode_PolicyID (value: PolicyID, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PolicyID) { _cached_encoder_for_PolicyID = _encode_CertPolicyId; }
