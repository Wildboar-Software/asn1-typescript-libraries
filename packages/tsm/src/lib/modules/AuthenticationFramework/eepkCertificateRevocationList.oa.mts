 ...
 */
export
const eepkCertificateRevocationList: ATTRIBUTE<CertificateList> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "eepkCertificateRevocationList" ] /* OBJECT_FIELD_SETTING */,
    "&ldapDesc": "X.509 EEPK certificate revocation list" /* OBJECT_FIELD_SETTING */,
