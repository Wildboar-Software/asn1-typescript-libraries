...
// export { id_at_certificationPracticeStmt } from "../AuthenticationFramework/id-at-certificationPracticeStmt.va.mjs";
 ...
 */
export
const certificationPracticeStmt: ATTRIBUTE<InfoSyntax> = {
    class: "ATTRIBUTE",
    decoderFor: {
