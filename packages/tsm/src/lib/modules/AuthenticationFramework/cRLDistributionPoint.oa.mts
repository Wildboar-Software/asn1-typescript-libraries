 ...
 */
export
const cRLDistributionPoint: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
    ...
    "&OptionalAttributes": [ certificateRevocationList, eepkCertificateRevocationList, authorityRevocationList, deltaRevocationList, ] /* OBJECT_FIELD_SETTING */,
    "&ldapName": [ "cRLDistributionPoint" ] /* OBJECT_FIELD_SETTING */,
