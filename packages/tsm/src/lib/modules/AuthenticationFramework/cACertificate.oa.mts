...
// export { id_at_cAcertificate } from "../AuthenticationFramework/id-at-cAcertificate.va.mjs";
 ...
 */
export
const cACertificate: ATTRIBUTE<Certificate> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "cACertificate" ] /* OBJECT_FIELD_SETTING */,
