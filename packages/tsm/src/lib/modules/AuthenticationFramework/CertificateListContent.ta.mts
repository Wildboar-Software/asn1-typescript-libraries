...
import { CertificateListContent_revokedCertificates_Item, _decode_CertificateListContent_revokedCertificates_Item, _encode_CertificateListContent_revokedCertificates_Item } from "../AuthenticationFramework/CertificateListContent-revokedCertificates-Item.ta.mjs";
// export { CertificateListContent_revokedCertificates_Item, _decode_CertificateListContent_revokedCertificates_Item, _encode_CertificateListContent_revokedCertificates_Item } from "../AuthenticationFramework/CertificateListContent-revokedCertificates-Item.ta.mjs";
...
class CertificateListContent {
    constructor (
         ...
         * @readonly
         */
        readonly revokedCertificates: OPTIONAL<CertificateListContent_revokedCertificates_Item[]>,
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (CertificateListContent)]: (CertificateListContent)[_K] }): CertificateListContent {
        return new CertificateListContent(_o.version, _o.signature, _o.issuer, _o.thisUpdate, _o.nextUpdate, _o.revokedCertificates, _o._unrecognizedExtensionsList, _o.crlExtensions);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_CertificateListContent: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("nextUpdate", true, $.or($.hasTag(_TagClass.universal, 23), $.hasTag(_TagClass.universal, 24)), undefined, undefined),
    new $.ComponentSpec("revokedCertificates", true, $.hasTag(_TagClass.universal, 16), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_CertificateListContent: $.ComponentSpec[] = [
    new $.ComponentSpec("crlExtensions", true, $.hasTag(_TagClass.context, 0), undefined, undefined)
];
 ...
 */
export
const _extension_additions_list_spec_for_CertificateListContent: $.ComponentSpec[] = [
 ...
 */
export
function _decode_CertificateListContent (el: _Element): CertificateListContent {
    if (!_cached_decoder_for_CertificateListContent) { _cached_decoder_for_CertificateListContent = function (el: _Element): CertificateListContent {
    let version: OPTIONAL<Version>;
    let signature!: AlgorithmIdentifier;
    let issuer!: Name;
    let thisUpdate!: Time;
    let nextUpdate: OPTIONAL<Time>;
    let revokedCertificates: OPTIONAL<CertificateListContent_revokedCertificates_Item[]>;
    ...
    const callbacks: $.DecodingMap = {
        ...
        "revokedCertificates": (_el: _Element): void => { revokedCertificates = $._decodeSequenceOf<CertificateListContent_revokedCertificates_Item>(() => _decode_CertificateListContent_revokedCertificates_Item)(_el); },
 ...
 */
export
function _encode_CertificateListContent (value: CertificateListContent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CertificateListContent) { _cached_encoder_for_CertificateListContent = function (value: CertificateListContent, elGetter: $.ASN1Encoder<CertificateListContent>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.revokedCertificates === undefined) ? undefined : $._encodeSequenceOf<CertificateListContent_revokedCertificates_Item>(() => _encode_CertificateListContent_revokedCertificates_Item, $.BER)(value.revokedCertificates, $.BER))
        ],
