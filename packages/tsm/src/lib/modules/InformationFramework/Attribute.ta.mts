...
import { Attribute_valuesWithContext_Item, _decode_Attribute_valuesWithContext_Item, _encode_Attribute_valuesWithContext_Item } from "../InformationFramework/Attribute-valuesWithContext-Item.ta.mjs";
// export { Attribute_valuesWithContext_Item, _decode_Attribute_valuesWithContext_Item, _encode_Attribute_valuesWithContext_Item } from "../InformationFramework/Attribute-valuesWithContext-Item.ta.mjs";
...
class Attribute {
    constructor (
         ...
         * @readonly
         */
        readonly valuesWithContext: OPTIONAL<Attribute_valuesWithContext_Item[]>,
        /**
...
const _root_component_type_list_1_spec_for_Attribute: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("values", false, $.hasTag(_TagClass.universal, 17), undefined, undefined),
    new $.ComponentSpec("valuesWithContext", true, $.hasTag(_TagClass.universal, 17), undefined, undefined)
];
...
function _decode_Attribute (el: _Element): Attribute {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "values": (_el: _Element): void => { values = $._decodeSetOf<_Element>(() => $._decodeAny)(_el); },
        "valuesWithContext": (_el: _Element): void => { valuesWithContext = $._decodeSetOf<Attribute_valuesWithContext_Item>(() => _decode_Attribute_valuesWithContext_Item)(_el); }
    };
...
function _encode_Attribute (value: Attribute, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ $._encodeSetOf<_Element>(() => $._encodeAny, $.BER)(value.values, $.BER),
            /* IF_ABSENT  */ ((value.valuesWithContext === undefined) ? undefined : $._encodeSetOf<Attribute_valuesWithContext_Item>(() => _encode_Attribute_valuesWithContext_Item, $.BER)(value.valuesWithContext, $.BER))
        ],
