...
// export { id_oa_serviceAdminSubentryList } from "../InformationFramework/id-oa-serviceAdminSubentryList.va.mjs";
 ...
 */
export
const serviceAdminSubentryList: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
