...
// export { id_at_objectClass } from "../InformationFramework/id-at-objectClass.va.mjs";
 ...
 */
export
const objectClass: ATTRIBUTE<OBJECT_IDENTIFIER> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "objectClass" ] /* OBJECT_FIELD_SETTING */,
