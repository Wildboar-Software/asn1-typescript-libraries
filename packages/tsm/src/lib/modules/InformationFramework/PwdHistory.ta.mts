...
class PwdHistory {
     ...
     * @returns {PwdHistory}
     */
    public static _from_object (_o: { [_K in keyof (PwdHistory)]: (PwdHistory)[_K] }): PwdHistory {
        return new PwdHistory(_o.time, _o.password, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_PwdHistory: $.ComponentSpec[] = [
    new $.ComponentSpec("time", false, $.hasTag(_TagClass.universal, 24), undefined, undefined),
 ...
 */
export
const _root_component_type_list_2_spec_for_PwdHistory: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PwdHistory: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PwdHistory (el: _Element): PwdHistory {
    if (!_cached_decoder_for_PwdHistory) { _cached_decoder_for_PwdHistory = function (el: _Element): PwdHistory {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("PwdHistory contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_PwdHistory (value: PwdHistory, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PwdHistory) { _cached_encoder_for_PwdHistory = function (value: PwdHistory, elGetter: $.ASN1Encoder<PwdHistory>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeGeneralizedTime(value.time, $.BER),
            /* REQUIRED   */ $._encodeAny(value.password, $.BER)
        ],
