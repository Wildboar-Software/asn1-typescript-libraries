...
// export { id_oa_creatorsName } from "../InformationFramework/id-oa-creatorsName.va.mjs";
 ...
 */
export
const creatorsName: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&ldapName": [ "creatorsName" ] /* OBJECT_FIELD_SETTING */,
