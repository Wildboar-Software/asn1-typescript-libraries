...
// export { id_sc_collectiveAttributeSubentry } from "../InformationFramework/id-sc-collectiveAttributeSubentry.va.mjs";
 ...
 */
export
const collectiveAttributeSubentry: OBJECT_CLASS = {
    class: "OBJECT-CLASS",
    decoderFor: {
    },
    encoderFor: {
