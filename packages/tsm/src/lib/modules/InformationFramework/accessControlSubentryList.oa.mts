...
// export { id_oa_accessControlSubentryList } from "../InformationFramework/id-oa-accessControlSubentryList.va.mjs";
 ...
 */
export
const accessControlSubentryList: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
