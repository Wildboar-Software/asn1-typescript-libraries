...
// export { id_oa_collectiveAttributeSubentryList } from "../InformationFramework/id-oa-collectiveAttributeSubentryList.va.mjs";
 ...
 */
export
const collectiveAttributeSubentryList: ATTRIBUTE<DistinguishedName> = {
    class: "ATTRIBUTE",
    decoderFor: {
