 ...
 */
export
function _decode_LocalName (el: _Element): LocalName {
    if (!_cached_decoder_for_LocalName) { _cached_decoder_for_LocalName = _decode_RDNSequence; }
 ...
 */
export
function _encode_LocalName (value: LocalName, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_LocalName) { _cached_encoder_for_LocalName = _encode_RDNSequence; }
