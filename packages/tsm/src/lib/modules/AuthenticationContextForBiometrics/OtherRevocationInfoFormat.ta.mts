...
const _root_component_type_list_1_spec_for_OtherRevocationInfoFormat: $.ComponentSpec[] = [
    new $.ComponentSpec("otherRevInfoFormat", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("otherRevInfo", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
