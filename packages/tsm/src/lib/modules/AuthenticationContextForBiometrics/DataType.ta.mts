...
import { ProcessedLevel, _enum_for_ProcessedLevel, ProcessedLevel_raw_data /* IMPORTED_LONG_ENUMERATION_ITEM */, raw_data /* IMPORTED_SHORT_ENUMERATION_ITEM */, ProcessedLevel_intermediate_data /* IMPORTED_LONG_ENUMERATION_ITEM */, intermediate_data /* IMPORTED_SHORT_ENUMERATION_ITEM */, ProcessedLevel_processed_data /* IMPORTED_LONG_ENUMERATION_ITEM */, processed_data /* IMPORTED_SHORT_ENUMERATION_ITEM */, ProcessedLevel_comparison_score /* IMPORTED_LONG_ENUMERATION_ITEM */, comparison_score /* IMPORTED_SHORT_ENUMERATION_ITEM */, ProcessedLevel_comparison_decision /* IMPORTED_LONG_ENUMERATION_ITEM */, comparison_decision /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_ProcessedLevel, _encode_ProcessedLevel } from "../AuthenticationContextForBiometrics/ProcessedLevel.ta.mjs";
...
import { Purpose, _enum_for_Purpose, Purpose_reference /* IMPORTED_LONG_ENUMERATION_ITEM */, reference /* IMPORTED_SHORT_ENUMERATION_ITEM */, Purpose_sample /* IMPORTED_LONG_ENUMERATION_ITEM */, sample /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_Purpose, _encode_Purpose } from "../AuthenticationContextForBiometrics/Purpose.ta.mjs";
// export { Purpose, _enum_for_Purpose, Purpose_reference /* IMPORTED_LONG_ENUMERATION_ITEM */, reference /* IMPORTED_SHORT_ENUMERATION_ITEM */, Purpose_sample /* IMPORTED_LONG_ENUMERATION_ITEM */, sample /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_Purpose, _encode_Purpose } from "../AuthenticationContextForBiometrics/Purpose.ta.mjs";
...
class DataType {
     ...
     * @returns {DataType}
     */
    public static _from_object (_o: { [_K in keyof (DataType)]: (DataType)[_K] }): DataType {
 ...
 */
export
const _root_component_type_list_1_spec_for_DataType: $.ComponentSpec[] = [
    new $.ComponentSpec("processedLevel", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("purpose", true, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_DataType: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_DataType: $.ComponentSpec[] = [
 ...
 */
export
function _decode_DataType (el: _Element): DataType {
    if (!_cached_decoder_for_DataType) { _cached_decoder_for_DataType = function (el: _Element): DataType {
    let processedLevel!: ProcessedLevel;
    let purpose: OPTIONAL<Purpose>;
    const callbacks: $.DecodingMap = {
        "processedLevel": (_el: _Element): void => { processedLevel = _decode_ProcessedLevel(_el); },
        "purpose": (_el: _Element): void => { purpose = _decode_Purpose(_el); }
    };
 ...
 */
export
function _encode_DataType (value: DataType, elGetter: $.ASN1Encoder<any>): _Element {
