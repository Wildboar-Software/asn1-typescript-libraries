...
import { CertificateSet, _decode_CertificateSet, _encode_CertificateSet } from "../AuthenticationContextForBiometrics/CertificateSet.ta.mjs";
// export { CertificateSet, _decode_CertificateSet, _encode_CertificateSet } from "../AuthenticationContextForBiometrics/CertificateSet.ta.mjs";
import { RevocationInfoChoices, _decode_RevocationInfoChoices, _encode_RevocationInfoChoices } from "../AuthenticationContextForBiometrics/RevocationInfoChoices.ta.mjs";
// export { RevocationInfoChoices, _decode_RevocationInfoChoices, _encode_RevocationInfoChoices } from "../AuthenticationContextForBiometrics/RevocationInfoChoices.ta.mjs";
 ...
 */
export
class SIGNEDDATA<EncapsulatedContentInfo> {
    constructor (
        /**
         * @summary `version`.
         * @public
     ...
     * @returns {SIGNEDDATA}
     */
    public static _from_object (_o: { [_K in keyof (SIGNEDDATA<any>)]: (SIGNEDDATA<any>)[_K] }): SIGNEDDATA<any> {
...
const _root_component_type_list_1_spec_for_SIGNEDDATA: $.ComponentSpec[] = [
    ...
    /* FIXME: signerInfos COULD_NOT_RESOLVE_TYPE_DEF */
];
...
let _cached_decoder_for_SIGNEDDATA: $.ASN1Decoder<SIGNEDDATA<EncapsulatedContentInfo>> | null = null;
 ...
 */
export
function _get_decoder_for_SIGNEDDATA<EncapsulatedContentInfo>(_decode_EncapsulatedContentInfo: $.ASN1Decoder<EncapsulatedContentInfo>): $.ASN1Decoder<SIGNEDDATA<EncapsulatedContentInfo>> {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "digestAlgorithms": (_el: _Element): void => { digestAlgorithms = $._decodeSetOf<DigestAlgorithmIdentifier>(() => _decode_DigestAlgorithmIdentifier)(_el); },
...
let _cached_encoder_for_SIGNEDDATA: $.ASN1Encoder<SIGNEDDATA<EncapsulatedContentInfo>> | null = null;
 ...
 */
export
function _get_encoder_for_SIGNEDDATA<EncapsulatedContentInfo>(_encode_EncapsulatedContentInfo: $.ASN1Encoder<EncapsulatedContentInfo>): $.ASN1Encoder<SIGNEDDATA<EncapsulatedContentInfo>> {
    return function (value: SIGNEDDATA<EncapsulatedContentInfo>, elGetter: $.ASN1Encoder<SIGNEDDATA<EncapsulatedContentInfo>>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_CMSVersion(value.version, $.BER),
            /* REQUIRED   */ $._encodeSetOf<DigestAlgorithmIdentifier>(() => _encode_DigestAlgorithmIdentifier, $.BER)(value.digestAlgorithms, $.BER),
