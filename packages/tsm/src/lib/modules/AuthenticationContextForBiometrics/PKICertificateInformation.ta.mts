 ...
 */
export
class PKICertificateInformation {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (PKICertificateInformation)]: (PKICertificateInformation)[_K] }): PKICertificateInformation {
        return new PKICertificateInformation(_o.pkiCertificateSerialNumber, _o.pkiCertificateIssuerName, _o.pkiCertificateIssuerUniqueIdentifier);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_PKICertificateInformation: $.ComponentSpec[] = [
    new $.ComponentSpec("pkiCertificateSerialNumber", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("pkiCertificateIssuerName", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    /* FIXME: pkiCertificateIssuerUniqueIdentifier COULD_NOT_RESOLVE_TYPE_DEF */
];
 ...
 */
export
const _root_component_type_list_2_spec_for_PKICertificateInformation: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PKICertificateInformation: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PKICertificateInformation (el: _Element): PKICertificateInformation {
    if (!_cached_decoder_for_PKICertificateInformation) { _cached_decoder_for_PKICertificateInformation = function (el: _Element): PKICertificateInformation {
    ...
    const callbacks: $.DecodingMap = {
        "pkiCertificateSerialNumber": (_el: _Element): void => { pkiCertificateSerialNumber = _decode_CertificateSerialNumber(_el); },
        "pkiCertificateIssuerName": (_el: _Element): void => { pkiCertificateIssuerName = _decode_Name(_el); },
        "pkiCertificateIssuerUniqueIdentifier": (_el: _Element): void => { pkiCertificateIssuerUniqueIdentifier = _decode_UniqueIdentifier(_el); }
    };
 ...
 */
export
function _encode_PKICertificateInformation (value: PKICertificateInformation, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PKICertificateInformation) { _cached_encoder_for_PKICertificateInformation = function (value: PKICertificateInformation, elGetter: $.ASN1Encoder<PKICertificateInformation>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_CertificateSerialNumber(value.pkiCertificateSerialNumber, $.BER),
            /* REQUIRED   */ _encode_Name(value.pkiCertificateIssuerName, $.BER),
            /* IF_ABSENT  */ ((value.pkiCertificateIssuerUniqueIdentifier === undefined) ? undefined : _encode_UniqueIdentifier(value.pkiCertificateIssuerUniqueIdentifier, $.BER))
        ],
