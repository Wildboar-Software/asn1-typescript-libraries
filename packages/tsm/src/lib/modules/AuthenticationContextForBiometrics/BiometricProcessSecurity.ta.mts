 ...
 */
export
type BiometricProcessSecurity = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_BiometricProcessSecurity (el: _Element): BiometricProcessSecurity {
    if (!_cached_decoder_for_BiometricProcessSecurity) { _cached_decoder_for_BiometricProcessSecurity = $._decodeOctetString; }
 ...
 */
export
function _encode_BiometricProcessSecurity (value: BiometricProcessSecurity, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BiometricProcessSecurity) { _cached_encoder_for_BiometricProcessSecurity = $._encodeOctetString; }
