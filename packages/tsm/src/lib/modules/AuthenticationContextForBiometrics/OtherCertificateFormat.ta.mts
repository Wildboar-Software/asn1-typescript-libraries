...
const _root_component_type_list_1_spec_for_OtherCertificateFormat: $.ComponentSpec[] = [
    new $.ComponentSpec("otherFormat", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("otherCert", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
...
function _encode_OtherCertificateFormat (value: OtherCertificateFormat, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeObjectIdentifier(value.otherFormat, $.BER),
