 ...
 */
export
class EncapsulatedContentInfoACBio {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (EncapsulatedContentInfoACBio)]: (EncapsulatedContentInfoACBio)[_K] }): EncapsulatedContentInfoACBio {
 ...
 */
export
const _root_component_type_list_1_spec_for_EncapsulatedContentInfoACBio: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_EncapsulatedContentInfoACBio: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_EncapsulatedContentInfoACBio: $.ComponentSpec[] = [
 ...
 */
export
function _decode_EncapsulatedContentInfoACBio (el: _Element): EncapsulatedContentInfoACBio {
    if (!_cached_decoder_for_EncapsulatedContentInfoACBio) { _cached_decoder_for_EncapsulatedContentInfoACBio = function (el: _Element): EncapsulatedContentInfoACBio {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("EncapsulatedContentInfoACBio contained only " + sequence.length.toString() + " elements.");
    }
    ...
    eContent = $._decode_explicit<_Element /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */>(() => $._decodeAny /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */)(sequence[1]);
    return new EncapsulatedContentInfoACBio(
        eContentType,
        eContent,
 ...
 */
export
function _encode_EncapsulatedContentInfoACBio (value: EncapsulatedContentInfoACBio, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EncapsulatedContentInfoACBio) { _cached_encoder_for_EncapsulatedContentInfoACBio = function (value: EncapsulatedContentInfoACBio, elGetter: $.ASN1Encoder<EncapsulatedContentInfoACBio>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeAny /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */(value.eContentType, $.BER),
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => $._encodeAny /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */, $.BER)(value.eContent, $.BER)
        ],
