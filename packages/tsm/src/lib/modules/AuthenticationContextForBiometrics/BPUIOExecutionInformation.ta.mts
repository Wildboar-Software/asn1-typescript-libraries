...
import { Hash, _decode_Hash, _encode_Hash } from "../AuthenticationContextForBiometrics/Hash.ta.mjs";
// export { Hash, _decode_Hash, _encode_Hash } from "../AuthenticationContextForBiometrics/Hash.ta.mjs";
 ...
 */
export
class BPUIOExecutionInformation {
    constructor (
        /**
         * @summary `dataType`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (BPUIOExecutionInformation)]: (BPUIOExecutionInformation)[_K] }): BPUIOExecutionInformation {
        return new BPUIOExecutionInformation(_o.dataType, _o.bpuIOIndex, _o.subprocessIOIndex, _o.hash);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BPUIOExecutionInformation: $.ComponentSpec[] = [
    new $.ComponentSpec("dataType", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("bpuIOIndex", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("subprocessIOIndex", false, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("hash", false, $.hasTag(_TagClass.context, 3), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BPUIOExecutionInformation: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BPUIOExecutionInformation: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BPUIOExecutionInformation (el: _Element): BPUIOExecutionInformation {
    if (!_cached_decoder_for_BPUIOExecutionInformation) { _cached_decoder_for_BPUIOExecutionInformation = function (el: _Element): BPUIOExecutionInformation {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 4) {
        throw new _ConstructionError("BPUIOExecutionInformation contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BPUIOExecutionInformation (value: BPUIOExecutionInformation, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BPUIOExecutionInformation) { _cached_encoder_for_BPUIOExecutionInformation = function (value: BPUIOExecutionInformation, elGetter: $.ASN1Encoder<BPUIOExecutionInformation>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_DataType(value.dataType, $.BER),
            /* REQUIRED   */ _encode_IOIndex(value.bpuIOIndex, $.BER),
