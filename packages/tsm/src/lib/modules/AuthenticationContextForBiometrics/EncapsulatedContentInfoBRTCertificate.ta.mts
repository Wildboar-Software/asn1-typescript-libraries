 ...
 */
export
class EncapsulatedContentInfoBRTCertificate {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (EncapsulatedContentInfoBRTCertificate)]: (EncapsulatedContentInfoBRTCertificate)[_K] }): EncapsulatedContentInfoBRTCertificate {
        return new EncapsulatedContentInfoBRTCertificate(_o.eContentType, _o.eContent);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_EncapsulatedContentInfoBRTCertificate: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_EncapsulatedContentInfoBRTCertificate: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_EncapsulatedContentInfoBRTCertificate: $.ComponentSpec[] = [
 ...
 */
export
function _decode_EncapsulatedContentInfoBRTCertificate (el: _Element): EncapsulatedContentInfoBRTCertificate {
    if (!_cached_decoder_for_EncapsulatedContentInfoBRTCertificate) { _cached_decoder_for_EncapsulatedContentInfoBRTCertificate = function (el: _Element): EncapsulatedContentInfoBRTCertificate {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("EncapsulatedContentInfoBRTCertificate contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_EncapsulatedContentInfoBRTCertificate (value: EncapsulatedContentInfoBRTCertificate, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EncapsulatedContentInfoBRTCertificate) { _cached_encoder_for_EncapsulatedContentInfoBRTCertificate = function (value: EncapsulatedContentInfoBRTCertificate, elGetter: $.ASN1Encoder<EncapsulatedContentInfoBRTCertificate>): _Element {
    ...
    return _cached_encoder_for_EncapsulatedContentInfoBRTCertificate(value, elGetter);
}
