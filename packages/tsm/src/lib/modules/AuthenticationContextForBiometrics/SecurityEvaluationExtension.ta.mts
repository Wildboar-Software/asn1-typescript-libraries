 ...
 */
export
type SecurityEvaluationExtension = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_SecurityEvaluationExtension (el: _Element): SecurityEvaluationExtension {
    if (!_cached_decoder_for_SecurityEvaluationExtension) { _cached_decoder_for_SecurityEvaluationExtension = $._decodeOctetString; }
 ...
 */
export
function _encode_SecurityEvaluationExtension (value: SecurityEvaluationExtension, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SecurityEvaluationExtension) { _cached_encoder_for_SecurityEvaluationExtension = $._encodeOctetString; }
