...
// export { brtcContentInformation } from "../AuthenticationContextForBiometrics/brtcContentInformation.oa.mjs";
 ...
 */
export
const ContentTypeBRTCertificateContentInfo: (CONTENT_TYPE)[] = [ brtcContentInformation, ];
