 ...
 */
export
type CryptoModuleSecurity = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_CryptoModuleSecurity (el: _Element): CryptoModuleSecurity {
    if (!_cached_decoder_for_CryptoModuleSecurity) { _cached_decoder_for_CryptoModuleSecurity = $._decodeOctetString; }
 ...
 */
export
function _encode_CryptoModuleSecurity (value: CryptoModuleSecurity, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CryptoModuleSecurity) { _cached_encoder_for_CryptoModuleSecurity = $._encodeOctetString; }
