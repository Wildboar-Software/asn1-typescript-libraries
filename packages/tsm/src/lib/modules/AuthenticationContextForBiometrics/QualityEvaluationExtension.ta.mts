 ...
 */
export
type QualityEvaluationExtension = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_QualityEvaluationExtension (el: _Element): QualityEvaluationExtension {
    if (!_cached_decoder_for_QualityEvaluationExtension) { _cached_decoder_for_QualityEvaluationExtension = $._decodeOctetString; }
 ...
 */
export
function _encode_QualityEvaluationExtension (value: QualityEvaluationExtension, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_QualityEvaluationExtension) { _cached_encoder_for_QualityEvaluationExtension = $._encodeOctetString; }
