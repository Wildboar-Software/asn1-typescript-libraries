...
const _root_component_type_list_1_spec_for_Hash: $.ComponentSpec[] = [
    new $.ComponentSpec("algorithmIdentifier", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("hashValue", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
...
function _decode_Hash (el: _Element): Hash {
    if (!_cached_decoder_for_Hash) { _cached_decoder_for_Hash = function (el: _Element): Hash {
...
function _encode_Hash (value: Hash, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Hash) { _cached_encoder_for_Hash = function (value: Hash, elGetter: $.ASN1Encoder<Hash>): _Element {
