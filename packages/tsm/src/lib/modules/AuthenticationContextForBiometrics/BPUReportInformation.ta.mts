...
import { BPUReport, _decode_BPUReport, _encode_BPUReport } from "../AuthenticationContextForBiometrics/BPUReport.ta.mjs";
// export { BPUReport, _decode_BPUReport, _encode_BPUReport } from "../AuthenticationContextForBiometrics/BPUReport.ta.mjs";
 ...
 */
export
function _decode_BPUReportInformation (el: _Element): BPUReportInformation {
 ...
 */
export
function _encode_BPUReportInformation (value: BPUReportInformation, elGetter: $.ASN1Encoder<any>): _Element {
