...
import { AUTHENTICATEDDATA, _get_decoder_for_AUTHENTICATEDDATA, _get_encoder_for_AUTHENTICATEDDATA } from "../AuthenticationContextForBiometrics/AUTHENTICATEDDATA.ta.mjs";
// export { AUTHENTICATEDDATA, _get_decoder_for_AUTHENTICATEDDATA, _get_encoder_for_AUTHENTICATEDDATA } from "../AuthenticationContextForBiometrics/AUTHENTICATEDDATA.ta.mjs";
 ...
 */
export
type AuthenticatedDataACBio = AUTHENTICATEDDATA<EncapsulatedContentInfoACBio>; // DefinedType
 ...
 */
export
function _decode_AuthenticatedDataACBio (el: _Element): AuthenticatedDataACBio {
    if (!_cached_decoder_for_AuthenticatedDataACBio) { _cached_decoder_for_AuthenticatedDataACBio = _get_decoder_for_AUTHENTICATEDDATA<EncapsulatedContentInfoACBio>(_decode_EncapsulatedContentInfoACBio); }
 ...
 */
export
function _encode_AuthenticatedDataACBio (value: AuthenticatedDataACBio, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AuthenticatedDataACBio) { _cached_encoder_for_AuthenticatedDataACBio = _get_encoder_for_AUTHENTICATEDDATA<EncapsulatedContentInfoACBio>(_encode_EncapsulatedContentInfoACBio); }
