 ...
 */
export
function _decode_SubprocessIndex (el: _Element): SubprocessIndex {
    if (!_cached_decoder_for_SubprocessIndex) { _cached_decoder_for_SubprocessIndex = $._decodeInteger; }
 ...
 */
export
function _encode_SubprocessIndex (value: SubprocessIndex, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SubprocessIndex) { _cached_encoder_for_SubprocessIndex = $._encodeInteger; }
