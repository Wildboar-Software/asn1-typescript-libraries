 ...
 */
export
type Cancel_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_Cancel_ResponseParams (el: _Element): Cancel_ResponseParams {
    if (!_cached_decoder_for_Cancel_ResponseParams) { _cached_decoder_for_Cancel_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_Cancel_ResponseParams (value: Cancel_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Cancel_ResponseParams) { _cached_encoder_for_Cancel_ResponseParams = $._encodeNull; }
