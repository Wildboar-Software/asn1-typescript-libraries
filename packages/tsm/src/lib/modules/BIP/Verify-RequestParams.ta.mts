...
class Verify_RequestParams {
     ...
     */
    public static _from_object (_o: { [_K in keyof (Verify_RequestParams)]: (Verify_RequestParams)[_K] }): Verify_RequestParams {
        return new Verify_RequestParams(_o.originalBSPHandle, _o.maxFMRRequested, _o.referenceTemplate, _o.subtype, _o.timeout, _o.no_adaptedBIR, _o.no_fmrAchieved, _o.no_payload, _o.no_auditData);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_Verify_RequestParams: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("referenceTemplate", false, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("subtype", false, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("timeout", false, $.hasTag(_TagClass.context, 4), undefined, undefined),
    new $.ComponentSpec("no-adaptedBIR", false, $.hasTag(_TagClass.context, 5), undefined, undefined),
    new $.ComponentSpec("no-fmrAchieved", false, $.hasTag(_TagClass.context, 6), undefined, undefined),
    new $.ComponentSpec("no-payload", false, $.hasTag(_TagClass.context, 7), undefined, undefined),
 ...
 */
export
const _root_component_type_list_2_spec_for_Verify_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_Verify_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_Verify_RequestParams (el: _Element): Verify_RequestParams {
    if (!_cached_decoder_for_Verify_RequestParams) { _cached_decoder_for_Verify_RequestParams = function (el: _Element): Verify_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 9) {
        throw new _ConstructionError("Verify-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_Verify_RequestParams (value: Verify_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Verify_RequestParams) { _cached_encoder_for_Verify_RequestParams = function (value: Verify_RequestParams, elGetter: $.ASN1Encoder<Verify_RequestParams>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ _encode_BioAPI_INPUT_BIR(value.referenceTemplate, $.BER),
