 ...
 */
export
type SetIndicatorStatus_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_SetIndicatorStatus_ResponseParams (el: _Element): SetIndicatorStatus_ResponseParams {
    if (!_cached_decoder_for_SetIndicatorStatus_ResponseParams) { _cached_decoder_for_SetIndicatorStatus_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_SetIndicatorStatus_ResponseParams (value: SetIndicatorStatus_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SetIndicatorStatus_ResponseParams) { _cached_encoder_for_SetIndicatorStatus_ResponseParams = $._encodeNull; }
