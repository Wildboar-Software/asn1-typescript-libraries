 ...
 */
export
type EnableEventNotifications_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_EnableEventNotifications_ResponseParams (el: _Element): EnableEventNotifications_ResponseParams {
    if (!_cached_decoder_for_EnableEventNotifications_ResponseParams) { _cached_decoder_for_EnableEventNotifications_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_EnableEventNotifications_ResponseParams (value: EnableEventNotifications_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EnableEventNotifications_ResponseParams) { _cached_encoder_for_EnableEventNotifications_ResponseParams = $._encodeNull; }
    return _cached_encoder_for_EnableEventNotifications_ResponseParams(value, elGetter);
}
