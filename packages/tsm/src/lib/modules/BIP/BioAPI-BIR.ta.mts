...
class BioAPI_BIR {
     ...
     * @returns {BioAPI_BIR}
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_BIR)]: (BioAPI_BIR)[_K] }): BioAPI_BIR {
        return new BioAPI_BIR(_o.patronFormatOwner, _o.patronFormatType, _o.formattedBIR);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_BIR: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_BIR: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_BIR: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_BIR (el: _Element): BioAPI_BIR {
    if (!_cached_decoder_for_BioAPI_BIR) { _cached_decoder_for_BioAPI_BIR = function (el: _Element): BioAPI_BIR {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new _ConstructionError("BioAPI-BIR contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BioAPI_BIR (value: BioAPI_BIR, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_BIR) { _cached_encoder_for_BioAPI_BIR = function (value: BioAPI_BIR, elGetter: $.ASN1Encoder<BioAPI_BIR>): _Element {
