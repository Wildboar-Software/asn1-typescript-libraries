 ...
 */
export
type BSPUnload_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_BSPUnload_ResponseParams (el: _Element): BSPUnload_ResponseParams {
    if (!_cached_decoder_for_BSPUnload_ResponseParams) { _cached_decoder_for_BSPUnload_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_BSPUnload_ResponseParams (value: BSPUnload_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BSPUnload_ResponseParams) { _cached_encoder_for_BSPUnload_ResponseParams = $._encodeNull; }
