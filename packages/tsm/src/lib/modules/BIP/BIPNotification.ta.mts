...
import { BIPNotification_params, _decode_BIPNotification_params, _encode_BIPNotification_params } from "../BIP/BIPNotification-params.ta.mjs";
// export { BIPNotification_params, _decode_BIPNotification_params, _encode_BIPNotification_params } from "../BIP/BIPNotification-params.ta.mjs";
...
class BIPNotification {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BIPNotification)]: (BIPNotification)[_K] }): BIPNotification {
        return new BIPNotification(_o.masterEndpointIRI, _o.slaveEndpointIRI, _o.linkNumber, _o.notificationId, _o.params);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BIPNotification: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BIPNotification: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BIPNotification: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BIPNotification (el: _Element): BIPNotification {
    if (!_cached_decoder_for_BIPNotification) { _cached_decoder_for_BIPNotification = function (el: _Element): BIPNotification {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 5) {
        throw new _ConstructionError("BIPNotification contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BIPNotification (value: BIPNotification, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BIPNotification) { _cached_encoder_for_BIPNotification = function (value: BIPNotification, elGetter: $.ASN1Encoder<BIPNotification>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ _encode_BIPNotification_params(value.params, $.BER)
        ],
