 ...
 */
export
class BioAPI_BIR_BIOMETRIC_PRODUCT_ID {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_BIR_BIOMETRIC_PRODUCT_ID)]: (BioAPI_BIR_BIOMETRIC_PRODUCT_ID)[_K] }): BioAPI_BIR_BIOMETRIC_PRODUCT_ID {
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_BIR_BIOMETRIC_PRODUCT_ID: $.ComponentSpec[] = [
    new $.ComponentSpec("productOwner", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("productType", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_BIR_BIOMETRIC_PRODUCT_ID: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_BIR_BIOMETRIC_PRODUCT_ID: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_BIR_BIOMETRIC_PRODUCT_ID (el: _Element): BioAPI_BIR_BIOMETRIC_PRODUCT_ID {
    if (!_cached_decoder_for_BioAPI_BIR_BIOMETRIC_PRODUCT_ID) { _cached_decoder_for_BioAPI_BIR_BIOMETRIC_PRODUCT_ID = function (el: _Element): BioAPI_BIR_BIOMETRIC_PRODUCT_ID {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BioAPI-BIR-BIOMETRIC-PRODUCT-ID contained only " + sequence.length.toString() + " elements.");
    }
    ...
    return new BioAPI_BIR_BIOMETRIC_PRODUCT_ID(
        productOwner,
        productType,
 ...
 */
export
function _encode_BioAPI_BIR_BIOMETRIC_PRODUCT_ID (value: BioAPI_BIR_BIOMETRIC_PRODUCT_ID, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_BIR_BIOMETRIC_PRODUCT_ID) { _cached_encoder_for_BioAPI_BIR_BIOMETRIC_PRODUCT_ID = function (value: BioAPI_BIR_BIOMETRIC_PRODUCT_ID, elGetter: $.ASN1Encoder<BioAPI_BIR_BIOMETRIC_PRODUCT_ID>): _Element {
