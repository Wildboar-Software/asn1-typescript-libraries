 ...
 */
export
type DeleteMaster_RequestParams = NULL; // NullType
 ...
 */
export
function _decode_DeleteMaster_RequestParams (el: _Element): DeleteMaster_RequestParams {
    if (!_cached_decoder_for_DeleteMaster_RequestParams) { _cached_decoder_for_DeleteMaster_RequestParams = $._decodeNull; }
 ...
 */
export
function _encode_DeleteMaster_RequestParams (value: DeleteMaster_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DeleteMaster_RequestParams) { _cached_encoder_for_DeleteMaster_RequestParams = $._encodeNull; }
