 ...
 */
export
class BioAPI_GUI_EVENT_SUBSCRIPTION {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_GUI_EVENT_SUBSCRIPTION)]: (BioAPI_GUI_EVENT_SUBSCRIPTION)[_K] }): BioAPI_GUI_EVENT_SUBSCRIPTION {
        return new BioAPI_GUI_EVENT_SUBSCRIPTION(_o.subscriberEndpointIRI, _o.guiEventSubscriptionUuid, _o.guiSelectEventSubscribed, _o.guiStateEventSubscribed, _o.guiProgressEventSubscribed);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_GUI_EVENT_SUBSCRIPTION: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("guiSelectEventSubscribed", false, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("guiStateEventSubscribed", false, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("guiProgressEventSubscribed", false, $.hasTag(_TagClass.context, 4), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_GUI_EVENT_SUBSCRIPTION: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_GUI_EVENT_SUBSCRIPTION: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_GUI_EVENT_SUBSCRIPTION (el: _Element): BioAPI_GUI_EVENT_SUBSCRIPTION {
    if (!_cached_decoder_for_BioAPI_GUI_EVENT_SUBSCRIPTION) { _cached_decoder_for_BioAPI_GUI_EVENT_SUBSCRIPTION = function (el: _Element): BioAPI_GUI_EVENT_SUBSCRIPTION {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 5) {
        throw new _ConstructionError("BioAPI-GUI-EVENT-SUBSCRIPTION contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BioAPI_GUI_EVENT_SUBSCRIPTION (value: BioAPI_GUI_EVENT_SUBSCRIPTION, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_GUI_EVENT_SUBSCRIPTION) { _cached_encoder_for_BioAPI_GUI_EVENT_SUBSCRIPTION = function (value: BioAPI_GUI_EVENT_SUBSCRIPTION, elGetter: $.ASN1Encoder<BioAPI_GUI_EVENT_SUBSCRIPTION>): _Element {
