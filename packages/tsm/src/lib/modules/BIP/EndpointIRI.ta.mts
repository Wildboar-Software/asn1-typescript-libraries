 ...
 */
export
type EndpointIRI = VisibleString; // VisibleString
 ...
 */
export
function _decode_EndpointIRI (el: _Element): EndpointIRI {
    if (!_cached_decoder_for_EndpointIRI) { _cached_decoder_for_EndpointIRI = $._decodeVisibleString; }
 ...
 */
export
function _encode_EndpointIRI (value: EndpointIRI, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EndpointIRI) { _cached_encoder_for_EndpointIRI = $._encodeVisibleString; }
