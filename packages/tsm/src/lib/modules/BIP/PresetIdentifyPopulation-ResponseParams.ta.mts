 ...
 */
export
type PresetIdentifyPopulation_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_PresetIdentifyPopulation_ResponseParams (el: _Element): PresetIdentifyPopulation_ResponseParams {
    if (!_cached_decoder_for_PresetIdentifyPopulation_ResponseParams) { _cached_decoder_for_PresetIdentifyPopulation_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_PresetIdentifyPopulation_ResponseParams (value: PresetIdentifyPopulation_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PresetIdentifyPopulation_ResponseParams) { _cached_encoder_for_PresetIdentifyPopulation_ResponseParams = $._encodeNull; }
    return _cached_encoder_for_PresetIdentifyPopulation_ResponseParams(value, elGetter);
}
