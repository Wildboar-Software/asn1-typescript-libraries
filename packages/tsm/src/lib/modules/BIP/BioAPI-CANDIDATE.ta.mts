...
import { BioAPI_CANDIDATE_bir, _decode_BioAPI_CANDIDATE_bir, _encode_BioAPI_CANDIDATE_bir } from "../BIP/BioAPI-CANDIDATE-bir.ta.mjs";
// export { BioAPI_CANDIDATE_bir, _decode_BioAPI_CANDIDATE_bir, _encode_BioAPI_CANDIDATE_bir } from "../BIP/BioAPI-CANDIDATE-bir.ta.mjs";
...
class BioAPI_CANDIDATE {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_CANDIDATE)]: (BioAPI_CANDIDATE)[_K] }): BioAPI_CANDIDATE {
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_CANDIDATE: $.ComponentSpec[] = [
    new $.ComponentSpec("bir", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("fmrAchieved", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_CANDIDATE: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_CANDIDATE: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_CANDIDATE (el: _Element): BioAPI_CANDIDATE {
    if (!_cached_decoder_for_BioAPI_CANDIDATE) { _cached_decoder_for_BioAPI_CANDIDATE = function (el: _Element): BioAPI_CANDIDATE {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BioAPI-CANDIDATE contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "bir";
 ...
 */
export
function _encode_BioAPI_CANDIDATE (value: BioAPI_CANDIDATE, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_CANDIDATE) { _cached_encoder_for_BioAPI_CANDIDATE = function (value: BioAPI_CANDIDATE, elGetter: $.ASN1Encoder<BioAPI_CANDIDATE>): _Element {
