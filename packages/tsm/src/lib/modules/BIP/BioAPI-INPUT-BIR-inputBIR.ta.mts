...
import { BioAPI_DBBIR_ID, _decode_BioAPI_DBBIR_ID, _encode_BioAPI_DBBIR_ID } from "../BIP/BioAPI-DBBIR-ID.ta.mjs";
// export { BioAPI_DBBIR_ID, _decode_BioAPI_DBBIR_ID, _encode_BioAPI_DBBIR_ID } from "../BIP/BioAPI-DBBIR-ID.ta.mjs";
 ...
 */
export
type BioAPI_INPUT_BIR_inputBIR =
 ...
 */
export
function _decode_BioAPI_INPUT_BIR_inputBIR (el: _Element): BioAPI_INPUT_BIR_inputBIR {
    if (!_cached_decoder_for_BioAPI_INPUT_BIR_inputBIR) { _cached_decoder_for_BioAPI_INPUT_BIR_inputBIR = $._decode_inextensible_choice<BioAPI_INPUT_BIR_inputBIR>({
 ...
 */
export
function _encode_BioAPI_INPUT_BIR_inputBIR (value: BioAPI_INPUT_BIR_inputBIR, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_INPUT_BIR_inputBIR) { _cached_encoder_for_BioAPI_INPUT_BIR_inputBIR = $._encode_choice<BioAPI_INPUT_BIR_inputBIR>({
