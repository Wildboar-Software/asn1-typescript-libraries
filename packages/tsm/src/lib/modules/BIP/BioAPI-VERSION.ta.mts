...
class BioAPI_VERSION {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_VERSION)]: (BioAPI_VERSION)[_K] }): BioAPI_VERSION {
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_VERSION: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_VERSION: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_VERSION: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_VERSION (el: _Element): BioAPI_VERSION {
    if (!_cached_decoder_for_BioAPI_VERSION) { _cached_decoder_for_BioAPI_VERSION = function (el: _Element): BioAPI_VERSION {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BioAPI-VERSION contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BioAPI_VERSION (value: BioAPI_VERSION, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_VERSION) { _cached_encoder_for_BioAPI_VERSION = function (value: BioAPI_VERSION, elGetter: $.ASN1Encoder<BioAPI_VERSION>): _Element {
