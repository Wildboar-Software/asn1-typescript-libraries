 ...
 */
export
type EnableUnitEvents_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_EnableUnitEvents_ResponseParams (el: _Element): EnableUnitEvents_ResponseParams {
    if (!_cached_decoder_for_EnableUnitEvents_ResponseParams) { _cached_decoder_for_EnableUnitEvents_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_EnableUnitEvents_ResponseParams (value: EnableUnitEvents_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EnableUnitEvents_ResponseParams) { _cached_encoder_for_EnableUnitEvents_ResponseParams = $._encodeNull; }
