...
class BioAPI_BIR_HEADER {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_BIR_HEADER)]: (BioAPI_BIR_HEADER)[_K] }): BioAPI_BIR_HEADER {
        return new BioAPI_BIR_HEADER(_o.patronFormatOwner, _o.patronFormatType, _o.formattedBIR);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_BIR_HEADER: $.ComponentSpec[] = [
    new $.ComponentSpec("patronFormatOwner", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("patronFormatType", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("formattedBIR", false, $.hasTag(_TagClass.context, 2), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_BIR_HEADER: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_BIR_HEADER: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_BIR_HEADER (el: _Element): BioAPI_BIR_HEADER {
    if (!_cached_decoder_for_BioAPI_BIR_HEADER) { _cached_decoder_for_BioAPI_BIR_HEADER = function (el: _Element): BioAPI_BIR_HEADER {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new _ConstructionError("BioAPI-BIR-HEADER contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BioAPI_BIR_HEADER (value: BioAPI_BIR_HEADER, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_BIR_HEADER) { _cached_encoder_for_BioAPI_BIR_HEADER = function (value: BioAPI_BIR_HEADER, elGetter: $.ASN1Encoder<BioAPI_BIR_HEADER>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_UnsignedShort(value.patronFormatOwner, $.BER),
            /* REQUIRED   */ _encode_UnsignedShort(value.patronFormatType, $.BER),
