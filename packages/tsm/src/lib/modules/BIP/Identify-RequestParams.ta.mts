...
class Identify_RequestParams {
     ...
     */
    public static _from_object (_o: { [_K in keyof (Identify_RequestParams)]: (Identify_RequestParams)[_K] }): Identify_RequestParams {
        return new Identify_RequestParams(_o.originalBSPHandle, _o.maxFMRRequested, _o.subtype, _o.population, _o.totalNumberOfTemplates, _o.binning, _o.maxNumberOfResults, _o.timeout, _o.no_auditData);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_Identify_RequestParams: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("no-auditData", false, $.hasTag(_TagClass.context, 8), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_Identify_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_Identify_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_Identify_RequestParams (el: _Element): Identify_RequestParams {
    if (!_cached_decoder_for_Identify_RequestParams) { _cached_decoder_for_Identify_RequestParams = function (el: _Element): Identify_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 9) {
        throw new _ConstructionError("Identify-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_Identify_RequestParams (value: Identify_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Identify_RequestParams) { _cached_encoder_for_Identify_RequestParams = function (value: Identify_RequestParams, elGetter: $.ASN1Encoder<Identify_RequestParams>): _Element {
