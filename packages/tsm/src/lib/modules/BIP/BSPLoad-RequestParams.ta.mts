...
class BSPLoad_RequestParams {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BSPLoad_RequestParams)]: (BSPLoad_RequestParams)[_K] }): BSPLoad_RequestParams {
        return new BSPLoad_RequestParams(_o.bspProductUuid, _o.unitEventSubscription);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BSPLoad_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BSPLoad_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BSPLoad_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BSPLoad_RequestParams (el: _Element): BSPLoad_RequestParams {
    if (!_cached_decoder_for_BSPLoad_RequestParams) { _cached_decoder_for_BSPLoad_RequestParams = function (el: _Element): BSPLoad_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BSPLoad-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BSPLoad_RequestParams (value: BSPLoad_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BSPLoad_RequestParams) { _cached_encoder_for_BSPLoad_RequestParams = function (value: BSPLoad_RequestParams, elGetter: $.ASN1Encoder<BSPLoad_RequestParams>): _Element {
