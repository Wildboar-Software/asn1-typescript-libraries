 ...
 */
export
function _decode_BioAPI_CANDIDATE_bir (el: _Element): BioAPI_CANDIDATE_bir {
    if (!_cached_decoder_for_BioAPI_CANDIDATE_bir) { _cached_decoder_for_BioAPI_CANDIDATE_bir = $._decode_inextensible_choice<BioAPI_CANDIDATE_bir>({
 ...
 */
export
function _encode_BioAPI_CANDIDATE_bir (value: BioAPI_CANDIDATE_bir, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_CANDIDATE_bir) { _cached_encoder_for_BioAPI_CANDIDATE_bir = $._encode_choice<BioAPI_CANDIDATE_bir>({
