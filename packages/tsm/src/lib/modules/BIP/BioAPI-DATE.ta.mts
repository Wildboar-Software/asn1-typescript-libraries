...
class BioAPI_DATE {
     ...
     * @returns {BioAPI_DATE}
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_DATE)]: (BioAPI_DATE)[_K] }): BioAPI_DATE {
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_DATE: $.ComponentSpec[] = [
    new $.ComponentSpec("year", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("month", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("day", false, $.hasTag(_TagClass.context, 2), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_DATE: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_DATE: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_DATE (el: _Element): BioAPI_DATE {
    if (!_cached_decoder_for_BioAPI_DATE) { _cached_decoder_for_BioAPI_DATE = function (el: _Element): BioAPI_DATE {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new _ConstructionError("BioAPI-DATE contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BioAPI_DATE (value: BioAPI_DATE, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_DATE) { _cached_encoder_for_BioAPI_DATE = function (value: BioAPI_DATE, elGetter: $.ASN1Encoder<BioAPI_DATE>): _Element {
