...
class BioAPI_TIME {
     ...
     * @returns {BioAPI_TIME}
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_TIME)]: (BioAPI_TIME)[_K] }): BioAPI_TIME {
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_TIME: $.ComponentSpec[] = [
    new $.ComponentSpec("hour", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("minute", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("second", false, $.hasTag(_TagClass.context, 2), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_TIME: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_TIME: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_TIME (el: _Element): BioAPI_TIME {
    if (!_cached_decoder_for_BioAPI_TIME) { _cached_decoder_for_BioAPI_TIME = function (el: _Element): BioAPI_TIME {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new _ConstructionError("BioAPI-TIME contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BioAPI_TIME (value: BioAPI_TIME, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_TIME) { _cached_encoder_for_BioAPI_TIME = function (value: BioAPI_TIME, elGetter: $.ASN1Encoder<BioAPI_TIME>): _Element {
