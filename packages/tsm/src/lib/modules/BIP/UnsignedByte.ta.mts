 ...
 */
export
function _decode_UnsignedByte (el: _Element): UnsignedByte {
    if (!_cached_decoder_for_UnsignedByte) { _cached_decoder_for_UnsignedByte = $._decodeInteger; }
 ...
 */
export
function _encode_UnsignedByte (value: UnsignedByte, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnsignedByte) { _cached_encoder_for_UnsignedByte = $._encodeInteger; }
