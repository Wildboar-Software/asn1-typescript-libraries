 ...
 */
export
type EnumFrameworksCallOutputParams = BioAPI_FRAMEWORK_SCHEMA[]; // SequenceOfType
 ...
 */
export
function _decode_EnumFrameworksCallOutputParams (el: _Element): EnumFrameworksCallOutputParams {
    if (!_cached_decoder_for_EnumFrameworksCallOutputParams) { _cached_decoder_for_EnumFrameworksCallOutputParams = $._decodeSequenceOf<BioAPI_FRAMEWORK_SCHEMA>(() => _decode_BioAPI_FRAMEWORK_SCHEMA); }
 ...
 */
export
function _encode_EnumFrameworksCallOutputParams (value: EnumFrameworksCallOutputParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EnumFrameworksCallOutputParams) { _cached_encoder_for_EnumFrameworksCallOutputParams = $._encodeSequenceOf<BioAPI_FRAMEWORK_SCHEMA>(() => _encode_BioAPI_FRAMEWORK_SCHEMA, $.BER); }
