 ...
 */
export
type DeleteMaster_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_DeleteMaster_ResponseParams (el: _Element): DeleteMaster_ResponseParams {
    if (!_cached_decoder_for_DeleteMaster_ResponseParams) { _cached_decoder_for_DeleteMaster_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_DeleteMaster_ResponseParams (value: DeleteMaster_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DeleteMaster_ResponseParams) { _cached_encoder_for_DeleteMaster_ResponseParams = $._encodeNull; }
