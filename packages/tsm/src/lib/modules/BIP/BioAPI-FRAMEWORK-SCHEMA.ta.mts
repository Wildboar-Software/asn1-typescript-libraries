...
class BioAPI_FRAMEWORK_SCHEMA {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_FRAMEWORK_SCHEMA)]: (BioAPI_FRAMEWORK_SCHEMA)[_K] }): BioAPI_FRAMEWORK_SCHEMA {
        return new BioAPI_FRAMEWORK_SCHEMA(_o.fwProductUuid, _o.description, _o.path, _o.specVersion, _o.productVersion, _o.vendor, _o.propertyUuid, _o.property, _o.hostingEndpointIRI);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_FRAMEWORK_SCHEMA: $.ComponentSpec[] = [
    new $.ComponentSpec("fwProductUuid", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    ...
    new $.ComponentSpec("propertyUuid", false, $.hasTag(_TagClass.context, 6), undefined, undefined),
    new $.ComponentSpec("property", false, $.hasTag(_TagClass.context, 7), undefined, undefined),
    new $.ComponentSpec("hostingEndpointIRI", false, $.hasTag(_TagClass.context, 8), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_FRAMEWORK_SCHEMA: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_FRAMEWORK_SCHEMA: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_FRAMEWORK_SCHEMA (el: _Element): BioAPI_FRAMEWORK_SCHEMA {
    if (!_cached_decoder_for_BioAPI_FRAMEWORK_SCHEMA) { _cached_decoder_for_BioAPI_FRAMEWORK_SCHEMA = function (el: _Element): BioAPI_FRAMEWORK_SCHEMA {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 9) {
        throw new _ConstructionError("BioAPI-FRAMEWORK-SCHEMA contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BioAPI_FRAMEWORK_SCHEMA (value: BioAPI_FRAMEWORK_SCHEMA, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_FRAMEWORK_SCHEMA) { _cached_encoder_for_BioAPI_FRAMEWORK_SCHEMA = function (value: BioAPI_FRAMEWORK_SCHEMA, elGetter: $.ASN1Encoder<BioAPI_FRAMEWORK_SCHEMA>): _Element {
