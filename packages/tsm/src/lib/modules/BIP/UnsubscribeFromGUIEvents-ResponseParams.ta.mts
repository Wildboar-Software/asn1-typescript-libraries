 ...
 */
export
type UnsubscribeFromGUIEvents_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_UnsubscribeFromGUIEvents_ResponseParams (el: _Element): UnsubscribeFromGUIEvents_ResponseParams {
    if (!_cached_decoder_for_UnsubscribeFromGUIEvents_ResponseParams) { _cached_decoder_for_UnsubscribeFromGUIEvents_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_UnsubscribeFromGUIEvents_ResponseParams (value: UnsubscribeFromGUIEvents_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnsubscribeFromGUIEvents_ResponseParams) { _cached_encoder_for_UnsubscribeFromGUIEvents_ResponseParams = $._encodeNull; }
    return _cached_encoder_for_UnsubscribeFromGUIEvents_ResponseParams(value, elGetter);
}
