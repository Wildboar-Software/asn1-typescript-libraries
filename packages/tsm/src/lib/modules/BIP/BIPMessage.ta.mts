...
import { BIPMessage_nature, _decode_BIPMessage_nature, _encode_BIPMessage_nature } from "../BIP/BIPMessage-nature.ta.mjs";
// export { BIPMessage_nature, _decode_BIPMessage_nature, _encode_BIPMessage_nature } from "../BIP/BIPMessage-nature.ta.mjs";
...
class BIPMessage {
     ...
     * @returns {BIPMessage}
     */
    public static _from_object (_o: { [_K in keyof (BIPMessage)]: (BIPMessage)[_K] }): BIPMessage {
 ...
 */
export
const _root_component_type_list_1_spec_for_BIPMessage: $.ComponentSpec[] = [
    new $.ComponentSpec("nature", false, $.hasTag(_TagClass.context, 0), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BIPMessage: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BIPMessage: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BIPMessage (el: _Element): BIPMessage {
    if (!_cached_decoder_for_BIPMessage) { _cached_decoder_for_BIPMessage = function (el: _Element): BIPMessage {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new _ConstructionError("BIPMessage contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "nature";
    let nature!: BIPMessage_nature;
    nature = _decode_BIPMessage_nature(sequence[0]);
    return new BIPMessage(
        nature,
        sequence.slice(1),
    );
}; }
 ...
 */
export
function _encode_BIPMessage (value: BIPMessage, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BIPMessage) { _cached_encoder_for_BIPMessage = function (value: BIPMessage, elGetter: $.ASN1Encoder<BIPMessage>): _Element {
