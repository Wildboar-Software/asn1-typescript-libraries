 ...
 */
export
type DbDelete_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_DbDelete_ResponseParams (el: _Element): DbDelete_ResponseParams {
    if (!_cached_decoder_for_DbDelete_ResponseParams) { _cached_decoder_for_DbDelete_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_DbDelete_ResponseParams (value: DbDelete_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DbDelete_ResponseParams) { _cached_encoder_for_DbDelete_ResponseParams = $._encodeNull; }
