 ...
 */
export
type DbClose_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_DbClose_ResponseParams (el: _Element): DbClose_ResponseParams {
    if (!_cached_decoder_for_DbClose_ResponseParams) { _cached_decoder_for_DbClose_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_DbClose_ResponseParams (value: DbClose_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DbClose_ResponseParams) { _cached_encoder_for_DbClose_ResponseParams = $._encodeNull; }
