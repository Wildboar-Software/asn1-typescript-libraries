...
class BSPUnload_RequestParams {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BSPUnload_RequestParams)]: (BSPUnload_RequestParams)[_K] }): BSPUnload_RequestParams {
        return new BSPUnload_RequestParams(_o.bspProductUuid, _o.unitEventSubscription);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BSPUnload_RequestParams: $.ComponentSpec[] = [
    new $.ComponentSpec("bspProductUuid", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("unitEventSubscription", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BSPUnload_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BSPUnload_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BSPUnload_RequestParams (el: _Element): BSPUnload_RequestParams {
    if (!_cached_decoder_for_BSPUnload_RequestParams) { _cached_decoder_for_BSPUnload_RequestParams = function (el: _Element): BSPUnload_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BSPUnload-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BSPUnload_RequestParams (value: BSPUnload_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BSPUnload_RequestParams) { _cached_encoder_for_BSPUnload_RequestParams = function (value: BSPUnload_RequestParams, elGetter: $.ASN1Encoder<BSPUnload_RequestParams>): _Element {
