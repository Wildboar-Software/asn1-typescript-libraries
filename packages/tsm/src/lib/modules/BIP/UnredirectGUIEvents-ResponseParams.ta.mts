 ...
 */
export
type UnredirectGUIEvents_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_UnredirectGUIEvents_ResponseParams (el: _Element): UnredirectGUIEvents_ResponseParams {
    if (!_cached_decoder_for_UnredirectGUIEvents_ResponseParams) { _cached_decoder_for_UnredirectGUIEvents_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_UnredirectGUIEvents_ResponseParams (value: UnredirectGUIEvents_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnredirectGUIEvents_ResponseParams) { _cached_encoder_for_UnredirectGUIEvents_ResponseParams = $._encodeNull; }
    return _cached_encoder_for_UnredirectGUIEvents_ResponseParams(value, elGetter);
}
