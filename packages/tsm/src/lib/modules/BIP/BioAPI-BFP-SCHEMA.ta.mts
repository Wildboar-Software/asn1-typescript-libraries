...
class BioAPI_BFP_SCHEMA {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_BFP_SCHEMA)]: (BioAPI_BFP_SCHEMA)[_K] }): BioAPI_BFP_SCHEMA {
        return new BioAPI_BFP_SCHEMA(_o.bfpProductUuid, _o.category, _o.description, _o.path, _o.specVersion, _o.productVersion, _o.vendor, _o.supportedFormats, _o.factorsMask, _o.propertyUuid, _o.property, _o.hostingEndpointIRI);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_BFP_SCHEMA: $.ComponentSpec[] = [
    new $.ComponentSpec("bfpProductUuid", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("category", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("description", false, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("path", false, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("specVersion", false, $.hasTag(_TagClass.context, 4), undefined, undefined),
    new $.ComponentSpec("productVersion", false, $.hasTag(_TagClass.context, 5), undefined, undefined),
    new $.ComponentSpec("vendor", false, $.hasTag(_TagClass.context, 6), undefined, undefined),
    new $.ComponentSpec("supportedFormats", false, $.hasTag(_TagClass.context, 7), undefined, undefined),
    new $.ComponentSpec("factorsMask", false, $.hasTag(_TagClass.context, 8), undefined, undefined),
    new $.ComponentSpec("propertyUuid", false, $.hasTag(_TagClass.context, 9), undefined, undefined),
    new $.ComponentSpec("property", false, $.hasTag(_TagClass.context, 10), undefined, undefined),
    new $.ComponentSpec("hostingEndpointIRI", false, $.hasTag(_TagClass.context, 11), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_BFP_SCHEMA: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_BFP_SCHEMA: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_BFP_SCHEMA (el: _Element): BioAPI_BFP_SCHEMA {
    if (!_cached_decoder_for_BioAPI_BFP_SCHEMA) { _cached_decoder_for_BioAPI_BFP_SCHEMA = function (el: _Element): BioAPI_BFP_SCHEMA {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 12) {
        throw new _ConstructionError("BioAPI-BFP-SCHEMA contained only " + sequence.length.toString() + " elements.");
    }
    ...
    supportedFormats = $._decodeSequenceOf<BioAPI_BIR_BIOMETRIC_DATA_FORMAT>(() => _decode_BioAPI_BIR_BIOMETRIC_DATA_FORMAT)(sequence[7]);
 ...
 */
export
function _encode_BioAPI_BFP_SCHEMA (value: BioAPI_BFP_SCHEMA, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_BFP_SCHEMA) { _cached_encoder_for_BioAPI_BFP_SCHEMA = function (value: BioAPI_BFP_SCHEMA, elGetter: $.ASN1Encoder<BioAPI_BFP_SCHEMA>): _Element {
