 ...
 */
export
type UnregisterBSP_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_UnregisterBSP_ResponseParams (el: _Element): UnregisterBSP_ResponseParams {
    if (!_cached_decoder_for_UnregisterBSP_ResponseParams) { _cached_decoder_for_UnregisterBSP_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_UnregisterBSP_ResponseParams (value: UnregisterBSP_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnregisterBSP_ResponseParams) { _cached_encoder_for_UnregisterBSP_ResponseParams = $._encodeNull; }
