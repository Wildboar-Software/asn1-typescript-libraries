 ...
 */
export
class BSPRegistrationEvent_NotificationParams {
    constructor (
        /**
         * @summary `bspSchema`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (BSPRegistrationEvent_NotificationParams)]: (BSPRegistrationEvent_NotificationParams)[_K] }): BSPRegistrationEvent_NotificationParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_BSPRegistrationEvent_NotificationParams: $.ComponentSpec[] = [
    new $.ComponentSpec("bspSchema", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("update", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BSPRegistrationEvent_NotificationParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BSPRegistrationEvent_NotificationParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BSPRegistrationEvent_NotificationParams (el: _Element): BSPRegistrationEvent_NotificationParams {
    if (!_cached_decoder_for_BSPRegistrationEvent_NotificationParams) { _cached_decoder_for_BSPRegistrationEvent_NotificationParams = function (el: _Element): BSPRegistrationEvent_NotificationParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BSPRegistrationEvent-NotificationParams contained only " + sequence.length.toString() + " elements.");
    }
    ...
    return new BSPRegistrationEvent_NotificationParams(
        bspSchema,
        update,
 ...
 */
export
function _encode_BSPRegistrationEvent_NotificationParams (value: BSPRegistrationEvent_NotificationParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BSPRegistrationEvent_NotificationParams) { _cached_encoder_for_BSPRegistrationEvent_NotificationParams = function (value: BSPRegistrationEvent_NotificationParams, elGetter: $.ASN1Encoder<BSPRegistrationEvent_NotificationParams>): _Element {
    ...
    return _cached_encoder_for_BSPRegistrationEvent_NotificationParams(value, elGetter);
}
