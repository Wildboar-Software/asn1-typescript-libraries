 ...
 */
export
type DbSetMarker_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_DbSetMarker_ResponseParams (el: _Element): DbSetMarker_ResponseParams {
    if (!_cached_decoder_for_DbSetMarker_ResponseParams) { _cached_decoder_for_DbSetMarker_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_DbSetMarker_ResponseParams (value: DbSetMarker_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DbSetMarker_ResponseParams) { _cached_encoder_for_DbSetMarker_ResponseParams = $._encodeNull; }
