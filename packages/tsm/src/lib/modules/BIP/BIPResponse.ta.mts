...
import { BIPResponse_params, _decode_BIPResponse_params, _encode_BIPResponse_params } from "../BIP/BIPResponse-params.ta.mjs";
// export { BIPResponse_params, _decode_BIPResponse_params, _encode_BIPResponse_params } from "../BIP/BIPResponse-params.ta.mjs";
...
class BIPResponse {
     ...
     * @returns {BIPResponse}
     */
    public static _from_object (_o: { [_K in keyof (BIPResponse)]: (BIPResponse)[_K] }): BIPResponse {
        return new BIPResponse(_o.slaveEndpointIRI, _o.masterEndpointIRI, _o.linkNumber, _o.requestId, _o.params, _o.returnValue);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BIPResponse: $.ComponentSpec[] = [
    new $.ComponentSpec("slaveEndpointIRI", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("masterEndpointIRI", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("linkNumber", false, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("requestId", false, $.hasTag(_TagClass.context, 3), undefined, undefined),
 ...
 */
export
const _root_component_type_list_2_spec_for_BIPResponse: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BIPResponse: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BIPResponse (el: _Element): BIPResponse {
    if (!_cached_decoder_for_BIPResponse) { _cached_decoder_for_BIPResponse = function (el: _Element): BIPResponse {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 6) {
        throw new _ConstructionError("BIPResponse contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BIPResponse (value: BIPResponse, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BIPResponse) { _cached_encoder_for_BIPResponse = function (value: BIPResponse, elGetter: $.ASN1Encoder<BIPResponse>): _Element {
