...
import { UnsignedShort, _decode_UnsignedShort, _encode_UnsignedShort } from "../BIP/UnsignedShort.ta.mjs";
// export { UnsignedShort, _decode_UnsignedShort, _encode_UnsignedShort } from "../BIP/UnsignedShort.ta.mjs";
 ...
 */
export
class BioAPI_BIR_SECURITY_BLOCK_FORMAT {
    constructor (
        /**
         * @summary `formatOwner`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_BIR_SECURITY_BLOCK_FORMAT)]: (BioAPI_BIR_SECURITY_BLOCK_FORMAT)[_K] }): BioAPI_BIR_SECURITY_BLOCK_FORMAT {
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_BIR_SECURITY_BLOCK_FORMAT: $.ComponentSpec[] = [
    new $.ComponentSpec("formatOwner", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("formatType", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_BIR_SECURITY_BLOCK_FORMAT: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_BIR_SECURITY_BLOCK_FORMAT: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_BIR_SECURITY_BLOCK_FORMAT (el: _Element): BioAPI_BIR_SECURITY_BLOCK_FORMAT {
    if (!_cached_decoder_for_BioAPI_BIR_SECURITY_BLOCK_FORMAT) { _cached_decoder_for_BioAPI_BIR_SECURITY_BLOCK_FORMAT = function (el: _Element): BioAPI_BIR_SECURITY_BLOCK_FORMAT {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BioAPI-BIR-SECURITY-BLOCK-FORMAT contained only " + sequence.length.toString() + " elements.");
    }
    ...
    return new BioAPI_BIR_SECURITY_BLOCK_FORMAT(
        formatOwner,
        formatType,
 ...
 */
export
function _encode_BioAPI_BIR_SECURITY_BLOCK_FORMAT (value: BioAPI_BIR_SECURITY_BLOCK_FORMAT, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_BIR_SECURITY_BLOCK_FORMAT) { _cached_encoder_for_BioAPI_BIR_SECURITY_BLOCK_FORMAT = function (value: BioAPI_BIR_SECURITY_BLOCK_FORMAT, elGetter: $.ASN1Encoder<BioAPI_BIR_SECURITY_BLOCK_FORMAT>): _Element {
