 ...
 */
export
class CalibrateSensor_RequestParams {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (CalibrateSensor_RequestParams)]: (CalibrateSensor_RequestParams)[_K] }): CalibrateSensor_RequestParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_CalibrateSensor_RequestParams: $.ComponentSpec[] = [
    new $.ComponentSpec("originalBSPHandle", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("timeout", false, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_CalibrateSensor_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_CalibrateSensor_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_CalibrateSensor_RequestParams (el: _Element): CalibrateSensor_RequestParams {
    if (!_cached_decoder_for_CalibrateSensor_RequestParams) { _cached_decoder_for_CalibrateSensor_RequestParams = function (el: _Element): CalibrateSensor_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("CalibrateSensor-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
    ...
    return new CalibrateSensor_RequestParams(
        originalBSPHandle,
        timeout,
 ...
 */
export
function _encode_CalibrateSensor_RequestParams (value: CalibrateSensor_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CalibrateSensor_RequestParams) { _cached_encoder_for_CalibrateSensor_RequestParams = function (value: CalibrateSensor_RequestParams, elGetter: $.ASN1Encoder<CalibrateSensor_RequestParams>): _Element {
