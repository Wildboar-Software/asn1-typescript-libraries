 ...
 */
export
class AddMaster_ResponseParams {
    constructor (
        /**
         * @summary `fwSchema`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (AddMaster_ResponseParams)]: (AddMaster_ResponseParams)[_K] }): AddMaster_ResponseParams {
        return new AddMaster_ResponseParams(_o.fwSchema, _o.bspSchemas, _o.bfpSchemas);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_AddMaster_ResponseParams: $.ComponentSpec[] = [
    new $.ComponentSpec("fwSchema", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("bspSchemas", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("bfpSchemas", false, $.hasTag(_TagClass.context, 2), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_AddMaster_ResponseParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AddMaster_ResponseParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AddMaster_ResponseParams (el: _Element): AddMaster_ResponseParams {
    if (!_cached_decoder_for_AddMaster_ResponseParams) { _cached_decoder_for_AddMaster_ResponseParams = function (el: _Element): AddMaster_ResponseParams {
    let fwSchema: OPTIONAL<BioAPI_FRAMEWORK_SCHEMA>;
    let bspSchemas!: BioAPI_BSP_SCHEMA[];
    let bfpSchemas!: BioAPI_BFP_SCHEMA[];
    const callbacks: $.DecodingMap = {
        "fwSchema": (_el: _Element): void => { fwSchema = _decode_BioAPI_FRAMEWORK_SCHEMA(_el); },
        "bspSchemas": (_el: _Element): void => { bspSchemas = $._decodeSequenceOf<BioAPI_BSP_SCHEMA>(() => _decode_BioAPI_BSP_SCHEMA)(_el); },
        "bfpSchemas": (_el: _Element): void => { bfpSchemas = $._decodeSequenceOf<BioAPI_BFP_SCHEMA>(() => _decode_BioAPI_BFP_SCHEMA)(_el); }
    };
 ...
 */
export
function _encode_AddMaster_ResponseParams (value: AddMaster_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AddMaster_ResponseParams) { _cached_encoder_for_AddMaster_ResponseParams = function (value: AddMaster_ResponseParams, elGetter: $.ASN1Encoder<AddMaster_ResponseParams>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.fwSchema === undefined) ? undefined : _encode_BioAPI_FRAMEWORK_SCHEMA(value.fwSchema, $.BER)),
            /* REQUIRED   */ $._encodeSequenceOf<BioAPI_BSP_SCHEMA>(() => _encode_BioAPI_BSP_SCHEMA, $.BER)(value.bspSchemas, $.BER),
            /* REQUIRED   */ $._encodeSequenceOf<BioAPI_BFP_SCHEMA>(() => _encode_BioAPI_BFP_SCHEMA, $.BER)(value.bfpSchemas, $.BER)
        ],
