 ...
 */
export
type BioAPI_DB_HANDLE = SignedInt; // DefinedType
 ...
 */
export
function _decode_BioAPI_DB_HANDLE (el: _Element): BioAPI_DB_HANDLE {
    if (!_cached_decoder_for_BioAPI_DB_HANDLE) { _cached_decoder_for_BioAPI_DB_HANDLE = _decode_SignedInt; }
 ...
 */
export
function _encode_BioAPI_DB_HANDLE (value: BioAPI_DB_HANDLE, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_DB_HANDLE) { _cached_encoder_for_BioAPI_DB_HANDLE = _encode_SignedInt; }
