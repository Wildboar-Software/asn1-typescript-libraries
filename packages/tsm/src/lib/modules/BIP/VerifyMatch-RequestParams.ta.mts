 ...
 */
export
class VerifyMatch_RequestParams {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (VerifyMatch_RequestParams)]: (VerifyMatch_RequestParams)[_K] }): VerifyMatch_RequestParams {
        return new VerifyMatch_RequestParams(_o.originalBSPHandle, _o.maxFMRRequested, _o.processedBIR, _o.referenceTemplate, _o.no_adaptedBIR, _o.no_fmrAchieved, _o.no_payload);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_VerifyMatch_RequestParams: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("referenceTemplate", false, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("no-adaptedBIR", false, $.hasTag(_TagClass.context, 4), undefined, undefined),
    new $.ComponentSpec("no-fmrAchieved", false, $.hasTag(_TagClass.context, 5), undefined, undefined),
    new $.ComponentSpec("no-payload", false, $.hasTag(_TagClass.context, 6), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_VerifyMatch_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_VerifyMatch_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_VerifyMatch_RequestParams (el: _Element): VerifyMatch_RequestParams {
    if (!_cached_decoder_for_VerifyMatch_RequestParams) { _cached_decoder_for_VerifyMatch_RequestParams = function (el: _Element): VerifyMatch_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 7) {
        throw new _ConstructionError("VerifyMatch-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_VerifyMatch_RequestParams (value: VerifyMatch_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_VerifyMatch_RequestParams) { _cached_encoder_for_VerifyMatch_RequestParams = function (value: VerifyMatch_RequestParams, elGetter: $.ASN1Encoder<VerifyMatch_RequestParams>): _Element {
