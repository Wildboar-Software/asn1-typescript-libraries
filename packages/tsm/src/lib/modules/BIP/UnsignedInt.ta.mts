 ...
 */
export
function _decode_UnsignedInt (el: _Element): UnsignedInt {
    if (!_cached_decoder_for_UnsignedInt) { _cached_decoder_for_UnsignedInt = $._decodeInteger; }
 ...
 */
export
function _encode_UnsignedInt (value: UnsignedInt, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnsignedInt) { _cached_encoder_for_UnsignedInt = $._encodeInteger; }
