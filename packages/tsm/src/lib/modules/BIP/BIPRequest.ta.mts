...
import { BIPRequest_params, _decode_BIPRequest_params, _encode_BIPRequest_params } from "../BIP/BIPRequest-params.ta.mjs";
// export { BIPRequest_params, _decode_BIPRequest_params, _encode_BIPRequest_params } from "../BIP/BIPRequest-params.ta.mjs";
...
class BIPRequest {
     ...
     * @returns {BIPRequest}
     */
    public static _from_object (_o: { [_K in keyof (BIPRequest)]: (BIPRequest)[_K] }): BIPRequest {
        return new BIPRequest(_o.slaveEndpointIRI, _o.masterEndpointIRI, _o.linkNumber, _o.requestId, _o.params);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BIPRequest: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BIPRequest: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BIPRequest: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BIPRequest (el: _Element): BIPRequest {
    if (!_cached_decoder_for_BIPRequest) { _cached_decoder_for_BIPRequest = function (el: _Element): BIPRequest {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 5) {
        throw new _ConstructionError("BIPRequest contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_BIPRequest (value: BIPRequest, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BIPRequest) { _cached_encoder_for_BIPRequest = function (value: BIPRequest, elGetter: $.ASN1Encoder<BIPRequest>): _Element {
