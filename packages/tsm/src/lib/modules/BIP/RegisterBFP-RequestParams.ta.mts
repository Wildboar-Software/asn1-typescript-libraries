 ...
 */
export
class RegisterBFP_RequestParams {
    constructor (
        /**
         * @summary `bfpSchema`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (RegisterBFP_RequestParams)]: (RegisterBFP_RequestParams)[_K] }): RegisterBFP_RequestParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_RegisterBFP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_RegisterBFP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_RegisterBFP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_RegisterBFP_RequestParams (el: _Element): RegisterBFP_RequestParams {
    if (!_cached_decoder_for_RegisterBFP_RequestParams) { _cached_decoder_for_RegisterBFP_RequestParams = function (el: _Element): RegisterBFP_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("RegisterBFP-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
    ...
    return new RegisterBFP_RequestParams(
        bfpSchema,
        update,
 ...
 */
export
function _encode_RegisterBFP_RequestParams (value: RegisterBFP_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RegisterBFP_RequestParams) { _cached_encoder_for_RegisterBFP_RequestParams = function (value: RegisterBFP_RequestParams, elGetter: $.ASN1Encoder<RegisterBFP_RequestParams>): _Element {
