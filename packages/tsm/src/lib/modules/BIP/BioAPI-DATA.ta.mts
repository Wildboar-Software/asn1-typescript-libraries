 ...
 */
export
type BioAPI_DATA = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_BioAPI_DATA (el: _Element): BioAPI_DATA {
    if (!_cached_decoder_for_BioAPI_DATA) { _cached_decoder_for_BioAPI_DATA = $._decodeOctetString; }
 ...
 */
export
function _encode_BioAPI_DATA (value: BioAPI_DATA, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_DATA) { _cached_encoder_for_BioAPI_DATA = $._encodeOctetString; }
