 ...
 */
export
type VisibleBFPRegistration = BioAPI_BFP_SCHEMA; // DefinedType
 ...
 */
export
function _decode_VisibleBFPRegistration (el: _Element): VisibleBFPRegistration {
    if (!_cached_decoder_for_VisibleBFPRegistration) { _cached_decoder_for_VisibleBFPRegistration = _decode_BioAPI_BFP_SCHEMA; }
 ...
 */
export
function _encode_VisibleBFPRegistration (value: VisibleBFPRegistration, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_VisibleBFPRegistration) { _cached_encoder_for_VisibleBFPRegistration = _encode_BioAPI_BFP_SCHEMA; }
