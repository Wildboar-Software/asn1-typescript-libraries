 ...
 */
export
type BioAPI_STRING = UTF8String; // UTF8String
 ...
 */
export
function _decode_BioAPI_STRING (el: _Element): BioAPI_STRING {
    if (!_cached_decoder_for_BioAPI_STRING) { _cached_decoder_for_BioAPI_STRING = $._decodeUTF8String; }
 ...
 */
export
function _encode_BioAPI_STRING (value: BioAPI_STRING, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_STRING) { _cached_encoder_for_BioAPI_STRING = $._encodeUTF8String; }
