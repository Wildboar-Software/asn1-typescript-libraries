 ...
 */
export
type BioAPI_UUID = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_BioAPI_UUID (el: _Element): BioAPI_UUID {
    if (!_cached_decoder_for_BioAPI_UUID) { _cached_decoder_for_BioAPI_UUID = $._decodeOctetString; }
 ...
 */
export
function _encode_BioAPI_UUID (value: BioAPI_UUID, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_UUID) { _cached_encoder_for_BioAPI_UUID = $._encodeOctetString; }
