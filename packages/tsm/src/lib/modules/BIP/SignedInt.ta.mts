 ...
 */
export
function _decode_SignedInt (el: _Element): SignedInt {
    if (!_cached_decoder_for_SignedInt) { _cached_decoder_for_SignedInt = $._decodeInteger; }
 ...
 */
export
function _encode_SignedInt (value: SignedInt, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SignedInt) { _cached_encoder_for_SignedInt = $._encodeInteger; }
