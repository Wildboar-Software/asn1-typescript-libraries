 ...
 */
export
type EnumBSPsCallOutputParams = BioAPI_BSP_SCHEMA[]; // SequenceOfType
 ...
 */
export
function _decode_EnumBSPsCallOutputParams (el: _Element): EnumBSPsCallOutputParams {
    if (!_cached_decoder_for_EnumBSPsCallOutputParams) { _cached_decoder_for_EnumBSPsCallOutputParams = $._decodeSequenceOf<BioAPI_BSP_SCHEMA>(() => _decode_BioAPI_BSP_SCHEMA); }
 ...
 */
export
function _encode_EnumBSPsCallOutputParams (value: EnumBSPsCallOutputParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EnumBSPsCallOutputParams) { _cached_encoder_for_EnumBSPsCallOutputParams = $._encodeSequenceOf<BioAPI_BSP_SCHEMA>(() => _encode_BioAPI_BSP_SCHEMA, $.BER); }
