 ...
 */
export
type RedirectGUIEvents_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_RedirectGUIEvents_ResponseParams (el: _Element): RedirectGUIEvents_ResponseParams {
    if (!_cached_decoder_for_RedirectGUIEvents_ResponseParams) { _cached_decoder_for_RedirectGUIEvents_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_RedirectGUIEvents_ResponseParams (value: RedirectGUIEvents_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RedirectGUIEvents_ResponseParams) { _cached_encoder_for_RedirectGUIEvents_ResponseParams = $._encodeNull; }
