 ...
 */
export
class BSPAttachCallOutputParams {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (BSPAttachCallOutputParams)]: (BSPAttachCallOutputParams)[_K] }): BSPAttachCallOutputParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_BSPAttachCallOutputParams: $.ComponentSpec[] = [
    new $.ComponentSpec("newBSPHandle", false, $.hasTag(_TagClass.context, 0), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BSPAttachCallOutputParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BSPAttachCallOutputParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BSPAttachCallOutputParams (el: _Element): BSPAttachCallOutputParams {
    if (!_cached_decoder_for_BSPAttachCallOutputParams) { _cached_decoder_for_BSPAttachCallOutputParams = function (el: _Element): BSPAttachCallOutputParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new _ConstructionError("BSPAttachCallOutputParams contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "newBSPHandle";
    let newBSPHandle!: BioAPI_HANDLE;
    newBSPHandle = _decode_BioAPI_HANDLE(sequence[0]);
    return new BSPAttachCallOutputParams(
        newBSPHandle,
 ...
 */
export
function _encode_BSPAttachCallOutputParams (value: BSPAttachCallOutputParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BSPAttachCallOutputParams) { _cached_encoder_for_BSPAttachCallOutputParams = function (value: BSPAttachCallOutputParams, elGetter: $.ASN1Encoder<BSPAttachCallOutputParams>): _Element {
