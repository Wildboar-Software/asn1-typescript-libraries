 ...
 */
export
type MasterDeletionEvent_NotificationParams = NULL; // NullType
 ...
 */
export
function _decode_MasterDeletionEvent_NotificationParams (el: _Element): MasterDeletionEvent_NotificationParams {
    if (!_cached_decoder_for_MasterDeletionEvent_NotificationParams) { _cached_decoder_for_MasterDeletionEvent_NotificationParams = $._decodeNull; }
 ...
 */
export
function _encode_MasterDeletionEvent_NotificationParams (value: MasterDeletionEvent_NotificationParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MasterDeletionEvent_NotificationParams) { _cached_encoder_for_MasterDeletionEvent_NotificationParams = $._encodeNull; }
    return _cached_encoder_for_MasterDeletionEvent_NotificationParams(value, elGetter);
}
