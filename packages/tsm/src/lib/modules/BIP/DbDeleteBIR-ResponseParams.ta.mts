 ...
 */
export
type DbDeleteBIR_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_DbDeleteBIR_ResponseParams (el: _Element): DbDeleteBIR_ResponseParams {
    if (!_cached_decoder_for_DbDeleteBIR_ResponseParams) { _cached_decoder_for_DbDeleteBIR_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_DbDeleteBIR_ResponseParams (value: DbDeleteBIR_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DbDeleteBIR_ResponseParams) { _cached_encoder_for_DbDeleteBIR_ResponseParams = $._encodeNull; }
