...
class BioAPI_BIR_BIOMETRIC_DATA_FORMAT {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BioAPI_BIR_BIOMETRIC_DATA_FORMAT)]: (BioAPI_BIR_BIOMETRIC_DATA_FORMAT)[_K] }): BioAPI_BIR_BIOMETRIC_DATA_FORMAT {
 ...
 */
export
const _root_component_type_list_1_spec_for_BioAPI_BIR_BIOMETRIC_DATA_FORMAT: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BioAPI_BIR_BIOMETRIC_DATA_FORMAT: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BioAPI_BIR_BIOMETRIC_DATA_FORMAT: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BioAPI_BIR_BIOMETRIC_DATA_FORMAT (el: _Element): BioAPI_BIR_BIOMETRIC_DATA_FORMAT {
    if (!_cached_decoder_for_BioAPI_BIR_BIOMETRIC_DATA_FORMAT) { _cached_decoder_for_BioAPI_BIR_BIOMETRIC_DATA_FORMAT = function (el: _Element): BioAPI_BIR_BIOMETRIC_DATA_FORMAT {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BioAPI-BIR-BIOMETRIC-DATA-FORMAT contained only " + sequence.length.toString() + " elements.");
    }
    ...
    return new BioAPI_BIR_BIOMETRIC_DATA_FORMAT(
        formatOwner,
        formatType,
 ...
 */
export
function _encode_BioAPI_BIR_BIOMETRIC_DATA_FORMAT (value: BioAPI_BIR_BIOMETRIC_DATA_FORMAT, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BioAPI_BIR_BIOMETRIC_DATA_FORMAT) { _cached_encoder_for_BioAPI_BIR_BIOMETRIC_DATA_FORMAT = function (value: BioAPI_BIR_BIOMETRIC_DATA_FORMAT, elGetter: $.ASN1Encoder<BioAPI_BIR_BIOMETRIC_DATA_FORMAT>): _Element {
