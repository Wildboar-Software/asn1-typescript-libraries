 ...
 */
export
type VisibleBSPRegistration = BioAPI_BSP_SCHEMA; // DefinedType
 ...
 */
export
function _decode_VisibleBSPRegistration (el: _Element): VisibleBSPRegistration {
    if (!_cached_decoder_for_VisibleBSPRegistration) { _cached_decoder_for_VisibleBSPRegistration = _decode_BioAPI_BSP_SCHEMA; }
 ...
 */
export
function _encode_VisibleBSPRegistration (value: VisibleBSPRegistration, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_VisibleBSPRegistration) { _cached_encoder_for_VisibleBSPRegistration = _encode_BioAPI_BSP_SCHEMA; }
