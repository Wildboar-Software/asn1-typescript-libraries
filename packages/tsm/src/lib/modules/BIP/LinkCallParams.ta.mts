...
class LinkCallParams {
     ...
     */
    public static _from_object (_o: { [_K in keyof (LinkCallParams)]: (LinkCallParams)[_K] }): LinkCallParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_LinkCallParams: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_LinkCallParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_LinkCallParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_LinkCallParams (el: _Element): LinkCallParams {
    if (!_cached_decoder_for_LinkCallParams) { _cached_decoder_for_LinkCallParams = function (el: _Element): LinkCallParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new _ConstructionError("LinkCallParams contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "slaveEndpointIRI";
    let slaveEndpointIRI!: EndpointIRI;
    slaveEndpointIRI = _decode_EndpointIRI(sequence[0]);
    return new LinkCallParams(
        slaveEndpointIRI,
 ...
 */
export
function _encode_LinkCallParams (value: LinkCallParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_LinkCallParams) { _cached_encoder_for_LinkCallParams = function (value: LinkCallParams, elGetter: $.ASN1Encoder<LinkCallParams>): _Element {
