...
class UnlinkCallParams {
     ...
     */
    public static _from_object (_o: { [_K in keyof (UnlinkCallParams)]: (UnlinkCallParams)[_K] }): UnlinkCallParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_UnlinkCallParams: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_UnlinkCallParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_UnlinkCallParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_UnlinkCallParams (el: _Element): UnlinkCallParams {
    if (!_cached_decoder_for_UnlinkCallParams) { _cached_decoder_for_UnlinkCallParams = function (el: _Element): UnlinkCallParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new _ConstructionError("UnlinkCallParams contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "slaveEndpointIRI";
    let slaveEndpointIRI!: EndpointIRI;
    slaveEndpointIRI = _decode_EndpointIRI(sequence[0]);
    return new UnlinkCallParams(
        slaveEndpointIRI,
 ...
 */
export
function _encode_UnlinkCallParams (value: UnlinkCallParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnlinkCallParams) { _cached_encoder_for_UnlinkCallParams = function (value: UnlinkCallParams, elGetter: $.ASN1Encoder<UnlinkCallParams>): _Element {
