 ...
 */
export
class UnregisterBFP_RequestParams {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (UnregisterBFP_RequestParams)]: (UnregisterBFP_RequestParams)[_K] }): UnregisterBFP_RequestParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_UnregisterBFP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_UnregisterBFP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_UnregisterBFP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_UnregisterBFP_RequestParams (el: _Element): UnregisterBFP_RequestParams {
    if (!_cached_decoder_for_UnregisterBFP_RequestParams) { _cached_decoder_for_UnregisterBFP_RequestParams = function (el: _Element): UnregisterBFP_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 1) {
        throw new _ConstructionError("UnregisterBFP-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "bfpProductUuid";
    let bfpProductUuid!: BioAPI_UUID;
    bfpProductUuid = _decode_BioAPI_UUID(sequence[0]);
    return new UnregisterBFP_RequestParams(
        bfpProductUuid,
 ...
 */
export
function _encode_UnregisterBFP_RequestParams (value: UnregisterBFP_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnregisterBFP_RequestParams) { _cached_encoder_for_UnregisterBFP_RequestParams = function (value: UnregisterBFP_RequestParams, elGetter: $.ASN1Encoder<UnregisterBFP_RequestParams>): _Element {
