 ...
 */
export
class BFPRegistrationEvent_NotificationParams {
    constructor (
        /**
         * @summary `bfpSchema`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (BFPRegistrationEvent_NotificationParams)]: (BFPRegistrationEvent_NotificationParams)[_K] }): BFPRegistrationEvent_NotificationParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_BFPRegistrationEvent_NotificationParams: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BFPRegistrationEvent_NotificationParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BFPRegistrationEvent_NotificationParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BFPRegistrationEvent_NotificationParams (el: _Element): BFPRegistrationEvent_NotificationParams {
    if (!_cached_decoder_for_BFPRegistrationEvent_NotificationParams) { _cached_decoder_for_BFPRegistrationEvent_NotificationParams = function (el: _Element): BFPRegistrationEvent_NotificationParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("BFPRegistrationEvent-NotificationParams contained only " + sequence.length.toString() + " elements.");
    }
    ...
    return new BFPRegistrationEvent_NotificationParams(
        bfpSchema,
        update,
 ...
 */
export
function _encode_BFPRegistrationEvent_NotificationParams (value: BFPRegistrationEvent_NotificationParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BFPRegistrationEvent_NotificationParams) { _cached_encoder_for_BFPRegistrationEvent_NotificationParams = function (value: BFPRegistrationEvent_NotificationParams, elGetter: $.ASN1Encoder<BFPRegistrationEvent_NotificationParams>): _Element {
    ...
    return _cached_encoder_for_BFPRegistrationEvent_NotificationParams(value, elGetter);
}
