 ...
 */
export
class RegisterBSP_RequestParams {
    constructor (
        /**
         * @summary `bspSchema`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (RegisterBSP_RequestParams)]: (RegisterBSP_RequestParams)[_K] }): RegisterBSP_RequestParams {
 ...
 */
export
const _root_component_type_list_1_spec_for_RegisterBSP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_RegisterBSP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_RegisterBSP_RequestParams: $.ComponentSpec[] = [
 ...
 */
export
function _decode_RegisterBSP_RequestParams (el: _Element): RegisterBSP_RequestParams {
    if (!_cached_decoder_for_RegisterBSP_RequestParams) { _cached_decoder_for_RegisterBSP_RequestParams = function (el: _Element): RegisterBSP_RequestParams {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("RegisterBSP-RequestParams contained only " + sequence.length.toString() + " elements.");
    }
    ...
    return new RegisterBSP_RequestParams(
        bspSchema,
        update,
 ...
 */
export
function _encode_RegisterBSP_RequestParams (value: RegisterBSP_RequestParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RegisterBSP_RequestParams) { _cached_encoder_for_RegisterBSP_RequestParams = function (value: RegisterBSP_RequestParams, elGetter: $.ASN1Encoder<RegisterBSP_RequestParams>): _Element {
