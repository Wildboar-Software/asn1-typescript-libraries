 ...
 */
export
type RegisterBFP_ResponseParams = NULL; // NullType
 ...
 */
export
function _decode_RegisterBFP_ResponseParams (el: _Element): RegisterBFP_ResponseParams {
    if (!_cached_decoder_for_RegisterBFP_ResponseParams) { _cached_decoder_for_RegisterBFP_ResponseParams = $._decodeNull; }
 ...
 */
export
function _encode_RegisterBFP_ResponseParams (value: RegisterBFP_ResponseParams, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RegisterBFP_ResponseParams) { _cached_encoder_for_RegisterBFP_ResponseParams = $._encodeNull; }
