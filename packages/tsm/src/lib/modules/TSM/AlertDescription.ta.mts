...
let _cached_decoder_for_AlertDescription: $.ASN1Decoder<AlertDescription> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) AlertDescription
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_AlertDescription (el: _Element): AlertDescription {
    if (!_cached_decoder_for_AlertDescription) { _cached_decoder_for_AlertDescription = $._decodeEnumerated; }
    return _cached_decoder_for_AlertDescription(el);
}

let _cached_encoder_for_AlertDescription: $.ASN1Encoder<AlertDescription> | null = null;

/**
 * @summary Encodes a(n) AlertDescription into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The AlertDescription, encoded as an ASN.1 Element.
 */
export
function _encode_AlertDescription (value: AlertDescription, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AlertDescription) { _cached_encoder_for_AlertDescription = $._encodeEnumerated; }
    return _cached_encoder_for_AlertDescription(value, elGetter);
}
