...
function _encode_PreMasterSecret (value: PreMasterSecret, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PreMasterSecret) { _cached_encoder_for_PreMasterSecret = function (value: PreMasterSecret, elGetter: $.ASN1Encoder<PreMasterSecret>): _Element {
