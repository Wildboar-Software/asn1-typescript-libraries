...
function _encode_BDforLocalModel (value: BDforLocalModel, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BDforLocalModel) { _cached_encoder_for_BDforLocalModel = function (value: BDforLocalModel, elGetter: $.ASN1Encoder<BDforLocalModel>): _Element {
