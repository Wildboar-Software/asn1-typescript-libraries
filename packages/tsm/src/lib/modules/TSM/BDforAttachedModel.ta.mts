...
function _encode_BDforAttachedModel (value: BDforAttachedModel, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BDforAttachedModel) { _cached_encoder_for_BDforAttachedModel = function (value: BDforAttachedModel, elGetter: $.ASN1Encoder<BDforAttachedModel>): _Element {
