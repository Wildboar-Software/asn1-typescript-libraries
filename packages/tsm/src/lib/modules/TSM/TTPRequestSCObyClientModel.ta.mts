...
function _encode_TTPRequestSCObyClientModel (value: TTPRequestSCObyClientModel, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TTPRequestSCObyClientModel) { _cached_encoder_for_TTPRequestSCObyClientModel = function (value: TTPRequestSCObyClientModel, elGetter: $.ASN1Encoder<TTPRequestSCObyClientModel>): _Element {
