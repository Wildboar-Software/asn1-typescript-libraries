...
const _root_component_type_list_1_spec_for_Finished: $.ComponentSpec[] = [
    new $.ComponentSpec("verify-data", false, $.hasTag(_TagClass.context, 0), undefined, undefined)
];
...
function _encode_Finished (value: Finished, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Finished) { _cached_encoder_for_Finished = function (value: Finished, elGetter: $.ASN1Encoder<Finished>): _Element {
