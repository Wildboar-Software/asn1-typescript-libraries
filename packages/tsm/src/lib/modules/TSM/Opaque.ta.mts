...
function _decode_Opaque (el: _Element): Opaque {
    if (!_cached_decoder_for_Opaque) { _cached_decoder_for_Opaque = $._decodeOctetString; }
 ...
 */
export
function _encode_Opaque (value: Opaque, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Opaque) { _cached_encoder_for_Opaque = $._encodeOctetString; }
