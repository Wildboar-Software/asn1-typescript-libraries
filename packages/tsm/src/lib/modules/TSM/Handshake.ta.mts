...
import { Handshakes } from "../TSM/Handshakes.osa.mjs";
// export { Handshakes } from "../TSM/Handshakes.osa.mjs";
...
function _encode_Handshake (value: Handshake, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Handshake) { _cached_encoder_for_Handshake = function (value: Handshake, elGetter: $.ASN1Encoder<Handshake>): _Element {
