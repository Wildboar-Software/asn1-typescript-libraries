...
function _encode_TTPResponseSCObyServer (value: TTPResponseSCObyServer, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TTPResponseSCObyServer) { _cached_encoder_for_TTPResponseSCObyServer = function (value: TTPResponseSCObyServer, elGetter: $.ASN1Encoder<TTPResponseSCObyServer>): _Element {
