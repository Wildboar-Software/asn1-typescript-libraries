...
function _encode_BiometricTTPProcess (value: BiometricTTPProcess, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BiometricTTPProcess) { _cached_encoder_for_BiometricTTPProcess = function (value: BiometricTTPProcess, elGetter: $.ASN1Encoder<BiometricTTPProcess>): _Element {
