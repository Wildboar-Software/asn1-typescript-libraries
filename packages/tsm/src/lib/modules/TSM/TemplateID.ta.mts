...
// export { TemplateInfo, _decode_TemplateInfo, _encode_TemplateInfo } from "../TSM/TemplateInfo.ta.mjs";
...
const _root_component_type_list_1_spec_for_TemplateID: $.ComponentSpec[] = [
    new $.ComponentSpec("certificateIssuer", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("serialNumber", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("templateInfo", false, $.hasTag(_TagClass.context, 2), undefined, undefined)
];
...
function _encode_TemplateID (value: TemplateID, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TemplateID) { _cached_encoder_for_TemplateID = function (value: TemplateID, elGetter: $.ASN1Encoder<TemplateID>): _Element {
