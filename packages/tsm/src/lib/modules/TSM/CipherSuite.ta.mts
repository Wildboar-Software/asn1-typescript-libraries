...
let _cached_decoder_for_CipherSuite: $.ASN1Decoder<CipherSuite> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) CipherSuite
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_CipherSuite (el: _Element): CipherSuite {
    if (!_cached_decoder_for_CipherSuite) { _cached_decoder_for_CipherSuite = $._decodeEnumerated; }
    return _cached_decoder_for_CipherSuite(el);
}

let _cached_encoder_for_CipherSuite: $.ASN1Encoder<CipherSuite> | null = null;

/**
 * @summary Encodes a(n) CipherSuite into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The CipherSuite, encoded as an ASN.1 Element.
 */
export
function _encode_CipherSuite (value: CipherSuite, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CipherSuite) { _cached_encoder_for_CipherSuite = $._encodeEnumerated; }
    return _cached_encoder_for_CipherSuite(value, elGetter);
}
