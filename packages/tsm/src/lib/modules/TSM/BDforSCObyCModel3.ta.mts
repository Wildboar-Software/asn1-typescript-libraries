...
function _encode_BDforSCObyCModel3 (value: BDforSCObyCModel3, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BDforSCObyCModel3) { _cached_encoder_for_BDforSCObyCModel3 = function (value: BDforSCObyCModel3, elGetter: $.ASN1Encoder<BDforSCObyCModel3>): _Element {
