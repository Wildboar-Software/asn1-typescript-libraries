...
const _root_component_type_list_1_spec_for_EncapsulatedContentInfo: $.ComponentSpec[] = [
    new $.ComponentSpec("eContentType", false, $.hasTag(_TagClass.universal, 6), undefined, undefined),
    new $.ComponentSpec("eContent", true, $.hasTag(_TagClass.context, 0), undefined, undefined)
];
...
function _decode_EncapsulatedContentInfo (el: _Element): EncapsulatedContentInfo {
    ...
    const callbacks: $.DecodingMap = {
        "eContentType": (_el: _Element): void => { eContentType = _decode_ContentType(_el); },
