...
function _decode_CertificateRevocationLists (el: _Element): CertificateRevocationLists {
    if (!_cached_decoder_for_CertificateRevocationLists) { _cached_decoder_for_CertificateRevocationLists = $._decodeOctetString; }
...
function _encode_CertificateRevocationLists (value: CertificateRevocationLists, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CertificateRevocationLists) { _cached_encoder_for_CertificateRevocationLists = $._encodeOctetString; }
