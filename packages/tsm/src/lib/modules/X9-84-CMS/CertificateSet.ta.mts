 ...
 */
export
type CertificateSet = OCTET_STRING; // OctetStringType
...
function _decode_CertificateSet (el: _Element): CertificateSet {
    if (!_cached_decoder_for_CertificateSet) { _cached_decoder_for_CertificateSet = $._decodeOctetString; }
...
function _encode_CertificateSet (value: CertificateSet, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CertificateSet) { _cached_encoder_for_CertificateSet = $._encodeOctetString; }
