 ...
 */
export
function _decode_BiometricSecurityLevelId (el: _Element): BiometricSecurityLevelId {
 ...
 */
export
function _encode_BiometricSecurityLevelId (value: BiometricSecurityLevelId, elGetter: $.ASN1Encoder<any>): _Element {
