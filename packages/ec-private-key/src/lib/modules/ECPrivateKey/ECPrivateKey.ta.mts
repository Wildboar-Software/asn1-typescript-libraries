...
import { ECPrivateKey_version, ECPrivateKey_version_ecPrivkeyVer1 /* IMPORTED_LONG_NAMED_INTEGER */, ecPrivkeyVer1 /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_ECPrivateKey_version, _encode_ECPrivateKey_version } from "../ECPrivateKey/ECPrivateKey-version.ta.mjs";
export { ECPrivateKey_version, ECPrivateKey_version_ecPrivkeyVer1 /* IMPORTED_LONG_NAMED_INTEGER */, ecPrivkeyVer1 /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_ECPrivateKey_version, _encode_ECPrivateKey_version } from "../ECPrivateKey/ECPrivateKey-version.ta.mjs";
import { ECParameters, _decode_ECParameters, _encode_ECParameters } from "../PKIXAlgs-2009/ECParameters.ta.mjs";
export { ECParameters, _decode_ECParameters, _encode_ECParameters } from "../PKIXAlgs-2009/ECParameters.ta.mjs";
...
function _decode_ECPrivateKey (el: _Element) {
    ...
    let parameters: OPTIONAL<ECParameters>;
    ...
    const callbacks: $.DecodingMap = {
        ...
        "parameters": (_el: _Element): void => { parameters = $._decode_explicit<ECParameters>(() => _decode_ECParameters)(_el); },
