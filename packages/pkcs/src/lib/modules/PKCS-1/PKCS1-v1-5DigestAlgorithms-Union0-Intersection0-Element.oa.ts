...
import { id_md2 } from "../PKCS-1/id-md2.va.js";
export { ALGORITHM_IDENTIFIER } from "../PKCS-1/ALGORITHM-IDENTIFIER.oca.js";
export { id_md2 } from "../PKCS-1/id-md2.va.js";
 ...
 *
 * ```asn1
 * PKCS1-v1-5DigestAlgorithms-Union0-Intersection0-Element ::= {} -- REMOVED_FROM_UNNESTING --
 * ```
 *
 * @constant
 ...
 */
export const PKCS1_v1_5DigestAlgorithms_Union0_Intersection0_Element: ALGORITHM_IDENTIFIER<NULL> = {
...
/* END_OF_SYMBOL_DEFINITION PKCS1_v1_5DigestAlgorithms_Union0_Intersection0_Element */
