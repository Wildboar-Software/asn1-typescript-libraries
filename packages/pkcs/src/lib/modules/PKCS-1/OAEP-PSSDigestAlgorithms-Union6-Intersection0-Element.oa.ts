...
import { id_sha512_256 } from "../NIST-SHA2/id-sha512-256.va.js";
 ...
 *
 * ```asn1
 * OAEP-PSSDigestAlgorithms-Union6-Intersection0-Element ::= {} -- REMOVED_FROM_UNNESTING --
 * ```
 *
 * @constant
 ...
 */
export const OAEP_PSSDigestAlgorithms_Union6_Intersection0_Element: ALGORITHM_IDENTIFIER<NULL> = {
