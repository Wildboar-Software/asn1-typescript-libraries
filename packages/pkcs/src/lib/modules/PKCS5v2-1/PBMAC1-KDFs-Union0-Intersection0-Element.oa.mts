...
export { id_PBKDF2 } from "../PKCS5v2-1/id-PBKDF2.va.mjs";
export {
    PBKDF2_params,
    _decode_PBKDF2_params,
    _encode_PBKDF2_params,
 ...
 *
 * ```asn1
 * PBMAC1-KDFs-Union0-Intersection0-Element ::= {} -- REMOVED_FROM_UNNESTING --
 * ```
 *
 * @constant
 ...
 */
export const PBMAC1_KDFs_Union0_Intersection0_Element: ALGORITHM_IDENTIFIER<PBKDF2_params> = {
