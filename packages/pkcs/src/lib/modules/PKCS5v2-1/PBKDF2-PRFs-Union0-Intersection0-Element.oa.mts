...
/* START_OF_SYMBOL_DEFINITION PBKDF2_PRFs_Union0_Intersection0_Element */
/**
 * @summary PBKDF2_PRFs_Union0_Intersection0_Element
 * @description
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 * PBKDF2-PRFs-Union0-Intersection0-Element ::= {} -- REMOVED_FROM_UNNESTING --
 * ```
 *
 * @constant
 ...
 */
export const PBKDF2_PRFs_Union0_Intersection0_Element: ALGORITHM_IDENTIFIER<NULL> = {
...
/* END_OF_SYMBOL_DEFINITION PBKDF2_PRFs_Union0_Intersection0_Element */
