...
} from "../CryptographicMessageSyntax/KeyEncryptionAlgorithmIdentifier.ta.js";
import {
    OriginatorIdentifierOrKey,
    _decode_OriginatorIdentifierOrKey,
    _encode_OriginatorIdentifierOrKey,
} from "../CryptographicMessageSyntax/OriginatorIdentifierOrKey.ta.js";
import {
    RecipientEncryptedKeys,
    _decode_RecipientEncryptedKeys,
    _encode_RecipientEncryptedKeys,
} from "../CryptographicMessageSyntax/RecipientEncryptedKeys.ta.js";
import {
    UserKeyingMaterial,
    _decode_UserKeyingMaterial,
    _encode_UserKeyingMaterial,
} from "../CryptographicMessageSyntax/UserKeyingMaterial.ta.js";
export {
    CMSVersion,
