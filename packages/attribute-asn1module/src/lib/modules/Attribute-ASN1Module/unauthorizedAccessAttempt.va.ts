...
/* START_OF_SYMBOL_DEFINITION unauthorizedAccessAttempt */
/**
 ...
 */
export
const unauthorizedAccessAttempt: SecurityAlarmCause = new _OID([
    16,
], securityAlarmCause);
/* END_OF_SYMBOL_DEFINITION unauthorizedAccessAttempt */
