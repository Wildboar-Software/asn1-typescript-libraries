...
export { AttributeId, _decode_AttributeId, _encode_AttributeId } from "@wildboar/cmip/src/lib/modules/CMIP-1/AttributeId.ta.mjs";
...
export { ThresholdLevelInd, _decode_ThresholdLevelInd, _encode_ThresholdLevelInd } from "../Attribute-ASN1Module/ThresholdLevelInd.ta.mjs";
...
function _encode_ThresholdInfo (value: ThresholdInfo, elGetter: $.ASN1Encoder<ThresholdInfo>) {
    if (!_cached_encoder_for_ThresholdInfo) { _cached_encoder_for_ThresholdInfo = function (value: ThresholdInfo, elGetter: $.ASN1Encoder<ThresholdInfo>): _Element {
