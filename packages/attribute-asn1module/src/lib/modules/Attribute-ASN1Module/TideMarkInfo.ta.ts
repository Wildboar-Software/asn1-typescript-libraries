...
import { TideMark, _decode_TideMark, _encode_TideMark } from "../Attribute-ASN1Module/TideMark.ta.js";
export { TideMark, _decode_TideMark, _encode_TideMark } from "../Attribute-ASN1Module/TideMark.ta.js";
...
function _encode_TideMarkInfo (value: TideMarkInfo, elGetter: $.ASN1Encoder<TideMarkInfo>) {
    if (!_cached_encoder_for_TideMarkInfo) { _cached_encoder_for_TideMarkInfo = function (value: TideMarkInfo, elGetter: $.ASN1Encoder<TideMarkInfo>): _Element {
