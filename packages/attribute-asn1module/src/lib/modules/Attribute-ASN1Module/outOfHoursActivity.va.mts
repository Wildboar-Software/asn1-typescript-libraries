 ...
 * @description
 * 
 * Registered `SecurityAlarmCause` `{securityAlarmCause 13}`. Typical with the
 * X.736 timeDomainViolation notification. ITU-T Rec. X.721 (02/92) §14.2; ITU-T
 ...
 */
export
const outOfHoursActivity: SecurityAlarmCause = _OID.fromParts([
    13,
], securityAlarmCause);
