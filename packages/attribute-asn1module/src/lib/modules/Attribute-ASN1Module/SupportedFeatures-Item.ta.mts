...
export { DMI_SUPPORTEDFEATURES } from "../Attribute-ASN1Module/DMI-SUPPORTEDFEATURES.oca.mjs";
import { SupportedFeaturesSet } from "../Attribute-ASN1Module/SupportedFeaturesSet.osa.mjs";
export { SupportedFeaturesSet } from "../Attribute-ASN1Module/SupportedFeaturesSet.osa.mjs";
...
function _encode_SupportedFeatures_Item (value: SupportedFeatures_Item, elGetter: $.ASN1Encoder<SupportedFeatures_Item>) {
    if (!_cached_encoder_for_SupportedFeatures_Item) { _cached_encoder_for_SupportedFeatures_Item = function (value: SupportedFeatures_Item, elGetter: $.ASN1Encoder<SupportedFeatures_Item>): _Element {
