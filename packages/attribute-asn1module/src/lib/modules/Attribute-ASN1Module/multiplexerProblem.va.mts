 ...
 * @description
 * 
 * Registered `ProbableCause` `globalValue` `{arfProbableCause 31}` for X.733
 * equipment-alarm notifications. ITU-T Rec. X.721 (02/92) §14.2; ITU-T Rec.
 ...
 */
export
const multiplexerProblem: ProbableCause = { globalValue: _OID.fromParts([31,], arfProbableCause) };
