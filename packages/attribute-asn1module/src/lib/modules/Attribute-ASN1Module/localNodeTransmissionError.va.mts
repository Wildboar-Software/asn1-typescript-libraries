 ...
 * @description
 * 
 * Registered `ProbableCause` `globalValue` `{arfProbableCause 27}` for X.733
 ...
 */
export
const localNodeTransmissionError: ProbableCause = { globalValue: _OID.fromParts([27,], arfProbableCause) };
