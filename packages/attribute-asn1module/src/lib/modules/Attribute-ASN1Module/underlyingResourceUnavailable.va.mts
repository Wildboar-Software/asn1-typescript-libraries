 ...
 * @description
 * 
 * Registered `ProbableCause` `globalValue` `{arfProbableCause 56}` for X.733
 ...
 */
export
const underlyingResourceUnavailable: ProbableCause = { globalValue: _OID.fromParts([56,], arfProbableCause) };
