 ...
 * @description
 * 
 * Registered `ProbableCause` `globalValue` `{arfProbableCause 5}` for X.733
 ...
 */
export
const communicationsProtocolError: ProbableCause = { globalValue: _OID.fromParts([5,], arfProbableCause) };
