 ...
 * @description
 * 
 * Registered `ProbableCause` `globalValue` `{arfProbableCause 7}` for X.733
 ...
 */
export
const configurationOrCustomizationError: ProbableCause = { globalValue: _OID.fromParts([7,], arfProbableCause) };
