 ...
 * @description
 * 
 * Registered `ProbableCause` `globalValue` `{arfProbableCause 21}` for X.733
 ...
 */
export
const heatingOrVentilationOrCoolingSystemProblem: ProbableCause = { globalValue: _OID.fromParts([21,], arfProbableCause) };
