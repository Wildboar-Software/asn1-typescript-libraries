 ...
 * @description
 * 
 * Registered `ProbableCause` `globalValue` `{arfProbableCause 4}` for X.733
 ...
 */
export
const callEstablishmentError: ProbableCause = { globalValue: _OID.fromParts([4,], arfProbableCause) };
