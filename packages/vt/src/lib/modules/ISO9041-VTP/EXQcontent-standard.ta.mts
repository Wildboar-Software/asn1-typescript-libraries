...
function _encode_EXQcontent_standard (value: EXQcontent_standard, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EXQcontent_standard) { _cached_encoder_for_EXQcontent_standard = function (value: EXQcontent_standard, elGetter: $.ASN1Encoder<EXQcontent_standard>): _Element {
