 ...
 * @description
 *
 * Logical COPY-FROM-BUFFER. `structure` present ⇒ `"x"`, absent
 * ⇒ `"none"`. ISO/IEC 9040:1997 §19.4.2.5.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class DOupdate_copyLogFromBuffer {
    constructor (
         ...
         * @summary `address`.
         * @description
         * Start of the logical copy destination.
...
function _encode_DOupdate_copyLogFromBuffer (value: DOupdate_copyLogFromBuffer, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DOupdate_copyLogFromBuffer) { _cached_encoder_for_DOupdate_copyLogFromBuffer = function (value: DOupdate_copyLogFromBuffer): _Element {
