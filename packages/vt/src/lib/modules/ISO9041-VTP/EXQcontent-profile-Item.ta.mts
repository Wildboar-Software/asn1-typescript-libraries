 ...
 * 
 * ```asn1
 * EXQcontent-profile-Item ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_EXQcontent_profile_Item (value: EXQcontent_profile_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EXQcontent_profile_Item) { _cached_encoder_for_EXQcontent_profile_Item = function (value: EXQcontent_profile_Item, elGetter: $.ASN1Encoder<EXQcontent_profile_Item>): _Element {
