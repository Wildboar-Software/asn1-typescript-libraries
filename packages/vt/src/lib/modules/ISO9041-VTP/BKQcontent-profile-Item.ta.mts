 ...
 * 
 * ```asn1
 * BKQcontent-profile-Item ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_BKQcontent_profile_Item (value: BKQcontent_profile_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BKQcontent_profile_Item) { _cached_encoder_for_BKQcontent_profile_Item = function (value: BKQcontent_profile_Item, elGetter: $.ASN1Encoder<BKQcontent_profile_Item>): _Element {
