 ...
 * @description
 *
 * Offered event-id for update-count termination: `integer` is a
 * non-zero positive integer offer; `nul` is `"null"`. ISO/IEC
 * 9040:1997 §23.4.
 *
 * ### ASN.1 Definition:
 * 
...
function _encode_ParameterOffers_terminationLength_eventId (value: ParameterOffers_terminationLength_eventId, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ParameterOffers_terminationLength_eventId) { _cached_encoder_for_ParameterOffers_terminationLength_eventId = function (value: ParameterOffers_terminationLength_eventId): _Element {
