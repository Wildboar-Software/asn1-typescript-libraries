 ...
 * 
 * ```asn1
 * ParameterValues-defaultCOinitialValue ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_ParameterValues_defaultCOinitialValue (value: ParameterValues_defaultCOinitialValue, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ParameterValues_defaultCOinitialValue) { _cached_encoder_for_ParameterValues_defaultCOinitialValue = function (value: ParameterValues_defaultCOinitialValue, elGetter: $.ASN1Encoder<ParameterValues_defaultCOinitialValue>): _Element {
