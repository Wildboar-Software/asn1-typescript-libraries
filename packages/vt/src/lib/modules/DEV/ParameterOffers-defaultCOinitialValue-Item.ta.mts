 ...
 * 
 * ```asn1
 * ParameterOffers-defaultCOinitialValue-Item ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_ParameterOffers_defaultCOinitialValue_Item (value: ParameterOffers_defaultCOinitialValue_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ParameterOffers_defaultCOinitialValue_Item) { _cached_encoder_for_ParameterOffers_defaultCOinitialValue_Item = function (value: ParameterOffers_defaultCOinitialValue_Item, elGetter: $.ASN1Encoder<ParameterOffers_defaultCOinitialValue_Item>): _Element {
