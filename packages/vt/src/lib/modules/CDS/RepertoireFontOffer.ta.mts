 ...
 * @description
 *
 * Offer for one repertoire-list slot: `placeholder` skips the slot;
 * `alternatives` is a set of (repertoire, font-capability, fonts)
 * alternatives. ISO/IEC 9041-1:1997 §12.3.2; ISO/IEC 9040:1997
 * §18.2.4, §18.3.
 *
 * ### ASN.1 Definition:
 * 
