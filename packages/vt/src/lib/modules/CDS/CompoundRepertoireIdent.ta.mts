...
function _encode_CompoundRepertoireIdent (value: CompoundRepertoireIdent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CompoundRepertoireIdent) { _cached_encoder_for_CompoundRepertoireIdent = function (value: CompoundRepertoireIdent, elGetter: $.ASN1Encoder<CompoundRepertoireIdent>): _Element {
