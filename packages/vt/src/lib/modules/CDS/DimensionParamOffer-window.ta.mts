 ...
 * 
 * ```asn1
 * DimensionParamOffer-window ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_DimensionParamOffer_window (value: DimensionParamOffer_window, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DimensionParamOffer_window) { _cached_encoder_for_DimensionParamOffer_window = function (value: DimensionParamOffer_window, elGetter: $.ASN1Encoder<DimensionParamOffer_window>): _Element {
