...
function _encode_FieldParamOffer_maxFields (value: FieldParamOffer_maxFields, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FieldParamOffer_maxFields) { _cached_encoder_for_FieldParamOffer_maxFields = function (value: FieldParamOffer_maxFields, elGetter: $.ASN1Encoder<FieldParamOffer_maxFields>): _Element {
