...
function _encode_CompoundColourIdent (value: CompoundColourIdent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CompoundColourIdent) { _cached_encoder_for_CompoundColourIdent = function (value: CompoundColourIdent, elGetter: $.ASN1Encoder<CompoundColourIdent>): _Element {
