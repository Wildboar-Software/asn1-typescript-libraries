...
function _encode_BlockParamValues (value: BlockParamValues, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BlockParamValues) { _cached_encoder_for_BlockParamValues = function (value: BlockParamValues, elGetter: $.ASN1Encoder<BlockParamValues>): _Element {
