...
function _encode_FieldParamIdent (value: FieldParamIdent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FieldParamIdent) { _cached_encoder_for_FieldParamIdent = function (value: FieldParamIdent, elGetter: $.ASN1Encoder<FieldParamIdent>): _Element {
