...
function _encode_RepertoireAssignment (value: RepertoireAssignment, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RepertoireAssignment) { _cached_encoder_for_RepertoireAssignment = function (value: RepertoireAssignment, elGetter: $.ASN1Encoder<RepertoireAssignment>): _Element {
