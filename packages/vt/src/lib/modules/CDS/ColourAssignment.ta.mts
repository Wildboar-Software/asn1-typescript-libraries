...
function _encode_ColourAssignment (value: ColourAssignment, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ColourAssignment) { _cached_encoder_for_ColourAssignment = function (value: ColourAssignment, elGetter: $.ASN1Encoder<ColourAssignment>): _Element {
