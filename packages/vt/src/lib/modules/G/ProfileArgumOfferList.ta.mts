...
function _encode_ProfileArgumOfferList (value: ProfileArgumOfferList, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ProfileArgumOfferList) { _cached_encoder_for_ProfileArgumOfferList = function (value: ProfileArgumOfferList, elGetter: $.ASN1Encoder<ProfileArgumOfferList>): _Element {
