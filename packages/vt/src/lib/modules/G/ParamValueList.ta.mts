...
function _encode_ParamValueList (value: ParamValueList, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ParamValueList) { _cached_encoder_for_ParamValueList = function (value: ParamValueList, elGetter: $.ASN1Encoder<ParamValueList>): _Element {
