 ...
 * 
 * ```asn1
 * EntryControl-feprList-Item ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_EntryControl_feprList_Item (value: EntryControl_feprList_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EntryControl_feprList_Item) { _cached_encoder_for_EntryControl_feprList_Item = function (value: EntryControl_feprList_Item, elGetter: $.ASN1Encoder<EntryControl_feprList_Item>): _Element {
