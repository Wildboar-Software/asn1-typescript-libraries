...
function _encode_ElementParamIdent (value: ElementParamIdent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ElementParamIdent) { _cached_encoder_for_ElementParamIdent = function (value: ElementParamIdent, elGetter: $.ASN1Encoder<ElementParamIdent>): _Element {
