 ...
 * @description
 *
 * Signed BIT payload. The signing BCA may differ from the BCA
 * that signed the enclosing biometric certificate. ITU-T Rec.
 * X.1089 (05/2008)
 ...
 */
export
function _encode_BCBiometricInformationTemplate (value: BCBiometricInformationTemplate, elGetter: $.ASN1Encoder<BCBiometricInformationTemplate>): _Element {
