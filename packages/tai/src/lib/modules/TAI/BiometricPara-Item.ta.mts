 ...
 */
export
function _decode_BiometricPara_Item (el: _Element): BiometricPara_Item {
 ...
 */
export
function _encode_BiometricPara_Item (value: BiometricPara_Item, elGetter: $.ASN1Encoder<BiometricPara_Item>): _Element {
