...
import { CertificatePoliciesSyntax, _decode_CertificatePoliciesSyntax, _encode_CertificatePoliciesSyntax } from "../CertificateExtensions/CertificatePoliciesSyntax.ta.mjs";
// export { CertificatePoliciesSyntax, _decode_CertificatePoliciesSyntax, _encode_CertificatePoliciesSyntax } from "../CertificateExtensions/CertificatePoliciesSyntax.ta.mjs";
...
const _root_component_type_list_1_spec_for_SupportedAlgorithm: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("intendedUsage", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("intendedCertificatePolicies", true, $.hasTag(_TagClass.context, 1))
];
