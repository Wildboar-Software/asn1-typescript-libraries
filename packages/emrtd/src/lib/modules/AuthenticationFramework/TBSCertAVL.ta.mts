...
import { Version, _decode_Version, _encode_Version, v1 /* IMPORTED_SHORT_NAMED_INTEGER */ } from "../AuthenticationFramework/Version.ta.mjs";
...
const _root_component_type_list_1_spec_for_TBSCertAVL: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("constrained", false, $.hasTag(_TagClass.universal, 1)),
    new $.ComponentSpec("entries", false, $.hasTag(_TagClass.universal, 16))
];
...
const _root_component_type_list_2_spec_for_TBSCertAVL: $.ComponentSpec[] = [
    new $.ComponentSpec("avlExtensions", true, $.hasTag(_TagClass.universal, 16))
];
