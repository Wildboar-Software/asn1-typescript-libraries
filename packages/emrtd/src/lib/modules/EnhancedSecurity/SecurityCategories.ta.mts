 ...
 */
export
function _decode_SecurityCategories (el: _Element): SecurityCategories {
 ...
 */
export
function _encode_SecurityCategories (value: SecurityCategories, elGetter: $.ASN1Encoder<any>): _Element {
