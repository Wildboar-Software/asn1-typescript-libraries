 ...
 */
export
function _decode_SecurityPolicyIdentifier (el: _Element): SecurityPolicyIdentifier {
 ...
 */
export
function _encode_SecurityPolicyIdentifier (value: SecurityPolicyIdentifier, elGetter: $.ASN1Encoder<any>): _Element {
