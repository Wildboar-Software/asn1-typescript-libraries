...
class IssuerAndSerialNumber {
    ...
    public static _from_object (_o: { [_K in keyof (IssuerAndSerialNumber)]: (IssuerAndSerialNumber)[_K] }): IssuerAndSerialNumber {
        return new IssuerAndSerialNumber(_o.issuer, _o.serial, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
function _decode_IssuerAndSerialNumber (el: _Element): IssuerAndSerialNumber {
 ...
 */
export
function _encode_IssuerAndSerialNumber (value: IssuerAndSerialNumber, elGetter: $.ASN1Encoder<any>): _Element {
