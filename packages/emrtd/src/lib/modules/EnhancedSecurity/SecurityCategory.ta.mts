...
import { SecurityCategoriesTable } from "../EnhancedSecurity/SecurityCategoriesTable.osa.mjs";
...
class SecurityCategory {
     ...
     */
    public static _from_object (_o: { [_K in keyof (SecurityCategory)]: (SecurityCategory)[_K] }): SecurityCategory {
        return new SecurityCategory(_o.type_, _o.value, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_SecurityCategory: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_SecurityCategory: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SecurityCategory: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SecurityCategory (el: _Element): SecurityCategory {
    if (!_cached_decoder_for_SecurityCategory) { _cached_decoder_for_SecurityCategory = function (el: _Element): SecurityCategory {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("SecurityCategory contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_SecurityCategory (value: SecurityCategory, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SecurityCategory) { _cached_encoder_for_SecurityCategory = function (value: SecurityCategory, elGetter: $.ASN1Encoder<SecurityCategory>): _Element {
