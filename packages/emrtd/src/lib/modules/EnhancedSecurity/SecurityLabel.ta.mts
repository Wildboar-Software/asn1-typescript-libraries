...
import { SecurityPolicyIdentifier, _decode_SecurityPolicyIdentifier, _encode_SecurityPolicyIdentifier } from "../EnhancedSecurity/SecurityPolicyIdentifier.ta.mjs";
// export { SecurityPolicyIdentifier, _decode_SecurityPolicyIdentifier, _encode_SecurityPolicyIdentifier } from "../EnhancedSecurity/SecurityPolicyIdentifier.ta.mjs";
import { SecurityClassification, _decode_SecurityClassification, _encode_SecurityClassification } from "../EnhancedSecurity/SecurityClassification.ta.mjs";
// export { SecurityClassification, SecurityClassification_unmarked /* IMPORTED_LONG_NAMED_INTEGER */, unmarked /* IMPORTED_SHORT_NAMED_INTEGER */, SecurityClassification_unclassified /* IMPORTED_LONG_NAMED_INTEGER */, unclassified /* IMPORTED_SHORT_NAMED_INTEGER */, SecurityClassification_restricted /* IMPORTED_LONG_NAMED_INTEGER */, restricted /* IMPORTED_SHORT_NAMED_INTEGER */, SecurityClassification_confidential /* IMPORTED_LONG_NAMED_INTEGER */, confidential /* IMPORTED_SHORT_NAMED_INTEGER */, SecurityClassification_secret /* IMPORTED_LONG_NAMED_INTEGER */, secret /* IMPORTED_SHORT_NAMED_INTEGER */, SecurityClassification_top_secret /* IMPORTED_LONG_NAMED_INTEGER */, top_secret /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_SecurityClassification, _encode_SecurityClassification } from "../EnhancedSecurity/SecurityClassification.ta.mjs";
import { PrivacyMark, _decode_PrivacyMark, _encode_PrivacyMark } from "../EnhancedSecurity/PrivacyMark.ta.mjs";
// export { PrivacyMark, _decode_PrivacyMark, _encode_PrivacyMark } from "../EnhancedSecurity/PrivacyMark.ta.mjs";
import { SecurityCategories, _decode_SecurityCategories, _encode_SecurityCategories } from "../EnhancedSecurity/SecurityCategories.ta.mjs";
// export { SecurityCategories, _decode_SecurityCategories, _encode_SecurityCategories } from "../EnhancedSecurity/SecurityCategories.ta.mjs";
...
class SecurityLabel {
     ...
     */
    public static _from_object (_o: { [_K in keyof (SecurityLabel)]: (SecurityLabel)[_K] }): SecurityLabel {
        return new SecurityLabel(_o.security_policy_identifier, _o.security_classification, _o.privacy_mark, _o.security_categories, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_SecurityLabel: $.ComponentSpec[] = [
    new $.ComponentSpec("security-policy-identifier", true, $.hasTag(_TagClass.universal, 6)),
    new $.ComponentSpec("security-classification", true, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("privacy-mark", true, $.hasTag(_TagClass.universal, 19)),
    new $.ComponentSpec("security-categories", true, $.hasTag(_TagClass.universal, 17))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_SecurityLabel: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SecurityLabel: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SecurityLabel (el: _Element): SecurityLabel {
    if (!_cached_decoder_for_SecurityLabel) { _cached_decoder_for_SecurityLabel = function (el: _Element): SecurityLabel {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "privacy-mark": (_el: _Element): void => { privacy_mark = _decode_PrivacyMark(_el); },
 ...
 */
export
function _encode_SecurityLabel (value: SecurityLabel, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SecurityLabel) { _cached_encoder_for_SecurityLabel = function (value: SecurityLabel, elGetter: $.ASN1Encoder<SecurityLabel>): _Element {
    return $._encodeSet(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.security_policy_identifier === undefined) ? undefined : _encode_SecurityPolicyIdentifier(value.security_policy_identifier, $.BER)),
            ...
            /* IF_ABSENT  */ ((value.privacy_mark === undefined) ? undefined : _encode_PrivacyMark(value.privacy_mark, $.BER)),
