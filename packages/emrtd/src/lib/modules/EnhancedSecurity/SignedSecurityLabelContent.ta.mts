...
import { SecurityLabel, _decode_SecurityLabel, _encode_SecurityLabel } from "../EnhancedSecurity/SecurityLabel.ta.mjs";
// export { SecurityLabel, _decode_SecurityLabel, _encode_SecurityLabel } from "../EnhancedSecurity/SecurityLabel.ta.mjs";
...
class SignedSecurityLabelContent {
     ...
     */
    public static _from_object (_o: { [_K in keyof (SignedSecurityLabelContent)]: (SignedSecurityLabelContent)[_K] }): SignedSecurityLabelContent {
        return new SignedSecurityLabelContent(_o.attHash, _o.issuer, _o.keyIdentifier, _o.securityLabel, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_SignedSecurityLabelContent: $.ComponentSpec[] = [
    new $.ComponentSpec("attHash", false, $.hasTag(_TagClass.universal, 16)),
    /* FIXME: issuer COULD_NOT_RESOLVE_TYPE_DEF */,
    new $.ComponentSpec("keyIdentifier", true, $.hasTag(_TagClass.universal, 4)),
    new $.ComponentSpec("securityLabel", false, $.hasTag(_TagClass.universal, 17))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_SignedSecurityLabelContent: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SignedSecurityLabelContent: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SignedSecurityLabelContent (el: _Element): SignedSecurityLabelContent {
    if (!_cached_decoder_for_SignedSecurityLabelContent) { _cached_decoder_for_SignedSecurityLabelContent = function (el: _Element): SignedSecurityLabelContent {
    ...
    const callbacks: $.DecodingMap = {
        "attHash": (_el: _Element): void => { attHash = _get_decoder_for_HASH<AttributeTypeAndValue>(_decode_AttributeTypeAndValue)(_el); },
        "issuer": (_el: _Element): void => { issuer = _decode_Name(_el); },
        "keyIdentifier": (_el: _Element): void => { keyIdentifier = _decode_KeyIdentifier(_el); },
        "securityLabel": (_el: _Element): void => { securityLabel = _decode_SecurityLabel(_el); }
    };
 ...
 */
export
function _encode_SignedSecurityLabelContent (value: SignedSecurityLabelContent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SignedSecurityLabelContent) { _cached_encoder_for_SignedSecurityLabelContent = function (value: SignedSecurityLabelContent, elGetter: $.ASN1Encoder<SignedSecurityLabelContent>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _get_encoder_for_HASH<AttributeTypeAndValue>(_encode_AttributeTypeAndValue)(value.attHash, $.BER),
            /* IF_ABSENT  */ ((value.issuer === undefined) ? undefined : _encode_Name(value.issuer, $.BER)),
            /* IF_ABSENT  */ ((value.keyIdentifier === undefined) ? undefined : _encode_KeyIdentifier(value.keyIdentifier, $.BER)),
            /* REQUIRED   */ _encode_SecurityLabel(value.securityLabel, $.BER)
        ],
