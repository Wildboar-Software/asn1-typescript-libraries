...
import { CertificateGroup, _decode_CertificateGroup, _encode_CertificateGroup } from "../CertificateExtensions/CertificateGroup.ta.mjs";
// export { CertificateGroup, _decode_CertificateGroup, _encode_CertificateGroup } from "../CertificateExtensions/CertificateGroup.ta.mjs";
...
class ToBeRevokedGroup {
     ...
     */
    public static _from_object (_o: { [_K in keyof (ToBeRevokedGroup)]: (ToBeRevokedGroup)[_K] }): ToBeRevokedGroup {
        return new ToBeRevokedGroup(_o.certificateIssuer, _o.reasonInfo, _o.revocationTime, _o.certificateGroup, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ToBeRevokedGroup: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("revocationTime", false, $.hasTag(_TagClass.universal, 24)),
    new $.ComponentSpec("certificateGroup", false, $.hasAnyTag)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_ToBeRevokedGroup: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ToBeRevokedGroup: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ToBeRevokedGroup (el: _Element): ToBeRevokedGroup {
    if (!_cached_decoder_for_ToBeRevokedGroup) { _cached_decoder_for_ToBeRevokedGroup = function (el: _Element): ToBeRevokedGroup {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "revocationTime": (_el: _Element): void => { revocationTime = $._decodeGeneralizedTime(_el); },
        "certificateGroup": (_el: _Element): void => { certificateGroup = _decode_CertificateGroup(_el); }
    };
 ...
 */
export
function _encode_ToBeRevokedGroup (value: ToBeRevokedGroup, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ToBeRevokedGroup) { _cached_encoder_for_ToBeRevokedGroup = function (value: ToBeRevokedGroup, elGetter: $.ASN1Encoder<ToBeRevokedGroup>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ $._encodeGeneralizedTime(value.revocationTime, $.BER),
            /* REQUIRED   */ _encode_CertificateGroup(value.certificateGroup, $.BER)
        ],
