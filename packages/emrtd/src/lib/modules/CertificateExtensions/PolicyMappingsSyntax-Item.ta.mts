 ...
 */
export
class PolicyMappingsSyntax_Item {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (PolicyMappingsSyntax_Item)]: (PolicyMappingsSyntax_Item)[_K] }): PolicyMappingsSyntax_Item {
        return new PolicyMappingsSyntax_Item(_o.issuerDomainPolicy, _o.subjectDomainPolicy, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_PolicyMappingsSyntax_Item: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_PolicyMappingsSyntax_Item: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PolicyMappingsSyntax_Item: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PolicyMappingsSyntax_Item (el: _Element): PolicyMappingsSyntax_Item {
    if (!_cached_decoder_for_PolicyMappingsSyntax_Item) { _cached_decoder_for_PolicyMappingsSyntax_Item = function (el: _Element): PolicyMappingsSyntax_Item {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("PolicyMappingsSyntax-Item contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_PolicyMappingsSyntax_Item (value: PolicyMappingsSyntax_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PolicyMappingsSyntax_Item) { _cached_encoder_for_PolicyMappingsSyntax_Item = function (value: PolicyMappingsSyntax_Item, elGetter: $.ASN1Encoder<PolicyMappingsSyntax_Item>): _Element {
