...
import { CRLReason, _decode_CRLReason, _encode_CRLReason, _enum_for_CRLReason } from "../CertificateExtensions/CRLReason.ta.mjs";
...
import { HoldInstruction, _decode_HoldInstruction, _encode_HoldInstruction } from "../CertificateExtensions/HoldInstruction.ta.mjs";
// export { HoldInstruction, _decode_HoldInstruction, _encode_HoldInstruction } from "../CertificateExtensions/HoldInstruction.ta.mjs";
...
class ReasonInfo {
     ...
     * @returns {ReasonInfo}
     */
    public static _from_object (_o: { [_K in keyof (ReasonInfo)]: (ReasonInfo)[_K] }): ReasonInfo {
        return new ReasonInfo(_o.reasonCode, _o.holdInstructionCode, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ReasonInfo: $.ComponentSpec[] = [
    new $.ComponentSpec("reasonCode", false, $.hasTag(_TagClass.universal, 10)),
    new $.ComponentSpec("holdInstructionCode", true, $.hasTag(_TagClass.universal, 6))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_ReasonInfo: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ReasonInfo: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ReasonInfo (el: _Element): ReasonInfo {
    if (!_cached_decoder_for_ReasonInfo) { _cached_decoder_for_ReasonInfo = function (el: _Element): ReasonInfo {
    let reasonCode!: CRLReason;
    let holdInstructionCode: OPTIONAL<HoldInstruction>;
    let _unrecognizedExtensionsList: _Element[] = [];
    const callbacks: $.DecodingMap = {
        "reasonCode": (_el: _Element): void => { reasonCode = _decode_CRLReason(_el); },
        "holdInstructionCode": (_el: _Element): void => { holdInstructionCode = _decode_HoldInstruction(_el); }
    };
 ...
 */
export
function _encode_ReasonInfo (value: ReasonInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReasonInfo) { _cached_encoder_for_ReasonInfo = function (value: ReasonInfo, elGetter: $.ASN1Encoder<ReasonInfo>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_CRLReason(value.reasonCode, $.BER),
            /* IF_ABSENT  */ ((value.holdInstructionCode === undefined) ? undefined : _encode_HoldInstruction(value.holdInstructionCode, $.BER))
        ],
