 ...
 */
export
type ProtRestriction = OBJECT_IDENTIFIER[]; // SequenceOfType
 ...
 */
export
function _decode_ProtRestriction (el: _Element): ProtRestriction {
    if (!_cached_decoder_for_ProtRestriction) { _cached_decoder_for_ProtRestriction = $._decodeSequenceOf<OBJECT_IDENTIFIER>(() => $._decodeObjectIdentifier); }
 ...
 */
export
function _encode_ProtRestriction (value: ProtRestriction, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ProtRestriction) { _cached_encoder_for_ProtRestriction = $._encodeSequenceOf<OBJECT_IDENTIFIER>(() => $._encodeObjectIdentifier, $.BER); }
