...
import { BaseRevocationInfo, _decode_BaseRevocationInfo, _encode_BaseRevocationInfo } from "../CertificateExtensions/BaseRevocationInfo.ta.mjs";
// export { BaseRevocationInfo, _decode_BaseRevocationInfo, _encode_BaseRevocationInfo } from "../CertificateExtensions/BaseRevocationInfo.ta.mjs";
...
class PerAuthorityScope {
     ...
     */
    public static _from_object (_o: { [_K in keyof (PerAuthorityScope)]: (PerAuthorityScope)[_K] }): PerAuthorityScope {
        return new PerAuthorityScope(_o.authorityName, _o.distributionPoint, _o.onlyContains, _o.onlySomeReasons, _o.serialNumberRange, _o.subjectKeyIdRange, _o.nameSubtrees, _o.baseRevocationInfo, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_PerAuthorityScope: $.ComponentSpec[] = [
    new $.ComponentSpec("authorityName", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("distributionPoint", true, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("onlyContains", true, $.hasTag(_TagClass.context, 2)),
    new $.ComponentSpec("onlySomeReasons", true, $.hasTag(_TagClass.context, 4)),
    new $.ComponentSpec("serialNumberRange", true, $.hasTag(_TagClass.context, 5)),
    new $.ComponentSpec("subjectKeyIdRange", true, $.hasTag(_TagClass.context, 6)),
    new $.ComponentSpec("nameSubtrees", true, $.hasTag(_TagClass.context, 7)),
    new $.ComponentSpec("baseRevocationInfo", true, $.hasTag(_TagClass.context, 9))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_PerAuthorityScope: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PerAuthorityScope: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PerAuthorityScope (el: _Element): PerAuthorityScope {
    if (!_cached_decoder_for_PerAuthorityScope) { _cached_decoder_for_PerAuthorityScope = function (el: _Element): PerAuthorityScope {
    ...
    const callbacks: $.DecodingMap = {
        "authorityName": (_el: _Element): void => { authorityName = $._decode_explicit<GeneralName>(() => _decode_GeneralName)(_el); },
        ...
        "onlyContains": (_el: _Element): void => { onlyContains = $._decode_implicit<OnlyCertificateTypes>(() => _decode_OnlyCertificateTypes)(_el); },
        "onlySomeReasons": (_el: _Element): void => { onlySomeReasons = $._decode_implicit<ReasonFlags>(() => _decode_ReasonFlags)(_el); },
        "serialNumberRange": (_el: _Element): void => { serialNumberRange = $._decode_implicit<NumberRange>(() => _decode_NumberRange)(_el); },
        "subjectKeyIdRange": (_el: _Element): void => { subjectKeyIdRange = $._decode_implicit<NumberRange>(() => _decode_NumberRange)(_el); },
        "nameSubtrees": (_el: _Element): void => { nameSubtrees = $._decode_implicit<GeneralNames>(() => _decode_GeneralNames)(_el); },
        "baseRevocationInfo": (_el: _Element): void => { baseRevocationInfo = $._decode_implicit<BaseRevocationInfo>(() => _decode_BaseRevocationInfo)(_el); }
    };
 ...
 */
export
function _encode_PerAuthorityScope (value: PerAuthorityScope, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PerAuthorityScope) { _cached_encoder_for_PerAuthorityScope = function (value: PerAuthorityScope, elGetter: $.ASN1Encoder<PerAuthorityScope>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.authorityName === undefined) ? undefined : $._encode_explicit(_TagClass.context, 0, () => _encode_GeneralName, $.BER)(value.authorityName, $.BER)),
            /* IF_ABSENT  */ ((value.distributionPoint === undefined) ? undefined : $._encode_explicit(_TagClass.context, 1, () => _encode_DistributionPointName, $.BER)(value.distributionPoint, $.BER)),
            /* IF_ABSENT  */ ((value.onlyContains === undefined) ? undefined : $._encode_implicit(_TagClass.context, 2, () => _encode_OnlyCertificateTypes, $.BER)(value.onlyContains, $.BER)),
            /* IF_ABSENT  */ ((value.onlySomeReasons === undefined) ? undefined : $._encode_implicit(_TagClass.context, 4, () => _encode_ReasonFlags, $.BER)(value.onlySomeReasons, $.BER)),
            /* IF_ABSENT  */ ((value.serialNumberRange === undefined) ? undefined : $._encode_implicit(_TagClass.context, 5, () => _encode_NumberRange, $.BER)(value.serialNumberRange, $.BER)),
            /* IF_ABSENT  */ ((value.subjectKeyIdRange === undefined) ? undefined : $._encode_implicit(_TagClass.context, 6, () => _encode_NumberRange, $.BER)(value.subjectKeyIdRange, $.BER)),
            /* IF_ABSENT  */ ((value.nameSubtrees === undefined) ? undefined : $._encode_implicit(_TagClass.context, 7, () => _encode_GeneralNames, $.BER)(value.nameSubtrees, $.BER)),
            /* IF_ABSENT  */ ((value.baseRevocationInfo === undefined) ? undefined : $._encode_implicit(_TagClass.context, 9, () => _encode_BaseRevocationInfo, $.BER)(value.baseRevocationInfo, $.BER))
        ],
