...
import { SupportedPolicyQualifiers } from "../CertificateExtensions/SupportedPolicyQualifiers.osa.mjs";
...
class PolicyQualifierInfo {
    ...
    public static _from_object (_o: { [_K in keyof (PolicyQualifierInfo)]: (PolicyQualifierInfo)[_K] }): PolicyQualifierInfo {
        return new PolicyQualifierInfo(_o.policyQualifierId, _o.qualifier, _o._unrecognizedExtensionsList);
    }
...
function _decode_PolicyQualifierInfo (el: _Element): PolicyQualifierInfo {
    ...
    const callbacks: $.DecodingMap = {
        "policyQualifierId": (_el: _Element): void => { policyQualifierId = $._decodeObjectIdentifier(_el); },
...
function _encode_PolicyQualifierInfo (value: PolicyQualifierInfo, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeObjectIdentifier(value.policyQualifierId, $.BER),
