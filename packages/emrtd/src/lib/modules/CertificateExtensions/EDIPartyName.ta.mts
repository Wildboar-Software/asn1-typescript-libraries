...
const _root_component_type_list_1_spec_for_EDIPartyName: $.ComponentSpec[] = [
    /* FIXME: nameAssigner COULD_NOT_RESOLVE_TYPE_DEF */,
    /* FIXME: partyName COULD_NOT_RESOLVE_TYPE_DEF */
];
...
function _decode_EDIPartyName (el: _Element): EDIPartyName {
    ...
    const callbacks: $.DecodingMap = {
        "nameAssigner": (_el: _Element): void => { nameAssigner = $._decode_implicit<UnboundedDirectoryString>(() => _decode_UnboundedDirectoryString)(_el); },
        "partyName": (_el: _Element): void => { partyName = $._decode_implicit<UnboundedDirectoryString>(() => _decode_UnboundedDirectoryString)(_el); }
    };
...
function _encode_EDIPartyName (value: EDIPartyName, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.nameAssigner === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => _encode_UnboundedDirectoryString, $.BER)(value.nameAssigner, $.BER)),
            /* REQUIRED   */ $._encode_implicit(_TagClass.context, 1, () => _encode_UnboundedDirectoryString, $.BER)(value.partyName, $.BER)
        ],
