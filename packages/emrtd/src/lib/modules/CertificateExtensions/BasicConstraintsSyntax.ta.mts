...
class BasicConstraintsSyntax {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BasicConstraintsSyntax)]: (BasicConstraintsSyntax)[_K] }): BasicConstraintsSyntax {
        return new BasicConstraintsSyntax(_o.cA, _o.pathLenConstraint, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BasicConstraintsSyntax: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BasicConstraintsSyntax: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BasicConstraintsSyntax: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BasicConstraintsSyntax (el: _Element): BasicConstraintsSyntax {
    if (!_cached_decoder_for_BasicConstraintsSyntax) { _cached_decoder_for_BasicConstraintsSyntax = function (el: _Element): BasicConstraintsSyntax {
    let cA: OPTIONAL<BOOLEAN> = BasicConstraintsSyntax._default_value_for_cA;
 ...
 */
export
function _encode_BasicConstraintsSyntax (value: BasicConstraintsSyntax, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BasicConstraintsSyntax) { _cached_encoder_for_BasicConstraintsSyntax = function (value: BasicConstraintsSyntax, elGetter: $.ASN1Encoder<BasicConstraintsSyntax>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_DEFAULT */ (value.cA === undefined || $.deepEq(value.cA, BasicConstraintsSyntax._default_value_for_cA) ? undefined : $._encodeBoolean(value.cA, $.BER)),
