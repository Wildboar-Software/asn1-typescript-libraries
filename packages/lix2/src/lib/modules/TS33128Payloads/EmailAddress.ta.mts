...
function _decode_EmailAddress (el: _Element): EmailAddress {
    if (!_cached_decoder_for_EmailAddress) { _cached_decoder_for_EmailAddress = $._decodeUTF8String; }
...
function _encode_EmailAddress (value: EmailAddress, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EmailAddress) { _cached_encoder_for_EmailAddress = $._encodeUTF8String; }
