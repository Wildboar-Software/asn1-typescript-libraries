 ...
 *     deprecatedS1Information        [15] S1Information OPTIONAL,
...
class MMEAttach {
    ...
    /**
     * @summary Restructures an object into a MMEAttach
     * @description
     * 
     * This takes an `object` and converts it to a `MMEAttach`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `MMEAttach`.
     * @returns {MMEAttach}
     */
    public static _from_object (_o: { [_K in keyof (MMEAttach)]: (MMEAttach)[_K] }): MMEAttach {
        return new MMEAttach(_o.attachType, _o.attachResult, _o.iMSI, _o.iMEI, _o.mSISDN, _o.gUTI, _o.location, _o.ePSTAIList, _o.sMSServiceStatus, _o.oldGUTI, _o.eMM5GRegStatus, _o.pagingRestrictionIndicator, _o.rATType, _o.rRCEstablishmentCause, _o.deprecatedS1Information, _o.nASTransportInitialInformation, _o.equivalentPLMNList, _o.ePSUENetworkCapability, _o.initailRANUEContextSetup, _o.mUSIMUERequestType, _o.ePSNetworkPolicy);
    }
...
/**
 * @summary The Leading Root Component Types of MMEAttach
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_MMEAttach: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("ePSTAIList", true, $.hasTag(_TagClass.context, 8)),
    new $.ComponentSpec("sMSServiceStatus", true, $.hasTag(_TagClass.context, 9)),
    new $.ComponentSpec("oldGUTI", true, $.hasTag(_TagClass.context, 10)),
    new $.ComponentSpec("eMM5GRegStatus", true, $.hasTag(_TagClass.context, 11)),
    new $.ComponentSpec("pagingRestrictionIndicator", true, $.hasTag(_TagClass.context, 12)),
    new $.ComponentSpec("rATType", true, $.hasTag(_TagClass.context, 13)),
    new $.ComponentSpec("rRCEstablishmentCause", true, $.hasTag(_TagClass.context, 14)),
    new $.ComponentSpec("deprecatedS1Information", true, $.hasTag(_TagClass.context, 15)),
    new $.ComponentSpec("nASTransportInitialInformation", true, $.hasTag(_TagClass.context, 16)),
    new $.ComponentSpec("equivalentPLMNList", true, $.hasTag(_TagClass.context, 17)),
    new $.ComponentSpec("ePSUENetworkCapability", true, $.hasTag(_TagClass.context, 18)),
    new $.ComponentSpec("initailRANUEContextSetup", true, $.hasTag(_TagClass.context, 19)),
    new $.ComponentSpec("mUSIMUERequestType", true, $.hasTag(_TagClass.context, 20)),
    new $.ComponentSpec("ePSNetworkPolicy", true, $.hasTag(_TagClass.context, 21))
];

/**
 * @summary The Trailing Root Component Types of MMEAttach
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_MMEAttach: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of MMEAttach
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_MMEAttach: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_MMEAttach: $.ASN1Decoder<MMEAttach> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) MMEAttach
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_MMEAttach (el: _Element): MMEAttach {
    if (!_cached_decoder_for_MMEAttach) { _cached_decoder_for_MMEAttach = function (el: _Element): MMEAttach {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_MMEAttach,
        _extension_additions_list_spec_for_MMEAttach,
        _root_component_type_list_2_spec_for_MMEAttach,
        undefined,
    );
    return new MMEAttach(
        attachType,
        attachResult,
        iMSI,
        iMEI,
    ...
    return _cached_decoder_for_MMEAttach(el);
}

let _cached_encoder_for_MMEAttach: $.ASN1Encoder<MMEAttach> | null = null;

/**
 * @summary Encodes a(n) MMEAttach into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The MMEAttach, encoded as an ASN.1 Element.
 */
export
function _encode_MMEAttach (value: MMEAttach, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MMEAttach) { _cached_encoder_for_MMEAttach = function (value: MMEAttach, elGetter: $.ASN1Encoder<MMEAttach>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.ePSTAIList === undefined) ? undefined : $._encode_implicit(_TagClass.context, 8, () => _encode_TAIList, $.BER)(value.ePSTAIList, $.BER)),
            /* IF_ABSENT  */ ((value.sMSServiceStatus === undefined) ? undefined : $._encode_implicit(_TagClass.context, 9, () => _encode_EPSSMSServiceStatus, $.BER)(value.sMSServiceStatus, $.BER)),
            /* IF_ABSENT  */ ((value.oldGUTI === undefined) ? undefined : $._encode_implicit(_TagClass.context, 10, () => _encode_GUTI, $.BER)(value.oldGUTI, $.BER)),
            /* IF_ABSENT  */ ((value.eMM5GRegStatus === undefined) ? undefined : $._encode_implicit(_TagClass.context, 11, () => _encode_EMM5GMMStatus, $.BER)(value.eMM5GRegStatus, $.BER)),
            /* IF_ABSENT  */ ((value.pagingRestrictionIndicator === undefined) ? undefined : $._encode_implicit(_TagClass.context, 12, () => _encode_PagingRestrictionIndicator, $.BER)(value.pagingRestrictionIndicator, $.BER)),
            /* IF_ABSENT  */ ((value.rATType === undefined) ? undefined : $._encode_implicit(_TagClass.context, 13, () => _encode_RATType, $.BER)(value.rATType, $.BER)),
            /* IF_ABSENT  */ ((value.rRCEstablishmentCause === undefined) ? undefined : $._encode_explicit(_TagClass.context, 14, () => _encode_RRCEstablishmentCause, $.BER)(value.rRCEstablishmentCause, $.BER)),
            /* IF_ABSENT  */ ((value.deprecatedS1Information === undefined) ? undefined : $._encode_implicit(_TagClass.context, 15, () => _encode_S1Information, $.BER)(value.deprecatedS1Information, $.BER)),
            /* IF_ABSENT  */ ((value.nASTransportInitialInformation === undefined) ? undefined : $._encode_implicit(_TagClass.context, 16, () => _encode_EPSNASTransportInitialInformation, $.BER)(value.nASTransportInitialInformation, $.BER)),
            /* IF_ABSENT  */ ((value.equivalentPLMNList === undefined) ? undefined : $._encode_implicit(_TagClass.context, 17, () => _encode_PLMNList, $.BER)(value.equivalentPLMNList, $.BER)),
            /* IF_ABSENT  */ ((value.ePSUENetworkCapability === undefined) ? undefined : $._encode_implicit(_TagClass.context, 18, () => _encode_EPSUENetworkCapability, $.BER)(value.ePSUENetworkCapability, $.BER)),
            /* IF_ABSENT  */ ((value.initailRANUEContextSetup === undefined) ? undefined : $._encode_implicit(_TagClass.context, 19, () => _encode_EPSRANUEContext, $.BER)(value.initailRANUEContextSetup, $.BER)),
            /* IF_ABSENT  */ ((value.mUSIMUERequestType === undefined) ? undefined : $._encode_implicit(_TagClass.context, 20, () => _encode_MUSIMUERequestType, $.BER)(value.mUSIMUERequestType, $.BER)),
            /* IF_ABSENT  */ ((value.ePSNetworkPolicy === undefined) ? undefined : $._encode_implicit(_TagClass.context, 21, () => _encode_EPSNetworkPolicy, $.BER)(value.ePSNetworkPolicy, $.BER))
        ],
    ).filter((c: (_Element | undefined)): c is _Element => (!!c)), $.BER);
}; }
    return _cached_encoder_for_MMEAttach(value, elGetter);
}
