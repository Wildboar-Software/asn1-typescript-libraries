...
import { N9HRPDUSessionInfo, _decode_N9HRPDUSessionInfo, _encode_N9HRPDUSessionInfo } from "../TS33128Payloads/N9HRPDUSessionInfo.ta.mjs";
// export { N9HRPDUSessionInfo, _decode_N9HRPDUSessionInfo, _encode_N9HRPDUSessionInfo } from "../TS33128Payloads/N9HRPDUSessionInfo.ta.mjs";
import { S8HRBearerInfo, _decode_S8HRBearerInfo, _encode_S8HRBearerInfo } from "../TS33128Payloads/S8HRBearerInfo.ta.mjs";
// export { S8HRBearerInfo, _decode_S8HRBearerInfo, _encode_S8HRBearerInfo } from "../TS33128Payloads/S8HRBearerInfo.ta.mjs";
 ...
 *     iPIRIPacketReport                                   [161] IPIRIPacketReport,
 * 
...
type XIRIEvent =
    ...
    | { n9HRPDUSessionInfo: N9HRPDUSessionInfo } /* CHOICE_ALT_ROOT */
    | { s8HRBearerInfo: S8HRBearerInfo } /* CHOICE_ALT_ROOT */
    ...
    | { iPIRIPacketReport: IPIRIPacketReport } /* CHOICE_ALT_ROOT */
...
let _cached_decoder_for_XIRIEvent: $.ASN1Decoder<XIRIEvent> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) XIRIEvent
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_XIRIEvent (el: _Element): XIRIEvent {
    if (!_cached_decoder_for_XIRIEvent) { _cached_decoder_for_XIRIEvent = $._decode_inextensible_choice<XIRIEvent>({
    ...
    "CONTEXT 100": [ "n9HRPDUSessionInfo", $._decode_implicit<N9HRPDUSessionInfo>(() => _decode_N9HRPDUSessionInfo) ],
    "CONTEXT 101": [ "s8HRBearerInfo", $._decode_implicit<S8HRBearerInfo>(() => _decode_S8HRBearerInfo) ],
    ...
    "CONTEXT 161": [ "iPIRIPacketReport", $._decode_implicit<IPIRIPacketReport>(() => _decode_IPIRIPacketReport) ],
    ...
    return _cached_decoder_for_XIRIEvent(el);
}

let _cached_encoder_for_XIRIEvent: $.ASN1Encoder<XIRIEvent> | null = null;

/**
 * @summary Encodes a(n) XIRIEvent into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The XIRIEvent, encoded as an ASN.1 Element.
 */
export
function _encode_XIRIEvent (value: XIRIEvent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_XIRIEvent) { _cached_encoder_for_XIRIEvent = $._encode_choice<XIRIEvent>({
    ...
    "n9HRPDUSessionInfo": $._encode_implicit(_TagClass.context, 100, () => _encode_N9HRPDUSessionInfo, $.BER),
    "s8HRBearerInfo": $._encode_implicit(_TagClass.context, 101, () => _encode_S8HRBearerInfo, $.BER),
    ...
    "iPIRIPacketReport": $._encode_implicit(_TagClass.context, 161, () => _encode_IPIRIPacketReport, $.BER),
    ...
    return _cached_encoder_for_XIRIEvent(value, elGetter);
}
