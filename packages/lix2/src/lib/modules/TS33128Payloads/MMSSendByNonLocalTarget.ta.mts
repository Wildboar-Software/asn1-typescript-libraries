...
/**
 * @summary MMSSendByNonLocalTarget
 * @description
 * 
 * ### ASN.1 Definition:
 * 
...
class MMSSendByNonLocalTarget {
    ...
    /**
     * @summary Restructures an object into a MMSSendByNonLocalTarget
     * @description
     * 
     * This takes an `object` and converts it to a `MMSSendByNonLocalTarget`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `MMSSendByNonLocalTarget`.
     * @returns {MMSSendByNonLocalTarget}
     */
    public static _from_object (_o: { [_K in keyof (MMSSendByNonLocalTarget)]: (MMSSendByNonLocalTarget)[_K] }): MMSSendByNonLocalTarget {
        return new MMSSendByNonLocalTarget(_o.version, _o.transactionID, _o.messageID, _o.terminatingMMSParty, _o.originatingMMSParty, _o.direction, _o.contentType, _o.messageClass, _o.dateTime, _o.expiry, _o.deliveryReport, _o.priority, _o.senderVisibility, _o.readReport, _o.subject, _o.forwardCount, _o.previouslySentBy, _o.prevSentByDateTime, _o.applicID, _o.replyApplicID, _o.auxApplicInfo, _o.contentClass, _o.dRMContent, _o.adaptationAllowed);
    }
...
/**
 * @summary The Leading Root Component Types of MMSSendByNonLocalTarget
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_MMSSendByNonLocalTarget: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of MMSSendByNonLocalTarget
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_MMSSendByNonLocalTarget: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of MMSSendByNonLocalTarget
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_MMSSendByNonLocalTarget: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_MMSSendByNonLocalTarget: $.ASN1Decoder<MMSSendByNonLocalTarget> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) MMSSendByNonLocalTarget
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_MMSSendByNonLocalTarget (el: _Element): MMSSendByNonLocalTarget {
    if (!_cached_decoder_for_MMSSendByNonLocalTarget) { _cached_decoder_for_MMSSendByNonLocalTarget = function (el: _Element): MMSSendByNonLocalTarget {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_MMSSendByNonLocalTarget,
        _extension_additions_list_spec_for_MMSSendByNonLocalTarget,
        _root_component_type_list_2_spec_for_MMSSendByNonLocalTarget,
        undefined,
    );
    return new MMSSendByNonLocalTarget(
        version,
    ...
    return _cached_decoder_for_MMSSendByNonLocalTarget(el);
}

let _cached_encoder_for_MMSSendByNonLocalTarget: $.ASN1Encoder<MMSSendByNonLocalTarget> | null = null;

/**
 * @summary Encodes a(n) MMSSendByNonLocalTarget into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The MMSSendByNonLocalTarget, encoded as an ASN.1 Element.
 */
export
function _encode_MMSSendByNonLocalTarget (value: MMSSendByNonLocalTarget, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MMSSendByNonLocalTarget) { _cached_encoder_for_MMSSendByNonLocalTarget = function (value: MMSSendByNonLocalTarget, elGetter: $.ASN1Encoder<MMSSendByNonLocalTarget>): _Element {
    ...
    return _cached_encoder_for_MMSSendByNonLocalTarget(value, elGetter);
}
