# Machine-Readable Biometric Testing and Reporting (MRBTR) in TypeScript

ASN.1 data structures based on the ASN.1 definitions in
[ISO/IEC 29120-1](https://www.iso.org/standard/79766.html), which defines
machine-readable biometric testing and reporting test reports.
...
This module is ESM-only. Import from `@wildboar/mrbtr`. Per-module
...
(Cursor Grok 4.6) on 18 September 2026.
