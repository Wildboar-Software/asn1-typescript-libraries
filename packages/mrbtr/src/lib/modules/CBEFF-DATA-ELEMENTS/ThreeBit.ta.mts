 ...
 */
export
function _decode_ThreeBit (el: _Element): ThreeBit {
    if (!_cached_decoder_for_ThreeBit) { _cached_decoder_for_ThreeBit = $._decodeInteger; }
 ...
 */
export
function _encode_ThreeBit (value: ThreeBit, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ThreeBit) { _cached_encoder_for_ThreeBit = $._encodeInteger; }
