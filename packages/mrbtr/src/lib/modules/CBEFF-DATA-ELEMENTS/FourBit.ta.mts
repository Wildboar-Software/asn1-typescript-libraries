 ...
 */
export
function _decode_FourBit (el: _Element): FourBit {
    if (!_cached_decoder_for_FourBit) { _cached_decoder_for_FourBit = $._decodeInteger; }
 ...
 */
export
function _encode_FourBit (value: FourBit, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FourBit) { _cached_encoder_for_FourBit = $._encodeInteger; }
