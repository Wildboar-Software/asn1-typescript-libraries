 ...
 */
export
type ChallengeResponse = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_ChallengeResponse (el: _Element): ChallengeResponse {
    if (!_cached_decoder_for_ChallengeResponse) { _cached_decoder_for_ChallengeResponse = $._decodeOctetString; }
 ...
 */
export
function _encode_ChallengeResponse (value: ChallengeResponse, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ChallengeResponse) { _cached_encoder_for_ChallengeResponse = $._encodeOctetString; }
