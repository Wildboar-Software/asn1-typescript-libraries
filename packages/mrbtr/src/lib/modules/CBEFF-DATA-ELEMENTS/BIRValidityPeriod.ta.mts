...
import { Date_Time, _decode_Date_Time, _encode_Date_Time } from "../CBEFF-DATA-ELEMENTS/Date-Time.ta.mjs";
// export { Date_Time, _decode_Date_Time, _encode_Date_Time } from "../CBEFF-DATA-ELEMENTS/Date-Time.ta.mjs";
...
class BIRValidityPeriod {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BIRValidityPeriod)]: (BIRValidityPeriod)[_K] }): BIRValidityPeriod {
 ...
 */
export
const _root_component_type_list_1_spec_for_BIRValidityPeriod: $.ComponentSpec[] = [
    new $.ComponentSpec("not-valid-before", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("not-valid-after", true, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BIRValidityPeriod: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BIRValidityPeriod: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BIRValidityPeriod (el: _Element): BIRValidityPeriod {
    if (!_cached_decoder_for_BIRValidityPeriod) { _cached_decoder_for_BIRValidityPeriod = function (el: _Element): BIRValidityPeriod {
    let not_valid_before: OPTIONAL<Date_Time>;
    let not_valid_after: OPTIONAL<Date_Time>;
    const callbacks: $.DecodingMap = {
        "not-valid-before": (_el: _Element): void => { not_valid_before = _decode_Date_Time(_el); },
        "not-valid-after": (_el: _Element): void => { not_valid_after = _decode_Date_Time(_el); }
    };
 ...
 */
export
function _encode_BIRValidityPeriod (value: BIRValidityPeriod, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BIRValidityPeriod) { _cached_encoder_for_BIRValidityPeriod = function (value: BIRValidityPeriod, elGetter: $.ASN1Encoder<BIRValidityPeriod>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.not_valid_before === undefined) ? undefined : _encode_Date_Time(value.not_valid_before, $.BER)),
            /* IF_ABSENT  */ ((value.not_valid_after === undefined) ? undefined : _encode_Date_Time(value.not_valid_after, $.BER))
        ],
