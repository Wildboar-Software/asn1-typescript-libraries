...
class SBFormat {
     ...
     * @returns {SBFormat}
     */
    public static _from_object (_o: { [_K in keyof (SBFormat)]: (SBFormat)[_K] }): SBFormat {
 ...
 */
export
const _root_component_type_list_1_spec_for_SBFormat: $.ComponentSpec[] = [
    new $.ComponentSpec("sb-owner", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("sb-type", true, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_SBFormat: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_SBFormat: $.ComponentSpec[] = [
 ...
 */
export
function _decode_SBFormat (el: _Element): SBFormat {
    if (!_cached_decoder_for_SBFormat) { _cached_decoder_for_SBFormat = function (el: _Element): SBFormat {
    let sb_owner: OPTIONAL<INTEGER>;
    let sb_type: OPTIONAL<INTEGER>;
    const callbacks: $.DecodingMap = {
        "sb-owner": (_el: _Element): void => { sb_owner = $._decodeInteger(_el); },
        "sb-type": (_el: _Element): void => { sb_type = $._decodeInteger(_el); }
    };
 ...
 */
export
function _encode_SBFormat (value: SBFormat, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SBFormat) { _cached_encoder_for_SBFormat = function (value: SBFormat, elGetter: $.ASN1Encoder<SBFormat>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.sb_owner === undefined) ? undefined : $._encodeInteger(value.sb_owner, $.BER)),
            /* IF_ABSENT  */ ((value.sb_type === undefined) ? undefined : $._encodeInteger(value.sb_type, $.BER))
        ],
