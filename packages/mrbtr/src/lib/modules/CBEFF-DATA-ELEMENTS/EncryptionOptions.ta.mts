 ...
 */
export
type EncryptionOptions = BOOLEAN; // BooleanType
 ...
 */
export
function _decode_EncryptionOptions (el: _Element): EncryptionOptions {
    if (!_cached_decoder_for_EncryptionOptions) { _cached_decoder_for_EncryptionOptions = $._decodeBoolean; }
 ...
 */
export
function _encode_EncryptionOptions (value: EncryptionOptions, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EncryptionOptions) { _cached_encoder_for_EncryptionOptions = $._encodeBoolean; }
