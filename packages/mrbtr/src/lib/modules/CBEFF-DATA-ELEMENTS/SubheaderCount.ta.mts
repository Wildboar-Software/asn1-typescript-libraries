 ...
 */
export
function _decode_SubheaderCount (el: _Element): SubheaderCount {
    if (!_cached_decoder_for_SubheaderCount) { _cached_decoder_for_SubheaderCount = $._decodeInteger; }
 ...
 */
export
function _encode_SubheaderCount (value: SubheaderCount, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SubheaderCount) { _cached_encoder_for_SubheaderCount = $._encodeInteger; }
