 ...
 */
export
function _decode_OneBit (el: _Element): OneBit {
    if (!_cached_decoder_for_OneBit) { _cached_decoder_for_OneBit = $._decodeInteger; }
 ...
 */
export
function _encode_OneBit (value: OneBit, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_OneBit) { _cached_encoder_for_OneBit = $._encodeInteger; }
