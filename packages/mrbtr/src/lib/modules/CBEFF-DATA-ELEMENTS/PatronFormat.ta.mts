...
class PatronFormat {
     ...
     */
    public static _from_object (_o: { [_K in keyof (PatronFormat)]: (PatronFormat)[_K] }): PatronFormat {
 ...
 */
export
const _root_component_type_list_1_spec_for_PatronFormat: $.ComponentSpec[] = [
    new $.ComponentSpec("patron-format-owner", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("patron-format-type", true, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_PatronFormat: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PatronFormat: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PatronFormat (el: _Element): PatronFormat {
    if (!_cached_decoder_for_PatronFormat) { _cached_decoder_for_PatronFormat = function (el: _Element): PatronFormat {
    let patron_format_owner: OPTIONAL<INTEGER>;
    let patron_format_type: OPTIONAL<INTEGER>;
    const callbacks: $.DecodingMap = {
        "patron-format-owner": (_el: _Element): void => { patron_format_owner = $._decodeInteger(_el); },
        "patron-format-type": (_el: _Element): void => { patron_format_type = $._decodeInteger(_el); }
    };
 ...
 */
export
function _encode_PatronFormat (value: PatronFormat, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PatronFormat) { _cached_encoder_for_PatronFormat = function (value: PatronFormat, elGetter: $.ASN1Encoder<PatronFormat>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.patron_format_owner === undefined) ? undefined : $._encodeInteger(value.patron_format_owner, $.BER)),
            /* IF_ABSENT  */ ((value.patron_format_type === undefined) ? undefined : $._encodeInteger(value.patron_format_type, $.BER))
        ],
