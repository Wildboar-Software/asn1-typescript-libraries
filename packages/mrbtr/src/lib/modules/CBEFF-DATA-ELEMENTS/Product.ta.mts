...
class Product {
     ...
     * @returns {Product}
     */
    public static _from_object (_o: { [_K in keyof (Product)]: (Product)[_K] }): Product {
 ...
 */
export
const _root_component_type_list_1_spec_for_Product: $.ComponentSpec[] = [
    new $.ComponentSpec("product-owner", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("product-type", true, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_Product: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_Product: $.ComponentSpec[] = [
 ...
 */
export
function _decode_Product (el: _Element): Product {
    if (!_cached_decoder_for_Product) { _cached_decoder_for_Product = function (el: _Element): Product {
    let product_owner: OPTIONAL<INTEGER>;
    let product_type: OPTIONAL<INTEGER>;
    const callbacks: $.DecodingMap = {
        "product-owner": (_el: _Element): void => { product_owner = $._decodeInteger(_el); },
        "product-type": (_el: _Element): void => { product_type = $._decodeInteger(_el); }
    };
 ...
 */
export
function _encode_Product (value: Product, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Product) { _cached_encoder_for_Product = function (value: Product, elGetter: $.ASN1Encoder<Product>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.product_owner === undefined) ? undefined : $._encodeInteger(value.product_owner, $.BER)),
            /* IF_ABSENT  */ ((value.product_type === undefined) ? undefined : $._encodeInteger(value.product_type, $.BER))
        ],
