 ...
 */
export
type CBEFFVersion_cbeff_major = INTEGER;
 ...
 */
export
const CBEFFVersion_cbeff_major_version2: CBEFFVersion_cbeff_major = 2; /* LONG_NAMED_INTEGER_VALUE */
 ...
 */
export
const version2: CBEFFVersion_cbeff_major = CBEFFVersion_cbeff_major_version2; /* SHORT_NAMED_INTEGER_VALUE */
 ...
 */
export
function _decode_CBEFFVersion_cbeff_major (el: _Element): CBEFFVersion_cbeff_major {
    if (!_cached_decoder_for_CBEFFVersion_cbeff_major) { _cached_decoder_for_CBEFFVersion_cbeff_major = $._decodeInteger; }
 ...
 */
export
function _encode_CBEFFVersion_cbeff_major (value: CBEFFVersion_cbeff_major, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CBEFFVersion_cbeff_major) { _cached_encoder_for_CBEFFVersion_cbeff_major = $._encodeInteger; }
