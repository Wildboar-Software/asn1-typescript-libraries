 ...
 */
export
function _decode_OneByte (el: _Element): OneByte {
    if (!_cached_decoder_for_OneByte) { _cached_decoder_for_OneByte = $._decodeInteger; }
 ...
 */
export
function _encode_OneByte (value: OneByte, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_OneByte) { _cached_encoder_for_OneByte = $._encodeInteger; }
