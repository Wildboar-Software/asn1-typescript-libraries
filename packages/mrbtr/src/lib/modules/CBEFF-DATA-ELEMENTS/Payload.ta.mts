 ...
 */
export
type Payload = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_Payload (el: _Element): Payload {
    if (!_cached_decoder_for_Payload) { _cached_decoder_for_Payload = $._decodeOctetString; }
 ...
 */
export
function _encode_Payload (value: Payload, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Payload) { _cached_encoder_for_Payload = $._encodeOctetString; }
