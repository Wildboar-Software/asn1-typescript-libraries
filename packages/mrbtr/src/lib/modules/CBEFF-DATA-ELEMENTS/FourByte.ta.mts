 ...
 */
export
function _decode_FourByte (el: _Element): FourByte {
    if (!_cached_decoder_for_FourByte) { _cached_decoder_for_FourByte = $._decodeInteger; }
 ...
 */
export
function _encode_FourByte (value: FourByte, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FourByte) { _cached_encoder_for_FourByte = $._encodeInteger; }
