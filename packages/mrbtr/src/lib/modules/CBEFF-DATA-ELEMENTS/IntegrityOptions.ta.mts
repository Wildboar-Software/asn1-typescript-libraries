 ...
 */
export
type IntegrityOptions = BOOLEAN; // BooleanType
 ...
 */
export
function _decode_IntegrityOptions (el: _Element): IntegrityOptions {
    if (!_cached_decoder_for_IntegrityOptions) { _cached_decoder_for_IntegrityOptions = $._decodeBoolean; }
 ...
 */
export
function _encode_IntegrityOptions (value: IntegrityOptions, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_IntegrityOptions) { _cached_encoder_for_IntegrityOptions = $._encodeBoolean; }
