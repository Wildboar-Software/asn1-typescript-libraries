 ...
 */
export
function _decode_TwoByte (el: _Element): TwoByte {
    if (!_cached_decoder_for_TwoByte) { _cached_decoder_for_TwoByte = $._decodeInteger; }
 ...
 */
export
function _encode_TwoByte (value: TwoByte, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TwoByte) { _cached_encoder_for_TwoByte = $._encodeInteger; }
