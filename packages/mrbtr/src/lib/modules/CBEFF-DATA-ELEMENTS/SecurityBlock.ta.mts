 ...
 */
export
type SecurityBlock = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_SecurityBlock (el: _Element): SecurityBlock {
    if (!_cached_decoder_for_SecurityBlock) { _cached_decoder_for_SecurityBlock = $._decodeOctetString; }
 ...
 */
export
function _encode_SecurityBlock (value: SecurityBlock, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SecurityBlock) { _cached_encoder_for_SecurityBlock = $._encodeOctetString; }
