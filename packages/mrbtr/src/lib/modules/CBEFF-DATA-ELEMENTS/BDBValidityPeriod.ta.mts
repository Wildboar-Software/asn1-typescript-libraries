...
class BDBValidityPeriod {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BDBValidityPeriod)]: (BDBValidityPeriod)[_K] }): BDBValidityPeriod {
 ...
 */
export
const _root_component_type_list_1_spec_for_BDBValidityPeriod: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_BDBValidityPeriod: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BDBValidityPeriod: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BDBValidityPeriod (el: _Element): BDBValidityPeriod {
    if (!_cached_decoder_for_BDBValidityPeriod) { _cached_decoder_for_BDBValidityPeriod = function (el: _Element): BDBValidityPeriod {
 ...
 */
export
function _encode_BDBValidityPeriod (value: BDBValidityPeriod, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BDBValidityPeriod) { _cached_encoder_for_BDBValidityPeriod = function (value: BDBValidityPeriod, elGetter: $.ASN1Encoder<BDBValidityPeriod>): _Element {
