 ...
 */
export
function _decode_Date_Time (el: _Element): Date_Time {
    if (!_cached_decoder_for_Date_Time) { _cached_decoder_for_Date_Time = $._decodeTime; }
 ...
 */
export
function _encode_Date_Time (value: Date_Time, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Date_Time) { _cached_encoder_for_Date_Time = $._encodeTime; }
