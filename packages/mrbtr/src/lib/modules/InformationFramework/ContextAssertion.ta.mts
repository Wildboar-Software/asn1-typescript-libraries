...
class ContextAssertion {
     ...
     */
    public static _from_object (_o: { [_K in keyof (ContextAssertion)]: (ContextAssertion)[_K] }): ContextAssertion {
        return new ContextAssertion(_o.contextType, _o.contextValues, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ContextAssertion: $.ComponentSpec[] = [
    new $.ComponentSpec("contextType", false, $.hasTag(_TagClass.universal, 6)),
    new $.ComponentSpec("contextValues", false, $.hasTag(_TagClass.universal, 17))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_ContextAssertion: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ContextAssertion: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ContextAssertion (el: _Element): ContextAssertion {
    if (!_cached_decoder_for_ContextAssertion) { _cached_decoder_for_ContextAssertion = function (el: _Element): ContextAssertion {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("ContextAssertion contained only " + sequence.length.toString() + " elements.");
    }
    ...
    contextValues = $._decodeSetOf<_Element>(() => $._decodeAny)(sequence[1]);
 ...
 */
export
function _encode_ContextAssertion (value: ContextAssertion, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ContextAssertion) { _cached_encoder_for_ContextAssertion = function (value: ContextAssertion, elGetter: $.ASN1Encoder<ContextAssertion>): _Element {
