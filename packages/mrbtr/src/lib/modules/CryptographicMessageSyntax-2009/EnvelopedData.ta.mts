...
import { EncryptedContentInfo, _decode_EncryptedContentInfo, _encode_EncryptedContentInfo } from "../CryptographicMessageSyntax-2009/EncryptedContentInfo.ta.mjs";
// export { EncryptedContentInfo, _decode_EncryptedContentInfo, _encode_EncryptedContentInfo } from "../CryptographicMessageSyntax-2009/EncryptedContentInfo.ta.mjs";
...
class EnvelopedData {
    ...
    public static _from_object (_o: { [_K in keyof (EnvelopedData)]: (EnvelopedData)[_K] }): EnvelopedData {
        return new EnvelopedData(_o.version, _o.originatorInfo, _o.recipientInfos, _o.encryptedContentInfo, _o._unrecognizedExtensionsList);
    }
