 ...
 */
export
type KeyDerivationAlgorithmIdentifier = AlgorithmIdentifier; // DefinedType
 ...
 */
export
function _decode_KeyDerivationAlgorithmIdentifier (el: _Element): KeyDerivationAlgorithmIdentifier {
 ...
 */
export
function _encode_KeyDerivationAlgorithmIdentifier (value: KeyDerivationAlgorithmIdentifier, elGetter: $.ASN1Encoder<any>): _Element {
