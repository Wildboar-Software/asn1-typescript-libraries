 ...
 */
export
type SignedAttributes = Attributes; // DefinedType
 ...
 */
export
function _decode_SignedAttributes (el: _Element): SignedAttributes {
 ...
 */
export
function _encode_SignedAttributes (value: SignedAttributes, elGetter: $.ASN1Encoder<any>): _Element {
