...
import { ContentSet } from "../CryptographicMessageSyntax-2009/ContentSet.osa.mjs";
// export { ContentSet } from "../CryptographicMessageSyntax-2009/ContentSet.osa.mjs";
...
class EncapsulatedContentInfo {
     ...
     */
    public static _from_object (_o: { [_K in keyof (EncapsulatedContentInfo)]: (EncapsulatedContentInfo)[_K] }): EncapsulatedContentInfo {
 ...
 */
export
const _root_component_type_list_1_spec_for_EncapsulatedContentInfo: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_EncapsulatedContentInfo: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_EncapsulatedContentInfo: $.ComponentSpec[] = [
 ...
 */
export
function _decode_EncapsulatedContentInfo (el: _Element): EncapsulatedContentInfo {
    if (!_cached_decoder_for_EncapsulatedContentInfo) { _cached_decoder_for_EncapsulatedContentInfo = function (el: _Element): EncapsulatedContentInfo {
    let eContentType!: OBJECT_IDENTIFIER;
    let eContent: OPTIONAL<OCTET_STRING>;
    const callbacks: $.DecodingMap = {
        "eContentType": (_el: _Element): void => { eContentType = $._decodeObjectIdentifier(_el); },
        "eContent": (_el: _Element): void => { eContent = $._decode_explicit<OCTET_STRING>(() => $._decodeOctetString)(_el); }
    };
 ...
 */
export
function _encode_EncapsulatedContentInfo (value: EncapsulatedContentInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EncapsulatedContentInfo) { _cached_encoder_for_EncapsulatedContentInfo = function (value: EncapsulatedContentInfo, elGetter: $.ASN1Encoder<EncapsulatedContentInfo>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeObjectIdentifier(value.eContentType, $.BER),
            /* IF_ABSENT  */ ((value.eContent === undefined) ? undefined : $._encode_explicit(_TagClass.context, 0, () => $._encodeOctetString, $.BER)(value.eContent, $.BER))
        ],
