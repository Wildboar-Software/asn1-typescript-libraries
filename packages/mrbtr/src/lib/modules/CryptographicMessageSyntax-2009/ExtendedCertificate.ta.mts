...
import { ExtendedCertificateInfo, _decode_ExtendedCertificateInfo, _encode_ExtendedCertificateInfo } from "../CryptographicMessageSyntax-2009/ExtendedCertificateInfo.ta.mjs";
// export { ExtendedCertificateInfo, _decode_ExtendedCertificateInfo, _encode_ExtendedCertificateInfo } from "../CryptographicMessageSyntax-2009/ExtendedCertificateInfo.ta.mjs";
...
import { Signature, _decode_Signature, _encode_Signature } from "../CryptographicMessageSyntax-2009/Signature.ta.mjs";
// export { Signature, _decode_Signature, _encode_Signature } from "../CryptographicMessageSyntax-2009/Signature.ta.mjs";
...
class ExtendedCertificate {
     ...
     */
    public static _from_object (_o: { [_K in keyof (ExtendedCertificate)]: (ExtendedCertificate)[_K] }): ExtendedCertificate {
 ...
 */
export
const _root_component_type_list_1_spec_for_ExtendedCertificate: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_ExtendedCertificate: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ExtendedCertificate: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ExtendedCertificate (el: _Element): ExtendedCertificate {
    if (!_cached_decoder_for_ExtendedCertificate) { _cached_decoder_for_ExtendedCertificate = function (el: _Element): ExtendedCertificate {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 3) {
        throw new _ConstructionError("ExtendedCertificate contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_ExtendedCertificate (value: ExtendedCertificate, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ExtendedCertificate) { _cached_encoder_for_ExtendedCertificate = function (value: ExtendedCertificate, elGetter: $.ASN1Encoder<ExtendedCertificate>): _Element {
