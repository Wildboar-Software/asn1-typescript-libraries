...
import { SignerIdentifier, _decode_SignerIdentifier, _encode_SignerIdentifier } from "../CryptographicMessageSyntax-2009/SignerIdentifier.ta.mjs";
// export { SignerIdentifier, _decode_SignerIdentifier, _encode_SignerIdentifier } from "../CryptographicMessageSyntax-2009/SignerIdentifier.ta.mjs";
...
import { SignedAttributes, _decode_SignedAttributes, _encode_SignedAttributes } from "../CryptographicMessageSyntax-2009/SignedAttributes.ta.mjs";
// export { SignedAttributes, _decode_SignedAttributes, _encode_SignedAttributes } from "../CryptographicMessageSyntax-2009/SignedAttributes.ta.mjs";
import { SignatureAlgorithmIdentifier, _decode_SignatureAlgorithmIdentifier, _encode_SignatureAlgorithmIdentifier } from "../CryptographicMessageSyntax-2009/SignatureAlgorithmIdentifier.ta.mjs";
// export { SignatureAlgorithmIdentifier, _decode_SignatureAlgorithmIdentifier, _encode_SignatureAlgorithmIdentifier } from "../CryptographicMessageSyntax-2009/SignatureAlgorithmIdentifier.ta.mjs";
import { SignatureValue, _decode_SignatureValue, _encode_SignatureValue } from "../CryptographicMessageSyntax-2009/SignatureValue.ta.mjs";
// export { SignatureValue, _decode_SignatureValue, _encode_SignatureValue } from "../CryptographicMessageSyntax-2009/SignatureValue.ta.mjs";
import { Attributes, _decode_Attributes, _encode_Attributes } from "../CryptographicMessageSyntax-2009/Attributes.ta.mjs";
// export { Attributes, _decode_Attributes, _encode_Attributes } from "../CryptographicMessageSyntax-2009/Attributes.ta.mjs";
...
function _decode_SignerInfo (el: _Element): SignerInfo {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "unsignedAttrs": (_el: _Element): void => { unsignedAttrs = $._decode_implicit<Attributes>(() => _decode_Attributes)(_el); }
    };
...
function _encode_SignerInfo (value: SignerInfo, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.unsignedAttrs === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => _encode_Attributes, $.BER)(value.unsignedAttrs, $.BER))
        ],
