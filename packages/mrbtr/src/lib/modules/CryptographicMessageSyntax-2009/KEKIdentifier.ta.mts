...
import { OtherKeyAttribute, _decode_OtherKeyAttribute, _encode_OtherKeyAttribute } from "../CryptographicMessageSyntax-2009/OtherKeyAttribute.ta.mjs";
// export { OtherKeyAttribute, _decode_OtherKeyAttribute, _encode_OtherKeyAttribute } from "../CryptographicMessageSyntax-2009/OtherKeyAttribute.ta.mjs";
...
class KEKIdentifier {
     ...
     */
    public static _from_object (_o: { [_K in keyof (KEKIdentifier)]: (KEKIdentifier)[_K] }): KEKIdentifier {
 ...
 */
export
const _root_component_type_list_1_spec_for_KEKIdentifier: $.ComponentSpec[] = [
    new $.ComponentSpec("keyIdentifier", false, $.hasTag(_TagClass.universal, 4)),
 ...
 */
export
const _root_component_type_list_2_spec_for_KEKIdentifier: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_KEKIdentifier: $.ComponentSpec[] = [
 ...
 */
export
function _decode_KEKIdentifier (el: _Element): KEKIdentifier {
    if (!_cached_decoder_for_KEKIdentifier) { _cached_decoder_for_KEKIdentifier = function (el: _Element): KEKIdentifier {
    let keyIdentifier!: OCTET_STRING;
    let date: OPTIONAL<GeneralizedTime>;
    let other: OPTIONAL<OtherKeyAttribute>;
    const callbacks: $.DecodingMap = {
        "keyIdentifier": (_el: _Element): void => { keyIdentifier = $._decodeOctetString(_el); },
 ...
 */
export
function _encode_KEKIdentifier (value: KEKIdentifier, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_KEKIdentifier) { _cached_encoder_for_KEKIdentifier = function (value: KEKIdentifier, elGetter: $.ASN1Encoder<KEKIdentifier>): _Element {
