...
import { ContentEncryptionAlgorithmIdentifier, _decode_ContentEncryptionAlgorithmIdentifier, _encode_ContentEncryptionAlgorithmIdentifier } from "../CryptographicMessageSyntax-2009/ContentEncryptionAlgorithmIdentifier.ta.mjs";
// export { ContentEncryptionAlgorithmIdentifier, _decode_ContentEncryptionAlgorithmIdentifier, _encode_ContentEncryptionAlgorithmIdentifier } from "../CryptographicMessageSyntax-2009/ContentEncryptionAlgorithmIdentifier.ta.mjs";
...
function _decode_EncryptedContentInfo (el: _Element): EncryptedContentInfo {
    ...
    const callbacks: $.DecodingMap = {
        "contentType": (_el: _Element): void => { contentType = $._decodeObjectIdentifier(_el); },
        "contentEncryptionAlgorithm": (_el: _Element): void => { contentEncryptionAlgorithm = _decode_ContentEncryptionAlgorithmIdentifier(_el); },
        "encryptedContent": (_el: _Element): void => { encryptedContent = $._decode_implicit<OCTET_STRING>(() => $._decodeOctetString)(_el); }
    };
...
function _encode_EncryptedContentInfo (value: EncryptedContentInfo, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.encryptedContent === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => $._encodeOctetString, $.BER)(value.encryptedContent, $.BER))
        ],
