...
import { OriginatorInfo, _decode_OriginatorInfo, _encode_OriginatorInfo } from "../CryptographicMessageSyntax-2009/OriginatorInfo.ta.mjs";
// export { OriginatorInfo, _decode_OriginatorInfo, _encode_OriginatorInfo } from "../CryptographicMessageSyntax-2009/OriginatorInfo.ta.mjs";
import { RecipientInfos, _decode_RecipientInfos, _encode_RecipientInfos } from "../CryptographicMessageSyntax-2009/RecipientInfos.ta.mjs";
// export { RecipientInfos, _decode_RecipientInfos, _encode_RecipientInfos } from "../CryptographicMessageSyntax-2009/RecipientInfos.ta.mjs";
import { MessageAuthenticationCodeAlgorithm, _decode_MessageAuthenticationCodeAlgorithm, _encode_MessageAuthenticationCodeAlgorithm } from "../CryptographicMessageSyntax-2009/MessageAuthenticationCodeAlgorithm.ta.mjs";
// export { MessageAuthenticationCodeAlgorithm, _decode_MessageAuthenticationCodeAlgorithm, _encode_MessageAuthenticationCodeAlgorithm } from "../CryptographicMessageSyntax-2009/MessageAuthenticationCodeAlgorithm.ta.mjs";
...
import { AuthAttributes, _decode_AuthAttributes, _encode_AuthAttributes } from "../CryptographicMessageSyntax-2009/AuthAttributes.ta.mjs";
// export { AuthAttributes, _decode_AuthAttributes, _encode_AuthAttributes } from "../CryptographicMessageSyntax-2009/AuthAttributes.ta.mjs";
import { MessageAuthenticationCode, _decode_MessageAuthenticationCode, _encode_MessageAuthenticationCode } from "../CryptographicMessageSyntax-2009/MessageAuthenticationCode.ta.mjs";
// export { MessageAuthenticationCode, _decode_MessageAuthenticationCode, _encode_MessageAuthenticationCode } from "../CryptographicMessageSyntax-2009/MessageAuthenticationCode.ta.mjs";
import { UnauthAttributes, _decode_UnauthAttributes, _encode_UnauthAttributes } from "../CryptographicMessageSyntax-2009/UnauthAttributes.ta.mjs";
// export { UnauthAttributes, _decode_UnauthAttributes, _encode_UnauthAttributes } from "../CryptographicMessageSyntax-2009/UnauthAttributes.ta.mjs";
...
const _root_component_type_list_1_spec_for_AuthenticatedData: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("authAttrs", true, $.hasTag(_TagClass.context, 2)),
    new $.ComponentSpec("mac", false, $.hasTag(_TagClass.universal, 4)),
    new $.ComponentSpec("unauthAttrs", true, $.hasTag(_TagClass.context, 3))
];
