...
import { ContentTypeBiometricTestReport } from "../MachineReadableBiometricTestingAndReportingTestReport/ContentTypeBiometricTestReport.osa.mjs";
...
function _encode_BiometricTestReport (value: BiometricTestReport, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BiometricTestReport) { _cached_encoder_for_BiometricTestReport = function (value: BiometricTestReport, elGetter: $.ASN1Encoder<BiometricTestReport>): _Element {
