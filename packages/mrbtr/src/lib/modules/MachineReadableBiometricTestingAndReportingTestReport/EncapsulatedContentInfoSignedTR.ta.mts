...
function _encode_EncapsulatedContentInfoSignedTR (value: EncapsulatedContentInfoSignedTR, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EncapsulatedContentInfoSignedTR) { _cached_encoder_for_EncapsulatedContentInfoSignedTR = function (value: EncapsulatedContentInfoSignedTR): _Element {
