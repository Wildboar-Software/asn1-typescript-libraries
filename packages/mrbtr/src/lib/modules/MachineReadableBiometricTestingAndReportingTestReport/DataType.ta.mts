...
import { Purpose, _enum_for_Purpose, Purpose_reference /* IMPORTED_LONG_ENUMERATION_ITEM */, reference /* IMPORTED_SHORT_ENUMERATION_ITEM */, Purpose_sample /* IMPORTED_LONG_ENUMERATION_ITEM */, sample /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_Purpose, _encode_Purpose } from "../MachineReadableBiometricTestingAndReportingTestReport/Purpose.ta.mjs";
...
const _root_component_type_list_1_spec_for_DataType: $.ComponentSpec[] = [
    new $.ComponentSpec("processedLevel", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("purpose", true, $.hasTag(_TagClass.context, 1))
];
