...
function _encode_SignedTestReport (value: SignedTestReport, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SignedTestReport) { _cached_encoder_for_SignedTestReport = function (value: SignedTestReport, elGetter: $.ASN1Encoder<SignedTestReport>): _Element {
