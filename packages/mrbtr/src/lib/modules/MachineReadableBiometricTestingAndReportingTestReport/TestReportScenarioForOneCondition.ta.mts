...
function _encode_TestReportScenarioForOneCondition (value: TestReportScenarioForOneCondition, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TestReportScenarioForOneCondition) { _cached_encoder_for_TestReportScenarioForOneCondition = function (value: TestReportScenarioForOneCondition): _Element {
