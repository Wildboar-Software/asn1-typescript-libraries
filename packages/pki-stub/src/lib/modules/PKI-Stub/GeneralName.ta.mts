...
import { Name, _decode_Name, _encode_Name } from "./Name.ta.mjs";
import {
    ORAddress,
    _decode_ORAddress,
    _encode_ORAddress,
 ...
 */
export function _encode_GeneralName(value: GeneralName, elGetter: $.ASN1Encoder<GeneralName>): GeneralName {
