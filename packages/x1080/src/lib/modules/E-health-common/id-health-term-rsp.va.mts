 ...
 * @description
 *
 * `{id-x1080-1-cms-content health-term-rsp(5)}`. Content type for
 * completing session termination. ITU-T Rec. X.1080.1 (05/2018)
 * [§7.3](https://www.itu.int/rec/T-REC-X.1080.1-201805-I), §11.2.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
