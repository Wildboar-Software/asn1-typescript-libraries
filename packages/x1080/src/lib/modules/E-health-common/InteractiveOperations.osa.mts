...
/* START_OF_SYMBOL_DEFINITION InteractiveOperations */
/**
 ...
 *
 */
export const InteractiveOperations: INTERACTIVE_OPERATION[] = [];
/* END_OF_SYMBOL_DEFINITION InteractiveOperations */
