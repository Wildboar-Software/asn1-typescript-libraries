 ...
 * `Identified-Simple-Message`, optionally inside a CMS
 * `ContentInfo` for encryption and/or integrity. ITU-T Rec.
 * X.1080.1 (10/2011) module E-health-send-and-ack; (05/2018)
...
export class Command {
    constructor(
         ...
         * @description
         *
         * Encoding of an `Identified-Simple-Message` under the
         * current encoding rules, in a CMS `ContentInfo` for
         * encryption and/or integrity if needed. ITU-T Rec.
         * X.1080.1 (10/2011) module E-health-send-and-ack.
         *
         * @public
         * @readonly
