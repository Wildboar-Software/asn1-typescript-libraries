...
import { MedicalRecordSchemes } from '../E-health-identification/MedicalRecordSchemes.osa.js';
export { MedicalRecordSchemes } from '../E-health-identification/MedicalRecordSchemes.osa.js';
import {
    SchemeName,
    _decode_SchemeName,
    _encode_SchemeName,
