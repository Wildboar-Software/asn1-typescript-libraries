...
} from '../Pbact-access/RenameRequest.ta';
export {
    RenameRequest,
    _decode_RenameRequest,
    _encode_RenameRequest,
} from '../Pbact-access/RenameRequest.ta';
import { id_renameRequest } from '../Pbact-access/id-renameRequest.va';
export { id_renameRequest } from '../Pbact-access/id-renameRequest.va';
