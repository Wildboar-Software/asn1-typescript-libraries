...
import {
    ...
    _decode_ReadResult,
    _encode_ReadResult,
} from '../Pbact-access/ReadResult.ta.js';
export {
    ReadResult,
    _decode_ReadResult,
    _encode_ReadResult,
} from '../Pbact-access/ReadResult.ta.js';
import { id_readResult } from '../Pbact-access/id-readResult.va.js';
export { id_readResult } from '../Pbact-access/id-readResult.va.js';
