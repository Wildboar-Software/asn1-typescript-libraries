...
} from '../Pbact-access/ModifyRequest.ta';
export {
    ModifyRequest,
    _decode_ModifyRequest,
    _encode_ModifyRequest,
} from '../Pbact-access/ModifyRequest.ta';
import { id_modifyRequest } from '../Pbact-access/id-modifyRequest.va';
export { id_modifyRequest } from '../Pbact-access/id-modifyRequest.va';
