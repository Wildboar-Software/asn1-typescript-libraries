 ...
 * @description
 *
 * Psychology quantities `{id-quantities psychology(5)}`. One of the
 * five X.1080.x fields. Named-quantity tables are in X.1082 clauses
 * 6–11, not compiled here. X.1080.1 Annex A.
