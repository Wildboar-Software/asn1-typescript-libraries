...
function _decode_TransactionId (el: _Element): TransactionId {
    if (!_cached_decoder_for_TransactionId) { _cached_decoder_for_TransactionId = $._decodeInteger; }
...
function _encode_TransactionId (value: TransactionId, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TransactionId) { _cached_encoder_for_TransactionId = $._encodeInteger; }
