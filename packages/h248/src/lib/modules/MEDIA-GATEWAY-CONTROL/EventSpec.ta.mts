...
class EventSpec {
    ...
    /**
     * @summary Restructures an object into a EventSpec
     * @description
     * 
     * This takes an `object` and converts it to a `EventSpec`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `EventSpec`.
     * @returns {EventSpec}
     */
    public static _from_object (_o: { [_K in keyof (EventSpec)]: (EventSpec)[_K] }): EventSpec {
        return new EventSpec(_o.eventName, _o.streamID, _o.eventParList, _o._unrecognizedExtensionsList);
    }
...
/**
 * @summary The Leading Root Component Types of EventSpec
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_EventSpec: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of EventSpec
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_EventSpec: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of EventSpec
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_EventSpec: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_EventSpec: $.ASN1Decoder<EventSpec> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) EventSpec
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_EventSpec (el: _Element): EventSpec {
    if (!_cached_decoder_for_EventSpec) { _cached_decoder_for_EventSpec = function (el: _Element): EventSpec {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_EventSpec,
        _extension_additions_list_spec_for_EventSpec,
        _root_component_type_list_2_spec_for_EventSpec,
    ...
    return _cached_decoder_for_EventSpec(el);
}

let _cached_encoder_for_EventSpec: $.ASN1Encoder<EventSpec> | null = null;

/**
 * @summary Encodes a(n) EventSpec into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The EventSpec, encoded as an ASN.1 Element.
 */
export
function _encode_EventSpec (value: EventSpec, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpec) { _cached_encoder_for_EventSpec = function (value: EventSpec, elGetter: $.ASN1Encoder<EventSpec>): _Element {
    ...
    return _cached_encoder_for_EventSpec(value, elGetter);
}
