 ...
 */
export
type TRMustBePresentAttributeMissing = AttributeIDList; // DefinedType
 ...
 */
export
function _decode_TRMustBePresentAttributeMissing (el: _Element): TRMustBePresentAttributeMissing {
    if (!_cached_decoder_for_TRMustBePresentAttributeMissing) { _cached_decoder_for_TRMustBePresentAttributeMissing = _decode_AttributeIDList; }
 ...
 */
export
function _encode_TRMustBePresentAttributeMissing (value: TRMustBePresentAttributeMissing, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TRMustBePresentAttributeMissing) { _cached_encoder_for_TRMustBePresentAttributeMissing = _encode_AttributeIDList; }
