 ...
 */
export
function _decode_ManagerSearchKey (el: _Element): ManagerSearchKey {
    if (!_cached_decoder_for_ManagerSearchKey) { _cached_decoder_for_ManagerSearchKey = $._decode_extensible_choice<ManagerSearchKey>({
 ...
 */
export
function _encode_ManagerSearchKey (value: ManagerSearchKey, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ManagerSearchKey) { _cached_encoder_for_ManagerSearchKey = $._encode_choice<ManagerSearchKey>({
