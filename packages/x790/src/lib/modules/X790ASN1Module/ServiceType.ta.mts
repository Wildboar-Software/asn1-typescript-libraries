...
function _decode_ServiceType (el: _Element): ServiceType {
    if (!_cached_decoder_for_ServiceType) { _cached_decoder_for_ServiceType = $._decode_extensible_choice<ServiceType>({
...
function _encode_ServiceType (value: ServiceType, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ServiceType) { _cached_encoder_for_ServiceType = $._encode_choice<ServiceType>({
    "int": $._encodeInteger,
