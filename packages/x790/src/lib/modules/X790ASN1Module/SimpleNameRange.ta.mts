 ...
 */
export
function _decode_SimpleNameRange (el: _Element): SimpleNameRange {
    if (!_cached_decoder_for_SimpleNameRange) { _cached_decoder_for_SimpleNameRange = $._decode_extensible_choice<SimpleNameRange>({
 ...
 */
export
function _encode_SimpleNameRange (value: SimpleNameRange, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SimpleNameRange) { _cached_encoder_for_SimpleNameRange = $._encode_choice<SimpleNameRange>({
