 ...
 * 
 * ```asn1
 * ManagerSearchKeyList-Item ::= CHOICE {
 ...
 */
export
type ManagerSearchKeyList_Item =
 ...
 */
export
function _decode_ManagerSearchKeyList_Item (el: _Element): ManagerSearchKeyList_Item {
    if (!_cached_decoder_for_ManagerSearchKeyList_Item) { _cached_decoder_for_ManagerSearchKeyList_Item = $._decode_extensible_choice<ManagerSearchKeyList_Item>({
 ...
 */
export
function _encode_ManagerSearchKeyList_Item (value: ManagerSearchKeyList_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ManagerSearchKeyList_Item) { _cached_encoder_for_ManagerSearchKeyList_Item = $._encode_choice<ManagerSearchKeyList_Item>({
