 ...
 */
export
function _decode_ManagerContactObjectPtr (el: _Element): ManagerContactObjectPtr {
    if (!_cached_decoder_for_ManagerContactObjectPtr) { _cached_decoder_for_ManagerContactObjectPtr = $._decode_extensible_choice<ManagerContactObjectPtr>({
 ...
 */
export
function _encode_ManagerContactObjectPtr (value: ManagerContactObjectPtr, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ManagerContactObjectPtr) { _cached_encoder_for_ManagerContactObjectPtr = $._encode_choice<ManagerContactObjectPtr>({
    "null_": $._encodeNull,
