 ...
 */
export
function _decode_FallBackReporting (el: _Element): FallBackReporting {
    if (!_cached_decoder_for_FallBackReporting) { _cached_decoder_for_FallBackReporting = $._decode_extensible_choice<FallBackReporting>({
 ...
 */
export
function _encode_FallBackReporting (value: FallBackReporting, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FallBackReporting) { _cached_encoder_for_FallBackReporting = $._encode_choice<FallBackReporting>({
    "null_": $._encodeNull,
