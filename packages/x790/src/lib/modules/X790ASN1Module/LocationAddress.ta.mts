...
class LocationAddress {
     ...
     */
    public static _from_object (_o: { [_K in keyof (LocationAddress)]: (LocationAddress)[_K] }): LocationAddress {
        return new LocationAddress(_o.name, _o.address, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_LocationAddress: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_LocationAddress: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_LocationAddress: $.ComponentSpec[] = [
 ...
 */
export
function _decode_LocationAddress (el: _Element): LocationAddress {
    if (!_cached_decoder_for_LocationAddress) { _cached_decoder_for_LocationAddress = function (el: _Element): LocationAddress {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("LocationAddress contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_LocationAddress (value: LocationAddress, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_LocationAddress) { _cached_encoder_for_LocationAddress = function (value: LocationAddress, elGetter: $.ASN1Encoder<LocationAddress>): _Element {
