 ...
 */
export
function _decode_ResponsiblePersonPtr (el: _Element): ResponsiblePersonPtr {
    if (!_cached_decoder_for_ResponsiblePersonPtr) { _cached_decoder_for_ResponsiblePersonPtr = $._decode_extensible_choice<ResponsiblePersonPtr>({
 ...
 */
export
function _encode_ResponsiblePersonPtr (value: ResponsiblePersonPtr, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ResponsiblePersonPtr) { _cached_encoder_for_ResponsiblePersonPtr = $._encode_choice<ResponsiblePersonPtr>({
    "null_": $._encodeNull,
