 ...
 * 
 * ```asn1
 * ServiceLocationList-Item ::= SEQUENCE {
 *     name     PremisesName,
 ...
 */
export
class ServiceLocationList_Item {
    constructor (
        /**
         * @summary `name`.
         * @public
     ...
     */
    public static _from_object (_o: { [_K in keyof (ServiceLocationList_Item)]: (ServiceLocationList_Item)[_K] }): ServiceLocationList_Item {
        return new ServiceLocationList_Item(_o.name, _o.address, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ServiceLocationList_Item: $.ComponentSpec[] = [
    new $.ComponentSpec("name", false, $.hasTag(_TagClass.universal, 25)),
    new $.ComponentSpec("address", false, $.hasTag(_TagClass.universal, 16))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_ServiceLocationList_Item: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ServiceLocationList_Item: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ServiceLocationList_Item (el: _Element): ServiceLocationList_Item {
    if (!_cached_decoder_for_ServiceLocationList_Item) { _cached_decoder_for_ServiceLocationList_Item = function (el: _Element): ServiceLocationList_Item {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("ServiceLocationList-Item contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_ServiceLocationList_Item (value: ServiceLocationList_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ServiceLocationList_Item) { _cached_encoder_for_ServiceLocationList_Item = function (value: ServiceLocationList_Item, elGetter: $.ASN1Encoder<ServiceLocationList_Item>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_PremisesName(value.name, $.BER),
            /* REQUIRED   */ _encode_PremisesAddress(value.address, $.BER)
        ],
