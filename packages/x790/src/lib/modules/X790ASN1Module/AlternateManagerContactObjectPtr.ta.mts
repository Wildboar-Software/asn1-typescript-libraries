 ...
 */
export
type AlternateManagerContactObjectPtr =
 ...
 */
export
function _decode_AlternateManagerContactObjectPtr (el: _Element): AlternateManagerContactObjectPtr {
    if (!_cached_decoder_for_AlternateManagerContactObjectPtr) { _cached_decoder_for_AlternateManagerContactObjectPtr = $._decode_extensible_choice<AlternateManagerContactObjectPtr>({
 ...
 */
export
function _encode_AlternateManagerContactObjectPtr (value: AlternateManagerContactObjectPtr, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AlternateManagerContactObjectPtr) { _cached_encoder_for_AlternateManagerContactObjectPtr = $._encode_choice<AlternateManagerContactObjectPtr>({
    "noContact": $._encodeNull,
    "contact": _encode_ObjectInstance,
}, $.BER); }
    return _cached_encoder_for_AlternateManagerContactObjectPtr(value, elGetter);
}
