 ...
 */
export
function _decode_RestoredTime (el: _Element): RestoredTime {
    if (!_cached_decoder_for_RestoredTime) { _cached_decoder_for_RestoredTime = $._decode_extensible_choice<RestoredTime>({
 ...
 */
export
function _encode_RestoredTime (value: RestoredTime, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RestoredTime) { _cached_encoder_for_RestoredTime = $._encode_choice<RestoredTime>({
    "null_": $._encodeNull,
