 ...
 */
export
function _decode_TroubleFound (el: _Element): TroubleFound {
    if (!_cached_decoder_for_TroubleFound) { _cached_decoder_for_TroubleFound = $._decode_extensible_choice<TroubleFound>({
 ...
 */
export
function _encode_TroubleFound (value: TroubleFound, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TroubleFound) { _cached_encoder_for_TroubleFound = $._encode_choice<TroubleFound>({
