 ...
 */
export
function _decode_AgentContactObjectPtr (el: _Element): AgentContactObjectPtr {
    if (!_cached_decoder_for_AgentContactObjectPtr) { _cached_decoder_for_AgentContactObjectPtr = $._decode_extensible_choice<AgentContactObjectPtr>({
 ...
 */
export
function _encode_AgentContactObjectPtr (value: AgentContactObjectPtr, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AgentContactObjectPtr) { _cached_encoder_for_AgentContactObjectPtr = $._encode_choice<AgentContactObjectPtr>({
