 ...
 */
export
function _decode_OutageDuration (el: _Element): OutageDuration {
    if (!_cached_decoder_for_OutageDuration) { _cached_decoder_for_OutageDuration = $._decode_extensible_choice<OutageDuration>({
 ...
 */
export
function _encode_OutageDuration (value: OutageDuration, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_OutageDuration) { _cached_encoder_for_OutageDuration = $._encode_choice<OutageDuration>({
    "null_": $._encodeNull,
