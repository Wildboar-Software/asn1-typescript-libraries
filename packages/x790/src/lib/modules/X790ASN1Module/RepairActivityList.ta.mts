 ...
 */
export
type RepairActivityList = RepairActivityList_Item[]; // SetOfType
 ...
 */
export
function _decode_RepairActivityList (el: _Element): RepairActivityList {
    if (!_cached_decoder_for_RepairActivityList) { _cached_decoder_for_RepairActivityList = $._decodeSetOf<RepairActivityList_Item>(() => _decode_RepairActivityList_Item); }
 ...
 */
export
function _encode_RepairActivityList (value: RepairActivityList, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RepairActivityList) { _cached_encoder_for_RepairActivityList = $._encodeSetOf<RepairActivityList_Item>(() => _encode_RepairActivityList_Item, $.BER); }
