 ...
 */
export
function _decode_ActivityCode (el: _Element): ActivityCode {
    if (!_cached_decoder_for_ActivityCode) { _cached_decoder_for_ActivityCode = $._decode_extensible_choice<ActivityCode>({
 ...
 */
export
function _encode_ActivityCode (value: ActivityCode, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ActivityCode) { _cached_encoder_for_ActivityCode = $._encode_choice<ActivityCode>({
