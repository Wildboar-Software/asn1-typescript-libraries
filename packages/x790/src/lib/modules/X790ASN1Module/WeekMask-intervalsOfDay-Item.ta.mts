 ...
 * 
 * ```asn1
 * WeekMask-intervalsOfDay-Item ::= SEQUENCE {
 ...
 */
export
class WeekMask_intervalsOfDay_Item {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (WeekMask_intervalsOfDay_Item)]: (WeekMask_intervalsOfDay_Item)[_K] }): WeekMask_intervalsOfDay_Item {
        return new WeekMask_intervalsOfDay_Item(_o.intervalStart, _o.intervalEnd);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_WeekMask_intervalsOfDay_Item: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_WeekMask_intervalsOfDay_Item: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_WeekMask_intervalsOfDay_Item: $.ComponentSpec[] = [
 ...
 */
export
function _decode_WeekMask_intervalsOfDay_Item (el: _Element): WeekMask_intervalsOfDay_Item {
    if (!_cached_decoder_for_WeekMask_intervalsOfDay_Item) { _cached_decoder_for_WeekMask_intervalsOfDay_Item = function (el: _Element): WeekMask_intervalsOfDay_Item {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("WeekMask-intervalsOfDay-Item contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_WeekMask_intervalsOfDay_Item (value: WeekMask_intervalsOfDay_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_WeekMask_intervalsOfDay_Item) { _cached_encoder_for_WeekMask_intervalsOfDay_Item = function (value: WeekMask_intervalsOfDay_Item, elGetter: $.ASN1Encoder<WeekMask_intervalsOfDay_Item>): _Element {
