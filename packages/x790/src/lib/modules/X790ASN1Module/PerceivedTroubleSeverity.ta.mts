 ...
 */
export
function _decode_PerceivedTroubleSeverity (el: _Element): PerceivedTroubleSeverity {
    if (!_cached_decoder_for_PerceivedTroubleSeverity) { _cached_decoder_for_PerceivedTroubleSeverity = $._decode_extensible_choice<PerceivedTroubleSeverity>({
    "UNIVERSAL 2": [ "number_", _decode_PerceivedTroubleSeverity_number ],
 ...
 */
export
function _encode_PerceivedTroubleSeverity (value: PerceivedTroubleSeverity, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PerceivedTroubleSeverity) { _cached_encoder_for_PerceivedTroubleSeverity = $._encode_choice<PerceivedTroubleSeverity>({
