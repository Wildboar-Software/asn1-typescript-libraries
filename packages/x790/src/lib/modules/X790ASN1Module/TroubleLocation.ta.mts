 ...
 */
export
function _decode_TroubleLocation (el: _Element): TroubleLocation {
    if (!_cached_decoder_for_TroubleLocation) { _cached_decoder_for_TroubleLocation = $._decode_extensible_choice<TroubleLocation>({
    "CONTEXT 0": [ "locationAddress", $._decode_implicit<LocationAddress>(() => _decode_LocationAddress) ],
    "CONTEXT 1": [ "locationPtr", $._decode_explicit<ObjectInstance>(() => _decode_ObjectInstance) ],
    "CONTEXT 2": [ "noTroubleLocationValue", $._decode_implicit<NULL>(() => $._decodeNull) ]
}); }
 ...
 */
export
function _encode_TroubleLocation (value: TroubleLocation, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TroubleLocation) { _cached_encoder_for_TroubleLocation = $._encode_choice<TroubleLocation>({
    "locationAddress": $._encode_implicit(_TagClass.context, 0, () => _encode_LocationAddress, $.BER),
    "locationPtr": $._encode_explicit(_TagClass.context, 1, () => _encode_ObjectInstance, $.BER),
    "noTroubleLocationValue": $._encode_implicit(_TagClass.context, 2, () => $._encodeNull, $.BER),
}, $.BER); }
