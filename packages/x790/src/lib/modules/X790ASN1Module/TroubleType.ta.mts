 ...
 */
export
function _decode_TroubleType (el: _Element): TroubleType {
    if (!_cached_decoder_for_TroubleType) { _cached_decoder_for_TroubleType = $._decode_extensible_choice<TroubleType>({
 ...
 */
export
function _encode_TroubleType (value: TroubleType, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TroubleType) { _cached_encoder_for_TroubleType = $._encode_choice<TroubleType>({
