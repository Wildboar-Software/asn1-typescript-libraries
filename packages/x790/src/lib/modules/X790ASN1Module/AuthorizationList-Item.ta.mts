 ...
 * 
 * ```asn1
 * AuthorizationList-Item ::= SEQUENCE {
 *     state       RequestState,
 *     type        ActivityType,
...
class AuthorizationList_Item {
     ...
     */
    public static _from_object (_o: { [_K in keyof (AuthorizationList_Item)]: (AuthorizationList_Item)[_K] }): AuthorizationList_Item {
        return new AuthorizationList_Item(_o.state, _o.type_, _o.authTime, _o.authPerson, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_AuthorizationList_Item: $.ComponentSpec[] = [
    new $.ComponentSpec("state", false, $.hasTag(_TagClass.universal, 10)),
    new $.ComponentSpec("type", false, $.hasTag(_TagClass.universal, 3)),
    new $.ComponentSpec("authTime", true, $.hasTag(_TagClass.universal, 24)),
    new $.ComponentSpec("authPerson", true, $.hasTag(_TagClass.universal, 16))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_AuthorizationList_Item: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AuthorizationList_Item: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AuthorizationList_Item (el: _Element): AuthorizationList_Item {
    if (!_cached_decoder_for_AuthorizationList_Item) { _cached_decoder_for_AuthorizationList_Item = function (el: _Element): AuthorizationList_Item {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "type": (_el: _Element): void => { type_ = _decode_ActivityType(_el); },
        "authTime": (_el: _Element): void => { authTime = _decode_AuthorizationTime(_el); },
        "authPerson": (_el: _Element): void => { authPerson = _decode_PersonReach(_el); }
    };
 ...
 */
export
function _encode_AuthorizationList_Item (value: AuthorizationList_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AuthorizationList_Item) { _cached_encoder_for_AuthorizationList_Item = function (value: AuthorizationList_Item, elGetter: $.ASN1Encoder<AuthorizationList_Item>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_RequestState(value.state, $.BER),
            /* REQUIRED   */ _encode_ActivityType(value.type_, $.BER),
            /* IF_ABSENT  */ ((value.authTime === undefined) ? undefined : _encode_AuthorizationTime(value.authTime, $.BER)),
            /* IF_ABSENT  */ ((value.authPerson === undefined) ? undefined : _encode_PersonReach(value.authPerson, $.BER))
        ],
