...
import {
    ...
    temporaryOK,
    cableFailure,
    originatingEquipFailure,
    backOrder,
    clearedCustNotAdvised,
    clearedCustAdvised,
    clearedAwaitingCustVerification,
    closedOut,
    closedOutByCustReq,
 ...
 */
export
function _decode_TroubleReportStatus (el: _Element): TroubleReportStatus {
    if (!_cached_decoder_for_TroubleReportStatus) { _cached_decoder_for_TroubleReportStatus = $._decode_extensible_choice<TroubleReportStatus>({
 ...
 */
export
function _encode_TroubleReportStatus (value: TroubleReportStatus, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TroubleReportStatus) { _cached_encoder_for_TroubleReportStatus = $._encode_choice<TroubleReportStatus>({
