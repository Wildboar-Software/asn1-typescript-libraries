 ...
 */
export
class TroubleReportChangeDenied {
    constructor (
        /**
     ...
     */
    public static _from_object (_o: { [_K in keyof (TroubleReportChangeDenied)]: (TroubleReportChangeDenied)[_K] }): TroubleReportChangeDenied {
        return new TroubleReportChangeDenied(_o.changeDeniedReason, _o.managedObjectClass, _o.managedObjectInstance, _o.troubleReportInstance, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_TroubleReportChangeDenied: $.ComponentSpec[] = [
    new $.ComponentSpec("changeDeniedReason", false, $.hasTag(_TagClass.universal, 10)),
    new $.ComponentSpec("managedObjectClass", true, $.or($.hasTag(_TagClass.context, 0), $.hasTag(_TagClass.context, 1))),
    new $.ComponentSpec("managedObjectInstance", false, $.hasAnyTag),
    new $.ComponentSpec("troubleReportInstance", false, $.hasAnyTag)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_TroubleReportChangeDenied: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_TroubleReportChangeDenied: $.ComponentSpec[] = [
 ...
 */
export
function _decode_TroubleReportChangeDenied (el: _Element): TroubleReportChangeDenied {
    if (!_cached_decoder_for_TroubleReportChangeDenied) { _cached_decoder_for_TroubleReportChangeDenied = function (el: _Element): TroubleReportChangeDenied {
    ...
    const callbacks: $.DecodingMap = {
        "changeDeniedReason": (_el: _Element): void => { changeDeniedReason = _decode_ChangeDeniedReason(_el); },
        "managedObjectClass": (_el: _Element): void => { managedObjectClass = _decode_ObjectClass(_el); },
        "managedObjectInstance": (_el: _Element): void => { managedObjectInstance = _decode_ObjectInstance(_el); },
        "troubleReportInstance": (_el: _Element): void => { troubleReportInstance = _decode_ObjectInstance(_el); }
    };
 ...
 */
export
function _encode_TroubleReportChangeDenied (value: TroubleReportChangeDenied, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TroubleReportChangeDenied) { _cached_encoder_for_TroubleReportChangeDenied = function (value: TroubleReportChangeDenied, elGetter: $.ASN1Encoder<TroubleReportChangeDenied>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ChangeDeniedReason(value.changeDeniedReason, $.BER),
            /* IF_ABSENT  */ ((value.managedObjectClass === undefined) ? undefined : _encode_ObjectClass(value.managedObjectClass, $.BER)),
            /* REQUIRED   */ _encode_ObjectInstance(value.managedObjectInstance, $.BER),
            /* REQUIRED   */ _encode_ObjectInstance(value.troubleReportInstance, $.BER)
        ],
