...
import {
    ...
    _decode_Name,
    _encode_Name,
} from "../X790ASN1Module/Name.ta.mjs";
 ...
 */
export
function _decode_Names (el: _Element): Names {
    if (!_cached_decoder_for_Names) { _cached_decoder_for_Names = $._decodeSetOf<Name>(() => _decode_Name); }
 ...
 */
export
function _encode_Names (value: Names, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Names) { _cached_encoder_for_Names = $._encodeSetOf<Name>(() => _encode_Name, $.BER); }
