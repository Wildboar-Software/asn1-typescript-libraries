 ...
 */
export
function _decode_RelatedObject (el: _Element): RelatedObject {
    if (!_cached_decoder_for_RelatedObject) { _cached_decoder_for_RelatedObject = $._decode_extensible_choice<RelatedObject>({
 ...
 */
export
function _encode_RelatedObject (value: RelatedObject, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RelatedObject) { _cached_encoder_for_RelatedObject = $._encode_choice<RelatedObject>({
