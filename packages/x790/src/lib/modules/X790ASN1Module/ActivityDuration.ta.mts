 ...
 */
export
type ActivityDuration = ActivityDuration_Item[]; // SetOfType
 ...
 */
export
function _decode_ActivityDuration (el: _Element): ActivityDuration {
    if (!_cached_decoder_for_ActivityDuration) { _cached_decoder_for_ActivityDuration = $._decodeSetOf<ActivityDuration_Item>(() => _decode_ActivityDuration_Item); }
 ...
 */
export
function _encode_ActivityDuration (value: ActivityDuration, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ActivityDuration) { _cached_encoder_for_ActivityDuration = $._encodeSetOf<ActivityDuration_Item>(() => _encode_ActivityDuration_Item, $.BER); }
