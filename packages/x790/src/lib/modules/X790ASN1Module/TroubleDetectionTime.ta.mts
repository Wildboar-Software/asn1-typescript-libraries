 ...
 */
export
function _decode_TroubleDetectionTime (el: _Element): TroubleDetectionTime {
    if (!_cached_decoder_for_TroubleDetectionTime) { _cached_decoder_for_TroubleDetectionTime = $._decode_extensible_choice<TroubleDetectionTime>({
 ...
 */
export
function _encode_TroubleDetectionTime (value: TroubleDetectionTime, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TroubleDetectionTime) { _cached_encoder_for_TroubleDetectionTime = $._encode_choice<TroubleDetectionTime>({
    "null_": $._encodeNull,
