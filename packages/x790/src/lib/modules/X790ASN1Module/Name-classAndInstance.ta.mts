 ...
 * 
 * ```asn1
 * Name-classAndInstance ::= SEQUENCE {
...
class Name_classAndInstance {
     ...
     */
    public static _from_object (_o: { [_K in keyof (Name_classAndInstance)]: (Name_classAndInstance)[_K] }): Name_classAndInstance {
        return new Name_classAndInstance(_o.managedObjectClass, _o.managedObjectInstance, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_Name_classAndInstance: $.ComponentSpec[] = [
    new $.ComponentSpec("managedObjectClass", false, $.hasAnyTag),
 ...
 */
export
const _root_component_type_list_2_spec_for_Name_classAndInstance: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_Name_classAndInstance: $.ComponentSpec[] = [
 ...
 */
export
function _decode_Name_classAndInstance (el: _Element): Name_classAndInstance {
    if (!_cached_decoder_for_Name_classAndInstance) { _cached_decoder_for_Name_classAndInstance = function (el: _Element): Name_classAndInstance {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("Name-classAndInstance contained only " + sequence.length.toString() + " elements.");
    }
 ...
 */
export
function _encode_Name_classAndInstance (value: Name_classAndInstance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Name_classAndInstance) { _cached_encoder_for_Name_classAndInstance = function (value: Name_classAndInstance, elGetter: $.ASN1Encoder<Name_classAndInstance>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ObjectClass(value.managedObjectClass, $.BER),
