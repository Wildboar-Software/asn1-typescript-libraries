...
function _encode_InitializeJournal_Request (value: InitializeJournal_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_InitializeJournal_Request) { _cached_encoder_for_InitializeJournal_Request = function (value: InitializeJournal_Request, elGetter: $.ASN1Encoder<InitializeJournal_Request>): _Element {
