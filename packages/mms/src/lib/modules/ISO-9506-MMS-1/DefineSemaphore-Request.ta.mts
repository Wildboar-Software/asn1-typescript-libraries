...
function _encode_DefineSemaphore_Request (value: DefineSemaphore_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DefineSemaphore_Request) { _cached_encoder_for_DefineSemaphore_Request = function (value: DefineSemaphore_Request, elGetter: $.ASN1Encoder<DefineSemaphore_Request>): _Element {
