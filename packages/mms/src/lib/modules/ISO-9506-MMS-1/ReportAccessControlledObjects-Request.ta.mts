...
function _encode_ReportAccessControlledObjects_Request (value: ReportAccessControlledObjects_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReportAccessControlledObjects_Request) { _cached_encoder_for_ReportAccessControlledObjects_Request = function (value: ReportAccessControlledObjects_Request): _Element {
