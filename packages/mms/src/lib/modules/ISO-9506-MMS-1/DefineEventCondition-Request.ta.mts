...
function _encode_DefineEventCondition_Request (value: DefineEventCondition_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DefineEventCondition_Request) { _cached_encoder_for_DefineEventCondition_Request = function (value: DefineEventCondition_Request, elGetter: $.ASN1Encoder<DefineEventCondition_Request>): _Element {
