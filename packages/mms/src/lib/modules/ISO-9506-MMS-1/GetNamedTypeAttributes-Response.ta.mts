...
function _encode_GetNamedTypeAttributes_Response (value: GetNamedTypeAttributes_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetNamedTypeAttributes_Response) { _cached_encoder_for_GetNamedTypeAttributes_Response = function (value: GetNamedTypeAttributes_Response): _Element {
