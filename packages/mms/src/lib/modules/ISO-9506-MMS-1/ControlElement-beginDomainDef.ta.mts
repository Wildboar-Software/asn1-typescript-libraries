...
function _encode_ControlElement_beginDomainDef (value: ControlElement_beginDomainDef, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ControlElement_beginDomainDef) { _cached_encoder_for_ControlElement_beginDomainDef = function (value: ControlElement_beginDomainDef): _Element {
