 ...
 * 
 * ```asn1
 * AlternateAccess-Item-named ::= SEQUENCE {
...
function _encode_AlternateAccess_Item_named (value: AlternateAccess_Item_named, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AlternateAccess_Item_named) { _cached_encoder_for_AlternateAccess_Item_named = function (value: AlternateAccess_Item_named): _Element {
