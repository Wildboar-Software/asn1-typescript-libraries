...
function _encode_ControlElement_piDefinition (value: ControlElement_piDefinition, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ControlElement_piDefinition) { _cached_encoder_for_ControlElement_piDefinition = function (value: ControlElement_piDefinition, elGetter: $.ASN1Encoder<ControlElement_piDefinition>): _Element {
