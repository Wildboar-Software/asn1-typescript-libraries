...
function _encode_ReportJournalStatus_Response (value: ReportJournalStatus_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReportJournalStatus_Response) { _cached_encoder_for_ReportJournalStatus_Response = function (value: ReportJournalStatus_Response, elGetter: $.ASN1Encoder<ReportJournalStatus_Response>): _Element {
