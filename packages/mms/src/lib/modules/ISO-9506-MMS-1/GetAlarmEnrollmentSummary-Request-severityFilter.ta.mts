...
function _encode_GetAlarmEnrollmentSummary_Request_severityFilter (value: GetAlarmEnrollmentSummary_Request_severityFilter, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetAlarmEnrollmentSummary_Request_severityFilter) { _cached_encoder_for_GetAlarmEnrollmentSummary_Request_severityFilter = function (value: GetAlarmEnrollmentSummary_Request_severityFilter, elGetter: $.ASN1Encoder<GetAlarmEnrollmentSummary_Request_severityFilter>): _Element {
