...
function _encode_DefineNamedVariableList_Request_listOfVariable_Item (value: DefineNamedVariableList_Request_listOfVariable_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DefineNamedVariableList_Request_listOfVariable_Item) { _cached_encoder_for_DefineNamedVariableList_Request_listOfVariable_Item = function (value: DefineNamedVariableList_Request_listOfVariable_Item): _Element {
