...
function _encode_CreateJournal_Request (value: CreateJournal_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CreateJournal_Request) { _cached_encoder_for_CreateJournal_Request = function (value: CreateJournal_Request, elGetter: $.ASN1Encoder<CreateJournal_Request>): _Element {
