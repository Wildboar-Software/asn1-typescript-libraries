...
function _encode_DefineEventAction_Request (value: DefineEventAction_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DefineEventAction_Request) { _cached_encoder_for_DefineEventAction_Request = function (value: DefineEventAction_Request, elGetter: $.ASN1Encoder<DefineEventAction_Request>): _Element {
