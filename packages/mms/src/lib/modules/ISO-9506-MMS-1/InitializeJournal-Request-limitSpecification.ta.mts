...
function _encode_InitializeJournal_Request_limitSpecification (value: InitializeJournal_Request_limitSpecification, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_InitializeJournal_Request_limitSpecification) { _cached_encoder_for_InitializeJournal_Request_limitSpecification = function (value: InitializeJournal_Request_limitSpecification): _Element {
