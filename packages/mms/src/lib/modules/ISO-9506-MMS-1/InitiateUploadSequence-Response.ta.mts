...
function _encode_InitiateUploadSequence_Response (value: InitiateUploadSequence_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_InitiateUploadSequence_Response) { _cached_encoder_for_InitiateUploadSequence_Response = function (value: InitiateUploadSequence_Response): _Element {
