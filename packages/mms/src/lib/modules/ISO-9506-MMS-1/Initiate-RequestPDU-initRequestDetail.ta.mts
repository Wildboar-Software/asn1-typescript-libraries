...
function _encode_Initiate_RequestPDU_initRequestDetail (value: Initiate_RequestPDU_initRequestDetail, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Initiate_RequestPDU_initRequestDetail) { _cached_encoder_for_Initiate_RequestPDU_initRequestDetail = function (value: Initiate_RequestPDU_initRequestDetail, elGetter: $.ASN1Encoder<Initiate_RequestPDU_initRequestDetail>): _Element {
