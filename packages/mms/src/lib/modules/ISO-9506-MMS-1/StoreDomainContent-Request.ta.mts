...
function _encode_StoreDomainContent_Request (value: StoreDomainContent_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_StoreDomainContent_Request) { _cached_encoder_for_StoreDomainContent_Request = function (value: StoreDomainContent_Request, elGetter: $.ASN1Encoder<StoreDomainContent_Request>): _Element {
