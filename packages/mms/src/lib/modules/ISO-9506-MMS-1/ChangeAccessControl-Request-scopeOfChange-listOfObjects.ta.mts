...
function _encode_ChangeAccessControl_Request_scopeOfChange_listOfObjects (value: ChangeAccessControl_Request_scopeOfChange_listOfObjects, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ChangeAccessControl_Request_scopeOfChange_listOfObjects) { _cached_encoder_for_ChangeAccessControl_Request_scopeOfChange_listOfObjects = function (value: ChangeAccessControl_Request_scopeOfChange_listOfObjects, elGetter: $.ASN1Encoder<ChangeAccessControl_Request_scopeOfChange_listOfObjects>): _Element {
