...
function _encode_AlterProgramInvocationAttributes_Request (value: AlterProgramInvocationAttributes_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AlterProgramInvocationAttributes_Request) { _cached_encoder_for_AlterProgramInvocationAttributes_Request = function (value: AlterProgramInvocationAttributes_Request): _Element {
