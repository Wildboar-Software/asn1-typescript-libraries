...
function _encode_TerminateDownloadSequence_Request (value: TerminateDownloadSequence_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TerminateDownloadSequence_Request) { _cached_encoder_for_TerminateDownloadSequence_Request = function (value: TerminateDownloadSequence_Request): _Element {
