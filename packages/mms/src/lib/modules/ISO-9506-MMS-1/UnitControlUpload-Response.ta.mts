...
function _encode_UnitControlUpload_Response (value: UnitControlUpload_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnitControlUpload_Response) { _cached_encoder_for_UnitControlUpload_Response = function (value: UnitControlUpload_Response, elGetter: $.ASN1Encoder<UnitControlUpload_Response>): _Element {
