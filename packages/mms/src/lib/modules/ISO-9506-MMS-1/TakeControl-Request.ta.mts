...
function _encode_TakeControl_Request (value: TakeControl_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TakeControl_Request) { _cached_encoder_for_TakeControl_Request = function (value: TakeControl_Request, elGetter: $.ASN1Encoder<TakeControl_Request>): _Element {
