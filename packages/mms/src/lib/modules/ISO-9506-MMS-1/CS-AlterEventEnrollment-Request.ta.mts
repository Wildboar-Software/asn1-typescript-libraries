...
function _encode_CS_AlterEventEnrollment_Request (value: CS_AlterEventEnrollment_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CS_AlterEventEnrollment_Request) { _cached_encoder_for_CS_AlterEventEnrollment_Request = function (value: CS_AlterEventEnrollment_Request): _Element {
