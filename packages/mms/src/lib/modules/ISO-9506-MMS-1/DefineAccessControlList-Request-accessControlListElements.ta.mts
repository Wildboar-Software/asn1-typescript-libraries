 ...
 * ISO 9506-1:2003 §9.3.1.1.2; ISO 9506-2:2003 §9.3.1.1 / §9.4.2.1. Used as the
 * DefineAccessControlList argument. ISO 9506-1:2003 §9.3; ISO 9506-2:2003
 * §9.3.1.1.
 * 
 * ### ASN.1 Definition:
 * 
...
class DefineAccessControlList_Request_accessControlListElements {
     ...
     * `DefineAccessControlList_Request_accessControlListElements`.
     * 
     * @public
     * @static
     * @method
