...
function _encode_DefineNamedVariable_Request (value: DefineNamedVariable_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DefineNamedVariable_Request) { _cached_encoder_for_DefineNamedVariable_Request = function (value: DefineNamedVariable_Request, elGetter: $.ASN1Encoder<DefineNamedVariable_Request>): _Element {
