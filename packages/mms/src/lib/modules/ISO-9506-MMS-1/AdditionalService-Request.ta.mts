 ...
 */
export
type AdditionalService_Request = ProblematicThereforeAnyType; // DefinedType
...
function _decode_AdditionalService_Request (el: _Element): AdditionalService_Request {
    if (!_cached_decoder_for_AdditionalService_Request) { _cached_decoder_for_AdditionalService_Request = _decode_ProblematicThereforeAnyType; }
...
function _encode_AdditionalService_Request (value: AdditionalService_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AdditionalService_Request) { _cached_encoder_for_AdditionalService_Request = _encode_ProblematicThereforeAnyType; }
