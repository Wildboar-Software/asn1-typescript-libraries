...
function _encode_ReadJournal_Request (value: ReadJournal_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReadJournal_Request) { _cached_encoder_for_ReadJournal_Request = function (value: ReadJournal_Request, elGetter: $.ASN1Encoder<ReadJournal_Request>): _Element {
