...
function _encode_CS_GetProgramInvocationAttributes_Response_control_controlling (value: CS_GetProgramInvocationAttributes_Response_control_controlling, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CS_GetProgramInvocationAttributes_Response_control_controlling) { _cached_encoder_for_CS_GetProgramInvocationAttributes_Response_control_controlling = function (value: CS_GetProgramInvocationAttributes_Response_control_controlling, elGetter: $.ASN1Encoder<CS_GetProgramInvocationAttributes_Response_control_controlling>): _Element {
