...
function _encode_DefineNamedVariableList_Request (value: DefineNamedVariableList_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DefineNamedVariableList_Request) { _cached_encoder_for_DefineNamedVariableList_Request = function (value: DefineNamedVariableList_Request, elGetter: $.ASN1Encoder<DefineNamedVariableList_Request>): _Element {
