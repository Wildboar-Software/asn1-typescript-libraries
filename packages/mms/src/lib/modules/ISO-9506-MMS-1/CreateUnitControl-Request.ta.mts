...
function _encode_CreateUnitControl_Request (value: CreateUnitControl_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CreateUnitControl_Request) { _cached_encoder_for_CreateUnitControl_Request = function (value: CreateUnitControl_Request, elGetter: $.ASN1Encoder<CreateUnitControl_Request>): _Element {
