 ...
 * @description
 * 
 * Client request to drop Domain and/or Program Invocation references from a
 * Unit Control object (does not delete those objects). ISO 9506-1:2003 §13.10.
 * ISO 9506-2:2003 §13.10.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class RemoveFromUnitControl_Request {
    constructor (
         ...
         * @description
         *
         * Unit Control whose constituent lists are reduced. ISO 9506-1:2003
         * §13.10.1.1.1.
         *
         * @public
         * @readonly
         ...
         * @description
         *
         * Zero or more Program Invocations to remove from
         * `&ProgramInvocations`. ISO 9506-1:2003 §13.10.1.1.3.
         *
         * @public
         * @readonly
         */
...
function _encode_RemoveFromUnitControl_Request (value: RemoveFromUnitControl_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RemoveFromUnitControl_Request) { _cached_encoder_for_RemoveFromUnitControl_Request = function (value: RemoveFromUnitControl_Request): _Element {
