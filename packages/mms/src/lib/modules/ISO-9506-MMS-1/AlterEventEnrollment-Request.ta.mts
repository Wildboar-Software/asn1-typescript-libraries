...
function _encode_AlterEventEnrollment_Request (value: AlterEventEnrollment_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AlterEventEnrollment_Request) { _cached_encoder_for_AlterEventEnrollment_Request = function (value: AlterEventEnrollment_Request): _Element {
