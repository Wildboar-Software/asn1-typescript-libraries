...
function _encode_ReportPoolSemaphoreStatus_Request (value: ReportPoolSemaphoreStatus_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReportPoolSemaphoreStatus_Request) { _cached_encoder_for_ReportPoolSemaphoreStatus_Request = function (value: ReportPoolSemaphoreStatus_Request): _Element {
