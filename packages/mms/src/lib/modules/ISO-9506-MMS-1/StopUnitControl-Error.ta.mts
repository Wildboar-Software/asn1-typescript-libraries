 ...
 * @description
 * 
 * Result(-) when a derived Stop fails: Program Invocation name and its
 * resulting state (previous if possible, else `unrunnable`). ISO 9506-1:2003
 * §13.7.1.3. ISO 9506-2:2003 §13.7.3.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class StopUnitControl_Error {
    constructor (
         ...
         * @description
         *
         * PI whose Stop failed. ISO 9506-1:2003 §13.7.1.3.1.1.
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * That PI's state after the failed Stop. ISO 9506-1:2003 §13.7.1.3.1.2.
         *
         * @public
         * @readonly
         */
...
function _encode_StopUnitControl_Error (value: StopUnitControl_Error, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_StopUnitControl_Error) { _cached_encoder_for_StopUnitControl_Error = function (value: StopUnitControl_Error): _Element {
