...
function _encode_GetEventEnrollmentAttributes_Response (value: GetEventEnrollmentAttributes_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetEventEnrollmentAttributes_Response) { _cached_encoder_for_GetEventEnrollmentAttributes_Response = function (value: GetEventEnrollmentAttributes_Response): _Element {
