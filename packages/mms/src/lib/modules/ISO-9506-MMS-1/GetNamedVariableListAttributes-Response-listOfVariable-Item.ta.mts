 ...
 * 
 * ```asn1
 * GetNamedVariableListAttributes-Response-listOfVariable-Item ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_GetNamedVariableListAttributes_Response_listOfVariable_Item (value: GetNamedVariableListAttributes_Response_listOfVariable_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetNamedVariableListAttributes_Response_listOfVariable_Item) { _cached_encoder_for_GetNamedVariableListAttributes_Response_listOfVariable_Item = function (value: GetNamedVariableListAttributes_Response_listOfVariable_Item, elGetter: $.ASN1Encoder<GetNamedVariableListAttributes_Response_listOfVariable_Item>): _Element {
