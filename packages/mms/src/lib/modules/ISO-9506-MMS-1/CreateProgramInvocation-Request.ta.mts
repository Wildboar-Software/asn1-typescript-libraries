...
function _encode_CreateProgramInvocation_Request (value: CreateProgramInvocation_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CreateProgramInvocation_Request) { _cached_encoder_for_CreateProgramInvocation_Request = function (value: CreateProgramInvocation_Request, elGetter: $.ASN1Encoder<CreateProgramInvocation_Request>): _Element {
