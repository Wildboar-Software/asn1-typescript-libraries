...
function _encode_ReportSemaphoreEntryStatus_Response (value: ReportSemaphoreEntryStatus_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReportSemaphoreEntryStatus_Response) { _cached_encoder_for_ReportSemaphoreEntryStatus_Response = function (value: ReportSemaphoreEntryStatus_Response, elGetter: $.ASN1Encoder<ReportSemaphoreEntryStatus_Response>): _Element {
