...
function _encode_VariableSpecification_variableDescription (value: VariableSpecification_variableDescription, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_VariableSpecification_variableDescription) { _cached_encoder_for_VariableSpecification_variableDescription = function (value: VariableSpecification_variableDescription): _Element {
