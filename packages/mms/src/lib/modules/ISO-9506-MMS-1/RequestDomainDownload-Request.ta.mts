...
function _encode_RequestDomainDownload_Request (value: RequestDomainDownload_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RequestDomainDownload_Request) { _cached_encoder_for_RequestDomainDownload_Request = function (value: RequestDomainDownload_Request, elGetter: $.ASN1Encoder<RequestDomainDownload_Request>): _Element {
