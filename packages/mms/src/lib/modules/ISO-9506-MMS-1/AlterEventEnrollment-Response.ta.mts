...
function _encode_AlterEventEnrollment_Response (value: AlterEventEnrollment_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AlterEventEnrollment_Response) { _cached_encoder_for_AlterEventEnrollment_Response = function (value: AlterEventEnrollment_Response): _Element {
