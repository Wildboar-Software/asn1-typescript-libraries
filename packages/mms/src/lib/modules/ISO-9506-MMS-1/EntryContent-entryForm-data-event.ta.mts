...
function _encode_EntryContent_entryForm_data_event (value: EntryContent_entryForm_data_event, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EntryContent_entryForm_data_event) { _cached_encoder_for_EntryContent_entryForm_data_event = function (value: EntryContent_entryForm_data_event): _Element {
