...
function _encode_Initiate_RequestPDU (value: Initiate_RequestPDU, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Initiate_RequestPDU) { _cached_encoder_for_Initiate_RequestPDU = function (value: Initiate_RequestPDU, elGetter: $.ASN1Encoder<Initiate_RequestPDU>): _Element {
