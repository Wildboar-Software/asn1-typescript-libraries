...
function _encode_GetCapabilityList_Request (value: GetCapabilityList_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetCapabilityList_Request) { _cached_encoder_for_GetCapabilityList_Request = function (value: GetCapabilityList_Request, elGetter: $.ASN1Encoder<GetCapabilityList_Request>): _Element {
