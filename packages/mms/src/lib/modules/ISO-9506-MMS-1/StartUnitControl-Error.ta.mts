...
function _encode_StartUnitControl_Error (value: StartUnitControl_Error, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_StartUnitControl_Error) { _cached_encoder_for_StartUnitControl_Error = function (value: StartUnitControl_Error, elGetter: $.ASN1Encoder<StartUnitControl_Error>): _Element {
