...
function _encode_GetUnitControlAttributes_Response (value: GetUnitControlAttributes_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetUnitControlAttributes_Response) { _cached_encoder_for_GetUnitControlAttributes_Response = function (value: GetUnitControlAttributes_Response): _Element {
