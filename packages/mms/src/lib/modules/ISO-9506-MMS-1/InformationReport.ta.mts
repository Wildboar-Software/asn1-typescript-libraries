...
function _encode_InformationReport (value: InformationReport, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_InformationReport) { _cached_encoder_for_InformationReport = function (value: InformationReport, elGetter: $.ASN1Encoder<InformationReport>): _Element {
