...
function _encode_DeleteNamedType_Response (value: DeleteNamedType_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DeleteNamedType_Response) { _cached_encoder_for_DeleteNamedType_Response = function (value: DeleteNamedType_Response, elGetter: $.ASN1Encoder<DeleteNamedType_Response>): _Element {
