...
function _encode_UnitControlLoadSegment_Response (value: UnitControlLoadSegment_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UnitControlLoadSegment_Response) { _cached_encoder_for_UnitControlLoadSegment_Response = function (value: UnitControlLoadSegment_Response): _Element {
