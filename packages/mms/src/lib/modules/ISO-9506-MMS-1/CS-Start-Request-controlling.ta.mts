...
function _encode_CS_Start_Request_controlling (value: CS_Start_Request_controlling, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CS_Start_Request_controlling) { _cached_encoder_for_CS_Start_Request_controlling = function (value: CS_Start_Request_controlling): _Element {
