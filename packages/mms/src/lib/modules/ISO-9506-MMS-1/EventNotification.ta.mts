...
function _encode_EventNotification (value: EventNotification, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventNotification) { _cached_encoder_for_EventNotification = function (value: EventNotification, elGetter: $.ASN1Encoder<EventNotification>): _Element {
