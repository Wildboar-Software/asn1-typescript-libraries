...
function _encode_EventConditionStatus (value: EventConditionStatus, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventConditionStatus) { _cached_encoder_for_EventConditionStatus = function (value: EventConditionStatus, elGetter: $.ASN1Encoder<EventConditionStatus>): _Element {
