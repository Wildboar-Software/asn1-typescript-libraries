...
function _encode_CS_Resume_Request_controlling (value: CS_Resume_Request_controlling, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CS_Resume_Request_controlling) { _cached_encoder_for_CS_Resume_Request_controlling = function (value: CS_Resume_Request_controlling): _Element {
