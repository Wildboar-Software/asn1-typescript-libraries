...
function _encode_GetEventActionAttributes_Response (value: GetEventActionAttributes_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetEventActionAttributes_Response) { _cached_encoder_for_GetEventActionAttributes_Response = function (value: GetEventActionAttributes_Response, elGetter: $.ASN1Encoder<GetEventActionAttributes_Response>): _Element {
