...
function _encode_CS_GetProgramInvocationAttributes_Response (value: CS_GetProgramInvocationAttributes_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CS_GetProgramInvocationAttributes_Response) { _cached_encoder_for_CS_GetProgramInvocationAttributes_Response = function (value: CS_GetProgramInvocationAttributes_Response, elGetter: $.ASN1Encoder<CS_GetProgramInvocationAttributes_Response>): _Element {
