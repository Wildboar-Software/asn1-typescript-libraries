...
function _encode_Confirmed_ResponsePDU (value: Confirmed_ResponsePDU, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Confirmed_ResponsePDU) { _cached_encoder_for_Confirmed_ResponsePDU = function (value: Confirmed_ResponsePDU, elGetter: $.ASN1Encoder<Confirmed_ResponsePDU>): _Element {
