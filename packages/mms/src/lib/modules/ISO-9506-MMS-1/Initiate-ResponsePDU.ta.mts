...
function _encode_Initiate_ResponsePDU (value: Initiate_ResponsePDU, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Initiate_ResponsePDU) { _cached_encoder_for_Initiate_ResponsePDU = function (value: Initiate_ResponsePDU, elGetter: $.ASN1Encoder<Initiate_ResponsePDU>): _Element {
