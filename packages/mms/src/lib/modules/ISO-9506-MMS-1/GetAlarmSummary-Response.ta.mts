 ...
 * @description
 *
 * Confirmed Result(+): zero or more Alarm Summary entries in
 * collation order. `moreFollows` true means a continuation
 * request (with `continueAfter`) is needed; in that case the
 * list is non-empty.
 *
 * [ISO 9506-1:2003 §18.5.1.2] [ISO 9506-2:2003 §18.5.2]
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
class GetAlarmSummary_Response {
    constructor (
         ...
         * @description
         *
         * One Alarm Summary per matching monitored Event
         * Condition, in collation sequence.
         *
         * [ISO 9506-1:2003 §18.5.1.2.1]
         *
         * @public
         * @readonly
         */
...
function _encode_GetAlarmSummary_Response (value: GetAlarmSummary_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetAlarmSummary_Response) { _cached_encoder_for_GetAlarmSummary_Response = function (value: GetAlarmSummary_Response): _Element {
