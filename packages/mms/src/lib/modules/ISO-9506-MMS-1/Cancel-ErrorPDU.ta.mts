...
function _encode_Cancel_ErrorPDU (value: Cancel_ErrorPDU, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Cancel_ErrorPDU) { _cached_encoder_for_Cancel_ErrorPDU = function (value: Cancel_ErrorPDU, elGetter: $.ASN1Encoder<Cancel_ErrorPDU>): _Element {
