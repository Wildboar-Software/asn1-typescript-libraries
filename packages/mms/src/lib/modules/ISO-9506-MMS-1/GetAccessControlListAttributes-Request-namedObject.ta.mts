...
function _encode_GetAccessControlListAttributes_Request_namedObject (value: GetAccessControlListAttributes_Request_namedObject, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetAccessControlListAttributes_Request_namedObject) { _cached_encoder_for_GetAccessControlListAttributes_Request_namedObject = function (value: GetAccessControlListAttributes_Request_namedObject, elGetter: $.ASN1Encoder<GetAccessControlListAttributes_Request_namedObject>): _Element {
