 ...
 * 
 * ```asn1
 * Initiate-ResponsePDU-initResponseDetail ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_Initiate_ResponsePDU_initResponseDetail (value: Initiate_ResponsePDU_initResponseDetail, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Initiate_ResponsePDU_initResponseDetail) { _cached_encoder_for_Initiate_ResponsePDU_initResponseDetail = function (value: Initiate_ResponsePDU_initResponseDetail, elGetter: $.ASN1Encoder<Initiate_ResponsePDU_initResponseDetail>): _Element {
