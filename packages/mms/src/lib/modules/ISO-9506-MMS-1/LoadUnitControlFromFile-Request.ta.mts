...
function _encode_LoadUnitControlFromFile_Request (value: LoadUnitControlFromFile_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_LoadUnitControlFromFile_Request) { _cached_encoder_for_LoadUnitControlFromFile_Request = function (value: LoadUnitControlFromFile_Request, elGetter: $.ASN1Encoder<LoadUnitControlFromFile_Request>): _Element {
