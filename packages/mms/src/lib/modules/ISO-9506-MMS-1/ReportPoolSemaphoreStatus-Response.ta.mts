...
function _encode_ReportPoolSemaphoreStatus_Response (value: ReportPoolSemaphoreStatus_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReportPoolSemaphoreStatus_Response) { _cached_encoder_for_ReportPoolSemaphoreStatus_Response = function (value: ReportPoolSemaphoreStatus_Response): _Element {
