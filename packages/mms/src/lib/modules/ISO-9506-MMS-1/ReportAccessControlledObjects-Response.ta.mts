...
function _encode_ReportAccessControlledObjects_Response (value: ReportAccessControlledObjects_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReportAccessControlledObjects_Response) { _cached_encoder_for_ReportAccessControlledObjects_Response = function (value: ReportAccessControlledObjects_Response, elGetter: $.ASN1Encoder<ReportAccessControlledObjects_Response>): _Element {
