...
function _encode_ExchangeData_Request (value: ExchangeData_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ExchangeData_Request) { _cached_encoder_for_ExchangeData_Request = function (value: ExchangeData_Request, elGetter: $.ASN1Encoder<ExchangeData_Request>): _Element {
