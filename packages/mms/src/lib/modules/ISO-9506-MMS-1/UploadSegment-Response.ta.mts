...
function _encode_UploadSegment_Response (value: UploadSegment_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UploadSegment_Response) { _cached_encoder_for_UploadSegment_Response = function (value: UploadSegment_Response, elGetter: $.ASN1Encoder<UploadSegment_Response>): _Element {
