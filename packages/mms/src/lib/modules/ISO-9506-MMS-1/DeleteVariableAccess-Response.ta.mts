...
function _encode_DeleteVariableAccess_Response (value: DeleteVariableAccess_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DeleteVariableAccess_Response) { _cached_encoder_for_DeleteVariableAccess_Response = function (value: DeleteVariableAccess_Response): _Element {
