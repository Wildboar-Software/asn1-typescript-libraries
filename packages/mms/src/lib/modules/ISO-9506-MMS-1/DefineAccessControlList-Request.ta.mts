...
function _encode_DefineAccessControlList_Request (value: DefineAccessControlList_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DefineAccessControlList_Request) { _cached_encoder_for_DefineAccessControlList_Request = function (value: DefineAccessControlList_Request, elGetter: $.ASN1Encoder<DefineAccessControlList_Request>): _Element {
