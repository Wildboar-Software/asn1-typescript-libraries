...
import { DeleteNamedType_Request_scopeOfDelete, specific /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_DeleteNamedType_Request_scopeOfDelete, _encode_DeleteNamedType_Request_scopeOfDelete } from "../ISO-9506-MMS-1/DeleteNamedType-Request-scopeOfDelete.ta.mjs";
...
function _encode_DeleteNamedType_Request (value: DeleteNamedType_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DeleteNamedType_Request) { _cached_encoder_for_DeleteNamedType_Request = function (value: DeleteNamedType_Request): _Element {
