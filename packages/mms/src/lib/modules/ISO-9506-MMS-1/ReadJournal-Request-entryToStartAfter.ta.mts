...
function _encode_ReadJournal_Request_entryToStartAfter (value: ReadJournal_Request_entryToStartAfter, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReadJournal_Request_entryToStartAfter) { _cached_encoder_for_ReadJournal_Request_entryToStartAfter = function (value: ReadJournal_Request_entryToStartAfter, elGetter: $.ASN1Encoder<ReadJournal_Request_entryToStartAfter>): _Element {
