...
function _encode_GetAlarmEnrollmentSummary_Response (value: GetAlarmEnrollmentSummary_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetAlarmEnrollmentSummary_Response) { _cached_encoder_for_GetAlarmEnrollmentSummary_Response = function (value: GetAlarmEnrollmentSummary_Response, elGetter: $.ASN1Encoder<GetAlarmEnrollmentSummary_Response>): _Element {
