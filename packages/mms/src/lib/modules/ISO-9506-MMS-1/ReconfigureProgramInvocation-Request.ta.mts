...
function _encode_ReconfigureProgramInvocation_Request (value: ReconfigureProgramInvocation_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReconfigureProgramInvocation_Request) { _cached_encoder_for_ReconfigureProgramInvocation_Request = function (value: ReconfigureProgramInvocation_Request, elGetter: $.ASN1Encoder<ReconfigureProgramInvocation_Request>): _Element {
