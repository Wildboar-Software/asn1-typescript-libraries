 ...
 * 
 * ```asn1
 * EventNotification-actionResult ::= SEQUENCE {
...
function _encode_EventNotification_actionResult (value: EventNotification_actionResult, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventNotification_actionResult) { _cached_encoder_for_EventNotification_actionResult = function (value: EventNotification_actionResult): _Element {
