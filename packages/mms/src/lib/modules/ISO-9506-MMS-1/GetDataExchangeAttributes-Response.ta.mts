...
function _encode_GetDataExchangeAttributes_Response (value: GetDataExchangeAttributes_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetDataExchangeAttributes_Response) { _cached_encoder_for_GetDataExchangeAttributes_Response = function (value: GetDataExchangeAttributes_Response, elGetter: $.ASN1Encoder<GetDataExchangeAttributes_Response>): _Element {
