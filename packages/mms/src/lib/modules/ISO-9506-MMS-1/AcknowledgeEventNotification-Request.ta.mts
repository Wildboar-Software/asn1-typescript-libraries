...
function _encode_AcknowledgeEventNotification_Request (value: AcknowledgeEventNotification_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AcknowledgeEventNotification_Request) { _cached_encoder_for_AcknowledgeEventNotification_Request = function (value: AcknowledgeEventNotification_Request, elGetter: $.ASN1Encoder<AcknowledgeEventNotification_Request>): _Element {
