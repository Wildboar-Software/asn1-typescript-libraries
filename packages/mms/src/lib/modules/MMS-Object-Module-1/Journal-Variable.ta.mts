...
function _encode_Journal_Variable (value: Journal_Variable, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Journal_Variable) { _cached_encoder_for_Journal_Variable = function (value: Journal_Variable, elGetter: $.ASN1Encoder<Journal_Variable>): _Element {
