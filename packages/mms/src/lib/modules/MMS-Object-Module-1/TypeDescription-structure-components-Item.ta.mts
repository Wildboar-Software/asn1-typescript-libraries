...
function _encode_TypeDescription_structure_components_Item (value: TypeDescription_structure_components_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TypeDescription_structure_components_Item) { _cached_encoder_for_TypeDescription_structure_components_Item = function (value: TypeDescription_structure_components_Item): _Element {
