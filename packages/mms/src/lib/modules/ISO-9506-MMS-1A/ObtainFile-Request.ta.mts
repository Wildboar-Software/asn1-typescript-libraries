...
function _encode_ObtainFile_Request (value: ObtainFile_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ObtainFile_Request) { _cached_encoder_for_ObtainFile_Request = function (value: ObtainFile_Request, elGetter: $.ASN1Encoder<ObtainFile_Request>): _Element {
