...
function _encode_ScatteredAccessDescription_Item (value: ScatteredAccessDescription_Item, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ScatteredAccessDescription_Item) { _cached_encoder_for_ScatteredAccessDescription_Item = function (value: ScatteredAccessDescription_Item, elGetter: $.ASN1Encoder<ScatteredAccessDescription_Item>): _Element {
