...
function _encode_FileOpen_Request (value: FileOpen_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FileOpen_Request) { _cached_encoder_for_FileOpen_Request = function (value: FileOpen_Request, elGetter: $.ASN1Encoder<FileOpen_Request>): _Element {
