...
function _encode_FileRename_Request (value: FileRename_Request, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_FileRename_Request) { _cached_encoder_for_FileRename_Request = function (value: FileRename_Request, elGetter: $.ASN1Encoder<FileRename_Request>): _Element {
