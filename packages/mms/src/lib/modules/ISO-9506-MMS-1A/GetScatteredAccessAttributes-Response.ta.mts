...
function _encode_GetScatteredAccessAttributes_Response (value: GetScatteredAccessAttributes_Response, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GetScatteredAccessAttributes_Response) { _cached_encoder_for_GetScatteredAccessAttributes_Response = function (value: GetScatteredAccessAttributes_Response, elGetter: $.ASN1Encoder<GetScatteredAccessAttributes_Response>): _Element {
