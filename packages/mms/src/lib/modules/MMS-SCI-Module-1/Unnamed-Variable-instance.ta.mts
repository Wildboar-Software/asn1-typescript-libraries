...
function _encode_Unnamed_Variable_instance (value: Unnamed_Variable_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Unnamed_Variable_instance) { _cached_encoder_for_Unnamed_Variable_instance = function (value: Unnamed_Variable_instance, elGetter: $.ASN1Encoder<Unnamed_Variable_instance>): _Element {
