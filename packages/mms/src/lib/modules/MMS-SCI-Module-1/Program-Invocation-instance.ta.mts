...
function _encode_Program_Invocation_instance (value: Program_Invocation_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Program_Invocation_instance) { _cached_encoder_for_Program_Invocation_instance = function (value: Program_Invocation_instance): _Element {
