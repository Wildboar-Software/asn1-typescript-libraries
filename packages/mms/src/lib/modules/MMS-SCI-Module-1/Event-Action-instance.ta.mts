 ...
 * @description
 * 
 * SCI record for a predefined EVENT-ACTION (ISO 9506-1:2003 §20.1.1). SCI
 * configuration/initialization encoding (ISO 9506-2:2003 Annex B), not a
 * runtime MMS PDU. ISO 9506-2:2003 Annex B.1.13.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
function _encode_Event_Action_instance (value: Event_Action_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Event_Action_instance) { _cached_encoder_for_Event_Action_instance = function (value: Event_Action_instance): _Element {
