...
function _encode_Named_Variable_Definition_Details (value: Named_Variable_Definition_Details, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Named_Variable_Definition_Details) { _cached_encoder_for_Named_Variable_Definition_Details = function (value: Named_Variable_Definition_Details): _Element {
