...
function _encode_GeneralManagementParameters_supportForTime (value: GeneralManagementParameters_supportForTime, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GeneralManagementParameters_supportForTime) { _cached_encoder_for_GeneralManagementParameters_supportForTime = function (value: GeneralManagementParameters_supportForTime): _Element {
