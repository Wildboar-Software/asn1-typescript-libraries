...
function _encode_OperatorCommunicationParameters (value: OperatorCommunicationParameters, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_OperatorCommunicationParameters) { _cached_encoder_for_OperatorCommunicationParameters = function (value: OperatorCommunicationParameters, elGetter: $.ASN1Encoder<OperatorCommunicationParameters>): _Element {
