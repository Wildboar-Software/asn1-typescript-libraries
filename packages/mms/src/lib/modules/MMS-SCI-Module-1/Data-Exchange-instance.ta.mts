 ...
 * @description
 * 
 * SCI record for a predefined DATA-EXCHANGE (ISO 9506-1:2003 §15.1.2). SCI
 * configuration/initialization encoding (ISO 9506-2:2003 Annex B), not a
 * runtime MMS PDU. ISO 9506-2:2003 Annex B.1.9.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
function _encode_Data_Exchange_instance (value: Data_Exchange_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Data_Exchange_instance) { _cached_encoder_for_Data_Exchange_instance = function (value: Data_Exchange_instance): _Element {
