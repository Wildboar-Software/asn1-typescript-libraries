...
function _encode_Data_Exchange_instance_definition_details (value: Data_Exchange_instance_definition_details, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Data_Exchange_instance_definition_details) { _cached_encoder_for_Data_Exchange_instance_definition_details = function (value: Data_Exchange_instance_definition_details): _Element {
