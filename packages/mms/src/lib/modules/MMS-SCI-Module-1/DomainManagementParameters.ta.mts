...
function _encode_DomainManagementParameters (value: DomainManagementParameters, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DomainManagementParameters) { _cached_encoder_for_DomainManagementParameters = function (value: DomainManagementParameters, elGetter: $.ASN1Encoder<DomainManagementParameters>): _Element {
