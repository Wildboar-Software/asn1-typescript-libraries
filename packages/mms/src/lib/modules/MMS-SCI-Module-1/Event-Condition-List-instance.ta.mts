...
function _encode_Event_Condition_List_instance (value: Event_Condition_List_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Event_Condition_List_instance) { _cached_encoder_for_Event_Condition_List_instance = function (value: Event_Condition_List_instance, elGetter: $.ASN1Encoder<Event_Condition_List_instance>): _Element {
