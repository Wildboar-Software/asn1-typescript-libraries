...
function _encode_ProgramInvocationManagementParameters (value: ProgramInvocationManagementParameters, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ProgramInvocationManagementParameters) { _cached_encoder_for_ProgramInvocationManagementParameters = function (value: ProgramInvocationManagementParameters): _Element {
