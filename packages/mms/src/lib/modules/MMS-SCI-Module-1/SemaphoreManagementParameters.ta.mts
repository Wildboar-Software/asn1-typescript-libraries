...
function _encode_SemaphoreManagementParameters (value: SemaphoreManagementParameters, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SemaphoreManagementParameters) { _cached_encoder_for_SemaphoreManagementParameters = function (value: SemaphoreManagementParameters): _Element {
