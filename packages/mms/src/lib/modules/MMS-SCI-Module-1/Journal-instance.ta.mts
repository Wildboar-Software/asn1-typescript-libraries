 ...
 * @description
 * 
 * SCI record for a predefined JOURNAL (ISO 9506-1:2003 §23.1.1). SCI
...
function _encode_Journal_instance (value: Journal_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Journal_instance) { _cached_encoder_for_Journal_instance = function (value: Journal_instance): _Element {
