...
function _encode_Named_Type_instance (value: Named_Type_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Named_Type_instance) { _cached_encoder_for_Named_Type_instance = function (value: Named_Type_instance, elGetter: $.ASN1Encoder<Named_Type_instance>): _Element {
