...
function _encode_Variable_List_Item_instance (value: Variable_List_Item_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Variable_List_Item_instance) { _cached_encoder_for_Variable_List_Item_instance = function (value: Variable_List_Item_instance): _Element {
