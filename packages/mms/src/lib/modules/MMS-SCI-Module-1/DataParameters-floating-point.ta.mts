...
function _encode_DataParameters_floating_point (value: DataParameters_floating_point, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DataParameters_floating_point) { _cached_encoder_for_DataParameters_floating_point = function (value: DataParameters_floating_point): _Element {
