 ...
 * @description
 * 
 * SCI record for a predefined SEMAPHORE (ISO 9506-1:2003 §16.1.1). SCI
 * configuration/initialization encoding (ISO 9506-2:2003 Annex B), not a
 * runtime MMS PDU. ISO 9506-2:2003 Annex B.1.10.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
function _encode_Semaphore_instance (value: Semaphore_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Semaphore_instance) { _cached_encoder_for_Semaphore_instance = function (value: Semaphore_instance): _Element {
