...
function _encode_Journal_Entry_instance_eventTransitionRecord (value: Journal_Entry_instance_eventTransitionRecord, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Journal_Entry_instance_eventTransitionRecord) { _cached_encoder_for_Journal_Entry_instance_eventTransitionRecord = function (value: Journal_Entry_instance_eventTransitionRecord): _Element {
