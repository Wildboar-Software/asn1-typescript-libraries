...
function _encode_VMDSupportParameters (value: VMDSupportParameters, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_VMDSupportParameters) { _cached_encoder_for_VMDSupportParameters = function (value: VMDSupportParameters, elGetter: $.ASN1Encoder<VMDSupportParameters>): _Element {
