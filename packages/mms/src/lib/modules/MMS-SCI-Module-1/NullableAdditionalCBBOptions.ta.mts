 ...
 * @description
 * 
 * AdditionalCBBOptions or
 * NULL (unsupported cspi). SCI configuration/initialization encoding (ISO
 * 9506-2:2003 Annex B), not a runtime MMS PDU. ISO 9506-2:2003 Annex B.2.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
