...
function _encode_Unit_Control_instance (value: Unit_Control_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Unit_Control_instance) { _cached_encoder_for_Unit_Control_instance = function (value: Unit_Control_instance, elGetter: $.ASN1Encoder<Unit_Control_instance>): _Element {
