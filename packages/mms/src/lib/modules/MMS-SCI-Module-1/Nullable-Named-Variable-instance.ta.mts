...
function _encode_Nullable_Named_Variable_instance (value: Nullable_Named_Variable_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Nullable_Named_Variable_instance) { _cached_encoder_for_Nullable_Named_Variable_instance = function (value: Nullable_Named_Variable_instance): _Element {
