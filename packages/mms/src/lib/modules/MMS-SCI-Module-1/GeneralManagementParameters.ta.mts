...
function _encode_GeneralManagementParameters (value: GeneralManagementParameters, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_GeneralManagementParameters) { _cached_encoder_for_GeneralManagementParameters = function (value: GeneralManagementParameters, elGetter: $.ASN1Encoder<GeneralManagementParameters>): _Element {
