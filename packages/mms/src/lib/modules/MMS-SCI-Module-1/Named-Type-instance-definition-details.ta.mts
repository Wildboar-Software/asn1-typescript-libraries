...
function _encode_Named_Type_instance_definition_details (value: Named_Type_instance_definition_details, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Named_Type_instance_definition_details) { _cached_encoder_for_Named_Type_instance_definition_details = function (value: Named_Type_instance_definition_details, elGetter: $.ASN1Encoder<Named_Type_instance_definition_details>): _Element {
