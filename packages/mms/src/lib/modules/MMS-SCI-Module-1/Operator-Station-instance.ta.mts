...
function _encode_Operator_Station_instance (value: Operator_Station_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Operator_Station_instance) { _cached_encoder_for_Operator_Station_instance = function (value: Operator_Station_instance, elGetter: $.ASN1Encoder<Operator_Station_instance>): _Element {
