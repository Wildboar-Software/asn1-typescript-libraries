...
function _encode_SCI_Information (value: SCI_Information, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SCI_Information) { _cached_encoder_for_SCI_Information = function (value: SCI_Information, elGetter: $.ASN1Encoder<SCI_Information>): _Element {
