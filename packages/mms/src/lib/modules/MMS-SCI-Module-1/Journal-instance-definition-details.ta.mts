...
function _encode_Journal_instance_definition_details (value: Journal_instance_definition_details, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Journal_instance_definition_details) { _cached_encoder_for_Journal_instance_definition_details = function (value: Journal_instance_definition_details): _Element {
