...
function _encode_Domain_instance (value: Domain_instance, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Domain_instance) { _cached_encoder_for_Domain_instance = function (value: Domain_instance, elGetter: $.ASN1Encoder<Domain_instance>): _Element {
