 ...
 * @description
 * 
 * Inline Event Condition List members in the SCI file. SCI
 * configuration/initialization encoding (ISO 9506-2:2003 Annex B), not a
 * runtime MMS PDU.
 * ISO 9506-2:2003 Annex B.1.15; ISO 9506-1:2003 §22.1.1.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
...
function _encode_Event_Condition_List_instance_definition_details (value: Event_Condition_List_instance_definition_details, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Event_Condition_List_instance_definition_details) { _cached_encoder_for_Event_Condition_List_instance_definition_details = function (value: Event_Condition_List_instance_definition_details): _Element {
