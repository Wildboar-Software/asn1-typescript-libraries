 ...
 */
export
type AP_title_form1 = Name; // DefinedType
 ...
 */
export
function _decode_AP_title_form1 (el: _Element): AP_title_form1 {
    if (!_cached_decoder_for_AP_title_form1) { _cached_decoder_for_AP_title_form1 = _decode_Name; }
 ...
 */
export
function _encode_AP_title_form1 (value: AP_title_form1, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AP_title_form1) { _cached_encoder_for_AP_title_form1 = _encode_Name; }
