...
import { AARE_apdu_protocol_version, AARE_apdu_protocol_version_version1 /* IMPORTED_LONG_NAMED_BIT */, version1 /* IMPORTED_SHORT_NAMED_BIT */, _decode_AARE_apdu_protocol_version, _encode_AARE_apdu_protocol_version } from "../ACSE-1/AARE-apdu-protocol-version.ta.mjs";
// export { AARE_apdu_protocol_version, AARE_apdu_protocol_version_version1 /* IMPORTED_LONG_NAMED_BIT */, version1 /* IMPORTED_SHORT_NAMED_BIT */, _decode_AARE_apdu_protocol_version, _encode_AARE_apdu_protocol_version } from "../ACSE-1/AARE-apdu-protocol-version.ta.mjs";
...
import { Associate_result, Associate_result_accepted /* IMPORTED_LONG_NAMED_INTEGER */, accepted /* IMPORTED_SHORT_NAMED_INTEGER */, Associate_result_rejected_permanent /* IMPORTED_LONG_NAMED_INTEGER */, rejected_permanent /* IMPORTED_SHORT_NAMED_INTEGER */, Associate_result_rejected_transient /* IMPORTED_LONG_NAMED_INTEGER */, rejected_transient /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_Associate_result, _encode_Associate_result } from "../ACSE-1/Associate-result.ta.mjs";
// export { Associate_result, Associate_result_accepted /* IMPORTED_LONG_NAMED_INTEGER */, accepted /* IMPORTED_SHORT_NAMED_INTEGER */, Associate_result_rejected_permanent /* IMPORTED_LONG_NAMED_INTEGER */, rejected_permanent /* IMPORTED_SHORT_NAMED_INTEGER */, Associate_result_rejected_transient /* IMPORTED_LONG_NAMED_INTEGER */, rejected_transient /* IMPORTED_SHORT_NAMED_INTEGER */, _decode_Associate_result, _encode_Associate_result } from "../ACSE-1/Associate-result.ta.mjs";
import { Associate_source_diagnostic, _decode_Associate_source_diagnostic, _encode_Associate_source_diagnostic } from "../ACSE-1/Associate-source-diagnostic.ta.mjs";
// export { Associate_source_diagnostic, _decode_Associate_source_diagnostic, _encode_Associate_source_diagnostic } from "../ACSE-1/Associate-source-diagnostic.ta.mjs";
...
class AARE_apdu {
    ...
    public static _from_object (_o: { [_K in keyof (AARE_apdu)]: (AARE_apdu)[_K] }): AARE_apdu {
        return new AARE_apdu(_o.protocol_version, _o.application_context_name, _o.result, _o.result_source_diagnostic, _o.responding_AP_title, _o.responding_AE_qualifier, _o.responding_AP_invocation_identifier, _o.responding_AE_invocation_identifier, _o.responder_acse_requirements, _o.mechanism_name, _o.responding_authentication_value, _o.application_context_name_list, _o.implementation_information, _o._unrecognizedExtensionsList, _o.user_information);
    }
...
const _root_component_type_list_1_spec_for_AARE_apdu: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("application-context-name-list", true, $.hasTag(_TagClass.context, 11)),
...
function _decode_AARE_apdu (el: _Element): AARE_apdu {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "result": (_el: _Element): void => { result = $._decode_explicit<Associate_result>(() => _decode_Associate_result)(_el); },
...
function _encode_AARE_apdu (value: AARE_apdu, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 2, () => _encode_Associate_result, $.BER)(value.result, $.BER),
            ...
            /* IF_ABSENT  */ ((value.application_context_name_list === undefined) ? undefined : $._encode_implicit(_TagClass.context, 11, () => _encode_Application_context_name_list, $.BER)(value.application_context_name_list, $.BER)),
