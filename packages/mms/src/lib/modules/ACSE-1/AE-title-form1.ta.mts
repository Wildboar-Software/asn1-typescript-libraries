 ...
 */
export
type AE_title_form1 = Name; // DefinedType
 ...
 */
export
function _decode_AE_title_form1 (el: _Element): AE_title_form1 {
    if (!_cached_decoder_for_AE_title_form1) { _cached_decoder_for_AE_title_form1 = _decode_Name; }
 ...
 */
export
function _encode_AE_title_form1 (value: AE_title_form1, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AE_title_form1) { _cached_encoder_for_AE_title_form1 = _encode_Name; }
