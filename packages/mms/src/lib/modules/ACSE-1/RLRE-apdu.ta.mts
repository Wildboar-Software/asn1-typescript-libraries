...
class RLRE_apdu {
    ...
    public static _from_object (_o: { [_K in keyof (RLRE_apdu)]: (RLRE_apdu)[_K] }): RLRE_apdu {
        return new RLRE_apdu(_o.reason, _o._unrecognizedExtensionsList, _o.user_information);
    }
