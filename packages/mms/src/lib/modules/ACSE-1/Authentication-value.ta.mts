...
import { Authentication_value_other, _decode_Authentication_value_other, _encode_Authentication_value_other } from "../ACSE-1/Authentication-value-other.ta.mjs";
// export { Authentication_value_other, _decode_Authentication_value_other, _encode_Authentication_value_other } from "../ACSE-1/Authentication-value-other.ta.mjs";
...
function _decode_Authentication_value (el: _Element): Authentication_value {
    ...
    "CONTEXT 2": [ "external", $._decode_implicit<EXTERNAL>(() => $._decodeExternal) ],
