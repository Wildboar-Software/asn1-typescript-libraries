 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_at_encrypted_mhs_supported_content_types`. Defined in ITU-T
 * X.402 (1999) (Annex A).
 *
 * ### ASN.1 Definition:
 *
 ...
 * @constant
 */
export const id_at_encrypted_mhs_supported_content_types: ID = _OID.fromParts(
    [9, 2],
    id_at
);
