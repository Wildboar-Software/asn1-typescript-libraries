 ...
 * @description
 *
 * `FetchRestrictionError`. Defined in ITU-T X.411 (1999) (accounting objects). SET SIZE
 ...
 */
export function _decode_FetchRestrictionError(el: _Element): FetchRestrictionError {
