 ...
 * @description
 *
 * `BindToken`. A token may be used to convey to the recipient of the token protected
 * security-relevant information. The token provides authentication of public
