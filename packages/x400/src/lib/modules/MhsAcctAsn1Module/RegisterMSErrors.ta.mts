 ...
 * @description
 *
 * `RegisterMSErrors`. The message with instructions detailing the problem encountered.
 * 126 14.2.1.4 Procedure Description 1) The message is checked for presence of the
