 ...
 * @description
 *
 * `DeliveryControlErrors`. The message with instructions detailing the problem
 ...
 */
export function _decode_DeliveryControlErrors(el: _Element): DeliveryControlErrors {
