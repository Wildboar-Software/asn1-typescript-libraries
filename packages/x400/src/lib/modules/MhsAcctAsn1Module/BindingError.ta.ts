...
import {
    ...
    BindingError_integer_authentication_error /* IMPORTED_LONG_NAMED_INTEGER */,
    authentication_error /* IMPORTED_SHORT_NAMED_INTEGER */,
    BindingError_integer_unacceptable_dialogue_mode /* IMPORTED_LONG_NAMED_INTEGER */,
    unacceptable_dialogue_mode /* IMPORTED_SHORT_NAMED_INTEGER */,
    BindingError_integer_unacceptable_security_context /* IMPORTED_LONG_NAMED_INTEGER */,
