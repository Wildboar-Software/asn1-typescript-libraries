 ...
 * @description
 *
 * `BindAuthenticationCheck`. Defined in ITU-T X.411 (1999) (accounting objects).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_BindAuthenticationCheck(el: _Element): BindAuthenticationCheck {
