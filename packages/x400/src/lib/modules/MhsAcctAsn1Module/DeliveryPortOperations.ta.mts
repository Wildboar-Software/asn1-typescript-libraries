 ...
 * @description
 *
 * `DeliveryPortOperations`. Defined in ITU-T X.411 (1999) (accounting objects).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_DeliveryPortOperations(el: _Element): DeliveryPortOperations {
