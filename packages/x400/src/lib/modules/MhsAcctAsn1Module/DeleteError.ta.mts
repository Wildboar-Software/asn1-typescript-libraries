 ...
 * @description
 *
 * `DeleteError`. Defined in ITU-T X.411 (1999) (accounting objects). SET SIZE (1..…):
 * omit this component rather than encode an empty SET; SET order is insignificant.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_DeleteError(el: _Element): DeleteError {
