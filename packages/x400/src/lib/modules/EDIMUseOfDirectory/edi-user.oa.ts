...
import { edi_name } from '../EDIMUseOfDirectory/edi-name.oa';
export { edi_name } from '../EDIMUseOfDirectory/edi-name.oa';
import { edi_routing_address } from '../EDIMUseOfDirectory/edi-routing-address.oa';
export { edi_routing_address } from '../EDIMUseOfDirectory/edi-routing-address.oa';
...
import { id_doc_edi_user } from '../EDIMUseOfDirectory/id-doc-edi-user.va';
export { id_doc_edi_user } from '../EDIMUseOfDirectory/id-doc-edi-user.va';
