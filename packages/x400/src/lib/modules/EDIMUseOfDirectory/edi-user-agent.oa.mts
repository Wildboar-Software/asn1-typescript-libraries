...
export { mhs_user_agent } from '../MHSDirectoryObjectsAndAttributes/mhs-user-agent.oa.mjs';
...
export { id_doc_edi_user_agent } from '../EDIMUseOfDirectory/id-doc-edi-user-agent.va.mjs';
