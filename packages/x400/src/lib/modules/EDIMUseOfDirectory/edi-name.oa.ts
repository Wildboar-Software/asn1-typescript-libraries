...
import { ub_edi_string_size } from '../EDIMSUpperBounds/ub-edi-string-size.va.js';
export { ub_edi_string_size } from '../EDIMSUpperBounds/ub-edi-string-size.va.js';
import { id_dat_edi_name } from '../EDIMUseOfDirectory/id-dat-edi-name.va.js';
export { id_dat_edi_name } from '../EDIMUseOfDirectory/id-dat-edi-name.va.js';
 ...
 */
export const edi_name: ATTRIBUTE<DirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_dat_edi_name /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
