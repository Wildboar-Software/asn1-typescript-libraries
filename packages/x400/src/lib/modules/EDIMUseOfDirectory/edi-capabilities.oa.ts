...
} from '../EDIMUseOfDirectory/EDIUserCapability.ta';
export {
    EDIUserCapability,
    _decode_EDIUserCapability,
    _encode_EDIUserCapability,
...
import { id_dat_edi_capabilities } from '../EDIMUseOfDirectory/id-dat-edi-capabilities.va';
export { id_dat_edi_capabilities } from '../EDIMUseOfDirectory/id-dat-edi-capabilities.va';
