...
import { mhs_message_store } from '../MHSDirectoryObjectsAndAttributes/mhs-message-store.oa.js';
export { mhs_message_store } from '../MHSDirectoryObjectsAndAttributes/mhs-message-store.oa.js';
...
import { id_doc_edi_message_store } from '../EDIMUseOfDirectory/id-doc-edi-message-store.va.js';
export { id_doc_edi_message_store } from '../EDIMUseOfDirectory/id-doc-edi-message-store.va.js';
 ...
 */
export const edi_message_store: OBJECT_CLASS = {
    class: 'OBJECT-CLASS',
    decoderFor: {},
    encoderFor: {},
    '&Superclasses': [mhs_message_store] /* OBJECT_FIELD_SETTING */,
