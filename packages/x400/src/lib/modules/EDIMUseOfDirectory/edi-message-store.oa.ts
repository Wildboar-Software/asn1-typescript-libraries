...
import { mhs_message_store } from '../MHSDirectoryObjectsAndAttributes/mhs-message-store.oa';
export { mhs_message_store } from '../MHSDirectoryObjectsAndAttributes/mhs-message-store.oa';
...
import { id_doc_edi_message_store } from '../EDIMUseOfDirectory/id-doc-edi-message-store.va';
export { id_doc_edi_message_store } from '../EDIMUseOfDirectory/id-doc-edi-message-store.va';
