...
import {
    ...
    _decode_RTTPapdu,
    _encode_RTTPapdu,
} from '../MTSAccessProtocol/RTTPapdu.ta.mjs';
import {
    RTTRapdu,
    _decode_RTTRapdu,
    _encode_RTTRapdu,
} from '../MTSAccessProtocol/RTTRapdu.ta.mjs';
import {
    RTABapdu,
    _decode_RTABapdu,
    _encode_RTABapdu,
} from '../MTSAccessProtocol/RTABapdu.ta.mjs';
/**
 * @summary RTSE_apdus
 * @description
 *
 * `RTSE_apdus`. Defined in ITU-T X.419 (1999) (§8).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
