 ...
 * @description
 *
 * `ContentTypes`. This result indicates the content-types of any messages held by the
 * MTS-user for submission to the MTS due to prevailing controls. It may be generated by
 * the MTS-user. See ITU-T X.411 (1999), §8.2.1.4.2.4. SET OF: order is insignificant;
