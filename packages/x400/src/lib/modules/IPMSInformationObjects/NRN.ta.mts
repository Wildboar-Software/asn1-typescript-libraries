 ...
 * @description
 *
 * `NRN`. The Receive NRN abstract operation receives a message whose content is an NRN.
 * The NRN is provoked by an IPM originated with the Originate IPM abstract operation.
 * See ITU-T X.420 (1999), §12.2.4.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_NRN(el: _Element): NRN {
 ...
 */
export function _encode_NRN(value: NRN, elGetter: $.ASN1Encoder<NRN>): _Element {
