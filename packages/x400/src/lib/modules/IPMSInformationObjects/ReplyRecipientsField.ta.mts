 ...
 * @description
 *
 * `ReplyRecipientsField`. Defined in ITU-T X.420 (1999) (§7). SEQUENCE OF: element order
 ...
 */
export function _decode_ReplyRecipientsField(el: _Element): ReplyRecipientsField {
