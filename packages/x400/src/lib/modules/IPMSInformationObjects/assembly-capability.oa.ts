...
import { id_mst_assembly_capability } from '../IPMSObjectIdentifiers/id-mst-assembly-capability.va';
export { id_mst_assembly_capability } from '../IPMSObjectIdentifiers/id-mst-assembly-capability.va';
