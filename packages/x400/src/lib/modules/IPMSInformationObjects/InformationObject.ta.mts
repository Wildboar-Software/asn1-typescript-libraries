 ...
 * @description
 *
 * `InformationObject`. For the IPMS-MS, the members of the IPMS-attribute-table
 * information object set are regarded as objects populating the
 * Content-specific-attributes information object set defined in 11.3 of 84
 * IPMSAttributeTable ATTRIBUTE ::= { acknowledgment-mode | authorizing-users |
 * auto-forward-comment | auto-forwarded | auto-submitted |
 * bilaterally-defined-body-parts | blind-copy-recipients | body | conversion-eits |… See
