 ...
 * @description
 *
 * `BodyPartReference_stored_body_part`. Defined in ITU-T X.420 (1999) (§7).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_BodyPartReference_stored_body_part(el: _Element): BodyPartReference_stored_body_part {
