 ...
 * @description
 *
 * Information object set `IPMPerRecipientEnvelopeExtensions`. The Extensions heading
 * field (D no extensions (i.e., members)) conveys information accommodated by no other
 * heading field. It comprises a Set of zero or more IPMS extensions each conveying one
 * such information item. See ITU-T X.420 (1999), §7.2.17.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
