...
import { id_mst_prevent_nrn_generation } from '../IPMSObjectIdentifiers/id-mst-prevent-nrn-generation.va';
export { id_mst_prevent_nrn_generation } from '../IPMSObjectIdentifiers/id-mst-prevent-nrn-generation.va';
