 ...
 * @description
 *
 * Information object class `BILATERAL`. This argument contains information intended for
 * MDs which the message will encounter as it is transferred through the MTS. It may be
 * generated by the originating-MD of the message. See ITU-T X.411 (1999), §12.2.1.1.1.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
