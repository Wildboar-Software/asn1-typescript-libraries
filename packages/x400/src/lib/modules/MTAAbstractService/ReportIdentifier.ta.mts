 ...
 * @description
 *
 * `ReportIdentifier`. This argument contains an MTS-identifier that distinguishes the
 * report from all other messages, probes and reports within the MTS. It shall be
 * generated by the originating-MTA of the report. See ITU-T X.411 (1999), §12.2.1.3.1.1.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
