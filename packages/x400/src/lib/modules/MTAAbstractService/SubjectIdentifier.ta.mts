 ...
 * @description
 *
 * `SubjectIdentifier`. This argument contains the message-identifier (or
 * probe-identifier) of the subject (an MTS-identifier). It shall be generated by the
 * originating-MTA of the subject. See ITU-T X.411 (1999), §12.2.1.3.1.3.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
