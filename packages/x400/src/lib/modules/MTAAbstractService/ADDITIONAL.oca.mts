 ...
 * @description
 *
 * Information object class `ADDITIONAL`. The specification of the contents of this
 * argument is by bilateral agreement between MDs. 12.2.1.3.2 Results The Report-transfer
