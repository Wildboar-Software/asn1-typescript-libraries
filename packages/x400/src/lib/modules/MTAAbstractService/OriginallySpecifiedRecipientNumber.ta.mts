 ...
 * @description
 *
 * `OriginallySpecifiedRecipientNumber`. This argument shall be generated by the
 * originating-MTA of the message. A different value of this argument is specified for
 * each originally-specified-recipient of the message. See ITU-T X.411 (1999),
 * §12.2.1.1.1.5.
 *
 * ### ASN.1 Definition:
 *
