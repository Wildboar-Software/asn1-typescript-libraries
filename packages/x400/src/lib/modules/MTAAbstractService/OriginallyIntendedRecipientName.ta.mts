 ...
 * @description
 *
 * `OriginallyIntendedRecipientName`. This argument contains the OR-name of a recipient
 * of the message. It shall be generated by the originator of the message. See ITU-T
 * X.411 (1999), §8.2.1.1.1.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
