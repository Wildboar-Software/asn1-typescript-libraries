 ...
 * @description
 *
 * `PerRecipientReportTransferFields`. Defined in ITU-T X.411 (1999) (§12). SET OF: order
 ...
 */
export function _decode_PerRecipientReportTransferFields(el: _Element): PerRecipientReportTransferFields {
