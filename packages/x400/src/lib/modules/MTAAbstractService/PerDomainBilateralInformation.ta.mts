 ...
 * @description
 *
 * `PerDomainBilateralInformation`. This argument contains information intended for MDs
 * which the message will encounter as it is transferred through the MTS. It may be
