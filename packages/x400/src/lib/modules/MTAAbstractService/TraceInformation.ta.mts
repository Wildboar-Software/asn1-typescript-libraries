 ...
 * @description
 *
 * `TraceInformation`. This argument documents the actions taken on the message (or probe
 * or report) by each MD through which the message (or probe or report) passes as it is
 * transferred through the MTS (see 12.3.1). It shall be generated by each MD through
 * which the message (or probe or report) passes. See ITU-T X.411 (1999), §12.2.1.1.1.3.
