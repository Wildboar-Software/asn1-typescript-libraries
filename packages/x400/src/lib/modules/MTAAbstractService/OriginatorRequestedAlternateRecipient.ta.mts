 ...
 * @description
 *
 * `OriginatorRequestedAlternateRecipient`. This argument contains the OR-name of the
 * alternate-recipient requested by the originator of the message. It may be generated by
 * the originator of the message. See ITU-T X.411 (1999), §8.2.1.1.1.5.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
