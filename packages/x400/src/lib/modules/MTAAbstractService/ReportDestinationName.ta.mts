 ...
 * @description
 *
 * `ReportDestinationName`. This argument contains the OR-name of the immediate
 * destination of the report. It shall be generated by the originating-MTA of the report,
 * and subsequently modified by the DL expansion-points if any DLs had been expanded to
 * add recipients to the subject. See ITU-T X.411 (1999), §12.2.1.3.1.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
