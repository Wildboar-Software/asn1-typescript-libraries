...
export { mta_bind } from '../MTAAbstractService/mta-bind.oa.mjs';
import { mta_unbind } from '../MTAAbstractService/mta-unbind.oa.mjs';
export { mta_unbind } from '../MTAAbstractService/mta-unbind.oa.mjs';
import { id_cp_mta_connect } from '../MTSObjectIdentifiers/id-cp-mta-connect.va.mjs';
export { id_cp_mta_connect } from '../MTSObjectIdentifiers/id-cp-mta-connect.va.mjs';
