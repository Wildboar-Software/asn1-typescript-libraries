 ...
 * @description
 *
 * `MessageOrProbeIdentifier`. This argument contains an MTS-identifier that
 * distinguishes the probe from all other messages, probes and reports within the MTS. It
 * shall be generated by the originating-MTA of the probe, and shall have the same value
 * as the probe-submission-identifier supplied to the originator of the probe when the
 * probe was submitted. See ITU-T X.411 (1999), §12.2.1.2.1.1.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
