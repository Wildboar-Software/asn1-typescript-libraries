 ...
 * @description
 *
 * `MessageIdentifier`. This argument contains an MTS-identifier that distinguishes the
 * message from all other messages, probes and reports within the MTS. It shall be
 * generated by the originating-MTA of the message, and shall have the same value as the
 * message-submission-identifier supplied to the originator of the message when the
 * message was submitted, and the message-delivery-identifier supplied to the recipients
 * of the message when… See ITU-T X.411 (1999), §12.2.1.1.1.1.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
