 ...
 * @description
 *
 * `ReportTransferContent`. This argument contains the information the message is
 * intended to convey to the recipient(s). It shall be generated by the originator of the
 * message. See ITU-T X.411 (1999), §8.2.1.1.1.37. SEQUENCE SIZE (1..…): omit this
