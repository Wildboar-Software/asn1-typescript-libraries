...
import { id_mr_msstring_match } from '../MSObjectIdentifiers/id-mr-msstring-match.va.js';
export { id_mr_msstring_match } from '../MSObjectIdentifiers/id-mr-msstring-match.va.js';
