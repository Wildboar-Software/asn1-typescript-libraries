...
import { id_mr_orname_single_element_match } from '../MSObjectIdentifiers/id-mr-orname-single-element-match.va';
export { id_mr_orname_single_element_match } from '../MSObjectIdentifiers/id-mr-orname-single-element-match.va';
