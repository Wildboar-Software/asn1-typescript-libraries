...
import { id_mr_orname_single_element_match } from '../MSObjectIdentifiers/id-mr-orname-single-element-match.va.js';
export { id_mr_orname_single_element_match } from '../MSObjectIdentifiers/id-mr-orname-single-element-match.va.js';
 ...
 */
export const oRNameSingleElementMatch: MATCHING_RULE<MSString> = {
    class: 'MATCHING-RULE',
    decoderFor: {
