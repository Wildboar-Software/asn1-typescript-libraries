...
import { id_mr_msstring_case_sensitive_match } from '../MSObjectIdentifiers/id-mr-msstring-case-sensitive-match.va';
export { id_mr_msstring_case_sensitive_match } from '../MSObjectIdentifiers/id-mr-msstring-case-sensitive-match.va';
