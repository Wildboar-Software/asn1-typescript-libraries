...
import { id_mr_oraddress_match } from '../MSObjectIdentifiers/id-mr-oraddress-match.va.js';
export { id_mr_oraddress_match } from '../MSObjectIdentifiers/id-mr-oraddress-match.va.js';
