...
} from '../MTSAbstractService/ContentCorrelator.ta.js';
export {
    ContentCorrelator,
    _decode_ContentCorrelator,
    _encode_ContentCorrelator,
} from '../MTSAbstractService/ContentCorrelator.ta.js';
import { id_mr_content_correlator_match } from '../MSObjectIdentifiers/id-mr-content-correlator-match.va.js';
export { id_mr_content_correlator_match } from '../MSObjectIdentifiers/id-mr-content-correlator-match.va.js';
