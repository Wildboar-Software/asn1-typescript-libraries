...
import { id_mr_orname_match } from '../MSObjectIdentifiers/id-mr-orname-match.va.js';
export { id_mr_orname_match } from '../MSObjectIdentifiers/id-mr-orname-match.va.js';
