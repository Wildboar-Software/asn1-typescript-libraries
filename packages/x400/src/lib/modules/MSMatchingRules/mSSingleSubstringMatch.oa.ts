...
import { id_mr_ms_single_substring_match } from '../MSObjectIdentifiers/id-mr-ms-single-substring-match.va';
export { id_mr_ms_single_substring_match } from '../MSObjectIdentifiers/id-mr-ms-single-substring-match.va';
