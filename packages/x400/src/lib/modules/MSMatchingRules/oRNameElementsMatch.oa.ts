...
import { id_mr_orname_elements_match } from '../MSObjectIdentifiers/id-mr-orname-elements-match.va.js';
export { id_mr_orname_elements_match } from '../MSObjectIdentifiers/id-mr-orname-elements-match.va.js';
