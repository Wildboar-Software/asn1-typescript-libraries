...
import { id_mr_oraddress_elements_match } from '../MSObjectIdentifiers/id-mr-oraddress-elements-match.va.js';
export { id_mr_oraddress_elements_match } from '../MSObjectIdentifiers/id-mr-oraddress-elements-match.va.js';
