...
import { id_mr_msstring_list_elements_match } from '../MSObjectIdentifiers/id-mr-msstring-list-elements-match.va';
export { id_mr_msstring_list_elements_match } from '../MSObjectIdentifiers/id-mr-msstring-list-elements-match.va';
