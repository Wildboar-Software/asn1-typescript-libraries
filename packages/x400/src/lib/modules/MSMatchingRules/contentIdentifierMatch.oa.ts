...
import { id_mr_content_identifier_match } from '../MSObjectIdentifiers/id-mr-content-identifier-match.va';
export { id_mr_content_identifier_match } from '../MSObjectIdentifiers/id-mr-content-identifier-match.va';
