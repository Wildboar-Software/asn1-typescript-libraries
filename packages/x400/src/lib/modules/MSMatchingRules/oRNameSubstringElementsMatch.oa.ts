...
import { id_mr_orname_substring_elements_match } from '../MSObjectIdentifiers/id-mr-orname-substring-elements-match.va.js';
export { id_mr_orname_substring_elements_match } from '../MSObjectIdentifiers/id-mr-orname-substring-elements-match.va.js';
