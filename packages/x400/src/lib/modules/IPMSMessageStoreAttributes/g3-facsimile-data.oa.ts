...
import { id_bat_g3_facsimile_data } from '../IPMSObjectIdentifiers/id-bat-g3-facsimile-data.va.js';
export { id_bat_g3_facsimile_data } from '../IPMSObjectIdentifiers/id-bat-g3-facsimile-data.va.js';
