...
import { id_bat_nationally_defined_body_parts } from '../IPMSObjectIdentifiers/id-bat-nationally-defined-body-parts.va';
export { id_bat_nationally_defined_body_parts } from '../IPMSObjectIdentifiers/id-bat-nationally-defined-body-parts.va';
