...
import { id_cat_obsoleted_ipms } from '../IPMSObjectIdentifiers/id-cat-obsoleted-ipms.va.js';
export { id_cat_obsoleted_ipms } from '../IPMSObjectIdentifiers/id-cat-obsoleted-ipms.va.js';
