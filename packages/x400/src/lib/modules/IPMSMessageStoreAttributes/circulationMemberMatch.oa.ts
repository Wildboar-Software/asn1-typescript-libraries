...
import { id_mr_circulation_member } from '../IPMSObjectIdentifiers/id-mr-circulation-member.va';
export { id_mr_circulation_member } from '../IPMSObjectIdentifiers/id-mr-circulation-member.va';
