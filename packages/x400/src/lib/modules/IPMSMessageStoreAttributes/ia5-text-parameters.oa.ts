...
import { id_bat_ia5_text_parameters } from '../IPMSObjectIdentifiers/id-bat-ia5-text-parameters.va.js';
export { id_bat_ia5_text_parameters } from '../IPMSObjectIdentifiers/id-bat-ia5-text-parameters.va.js';
