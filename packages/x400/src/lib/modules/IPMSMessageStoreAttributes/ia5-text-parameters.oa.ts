...
} from '../IPMSInformationObjects/IA5TextParameters.ta';
export {
    IA5TextParameters,
    _decode_IA5TextParameters,
    _encode_IA5TextParameters,
} from '../IPMSInformationObjects/IA5TextParameters.ta';
import { id_bat_ia5_text_parameters } from '../IPMSObjectIdentifiers/id-bat-ia5-text-parameters.va';
export { id_bat_ia5_text_parameters } from '../IPMSObjectIdentifiers/id-bat-ia5-text-parameters.va';
