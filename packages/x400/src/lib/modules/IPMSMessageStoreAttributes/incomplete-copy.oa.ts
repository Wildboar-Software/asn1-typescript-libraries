...
import { id_hat_incomplete_copy } from '../IPMSObjectIdentifiers/id-hat-incomplete-copy.va.js';
export { id_hat_incomplete_copy } from '../IPMSObjectIdentifiers/id-hat-incomplete-copy.va.js';
