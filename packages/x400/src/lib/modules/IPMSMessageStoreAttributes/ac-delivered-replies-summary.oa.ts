...
} from '../IPMSMessageStoreAttributes/DeliveredReplyStatus.ta.js';
export {
    DeliveredReplyStatus,
    DeliveredReplyStatus_no_reply_requested /* IMPORTED_LONG_NAMED_INTEGER */,
    no_reply_requested /* IMPORTED_SHORT_NAMED_INTEGER */,
...
import { id_cat_delivered_replies_summary } from '../IPMSObjectIdentifiers/id-cat-delivered-replies-summary.va.js';
export { id_cat_delivered_replies_summary } from '../IPMSObjectIdentifiers/id-cat-delivered-replies-summary.va.js';
