 ...
 * @description
 *
 * The AC Delivered IPN Summary attribute, which is multi-valued, contains a summary of the
 * IPNs requested of, and generated by, or on behalf of, the AC IPM Recipients of a
 * submitted message. See ITU-T X.420 (1999), §19.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
