...
import { id_mr_or_descriptor_substring_elements } from '../IPMSObjectIdentifiers/id-mr-or-descriptor-substring-elements.va.js';
export { id_mr_or_descriptor_substring_elements } from '../IPMSObjectIdentifiers/id-mr-or-descriptor-substring-elements.va.js';
 ...
 */
export const oRDescriptorSubstringElementsMatch: MATCHING_RULE<ORDescriptor> = {
    class: 'MATCHING-RULE',
    decoderFor: {
