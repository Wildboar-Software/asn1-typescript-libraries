...
} from '../IPMSMessageStoreAttributes/BodyPartDescriptor.ta.js';
export {
    BodyPartDescriptor,
    _decode_BodyPartDescriptor,
    _encode_BodyPartDescriptor,
} from '../IPMSMessageStoreAttributes/BodyPartDescriptor.ta.js';
import { id_sat_body_parts_summary } from '../IPMSObjectIdentifiers/id-sat-body-parts-summary.va.js';
export { id_sat_body_parts_summary } from '../IPMSObjectIdentifiers/id-sat-body-parts-summary.va.js';
