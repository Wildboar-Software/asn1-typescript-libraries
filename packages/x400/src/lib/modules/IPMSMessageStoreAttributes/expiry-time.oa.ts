...
import { id_hat_expiry_time } from '../IPMSObjectIdentifiers/id-hat-expiry-time.va.js';
export { id_hat_expiry_time } from '../IPMSObjectIdentifiers/id-hat-expiry-time.va.js';
