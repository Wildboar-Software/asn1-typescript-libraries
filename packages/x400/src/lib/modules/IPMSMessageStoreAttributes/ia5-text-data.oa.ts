...
import { id_bat_ia5_text_data } from '../IPMSObjectIdentifiers/id-bat-ia5-text-data.va.js';
export { id_bat_ia5_text_data } from '../IPMSObjectIdentifiers/id-bat-ia5-text-data.va.js';
