...
import { id_nat_receipt_time } from '../IPMSObjectIdentifiers/id-nat-receipt-time.va.js';
export { id_nat_receipt_time } from '../IPMSObjectIdentifiers/id-nat-receipt-time.va.js';
