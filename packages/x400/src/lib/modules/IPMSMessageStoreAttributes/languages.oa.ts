...
import {
    ...
    _decode_Language,
    _encode_Language,
} from '../IPMSHeadingExtensions/Language.ta.js';
export {
    Language,
    _decode_Language,
    _encode_Language,
...
import { id_hat_languages } from '../IPMSObjectIdentifiers/id-hat-languages.va.js';
export { id_hat_languages } from '../IPMSObjectIdentifiers/id-hat-languages.va.js';
