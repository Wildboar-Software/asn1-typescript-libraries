...
import { id_cat_submitted_ipns } from '../IPMSObjectIdentifiers/id-cat-submitted-ipns.va';
export { id_cat_submitted_ipns } from '../IPMSObjectIdentifiers/id-cat-submitted-ipns.va';
