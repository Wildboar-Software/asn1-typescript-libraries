...
import { id_hat_precedence_policy_id } from '../IPMSObjectIdentifiers/id-hat-precedence-policy-id.va.js';
export { id_hat_precedence_policy_id } from '../IPMSObjectIdentifiers/id-hat-precedence-policy-id.va.js';
