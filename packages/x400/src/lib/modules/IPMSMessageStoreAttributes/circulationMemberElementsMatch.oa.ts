...
import { id_mr_circulation_member_elements } from '../IPMSObjectIdentifiers/id-mr-circulation-member-elements.va';
export { id_mr_circulation_member_elements } from '../IPMSObjectIdentifiers/id-mr-circulation-member-elements.va';
