...
import { id_cat_ipm_recipients } from '../IPMSObjectIdentifiers/id-cat-ipm-recipients.va.js';
export { id_cat_ipm_recipients } from '../IPMSObjectIdentifiers/id-cat-ipm-recipients.va.js';
