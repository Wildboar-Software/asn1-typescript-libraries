...
} from '../IPMSInformationObjects/CopyRecipientsSubfield.ta.js';
export {
    CopyRecipientsSubfield,
    _decode_CopyRecipientsSubfield,
    _encode_CopyRecipientsSubfield,
...
import { id_hat_copy_recipients } from '../IPMSObjectIdentifiers/id-hat-copy-recipients.va.js';
export { id_hat_copy_recipients } from '../IPMSObjectIdentifiers/id-hat-copy-recipients.va.js';
