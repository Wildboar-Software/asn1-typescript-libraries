...
} from '../IPMSMessageStoreAttributes/IPMEntryType.ta.js';
export {
    IPMEntryType,
    _enum_for_IPMEntryType,
    IPMEntryType_ipm /* IMPORTED_LONG_ENUMERATION_ITEM */,
...
import { id_sat_ipm_entry_type } from '../IPMSObjectIdentifiers/id-sat-ipm-entry-type.va.js';
export { id_sat_ipm_entry_type } from '../IPMSObjectIdentifiers/id-sat-ipm-entry-type.va.js';
