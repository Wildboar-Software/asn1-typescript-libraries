...
} from '../IPMSHeadingExtensions/IPMSecurityLabel.ta.js';
export {
    IPMSecurityLabel,
    _decode_IPMSecurityLabel,
    _encode_IPMSecurityLabel,
} from '../IPMSHeadingExtensions/IPMSecurityLabel.ta.js';
import { id_hat_ipm_security_label } from '../IPMSObjectIdentifiers/id-hat-ipm-security-label.va.js';
export { id_hat_ipm_security_label } from '../IPMSObjectIdentifiers/id-hat-ipm-security-label.va.js';
