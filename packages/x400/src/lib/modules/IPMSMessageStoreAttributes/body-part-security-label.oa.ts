...
import { id_hat_body_part_security_label } from '../IPMSObjectIdentifiers/id-hat-body-part-security-label.va.js';
export { id_hat_body_part_security_label } from '../IPMSObjectIdentifiers/id-hat-body-part-security-label.va.js';
