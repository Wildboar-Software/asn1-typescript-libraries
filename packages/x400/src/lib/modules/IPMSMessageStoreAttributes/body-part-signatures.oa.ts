...
import { id_hat_body_part_signatures } from '../IPMSObjectIdentifiers/id-hat-body-part-signatures.va.js';
export { id_hat_body_part_signatures } from '../IPMSObjectIdentifiers/id-hat-body-part-signatures.va.js';
