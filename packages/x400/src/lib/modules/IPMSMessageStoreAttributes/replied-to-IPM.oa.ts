...
import { id_hat_replied_to_IPM } from '../IPMSObjectIdentifiers/id-hat-replied-to-IPM.va.js';
export { id_hat_replied_to_IPM } from '../IPMSObjectIdentifiers/id-hat-replied-to-IPM.va.js';
