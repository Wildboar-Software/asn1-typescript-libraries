...
import { id_hat_information_category } from '../IPMSObjectIdentifiers/id-hat-information-category.va.js';
export { id_hat_information_category } from '../IPMSObjectIdentifiers/id-hat-information-category.va.js';
