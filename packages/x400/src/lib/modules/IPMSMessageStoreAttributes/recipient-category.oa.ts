...
} from '../IPMSMessageStoreAttributes/RecipientCategory.ta';
export {
    RecipientCategory,
    RecipientCategory_primary_recipient /* IMPORTED_LONG_NAMED_INTEGER */,
    primary_recipient /* IMPORTED_SHORT_NAMED_INTEGER */,
...
import { id_cat_recipient_category } from '../IPMSObjectIdentifiers/id-cat-recipient-category.va';
export { id_cat_recipient_category } from '../IPMSObjectIdentifiers/id-cat-recipient-category.va';
