...
import { id_hat_reply_requestors } from '../IPMSObjectIdentifiers/id-hat-reply-requestors.va.mjs';
export { id_hat_reply_requestors } from '../IPMSObjectIdentifiers/id-hat-reply-requestors.va.mjs';
...
/* START_OF_SYMBOL_DEFINITION reply_requestors */
/**
 ...
 */
export const reply_requestors: X413ATTRIBUTE<ORDescriptor> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_hat_reply_requestors /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
    '&Type': 0 as never /* OBJECT_FIELD_SETTING OBJECT_TYPE_FIELD_SETTING */,
};
/* END_OF_SYMBOL_DEFINITION reply_requestors */
