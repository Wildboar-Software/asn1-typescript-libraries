...
import { id_cat_replying_ipms } from '../IPMSObjectIdentifiers/id-cat-replying-ipms.va';
export { id_cat_replying_ipms } from '../IPMSObjectIdentifiers/id-cat-replying-ipms.va';
