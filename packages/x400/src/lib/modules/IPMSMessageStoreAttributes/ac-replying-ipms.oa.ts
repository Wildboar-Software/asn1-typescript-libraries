...
import { id_cat_replying_ipms } from '../IPMSObjectIdentifiers/id-cat-replying-ipms.va.js';
export { id_cat_replying_ipms } from '../IPMSObjectIdentifiers/id-cat-replying-ipms.va.js';
