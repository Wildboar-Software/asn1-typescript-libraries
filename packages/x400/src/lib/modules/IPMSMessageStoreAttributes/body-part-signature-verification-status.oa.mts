 ...
 * @description
 *
 * Information object `body_part_signature_verification_status`. The-Body Part Signature
 * Verification Status attribute reports the outcome of verification by the IPMS-MS that
 * body parts of a delivered IPM have not been modified in the MTS, if the IPMS-MS has
 * the capability to perform such verification and a signature of the body part was
 * present in the IPM. It is generated by the IPMS-MS. See ITU-T X.420 (1999), §19.6.1.5.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
