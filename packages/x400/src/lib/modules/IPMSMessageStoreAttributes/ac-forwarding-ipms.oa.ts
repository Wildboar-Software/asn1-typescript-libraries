...
import { id_cat_forwarding_ipms } from '../IPMSObjectIdentifiers/id-cat-forwarding-ipms.va';
export { id_cat_forwarding_ipms } from '../IPMSObjectIdentifiers/id-cat-forwarding-ipms.va';
