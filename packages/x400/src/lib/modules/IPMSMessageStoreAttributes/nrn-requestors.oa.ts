...
import { id_hat_nrn_requestors } from '../IPMSObjectIdentifiers/id-hat-nrn-requestors.va.js';
export { id_hat_nrn_requestors } from '../IPMSObjectIdentifiers/id-hat-nrn-requestors.va.js';
