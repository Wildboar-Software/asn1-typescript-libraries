...
import { id_bat_extended_body_part_types } from '../IPMSObjectIdentifiers/id-bat-extended-body-part-types.va.js';
export { id_bat_extended_body_part_types } from '../IPMSObjectIdentifiers/id-bat-extended-body-part-types.va.js';
