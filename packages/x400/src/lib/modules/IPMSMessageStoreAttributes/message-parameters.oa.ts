...
import { id_bat_message_parameters } from '../IPMSObjectIdentifiers/id-bat-message-parameters.va.js';
export { id_bat_message_parameters } from '../IPMSObjectIdentifiers/id-bat-message-parameters.va.js';
