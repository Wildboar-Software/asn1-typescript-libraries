...
import { id_cat_revised_reply_time } from '../IPMSObjectIdentifiers/id-cat-revised-reply-time.va.mjs';
import { type X413ATTRIBUTE } from '../MSAbstractService/X413ATTRIBUTE.oca.mjs';
import { single_valued } from "../MSAbstractService/X413ATTRIBUTE-numeration.ta.mjs";

/**
 * @summary revised_reply_time
 * @description
 *
 * Information object `revised_reply_time`. The Reply Time heading field (O) identifies
 * by when the authorizing users request (but do not demand) that any replies to the
 * present IPM be originated. It comprises a date and time. See ITU-T X.420 (1999),
 * §7.2.12.
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const revised_reply_time: X413ATTRIBUTE<ReplyTimeField> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_cat_revised_reply_time /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
