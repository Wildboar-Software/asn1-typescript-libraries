 ...
 * value. circulationMemberCheckmarkMatch MATCHING-RULE ::= { SYNTAX CirculationMember ID
 * id-mr-circulation-member-checkmark } The rule returns true if, and only if, the
