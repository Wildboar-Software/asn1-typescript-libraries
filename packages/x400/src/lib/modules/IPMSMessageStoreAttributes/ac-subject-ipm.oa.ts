...
import { id_cat_subject_ipm } from '../IPMSObjectIdentifiers/id-cat-subject-ipm.va.js';
export { id_cat_subject_ipm } from '../IPMSObjectIdentifiers/id-cat-subject-ipm.va.js';
