...
import { id_nat_nrn_extensions } from '../IPMSObjectIdentifiers/id-nat-nrn-extensions.va';
export { id_nat_nrn_extensions } from '../IPMSObjectIdentifiers/id-nat-nrn-extensions.va';
