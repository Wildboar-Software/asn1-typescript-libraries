...
import { id_cat_replied_to_ipm } from '../IPMSObjectIdentifiers/id-cat-replied-to-ipm.va';
export { id_cat_replied_to_ipm } from '../IPMSObjectIdentifiers/id-cat-replied-to-ipm.va';
