...
import { id_bat_message_body_parts } from '../IPMSObjectIdentifiers/id-bat-message-body-parts.va.js';
export { id_bat_message_body_parts } from '../IPMSObjectIdentifiers/id-bat-message-body-parts.va.js';
