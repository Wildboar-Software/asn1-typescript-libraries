 ...
 * @description
 *
 * `IPMSynopsis`. The IPM Synopsis attribute gives the structure, characteristics, size,
 * and processing status of an IPM at the granularity of individual body parts.
 * ipm-synopsis ATTRIBUTE ::= { WITH ATTRIBUTE-SYNTAX IPMSynopsis, NUMERATION
 * single-valued, ID id-sat-ipm-synopsis } The synopsis of an IPM comprises a synopsis of
 * each of its body parts. See ITU-T X.420 (1999), §19.6.1.2. SEQUENCE OF: element order
