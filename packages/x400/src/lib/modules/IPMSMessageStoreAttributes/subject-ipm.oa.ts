...
import { id_nat_subject_ipm } from '../IPMSObjectIdentifiers/id-nat-subject-ipm.va.js';
export { id_nat_subject_ipm } from '../IPMSObjectIdentifiers/id-nat-subject-ipm.va.js';
