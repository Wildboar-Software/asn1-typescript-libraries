...
import {
    ...
    _decode_TeletexData,
    _encode_TeletexData,
} from '../IPMSInformationObjects/TeletexData.ta.js';
export {
    TeletexData,
    _decode_TeletexData,
    _encode_TeletexData,
} from '../IPMSInformationObjects/TeletexData.ta.js';
import { id_bat_teletex_data } from '../IPMSObjectIdentifiers/id-bat-teletex-data.va.js';
export { id_bat_teletex_data } from '../IPMSObjectIdentifiers/id-bat-teletex-data.va.js';
import { X413ATTRIBUTE } from '../MSAbstractService/X413ATTRIBUTE.oca.js';
export { X413ATTRIBUTE } from '../MSAbstractService/X413ATTRIBUTE.oca.js';
import { single_valued, multi_valued } from "../MSAbstractService/X413ATTRIBUTE-numeration.ta.js";

/* START_OF_SYMBOL_DEFINITION teletex_data */
/**
...
/* END_OF_SYMBOL_DEFINITION teletex_data */
