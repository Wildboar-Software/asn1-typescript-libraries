...
import { id_nat_conversion_eits } from '../IPMSObjectIdentifiers/id-nat-conversion-eits.va';
export { id_nat_conversion_eits } from '../IPMSObjectIdentifiers/id-nat-conversion-eits.va';
