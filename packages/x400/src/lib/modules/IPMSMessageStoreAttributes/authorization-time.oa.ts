...
import { id_hat_authorization_time } from '../IPMSObjectIdentifiers/id-hat-authorization-time.va.js';
export { id_hat_authorization_time } from '../IPMSObjectIdentifiers/id-hat-authorization-time.va.js';
