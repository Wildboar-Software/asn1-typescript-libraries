...
import { id_hat_importance } from '../IPMSObjectIdentifiers/id-hat-importance.va.js';
export { id_hat_importance } from '../IPMSObjectIdentifiers/id-hat-importance.va.js';
