 ...
 * Category as defined in A.1.10. informationCategoryMatch MATCHING-RULE ::= { SYNTAX
 * InformationCategory ID id-mr-information-category } The rule returns true if, and only
