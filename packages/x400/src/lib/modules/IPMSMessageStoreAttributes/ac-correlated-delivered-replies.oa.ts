...
} from '../IPMSMessageStoreAttributes/CorrelatedDeliveredReplies.ta.js';
export {
    CorrelatedDeliveredReplies,
    _decode_CorrelatedDeliveredReplies,
    _encode_CorrelatedDeliveredReplies,
} from '../IPMSMessageStoreAttributes/CorrelatedDeliveredReplies.ta.js';
import { id_cat_correlated_delivered_replies } from '../IPMSObjectIdentifiers/id-cat-correlated-delivered-replies.va.js';
export { id_cat_correlated_delivered_replies } from '../IPMSObjectIdentifiers/id-cat-correlated-delivered-replies.va.js';
