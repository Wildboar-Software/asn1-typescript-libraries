...
import { id_hat_precedence } from '../IPMSObjectIdentifiers/id-hat-precedence.va.js';
export { id_hat_precedence } from '../IPMSObjectIdentifiers/id-hat-precedence.va.js';
