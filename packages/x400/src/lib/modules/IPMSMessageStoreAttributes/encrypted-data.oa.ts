...
import { id_bat_encrypted_data } from '../IPMSObjectIdentifiers/id-bat-encrypted-data.va';
export { id_bat_encrypted_data } from '../IPMSObjectIdentifiers/id-bat-encrypted-data.va';
