...
import { id_bat_encrypted_data } from '../IPMSObjectIdentifiers/id-bat-encrypted-data.va.js';
export { id_bat_encrypted_data } from '../IPMSObjectIdentifiers/id-bat-encrypted-data.va.js';
