...
import { id_nat_auto_forward_comment } from '../IPMSObjectIdentifiers/id-nat-auto-forward-comment.va.js';
export { id_nat_auto_forward_comment } from '../IPMSObjectIdentifiers/id-nat-auto-forward-comment.va.js';
