...
} from '../IPMSInformationObjects/AuthorizingUsersSubfield.ta';
export {
    AuthorizingUsersSubfield,
    _decode_AuthorizingUsersSubfield,
    _encode_AuthorizingUsersSubfield,
...
import { id_hat_authorizing_users } from '../IPMSObjectIdentifiers/id-hat-authorizing-users.va';
export { id_hat_authorizing_users } from '../IPMSObjectIdentifiers/id-hat-authorizing-users.va';
