...
import { id_hat_extended_subject } from '../IPMSObjectIdentifiers/id-hat-extended-subject.va.js';
export { id_hat_extended_subject } from '../IPMSObjectIdentifiers/id-hat-extended-subject.va.js';
