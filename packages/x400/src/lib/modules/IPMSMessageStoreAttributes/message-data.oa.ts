...
import { id_bat_message_data } from '../IPMSObjectIdentifiers/id-bat-message-data.va.js';
export { id_bat_message_data } from '../IPMSObjectIdentifiers/id-bat-message-data.va.js';
