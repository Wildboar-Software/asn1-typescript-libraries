...
} from '../IPMSHeadingExtensions/AutoSubmitted.ta';
export {
    AutoSubmitted,
    _enum_for_AutoSubmitted,
    AutoSubmitted_not_auto_submitted /* IMPORTED_LONG_ENUMERATION_ITEM */,
...
import { id_hat_auto_submitted } from '../IPMSObjectIdentifiers/id-hat-auto-submitted.va';
export { id_hat_auto_submitted } from '../IPMSObjectIdentifiers/id-hat-auto-submitted.va';
