 ...
 * @description
 *
 * Information object `subject`. The Subject heading field (O) identifies the subject of
 * the IPM. It comprises a Teletex String[ of from zero to a prescribed number of
 * characters (see annex L)|], chosen from the graphic subset of the Teletex String
