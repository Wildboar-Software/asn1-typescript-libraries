...
import { id_cat_forwarded_ipms } from '../IPMSObjectIdentifiers/id-cat-forwarded-ipms.va.js';
export { id_cat_forwarded_ipms } from '../IPMSObjectIdentifiers/id-cat-forwarded-ipms.va.js';
