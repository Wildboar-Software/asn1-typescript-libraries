...
} from '../IPMSInformationObjects/PrimaryRecipientsSubfield.ta.js';
export {
    PrimaryRecipientsSubfield,
    _decode_PrimaryRecipientsSubfield,
    _encode_PrimaryRecipientsSubfield,
...
import { id_hat_primary_recipients } from '../IPMSObjectIdentifiers/id-hat-primary-recipients.va.js';
export { id_hat_primary_recipients } from '../IPMSObjectIdentifiers/id-hat-primary-recipients.va.js';
