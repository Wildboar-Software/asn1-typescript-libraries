...
import { id_bat_teletex_body_parts } from '../IPMSObjectIdentifiers/id-bat-teletex-body-parts.va.js';
export { id_bat_teletex_body_parts } from '../IPMSObjectIdentifiers/id-bat-teletex-body-parts.va.js';
