...
import { id_bat_encrypted_body_parts } from '../IPMSObjectIdentifiers/id-bat-encrypted-body-parts.va';
export { id_bat_encrypted_body_parts } from '../IPMSObjectIdentifiers/id-bat-encrypted-body-parts.va';
