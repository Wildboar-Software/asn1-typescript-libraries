...
import { id_bat_encrypted_body_parts } from '../IPMSObjectIdentifiers/id-bat-encrypted-body-parts.va.js';
export { id_bat_encrypted_body_parts } from '../IPMSObjectIdentifiers/id-bat-encrypted-body-parts.va.js';
