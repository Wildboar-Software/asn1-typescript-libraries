...
} from '../IPMSInformationObjects/BlindCopyRecipientsSubfield.ta.js';
export {
    BlindCopyRecipientsSubfield,
    _decode_BlindCopyRecipientsSubfield,
    _encode_BlindCopyRecipientsSubfield,
...
import { id_hat_blind_copy_recipients } from '../IPMSObjectIdentifiers/id-hat-blind-copy-recipients.va.js';
export { id_hat_blind_copy_recipients } from '../IPMSObjectIdentifiers/id-hat-blind-copy-recipients.va.js';
