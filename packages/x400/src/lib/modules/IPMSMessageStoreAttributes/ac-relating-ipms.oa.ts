...
import { id_cat_relating_ipms } from '../IPMSObjectIdentifiers/id-cat-relating-ipms.va';
export { id_cat_relating_ipms } from '../IPMSObjectIdentifiers/id-cat-relating-ipms.va';
