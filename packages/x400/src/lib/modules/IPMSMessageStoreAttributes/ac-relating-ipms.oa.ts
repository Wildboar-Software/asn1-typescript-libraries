...
import { id_cat_relating_ipms } from '../IPMSObjectIdentifiers/id-cat-relating-ipms.va.js';
export { id_cat_relating_ipms } from '../IPMSObjectIdentifiers/id-cat-relating-ipms.va.js';
