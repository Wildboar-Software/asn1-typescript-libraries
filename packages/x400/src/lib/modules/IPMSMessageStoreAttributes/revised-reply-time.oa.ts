...
import { id_cat_revised_reply_time } from '../IPMSObjectIdentifiers/id-cat-revised-reply-time.va.js';
export { id_cat_revised_reply_time } from '../IPMSObjectIdentifiers/id-cat-revised-reply-time.va.js';
