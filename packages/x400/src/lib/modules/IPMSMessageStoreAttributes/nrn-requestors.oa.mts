...
import { id_hat_nrn_requestors } from '../IPMSObjectIdentifiers/id-hat-nrn-requestors.va.mjs';
export { id_hat_nrn_requestors } from '../IPMSObjectIdentifiers/id-hat-nrn-requestors.va.mjs';
 ...
 */
export const nrn_requestors: X413ATTRIBUTE<ORDescriptor> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
