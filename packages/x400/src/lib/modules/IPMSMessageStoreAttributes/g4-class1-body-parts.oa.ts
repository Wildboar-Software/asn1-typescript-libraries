...
import { id_bat_g4_class1_body_parts } from '../IPMSObjectIdentifiers/id-bat-g4-class1-body-parts.va';
export { id_bat_g4_class1_body_parts } from '../IPMSObjectIdentifiers/id-bat-g4-class1-body-parts.va';
