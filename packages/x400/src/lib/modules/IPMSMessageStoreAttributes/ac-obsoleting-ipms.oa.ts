...
import { id_cat_obsoleting_ipms } from '../IPMSObjectIdentifiers/id-cat-obsoleting-ipms.va';
export { id_cat_obsoleting_ipms } from '../IPMSObjectIdentifiers/id-cat-obsoleting-ipms.va';
