...
import { id_hat_forwarded_content_token } from '../IPMSObjectIdentifiers/id-hat-forwarded-content-token.va';
export { id_hat_forwarded_content_token } from '../IPMSObjectIdentifiers/id-hat-forwarded-content-token.va';
