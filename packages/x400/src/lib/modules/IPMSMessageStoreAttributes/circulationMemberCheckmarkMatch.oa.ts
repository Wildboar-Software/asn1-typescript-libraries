...
import { id_mr_circulation_member_checkmark } from '../IPMSObjectIdentifiers/id-mr-circulation-member-checkmark.va';
export { id_mr_circulation_member_checkmark } from '../IPMSObjectIdentifiers/id-mr-circulation-member-checkmark.va';
