...
import { id_nat_ipm_intended_recipient } from '../IPMSObjectIdentifiers/id-nat-ipm-intended-recipient.va.js';
export { id_nat_ipm_intended_recipient } from '../IPMSObjectIdentifiers/id-nat-ipm-intended-recipient.va.js';
