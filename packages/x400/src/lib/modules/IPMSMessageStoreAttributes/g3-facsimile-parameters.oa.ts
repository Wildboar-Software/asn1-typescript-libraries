...
import { id_bat_g3_facsimile_parameters } from '../IPMSObjectIdentifiers/id-bat-g3-facsimile-parameters.va';
export { id_bat_g3_facsimile_parameters } from '../IPMSObjectIdentifiers/id-bat-g3-facsimile-parameters.va';
