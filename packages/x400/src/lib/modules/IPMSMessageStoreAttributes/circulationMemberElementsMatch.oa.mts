 ...
 * @description
 *
 * The Circulation-member-elements-match determines whether a presented value is a subset
 * of the elements present in some value of an attribute of type Circulation Member. See
 * ITU-T X.420 (1999), §19.
 *
 * ### ASN.1 Definition:
 *
