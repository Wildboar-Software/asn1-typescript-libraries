 ...
 * @description
 *
 * Information object `groupMTAPassword`. The Group MTA Password attribute type contains
 * a password used by members of an unenumerated connection-group. This attribute shall
 * be absent from the connection-group object class if the Enumerated Flag attribute has
 * the value true. See ITU-T X.412 (1999), §7.2.3.3.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
