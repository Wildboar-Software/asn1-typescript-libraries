...
import { id_at_local_exit_connection_group_name } from '../MHSRoutingObjectIdentifiers/id-at-local-exit-connection-group-name.va.js';
export { id_at_local_exit_connection_group_name } from '../MHSRoutingObjectIdentifiers/id-at-local-exit-connection-group-name.va.js';

/* START_OF_SYMBOL_DEFINITION localExitConnectionGroupName */
/**
...
/* END_OF_SYMBOL_DEFINITION localExitConnectionGroupName */
