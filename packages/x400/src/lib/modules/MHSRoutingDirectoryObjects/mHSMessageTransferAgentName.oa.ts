...
import { id_at_mhs_message_transfer_agent } from '../MHSRoutingObjectIdentifiers/id-at-mhs-message-transfer-agent.va';
export { id_at_mhs_message_transfer_agent } from '../MHSRoutingObjectIdentifiers/id-at-mhs-message-transfer-agent.va';
