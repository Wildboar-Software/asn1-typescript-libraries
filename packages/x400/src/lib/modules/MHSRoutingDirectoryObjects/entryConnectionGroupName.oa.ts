...
import { id_at_entry_connection_group_name } from '../MHSRoutingObjectIdentifiers/id-at-entry-connection-group-name.va.js';
export { id_at_entry_connection_group_name } from '../MHSRoutingObjectIdentifiers/id-at-entry-connection-group-name.va.js';
 ...
 */
export const entryConnectionGroupName: ATTRIBUTE = {
    class: 'ATTRIBUTE',
    decoderFor: {
        '&Type': undefined,
    },
    ...
    '&id': id_at_entry_connection_group_name /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
