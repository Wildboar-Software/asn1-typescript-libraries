...
import { id_nf_routing_collective } from '../MHSRoutingObjectIdentifiers/id-nf-routing-collective.va';
export { id_nf_routing_collective } from '../MHSRoutingObjectIdentifiers/id-nf-routing-collective.va';
