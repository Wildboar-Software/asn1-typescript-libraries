...
} from '../MHSRoutingDirectoryObjects/RoutingMTAName.ta.js';
export {
    RoutingMTAName,
    _decode_RoutingMTAName,
    _encode_RoutingMTAName,
} from '../MHSRoutingDirectoryObjects/RoutingMTAName.ta.js';
import { id_at_member_mta } from '../MHSRoutingObjectIdentifiers/id-at-member-mta.va.js';
export { id_at_member_mta } from '../MHSRoutingObjectIdentifiers/id-at-member-mta.va.js';
