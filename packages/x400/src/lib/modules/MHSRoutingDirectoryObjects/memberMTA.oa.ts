...
} from '../MHSRoutingDirectoryObjects/RoutingMTAName.ta';
export {
    RoutingMTAName,
    _decode_RoutingMTAName,
    _encode_RoutingMTAName,
} from '../MHSRoutingDirectoryObjects/RoutingMTAName.ta';
import { id_at_member_mta } from '../MHSRoutingObjectIdentifiers/id-at-member-mta.va';
export { id_at_member_mta } from '../MHSRoutingObjectIdentifiers/id-at-member-mta.va';
