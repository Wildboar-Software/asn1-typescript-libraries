...
import { id_at_mta_password } from '../MHSRoutingObjectIdentifiers/id-at-mta-password.va.mjs';
export { id_at_mta_password } from '../MHSRoutingObjectIdentifiers/id-at-mta-password.va.mjs';

/* START_OF_SYMBOL_DEFINITION mTAPassword */
/**
 * @summary mTAPassword
 * @description
 *
 ...
 */
export const mTAPassword: ATTRIBUTE<Password> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_mta_password /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mTAPassword */
