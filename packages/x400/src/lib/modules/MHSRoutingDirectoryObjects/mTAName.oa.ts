...
import { id_at_mta_name } from '../MHSRoutingObjectIdentifiers/id-at-mta-name.va.js';
export { id_at_mta_name } from '../MHSRoutingObjectIdentifiers/id-at-mta-name.va.js';
