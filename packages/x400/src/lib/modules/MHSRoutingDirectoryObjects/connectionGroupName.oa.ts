...
import { id_at_connection_group_name } from '../MHSRoutingObjectIdentifiers/id-at-connection-group-name.va.js';
export { id_at_connection_group_name } from '../MHSRoutingObjectIdentifiers/id-at-connection-group-name.va.js';
