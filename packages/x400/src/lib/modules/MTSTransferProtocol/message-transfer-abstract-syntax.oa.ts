...
import {
    ...
    _decode_MTS_APDU,
    _encode_MTS_APDU,
} from '../MTSTransferProtocol/MTS-APDU.ta';
export {
    MTS_APDU,
    _decode_MTS_APDU,
    _encode_MTS_APDU,
} from '../MTSTransferProtocol/MTS-APDU.ta';
import { id_as_mtse } from '../MHSProtocolObjectIdentifiers/id-as-mtse.va';
export { id_as_mtse } from '../MHSProtocolObjectIdentifiers/id-as-mtse.va';
