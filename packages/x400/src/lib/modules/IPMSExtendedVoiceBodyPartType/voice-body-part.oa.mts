...
export { voice_body_part_parameters } from '../IPMSExtendedVoiceBodyPartType/voice-body-part-parameters.oa.mjs';
import { voice_body_part_data } from '../IPMSExtendedVoiceBodyPartType/voice-body-part-data.oa.mjs';
export { voice_body_part_data } from '../IPMSExtendedVoiceBodyPartType/voice-body-part-data.oa.mjs';
