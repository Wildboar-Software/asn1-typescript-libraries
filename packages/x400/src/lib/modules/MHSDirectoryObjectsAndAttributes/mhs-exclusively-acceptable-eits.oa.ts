...
} from '../MTSAbstractService/ExtendedEncodedInformationType.ta';
export {
    ExtendedEncodedInformationType,
    _decode_ExtendedEncodedInformationType,
    _encode_ExtendedEncodedInformationType,
...
import { id_at_mhs_exclusively_acceptable_eits } from '../MHSObjectIdentifiers/id-at-mhs-exclusively-acceptable-eits.va';
export { id_at_mhs_exclusively_acceptable_eits } from '../MHSObjectIdentifiers/id-at-mhs-exclusively-acceptable-eits.va';

/* START_OF_SYMBOL_DEFINITION mhs_exclusively_acceptable_eits */
/**
 ...
 */
export const mhs_exclusively_acceptable_eits: ATTRIBUTE<ExtendedEncodedInformationType> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_mhs_exclusively_acceptable_eits /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mhs_exclusively_acceptable_eits */
