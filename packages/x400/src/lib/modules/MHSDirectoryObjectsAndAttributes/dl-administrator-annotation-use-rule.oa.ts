...
import { dl_administrator_annotation } from '../MHSDirectoryObjectsAndAttributes/dl-administrator-annotation.oa';
export { dl_administrator_annotation } from '../MHSDirectoryObjectsAndAttributes/dl-administrator-annotation.oa';
