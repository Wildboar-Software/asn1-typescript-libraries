...
import {
    ...
    _decode_DLPolicy,
    _encode_DLPolicy,
} from '../MHSDirectoryObjectsAndAttributes/DLPolicy.ta';
export {
    DLPolicy,
    _decode_DLPolicy,
    _encode_DLPolicy,
} from '../MHSDirectoryObjectsAndAttributes/DLPolicy.ta';
import { id_at_mhs_dl_policy } from '../MHSObjectIdentifiers/id-at-mhs-dl-policy.va';
export { id_at_mhs_dl_policy } from '../MHSObjectIdentifiers/id-at-mhs-dl-policy.va';
