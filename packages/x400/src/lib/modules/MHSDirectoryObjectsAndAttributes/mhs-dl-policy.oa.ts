...
import {
    ...
    _decode_DLPolicy,
    _encode_DLPolicy,
} from '../MHSDirectoryObjectsAndAttributes/DLPolicy.ta.js';
export {
    DLPolicy,
    _decode_DLPolicy,
    _encode_DLPolicy,
} from '../MHSDirectoryObjectsAndAttributes/DLPolicy.ta.js';
import { id_at_mhs_dl_policy } from '../MHSObjectIdentifiers/id-at-mhs-dl-policy.va.js';
export { id_at_mhs_dl_policy } from '../MHSObjectIdentifiers/id-at-mhs-dl-policy.va.js';
