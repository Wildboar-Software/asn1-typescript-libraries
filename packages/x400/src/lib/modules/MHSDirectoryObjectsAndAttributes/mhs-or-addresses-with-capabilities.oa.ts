...
} from '../MHSDirectoryObjectsAndAttributes/AddressCapabilities.ta.js';
export {
    AddressCapabilities,
    _decode_AddressCapabilities,
    _encode_AddressCapabilities,
} from '../MHSDirectoryObjectsAndAttributes/AddressCapabilities.ta.js';
import { addressCapabilitiesMatch } from '../MHSDirectoryObjectsAndAttributes/addressCapabilitiesMatch.oa.js';
export { addressCapabilitiesMatch } from '../MHSDirectoryObjectsAndAttributes/addressCapabilitiesMatch.oa.js';
import { id_at_mhs_or_addresses_with_capabilities } from '../MHSObjectIdentifiers/id-at-mhs-or-addresses-with-capabilities.va.js';
export { id_at_mhs_or_addresses_with_capabilities } from '../MHSObjectIdentifiers/id-at-mhs-or-addresses-with-capabilities.va.js';
