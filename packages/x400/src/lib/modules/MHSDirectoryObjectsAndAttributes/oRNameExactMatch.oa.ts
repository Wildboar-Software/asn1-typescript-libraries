...
import { id_mr_orname_exact_match } from '../MHSObjectIdentifiers/id-mr-orname-exact-match.va.js';
export { id_mr_orname_exact_match } from '../MHSObjectIdentifiers/id-mr-orname-exact-match.va.js';
