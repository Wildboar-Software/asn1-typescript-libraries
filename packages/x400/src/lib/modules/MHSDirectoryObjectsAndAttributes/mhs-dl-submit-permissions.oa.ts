...
} from '../MHSDirectoryObjectsAndAttributes/DLSubmitPermission.ta.js';
export {
    DLSubmitPermission,
    _decode_DLSubmitPermission,
    _encode_DLSubmitPermission,
} from '../MHSDirectoryObjectsAndAttributes/DLSubmitPermission.ta.js';
import { id_at_mhs_dl_submit_permissions } from '../MHSObjectIdentifiers/id-at-mhs-dl-submit-permissions.va.js';
export { id_at_mhs_dl_submit_permissions } from '../MHSObjectIdentifiers/id-at-mhs-dl-submit-permissions.va.js';
