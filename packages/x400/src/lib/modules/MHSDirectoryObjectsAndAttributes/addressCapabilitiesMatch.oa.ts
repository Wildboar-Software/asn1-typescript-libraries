...
import { id_mr_address_capabilities_match } from '../MHSObjectIdentifiers/id-mr-address-capabilities-match.va';
export { id_mr_address_capabilities_match } from '../MHSObjectIdentifiers/id-mr-address-capabilities-match.va';
