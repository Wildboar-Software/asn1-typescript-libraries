...
import { id_at_mhs_message_store_dn } from '../MHSObjectIdentifiers/id-at-mhs-message-store-dn.va';
export { id_at_mhs_message_store_dn } from '../MHSObjectIdentifiers/id-at-mhs-message-store-dn.va';
