 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_mod_forwarded_content_body_part_type`. Defined in ITU-T X.420
 * (1999) (Annex A).
 *
 * ### ASN.1 Definition:
 *
 ...
 * @constant
 */
export const id_mod_forwarded_content_body_part_type: ID = _OID.fromParts(
    [15],
    id_mod
);
