 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_bat_mixed_mode_body_parts`. The IPM Body Part Table information
 ...
 * @constant
 */
export const id_bat_mixed_mode_body_parts: ID = _OID.fromParts([9], id_bat);
