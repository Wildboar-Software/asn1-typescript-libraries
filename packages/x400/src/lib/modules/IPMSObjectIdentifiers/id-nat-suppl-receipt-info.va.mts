 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_nat_suppl_receipt_info`. The Suppl Receipt Info receipt field
 * (O) gives supplementary information about the receipt of the subject IPM by the RN's
