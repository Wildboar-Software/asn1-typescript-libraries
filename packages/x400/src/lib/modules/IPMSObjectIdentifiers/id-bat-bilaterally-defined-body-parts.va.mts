 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_bat_bilaterally_defined_body_parts`. The IPM Body Part Table
 ...
 * @constant
 */
export const id_bat_bilaterally_defined_body_parts: ID = _OID.fromParts([10], id_bat);
