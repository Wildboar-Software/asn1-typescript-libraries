 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_sat_body_parts_summary`. The Body Parts Summary attribute, which
 * is multi-valued, provides a summary of the body parts present in an IPM. One value of
