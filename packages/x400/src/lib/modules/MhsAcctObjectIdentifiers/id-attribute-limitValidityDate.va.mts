 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_limitValidityDate`. Defined in ITU-T X.411 (1999)
 * (accounting objects).
 *
 * ### ASN.1 Definition:
 *
 ...
 * @constant
 */
export const id_attribute_limitValidityDate: ID = _OID.fromParts([56], id_attribute);
