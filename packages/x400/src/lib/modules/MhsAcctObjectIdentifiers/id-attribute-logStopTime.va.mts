 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_logStopTime`. A Time parameter is specified in terms
 ...
 * @constant
 */
export const id_attribute_logStopTime: ID = _OID.fromParts([60], id_attribute);
