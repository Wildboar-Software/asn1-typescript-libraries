 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_name_binding_customer_mdServiceManagementPointOfAccess`. Defined
 * in ITU-T X.411 (1999) (accounting objects).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 * @constant
 */
export const id_name_binding_customer_mdServiceManagementPointOfAccess: ID = _OID.fromParts(
    [4],
    id_name_binding
);
