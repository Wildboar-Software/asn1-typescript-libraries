 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_serviceRequestId`. Defined in ITU-T X.411 (1999)
 * (accounting objects).
 *
 * ### ASN.1 Definition:
 *
 ...
 * @constant
 */
export const id_attribute_serviceRequestId: ID = _OID.fromParts([115], id_attribute);
