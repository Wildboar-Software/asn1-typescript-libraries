 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_operationTime`. A Time parameter is specified in terms
 ...
 * @constant
 */
export const id_attribute_operationTime: ID = _OID.fromParts([78], id_attribute);
