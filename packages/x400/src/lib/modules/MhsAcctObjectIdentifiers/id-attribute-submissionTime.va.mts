 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_submissionTime`. A Time parameter is specified in
 ...
 * @constant
 */
export const id_attribute_submissionTime: ID = _OID.fromParts([68], id_attribute);
