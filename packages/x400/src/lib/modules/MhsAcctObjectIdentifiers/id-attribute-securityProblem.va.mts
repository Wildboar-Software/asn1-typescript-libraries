 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_securityProblem`. Defined in ITU-T X.411 (1999)
 * (accounting objects).
 *
 * ### ASN.1 Definition:
 *
 ...
 * @constant
 */
export const id_attribute_securityProblem: ID = _OID.fromParts([112], id_attribute);
