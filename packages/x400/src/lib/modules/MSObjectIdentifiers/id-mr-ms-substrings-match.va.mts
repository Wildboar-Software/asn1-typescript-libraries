 ...
 * mSSubstringsMatch MATCHING-RULE ::= { SYNTAX SubstringAssertion ID
 * id-mr-ms-substrings-match } SubstringAssertion ::= SEQUENCE OF CHOICE { initial [0]
 * MSString {ub-msstring-match}, any [1] MSString {ub-msstring-match}, final [2]… See
