...
import { delivery_control_88 } from '../MTSAbstractService88/delivery-control-88.oa';
export { delivery_control_88 } from '../MTSAbstractService88/delivery-control-88.oa';
