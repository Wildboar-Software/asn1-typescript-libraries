...
import { ub_extended_subject_length } from '../IPMSUpperBounds/ub-extended-subject-length.va.js';
export { ub_extended_subject_length } from '../IPMSUpperBounds/ub-extended-subject-length.va.js';
