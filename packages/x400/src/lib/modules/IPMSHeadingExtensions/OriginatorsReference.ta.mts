...
import { ub_originators_reference_length } from '../IPMSUpperBounds/ub-originators-reference-length.va.mjs';
export { ub_originators_reference_length } from '../IPMSUpperBounds/ub-originators-reference-length.va.mjs';
