 ...
 * @description
 *
 * `Checkmark`. The Circulation-member-checkmark-match rule compares a presented value
 * with attribute-values of type Circulation Member for the presence of the checked
 * component value.  The rule returns true if,
