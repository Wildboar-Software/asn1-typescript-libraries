...
import { ub_alpha_code_length } from '../IPMSUpperBounds/ub-alpha-code-length.va.mjs';
export { ub_alpha_code_length } from '../IPMSUpperBounds/ub-alpha-code-length.va.mjs';
