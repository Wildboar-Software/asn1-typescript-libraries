...
} from '../IPMSHeadingExtensions/CirculationList.ta.js';
export {
    CirculationList,
    _decode_CirculationList,
    _encode_CirculationList,
} from '../IPMSHeadingExtensions/CirculationList.ta.js';
import { id_hex_circulation_list_recipients } from '../IPMSObjectIdentifiers/id-hex-circulation-list-recipients.va.js';
export { id_hex_circulation_list_recipients } from '../IPMSObjectIdentifiers/id-hex-circulation-list-recipients.va.js';
