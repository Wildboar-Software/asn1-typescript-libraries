...
} from '../IPMSHeadingExtensions/ManualHandlingInstructions.ta';
export {
    ManualHandlingInstructions,
    _decode_ManualHandlingInstructions,
    _encode_ManualHandlingInstructions,
} from '../IPMSHeadingExtensions/ManualHandlingInstructions.ta';
import { id_hex_manual_handling_instructions } from '../IPMSObjectIdentifiers/id-hex-manual-handling-instructions.va';
export { id_hex_manual_handling_instructions } from '../IPMSObjectIdentifiers/id-hex-manual-handling-instructions.va';
