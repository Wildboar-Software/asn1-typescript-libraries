...
import {
    ...
    _decode_Precedence,
    _encode_Precedence,
} from '../IPMSHeadingExtensions/Precedence.ta';
export {
    Precedence,
    _decode_Precedence,
    _encode_Precedence,
} from '../IPMSHeadingExtensions/Precedence.ta';
import { id_rex_precedence } from '../IPMSObjectIdentifiers/id-rex-precedence.va';
export { id_rex_precedence } from '../IPMSObjectIdentifiers/id-rex-precedence.va';
