 ...
 * `additional-body-parts`. Additional parts are a SEQUENCE; order is the
 * originator's order. Omit `additional-body-parts` rather than encode empty.
 * This is not an IPM `Body` (X.420 §7.3).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
