 ...
 * @description
 *
 * `InterchangeControlReferenceField`. Defined in ITU-T X.435 (1999) (§8).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_InterchangeControlReferenceField(el: _Element): InterchangeControlReferenceField {
