 ...
 * follows: edi-submission-options EDIM-EXTENSION ::= { VALUE EDISubmissionOptions,
 * IDENTIFIED BY id-ext-submission-options } EDISubmissionOptions ::= SET {
 * assembly-instructions [0]… See ITU-T X.435 (1999), §18.6.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
