 ...
 * @description
 *
 * `ReportingDLName`. This argument contains the OR-name of the DL that forwarded the
 * report to the owner of the DL. It shall be generated by a DL-expansion-point (an MTA)
 * when forwarding a report to the owner of the DL, in line with the reporting-policy of
 * the DL. See ITU-T X.411 (1999), §8.3.1.2.1.4.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
