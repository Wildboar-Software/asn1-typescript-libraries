 ...
 * @description
 *
 * `Token`. This argument contains the token associated with the message. It may be
 * generated by the originator of the message. See ITU-T X.411 (1999), §8.2.1.1.1.26.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
