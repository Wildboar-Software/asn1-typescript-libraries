 ...
 * @description
 *
 * Information object `delivery`. The Cancel-deferred-delivery abstract-operation enables
 * an MTS-user to abort the deferred-delivery of a message previously submitted by that
 * user via the Message-submission abstract-operation. The MTS-user identifies the
 * message whose delivery is to be cancelled by means of the
