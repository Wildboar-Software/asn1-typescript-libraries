 ...
 * @description
 *
 * Information object `proof_of_delivery_request`. This argument indicates whether or not
 * the originator of the message requires proof-of-delivery (to provide the Proof of
 * Delivery element-of-service as defined in recipient of the message. This argument may
 * have one of the following values: proof-of-delivery-requested or
