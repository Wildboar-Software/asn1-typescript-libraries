 ...
 * @description
 *
 * `WaitingMessages`. This result indicates the kind of messages the MTS-user is holding
 * for submission to the MTS, and would submit via the Message-submission
 * abstract-operation, if it were not for the prevailing controls. It may be generated by
 * the MTS- user. See ITU-T X.411 (1999), §8.2.1.4.2.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
