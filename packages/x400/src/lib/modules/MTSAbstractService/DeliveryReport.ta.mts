 ...
 * @description
 *
 * `DeliveryReport`. This argument indicates the type of physical-delivery-report
 * requested by the originator of the message. It may be generated by the originator of
 * the message if the requested-delivery-method argument specifies that physical-delivery
 * is required to the recipient or if the originator of the message supplied a
 * postal-OR-address for the recipient. See ITU-T X.411 (1999), §8.2.1.1.1.24. ASN.1
 * DEFAULT `public`: that value is assumed when the component is absent (do not encode
