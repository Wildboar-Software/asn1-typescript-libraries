 ...
 * @description
 *
 * This argument indicates whether DL-expansion within the MTS shall occur for any
 * recipient-name which denotes a DL. It may be generated by the originator of the message.
 * See ITU-T X.411 (1999), §8.2.1.1.1.6.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
