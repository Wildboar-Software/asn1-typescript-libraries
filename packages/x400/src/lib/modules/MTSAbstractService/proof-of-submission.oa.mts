 ...
 * @description
 *
 * Information object `proof_of_submission`. This result provides the originator of the
 * message with proof of submission of the message to the MTS (to provide the Proof of
 * Submission element-of-service as defined in Submission element-of-service (as defined
 * in The proof-of-submission is computed using the algorithm identified by the
