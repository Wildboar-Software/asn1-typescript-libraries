 ...
 * @description
 *
 * This argument identifies the encoded-information-types of the message content after
 * conversion, if conversion took place. It may be generated by the MTS. See ITU-T X.411
 * (1999), §8.3.1.1.1.8.
 *
 * ### ASN.1 Definition:
 *
