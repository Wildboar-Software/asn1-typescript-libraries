 ...
 * @description
 *
 * `UserAddress`. This argument contains the user-address of the MTS-user, if it is
 * required by the MTS and if it is to be changed. It may be generated by the MTS-user.
 * See ITU-T X.411 (1999), §8.4.1.1.1.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
