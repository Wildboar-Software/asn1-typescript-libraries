 ...
 * @description
 *
 * Information object `redirection_history`. This argument documents the redirection
 * events which have occurred during the transfer of the message through the MTS. It
 * shall be generated by the MTS if redirection has occurred. See ITU-T X.411 (1999),
 * §8.3.1.1.1.5.
 *
 * ### ASN.1 Definition:
 *
