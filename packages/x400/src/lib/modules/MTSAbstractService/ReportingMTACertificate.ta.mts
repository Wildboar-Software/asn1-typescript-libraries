 ...
 * @description
 *
 * `ReportingMTACertificate`. This argument contains the certificate of the MTA that
 * generated the report. It shall be generated by a trusted source (e.g., a
 * certification-authority), and may be supplied by the reporting-MTA if a
