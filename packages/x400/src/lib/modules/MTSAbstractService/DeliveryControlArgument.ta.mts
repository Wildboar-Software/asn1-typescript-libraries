 ...
 * @description
 *
 * `DeliveryControlArgument`. The default control arguments are the same as the arguments
 * of the Delivery-control abstract-operation, and are defined in 8.3.1.3.1. Except for
 * restrict and permissible-security-context, they may be generated by the MTS-user. See
 * ITU-T X.411 (1999), §8.4.1.1.1.7. SET OF: order is insignificant; duplicates are
