...
import { ub_unformatted_address_length } from '../MTSUpperBounds/ub-unformatted-address-length.va.js';
export { ub_unformatted_address_length } from '../MTSUpperBounds/ub-unformatted-address-length.va.js';
