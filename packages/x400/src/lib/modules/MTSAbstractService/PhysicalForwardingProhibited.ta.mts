 ...
 * @description
 *
 * `PhysicalForwardingProhibited`. This argument indicates whether physical-forwarding of
 * the message is prohibited. It may be generated by the originator of the message if the
 * requested-delivery-method argument specifies that physical-delivery is required to the
 * recipient, or if the originator of the message supplied a postal-OR-address for the
 * recipient. See ITU-T X.411 (1999), §8.2.1.1.1.15. ENUMERATED value `0` is a named
