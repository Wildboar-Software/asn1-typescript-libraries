 ...
 * @description
 *
 * This argument indicates whether physical-forwarding of the message is prohibited. It may
 * be generated by the originator of the message if the requested-delivery-method argument
