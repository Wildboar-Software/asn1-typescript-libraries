 ...
 * messages at the delivery-port. It shall be generated by the MTS, and shall have the same
 * value as the message-submission-identifier supplied to the originator of the message
 * when the message was submitted. See ITU-T X.411 (1999), §8.3.1.1.1.1.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
