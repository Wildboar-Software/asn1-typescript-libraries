...
/* START_OF_SYMBOL_DEFINITION MessageClassExtensions */
/**
 * @summary MessageClassExtensions
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 *
 */
export const MessageClassExtensions: EXTENSION[] = [...PrivateExtensions];
/* END_OF_SYMBOL_DEFINITION MessageClassExtensions */
