 ...
 * @description
 *
 * `SecurityContext`. This argument identifies the security-context that the initiator of
 * the association proposes to operate at. It may be generated by the initiator of the
 * association. See ITU-T X.411 (1999), §8.1.1.1.1.3. SET SIZE (1..…): omit this
