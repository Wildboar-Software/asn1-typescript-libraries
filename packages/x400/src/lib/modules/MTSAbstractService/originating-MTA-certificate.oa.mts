 ...
 * @description
 *
 * Information object `originating_MTA_certificate`. This result contains the certificate
 * of the MTA to which the message has been submitted (the originating-MTA). It shall be
 * generated by a trusted source (e.g., a certification-authority), and may be supplied
 * by the originating-MTA, if the originator of the message requested proof-of-submission
 * (see 8.2.1.1.1.31) and an asymmetric-encryption-algorithm is used to compute the
