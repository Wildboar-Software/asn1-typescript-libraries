 ...
 * @description
 *
 * `DeliveredOriginatorName`. This argument contains the OR-name of the originator of the
 * message. It shall be generated by the originating MTS- user. See ITU-T X.411 (1999),
 * §8.2.1.1.1.1.
 *
 * ### ASN.1 Definition:
 *
