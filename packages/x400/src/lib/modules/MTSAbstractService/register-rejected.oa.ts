...
import { err_register_rejected } from '../MTSAccessProtocol/err-register-rejected.va';
export { err_register_rejected } from '../MTSAccessProtocol/err-register-rejected.va';
