...
import { err_register_rejected } from '../MTSAccessProtocol/err-register-rejected.va.js';
export { err_register_rejected } from '../MTSAccessProtocol/err-register-rejected.va.js';
