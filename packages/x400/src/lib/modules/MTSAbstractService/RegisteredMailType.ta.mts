 ...
 * @description
 *
 * This argument indicates the type of registered mail service to be used to physically
 * deliver the message to the recipient. It may be generated by the originator of the
 * message if the requested-delivery-method argument specifies that physical-delivery is
 * required to the recipient, or if the originator of the message supplied a
 * postal-OR-address for the recipient. See ITU-T X.411 (1999), §8.2.1.1.1.18.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
