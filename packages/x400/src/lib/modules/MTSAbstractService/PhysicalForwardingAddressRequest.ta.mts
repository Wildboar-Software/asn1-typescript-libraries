 ...
 * @description
 *
 * This argument indicates whether the physical-forwarding-address of the recipient is to
 * be returned in the report. It may be generated by the originator of the message if the
 ...
 * recipient. See ITU-T X.411 (1999), §8.2.1.1.1.16.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
