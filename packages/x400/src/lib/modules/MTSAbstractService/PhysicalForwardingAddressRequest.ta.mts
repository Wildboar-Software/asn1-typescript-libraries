 ...
 * @description
 *
 * `PhysicalForwardingAddressRequest`. This argument indicates whether the
 * physical-forwarding-address of the recipient is to be returned in the report. It may
 * be generated by the originator of the message if the requested-delivery-method
 ...
 * X.411 (1999), §8.2.1.1.1.16. ENUMERATED value `0` is a named variant, not a sentinel
