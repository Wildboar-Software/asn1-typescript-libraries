...
} from '../MTSAbstractService/CancelDeferredDeliveryArgument.ta.js';
export {
    CancelDeferredDeliveryArgument,
    _decode_CancelDeferredDeliveryArgument,
    _encode_CancelDeferredDeliveryArgument,
...
} from '../MTSAbstractService/CancelDeferredDeliveryResult.ta.js';
export {
    CancelDeferredDeliveryResult,
    _decode_CancelDeferredDeliveryResult,
    _encode_CancelDeferredDeliveryResult,
} from '../MTSAbstractService/CancelDeferredDeliveryResult.ta.js';
import { deferred_delivery_cancellation_rejected } from '../MTSAbstractService/deferred-delivery-cancellation-rejected.oa.js';
export { deferred_delivery_cancellation_rejected } from '../MTSAbstractService/deferred-delivery-cancellation-rejected.oa.js';
import { message_submission_identifier_invalid } from '../MTSAbstractService/message-submission-identifier-invalid.oa.js';
export { message_submission_identifier_invalid } from '../MTSAbstractService/message-submission-identifier-invalid.oa.js';
...
import { op_cancel_deferred_delivery } from '../MTSAccessProtocol/op-cancel-deferred-delivery.va.js';
export { op_cancel_deferred_delivery } from '../MTSAccessProtocol/op-cancel-deferred-delivery.va.js';
