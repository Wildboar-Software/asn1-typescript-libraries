...
import { err_inconsistent_request } from '../MTSAccessProtocol/err-inconsistent-request.va';
export { err_inconsistent_request } from '../MTSAccessProtocol/err-inconsistent-request.va';
