 ...
 * @description
 *
 * Information object `physical_forwarding_prohibited`. This argument indicates whether
 * physical-forwarding of the message is prohibited. It may be generated by the
 ...
 * supplied a postal-OR-address for the recipient. See ITU-T X.411 (1999), §8.2.1.1.1.15.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
