 ...
 * @description
 *
 * `ProofOfDeliveryRequest`. This argument indicates whether or not the originator of the
 * message requires proof-of-delivery (to provide the Proof of Delivery
 * element-of-service as defined in recipient of the message. This argument may have one
 * of the following values: proof-of-delivery-requested or proof-of-delivery-not-
 * requested. See ITU-T X.411 (1999), §8.2.1.1.1.32. ENUMERATED value `0` is a named
