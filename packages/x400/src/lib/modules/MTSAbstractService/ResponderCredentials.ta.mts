 ...
 * @description
 *
 * `ResponderCredentials`. This argument contains the credentials of the responder of the
 * association. It shall be generated by the responder of the association. See ITU-T
 * X.411 (1999), §8.1.1.1.2.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
