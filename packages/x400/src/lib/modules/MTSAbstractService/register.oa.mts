 ...
 * @description
 *
 * Information object `register`. The Register abstract-operation enables an MTS-user to
 * make long-term changes to various parameters of the MTS-user held by the MTS concerned
 * with delivery of messages to the MTS-user, and to retrieve the current settings of
 * these parameters. Such changes remain in effect until overridden by re-invocation of
 * the Register abstract-operation. See ITU-T X.411 (1999), §8.4.1.1.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
