...
import { err_old_credentials_incorrectly_specified } from '../MTSAccessProtocol/err-old-credentials-incorrectly-specified.va.mjs';
export { err_old_credentials_incorrectly_specified } from '../MTSAccessProtocol/err-old-credentials-incorrectly-specified.va.mjs';
 ...
 */
export const old_credentials_incorrectly_specified: ABSTRACT_ERROR<NULL> = {
    class: 'ERROR',
    decoderFor: {
    ...
    '&errorCode': err_old_credentials_incorrectly_specified /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
