 ...
 * @description
 *
 * This component indicates the encoded-information-types that the MTS shall permit to
 * appear in messages delivered to the MTS-user, if they are to be constrained within a
 * deliverable-class. The component comprises acceptable-encoded-information-types,
