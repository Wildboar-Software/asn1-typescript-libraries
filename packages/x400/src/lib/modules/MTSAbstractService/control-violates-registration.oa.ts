...
import { err_control_violates_registration } from '../MTSAccessProtocol/err-control-violates-registration.va';
export { err_control_violates_registration } from '../MTSAccessProtocol/err-control-violates-registration.va';
