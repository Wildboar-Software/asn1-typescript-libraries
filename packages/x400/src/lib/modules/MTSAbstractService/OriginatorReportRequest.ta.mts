 ...
 * @description
 *
 * `OriginatorReportRequest`. This argument indicates the kind of report requested by the
 * originator of the message. It shall be generated by the originator of the message. See
 * ITU-T X.411 (1999), §8.2.1.1.1.22.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
