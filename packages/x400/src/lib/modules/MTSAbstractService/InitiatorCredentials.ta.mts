 ...
 * @description
 *
 * `InitiatorCredentials`. This argument contains the credentials of the initiator of the
 * association. It shall be generated by the initiator of the association. See ITU-T
 * X.411 (1999), §8.1.1.1.1.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
