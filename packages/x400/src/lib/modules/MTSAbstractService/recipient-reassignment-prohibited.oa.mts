 ...
 * @description
 *
 * Information object `recipient_reassignment_prohibited`. This argument indicates
 * whether the message may be reassigned to another MTS-user registered as a recipient-
 * assigned-alternate-recipient by the intended-recipient. It may be generated by the
 * originator of the message. See ITU-T X.411 (1999), §8.2.1.1.1.4.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
