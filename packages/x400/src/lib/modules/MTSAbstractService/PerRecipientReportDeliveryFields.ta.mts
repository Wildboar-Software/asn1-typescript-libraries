 ...
 * @description
 *
 * `PerRecipientReportDeliveryFields`. Defined in ITU-T X.411 (1999) (§8). SET OF: order
 ...
 */
export function _decode_PerRecipientReportDeliveryFields(el: _Element): PerRecipientReportDeliveryFields {
