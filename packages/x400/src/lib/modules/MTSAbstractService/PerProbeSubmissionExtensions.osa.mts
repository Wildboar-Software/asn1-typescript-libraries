...
import { recipient_reassignment_prohibited } from "./recipient-reassignment-prohibited.oa.mjs";
 ...
 * @description
 *
 * Information object set `PerProbeSubmissionExtensions`. Defined in ITU-T X.411 (1999)
 * (§8).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 * PerProbeSubmissionExtensions EXTENSION ::= {-- May contain the following extensions, private extensions, and future standardised extensions,
 ...
 *
 */
export const PerProbeSubmissionExtensions: EXTENSION[] = [
