 ...
 * @description
 *
 * `PerRecipientProbeSubmissionFields`. Defined in ITU-T X.411 (1999) (§8). SET OF: order
 ...
 *
 */
export class PerRecipientProbeSubmissionFields {
    constructor(
        /**
    ...
    /**
     * @summary Restructures an object into a PerRecipientProbeSubmissionFields
     * @description
     *
     * This takes an `object` and converts it to a `PerRecipientProbeSubmissionFields`.
     *
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `PerRecipientProbeSubmissionFields`.
     * @returns {PerRecipientProbeSubmissionFields}
     */
    public static _from_object(
        _o: {
            [_K in keyof PerRecipientProbeSubmissionFields]: PerRecipientProbeSubmissionFields[_K];
        }
    ): PerRecipientProbeSubmissionFields {
        return new PerRecipientProbeSubmissionFields(
            _o.recipient_name,
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_PerRecipientProbeSubmissionFields: $.ComponentSpec[] = [
    new $.ComponentSpec(
        'recipient-name',
        false,
 ...
 * @returns {PerRecipientProbeSubmissionFields} The decoded data structure.
 */
export function _decode_PerRecipientProbeSubmissionFields(el: _Element): PerRecipientProbeSubmissionFields {
    if (!_cached_decoder_for_PerRecipientProbeSubmissionFields) {
        _cached_decoder_for_PerRecipientProbeSubmissionFields = function (
            el: _Element
        ): PerRecipientProbeSubmissionFields {
            ...
            let extensions: OPTIONAL<ExtensionField[]> =
                PerRecipientProbeSubmissionFields._default_value_for_extensions;
            ...
            $._parse_set(
                el,
                callbacks,
                _root_component_type_list_1_spec_for_PerRecipientProbeSubmissionFields,
                _extension_additions_list_spec_for_PerRecipientProbeSubmissionFields,
                _root_component_type_list_2_spec_for_PerRecipientProbeSubmissionFields,
                undefined
            );
            return new PerRecipientProbeSubmissionFields /* SET_CONSTRUCTOR_CALL */(
                recipient_name,
 ...
 */
export function _encode_PerRecipientProbeSubmissionFields(
    value: PerRecipientProbeSubmissionFields,
    elGetter: $.ASN1Encoder<PerRecipientProbeSubmissionFields>
): _Element {
    if (!_cached_encoder_for_PerRecipientProbeSubmissionFields) {
        _cached_encoder_for_PerRecipientProbeSubmissionFields = function (
            value: PerRecipientProbeSubmissionFields        ): _Element {
            return $._encodeSet(
    ...
    return _cached_encoder_for_PerRecipientProbeSubmissionFields(
        value,
        elGetter
    );
}
