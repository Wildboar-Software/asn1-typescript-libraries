 ...
 * @description
 *
 * Information object `dl_expansion_history`. This argument contains the sequence of
 * OR-names of any DLs which have been expanded to add recipients to the copy of the
 * message delivered to the recipient and the Time of each expansion. It shall be
