 ...
 * @description
 *
 * Information object `latest_delivery_time`. This argument contains the Time after which
 * the message should not be delivered to the recipient(s). It may be generated by the
 * originator of the message. See ITU-T X.411 (1999), §8.2.1.1.1.13.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
