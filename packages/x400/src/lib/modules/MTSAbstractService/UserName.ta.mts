 ...
 * @description
 *
 * `UserName`. This argument contains the OR-name of the MTS-user, if the user-name is to
 * be changed. It may be generated by the MTS-user. See ITU-T X.411 (1999), §8.4.1.1.1.1.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
