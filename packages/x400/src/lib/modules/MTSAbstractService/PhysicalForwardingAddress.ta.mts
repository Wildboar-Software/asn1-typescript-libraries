 ...
 * @description
 *
 * This argument contains the new postal-OR-address of the physical-recipient of the
 * message. It may be generated by the associated PDAU of the originating-MTA of the
 * report, if the originator of the message requested the physical-forwarding-address of
 * the recipient (see 8.2.1.1.1.16). See ITU-T X.411 (1999), §8.3.1.2.1.8.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
