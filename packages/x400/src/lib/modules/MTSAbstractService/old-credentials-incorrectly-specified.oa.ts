...
import { err_old_credentials_incorrectly_specified } from '../MTSAccessProtocol/err-old-credentials-incorrectly-specified.va';
export { err_old_credentials_incorrectly_specified } from '../MTSAccessProtocol/err-old-credentials-incorrectly-specified.va';
