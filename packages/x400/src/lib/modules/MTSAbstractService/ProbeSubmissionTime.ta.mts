 ...
 * @description
 *
 * `ProbeSubmissionTime`. This result indicates the Time at which the MTS agreed to
 * undertake the probe. It shall be generated by the MTS. See ITU-T X.411 (1999),
 * §8.2.1.2.2.2.
 *
 * ### ASN.1 Definition:
 *
