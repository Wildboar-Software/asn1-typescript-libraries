 ...
 * @description
 *
 * `RecipientCertificate`. This argument contains a certificate of the recipient of the
 * message and optionally its certification path. The certificate shall be generated by a
 * trusted source (e.g. See ITU-T X.411 (1999), §8.2.1.1.1.42.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
