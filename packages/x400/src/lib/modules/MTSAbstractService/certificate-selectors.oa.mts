 ...
 * within the message-origin-authentication-check, content-integrity-check, or
 * message-token arguments, or to be used for key agreement for encryption. See ITU-T X.411
 * (1999), §8.2.1.1.1.43.
 *
 * ### ASN.1 Definition:
 *
