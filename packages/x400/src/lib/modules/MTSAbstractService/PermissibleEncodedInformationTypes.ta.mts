 ...
 * @description
 *
 * This argument indicates the encoded-information-types that shall appear in messages that
 * the MTS shall deliver to the MTS-user via the Message-delivery abstract-operation. It
 * may be generated by the MTS-user. See ITU-T X.411 (1999), §8.3.1.3.1.4.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
