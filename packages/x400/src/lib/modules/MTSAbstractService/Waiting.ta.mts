 ...
 * @description
 *
 * `Waiting`. This argument indicates the number of messages and total number of octets
 * waiting to be delivered by the MTS to the MTS-user, for each priority. It may be
 * generated by the initiator of the association. See ITU-T X.411 (1999), §8.1.1.1.1.4.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
