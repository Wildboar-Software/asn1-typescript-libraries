 ...
 * @description
 *
 * `TypeOfMTSUser`. This argument indicates the type of recipient MTS-user to which the
 * message was (or would have been) delivered. It shall be generated by the MTS if the
 * message was (or would have been) successfully delivered. See ITU-T X.411 (1999),
 * §8.3.1.2.1.10.
 *
 * ### ASN.1 Definition:
 *
