...
import { err_submission_control_violated } from '../MTSAccessProtocol/err-submission-control-violated.va.js';
export { err_submission_control_violated } from '../MTSAccessProtocol/err-submission-control-violated.va.js';
