 ...
 * @description
 *
 * `MessageSubmissionResult`. Defined in ITU-T X.411 (1999) (§8). SET OF: order is
 ...
 */
export function _decode_MessageSubmissionResult(el: _Element): MessageSubmissionResult {
