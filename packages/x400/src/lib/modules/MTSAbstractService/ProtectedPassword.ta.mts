 ...
 * @description
 *
 * `ProtectedPassword`. A password comprises either an IA5 String or an Octet String.
 * Where the octets of an Octet String value are the encoding in an 8-bit environment of
 * the characters of an IA5 String value, the choice between the IA5 String and the Octet
