 ...
 * @description
 *
 * One: critical for submission. Zero: non-critical for submission. An unrecognized
 * extension marked critical for a step shall cause that step to fail.
 *
 * @constant
 */
 ...
 * @description
 *
 * One: critical for transfer. Zero: non-critical for transfer.
 *
 * @constant
 */
 ...
 * @description
 *
 * One: critical for delivery. Zero: non-critical for delivery.
 *
 * @constant
 */
