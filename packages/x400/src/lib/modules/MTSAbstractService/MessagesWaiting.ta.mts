 ...
 * @description
 *
 * `MessagesWaiting`. This argument indicates the number of messages and total number of
 * octets waiting to be delivered by the MTS to the MTS-user, for each priority. It may
