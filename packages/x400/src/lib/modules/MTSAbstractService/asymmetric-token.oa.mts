 ...
 * @description
 *
 * Information object `asymmetric_token`. A token may be used to convey to the recipient
 * of the token protected security-relevant information. The token provides
