 ...
 * @description
 *
 * `NonDeliveryDiagnosticCode`. This argument contains a code indicating the nature of
 * the problem which caused delivery or probing of delivery of the subject-message, to
 * fail. It may be generated by the MTS if the message was (or would have been)
 * unsuccessfully delivered. See ITU-T X.411 (1999), §8.3.1.2.1.12.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
