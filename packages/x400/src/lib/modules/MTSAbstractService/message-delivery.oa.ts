...
} from '../MTSAbstractService/MessageDeliveryArgument.ta.js';
export {
    MessageDeliveryArgument,
    _decode_MessageDeliveryArgument,
    _encode_MessageDeliveryArgument,
...
} from '../MTSAbstractService/MessageDeliveryResult.ta.js';
export {
    MessageDeliveryResult,
    _decode_MessageDeliveryResult,
    _encode_MessageDeliveryResult,
...
import { op_message_delivery } from '../MTSAccessProtocol/op-message-delivery.va.js';
export { op_message_delivery } from '../MTSAccessProtocol/op-message-delivery.va.js';
