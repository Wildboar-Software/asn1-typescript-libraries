 ...
 * @description
 *
 * This result contains an MTS-identifier that uniquely and unambiguously identifies the
 * message-submission. It shall be generated by the MTS. See ITU-T X.411 (1999),
 * §8.2.1.1.2.1.
 *
 * ### ASN.1 Definition:
 *
