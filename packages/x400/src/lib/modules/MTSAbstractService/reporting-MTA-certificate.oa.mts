 ...
 * @description
 *
 * Information object `reporting_MTA_certificate`. This argument contains the certificate
 * of the MTA that generated the report. It shall be generated by a trusted source (e.g.,
 * a certification-authority), and may be supplied by the reporting-MTA if a
 * report-origin-authentication-check is supplied. See ITU-T X.411 (1999), §8.3.1.2.1.13.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
