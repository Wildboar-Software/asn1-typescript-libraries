 ...
 * @description
 *
 * This argument contains the postal-OR-address of the originator of the message. It may be
 * generated by the originator of the message if the requested-delivery-method argument
 * specifies that physical-delivery is required to one or more recipients of the message,
 * or if the originator of the message supplied one or more postal-OR-addresses for the
 * recipients. See ITU-T X.411 (1999), §8.2.1.1.1.21.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
