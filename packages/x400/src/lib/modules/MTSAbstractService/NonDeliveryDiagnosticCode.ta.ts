...
let _cached_decoder_for_NonDeliveryDiagnosticCode: $.ASN1Decoder<NonDeliveryDiagnosticCode> | null = null;
...
/**
 * @summary Decodes an ASN.1 element into a(n) NonDeliveryDiagnosticCode
 * @function
 * @param {_Element} el The element being decoded.
 * @returns {NonDeliveryDiagnosticCode} The decoded data structure.
 */
export function _decode_NonDeliveryDiagnosticCode(el: _Element) {
    if (!_cached_decoder_for_NonDeliveryDiagnosticCode) {
        _cached_decoder_for_NonDeliveryDiagnosticCode = $._decodeInteger;
    }
    return _cached_decoder_for_NonDeliveryDiagnosticCode(el);
}
...
let _cached_encoder_for_NonDeliveryDiagnosticCode: $.ASN1Encoder<NonDeliveryDiagnosticCode> | null = null;
 ...
 */
export function _encode_NonDeliveryDiagnosticCode(
    value: NonDeliveryDiagnosticCode,
    elGetter: $.ASN1Encoder<NonDeliveryDiagnosticCode>
) {
    if (!_cached_encoder_for_NonDeliveryDiagnosticCode) {
        _cached_encoder_for_NonDeliveryDiagnosticCode = $._encodeInteger;
    }
    return _cached_encoder_for_NonDeliveryDiagnosticCode(value, elGetter);
}
