 ...
 * @description
 *
 * `CancelDeferredDeliveryArgument`. Defined in ITU-T X.411 (1999) (§8).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_CancelDeferredDeliveryArgument(el: _Element): CancelDeferredDeliveryArgument {
