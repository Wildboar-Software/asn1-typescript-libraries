 ...
 * @description
 *
 * Information object `dl_expansion_prohibited`. This argument indicates whether
 * DL-expansion within the MTS shall occur for any recipient-name which denotes a DL. It
