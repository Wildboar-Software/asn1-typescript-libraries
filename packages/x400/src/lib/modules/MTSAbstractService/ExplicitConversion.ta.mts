 ...
 * @description
 *
 * This argument indicates the type of conversion of the message content explicitly
 * requested by the originator for the recipient. It may be generated by the originator of
 * the message. See ITU-T X.411 (1999), §8.2.1.1.1.11.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
