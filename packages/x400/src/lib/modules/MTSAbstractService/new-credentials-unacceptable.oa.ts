...
import { err_new_credentials_unacceptable } from '../MTSAccessProtocol/err-new-credentials-unacceptable.va.js';
export { err_new_credentials_unacceptable } from '../MTSAccessProtocol/err-new-credentials-unacceptable.va.js';
