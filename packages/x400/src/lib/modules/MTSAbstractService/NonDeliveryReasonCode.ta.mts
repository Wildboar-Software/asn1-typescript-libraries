 ...
 * @description
 *
 * This argument contains a code indicating the reason the delivery of the subject-message
 * failed (or, in the case of a probe, would have failed). It shall be generated by the MTS
