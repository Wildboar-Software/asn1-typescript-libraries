 ...
 * @description
 *
 * `NonDeliveryReasonCode`. This argument contains a code indicating the reason the
 * delivery of the subject-message failed (or, in the case of a probe, would have
 * failed). It shall be generated by the MTS if the message was (or would have been)
 * unsuccessfully delivered. See ITU-T X.411 (1999), §8.3.1.2.1.11.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
