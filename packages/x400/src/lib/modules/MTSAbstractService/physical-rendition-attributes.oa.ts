...
} from '../MTSAbstractService/PhysicalRenditionAttributes.ta';
export {
    PhysicalRenditionAttributes,
    _decode_PhysicalRenditionAttributes,
    _encode_PhysicalRenditionAttributes,
} from '../MTSAbstractService/PhysicalRenditionAttributes.ta';
import { id_att_physicalRendition_basic } from '../MTSObjectIdentifiers/id-att-physicalRendition-basic.va';
export { id_att_physicalRendition_basic } from '../MTSObjectIdentifiers/id-att-physicalRendition-basic.va';
