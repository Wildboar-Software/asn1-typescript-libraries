...
} from '../MTSAbstractService/PhysicalRenditionAttributes.ta.js';
export {
    PhysicalRenditionAttributes,
    _decode_PhysicalRenditionAttributes,
    _encode_PhysicalRenditionAttributes,
} from '../MTSAbstractService/PhysicalRenditionAttributes.ta.js';
import { id_att_physicalRendition_basic } from '../MTSObjectIdentifiers/id-att-physicalRendition-basic.va.js';
export { id_att_physicalRendition_basic } from '../MTSObjectIdentifiers/id-att-physicalRendition-basic.va.js';
