 ...
 * @description
 *
 * This argument indicates the preferred method of delivery of the message to the
 * recipient. It may be generated by the originator of the message. See ITU-T X.411 (1999),
 * §8.2.1.1.1.14.
 *
 * ### ASN.1 Definition:
 *
