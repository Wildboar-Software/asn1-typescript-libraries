 ...
 * @description
 *
 * This argument contains the Time at which delivery occurs and at which the MTS is
 * relinquishing responsibility for the message. It shall be generated by the MTS. See
 * ITU-T X.411 (1999), §8.3.1.1.1.2.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
