 ...
 * @description
 *
 * `SupplementaryInformation`. This argument may contain information supplied by the
 * originator of the report, as a printable string. It may be generated by the
