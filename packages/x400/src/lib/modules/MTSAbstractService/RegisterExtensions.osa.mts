...
/* START_OF_SYMBOL_DEFINITION RegisterExtensions */
/**
 * @summary RegisterExtensions
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 *
 */
export const RegisterExtensions: EXTENSION[] = [...PrivateExtensions];
/* END_OF_SYMBOL_DEFINITION RegisterExtensions */
