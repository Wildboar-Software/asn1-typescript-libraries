 ...
 * @description
 *
 * The Operation-refused abstract-error indicates that the MTS has refused to perform an
 * operation due to local policy. The Operation-refused error has two parameters, the
 * refused-argument and the refusal-reason, generated by the MTS. See ITU-T X.411 (1999),
 * §8.3.2.5.
 *
 * ### ASN.1 Definition:
 *
