 ...
 * @description
 *
 * `OriginatorCertificate`. This argument contains a certificate of the originator of the
 * message. It shall be generated by a trusted source (e.g., a certification-authority),
 * and may be supplied by the originator of the message. See ITU-T X.411 (1999),
 * §8.2.1.1.1.25.
 *
 * ### ASN.1 Definition:
 *
