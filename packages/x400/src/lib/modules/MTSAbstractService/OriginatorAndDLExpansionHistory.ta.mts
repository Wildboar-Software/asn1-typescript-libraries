 ...
 * @description
 *
 * `OriginatorAndDLExpansionHistory`. This argument contains the sequence of OR-names of
 * any DLs which have been expanded to add recipients to the copy of the message
 * delivered to the recipient and the Time of each expansion. It shall be generated by
 * the MTS if any DL-expansion has occurred. See ITU-T X.411 (1999), §8.3.1.1.1.7.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
