...
export { videotex_body_part_parameters } from '../IPMSExtendedBodyPartTypes/videotex-body-part-parameters.oa.mjs';
import { videotex_body_part_data } from '../IPMSExtendedBodyPartTypes/videotex-body-part-data.oa.mjs';
export { videotex_body_part_data } from '../IPMSExtendedBodyPartTypes/videotex-body-part-data.oa.mjs';
