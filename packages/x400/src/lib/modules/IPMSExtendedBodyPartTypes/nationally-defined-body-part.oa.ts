...
import { nationally_defined_body_part_data } from '../IPMSExtendedBodyPartTypes/nationally-defined-body-part-data.oa.js';
export { nationally_defined_body_part_data } from '../IPMSExtendedBodyPartTypes/nationally-defined-body-part-data.oa.js';
