...
import { g4_class1_body_part_data } from '../IPMSExtendedBodyPartTypes/g4-class1-body-part-data.oa.js';
export { g4_class1_body_part_data } from '../IPMSExtendedBodyPartTypes/g4-class1-body-part-data.oa.js';
