...
export { teletex_body_part_parameters } from '../IPMSExtendedBodyPartTypes/teletex-body-part-parameters.oa.mjs';
import { teletex_body_part_data } from '../IPMSExtendedBodyPartTypes/teletex-body-part-data.oa.mjs';
export { teletex_body_part_data } from '../IPMSExtendedBodyPartTypes/teletex-body-part-data.oa.mjs';
