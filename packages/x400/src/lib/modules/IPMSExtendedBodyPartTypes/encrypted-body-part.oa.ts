...
import { encrypted_body_part_parameters } from '../IPMSExtendedBodyPartTypes/encrypted-body-part-parameters.oa';
export { encrypted_body_part_parameters } from '../IPMSExtendedBodyPartTypes/encrypted-body-part-parameters.oa';
import { encrypted_body_part_data } from '../IPMSExtendedBodyPartTypes/encrypted-body-part-data.oa';
export { encrypted_body_part_data } from '../IPMSExtendedBodyPartTypes/encrypted-body-part-data.oa';
