...
export { encrypted_body_part_parameters } from '../IPMSExtendedBodyPartTypes/encrypted-body-part-parameters.oa.mjs';
import { encrypted_body_part_data } from '../IPMSExtendedBodyPartTypes/encrypted-body-part-data.oa.mjs';
export { encrypted_body_part_data } from '../IPMSExtendedBodyPartTypes/encrypted-body-part-data.oa.mjs';
