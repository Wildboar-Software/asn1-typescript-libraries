...
import { videotex_body_part_parameters } from '../IPMSExtendedBodyPartTypes/videotex-body-part-parameters.oa.js';
export { videotex_body_part_parameters } from '../IPMSExtendedBodyPartTypes/videotex-body-part-parameters.oa.js';
import { videotex_body_part_data } from '../IPMSExtendedBodyPartTypes/videotex-body-part-data.oa.js';
export { videotex_body_part_data } from '../IPMSExtendedBodyPartTypes/videotex-body-part-data.oa.js';
