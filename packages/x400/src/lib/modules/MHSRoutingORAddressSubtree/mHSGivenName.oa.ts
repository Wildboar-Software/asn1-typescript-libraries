...
import { id_oc_mhs_given_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-given-name.va.js';
export { id_oc_mhs_given_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-given-name.va.js';
