...
export { mHSGivenName } from '../MHSRoutingORAddressSubtree/mHSGivenName.oa.mjs';
...
export { id_nf_mhs_given_name } from '../MHSRoutingObjectIdentifiers/id-nf-mhs-given-name.va.mjs';
