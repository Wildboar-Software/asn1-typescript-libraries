...
import { ub_domain_name_length } from '../MTSUpperBounds/ub-domain-name-length.va.js';
export { ub_domain_name_length } from '../MTSUpperBounds/ub-domain-name-length.va.js';
import { id_at_mhs_admd_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-admd-name.va.js';
export { id_at_mhs_admd_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-admd-name.va.js';

/* START_OF_SYMBOL_DEFINITION mHSADMDName */
/**
 * @summary mHSADMDName
 * @description
 *
 ...
 */
export const mHSADMDName: ATTRIBUTE<DirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_mhs_admd_name /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mHSADMDName */
