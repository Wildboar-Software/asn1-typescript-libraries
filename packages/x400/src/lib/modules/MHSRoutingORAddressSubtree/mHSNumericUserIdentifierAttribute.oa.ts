...
import { ub_numeric_user_id_length } from '../MTSUpperBounds/ub-numeric-user-id-length.va.js';
export { ub_numeric_user_id_length } from '../MTSUpperBounds/ub-numeric-user-id-length.va.js';
import { id_at_mhs_numeric_user_identifier } from '../MHSRoutingObjectIdentifiers/id-at-mhs-numeric-user-identifier.va.js';
export { id_at_mhs_numeric_user_identifier } from '../MHSRoutingObjectIdentifiers/id-at-mhs-numeric-user-identifier.va.js';

/* START_OF_SYMBOL_DEFINITION mHSNumericUserIdentifierAttribute */
/**
...
/* END_OF_SYMBOL_DEFINITION mHSNumericUserIdentifierAttribute */
