...
import { id_oc_mhs_initials } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-initials.va.js';
export { id_oc_mhs_initials } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-initials.va.js';
