...
import { id_oc_mhs_terminal_type } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-terminal-type.va';
export { id_oc_mhs_terminal_type } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-terminal-type.va';
