...
import { id_oc_mhs_common_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-common-name.va.js';
export { id_oc_mhs_common_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-common-name.va.js';
