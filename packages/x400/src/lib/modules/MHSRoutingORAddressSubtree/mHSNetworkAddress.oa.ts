...
import { id_oc_mhs_network_address } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-network-address.va.js';
export { id_oc_mhs_network_address } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-network-address.va.js';
