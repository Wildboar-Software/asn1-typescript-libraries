...
import { id_oc_mhs_extended_network_address } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-extended-network-address.va';
export { id_oc_mhs_extended_network_address } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-extended-network-address.va';
