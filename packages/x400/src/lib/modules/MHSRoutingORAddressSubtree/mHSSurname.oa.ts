...
import { id_oc_mhs_surname } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-surname.va';
export { id_oc_mhs_surname } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-surname.va';
