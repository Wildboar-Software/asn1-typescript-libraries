...
import { id_oc_mhs_terminal_identifier } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-terminal-identifier.va';
export { id_oc_mhs_terminal_identifier } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-terminal-identifier.va';
