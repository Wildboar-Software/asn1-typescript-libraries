...
import { ub_pds_name_length } from '../MTSUpperBounds/ub-pds-name-length.va.js';
export { ub_pds_name_length } from '../MTSUpperBounds/ub-pds-name-length.va.js';
import { id_at_mhs_pds_name_attribute } from '../MHSRoutingObjectIdentifiers/id-at-mhs-pds-name-attribute.va.js';
export { id_at_mhs_pds_name_attribute } from '../MHSRoutingObjectIdentifiers/id-at-mhs-pds-name-attribute.va.js';

/* START_OF_SYMBOL_DEFINITION mHSPDSNameAttribute */
/**
 ...
 */
export const mHSPDSNameAttribute: ATTRIBUTE<DirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_mhs_pds_name_attribute /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mHSPDSNameAttribute */
