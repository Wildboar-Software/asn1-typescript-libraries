...
import { ub_postal_code_length } from '../MTSUpperBounds/ub-postal-code-length.va';
export { ub_postal_code_length } from '../MTSUpperBounds/ub-postal-code-length.va';
import { id_at_mhs_postal_code } from '../MHSRoutingObjectIdentifiers/id-at-mhs-postal-code.va';
export { id_at_mhs_postal_code } from '../MHSRoutingObjectIdentifiers/id-at-mhs-postal-code.va';
