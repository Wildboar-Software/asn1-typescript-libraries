...
import { ub_postal_code_length } from '../MTSUpperBounds/ub-postal-code-length.va.js';
export { ub_postal_code_length } from '../MTSUpperBounds/ub-postal-code-length.va.js';
import { id_at_mhs_postal_code } from '../MHSRoutingObjectIdentifiers/id-at-mhs-postal-code.va.js';
export { id_at_mhs_postal_code } from '../MHSRoutingObjectIdentifiers/id-at-mhs-postal-code.va.js';

/* START_OF_SYMBOL_DEFINITION mHSPostalCodeAttribute */
/**
 ...
 */
export const mHSPostalCodeAttribute: ATTRIBUTE<DirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_mhs_postal_code /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mHSPostalCodeAttribute */
