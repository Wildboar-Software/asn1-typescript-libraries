...
import { id_at_mhs_organization_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-organization-name.va';
export { id_at_mhs_organization_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-organization-name.va';
