...
import { ub_country_name_numeric_length } from '../MTSUpperBounds/ub-country-name-numeric-length.va.js';
export { ub_country_name_numeric_length } from '../MTSUpperBounds/ub-country-name-numeric-length.va.js';
import { id_at_mhs_country_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-country-name.va.js';
export { id_at_mhs_country_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-country-name.va.js';
 ...
 */
export const mHSCountryName: ATTRIBUTE<DirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_mhs_country_name /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
