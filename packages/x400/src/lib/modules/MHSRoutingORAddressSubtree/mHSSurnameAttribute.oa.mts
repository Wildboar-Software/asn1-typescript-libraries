...
import { ub_surname_length } from '../MTSUpperBounds/ub-surname-length.va.mjs';
export { ub_surname_length } from '../MTSUpperBounds/ub-surname-length.va.mjs';
import { id_at_mhs_surname } from '../MHSRoutingObjectIdentifiers/id-at-mhs-surname.va.mjs';
export { id_at_mhs_surname } from '../MHSRoutingObjectIdentifiers/id-at-mhs-surname.va.mjs';

/* START_OF_SYMBOL_DEFINITION mHSSurnameAttribute */
/**
 ...
 */
export const mHSSurnameAttribute: ATTRIBUTE<DirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_mhs_surname /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mHSSurnameAttribute */
