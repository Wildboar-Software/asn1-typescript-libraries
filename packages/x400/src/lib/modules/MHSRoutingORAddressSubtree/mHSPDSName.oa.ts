...
import { id_oc_mhs_pds_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-pds-name.va.js';
export { id_oc_mhs_pds_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-pds-name.va.js';
