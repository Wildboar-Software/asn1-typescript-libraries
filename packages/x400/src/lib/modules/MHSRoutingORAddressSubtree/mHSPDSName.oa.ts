...
import { id_oc_mhs_pds_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-pds-name.va';
export { id_oc_mhs_pds_name } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-pds-name.va';
