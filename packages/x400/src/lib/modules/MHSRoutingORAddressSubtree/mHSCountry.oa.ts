...
import { id_oc_mhs_country } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-country.va.js';
export { id_oc_mhs_country } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-country.va.js';

/* START_OF_SYMBOL_DEFINITION mHSCountry */
/**
 * @summary mHSCountry
 * @description
 *
 ...
 */
export const mHSCountry: OBJECT_CLASS = {
    class: 'OBJECT-CLASS',
    decoderFor: {},
    encoderFor: {},
    ...
    '&id': id_oc_mhs_country /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
};
/* END_OF_SYMBOL_DEFINITION mHSCountry */
