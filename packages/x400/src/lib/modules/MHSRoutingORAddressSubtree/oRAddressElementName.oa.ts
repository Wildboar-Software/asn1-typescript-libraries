...
export { name } from '@wildboar/x500/src/lib/modules/SelectedAttributeTypes/name.oa.js';
import { id_at_oraddress_element_name } from '../MHSRoutingObjectIdentifiers/id-at-oraddress-element-name.va.js';
export { id_at_oraddress_element_name } from '../MHSRoutingObjectIdentifiers/id-at-oraddress-element-name.va.js';
