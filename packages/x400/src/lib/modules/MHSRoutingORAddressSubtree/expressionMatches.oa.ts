...
} from '../MHSRoutingORAddressSubtree/ExpressionMatches.ta.js';
export {
    ExpressionMatches,
    _decode_ExpressionMatches,
    _encode_ExpressionMatches,
} from '../MHSRoutingORAddressSubtree/ExpressionMatches.ta.js';
import { id_at_mhs_expression_matches } from '../MHSRoutingObjectIdentifiers/id-at-mhs-expression-matches.va.js';
export { id_at_mhs_expression_matches } from '../MHSRoutingObjectIdentifiers/id-at-mhs-expression-matches.va.js';
