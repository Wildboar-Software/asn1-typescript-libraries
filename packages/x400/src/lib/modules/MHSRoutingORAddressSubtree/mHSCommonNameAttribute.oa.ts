...
import { ub_common_name_length } from '../MTSUpperBounds/ub-common-name-length.va.js';
export { ub_common_name_length } from '../MTSUpperBounds/ub-common-name-length.va.js';
import { id_at_mhs_common_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-common-name.va.js';
export { id_at_mhs_common_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-common-name.va.js';
...
/* END_OF_SYMBOL_DEFINITION mHSCommonNameAttribute */
