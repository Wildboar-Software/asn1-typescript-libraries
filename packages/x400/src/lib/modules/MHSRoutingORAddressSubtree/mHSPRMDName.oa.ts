...
import { id_at_mhs_prmd_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-prmd-name.va.js';
export { id_at_mhs_prmd_name } from '../MHSRoutingObjectIdentifiers/id-at-mhs-prmd-name.va.js';

/* START_OF_SYMBOL_DEFINITION mHSPRMDName */
/**
 * @summary mHSPRMDName
 * @description
 *
 ...
 */
export const mHSPRMDName: ATTRIBUTE<DirectoryString> = {
    class: 'ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_at_mhs_prmd_name /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION mHSPRMDName */
