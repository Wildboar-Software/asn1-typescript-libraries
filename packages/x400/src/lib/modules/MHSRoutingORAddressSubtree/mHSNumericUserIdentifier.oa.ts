...
import { id_oc_mhs_numeric_user_identifier } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-numeric-user-identifier.va';
export { id_oc_mhs_numeric_user_identifier } from '../MHSRoutingObjectIdentifiers/id-oc-mhs-numeric-user-identifier.va';
