 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_name_binding_dLCurrentData_distibutionListFunction`. Defined in
 ...
 * @constant
 */
export const id_name_binding_dLCurrentData_distibutionListFunction: ID = _OID.fromParts(
    [7],
    id_name_binding
);
