 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_creationTime`. A Time parameter is specified in terms
 ...
 * @constant
 */
export const id_attribute_creationTime: ID = _OID.fromParts([23], id_attribute);
