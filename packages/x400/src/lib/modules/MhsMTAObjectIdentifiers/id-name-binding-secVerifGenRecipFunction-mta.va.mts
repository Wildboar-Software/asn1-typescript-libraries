 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_name_binding_secVerifGenRecipFunction_mta`. Defined in ITU-T
 ...
 * @constant
 */
export const id_name_binding_secVerifGenRecipFunction_mta: ID = _OID.fromParts(
    [30],
    id_name_binding
);
