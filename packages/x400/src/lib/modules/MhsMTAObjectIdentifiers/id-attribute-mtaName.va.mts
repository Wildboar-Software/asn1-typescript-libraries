 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_mtaName`. An MTA-name is an identifier for an MTA that
 * uniquely identifies the MTA within the MD to which it belongs. 8.5.4 Time A Time
