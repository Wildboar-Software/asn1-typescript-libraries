 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_deferralTime`. A Time parameter is specified in terms
 ...
 * @constant
 */
export const id_attribute_deferralTime: ID = _OID.fromParts([32], id_attribute);
