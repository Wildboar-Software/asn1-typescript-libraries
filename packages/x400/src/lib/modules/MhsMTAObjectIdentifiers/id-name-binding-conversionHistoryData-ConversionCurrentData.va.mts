 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_name_binding_conversionHistoryData_ConversionCurrentData`.
 ...
 * @constant
 */
export const id_name_binding_conversionHistoryData_ConversionCurrentData: ID = _OID.fromParts(
    [5],
    id_name_binding
);
