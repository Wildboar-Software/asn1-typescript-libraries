 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_name_binding_secVerifGenMsgFunction_mta`. Defined in ITU-T X.411
 ...
 * @constant
 */
export const id_name_binding_secVerifGenMsgFunction_mta: ID = _OID.fromParts(
    [29],
    id_name_binding
);
