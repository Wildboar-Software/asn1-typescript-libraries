 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_arrivalTime`. A Time parameter is specified in terms
 ...
 * @constant
 */
export const id_attribute_arrivalTime: ID = _OID.fromParts([10], id_attribute);
