 ...
 * @description
 *
 * OBJECT IDENTIFIER `id_attribute_distributionListObjectInstanceId`. Defined in ITU-T
 ...
 * @constant
 */
export const id_attribute_distributionListObjectInstanceId: ID = _OID.fromParts(
    [35],
    id_attribute
);
