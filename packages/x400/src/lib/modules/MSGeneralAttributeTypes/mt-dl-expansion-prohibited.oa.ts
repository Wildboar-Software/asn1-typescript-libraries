...
} from '../MTSAbstractService/DLExpansionProhibited.ta';
export {
    DLExpansionProhibited,
    _enum_for_DLExpansionProhibited,
    DLExpansionProhibited_dl_expansion_allowed /* IMPORTED_LONG_ENUMERATION_ITEM */,
...
import { id_att_dl_expansion_prohibited } from '../MSObjectIdentifiers/id-att-dl-expansion-prohibited.va';
export { id_att_dl_expansion_prohibited } from '../MSObjectIdentifiers/id-att-dl-expansion-prohibited.va';
