 ...
 * @description
 *
 * Information object `ms_delivered_EITs`. This general-attribute, which is multi-valued,
 * identifies the encoded-information-types in the content of a message as delivered. It
 * is generated by the MS, and is derived from the original-encoded-information-types and
 * the converted- encoded-information-types arguments of the Message-delivery
 * abstract-operation. See ITU-T X.413 (1999), §11.2.25.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
