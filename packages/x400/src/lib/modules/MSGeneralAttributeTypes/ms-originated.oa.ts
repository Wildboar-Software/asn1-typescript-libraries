...
import { id_att_ms_originated } from '../MSObjectIdentifiers/id-att-ms-originated.va';
export { id_att_ms_originated } from '../MSObjectIdentifiers/id-att-ms-originated.va';
