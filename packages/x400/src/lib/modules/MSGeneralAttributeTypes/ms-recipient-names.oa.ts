...
import { id_att_recipient_names } from '../MSObjectIdentifiers/id-att-recipient-names.va.js';
export { id_att_recipient_names } from '../MSObjectIdentifiers/id-att-recipient-names.va.js';
