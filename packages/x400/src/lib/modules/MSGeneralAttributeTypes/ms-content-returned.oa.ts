...
import { id_att_content_returned } from '../MSObjectIdentifiers/id-att-content-returned.va';
export { id_att_content_returned } from '../MSObjectIdentifiers/id-att-content-returned.va';
