...
import { id_att_content_returned } from '../MSObjectIdentifiers/id-att-content-returned.va.js';
export { id_att_content_returned } from '../MSObjectIdentifiers/id-att-content-returned.va.js';
