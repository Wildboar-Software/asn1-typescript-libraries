...
} from '../MSGeneralAttributeTypes/DeletionTime.ta';
export {
    DeletionTime,
    _decode_DeletionTime,
    _encode_DeletionTime,
...
import { id_att_deletion_time } from '../MSObjectIdentifiers/id-att-deletion-time.va';
export { id_att_deletion_time } from '../MSObjectIdentifiers/id-att-deletion-time.va';
