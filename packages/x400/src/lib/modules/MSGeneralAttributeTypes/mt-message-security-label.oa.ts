...
import { id_att_message_security_label } from '../MSObjectIdentifiers/id-att-message-security-label.va.js';
export { id_att_message_security_label } from '../MSObjectIdentifiers/id-att-message-security-label.va.js';
