 ...
 * @description
 *
 * Information object `ms_signature_verification_status`. This general-attribute reports
 * the outcome of verification by the MS that the content of a delivered message has not
 * been modified in the MTS, if the MS has the capability to perform such verification
 * and a signature of the content was present in content-integrity-check,
