...
import { id_att_this_recipient_name } from '../MSObjectIdentifiers/id-att-this-recipient-name.va.mjs';
 ...
 * @description
 *
 * Information object `mt_this_recipient_name`. This general-attribute contains the
 * this-recipient-name argument of the Message-delivery abstract-operation, and
 * identifies the MS-user. See ITU-T X.413 (1999), §11.2.81.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export const mt_this_recipient_name: X413ATTRIBUTE<ORName> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
        '&Type': _decode_ORName,
    },
