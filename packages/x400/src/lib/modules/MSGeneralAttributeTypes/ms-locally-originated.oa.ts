...
import { id_att_locally_originated } from '../MSObjectIdentifiers/id-att-locally-originated.va';
export { id_att_locally_originated } from '../MSObjectIdentifiers/id-att-locally-originated.va';
