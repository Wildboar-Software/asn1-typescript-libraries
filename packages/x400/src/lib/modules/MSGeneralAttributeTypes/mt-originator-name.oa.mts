...
import { id_att_originator_name } from '../MSObjectIdentifiers/id-att-originator-name.va.mjs';
export { id_att_originator_name } from '../MSObjectIdentifiers/id-att-originator-name.va.mjs';
 ...
 */
export const mt_originator_name: X413ATTRIBUTE<ORName> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
        '&Type': _decode_ORName,
    },
