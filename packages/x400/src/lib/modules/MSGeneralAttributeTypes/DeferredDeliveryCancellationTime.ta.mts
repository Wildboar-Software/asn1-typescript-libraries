 ...
 * @description
 *
 * `DeferredDeliveryCancellationTime`. This general-attribute indicates the time at which
 * the MTS confirmed the successful cancellation of the deferred-delivery of a previously
 * submitted message (see 8.3.3). It is generated by the MS. See ITU-T X.413 (1999),
 * §11.2.22.
 *
 * ### ASN.1 Definition:
 *
