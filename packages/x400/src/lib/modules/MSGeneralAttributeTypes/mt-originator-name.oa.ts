...
import { id_att_originator_name } from '../MSObjectIdentifiers/id-att-originator-name.va';
export { id_att_originator_name } from '../MSObjectIdentifiers/id-att-originator-name.va';
