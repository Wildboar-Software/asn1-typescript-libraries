...
import { id_att_other_recipient_names } from '../MSObjectIdentifiers/id-att-other-recipient-names.va';
export { id_att_other_recipient_names } from '../MSObjectIdentifiers/id-att-other-recipient-names.va';
