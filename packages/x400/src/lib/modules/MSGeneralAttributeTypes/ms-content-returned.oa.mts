 ...
 * @description
 *
 * This general-attribute indicates whether a content has been returned in the
 * Report-delivery abstract-operation. It is generated by the MS (see 6.3.4). See ITU-T
 * X.413 (1999), §11.2.17.
 *
 * ### ASN.1 Definition:
 *
