...
import { id_att_originally_intended_recipient_name } from '../MSObjectIdentifiers/id-att-originally-intended-recipient-name.va.js';
export { id_att_originally_intended_recipient_name } from '../MSObjectIdentifiers/id-att-originally-intended-recipient-name.va.js';
