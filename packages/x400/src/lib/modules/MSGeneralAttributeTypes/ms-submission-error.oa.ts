...
} from '../MSGeneralAttributeTypes/SubmissionError.ta';
export {
    SubmissionError,
    _decode_SubmissionError,
    _encode_SubmissionError,
} from '../MSGeneralAttributeTypes/SubmissionError.ta';
import { id_att_ms_submission_error } from '../MSObjectIdentifiers/id-att-ms-submission-error.va';
export { id_att_ms_submission_error } from '../MSObjectIdentifiers/id-att-ms-submission-error.va';
