 ...
 * @description
 *
 * Information object `ms_parent_sequence_number`. This general-attribute identifies the
 * entry's parent-entry. It is generated by the MS. See ITU-T X.413 (1999), §11.2.56.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
