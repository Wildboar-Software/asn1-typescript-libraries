...
import { id_att_content_integrity_check } from '../MSObjectIdentifiers/id-att-content-integrity-check.va.js';
export { id_att_content_integrity_check } from '../MSObjectIdentifiers/id-att-content-integrity-check.va.js';
