 ...
 * @description
 *
 * Information object `mt_originating_MTA_certificate`. This general-attribute contains
 * the originating-MTA-certificate result of the Message-submission abstract-operation.
 * It is generated by the MTA to which the message was submitted. See ITU-T X.413 (1999),
 * §11.2.50.
 *
 * ### ASN.1 Definition:
 *
