...
import { id_att_converted_EITs } from '../MSObjectIdentifiers/id-att-converted-EITs.va';
export { id_att_converted_EITs } from '../MSObjectIdentifiers/id-att-converted-EITs.va';
