...
} from '../MSAbstractService/RetrievalStatus.ta.js';
...
import { id_att_retrieval_status } from '../MSObjectIdentifiers/id-att-retrieval-status.va.js';
export { id_att_retrieval_status } from '../MSObjectIdentifiers/id-att-retrieval-status.va.js';
