...
import { id_att_original_EITs } from '../MSObjectIdentifiers/id-att-original-EITs.va';
export { id_att_original_EITs } from '../MSObjectIdentifiers/id-att-original-EITs.va';
