...
import { id_att_creation_time } from '../MSObjectIdentifiers/id-att-creation-time.va';
export { id_att_creation_time } from '../MSObjectIdentifiers/id-att-creation-time.va';
