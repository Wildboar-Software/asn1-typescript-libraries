 ...
 * @description
 *
 * `SignatureVerificationStatus`. This general-attribute reports the outcome of
 * verification by the MS that the content of a delivered message has not been modified
 * in the MTS, if the MS has the capability to perform such verification and a signature
 * of the content was present in content-integrity-check,
 * message-origin-authentication-check or message-token. It is generated by the MS. See
 * ITU-T X.413 (1999), §11.2.77. ASN.1 DEFAULT `signature-absent`, `signature-absent`,
 * `signature-absent`, `signature-absent`, `signature-absent`, `signature-absent`: that
