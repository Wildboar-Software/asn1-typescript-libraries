...
import { id_att_message_token } from '../MSObjectIdentifiers/id-att-message-token.va';
export { id_att_message_token } from '../MSObjectIdentifiers/id-att-message-token.va';
