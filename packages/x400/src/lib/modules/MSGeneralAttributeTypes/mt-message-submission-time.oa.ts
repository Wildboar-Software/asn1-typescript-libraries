...
import { id_att_message_submission_time } from '../MSObjectIdentifiers/id-att-message-submission-time.va.js';
export { id_att_message_submission_time } from '../MSObjectIdentifiers/id-att-message-submission-time.va.js';
