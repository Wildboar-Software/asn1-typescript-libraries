...
import { id_att_originating_MTA_certificate } from '../MSObjectIdentifiers/id-att-originating-MTA-certificate.va';
export { id_att_originating_MTA_certificate } from '../MSObjectIdentifiers/id-att-originating-MTA-certificate.va';
