...
} from '../MTSAbstractService/ConversionWithLossProhibited.ta.js';
export {
    ConversionWithLossProhibited,
    _enum_for_ConversionWithLossProhibited,
    ConversionWithLossProhibited_conversion_with_loss_allowed /* IMPORTED_LONG_ENUMERATION_ITEM */,
...
import { id_att_conversion_with_loss_prohibited } from '../MSObjectIdentifiers/id-att-conversion-with-loss-prohibited.va.js';
export { id_att_conversion_with_loss_prohibited } from '../MSObjectIdentifiers/id-att-conversion-with-loss-prohibited.va.js';
