 ...
 * @description
 *
 * Information object `ms_entry_type`. This general-attribute identifies the type of an
 * entry (see 6.3.6). It is generated by the MS. See ITU-T X.413 (1999), §11.2.30.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
