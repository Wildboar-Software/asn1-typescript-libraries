 ...
 * @description
 *
 * This general-attribute, which is multi-valued, identifies the delivered-report entries
 * which have been correlated with the originally specified recipients of a submitted
