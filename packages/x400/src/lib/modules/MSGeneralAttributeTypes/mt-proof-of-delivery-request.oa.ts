...
import { id_att_proof_of_delivery_request } from '../MSObjectIdentifiers/id-att-proof-of-delivery-request.va';
export { id_att_proof_of_delivery_request } from '../MSObjectIdentifiers/id-att-proof-of-delivery-request.va';
