 ...
 * @description
 *
 * Information object `ms_submission_error`. This general-attribute may be present in
 * entries of the Submission-log entry-class and indicates the error returned by the
