...
import { id_att_recipient_certificate } from '../MSObjectIdentifiers/id-att-recipient-certificate.va.mjs';
export { id_att_recipient_certificate } from '../MSObjectIdentifiers/id-att-recipient-certificate.va.mjs';
...
/* START_OF_SYMBOL_DEFINITION mt_recipient_certificate */
/**
 * @summary mt_recipient_certificate
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const mt_recipient_certificate: X413ATTRIBUTE<ExtendedCertificates> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_att_recipient_certificate /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
    '&Type': 0 as never /* OBJECT_FIELD_SETTING OBJECT_TYPE_FIELD_SETTING */,
};
/* END_OF_SYMBOL_DEFINITION mt_recipient_certificate */
