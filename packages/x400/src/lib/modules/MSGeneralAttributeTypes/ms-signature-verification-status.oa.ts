...
} from '../MSGeneralAttributeTypes/SignatureVerificationStatus.ta';
export {
    SignatureVerificationStatus,
    _decode_SignatureVerificationStatus,
    _encode_SignatureVerificationStatus,
} from '../MSGeneralAttributeTypes/SignatureVerificationStatus.ta';
import { id_att_signature_verification_status } from '../MSObjectIdentifiers/id-att-signature-verification-status.va';
export { id_att_signature_verification_status } from '../MSObjectIdentifiers/id-att-signature-verification-status.va';
