...
import { id_att_message_notes } from '../MSObjectIdentifiers/id-att-message-notes.va';
export { id_att_message_notes } from '../MSObjectIdentifiers/id-att-message-notes.va';
