...
} from '../MSGeneralAttributeTypes/ReportLocation.ta.js';
export {
    ReportLocation,
    _decode_ReportLocation,
    _encode_ReportLocation,
} from '../MSGeneralAttributeTypes/ReportLocation.ta.js';
import { id_att_ac_correlated_report_list } from '../MSObjectIdentifiers/id-att-ac-correlated-report-list.va.js';
export { id_att_ac_correlated_report_list } from '../MSObjectIdentifiers/id-att-ac-correlated-report-list.va.js';
