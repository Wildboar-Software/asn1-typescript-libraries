...
import { id_att_message_origin_authentication_check } from '../MSObjectIdentifiers/id-att-message-origin-authentication-check.va.js';
export { id_att_message_origin_authentication_check } from '../MSObjectIdentifiers/id-att-message-origin-authentication-check.va.js';
