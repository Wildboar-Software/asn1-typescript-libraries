 ...
 * @description
 *
 * Information object `mt_content_integrity_check`. This general-attribute contains the
 * content-integrity-check argument of the Message-delivery abstract-operation; it
