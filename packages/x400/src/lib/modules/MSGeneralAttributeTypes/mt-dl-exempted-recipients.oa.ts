...
import { id_att_dl_exempted_recipients } from '../MSObjectIdentifiers/id-att-dl-exempted-recipients.va';
export { id_att_dl_exempted_recipients } from '../MSObjectIdentifiers/id-att-dl-exempted-recipients.va';
