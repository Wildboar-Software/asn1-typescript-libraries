...
import { id_att_message_submission_envelope } from '../MSObjectIdentifiers/id-att-message-submission-envelope.va';
export { id_att_message_submission_envelope } from '../MSObjectIdentifiers/id-att-message-submission-envelope.va';
