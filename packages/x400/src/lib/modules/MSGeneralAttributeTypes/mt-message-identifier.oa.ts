...
import { id_att_message_identifier } from '../MSObjectIdentifiers/id-att-message-identifier.va';
export { id_att_message_identifier } from '../MSObjectIdentifiers/id-att-message-identifier.va';
