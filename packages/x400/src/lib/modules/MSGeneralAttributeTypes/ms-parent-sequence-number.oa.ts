...
import { id_att_parent_sequence_number } from '../MSObjectIdentifiers/id-att-parent-sequence-number.va.js';
export { id_att_parent_sequence_number } from '../MSObjectIdentifiers/id-att-parent-sequence-number.va.js';
