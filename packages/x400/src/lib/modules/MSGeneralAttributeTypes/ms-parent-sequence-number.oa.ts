...
import { id_att_parent_sequence_number } from '../MSObjectIdentifiers/id-att-parent-sequence-number.va';
export { id_att_parent_sequence_number } from '../MSObjectIdentifiers/id-att-parent-sequence-number.va';
