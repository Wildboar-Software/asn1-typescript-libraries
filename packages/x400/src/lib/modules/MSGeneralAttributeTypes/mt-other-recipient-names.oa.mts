...
import { id_att_other_recipient_names } from '../MSObjectIdentifiers/id-att-other-recipient-names.va.mjs';
export { id_att_other_recipient_names } from '../MSObjectIdentifiers/id-att-other-recipient-names.va.mjs';
...
/* START_OF_SYMBOL_DEFINITION mt_other_recipient_names */
/**
 ...
 */
export const mt_other_recipient_names: X413ATTRIBUTE<ORName> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
        '&Type': _decode_ORName,
    },
    ...
    '&id': id_att_other_recipient_names /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
    '&Type': 0 as never /* OBJECT_FIELD_SETTING OBJECT_TYPE_FIELD_SETTING */,
};
/* END_OF_SYMBOL_DEFINITION mt_other_recipient_names */
