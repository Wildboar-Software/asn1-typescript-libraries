...
import { id_att_content_correlator } from '../MSObjectIdentifiers/id-att-content-correlator.va.js';
export { id_att_content_correlator } from '../MSObjectIdentifiers/id-att-content-correlator.va.js';
