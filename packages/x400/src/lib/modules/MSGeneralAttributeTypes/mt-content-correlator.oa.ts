...
import { id_att_content_correlator } from '../MSObjectIdentifiers/id-att-content-correlator.va';
export { id_att_content_correlator } from '../MSObjectIdentifiers/id-att-content-correlator.va';
