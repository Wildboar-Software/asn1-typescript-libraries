...
import { id_att_multiple_originator_certificates } from '../MSObjectIdentifiers/id-att-multiple-originator-certificates.va';
export { id_att_multiple_originator_certificates } from '../MSObjectIdentifiers/id-att-multiple-originator-certificates.va';
