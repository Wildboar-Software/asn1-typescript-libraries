 ...
 * @description
 *
 * Information object `mt_probe_submission_envelope`. This general-attribute contains the
 * envelope component of the argument of the Probe-submission abstract-operation. See
