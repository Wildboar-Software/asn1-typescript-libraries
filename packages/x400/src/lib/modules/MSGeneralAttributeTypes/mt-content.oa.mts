 ...
 * @description
 *
 * Information object `mt_content`. This general-attribute contains the complete content
 * of a message as submitted by the MS-message-submission abstract- operation, or as
 * delivered by the Message-delivery abstract-operation, or as presented in the
