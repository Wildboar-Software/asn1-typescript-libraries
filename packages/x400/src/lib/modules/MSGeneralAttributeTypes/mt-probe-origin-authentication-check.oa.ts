...
import { id_att_probe_origin_authentication_check } from '../MSObjectIdentifiers/id-att-probe-origin-authentication-check.va.js';
export { id_att_probe_origin_authentication_check } from '../MSObjectIdentifiers/id-att-probe-origin-authentication-check.va.js';
