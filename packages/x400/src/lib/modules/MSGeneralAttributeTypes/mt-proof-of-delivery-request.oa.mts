 ...
 * @description
 *
 * Information object `mt_proof_of_delivery_request`. This general-attribute contains the
 * proof-of-delivery-request argument of the Message-delivery abstract-operation. It may
 * be generated by the originator of the message. See ITU-T X.413 (1999), §11.2.64.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
