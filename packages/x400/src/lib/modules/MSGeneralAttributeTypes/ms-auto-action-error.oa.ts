...
} from '../MSAbstractService/AutoActionError.ta.js';
export {
    AutoActionError,
    _decode_AutoActionError,
    _encode_AutoActionError,
} from '../MSAbstractService/AutoActionError.ta.js';
import { id_att_auto_action_error } from '../MSObjectIdentifiers/id-att-auto-action-error.va.js';
export { id_att_auto_action_error } from '../MSObjectIdentifiers/id-att-auto-action-error.va.js';
