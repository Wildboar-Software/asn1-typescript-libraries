...
} from '../MSAbstractService/AutoActionError.ta';
export {
    AutoActionError,
    _decode_AutoActionError,
    _encode_AutoActionError,
} from '../MSAbstractService/AutoActionError.ta';
import { id_att_auto_action_error } from '../MSObjectIdentifiers/id-att-auto-action-error.va';
export { id_att_auto_action_error } from '../MSObjectIdentifiers/id-att-auto-action-error.va';
