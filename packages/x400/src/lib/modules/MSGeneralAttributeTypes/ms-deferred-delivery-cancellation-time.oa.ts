...
} from '../MSGeneralAttributeTypes/DeferredDeliveryCancellationTime.ta';
export {
    DeferredDeliveryCancellationTime,
    _decode_DeferredDeliveryCancellationTime,
    _encode_DeferredDeliveryCancellationTime,
...
import { id_att_deferred_delivery_cancellation_time } from '../MSObjectIdentifiers/id-att-deferred-delivery-cancellation-time.va';
export { id_att_deferred_delivery_cancellation_time } from '../MSObjectIdentifiers/id-att-deferred-delivery-cancellation-time.va';
