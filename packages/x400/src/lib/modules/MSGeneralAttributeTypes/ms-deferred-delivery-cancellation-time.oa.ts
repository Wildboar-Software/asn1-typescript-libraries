...
} from '../MSGeneralAttributeTypes/DeferredDeliveryCancellationTime.ta.js';
export {
    DeferredDeliveryCancellationTime,
    _decode_DeferredDeliveryCancellationTime,
    _encode_DeferredDeliveryCancellationTime,
...
import { id_att_deferred_delivery_cancellation_time } from '../MSObjectIdentifiers/id-att-deferred-delivery-cancellation-time.va.js';
export { id_att_deferred_delivery_cancellation_time } from '../MSObjectIdentifiers/id-att-deferred-delivery-cancellation-time.va.js';
