...
import { id_att_child_sequence_numbers } from '../MSObjectIdentifiers/id-att-child-sequence-numbers.va.mjs';
export { id_att_child_sequence_numbers } from '../MSObjectIdentifiers/id-att-child-sequence-numbers.va.mjs';
...
/* START_OF_SYMBOL_DEFINITION ms_child_sequence_numbers */
/**
 * @summary ms_child_sequence_numbers
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const ms_child_sequence_numbers: X413ATTRIBUTE<SequenceNumber> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_att_child_sequence_numbers /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
    '&Type': 0 as never /* OBJECT_FIELD_SETTING OBJECT_TYPE_FIELD_SETTING */,
};
/* END_OF_SYMBOL_DEFINITION ms_child_sequence_numbers */
