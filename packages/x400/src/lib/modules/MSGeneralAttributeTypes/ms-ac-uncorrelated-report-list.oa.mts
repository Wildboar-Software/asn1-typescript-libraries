 ...
 * @description
 *
 * Information object `ms_ac_uncorrelated_report_list`. This general-attribute, which is
 * multi-valued, identifies each of the per-recipient-report-delivery-fields which have
 * been correlated with a submitted message or probe but which have not been correlated
 * with any of its originally specified recipients. It is generated by the MS. See ITU-T
 * X.413 (1999), §11.2.4.
 *
 * ### ASN.1 Definition:
 *
