...
import {
    ...
    _decode_StorageTime,
    _encode_StorageTime,
} from '../MSGeneralAttributeTypes/StorageTime.ta';
export {
    StorageTime,
    _decode_StorageTime,
    _encode_StorageTime,
...
import { id_att_storage_time } from '../MSObjectIdentifiers/id-att-storage-time.va';
export { id_att_storage_time } from '../MSObjectIdentifiers/id-att-storage-time.va';
