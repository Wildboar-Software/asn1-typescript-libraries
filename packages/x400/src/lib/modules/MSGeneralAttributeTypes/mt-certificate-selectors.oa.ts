...
import { id_att_certificate_selectors } from '../MSObjectIdentifiers/id-att-certificate-selectors.va';
export { id_att_certificate_selectors } from '../MSObjectIdentifiers/id-att-certificate-selectors.va';
