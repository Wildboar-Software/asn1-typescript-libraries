...
} from '../MTSAbstractService/ReportingMTACertificate.ta';
export {
    ReportingMTACertificate,
    _decode_ReportingMTACertificate,
    _encode_ReportingMTACertificate,
} from '../MTSAbstractService/ReportingMTACertificate.ta';
import { id_att_reporting_MTA_certificate } from '../MSObjectIdentifiers/id-att-reporting-MTA-certificate.va';
export { id_att_reporting_MTA_certificate } from '../MSObjectIdentifiers/id-att-reporting-MTA-certificate.va';
