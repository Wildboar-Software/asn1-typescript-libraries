...
import { id_att_content_length } from '../MSObjectIdentifiers/id-att-content-length.va.js';
export { id_att_content_length } from '../MSObjectIdentifiers/id-att-content-length.va.js';
