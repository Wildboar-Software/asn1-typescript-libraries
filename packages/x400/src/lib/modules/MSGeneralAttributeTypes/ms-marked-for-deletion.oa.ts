...
import { id_att_marked_for_deletion } from '../MSObjectIdentifiers/id-att-marked-for-deletion.va';
export { id_att_marked_for_deletion } from '../MSObjectIdentifiers/id-att-marked-for-deletion.va';
