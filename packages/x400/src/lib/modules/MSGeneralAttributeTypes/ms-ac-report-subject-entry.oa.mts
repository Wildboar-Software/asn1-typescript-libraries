...
import { id_att_ac_report_subject_entry } from '../MSObjectIdentifiers/id-att-ac-report-subject-entry.va.mjs';
export { id_att_ac_report_subject_entry } from '../MSObjectIdentifiers/id-att-ac-report-subject-entry.va.mjs';
...
/* START_OF_SYMBOL_DEFINITION ms_ac_report_subject_entry */
/**
 * @summary ms_ac_report_subject_entry
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const ms_ac_report_subject_entry: X413ATTRIBUTE<SequenceNumber> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_att_ac_report_subject_entry /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
    '&Type': 0 as never /* OBJECT_FIELD_SETTING OBJECT_TYPE_FIELD_SETTING */,
};
/* END_OF_SYMBOL_DEFINITION ms_ac_report_subject_entry */
