...
import { report_body_part_data } from '../IPMSForwardedReportBodyPartType/report-body-part-data.oa';
export { report_body_part_data } from '../IPMSForwardedReportBodyPartType/report-body-part-data.oa';
