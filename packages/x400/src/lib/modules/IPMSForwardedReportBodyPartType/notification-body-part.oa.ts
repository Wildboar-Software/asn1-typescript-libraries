...
import { notification_body_part_parameters } from '../IPMSForwardedReportBodyPartType/notification-body-part-parameters.oa.js';
export { notification_body_part_parameters } from '../IPMSForwardedReportBodyPartType/notification-body-part-parameters.oa.js';
import { notification_body_part_data } from '../IPMSForwardedReportBodyPartType/notification-body-part-data.oa.js';
export { notification_body_part_data } from '../IPMSForwardedReportBodyPartType/notification-body-part-data.oa.js';
...
/* START_OF_SYMBOL_DEFINITION notification_body_part */
/**
...
/* END_OF_SYMBOL_DEFINITION notification_body_part */
