...
export { notification_body_part_parameters } from '../IPMSForwardedReportBodyPartType/notification-body-part-parameters.oa.mjs';
import { notification_body_part_data } from '../IPMSForwardedReportBodyPartType/notification-body-part-data.oa.mjs';
export { notification_body_part_data } from '../IPMSForwardedReportBodyPartType/notification-body-part-data.oa.mjs';
