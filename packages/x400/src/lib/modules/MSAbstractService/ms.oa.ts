...
import { mts_user } from '../MTSAbstractService/mts-user.oa.js';
export { mts_user } from '../MTSAbstractService/mts-user.oa.js';
...
import { id_ot_ms } from '../MSObjectIdentifiers/id-ot-ms.va.js';
export { id_ot_ms } from '../MSObjectIdentifiers/id-ot-ms.va.js';
