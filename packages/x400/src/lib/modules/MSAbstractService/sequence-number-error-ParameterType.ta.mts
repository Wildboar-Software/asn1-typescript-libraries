 ...
 * @description
 *
 * `sequence_number_error_ParameterType`. Defined in ITU-T X.413 (1999) (§6).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_sequence_number_error_ParameterType(el: _Element): sequence_number_error_ParameterType {
