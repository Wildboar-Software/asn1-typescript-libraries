...
} from '../MSAbstractService/ModifyErrorParameter.ta';
export {
    ModifyErrorParameter,
    _decode_ModifyErrorParameter,
    _encode_ModifyErrorParameter,
} from '../MSAbstractService/ModifyErrorParameter.ta';
import { err_modify_error } from '../MSAccessProtocol/err-modify-error.va';
export { err_modify_error } from '../MSAccessProtocol/err-modify-error.va';
