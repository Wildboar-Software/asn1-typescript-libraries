...
export { auto_action_request_error } from '../MSAbstractService/auto-action-request-error.oa.mjs';
...
export { old_credentials_incorrectly_specified } from '../MTSAbstractService/old-credentials-incorrectly-specified.oa.mjs';
import { new_credentials_unacceptable } from '../MTSAbstractService/new-credentials-unacceptable.oa.mjs';
export { new_credentials_unacceptable } from '../MTSAbstractService/new-credentials-unacceptable.oa.mjs';
...
export { register_ms_error } from '../MSAbstractService/register-ms-error.oa.mjs';
...
export { op_register_ms } from '../MSAccessProtocol/op-register-ms.va.mjs';
