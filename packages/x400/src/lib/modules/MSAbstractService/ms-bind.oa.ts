...
} from '../MSAbstractService/MSBindArgument.ta.js';
export {
    MSBindArgument,
    _decode_MSBindArgument,
    _encode_MSBindArgument,
...
} from '../MSAbstractService/MSBindResult.ta.js';
export {
    MSBindResult,
    _decode_MSBindResult,
    _encode_MSBindResult,
} from '../MSAbstractService/MSBindResult.ta.js';
import { ms_bind_error } from '../MSAbstractService/ms-bind-error.oa.js';
export { ms_bind_error } from '../MSAbstractService/ms-bind-error.oa.js';
