 ...
 * @description
 *
 * `NumberRange`. A range parameter is used to select a contiguous sequence of entries of
 * a specified entry-class. Range ::= CHOICE { sequence-number-range [0] NumberRange,
