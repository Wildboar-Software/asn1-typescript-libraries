...
import { id_ext_modify_capability } from '../MSObjectIdentifiers/id-ext-modify-capability.va.js';
export { id_ext_modify_capability } from '../MSObjectIdentifiers/id-ext-modify-capability.va.js';
