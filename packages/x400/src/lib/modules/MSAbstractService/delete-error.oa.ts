...
} from '../MSAbstractService/delete-error-ParameterType.ta.js';
export {
    delete_error_ParameterType,
    _decode_delete_error_ParameterType,
    _encode_delete_error_ParameterType,
} from '../MSAbstractService/delete-error-ParameterType.ta.js';
import { err_delete_error } from '../MSAccessProtocol/err-delete-error.va.js';
export { err_delete_error } from '../MSAccessProtocol/err-delete-error.va.js';
