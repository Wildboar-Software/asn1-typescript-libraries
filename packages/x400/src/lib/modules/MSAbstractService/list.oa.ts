...
} from '../MSAbstractService/ListArgument.ta.js';
export {
    ListArgument,
    _decode_ListArgument,
    _encode_ListArgument,
...
import {
    ...
    _decode_ListResult,
    _encode_ListResult,
} from '../MSAbstractService/ListResult.ta.js';
export {
    ListResult,
    _decode_ListResult,
    _encode_ListResult,
...
import { op_list } from '../MSAccessProtocol/op-list.va.js';
export { op_list } from '../MSAccessProtocol/op-list.va.js';
