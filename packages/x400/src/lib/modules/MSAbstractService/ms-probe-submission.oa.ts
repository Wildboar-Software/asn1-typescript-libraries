...
} from '../MSAbstractService/MSProbeSubmissionArgument.ta.js';
export {
    MSProbeSubmissionArgument,
    _decode_MSProbeSubmissionArgument,
    _encode_MSProbeSubmissionArgument,
...
} from '../MSAbstractService/MSProbeSubmissionResult.ta.js';
export {
    MSProbeSubmissionResult,
    _decode_MSProbeSubmissionResult,
    _encode_MSProbeSubmissionResult,
...
import { op_ms_probe_submission } from '../MSAccessProtocol/op-ms-probe-submission.va.js';
export { op_ms_probe_submission } from '../MSAccessProtocol/op-ms-probe-submission.va.js';
...
/* START_OF_SYMBOL_DEFINITION ms_probe_submission */
/**
...
/* END_OF_SYMBOL_DEFINITION ms_probe_submission */
