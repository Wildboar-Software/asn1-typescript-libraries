...
} from '../MSAbstractService/range-error-ParameterType.ta';
export {
    range_error_ParameterType,
    _decode_range_error_ParameterType,
    _encode_range_error_ParameterType,
} from '../MSAbstractService/range-error-ParameterType.ta';
import { err_range_error } from '../MSAccessProtocol/err-range-error.va';
export { err_range_error } from '../MSAccessProtocol/err-range-error.va';
