...
import { id_aae_duplicate_ipn } from '../IPMSObjectIdentifiers/id-aae-duplicate-ipn.va';
export { id_aae_duplicate_ipn } from '../IPMSObjectIdentifiers/id-aae-duplicate-ipn.va';
