...
export { general_text_body_part_parameters } from '../IPMSExtendedBodyPartTypes2/general-text-body-part-parameters.oa.mjs';
import { general_text_body_part_data } from '../IPMSExtendedBodyPartTypes2/general-text-body-part-data.oa.mjs';
export { general_text_body_part_data } from '../IPMSExtendedBodyPartTypes2/general-text-body-part-data.oa.mjs';
...
/* END_OF_SYMBOL_DEFINITION general_text_body_part */
