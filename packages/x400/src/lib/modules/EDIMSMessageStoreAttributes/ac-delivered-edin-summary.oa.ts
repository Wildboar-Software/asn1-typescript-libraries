...
import { id_cat_delivered_edin_summary } from '../EDIMSObjectIdentifiers/id-cat-delivered-edin-summary.va.js';
export { id_cat_delivered_edin_summary } from '../EDIMSObjectIdentifiers/id-cat-delivered-edin-summary.va.js';
