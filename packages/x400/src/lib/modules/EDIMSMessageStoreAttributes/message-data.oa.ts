...
import {
    ...
    _decode_MessageData,
    _encode_MessageData,
} from '../EDIMSInformationObjects/MessageData.ta.js';
export {
    MessageData,
    _decode_MessageData,
    _encode_MessageData,
} from '../EDIMSInformationObjects/MessageData.ta.js';
import { id_bat_message_data } from '../EDIMSObjectIdentifiers/id-bat-message-data.va.js';
export { id_bat_message_data } from '../EDIMSObjectIdentifiers/id-bat-message-data.va.js';
