...
import { id_hat_originator } from '../EDIMSObjectIdentifiers/id-hat-originator.va.js';
export { id_hat_originator } from '../EDIMSObjectIdentifiers/id-hat-originator.va.js';
