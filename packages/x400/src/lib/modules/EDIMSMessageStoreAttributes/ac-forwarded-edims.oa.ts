...
import { id_cat_forwarded_edims } from '../EDIMSObjectIdentifiers/id-cat-forwarded-edims.va';
export { id_cat_forwarded_edims } from '../EDIMSObjectIdentifiers/id-cat-forwarded-edims.va';
