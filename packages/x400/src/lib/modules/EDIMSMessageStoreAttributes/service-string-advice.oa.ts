...
import { id_hat_service_string_advice } from '../EDIMSObjectIdentifiers/id-hat-service-string-advice.va.js';
export { id_hat_service_string_advice } from '../EDIMSObjectIdentifiers/id-hat-service-string-advice.va.js';
