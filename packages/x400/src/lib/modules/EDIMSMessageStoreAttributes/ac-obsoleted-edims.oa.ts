...
import { id_cat_obsoleted_edims } from '../EDIMSObjectIdentifiers/id-cat-obsoleted-edims.va.js';
export { id_cat_obsoleted_edims } from '../EDIMSObjectIdentifiers/id-cat-obsoleted-edims.va.js';
