...
import { id_cat_obsoleted_edims } from '../EDIMSObjectIdentifiers/id-cat-obsoleted-edims.va';
export { id_cat_obsoleted_edims } from '../EDIMSObjectIdentifiers/id-cat-obsoleted-edims.va';
