...
} from '../EDIMSInformationObjects/CrossReferencingInformationSubField.ta.js';
export {
    CrossReferencingInformationSubField,
    _decode_CrossReferencingInformationSubField,
    _encode_CrossReferencingInformationSubField,
...
import { id_hat_cross_referencing_information } from '../EDIMSObjectIdentifiers/id-hat-cross-referencing-information.va.js';
export { id_hat_cross_referencing_information } from '../EDIMSObjectIdentifiers/id-hat-cross-referencing-information.va.js';
