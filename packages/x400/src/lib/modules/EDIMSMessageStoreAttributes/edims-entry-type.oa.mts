 ...
 * @description
 *
 * Information object `edims_entry_type`. The EDIMS Entry Type attribute identifies an
 * information object’s type. edims-entry-type ATTRIBUTE ::= { WITH ATTRIBUTE-SYNTAX
