...
import { id_cat_submitted_edins } from '../EDIMSObjectIdentifiers/id-cat-submitted-edins.va.js';
export { id_cat_submitted_edins } from '../EDIMSObjectIdentifiers/id-cat-submitted-edins.va.js';
