...
import { id_cat_subject_edim } from '../EDIMSObjectIdentifiers/id-cat-subject-edim.va';
export { id_cat_subject_edim } from '../EDIMSObjectIdentifiers/id-cat-subject-edim.va';
