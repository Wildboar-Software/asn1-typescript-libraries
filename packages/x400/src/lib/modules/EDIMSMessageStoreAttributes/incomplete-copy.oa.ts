...
import { id_hat_incomplete_copy } from '../EDIMSObjectIdentifiers/id-hat-incomplete-copy.va';
export { id_hat_incomplete_copy } from '../EDIMSObjectIdentifiers/id-hat-incomplete-copy.va';
