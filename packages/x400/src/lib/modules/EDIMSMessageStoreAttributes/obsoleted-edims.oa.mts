 ...
 * @description
 *
 * Information object `obsoleted_edims`. The Obsoleted EDIMs Field identifies one or more
 * EDIMs that the present EDIM obsoletes. It is a sequence of subfields, each an EDIM
