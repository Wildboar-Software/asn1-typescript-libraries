...
import { id_hat_application_reference } from '../EDIMSObjectIdentifiers/id-hat-application-reference.va';
export { id_hat_application_reference } from '../EDIMSObjectIdentifiers/id-hat-application-reference.va';
