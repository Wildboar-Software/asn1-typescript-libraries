...
import { id_nat_nn_supplementary_info } from '../EDIMSObjectIdentifiers/id-nat-nn-supplementary-info.va.js';
export { id_nat_nn_supplementary_info } from '../EDIMSObjectIdentifiers/id-nat-nn-supplementary-info.va.js';
import { X413ATTRIBUTE } from '../MSAbstractService/X413ATTRIBUTE.oca.js';
export { X413ATTRIBUTE } from '../MSAbstractService/X413ATTRIBUTE.oca.js';
import { single_valued, multi_valued } from "../MSAbstractService/X413ATTRIBUTE-numeration.ta.js";

/* START_OF_SYMBOL_DEFINITION nn_supplementary_information */
/**
 ...
 */
export const nn_supplementary_information: X413ATTRIBUTE<EDISupplementaryInformation> = {
    class: 'X413ATTRIBUTE',
    decoderFor: {
    ...
    '&id': id_nat_nn_supplementary_info /* OBJECT_FIELD_SETTING */ /* UNIQUE_OBJECT_FIELD_SETTING */,
    '&Type': 0 as never /* OBJECT_FIELD_SETTING OBJECT_TYPE_FIELD_SETTING */,
};
/* END_OF_SYMBOL_DEFINITION nn_supplementary_information */
