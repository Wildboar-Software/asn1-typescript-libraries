...
import { id_hat_edi_bodypart_type } from '../EDIMSObjectIdentifiers/id-hat-edi-bodypart-type.va';
export { id_hat_edi_bodypart_type } from '../EDIMSObjectIdentifiers/id-hat-edi-bodypart-type.va';
