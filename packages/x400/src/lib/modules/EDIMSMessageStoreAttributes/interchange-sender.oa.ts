...
import { id_hat_interchange_sender } from '../EDIMSObjectIdentifiers/id-hat-interchange-sender.va';
export { id_hat_interchange_sender } from '../EDIMSObjectIdentifiers/id-hat-interchange-sender.va';
