...
} from '../EDIMSMessageStoreAttributes/EDIMSEntryType.ta.js';
export {
    EDIMSEntryType,
    _enum_for_EDIMSEntryType,
    EDIMSEntryType_edim /* IMPORTED_LONG_ENUMERATION_ITEM */,
...
import { id_sat_edims_entry_type } from '../EDIMSObjectIdentifiers/id-sat-edims-entry-type.va.js';
export { id_sat_edims_entry_type } from '../EDIMSObjectIdentifiers/id-sat-edims-entry-type.va.js';
