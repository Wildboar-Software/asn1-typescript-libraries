...
import { id_cat_relating_edims } from '../EDIMSObjectIdentifiers/id-cat-relating-edims.va';
export { id_cat_relating_edims } from '../EDIMSObjectIdentifiers/id-cat-relating-edims.va';
