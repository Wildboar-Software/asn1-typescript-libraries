...
import { id_cat_relating_edims } from '../EDIMSObjectIdentifiers/id-cat-relating-edims.va.js';
export { id_cat_relating_edims } from '../EDIMSObjectIdentifiers/id-cat-relating-edims.va.js';
