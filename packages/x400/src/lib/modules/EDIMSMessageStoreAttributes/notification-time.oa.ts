...
import { id_nat_notification_time } from '../EDIMSObjectIdentifiers/id-nat-notification-time.va.js';
export { id_nat_notification_time } from '../EDIMSObjectIdentifiers/id-nat-notification-time.va.js';
