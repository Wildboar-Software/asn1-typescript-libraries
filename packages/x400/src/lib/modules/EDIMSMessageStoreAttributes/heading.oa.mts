 ...
 * EDIM. heading ATTRIBUTE ::= { WITH ATTRIBUTE-SYNTAX Heading, NUMERATION single-valued,
 * ID id-hat-heading } An MS that supports this attribute shall maintain it for an
