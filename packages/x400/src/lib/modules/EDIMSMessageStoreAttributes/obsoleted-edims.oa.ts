...
} from '../EDIMSInformationObjects/ObsoletedEDIMsSubfield.ta.js';
export {
    ObsoletedEDIMsSubfield,
    _decode_ObsoletedEDIMsSubfield,
    _encode_ObsoletedEDIMsSubfield,
...
import { id_hat_obsoleted_edims } from '../EDIMSObjectIdentifiers/id-hat-obsoleted-edims.va.js';
export { id_hat_obsoleted_edims } from '../EDIMSObjectIdentifiers/id-hat-obsoleted-edims.va.js';
