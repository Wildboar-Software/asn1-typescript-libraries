 ...
 * @description
 *
 * The AC Delivered EDIN Summary attribute, which is multi-valued, contains a summary of
 * the EDINs requested of, and generated by, or on behalf of, the AC EDIM Recipients of a
 * submitted message. The initial values of AC Delivered EDIN Summary are set according to
 * the values of the EDI Notification Requests component of each of the EDIM’s Recipients
 * subfields, and each value is updated as each EDIN is received. See ITU-T X.435 (1999),
 * §18.8.6.2.2.
 *
 * ### ASN.1 Definition:
 *
