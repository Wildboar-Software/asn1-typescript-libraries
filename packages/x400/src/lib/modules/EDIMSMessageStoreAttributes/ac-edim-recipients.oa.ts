...
import { id_cat_edim_recipients } from '../EDIMSObjectIdentifiers/id-cat-edim-recipients.va';
export { id_cat_edim_recipients } from '../EDIMSObjectIdentifiers/id-cat-edim-recipients.va';
