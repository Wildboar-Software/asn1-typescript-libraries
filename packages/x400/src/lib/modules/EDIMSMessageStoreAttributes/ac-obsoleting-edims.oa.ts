...
import { id_cat_obsoleting_edims } from '../EDIMSObjectIdentifiers/id-cat-obsoleting-edims.va.js';
export { id_cat_obsoleting_edims } from '../EDIMSObjectIdentifiers/id-cat-obsoleting-edims.va.js';
