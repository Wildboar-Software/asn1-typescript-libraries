...
import { id_nat_first_recipient } from '../EDIMSObjectIdentifiers/id-nat-first-recipient.va.js';
export { id_nat_first_recipient } from '../EDIMSObjectIdentifiers/id-nat-first-recipient.va.js';
