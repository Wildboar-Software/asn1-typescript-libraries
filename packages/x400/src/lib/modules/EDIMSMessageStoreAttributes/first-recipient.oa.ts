...
import { id_nat_first_recipient } from '../EDIMSObjectIdentifiers/id-nat-first-recipient.va';
export { id_nat_first_recipient } from '../EDIMSObjectIdentifiers/id-nat-first-recipient.va';
