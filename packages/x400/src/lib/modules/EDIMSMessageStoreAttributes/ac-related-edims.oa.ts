...
} from '../EDIMSMessageStoreAttributes/EDIMLocation.ta';
export {
    EDIMLocation,
    _decode_EDIMLocation,
    _encode_EDIMLocation,
...
import { id_cat_related_edims } from '../EDIMSObjectIdentifiers/id-cat-related-edims.va';
export { id_cat_related_edims } from '../EDIMSObjectIdentifiers/id-cat-related-edims.va';
