...
} from '../EDIMSInformationObjects/NNExtensionsSubField.ta';
export {
    NNExtensionsSubField,
    _decode_NNExtensionsSubField,
    _encode_NNExtensionsSubField,
} from '../EDIMSInformationObjects/NNExtensionsSubField.ta';
import { id_nat_nn_extensions } from '../EDIMSObjectIdentifiers/id-nat-nn-extensions.va';
export { id_nat_nn_extensions } from '../EDIMSObjectIdentifiers/id-nat-nn-extensions.va';
