...
} from '../EDIMSMessageStoreAttributes/EDIMSynopsis.ta.js';
export {
    EDIMSynopsis,
    _decode_EDIMSynopsis,
    _encode_EDIMSynopsis,
} from '../EDIMSMessageStoreAttributes/EDIMSynopsis.ta.js';
import { id_sat_edim_synopsis } from '../EDIMSObjectIdentifiers/id-sat-edim-synopsis.va.js';
export { id_sat_edim_synopsis } from '../EDIMSObjectIdentifiers/id-sat-edim-synopsis.va.js';
