...
import { id_hat_edi_message_type } from '../EDIMSObjectIdentifiers/id-hat-edi-message-type.va.js';
export { id_hat_edi_message_type } from '../EDIMSObjectIdentifiers/id-hat-edi-message-type.va.js';
