...
} from '../EDIMSInformationObjects/PNExtensionsSubField.ta';
export {
    PNExtensionsSubField,
    _decode_PNExtensionsSubField,
    _encode_PNExtensionsSubField,
} from '../EDIMSInformationObjects/PNExtensionsSubField.ta';
import { id_nat_pn_extensions } from '../EDIMSObjectIdentifiers/id-nat-pn-extensions.va';
export { id_nat_pn_extensions } from '../EDIMSObjectIdentifiers/id-nat-pn-extensions.va';
