...
} from '../EDIMSInformationObjects/NotificationExtensionsSubField.ta.js';
export {
    NotificationExtensionsSubField,
    _decode_NotificationExtensionsSubField,
    _encode_NotificationExtensionsSubField,
} from '../EDIMSInformationObjects/NotificationExtensionsSubField.ta.js';
import { id_nat_notification_extensions } from '../EDIMSObjectIdentifiers/id-nat-notification-extensions.va.js';
export { id_nat_notification_extensions } from '../EDIMSObjectIdentifiers/id-nat-notification-extensions.va.js';
