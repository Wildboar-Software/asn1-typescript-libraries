...
} from '../EDIMSInformationObjects/NotificationExtensionsSubField.ta';
export {
    NotificationExtensionsSubField,
    _decode_NotificationExtensionsSubField,
    _encode_NotificationExtensionsSubField,
} from '../EDIMSInformationObjects/NotificationExtensionsSubField.ta';
import { id_nat_notification_extensions } from '../EDIMSObjectIdentifiers/id-nat-notification-extensions.va';
export { id_nat_notification_extensions } from '../EDIMSObjectIdentifiers/id-nat-notification-extensions.va';
