...
} from '../EDIMSInformationObjects/RecipientExtensionsSubField.ta.js';
export {
    RecipientExtensionsSubField,
    _decode_RecipientExtensionsSubField,
    _encode_RecipientExtensionsSubField,
} from '../EDIMSInformationObjects/RecipientExtensionsSubField.ta.js';
import { id_rat_recipient_extensions_for_this_recipient } from '../EDIMSObjectIdentifiers/id-rat-recipient-extensions-for-this-recipient.va.js';
export { id_rat_recipient_extensions_for_this_recipient } from '../EDIMSObjectIdentifiers/id-rat-recipient-extensions-for-this-recipient.va.js';
