...
import { id_hat_edi_application_security_element } from '../EDIMSObjectIdentifiers/id-hat-edi-application-security-element.va.js';
export { id_hat_edi_application_security_element } from '../EDIMSObjectIdentifiers/id-hat-edi-application-security-element.va.js';
