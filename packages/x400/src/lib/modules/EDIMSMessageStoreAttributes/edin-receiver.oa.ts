...
import { id_hat_edin_receiver } from '../EDIMSObjectIdentifiers/id-hat-edin-receiver.va';
export { id_hat_edin_receiver } from '../EDIMSObjectIdentifiers/id-hat-edin-receiver.va';
