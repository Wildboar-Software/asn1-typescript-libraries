...
import { id_nat_pn_supplementary_info } from '../EDIMSObjectIdentifiers/id-nat-pn-supplementary-info.va';
export { id_nat_pn_supplementary_info } from '../EDIMSObjectIdentifiers/id-nat-pn-supplementary-info.va';
