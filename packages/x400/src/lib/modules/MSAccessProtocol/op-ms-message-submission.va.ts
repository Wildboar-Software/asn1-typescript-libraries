...
/* START_OF_SYMBOL_DEFINITION op_ms_message_submission */
/**
 ...
 * @constant
 */
export const op_ms_message_submission: Code = { local: 3 };
/* END_OF_SYMBOL_DEFINITION op_ms_message_submission */
