 ...
 * @description
 *
 * `originate_rn_ResultType`. Defined in ITU-T X.420 (1999) (§8).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
...
export class originate_rn_ResultType {
    ...
    /**
     * @summary Restructures an object into a originate_rn_ResultType
     * @description
     *
     * This takes an `object` and converts it to a `originate_rn_ResultType`.
     *
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `originate_rn_ResultType`.
     * @returns {originate_rn_ResultType}
     */
    public static _from_object(
        _o: {
            [_K in keyof originate_rn_ResultType]: originate_rn_ResultType[_K];
        }
    ): originate_rn_ResultType {
        return new originate_rn_ResultType(
 ...
 * @constant
 */
export const _root_component_type_list_1_spec_for_originate_rn_ResultType: $.ComponentSpec[] = [
    new $.ComponentSpec(
 ...
 * @returns {originate_rn_ResultType} The decoded data structure.
 */
export function _decode_originate_rn_ResultType(el: _Element): originate_rn_ResultType {
    if (!_cached_decoder_for_originate_rn_ResultType) {
        _cached_decoder_for_originate_rn_ResultType = function (
            el: _Element
        ): originate_rn_ResultType {
            ...
            $._parse_set(
                el,
                callbacks,
                _root_component_type_list_1_spec_for_originate_rn_ResultType,
                _extension_additions_list_spec_for_originate_rn_ResultType,
                _root_component_type_list_2_spec_for_originate_rn_ResultType,
                undefined
            );
            return new originate_rn_ResultType /* SET_CONSTRUCTOR_CALL */(
 ...
 * @returns {_Element} The originate_rn_ResultType, encoded as an ASN.1 Element.
 */
export function _encode_originate_rn_ResultType(
    value: originate_rn_ResultType,
    elGetter: $.ASN1Encoder<originate_rn_ResultType>
): _Element {
    if (!_cached_encoder_for_originate_rn_ResultType) {
        _cached_encoder_for_originate_rn_ResultType = function (
            value: originate_rn_ResultType        ): _Element {
            return $._encodeSet(
