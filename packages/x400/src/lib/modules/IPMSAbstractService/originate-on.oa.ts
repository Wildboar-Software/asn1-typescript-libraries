...
} from '../IPMSAbstractService/originate-on-ArgumentType.ta.js';
export {
    originate_on_ArgumentType,
    _decode_originate_on_ArgumentType,
    _encode_originate_on_ArgumentType,
...
} from '../IPMSAbstractService/originate-on-ResultType.ta.js';
export {
    originate_on_ResultType,
    _decode_originate_on_ResultType,
    _encode_originate_on_ResultType,
...
/* START_OF_SYMBOL_DEFINITION originate_on */
/**
...
/* END_OF_SYMBOL_DEFINITION originate_on */
