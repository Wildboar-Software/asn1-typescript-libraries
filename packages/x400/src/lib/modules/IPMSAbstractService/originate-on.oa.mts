 ...
 * @description
 *
 * Information object `originate_on`. The Originate ON abstract operation originates a
 * message whose content is an ON. originate-on ABSTRACT-OPERATION ::= { ARGUMENT SET {
 * envelope [0] MessageSubmissionEnvelope, content [1] ON} RESULT SET {
 ...
 * This abstract operation has the following… See ITU-T X.420 (1999), §12.1.4.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
