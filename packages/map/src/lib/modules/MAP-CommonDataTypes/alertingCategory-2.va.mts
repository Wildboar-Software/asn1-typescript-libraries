...
/**
 * @summary alertingCategory_2
 * @description
 *
 * Alerting category 2 (`00000101`B). Bits 43 = 01 (category). Other category
 ...
 */
export
const alertingCategory_2: AlertingPattern = new Uint8Array([ 0x05 ]);
