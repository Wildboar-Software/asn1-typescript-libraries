...
let _cached_decoder_for_MGW_InterfaceList: $.ASN1Decoder<MGW_InterfaceList> | null = null;
 ...
 */
export
function _decode_MGW_InterfaceList (el: _Element): MGW_InterfaceList {
    if (!_cached_decoder_for_MGW_InterfaceList) { _cached_decoder_for_MGW_InterfaceList = $._decodeBitString; }
    return _cached_decoder_for_MGW_InterfaceList(el);
}

let _cached_encoder_for_MGW_InterfaceList: $.ASN1Encoder<MGW_InterfaceList> | null = null;
 ...
 */
export
function _encode_MGW_InterfaceList (value: MGW_InterfaceList, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MGW_InterfaceList) { _cached_encoder_for_MGW_InterfaceList = $._encodeBitString; }
    return _cached_encoder_for_MGW_InterfaceList(value, elGetter);
}
