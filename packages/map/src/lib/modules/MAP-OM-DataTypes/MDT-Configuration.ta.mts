...
const _root_component_type_list_1_spec_for_MDT_Configuration: $.ComponentSpec[] = [
    new $.ComponentSpec("jobType", false, $.hasTag(_TagClass.universal, 10)),
    new $.ComponentSpec("areaScope", true, $.hasTag(_TagClass.universal, 16)),
    new $.ComponentSpec("listOfMeasurements", true, $.hasTag(_TagClass.universal, 4)),
    new $.ComponentSpec("reportingTrigger", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("reportInterval", true, $.hasTag(_TagClass.universal, 10)),
    new $.ComponentSpec("reportAmount", true, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("eventThresholdRSRP", true, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("eventThresholdRSRQ", true, $.hasTag(_TagClass.context, 2)),
    new $.ComponentSpec("loggingInterval", true, $.hasTag(_TagClass.context, 3)),
    new $.ComponentSpec("loggingDuration", true, $.hasTag(_TagClass.context, 4)),
...
const _extension_additions_list_spec_for_MDT_Configuration: $.ComponentSpec[] = [
    new $.ComponentSpec("measurementPeriodUMTS", true, $.hasTag(_TagClass.context, 6)),
    new $.ComponentSpec("measurementPeriodLTE", true, $.hasTag(_TagClass.context, 7)),
    new $.ComponentSpec("collectionPeriodRRM-UMTS", true, $.hasTag(_TagClass.context, 8)),
    new $.ComponentSpec("collectionPeriodRRM-LTE", true, $.hasTag(_TagClass.context, 9)),
    new $.ComponentSpec("positioningMethod", true, $.hasTag(_TagClass.context, 10)),
    new $.ComponentSpec("measurementQuantity", true, $.hasTag(_TagClass.context, 11)),
    new $.ComponentSpec("eventThreshold1F", true, $.hasTag(_TagClass.context, 12)),
    new $.ComponentSpec("eventThreshold1I", true, $.hasTag(_TagClass.context, 13)),
    new $.ComponentSpec("mdt-Allowed-PLMN-List", true, $.hasTag(_TagClass.context, 14))
];
...
function _decode_MDT_Configuration (el: _Element): MDT_Configuration {
    ...
    let jobType!: JobType;
    let areaScope: OPTIONAL<AreaScope> = undefined;
    let listOfMeasurements: OPTIONAL<ListOfMeasurements> = undefined;
    let reportingTrigger: OPTIONAL<ReportingTrigger> = undefined;
    let reportInterval: OPTIONAL<ReportInterval> = undefined;
    let reportAmount: OPTIONAL<ReportAmount> = undefined;
    let eventThresholdRSRP: OPTIONAL<EventThresholdRSRP> = undefined;
    let eventThresholdRSRQ: OPTIONAL<EventThresholdRSRQ> = undefined;
    let loggingInterval: OPTIONAL<LoggingInterval> = undefined;
    let loggingDuration: OPTIONAL<LoggingDuration> = undefined;
    let extensionContainer: OPTIONAL<ExtensionContainer> = undefined;
    let measurementPeriodUMTS: OPTIONAL<PeriodUMTS> = undefined;
    let measurementPeriodLTE: OPTIONAL<PeriodLTE> = undefined;
    let collectionPeriodRRM_UMTS: OPTIONAL<PeriodUMTS> = undefined;
    let collectionPeriodRRM_LTE: OPTIONAL<PeriodLTE> = undefined;
    let positioningMethod: OPTIONAL<PositioningMethod> = undefined;
    let measurementQuantity: OPTIONAL<MeasurementQuantity> = undefined;
    let eventThreshold1F: OPTIONAL<EventThreshold1F> = undefined;
    let eventThreshold1I: OPTIONAL<EventThreshold1I> = undefined;
    let mdt_Allowed_PLMN_List: OPTIONAL<MDT_Allowed_PLMNId_List> = undefined;
