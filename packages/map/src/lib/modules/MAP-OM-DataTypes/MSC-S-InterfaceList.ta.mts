...
let _cached_decoder_for_MSC_S_InterfaceList: $.ASN1Decoder<MSC_S_InterfaceList> | null = null;
 ...
 */
export
function _decode_MSC_S_InterfaceList (el: _Element): MSC_S_InterfaceList {
    if (!_cached_decoder_for_MSC_S_InterfaceList) { _cached_decoder_for_MSC_S_InterfaceList = $._decodeBitString; }
    return _cached_decoder_for_MSC_S_InterfaceList(el);
}

let _cached_encoder_for_MSC_S_InterfaceList: $.ASN1Encoder<MSC_S_InterfaceList> | null = null;
 ...
 */
export
function _encode_MSC_S_InterfaceList (value: MSC_S_InterfaceList, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MSC_S_InterfaceList) { _cached_encoder_for_MSC_S_InterfaceList = $._encodeBitString; }
    return _cached_encoder_for_MSC_S_InterfaceList(value, elGetter);
}
