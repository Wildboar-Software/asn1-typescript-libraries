 ...
 * 
 * @constant
 * @type {OPERATION<AnyTimeModificationArg, AnyTimeModificationRes>}
 * @implements {OPERATION<AnyTimeModificationArg, AnyTimeModificationRes>}
 */
export
const anyTimeModification: OPERATION<AnyTimeModificationArg, AnyTimeModificationRes> = {
    class: "OPERATION",
    decoderFor: {
        "&ArgumentType": _decode_AnyTimeModificationArg,
        "&ResultType": _decode_AnyTimeModificationRes,
    },
    encoderFor: {
        "&ArgumentType": _encode_AnyTimeModificationArg,
        "&ResultType": _encode_AnyTimeModificationRes,
    },
    "&Errors": [ atm_NotAllowed, dataMissing, unexpectedDataValue, unknownSubscriber, bearerServiceNotProvisioned, teleserviceNotProvisioned, callBarred, illegalSS_Operation, ss_SubscriptionViolation, ss_ErrorStatus, ss_Incompatibility, informationNotAvailable, ] /* OBJECT_FIELD_SETTING */,
    "&operationCode": { local: 65 } /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
