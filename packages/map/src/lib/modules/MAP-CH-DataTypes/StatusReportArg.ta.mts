...
const _root_component_type_list_1_spec_for_StatusReportArg: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("eventReportData", true, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("callReportdata", true, $.hasTag(_TagClass.context, 2)),
...
function _decode_StatusReportArg (el: _Element): StatusReportArg {
    ...
    let imsi!: IMSI;
    let eventReportData: OPTIONAL<EventReportData> = undefined;
    let callReportdata: OPTIONAL<CallReportData> = undefined;
