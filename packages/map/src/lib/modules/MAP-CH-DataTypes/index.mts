...
export {
    CallOutcome_busy, CallOutcome_failure, CallOutcome_success, _decode_CallOutcome,
    _encode_CallOutcome, _enum_for_CallOutcome, failure, success
...
export {
    ForwardingReason, ForwardingReason_busy,
    ForwardingReason_noReply, ForwardingReason_notReachable, _decode_ForwardingReason,
    _encode_ForwardingReason, _enum_for_ForwardingReason, noReply, notReachable
