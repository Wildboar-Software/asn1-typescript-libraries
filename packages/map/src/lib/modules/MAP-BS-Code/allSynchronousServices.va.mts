...
/**
 * @summary allSynchronousServices
 * @description
 *
 * All synchronous services. Group code. Bit pattern `'01101000'B`.
 ...
 * `allAlternateSpeech-DataCDS`, `allSpeechFollowedByDataCDS` and
 * `allDataPDS-Services` (3GPP TS 29.002 V19.1.0 clause 17.7.10).
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 ...
 */
export
const allSynchronousServices: BearerServiceCode = new Uint8Array([ 0x68 ]);
