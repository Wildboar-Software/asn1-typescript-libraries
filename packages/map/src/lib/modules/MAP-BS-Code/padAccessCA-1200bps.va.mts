...
/**
 * @summary padAccessCA_1200bps
 * @description
 *
 * PAD access CA 1200 bps. Specific service. Bit pattern `'00100010'B` (3GPP TS
 ...
 */
export
const padAccessCA_1200bps: BearerServiceCode = new Uint8Array([ 0x22 ]);
