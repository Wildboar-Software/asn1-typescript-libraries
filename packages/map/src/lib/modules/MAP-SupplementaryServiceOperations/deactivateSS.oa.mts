...
/**
 * @summary deactivateSS
 * @description
 *
 * MAP_DEACTIVATE_SS: deactivate a supplementary service. Used MSC→VLR and
 * VLR→HLR; the VLR relays to the HLR. Confirmed. Typical MAP path: VLR→HLR.
 * Local opcode 13. Timer class `m` (15 s to 30 s). Distinctive errors:
 * `negativePW-Check`, `numberOfPW-AttemptsViolation`. (3GPP TS 29.002 V19.1.0
 * clauses 11.4.1, 17.1.2, 17.3.2.19 and 17.6.4).
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 ...
 */
export
const deactivateSS: OPERATION<SS_ForBS_Code, SS_Info> = {
    class: "OPERATION",
    decoderFor: {
    ...
    "&Errors": [ systemFailure, dataMissing, unexpectedDataValue, bearerServiceNotProvisioned, teleserviceNotProvisioned, callBarred, illegalSS_Operation, ss_ErrorStatus, ss_SubscriptionViolation, negativePW_Check, numberOfPW_AttemptsViolation, ] /* OBJECT_FIELD_SETTING */,
