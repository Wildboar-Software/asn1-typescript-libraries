 ...
 * 
 * @constant
 * @type {OPERATION<SS_ForBS_Code, InterrogateSS_Res>}
 * @implements {OPERATION<SS_ForBS_Code, InterrogateSS_Res>}
 */
export
const interrogateSS: OPERATION<SS_ForBS_Code, InterrogateSS_Res> = {
    class: "OPERATION",
    decoderFor: {
        "&ArgumentType": _decode_SS_ForBS_Code,
        "&ResultType": _decode_InterrogateSS_Res,
    },
    encoderFor: {
        "&ArgumentType": _encode_SS_ForBS_Code,
        "&ResultType": _encode_InterrogateSS_Res,
    },
    "&Errors": [ systemFailure, dataMissing, unexpectedDataValue, bearerServiceNotProvisioned, teleserviceNotProvisioned, callBarred, illegalSS_Operation, ss_NotAvailable, ] /* OBJECT_FIELD_SETTING */,
