...
function _decode_VelocityEstimate (el: _Element): VelocityEstimate {
    if (!_cached_decoder_for_VelocityEstimate) { _cached_decoder_for_VelocityEstimate = $._decodeOctetString; }
...
function _encode_VelocityEstimate (value: VelocityEstimate, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_VelocityEstimate) { _cached_encoder_for_VelocityEstimate = $._encodeOctetString; }
