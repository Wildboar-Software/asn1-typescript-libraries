...
import { ReturnResult_result, _decode_ReturnResult_result, _encode_ReturnResult_result } from "../Remote-Operations-Generic-ROS-PDUs/ReturnResult-result.ta.mjs";
// export { ReturnResult_result, _decode_ReturnResult_result, _encode_ReturnResult_result } from "../Remote-Operations-Generic-ROS-PDUs/ReturnResult-result.ta.mjs";
...
class ReturnResult {
     ...
     */
    public static _from_object (_o: { [_K in keyof (ReturnResult)]: (ReturnResult)[_K] }): ReturnResult {
 ...
 */
export
const _root_component_type_list_1_spec_for_ReturnResult: $.ComponentSpec[] = [
    new $.ComponentSpec("invokeId", false, $.hasAnyTag, undefined, undefined),
    new $.ComponentSpec("result", true, $.hasTag(_TagClass.universal, 16), undefined, undefined)
];
 ...
 */
export
const _root_component_type_list_2_spec_for_ReturnResult: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ReturnResult: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ReturnResult (el: _Element): ReturnResult {
    if (!_cached_decoder_for_ReturnResult) { _cached_decoder_for_ReturnResult = function (el: _Element): ReturnResult {
    let invokeId!: InvokeId;
    let result: OPTIONAL<ReturnResult_result>;
    const callbacks: $.DecodingMap = {
        "invokeId": (_el: _Element): void => { invokeId = _decode_InvokeId(_el); },
        "result": (_el: _Element): void => { result = _decode_ReturnResult_result(_el); }
    };
 ...
 */
export
function _encode_ReturnResult (value: ReturnResult, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReturnResult) { _cached_encoder_for_ReturnResult = function (value: ReturnResult, elGetter: $.ASN1Encoder<ReturnResult>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_InvokeId(value.invokeId, $.BER),
            /* IF_ABSENT  */ ((value.result === undefined) ? undefined : _encode_ReturnResult_result(value.result, $.BER))
        ],
