...
// export { SMS_CAMEL_TDP_DataList, _decode_SMS_CAMEL_TDP_DataList, _encode_SMS_CAMEL_TDP_DataList } from "../MAP-MS-DataTypes/SMS-CAMEL-TDP-DataList.ta.mjs";
...
const _root_component_type_list_1_spec_for_SMS_CSI: $.ComponentSpec[] = [
    new $.ComponentSpec("sms-CAMEL-TDP-DataList", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
...
function _decode_SMS_CSI (el: _Element): SMS_CSI {
    ...
    let sms_CAMEL_TDP_DataList: OPTIONAL<SMS_CAMEL_TDP_DataList>;
