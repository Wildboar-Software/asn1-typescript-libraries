...
import { DefaultCallHandling, _decode_DefaultCallHandling, _encode_DefaultCallHandling, _enum_for_DefaultCallHandling } from "../MAP-MS-DataTypes/DefaultCallHandling.ta.mjs";
 ...
 * @description
 *
 * One D-CSI analysed-info criterion: dialled number, service key, gsmSCF
 * address and default call handling (3GPP TS 29.002 V19.1.0 clauses 7.6.5.7A,
 * 7.6.2.58 and 17.7.1).
 *
 * ### ASN.1 Definition:
 * 
...
class DP_AnalysedInfoCriterium {
    constructor (
         ...
         * @description
         *
         * Default call handling if the CAMEL service is not available (3GPP TS
