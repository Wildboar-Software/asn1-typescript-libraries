...
class M_CSI {
    ...
    /**
     * @summary Restructures an object into a M_CSI
     * @description
     * 
     * This takes an `object` and converts it to a `M_CSI`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `M_CSI`.
     * @returns {M_CSI}
     */
    public static _from_object (_o: { [_K in keyof (M_CSI)]: (M_CSI)[_K] }): M_CSI {
        return new M_CSI(_o.mobilityTriggers, _o.serviceKey, _o.gsmSCF_Address, _o.extensionContainer, _o.notificationToCSE, _o.csi_Active, _o._unrecognizedExtensionsList);
    }
...
/**
 * @summary The Leading Root Component Types of M_CSI
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_M_CSI: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of M_CSI
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_M_CSI: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of M_CSI
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_M_CSI: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_M_CSI: $.ASN1Decoder<M_CSI> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) M_CSI
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_M_CSI (el: _Element): M_CSI {
    if (!_cached_decoder_for_M_CSI) { _cached_decoder_for_M_CSI = function (el: _Element): M_CSI {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_M_CSI,
        _extension_additions_list_spec_for_M_CSI,
        _root_component_type_list_2_spec_for_M_CSI,
    ...
    return _cached_decoder_for_M_CSI(el);
}

let _cached_encoder_for_M_CSI: $.ASN1Encoder<M_CSI> | null = null;

/**
 * @summary Encodes a(n) M_CSI into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The M_CSI, encoded as an ASN.1 Element.
 */
export
function _encode_M_CSI (value: M_CSI, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_M_CSI) { _cached_encoder_for_M_CSI = function (value: M_CSI, elGetter: $.ASN1Encoder<M_CSI>): _Element {
    ...
    return _cached_encoder_for_M_CSI(value, elGetter);
}
