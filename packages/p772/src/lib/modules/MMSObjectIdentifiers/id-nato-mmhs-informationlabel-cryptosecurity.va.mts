...
/**
 * @summary id_nato_mmhs_informationlabel_cryptosecurity
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * id-nato-mmhs-informationlabel-cryptosecurity ID ::= {id-informationlabel  2}
 * ```
 * 
 * @constant
 */
export
const id_nato_mmhs_informationlabel_cryptosecurity: ID = _OID.fromParts([
    2,
], id_informationlabel);
