...
/**
 * @summary id_nato_mmhs_informationlabel_eyesonly
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * id-nato-mmhs-informationlabel-eyesonly ID ::= {id-informationlabel  5}
 * ```
 * 
 * @constant
 */
export
const id_nato_mmhs_informationlabel_eyesonly: ID = _OID.fromParts([
    5,
], id_informationlabel);
