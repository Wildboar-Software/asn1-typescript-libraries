...
/**
 * @summary id_nato_mmhs_informationlabel_ussiopesi
 * @description
 * 
 * ### ASN.1 Definition:
 * 
 * ```asn1
 * id-nato-mmhs-informationlabel-ussiopesi ID ::= {id-informationlabel  4}
 * ```
 * 
 * @constant
 */
export
const id_nato_mmhs_informationlabel_ussiopesi: ID = _OID.fromParts([
    4,
], id_informationlabel);
