 ...
 * @description
 *
 * Classifications in *other* policies equivalent to this
 * `labelAndCertValue`. SIZE (0..MAX). ITU-T Rec. X.841
 * (10/2000) [§6.2.2.6](https://www.itu.int/rec/T-REC-X.841-200010-I).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_EquivalentClassifications(el: _Element): EquivalentClassifications {
