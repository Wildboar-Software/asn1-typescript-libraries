 ...
 */
export
function _decode_InformationType (el: _Element) {
    if (!_cached_decoder_for_InformationType) { _cached_decoder_for_InformationType = $._decodeObjectIdentifier; }
 ...
 */
export
function _encode_InformationType (value: InformationType, elGetter: $.ASN1Encoder<InformationType>) {
    if (!_cached_encoder_for_InformationType) { _cached_encoder_for_InformationType = $._encodeObjectIdentifier; }
