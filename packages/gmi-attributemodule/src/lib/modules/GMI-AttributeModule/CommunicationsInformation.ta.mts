...
export { InformationType, _decode_InformationType, _encode_InformationType } from "../GMI-AttributeModule/InformationType.ta.mjs";
import { InformationData, _decode_InformationData, _encode_InformationData } from "../GMI-AttributeModule/InformationData.ta.mjs";
export { InformationData, _decode_InformationData, _encode_InformationData } from "../GMI-AttributeModule/InformationData.ta.mjs";
...
function _encode_CommunicationsInformation (value: CommunicationsInformation, elGetter: $.ASN1Encoder<CommunicationsInformation>) {
    if (!_cached_encoder_for_CommunicationsInformation) { _cached_encoder_for_CommunicationsInformation = function (value: CommunicationsInformation, elGetter: $.ASN1Encoder<CommunicationsInformation>): _Element {
