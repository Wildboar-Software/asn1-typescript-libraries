 ...
 */
export
function _decode_ConnectionId (el: _Element) {
    if (!_cached_decoder_for_ConnectionId) { _cached_decoder_for_ConnectionId = $._decodeGraphicString; }
 ...
 */
export
function _encode_ConnectionId (value: ConnectionId, elGetter: $.ASN1Encoder<ConnectionId>) {
    if (!_cached_encoder_for_ConnectionId) { _cached_encoder_for_ConnectionId = $._encodeGraphicString; }
