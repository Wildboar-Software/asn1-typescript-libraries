 ...
 */
export
function _decode_SubsystemId (el: _Element) {
    if (!_cached_decoder_for_SubsystemId) { _cached_decoder_for_SubsystemId = $._decodeGraphicString; }
 ...
 */
export
function _encode_SubsystemId (value: SubsystemId, elGetter: $.ASN1Encoder<SubsystemId>) {
    if (!_cached_encoder_for_SubsystemId) { _cached_encoder_for_SubsystemId = $._encodeGraphicString; }
