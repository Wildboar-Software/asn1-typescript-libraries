...
/* START_OF_SYMBOL_DEFINITION ApplicationProcessId */
/**
 ...
 */
export
function _decode_ApplicationProcessId (el: _Element) {
    if (!_cached_decoder_for_ApplicationProcessId) { _cached_decoder_for_ApplicationProcessId = $._decodeGraphicString; }
 ...
 */
export
function _encode_ApplicationProcessId (value: ApplicationProcessId, elGetter: $.ASN1Encoder<ApplicationProcessId>) {
    if (!_cached_encoder_for_ApplicationProcessId) { _cached_encoder_for_ApplicationProcessId = $._encodeGraphicString; }
