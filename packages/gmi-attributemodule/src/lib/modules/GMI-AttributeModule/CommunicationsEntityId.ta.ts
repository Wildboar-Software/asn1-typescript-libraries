 ...
 */
export
function _decode_CommunicationsEntityId (el: _Element) {
    if (!_cached_decoder_for_CommunicationsEntityId) { _cached_decoder_for_CommunicationsEntityId = $._decodeGraphicString; }
 ...
 */
export
function _encode_CommunicationsEntityId (value: CommunicationsEntityId, elGetter: $.ASN1Encoder<CommunicationsEntityId>) {
    if (!_cached_encoder_for_CommunicationsEntityId) { _cached_encoder_for_CommunicationsEntityId = $._encodeGraphicString; }
