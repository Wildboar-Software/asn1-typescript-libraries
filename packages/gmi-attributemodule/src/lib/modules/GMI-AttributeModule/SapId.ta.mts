 ...
 */
export
function _decode_SapId (el: _Element) {
    if (!_cached_decoder_for_SapId) { _cached_decoder_for_SapId = $._decodeGraphicString; }
 ...
 */
export
function _encode_SapId (value: SapId, elGetter: $.ASN1Encoder<SapId>) {
    if (!_cached_encoder_for_SapId) { _cached_encoder_for_SapId = $._encodeGraphicString; }
