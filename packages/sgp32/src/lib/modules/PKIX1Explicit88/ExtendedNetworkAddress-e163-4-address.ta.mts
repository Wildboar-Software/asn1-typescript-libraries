...
class ExtendedNetworkAddress_e163_4_address {
     ...
     */
    public static _from_object (_o: { [_K in keyof (ExtendedNetworkAddress_e163_4_address)]: (ExtendedNetworkAddress_e163_4_address)[_K] }): ExtendedNetworkAddress_e163_4_address {
        return new ExtendedNetworkAddress_e163_4_address(_o.number_, _o.sub_address);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_ExtendedNetworkAddress_e163_4_address: $.ComponentSpec[] = [
    new $.ComponentSpec("number", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("sub-address", true, $.hasTag(_TagClass.context, 1))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_ExtendedNetworkAddress_e163_4_address: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_ExtendedNetworkAddress_e163_4_address: $.ComponentSpec[] = [
 ...
 */
export
function _decode_ExtendedNetworkAddress_e163_4_address (el: _Element): ExtendedNetworkAddress_e163_4_address {
    if (!_cached_decoder_for_ExtendedNetworkAddress_e163_4_address) { _cached_decoder_for_ExtendedNetworkAddress_e163_4_address = function (el: _Element): ExtendedNetworkAddress_e163_4_address {
    let number_!: NumericString;
    let sub_address: OPTIONAL<NumericString>;
    const callbacks: $.DecodingMap = {
        "number": (_el: _Element): void => { number_ = $._decode_implicit<NumericString>(() => $._decodeNumericString)(_el); },
        "sub-address": (_el: _Element): void => { sub_address = $._decode_implicit<NumericString>(() => $._decodeNumericString)(_el); }
    };
...
function _encode_ExtendedNetworkAddress_e163_4_address (value: ExtendedNetworkAddress_e163_4_address, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.sub_address === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => $._encodeNumericString, $.BER)(value.sub_address, $.BER))
        ],
    ).filter((c: (_Element | undefined)): c is _Element => (!!c)), $.BER);
}; }
    return _cached_encoder_for_ExtendedNetworkAddress_e163_4_address(value, elGetter);
}
