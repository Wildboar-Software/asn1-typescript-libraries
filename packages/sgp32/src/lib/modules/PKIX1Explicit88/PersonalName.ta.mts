...
class PersonalName {
     ...
     */
    public static _from_object (_o: { [_K in keyof (PersonalName)]: (PersonalName)[_K] }): PersonalName {
 ...
 */
export
const _root_component_type_list_1_spec_for_PersonalName: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_PersonalName: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_PersonalName: $.ComponentSpec[] = [
 ...
 */
export
function _decode_PersonalName (el: _Element): PersonalName {
    if (!_cached_decoder_for_PersonalName) { _cached_decoder_for_PersonalName = function (el: _Element): PersonalName {
    ...
    const callbacks: $.DecodingMap = {
        "surname": (_el: _Element): void => { surname = $._decode_implicit<PrintableString>(() => $._decodePrintableString)(_el); },
        "given-name": (_el: _Element): void => { given_name = $._decode_implicit<PrintableString>(() => $._decodePrintableString)(_el); },
        "initials": (_el: _Element): void => { initials = $._decode_implicit<PrintableString>(() => $._decodePrintableString)(_el); },
        "generation-qualifier": (_el: _Element): void => { generation_qualifier = $._decode_implicit<PrintableString>(() => $._decodePrintableString)(_el); }
    };
...
function _encode_PersonalName (value: PersonalName, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSet(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.given_name === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => $._encodePrintableString, $.BER)(value.given_name, $.BER)),
            /* IF_ABSENT  */ ((value.initials === undefined) ? undefined : $._encode_implicit(_TagClass.context, 2, () => $._encodePrintableString, $.BER)(value.initials, $.BER)),
            /* IF_ABSENT  */ ((value.generation_qualifier === undefined) ? undefined : $._encode_implicit(_TagClass.context, 3, () => $._encodePrintableString, $.BER)(value.generation_qualifier, $.BER))
        ],
