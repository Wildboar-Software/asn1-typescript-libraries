...
class BuiltInStandardAttributes {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BuiltInStandardAttributes)]: (BuiltInStandardAttributes)[_K] }): BuiltInStandardAttributes {
 ...
 */
export
const _root_component_type_list_1_spec_for_BuiltInStandardAttributes: $.ComponentSpec[] = [
    new $.ComponentSpec("country-name", true, $.hasTag(_TagClass.application, 1)),
    new $.ComponentSpec("administration-domain-name", true, $.hasTag(_TagClass.application, 2)),
    new $.ComponentSpec("network-address", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("terminal-identifier", true, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("private-domain-name", true, $.hasTag(_TagClass.context, 2)),
    new $.ComponentSpec("organization-name", true, $.hasTag(_TagClass.context, 3)),
    new $.ComponentSpec("numeric-user-identifier", true, $.hasTag(_TagClass.context, 4)),
    new $.ComponentSpec("personal-name", true, $.hasTag(_TagClass.context, 5)),
    new $.ComponentSpec("organizational-unit-names", true, $.hasTag(_TagClass.context, 6))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BuiltInStandardAttributes: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BuiltInStandardAttributes: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BuiltInStandardAttributes (el: _Element): BuiltInStandardAttributes {
    if (!_cached_decoder_for_BuiltInStandardAttributes) { _cached_decoder_for_BuiltInStandardAttributes = function (el: _Element): BuiltInStandardAttributes {
    ...
    const callbacks: $.DecodingMap = {
        "country-name": (_el: _Element): void => { country_name = _decode_CountryName(_el); },
        "administration-domain-name": (_el: _Element): void => { administration_domain_name = _decode_AdministrationDomainName(_el); },
        "network-address": (_el: _Element): void => { network_address = $._decode_implicit<NetworkAddress>(() => _decode_NetworkAddress)(_el); },
        "terminal-identifier": (_el: _Element): void => { terminal_identifier = $._decode_implicit<TerminalIdentifier>(() => _decode_TerminalIdentifier)(_el); },
        "private-domain-name": (_el: _Element): void => { private_domain_name = $._decode_explicit<PrivateDomainName>(() => _decode_PrivateDomainName)(_el); },
        "organization-name": (_el: _Element): void => { organization_name = $._decode_implicit<OrganizationName>(() => _decode_OrganizationName)(_el); },
        "numeric-user-identifier": (_el: _Element): void => { numeric_user_identifier = $._decode_implicit<NumericUserIdentifier>(() => _decode_NumericUserIdentifier)(_el); },
        "personal-name": (_el: _Element): void => { personal_name = $._decode_implicit<PersonalName>(() => _decode_PersonalName)(_el); },
        "organizational-unit-names": (_el: _Element): void => { organizational_unit_names = $._decode_implicit<OrganizationalUnitNames>(() => _decode_OrganizationalUnitNames)(_el); }
    };
...
function _encode_BuiltInStandardAttributes (value: BuiltInStandardAttributes, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_ABSENT  */ ((value.administration_domain_name === undefined) ? undefined : _encode_AdministrationDomainName(value.administration_domain_name, $.BER)),
            /* IF_ABSENT  */ ((value.network_address === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => _encode_NetworkAddress, $.BER)(value.network_address, $.BER)),
            /* IF_ABSENT  */ ((value.terminal_identifier === undefined) ? undefined : $._encode_implicit(_TagClass.context, 1, () => _encode_TerminalIdentifier, $.BER)(value.terminal_identifier, $.BER)),
            /* IF_ABSENT  */ ((value.private_domain_name === undefined) ? undefined : $._encode_explicit(_TagClass.context, 2, () => _encode_PrivateDomainName, $.BER)(value.private_domain_name, $.BER)),
            /* IF_ABSENT  */ ((value.organization_name === undefined) ? undefined : $._encode_implicit(_TagClass.context, 3, () => _encode_OrganizationName, $.BER)(value.organization_name, $.BER)),
            /* IF_ABSENT  */ ((value.numeric_user_identifier === undefined) ? undefined : $._encode_implicit(_TagClass.context, 4, () => _encode_NumericUserIdentifier, $.BER)(value.numeric_user_identifier, $.BER)),
            /* IF_ABSENT  */ ((value.personal_name === undefined) ? undefined : $._encode_implicit(_TagClass.context, 5, () => _encode_PersonalName, $.BER)(value.personal_name, $.BER)),
            /* IF_ABSENT  */ ((value.organizational_unit_names === undefined) ? undefined : $._encode_implicit(_TagClass.context, 6, () => _encode_OrganizationalUnitNames, $.BER)(value.organizational_unit_names, $.BER))
        ],
