 ...
 */
export
function _decode_StreetAddress (el: _Element): StreetAddress {
    if (!_cached_decoder_for_StreetAddress) { _cached_decoder_for_StreetAddress = _decode_PDSParameter; }
 ...
 */
export
function _encode_StreetAddress (value: StreetAddress, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_StreetAddress) { _cached_encoder_for_StreetAddress = _encode_PDSParameter; }
