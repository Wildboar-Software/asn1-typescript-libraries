 ...
 * attacks. KDF is the default for the associated domain parameters. [SEC 1 v2](https://www.secg.org/sec1-v2.pdf)
 * §6.1, §5.2, §C.5.
 *
 * ### ASN.1 Definition:
 * 
 ...
 */
export
const dhSinglePass_cofactorDH_recommendedKDF: OBJECT_IDENTIFIER = _OID.fromParts([
    1,
], secg_scheme);
