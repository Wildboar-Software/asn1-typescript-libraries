 ...
 * is given in the parameters (`KeyDerivationFunction`). [SEC 1 v2](https://www.secg.org/sec1-v2.pdf) §6.2, §C.5.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 ...
 */
export
const mqvFull_specifiedKDF: OBJECT_IDENTIFIER = _OID.fromParts([
    6,
], secg_scheme);
