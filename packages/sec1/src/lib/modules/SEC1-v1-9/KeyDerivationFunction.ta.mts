 ...
 */
export
function _decode_KeyDerivationFunction (el: _Element): KeyDerivationFunction {
 ...
 */
export
function _encode_KeyDerivationFunction (value: KeyDerivationFunction, elGetter: $.ASN1Encoder<KeyDerivationFunction>): _Element {
