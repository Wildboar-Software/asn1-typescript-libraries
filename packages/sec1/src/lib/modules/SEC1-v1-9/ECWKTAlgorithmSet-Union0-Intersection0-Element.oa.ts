...
import { ecwkt_recommendedParameters } from "../SEC1-v1-9/ecwkt-recommendedParameters.va.js";
export { ecwkt_recommendedParameters } from "../SEC1-v1-9/ecwkt-recommendedParameters.va.js";
 ...
 * 
 * ```asn1
 * ECWKTAlgorithmSet-Union0-Intersection0-Element ::= {} -- REMOVED_FROM_UNNESTING --
 * ```
 * 
 * @constant
 * @type {ALGORITHM}
 ...
 */
export
const ECWKTAlgorithmSet_Union0_Intersection0_Element: ALGORITHM = {
    class: "ALGORITHM",
    decoderFor: {
        "&Type": undefined,
    },
