 ...
 * attacks. SHA-512 KDF. [SEC 1 v2](https://www.secg.org/sec1-v2.pdf) §6.1, §5.2, §C.5.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
 ...
 */
export
const dhSinglePass_cofactorDH_sha512kdf_scheme: OBJECT_IDENTIFIER = _OID.fromParts([
    14,
    3,
], secg_scheme);
