...
function _encode_SpecifiedMultiples_Item (value: SpecifiedMultiples_Item, elGetter: $.ASN1Encoder<SpecifiedMultiples_Item>) {
    if (!_cached_encoder_for_SpecifiedMultiples_Item) { _cached_encoder_for_SpecifiedMultiples_Item = function (value: SpecifiedMultiples_Item, elGetter: $.ASN1Encoder<SpecifiedMultiples_Item>): _Element {
