...
import { hmac_half_ecies } from "../SEC1-v1-9/hmac-half-ecies.va.js";
export { hmac_half_ecies } from "../SEC1-v1-9/hmac-half-ecies.va.js";
 ...
 * 
 * ```asn1
 * MACSet-Union1-Intersection0-Element ::= {} -- REMOVED_FROM_UNNESTING --
 * ```
 * 
 * @constant
 ...
 */
export
const MACSet_Union1_Intersection0_Element: ALGORITHM<HashAlgorithm> = {
    class: "ALGORITHM",
    decoderFor: {
