...
import { mqvFull_specifiedKDF } from "../SEC1-v1-9/mqvFull-specifiedKDF.va.js";
export { mqvFull_specifiedKDF } from "../SEC1-v1-9/mqvFull-specifiedKDF.va.js";
 ...
 * 
 * ```asn1
 * ECMQVAlgorithmSet-Union5-Intersection0-Element ::= {} -- REMOVED_FROM_UNNESTING --
 * ```
 * 
 * @constant
 ...
 */
export
const ECMQVAlgorithmSet_Union5_Intersection0_Element: ALGORITHM<KeyDerivationFunction> = {
    class: "ALGORITHM",
    decoderFor: {
