 ...
 * @description
 * 
 * ECIES using the KDF, MAC, and symmetric cipher recommended for the associated
 * domain parameters. SEC 1 lists the OID but does not enumerate those defaults.
