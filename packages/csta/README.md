# Computer Supported Telecommunications Applications (CSTA) in TypeScript

ASN.1 data structures and PDUs based on the ASN.1 definitions in
[ECMA-269](https://www.ecma-international.org/publications-and-standards/standards/ecma-269/)
(CSTA Phase III).
...
(Cursor Grok 4.6) on 8 September 2026.
