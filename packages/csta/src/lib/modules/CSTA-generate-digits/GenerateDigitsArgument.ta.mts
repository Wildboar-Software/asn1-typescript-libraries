...
import { DigitMode, _enum_for_DigitMode, DigitMode_rotaryPulse /* IMPORTED_LONG_ENUMERATION_ITEM */, rotaryPulse /* IMPORTED_SHORT_ENUMERATION_ITEM */, DigitMode_dTMF /* IMPORTED_LONG_ENUMERATION_ITEM */, dTMF /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_DigitMode, _encode_DigitMode } from "../CSTA-generate-digits/DigitMode.ta.mjs";
// export { DigitMode, _enum_for_DigitMode, DigitMode_rotaryPulse /* IMPORTED_LONG_ENUMERATION_ITEM */, rotaryPulse /* IMPORTED_SHORT_ENUMERATION_ITEM */, DigitMode_dTMF /* IMPORTED_LONG_ENUMERATION_ITEM */, dTMF /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_DigitMode, _encode_DigitMode } from "../CSTA-generate-digits/DigitMode.ta.mjs";
...
const _root_component_type_list_1_spec_for_GenerateDigitsArgument: $.ComponentSpec[] = [
    new $.ComponentSpec("connectionToSendDigits", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("digitMode", true, $.hasTag(_TagClass.universal, 10), undefined, undefined),
    new $.ComponentSpec("charactersToSend", false, $.hasTag(_TagClass.universal, 22), undefined, undefined),
    new $.ComponentSpec("toneDuration", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("pulseRate", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
