...
const _root_component_type_list_1_spec_for_DivertedEvent: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("divertingDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    new $.ComponentSpec("newDestination", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
