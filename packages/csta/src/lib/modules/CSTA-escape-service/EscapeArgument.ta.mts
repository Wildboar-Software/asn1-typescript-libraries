...
const _root_component_type_list_1_spec_for_EscapeArgument: $.ComponentSpec[] = [
    new $.ComponentSpec("escapeRegisterID", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("security", true, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("privateData", false, $.hasAnyTag, undefined, undefined)
];
