...
// export { DeviceList, _decode_DeviceList, _encode_DeviceList } from "../CSTA-switching-function-devices/DeviceList.ta.mjs";
...
const _root_component_type_list_1_spec_for_SwitchingFunctionDevicesArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("deviceList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
