...
const _root_component_type_list_1_spec_for_ParkCallArgument: $.ComponentSpec[] = [
    new $.ComponentSpec("parking", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("parkTo", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    /* FIXME: correlatorData COULD_NOT_RESOLVE_TYPE_DEF */,
    new $.ComponentSpec("subjectOfCall", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("languagePreferences", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
