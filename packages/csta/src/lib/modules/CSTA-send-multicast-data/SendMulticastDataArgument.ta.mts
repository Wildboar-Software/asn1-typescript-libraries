...
const _root_component_type_list_1_spec_for_SendMulticastDataArgument: $.ComponentSpec[] = [
    new $.ComponentSpec("ioCrossRefIDList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("ioData", true, $.hasTag(_TagClass.universal, 4), undefined, undefined),
