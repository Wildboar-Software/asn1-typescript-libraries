...
// export { EventSpecificInfo, _decode_EventSpecificInfo, _encode_EventSpecificInfo } from "../CSTA-event-report-definitions/EventSpecificInfo.ta.mjs";
...
const _root_component_type_list_1_spec_for_CSTAEventReportArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("eventSpecificInfo", false, $.hasAnyTag, undefined, undefined)
];
