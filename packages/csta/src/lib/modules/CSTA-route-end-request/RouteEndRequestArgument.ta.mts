...
// export { ErrorValue, _decode_ErrorValue, _encode_ErrorValue } from "../CSTA-error-definition/ErrorValue.ta.mjs";
...
const _root_component_type_list_1_spec_for_RouteEndRequestArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("errorValue", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
