 ...
 * @description
 *
 * Indicates a prompt has been fully rendered. Reported to a computing function
 ...
 * (ECMA-269 §26.2.2, ECMA-285 §24.2.2).
 *
...
class CompletedEvent {
    constructor (
         ...
         * @description
         *
         * Connection on which the prompt completed (ECMA-269 §26.2.2).
         *
         * @public
         * @readonly
         */
