...
import { AttributeToSet_mode, _enum_for_AttributeToSet_mode, AttributeToSet_mode_automatic /* IMPORTED_LONG_ENUMERATION_ITEM */, automatic /* IMPORTED_SHORT_ENUMERATION_ITEM */, AttributeToSet_mode_single /* IMPORTED_LONG_ENUMERATION_ITEM */, single /* IMPORTED_SHORT_ENUMERATION_ITEM */, AttributeToSet_mode_multiple /* IMPORTED_LONG_ENUMERATION_ITEM */, multiple /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_AttributeToSet_mode, _encode_AttributeToSet_mode } from "../CSTA-set-voice-attribute/AttributeToSet-mode.ta.mjs";
// export { AttributeToSet_mode, _enum_for_AttributeToSet_mode, AttributeToSet_mode_automatic /* IMPORTED_LONG_ENUMERATION_ITEM */, automatic /* IMPORTED_SHORT_ENUMERATION_ITEM */, AttributeToSet_mode_single /* IMPORTED_LONG_ENUMERATION_ITEM */, single /* IMPORTED_SHORT_ENUMERATION_ITEM */, AttributeToSet_mode_multiple /* IMPORTED_LONG_ENUMERATION_ITEM */, multiple /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_AttributeToSet_mode, _encode_AttributeToSet_mode } from "../CSTA-set-voice-attribute/AttributeToSet-mode.ta.mjs";
