...
const _root_component_type_list_1_spec_for_ConnectionClearedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("droppedConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("releasingDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    ...
    new $.ComponentSpec("chargingInfo", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
    ...
    new $.ComponentSpec("droppedConnectionInfo", true, $.hasTag(_TagClass.context, 5), undefined, undefined),
