...
const _root_component_type_list_1_spec_for_CSTASecurityData: $.ComponentSpec[] = [
    new $.ComponentSpec("messageSequenceNumber", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("timestamp", true, $.hasTag(_TagClass.universal, 24)),
    new $.ComponentSpec("securityInfo", true, $.or($.hasTag(_TagClass.universal, 4), $.hasTag(_TagClass.universal, 5)))
];
