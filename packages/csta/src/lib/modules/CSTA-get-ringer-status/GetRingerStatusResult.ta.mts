...
// export { RingerStatusList, _decode_RingerStatusList, _encode_RingerStatusList } from "../CSTA-get-ringer-status/RingerStatusList.ta.mjs";
...
const _root_component_type_list_1_spec_for_GetRingerStatusResult: $.ComponentSpec[] = [
    new $.ComponentSpec("ringerStatusList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
