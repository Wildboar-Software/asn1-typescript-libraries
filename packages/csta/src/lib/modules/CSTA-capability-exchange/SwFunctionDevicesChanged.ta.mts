 ...
 * @description
 * Capability bitmap for the Switching Function Devices Changed service
 * (ECMA-269 C.2.8, ECMA-285 §9.10). Presence of this entry in
 ...
 * @constant
 * @description
 * Alias of `SwFunctionDevicesChanged_privateData`.
 */
export
 ...
 * @constant
 * @description
 * Alias of `SwFunctionDevicesChanged_privateDataInAck`.
 */
export
