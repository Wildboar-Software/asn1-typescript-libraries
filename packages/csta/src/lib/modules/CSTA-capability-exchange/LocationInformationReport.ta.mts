 ...
 * @description
 * Capability bitmap for the Location Information Report service (ECMA-269
 * C.22.6, ECMA-285 §9.10). Presence of this entry in `LocationServicesServList`
 ...
 * @constant
 * @description
 * Alias of `LocationInformationReport_locationInfoList`.
 */
export
 ...
 * @constant
 * @description
 * Alias of `LocationInformationReport_privateData`.
 */
export
 ...
 * @constant
 * @description
 * Alias of `LocationInformationReport_privateDataInAck`.
 */
export
