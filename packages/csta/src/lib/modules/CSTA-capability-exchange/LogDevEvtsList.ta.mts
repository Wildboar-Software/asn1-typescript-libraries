...
const _root_component_type_list_1_spec_for_LogDevEvtsList: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("logicalEvtsList", true, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("mediaEvtsList", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("voiceUnitEvtsList", true, $.hasTag(_TagClass.context, 4), undefined, undefined)
];
