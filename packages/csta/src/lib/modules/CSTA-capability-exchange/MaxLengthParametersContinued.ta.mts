...
const _root_component_type_list_1_spec_for_MaxLengthParametersContinued: $.ComponentSpec[] = [
    new $.ComponentSpec("monitorCrossRefID", false, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("callQualifyingData", false, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("subDomainCallLinkageData", false, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("subDomainThreadID", false, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("ioData", false, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("messageInfo", false, $.hasTag(_TagClass.universal, 2))
];
