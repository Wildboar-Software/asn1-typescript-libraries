...
// export { PrivateEvent, _decode_PrivateEvent, _encode_PrivateEvent } from "../CSTA-capability-exchange/PrivateEvent.ta.mjs";
...
const _root_component_type_list_1_spec_for_VendorSpecificEvtsList: $.ComponentSpec[] = [
    new $.ComponentSpec("privateEvent", true, $.hasTag(_TagClass.context, 0), undefined, undefined)
];
