 ...
 * @constant
 * @description
 * Alias of `ReviewEvent_currentPosition`.
 */
export
 ...
 * @constant
 * @description
 * Alias of `ReviewEvent_servicesPermitted`.
 */
export
 ...
 * @constant
 * @description
 * Alias of `ReviewEvent_privateData`.
 */
export
