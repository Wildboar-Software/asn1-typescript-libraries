 ...
 * @description
 * Capability bitmap for the Change Monitor Filter service (ECMA-269 C.3.1,
 * ECMA-285 §9.10). Presence of this entry in `MonitoringServList` means the SF
 ...
 * @constant
 * @description
 * Alias of `ChangeMonitorFilter_privateData`.
 */
export
 ...
 * @constant
 * @description
 * Alias of `ChangeMonitorFilter_privateDataInAck`.
 */
export
