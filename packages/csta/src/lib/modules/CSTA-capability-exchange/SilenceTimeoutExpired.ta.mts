 ...
 * @description
 * Capability bitmap for the Silence Timeout Expired event (ECMA-269 C.20.11,
 ...
 * @constant
 * @description
 * Alias of `SilenceTimeoutExpired_resource`.
 */
export
 ...
 * @constant
 * @description
 * Alias of `SilenceTimeoutExpired_cause`.
 */
export
 ...
 * separate Annex C prose gloss (ECMA-269 C.20.11).
 */
export
 ...
 * @constant
 * @description
 * Alias of `SilenceTimeoutExpired_servicesPermitted`.
 */
export
 ...
 * @constant
 * @description
 * Alias of `SilenceTimeoutExpired_privateData`.
 */
export
