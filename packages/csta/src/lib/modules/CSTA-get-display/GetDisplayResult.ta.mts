...
// export { DisplayList, _decode_DisplayList, _encode_DisplayList } from "../CSTA-get-display/DisplayList.ta.mjs";
...
const _root_component_type_list_1_spec_for_GetDisplayResult: $.ComponentSpec[] = [
    new $.ComponentSpec("displayList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
