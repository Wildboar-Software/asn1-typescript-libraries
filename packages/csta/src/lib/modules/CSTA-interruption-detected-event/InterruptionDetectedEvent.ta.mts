 ...
 * @description
 *
 * Indicates activity has been detected at an Interactive Voice resource.
 ...
 * alternative (ECMA-285 §24.2). (ECMA-269 §26.2.5, ECMA-285 §24.2.5).
 *
...
class InterruptionDetectedEvent {
    constructor (
         ...
         * @description
         *
         * Connection on which interruption was detected (ECMA-269 §26.2.5).
         *
         * @public
         * @readonly
         */
