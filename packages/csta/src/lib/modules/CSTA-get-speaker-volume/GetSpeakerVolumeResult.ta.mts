...
// export { SpeakerVolumeList, _decode_SpeakerVolumeList, _encode_SpeakerVolumeList } from "../CSTA-get-speaker-volume/SpeakerVolumeList.ta.mjs";
...
const _root_component_type_list_1_spec_for_GetSpeakerVolumeResult: $.ComponentSpec[] = [
    new $.ComponentSpec("speakerVolumeList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
