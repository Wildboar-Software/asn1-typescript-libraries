...
const _root_component_type_list_1_spec_for_MonitorStartResult: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("actualmonitorFilter", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("actualMonitorMediaClass", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("monitorExistingCalls", true, $.hasTag(_TagClass.universal, 1), undefined, undefined),
