...
// export { LampList, _decode_LampList, _encode_LampList } from "../CSTA-get-lamp-information/LampList.ta.mjs";
...
const _root_component_type_list_1_spec_for_GetLampInformationResult: $.ComponentSpec[] = [
    new $.ComponentSpec("lampList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
