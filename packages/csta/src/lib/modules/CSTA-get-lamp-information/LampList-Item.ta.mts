 ...
 * 
 * ```asn1
 * LampList-Item ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
const _root_component_type_list_1_spec_for_LampList_Item: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("lampLabel", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("button", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
