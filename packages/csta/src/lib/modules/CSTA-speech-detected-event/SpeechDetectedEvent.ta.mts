...
class SpeechDetectedEvent {
    ...
    /**
     * @summary Restructures an object into a SpeechDetectedEvent
     * @description
     * 
     * This takes an `object` and converts it to a `SpeechDetectedEvent`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `SpeechDetectedEvent`.
     * @returns {SpeechDetectedEvent}
     */
    public static _from_object (_o: { [_K in keyof (SpeechDetectedEvent)]: (SpeechDetectedEvent)[_K] }): SpeechDetectedEvent {
        return new SpeechDetectedEvent(_o.overConnection, _o.resource, _o.cause, _o.servicesPermitted, _o.extensions);
    }
...
/**
 * @summary The Leading Root Component Types of SpeechDetectedEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_SpeechDetectedEvent: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of SpeechDetectedEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_SpeechDetectedEvent: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of SpeechDetectedEvent
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_SpeechDetectedEvent: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_SpeechDetectedEvent: $.ASN1Decoder<SpeechDetectedEvent> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) SpeechDetectedEvent
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_SpeechDetectedEvent (el: _Element): SpeechDetectedEvent {
    if (!_cached_decoder_for_SpeechDetectedEvent) { _cached_decoder_for_SpeechDetectedEvent = function (el: _Element): SpeechDetectedEvent {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_SpeechDetectedEvent,
        _extension_additions_list_spec_for_SpeechDetectedEvent,
        _root_component_type_list_2_spec_for_SpeechDetectedEvent,
        undefined,
    );
    return new SpeechDetectedEvent(
        overConnection,
        resource,
        cause,
        servicesPermitted,
    ...
    return _cached_decoder_for_SpeechDetectedEvent(el);
}

let _cached_encoder_for_SpeechDetectedEvent: $.ASN1Encoder<SpeechDetectedEvent> | null = null;

/**
 * @summary Encodes a(n) SpeechDetectedEvent into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The SpeechDetectedEvent, encoded as an ASN.1 Element.
 */
export
function _encode_SpeechDetectedEvent (value: SpeechDetectedEvent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SpeechDetectedEvent) { _cached_encoder_for_SpeechDetectedEvent = function (value: SpeechDetectedEvent, elGetter: $.ASN1Encoder<SpeechDetectedEvent>): _Element {
    ...
    return _cached_encoder_for_SpeechDetectedEvent(value, elGetter);
}
