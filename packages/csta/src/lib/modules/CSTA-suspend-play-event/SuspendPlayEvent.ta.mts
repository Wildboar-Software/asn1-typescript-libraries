...
const _root_component_type_list_1_spec_for_SuspendPlayEvent: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("length", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("currentPosition", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
