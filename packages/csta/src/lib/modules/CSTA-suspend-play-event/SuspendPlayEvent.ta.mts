 ...
 * @description
 *
 * Indicates that a message is suspended in play. Reported to a computing
 ...
 * (ECMA-269 §26.2.15, ECMA-285 §24.2.15).
 *
 ...
 */
export
class SuspendPlayEvent {
    constructor (
        /**
         * @summary `connection`.
         * @description
         *
         * Connection whose play is suspended (ECMA-269 §26.2.15).
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Suspended message (ECMA-269 §26.2.15).
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Length, when provided (ECMA-269 §26.2.15).
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Position at suspend (ECMA-269 §26.2.15).
         *
         * @public
         * @readonly
         */
    ...
    /**
     * @summary Restructures an object into a SuspendPlayEvent
     * @description
     * 
     * This takes an `object` and converts it to a `SuspendPlayEvent`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `SuspendPlayEvent`.
     * @returns {SuspendPlayEvent}
     */
    public static _from_object (_o: { [_K in keyof (SuspendPlayEvent)]: (SuspendPlayEvent)[_K] }): SuspendPlayEvent {
        return new SuspendPlayEvent(_o.connection, _o.message, _o.resource, _o.length, _o.currentPosition, _o.cause, _o.servicesPermitted, _o.extensions);
    }
...
/**
 * @summary The Leading Root Component Types of SuspendPlayEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_SuspendPlayEvent: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of SuspendPlayEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_SuspendPlayEvent: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of SuspendPlayEvent
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_SuspendPlayEvent: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_SuspendPlayEvent: $.ASN1Decoder<SuspendPlayEvent> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) SuspendPlayEvent
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_SuspendPlayEvent (el: _Element): SuspendPlayEvent {
    if (!_cached_decoder_for_SuspendPlayEvent) { _cached_decoder_for_SuspendPlayEvent = function (el: _Element): SuspendPlayEvent {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_SuspendPlayEvent,
        _extension_additions_list_spec_for_SuspendPlayEvent,
        _root_component_type_list_2_spec_for_SuspendPlayEvent,
        undefined,
    );
    return new SuspendPlayEvent(
        connection,
        message,
        resource,
        length,
    ...
    return _cached_decoder_for_SuspendPlayEvent(el);
}

let _cached_encoder_for_SuspendPlayEvent: $.ASN1Encoder<SuspendPlayEvent> | null = null;

/**
 * @summary Encodes a(n) SuspendPlayEvent into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The SuspendPlayEvent, encoded as an ASN.1 Element.
 */
export
function _encode_SuspendPlayEvent (value: SuspendPlayEvent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SuspendPlayEvent) { _cached_encoder_for_SuspendPlayEvent = function (value: SuspendPlayEvent, elGetter: $.ASN1Encoder<SuspendPlayEvent>): _Element {
    ...
    return _cached_encoder_for_SuspendPlayEvent(value, elGetter);
}
