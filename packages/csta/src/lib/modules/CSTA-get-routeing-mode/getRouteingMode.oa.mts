 ...
 * @description
 *
 * Get Routeing Mode (ECMA-269 §22.1.14 / ECMA-285 §20.1.14). Direction: CF→SF.
 * ROSE local CODE 311. Errors: `universalFailure`. TRUE means the device is
 * able to make routeing requests (Route
 * Request) when a call arrives.
 *
