...
const _root_component_type_list_1_spec_for_TransferredEvent: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("secondaryOldCall", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("transferringDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    new $.ComponentSpec("transferredToDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    new $.ComponentSpec("transferredConnections", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    ...
    new $.ComponentSpec("chargingInfo", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
