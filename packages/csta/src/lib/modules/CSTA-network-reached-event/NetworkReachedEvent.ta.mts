...
const _root_component_type_list_1_spec_for_NetworkReachedEvent: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("originatingNIDConneciton", true, $.hasTag(_TagClass.application, 11), undefined, undefined),
    ...
    new $.ComponentSpec("outboundConnectionInfo", true, $.hasTag(_TagClass.context, 5), undefined, undefined),
