...
const _root_component_type_list_1_spec_for_DigitsData: $.ComponentSpec[] = [
    new $.ComponentSpec("digitsDetected", false, $.hasTag(_TagClass.universal, 22)),
    new $.ComponentSpec("digitsDuration", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("digitsPauseDuration", true, $.hasTag(_TagClass.context, 1))
];
