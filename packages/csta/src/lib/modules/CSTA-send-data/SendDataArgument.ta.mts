...
// export { DisplayAttributeList, _decode_DisplayAttributeList, _encode_DisplayAttributeList } from "../CSTA-device-feature-types/DisplayAttributeList.ta.mjs";
...
const _root_component_type_list_1_spec_for_SendDataArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("ioRegisterReqID", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("displayAttributes", true, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("ioData", false, $.hasTag(_TagClass.universal, 4), undefined, undefined),
    new $.ComponentSpec("ioCause", true, $.hasTag(_TagClass.universal, 10), undefined, undefined),
