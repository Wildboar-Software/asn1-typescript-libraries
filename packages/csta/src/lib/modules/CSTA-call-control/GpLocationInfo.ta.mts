...
// export { GpLocationInfo_civicLocGml, _decode_GpLocationInfo_civicLocGml, _encode_GpLocationInfo_civicLocGml } from "../CSTA-call-control/GpLocationInfo-civicLocGml.ta.mjs";
...
const _root_component_type_list_1_spec_for_GpLocationInfo: $.ComponentSpec[] = [
    new $.ComponentSpec("civicLocGml", false, $.hasTag(_TagClass.universal, 16), undefined, undefined)
];
