...
// export { GlobalCallLinkageID, _decode_GlobalCallLinkageID, _encode_GlobalCallLinkageID } from "../CSTA-call-control/GlobalCallLinkageID.ta.mjs";
...
const _root_component_type_list_1_spec_for_GlobalCallData: $.ComponentSpec[] = [
    new $.ComponentSpec("globalCallSwitchingSubDomainName", true, $.hasTag(_TagClass.universal, 22), undefined, undefined),
    new $.ComponentSpec("globalCallLinkageID", false, $.hasAnyTag, undefined, undefined),
    new $.ComponentSpec("callLinkageIDTimestamp", true, $.hasTag(_TagClass.universal, 24), undefined, undefined)
];
