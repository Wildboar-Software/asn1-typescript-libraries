 ...
 * @description
 *
 * One Snapshot DeviceData segment: calls at the device and their local call
 * state. ECMA-269 §16.1.4.
 *
...
class SnapshotDeviceDataArgument {
    constructor (
         ...
         * @description
         *
         * Per-call snapshot rows (connection, call state, services, media,
         * optional call linkage). ECMA-269 §16.1.4.
         *
         * @public
         * @readonly
         */
...
const _root_component_type_list_1_spec_for_SnapshotDeviceDataArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("snapshotData", false, $.hasTag(_TagClass.application, 22)),
