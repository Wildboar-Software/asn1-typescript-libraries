...
// export { MicrophoneMuteList, _decode_MicrophoneMuteList, _encode_MicrophoneMuteList } from "../CSTA-get-microphone-mute/MicrophoneMuteList.ta.mjs";
...
const _root_component_type_list_1_spec_for_GetMicrophoneMuteResult: $.ComponentSpec[] = [
    new $.ComponentSpec("microphoneMuteList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
