...
const _root_component_type_list_1_spec_for_AssociateDataArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("callQualifyingData", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
    ...
    new $.ComponentSpec("deviceInfo", true, $.hasTag(_TagClass.context, 7), undefined, undefined),
