...
const _root_component_type_list_1_spec_for_ClearConnectionArgument: $.ComponentSpec[] = [
    new $.ComponentSpec("connectionToBeCleared", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    ...
    new $.ComponentSpec("reason", true, $.hasTag(_TagClass.universal, 10), undefined, undefined),
