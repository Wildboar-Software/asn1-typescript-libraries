...
const _root_component_type_list_1_spec_for_FailedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("failedConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("failingDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    ...
    new $.ComponentSpec("failedConnectionInfo", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
