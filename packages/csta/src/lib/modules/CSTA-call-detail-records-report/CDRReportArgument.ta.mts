...
// export { CDRInfo, _decode_CDRInfo, _encode_CDRInfo } from "../CSTA-call-detail-record/CDRInfo.ta.mjs";
...
const _root_component_type_list_1_spec_for_CDRReportArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("numberOfRecordsSent", false, $.hasTag(_TagClass.universal, 2), undefined, undefined),
    new $.ComponentSpec("cdrInfo", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("lastStoredCDRReportSent", true, $.hasTag(_TagClass.universal, 1), undefined, undefined),
