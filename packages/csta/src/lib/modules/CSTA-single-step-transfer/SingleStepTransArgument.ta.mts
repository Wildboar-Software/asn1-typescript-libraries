...
const _root_component_type_list_1_spec_for_SingleStepTransArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("transferredTo", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    ...
    new $.ComponentSpec("subjectOfCall", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
    new $.ComponentSpec("languagePreferences", true, $.hasTag(_TagClass.context, 5), undefined, undefined),
    new $.ComponentSpec("reason", true, $.hasTag(_TagClass.context, 6), undefined, undefined),
