...
const _root_component_type_list_1_spec_for_RetrievedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("retrievedConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("retrievingDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    ...
    new $.ComponentSpec("retrievedConnectionInfo", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
