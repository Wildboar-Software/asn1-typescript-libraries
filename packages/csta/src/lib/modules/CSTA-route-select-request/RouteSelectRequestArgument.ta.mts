...
const _root_component_type_list_1_spec_for_RouteSelectRequestArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("routeSelected", false, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("alternateRoutes", true, $.hasTag(_TagClass.context, 2)),
    new $.ComponentSpec("remainRetries", true, $.hasTag(_TagClass.context, 3)),
    new $.ComponentSpec("routeUsedReq", true, $.hasTag(_TagClass.context, 4)),
