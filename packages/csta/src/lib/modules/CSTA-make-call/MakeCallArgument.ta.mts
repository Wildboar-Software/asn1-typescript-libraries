...
const _root_component_type_list_1_spec_for_MakeCallArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("autoOriginate", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
    ...
    new $.ComponentSpec("callingConnectionInfo", true, $.hasTag(_TagClass.context, 5), undefined, undefined),
    ...
    new $.ComponentSpec("reason", true, $.hasTag(_TagClass.context, 8), undefined, undefined),
