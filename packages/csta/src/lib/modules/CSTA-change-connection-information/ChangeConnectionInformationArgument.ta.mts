...
const _root_component_type_list_1_spec_for_ChangeConnectionInformationArgument: $.ComponentSpec[] = [
    new $.ComponentSpec("connectionToBeChanged", false, $.hasTag(_TagClass.application, 11)),
    new $.ComponentSpec("requestedConnectionInfo", false, $.hasTag(_TagClass.universal, 16)),
