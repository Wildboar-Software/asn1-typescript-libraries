 ...
 * @description
 *
 * Identifies the I/O registration that was aborted (ECMA-269 §24.1.2.1). No
 * positive acknowledgement is defined.
 *
...
class IORegisterAbortArgument {
    constructor (
         ...
         * @description
         *
         * I/O registration that was aborted (ECMA-269 §24.1.2.1).
         *
         * @public
         * @readonly
         */
