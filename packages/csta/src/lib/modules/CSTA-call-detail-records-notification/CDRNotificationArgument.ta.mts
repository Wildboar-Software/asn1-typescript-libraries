...
import { CDRReason, _enum_for_CDRReason, CDRReason_timeout /* IMPORTED_LONG_ENUMERATION_ITEM */, timeout /* IMPORTED_SHORT_ENUMERATION_ITEM */, CDRReason_thresholdReached /* IMPORTED_LONG_ENUMERATION_ITEM */, thresholdReached /* IMPORTED_SHORT_ENUMERATION_ITEM */, CDRReason_other /* IMPORTED_LONG_ENUMERATION_ITEM */, other /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_CDRReason, _encode_CDRReason } from "../CSTA-call-detail-record/CDRReason.ta.mjs";
// export { CDRReason, _enum_for_CDRReason, CDRReason_timeout /* IMPORTED_LONG_ENUMERATION_ITEM */, timeout /* IMPORTED_SHORT_ENUMERATION_ITEM */, CDRReason_thresholdReached /* IMPORTED_LONG_ENUMERATION_ITEM */, thresholdReached /* IMPORTED_SHORT_ENUMERATION_ITEM */, CDRReason_other /* IMPORTED_LONG_ENUMERATION_ITEM */, other /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_CDRReason, _encode_CDRReason } from "../CSTA-call-detail-record/CDRReason.ta.mjs";
...
const _root_component_type_list_1_spec_for_CDRNotificationArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("cdrReason", true, $.hasTag(_TagClass.universal, 10), undefined, undefined),
