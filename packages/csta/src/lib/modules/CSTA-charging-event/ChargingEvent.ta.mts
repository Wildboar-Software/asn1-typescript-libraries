...
const _root_component_type_list_1_spec_for_ChargingEvent: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("chargedDevice", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    new $.ComponentSpec("chargingInfo", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
