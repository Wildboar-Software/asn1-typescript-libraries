...
import { CollectionType, _enum_for_CollectionType, CollectionType_periodic /* IMPORTED_LONG_ENUMERATION_ITEM */, CollectionType_periodicWithUpdates /* IMPORTED_LONG_ENUMERATION_ITEM */, periodicWithUpdates /* IMPORTED_SHORT_ENUMERATION_ITEM */, CollectionType_updatesOnly /* IMPORTED_LONG_ENUMERATION_ITEM */, updatesOnly /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_CollectionType, _encode_CollectionType } from "../CSTA-start-location-tracking-session/CollectionType.ta.mjs";
// export { CollectionType, _enum_for_CollectionType, CollectionType_periodic /* IMPORTED_LONG_ENUMERATION_ITEM */, CollectionType_periodicWithUpdates /* IMPORTED_LONG_ENUMERATION_ITEM */, periodicWithUpdates /* IMPORTED_SHORT_ENUMERATION_ITEM */, CollectionType_updatesOnly /* IMPORTED_LONG_ENUMERATION_ITEM */, updatesOnly /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_CollectionType, _encode_CollectionType } from "../CSTA-start-location-tracking-session/CollectionType.ta.mjs";
...
// export { CollectionFilter, _decode_CollectionFilter, _encode_CollectionFilter } from "../CSTA-start-location-tracking-session/CollectionFilter.ta.mjs";
import { ReportingType, _enum_for_ReportingType, ReportingType_immediate /* IMPORTED_LONG_ENUMERATION_ITEM */, immediate /* IMPORTED_SHORT_ENUMERATION_ITEM */, ReportingType_periodic /* IMPORTED_LONG_ENUMERATION_ITEM */, ReportingType_count /* IMPORTED_LONG_ENUMERATION_ITEM */, count /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_ReportingType, _encode_ReportingType } from "../CSTA-start-location-tracking-session/ReportingType.ta.mjs";
// export { ReportingType, _enum_for_ReportingType, ReportingType_immediate /* IMPORTED_LONG_ENUMERATION_ITEM */, immediate /* IMPORTED_SHORT_ENUMERATION_ITEM */, ReportingType_periodic /* IMPORTED_LONG_ENUMERATION_ITEM */, ReportingType_count /* IMPORTED_LONG_ENUMERATION_ITEM */, count /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_ReportingType, _encode_ReportingType } from "../CSTA-start-location-tracking-session/ReportingType.ta.mjs";
...
const _root_component_type_list_1_spec_for_StartLocationTrackingSessionArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("collectionType", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("collectionInterval", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("maxCollections", true, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("collectionFilter", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
    new $.ComponentSpec("reportingType", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
    new $.ComponentSpec("reportingInterval", true, $.hasTag(_TagClass.context, 5), undefined, undefined),
    new $.ComponentSpec("reportingCount", true, $.hasTag(_TagClass.context, 6), undefined, undefined),
