...
const _root_component_type_list_1_spec_for_EstablishedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("establishedConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("answeringDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    ...
    new $.ComponentSpec("establishedConnectionInfo", true, $.hasTag(_TagClass.context, 5), undefined, undefined),
    ...
    new $.ComponentSpec("messageInfo", true, $.hasTag(_TagClass.context, 8), undefined, undefined),
    new $.ComponentSpec("languagePreferences", true, $.hasTag(_TagClass.context, 9), undefined, undefined),
    new $.ComponentSpec("deviceHistory", true, $.hasTag(_TagClass.context, 10), undefined, undefined),
    new $.ComponentSpec("locationInfo", true, $.hasTag(_TagClass.context, 11), undefined, undefined),
