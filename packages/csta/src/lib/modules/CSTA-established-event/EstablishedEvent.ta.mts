 ...
 * @description
 *
 * Established event payload (ECMA-269 §17.2.8 / ECMA-285 §15.2.8) for
 * `cSTAEventReport`. A computing function does not see this event after Service
 * Initiated for prompting Make Call; Originated is used (FR 1).
 *
...
class EstablishedEvent {
    constructor (
         ...
         * @description
         *
         * Mandatory. Connection that was connected.
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Mandatory. Device that connected into the call.
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Mandatory. Valid values are listed in Table 17-166.
         *
         * @public
         * @readonly
         */
