...
const _root_component_type_list_1_spec_for_OfferedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("offeredConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("offeredDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    ...
    new $.ComponentSpec("offeredConnectionInfo", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
    ...
    new $.ComponentSpec("messageInfo", true, $.hasTag(_TagClass.context, 6), undefined, undefined),
