...
/**
 * @summary OfferedEvent
 * @description
 *
 * Offered event payload (ECMA-269 §17.2.13 / ECMA-285 §15.2.13) for
 * `cSTAEventReport`. Services allowed while Offered are determined by
 * capability exchange (FR 1).
 *
...
class OfferedEvent {
    constructor (
        /**
         * @summary `offeredConnection`.
         * @description
         *
         * Mandatory. Connection that is alerting.
         *
         * @public
         * @readonly
         */
        readonly offeredConnection: ConnectionID,
        /**
         * @summary `offeredDevice`.
         * @description
         *
         * Mandatory. Device that is alerting.
         *
         * @public
         * @readonly
         */
        readonly offeredDevice: SubjectDeviceID,
        /**
         ...
         * @description
         *
         * Mandatory. Valid values are listed in Table 17-176.
         *
         * @public
         * @readonly
         */
         ...
         * @readonly
         */
        readonly offeredConnectionInfo: OPTIONAL<ConnectionInformation>,
        /**
    ...
    /**
     * @summary Restructures an object into a OfferedEvent
     * @description
     * 
     * This takes an `object` and converts it to a `OfferedEvent`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `OfferedEvent`.
     * @returns {OfferedEvent}
     */
    public static _from_object (_o: { [_K in keyof (OfferedEvent)]: (OfferedEvent)[_K] }): OfferedEvent {
        return new OfferedEvent(_o.offeredConnection, _o.offeredDevice, _o.callingDevice, _o.calledDevice, _o.lastRedirectionDevice, _o.originatingNIDConnection, _o.localConnectionInfo, _o.correlatorData, _o.userData, _o.cause, _o.servicesPermitted, _o.networkCallingDevice, _o.networkCalledDevice, _o.associatedCallingDevice, _o.associatedCalledDevice, _o.mediaCallCharacteristics, _o.callCharacteristics, _o.offeredConnectionInfo, _o.callLinkageData, _o.subjectOfCall, _o.messageInfo, _o.languagePreferences, _o.deviceHistory, _o.locationInfo, _o.extensions);
    }
...
/**
 * @summary The Leading Root Component Types of OfferedEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_OfferedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("offeredConnection", false, $.hasTag(_TagClass.application, 11)),
    new $.ComponentSpec("offeredDevice", false, $.hasTag(_TagClass.application, 3)),
    ...
    new $.ComponentSpec("mediaCallCharacteristics", true, $.hasTag(_TagClass.context, 1)),
        new $.ComponentSpec("callCharacteristics", true, $.hasTag(_TagClass.context, 2)),
    new $.ComponentSpec("offeredConnectionInfo", true, $.hasTag(_TagClass.context, 3)),
    ...
    new $.ComponentSpec("messageInfo", true, $.hasTag(_TagClass.context, 6)),
...
/**
 * @summary The Trailing Root Component Types of OfferedEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_OfferedEvent: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of OfferedEvent
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_OfferedEvent: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_OfferedEvent: $.ASN1Decoder<OfferedEvent> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) OfferedEvent
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_OfferedEvent (el: _Element): OfferedEvent {
    if (!_cached_decoder_for_OfferedEvent) { _cached_decoder_for_OfferedEvent = function (el: _Element): OfferedEvent {
    let offeredConnection!: ConnectionID;
    let offeredDevice!: SubjectDeviceID;
    ...
    let offeredConnectionInfo: OPTIONAL<ConnectionInformation>;
    ...
    const callbacks: $.DecodingMap = {
        "offeredConnection": (_el: _Element): void => { offeredConnection = _decode_ConnectionID(_el); },
        "offeredDevice": (_el: _Element): void => { offeredDevice = _decode_SubjectDeviceID(_el); },
        ...
        "offeredConnectionInfo": (_el: _Element): void => { offeredConnectionInfo = $._decode_implicit<ConnectionInformation>(() => _decode_ConnectionInformation)(_el); },
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_OfferedEvent,
        _extension_additions_list_spec_for_OfferedEvent,
        _root_component_type_list_2_spec_for_OfferedEvent,
        undefined,
    );
    return new OfferedEvent(
        offeredConnection,
        offeredDevice,
        callingDevice,
        calledDevice,
    ...
    return _cached_decoder_for_OfferedEvent(el);
}

let _cached_encoder_for_OfferedEvent: $.ASN1Encoder<OfferedEvent> | null = null;

/**
 * @summary Encodes a(n) OfferedEvent into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The OfferedEvent, encoded as an ASN.1 Element.
 */
export
function _encode_OfferedEvent (value: OfferedEvent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_OfferedEvent) { _cached_encoder_for_OfferedEvent = function (value: OfferedEvent, elGetter: $.ASN1Encoder<OfferedEvent>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ConnectionID(value.offeredConnection, $.BER),
            /* REQUIRED   */ _encode_SubjectDeviceID(value.offeredDevice, $.BER),
            ...
            /* IF_ABSENT  */ ((value.callCharacteristics === undefined) ? undefined : $._encode_implicit(_TagClass.context, 2, () => _encode_CallCharacteristics, $.BER)(value.callCharacteristics, $.BER)),
            /* IF_ABSENT  */ ((value.offeredConnectionInfo === undefined) ? undefined : $._encode_implicit(_TagClass.context, 3, () => _encode_ConnectionInformation, $.BER)(value.offeredConnectionInfo, $.BER)),
            ...
            /* IF_ABSENT  */ ((value.messageInfo === undefined) ? undefined : $._encode_implicit(_TagClass.context, 6, () => _encode_MessageInfo, $.BER)(value.messageInfo, $.BER)),
    ...
    return _cached_encoder_for_OfferedEvent(value, elGetter);
}
