...
class AgentReadyEvent {
    ...
    /**
     * @summary Restructures an object into a AgentReadyEvent
     * @description
     * 
     * This takes an `object` and converts it to a `AgentReadyEvent`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `AgentReadyEvent`.
     * @returns {AgentReadyEvent}
     */
    public static _from_object (_o: { [_K in keyof (AgentReadyEvent)]: (AgentReadyEvent)[_K] }): AgentReadyEvent {
        return new AgentReadyEvent(_o.agentDevice, _o.agentID, _o.acdGroup, _o.cause, _o.extensions);
    }
...
/**
 * @summary The Leading Root Component Types of AgentReadyEvent
 * @description
 * 
...
const _root_component_type_list_1_spec_for_AgentReadyEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("agentDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
...
/**
 * @summary The Trailing Root Component Types of AgentReadyEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_AgentReadyEvent: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of AgentReadyEvent
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_AgentReadyEvent: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_AgentReadyEvent: $.ASN1Decoder<AgentReadyEvent> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) AgentReadyEvent
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_AgentReadyEvent (el: _Element): AgentReadyEvent {
    if (!_cached_decoder_for_AgentReadyEvent) { _cached_decoder_for_AgentReadyEvent = function (el: _Element): AgentReadyEvent {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_AgentReadyEvent,
        _extension_additions_list_spec_for_AgentReadyEvent,
        _root_component_type_list_2_spec_for_AgentReadyEvent,
        undefined,
    );
    return new AgentReadyEvent(
        agentDevice,
        agentID,
        acdGroup,
        cause,
    ...
    return _cached_decoder_for_AgentReadyEvent(el);
}

let _cached_encoder_for_AgentReadyEvent: $.ASN1Encoder<AgentReadyEvent> | null = null;

/**
 * @summary Encodes a(n) AgentReadyEvent into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The AgentReadyEvent, encoded as an ASN.1 Element.
 */
export
function _encode_AgentReadyEvent (value: AgentReadyEvent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AgentReadyEvent) { _cached_encoder_for_AgentReadyEvent = function (value: AgentReadyEvent, elGetter: $.ASN1Encoder<AgentReadyEvent>): _Element {
    ...
    return _cached_encoder_for_AgentReadyEvent(value, elGetter);
}
