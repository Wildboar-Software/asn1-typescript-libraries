...
const _root_component_type_list_1_spec_for_ServiceInitiatedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("initiatedConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    /* FIXME: initiatingDevice COULD_NOT_RESOLVE_TYPE_DEF */,
    ...
    new $.ComponentSpec("initiatedConnectionInfo", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
    /* FIXME: networkCallingDevice COULD_NOT_RESOLVE_TYPE_DEF */,
    /* FIXME: networkCalledDevice COULD_NOT_RESOLVE_TYPE_DEF */,
    /* FIXME: associatedCallingDevice COULD_NOT_RESOLVE_TYPE_DEF */,
