 ...
 * @description
 *
 * Agent Busy event (ECMA-269 §22.2.1 / ECMA-285 §20.2.1). Direction: SF→CF via
 * Event Report. Agent entered Busy: involved with an ACD call (even if held).
 * May still accept non-ACD calls. Agent/supervisor/private calls may or may not
 * cause this. May be reported for a monitor on the ACD device, ACD group, or
...
class AgentBusyEvent {
    constructor (
         ...
         * @description
         *
         * Device at which the agent entered Busy.
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Next state after Busy ends: Working After Call, Not Ready, Ready, or
         * Null. Required if the SF delays that transition.
         * @public
         * @readonly
         */
