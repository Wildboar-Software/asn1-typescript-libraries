 ...
 * @description
 *
 * Connection, rule, optional grammar and resource (ECMA-269 §26.1.4.1).
 *
...
class DeactivateArgument {
    constructor (
         ...
         * @description
         *
         * Connection whose Listener grammar is deactivated (ECMA-269
         * §26.1.4.1).
         *
         * @public
         * @readonly
         ...
         * @description
         *
         * Grammar rule to deactivate (ECMA-269 §26.1.4.1).
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Grammar to deactivate; if absent, all grammars are affected (ECMA-269
         * §26.1.4.1).
         *
         * @public
         * @readonly
...
const _root_component_type_list_1_spec_for_DeactivateArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("ruleName", false, $.hasTag(_TagClass.universal, 22)),
    new $.ComponentSpec("grammarName", true, $.hasTag(_TagClass.context, 1)),
