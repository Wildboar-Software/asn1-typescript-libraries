...
class ReviewEvent {
    ...
    /**
     * @summary Restructures an object into a ReviewEvent
     * @description
     * 
     * This takes an `object` and converts it to a `ReviewEvent`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `ReviewEvent`.
     * @returns {ReviewEvent}
     */
    public static _from_object (_o: { [_K in keyof (ReviewEvent)]: (ReviewEvent)[_K] }): ReviewEvent {
        return new ReviewEvent(_o.connection, _o.message, _o.resource, _o.length, _o.currentPosition, _o.cause, _o.servicesPermitted, _o.extensions);
    }
...
/**
 * @summary The Leading Root Component Types of ReviewEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_ReviewEvent: $.ComponentSpec[] = [
...
/**
 * @summary The Trailing Root Component Types of ReviewEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_ReviewEvent: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of ReviewEvent
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_ReviewEvent: $.ComponentSpec[] = [
...
function _decode_ReviewEvent (el: _Element): ReviewEvent {
    if (!_cached_decoder_for_ReviewEvent) { _cached_decoder_for_ReviewEvent = function (el: _Element): ReviewEvent {
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_ReviewEvent,
        _extension_additions_list_spec_for_ReviewEvent,
        _root_component_type_list_2_spec_for_ReviewEvent,
        undefined,
    );
...
function _encode_ReviewEvent (value: ReviewEvent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ReviewEvent) { _cached_encoder_for_ReviewEvent = function (value: ReviewEvent, elGetter: $.ASN1Encoder<ReviewEvent>): _Element {
