 ...
 * @description
 *
 * Indicates a message play or record operation on a connection has stopped.
 ...
 * alternative (ECMA-285 §24.2). (ECMA-269 §26.2.14, ECMA-285 §24.2.14).
 *
...
class StopEvent {
    constructor (
         ...
         * @description
         *
         * Connection whose play/record stopped (ECMA-269 §26.2.14).
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Message that stopped (ECMA-269 §26.2.14).
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Length, when provided (ECMA-269 §26.2.14).
         *
         * @public
         * @readonly
         */
         ...
         * @description
         *
         * Position at stop (ECMA-269 §26.2.14).
         *
         * @public
         * @readonly
         */
