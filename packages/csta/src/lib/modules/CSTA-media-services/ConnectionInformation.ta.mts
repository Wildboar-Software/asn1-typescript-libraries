...
import { ConnectionInformation_flowDirection, _enum_for_ConnectionInformation_flowDirection, ConnectionInformation_flowDirection_transmit /* IMPORTED_LONG_ENUMERATION_ITEM */, transmit /* IMPORTED_SHORT_ENUMERATION_ITEM */, ConnectionInformation_flowDirection_receive /* IMPORTED_LONG_ENUMERATION_ITEM */, receive /* IMPORTED_SHORT_ENUMERATION_ITEM */, ConnectionInformation_flowDirection_transmitAndReceive /* IMPORTED_LONG_ENUMERATION_ITEM */, transmitAndReceive /* IMPORTED_SHORT_ENUMERATION_ITEM */, ConnectionInformation_flowDirection_none /* IMPORTED_LONG_ENUMERATION_ITEM */, none /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_ConnectionInformation_flowDirection, _encode_ConnectionInformation_flowDirection } from "../CSTA-media-services/ConnectionInformation-flowDirection.ta.mjs";
// export { ConnectionInformation_flowDirection, _enum_for_ConnectionInformation_flowDirection, ConnectionInformation_flowDirection_transmit /* IMPORTED_LONG_ENUMERATION_ITEM */, transmit /* IMPORTED_SHORT_ENUMERATION_ITEM */, ConnectionInformation_flowDirection_receive /* IMPORTED_LONG_ENUMERATION_ITEM */, receive /* IMPORTED_SHORT_ENUMERATION_ITEM */, ConnectionInformation_flowDirection_transmitAndReceive /* IMPORTED_LONG_ENUMERATION_ITEM */, transmitAndReceive /* IMPORTED_SHORT_ENUMERATION_ITEM */, ConnectionInformation_flowDirection_none /* IMPORTED_LONG_ENUMERATION_ITEM */, none /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_ConnectionInformation_flowDirection, _encode_ConnectionInformation_flowDirection } from "../CSTA-media-services/ConnectionInformation-flowDirection.ta.mjs";
...
const _root_component_type_list_1_spec_for_ConnectionInformation: $.ComponentSpec[] = [
    new $.ComponentSpec("flowDirection", true, $.hasTag(_TagClass.universal, 10), undefined, undefined),
    new $.ComponentSpec("numberOfChannels", true, $.hasTag(_TagClass.universal, 2), undefined, undefined),
    new $.ComponentSpec("mediaSessionInformation", true, $.hasTag(_TagClass.universal, 22), undefined, undefined)
];
