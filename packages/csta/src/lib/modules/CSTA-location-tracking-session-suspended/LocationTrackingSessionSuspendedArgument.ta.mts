...
import { LocReason, _enum_for_LocReason, LocReason_connectionToDeviceOrNetworkRestored /* IMPORTED_LONG_ENUMERATION_ITEM */, connectionToDeviceOrNetworkRestored /* IMPORTED_SHORT_ENUMERATION_ITEM */, LocReason_performanceConditionRelieved /* IMPORTED_LONG_ENUMERATION_ITEM */, performanceConditionRelieved /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_LocReason, _encode_LocReason } from "../CSTA-device-feature-types/LocReason.ta.mjs";
// export { LocReason, _enum_for_LocReason, LocReason_connectionToDeviceOrNetworkRestored /* IMPORTED_LONG_ENUMERATION_ITEM */, connectionToDeviceOrNetworkRestored /* IMPORTED_SHORT_ENUMERATION_ITEM */, LocReason_performanceConditionRelieved /* IMPORTED_LONG_ENUMERATION_ITEM */, performanceConditionRelieved /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_LocReason, _encode_LocReason } from "../CSTA-device-feature-types/LocReason.ta.mjs";
...
const _root_component_type_list_1_spec_for_LocationTrackingSessionSuspendedArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("locReason", true, $.hasTag(_TagClass.universal, 10), undefined, undefined),
