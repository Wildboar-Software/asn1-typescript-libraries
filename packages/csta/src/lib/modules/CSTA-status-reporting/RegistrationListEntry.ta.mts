...
const _root_component_type_list_1_spec_for_RegistrationListEntry: $.ComponentSpec[] = [
    new $.ComponentSpec("registrationType", false, $.hasTag(_TagClass.universal, 10), undefined, undefined),
    new $.ComponentSpec("registrationID", false, $.hasTag(_TagClass.universal, 22), undefined, undefined),
    new $.ComponentSpec("registrationObject", true, $.hasTag(_TagClass.universal, 16), undefined, undefined)
];
