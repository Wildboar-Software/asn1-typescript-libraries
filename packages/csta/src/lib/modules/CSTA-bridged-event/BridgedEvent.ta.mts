...
class BridgedEvent {
    ...
    /**
     * @summary Restructures an object into a BridgedEvent
     * @description
     * 
     * This takes an `object` and converts it to a `BridgedEvent`.
     * 
     * @public
     * @static
     * @method
     * @param {Object} _o An object having all of the keys and values of a `BridgedEvent`.
     * @returns {BridgedEvent}
     */
    public static _from_object (_o: { [_K in keyof (BridgedEvent)]: (BridgedEvent)[_K] }): BridgedEvent {
        return new BridgedEvent(_o.bridgedConnection, _o.bridgedAppearance, _o.localConnectionInfo, _o.correlatorData, _o.userData, _o.cause, _o.servicesPermitted, _o.mediaCallCharacteristics, _o.callCharacteristics, _o.bridgedConnectionInfo, _o.callLinkageData, _o.languagePreferences, _o.locationInfo, _o.extensions);
    }
...
/**
 * @summary The Leading Root Component Types of BridgedEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_1_spec_for_BridgedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("bridgedConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("bridgedAppearance", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    ...
    new $.ComponentSpec("bridgedConnectionInfo", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
    ...
    new $.ComponentSpec("locationInfo", true, $.hasTag(_TagClass.context, 7), undefined, undefined),
    new $.ComponentSpec("extensions", true, $.hasTag(_TagClass.application, 30), undefined, undefined)
];

/**
 * @summary The Trailing Root Component Types of BridgedEvent
 * @description
 * 
 ...
 */
export
const _root_component_type_list_2_spec_for_BridgedEvent: $.ComponentSpec[] = [
    
];

/**
 * @summary The Extension Addition Component Types of BridgedEvent
 * @description
 * 
 ...
 */
export
const _extension_additions_list_spec_for_BridgedEvent: $.ComponentSpec[] = [
    
];

let _cached_decoder_for_BridgedEvent: $.ASN1Decoder<BridgedEvent> | null = null;

/**
 * @summary Decodes an ASN.1 element into a(n) BridgedEvent
 * @function
 * @param el The element being decoded.
 * @returns The decoded data structure.
 */
export
function _decode_BridgedEvent (el: _Element): BridgedEvent {
    if (!_cached_decoder_for_BridgedEvent) { _cached_decoder_for_BridgedEvent = function (el: _Element): BridgedEvent {
    let bridgedConnection!: ConnectionID;
    let bridgedAppearance!: SubjectDeviceID;
    ...
    let bridgedConnectionInfo: OPTIONAL<ConnectionInformation>;
    ...
    const callbacks: $.DecodingMap = {
        "bridgedConnection": (_el: _Element): void => { bridgedConnection = _decode_ConnectionID(_el); },
        "bridgedAppearance": (_el: _Element): void => { bridgedAppearance = _decode_SubjectDeviceID(_el); },
        ...
        "bridgedConnectionInfo": (_el: _Element): void => { bridgedConnectionInfo = $._decode_implicit<ConnectionInformation>(() => _decode_ConnectionInformation)(_el); },
    ...
    $._parse_sequence(el, callbacks,
        _root_component_type_list_1_spec_for_BridgedEvent,
        _extension_additions_list_spec_for_BridgedEvent,
        _root_component_type_list_2_spec_for_BridgedEvent,
        undefined,
    );
    return new BridgedEvent(
        bridgedConnection,
        bridgedAppearance,
        localConnectionInfo,
        correlatorData,
    ...
    return _cached_decoder_for_BridgedEvent(el);
}

let _cached_encoder_for_BridgedEvent: $.ASN1Encoder<BridgedEvent> | null = null;

/**
 * @summary Encodes a(n) BridgedEvent into an ASN.1 Element.
 * @function
 * @param value The value being encoded.
 * @param elGetter A function that can be used to get new ASN.1 elements.
 * @returns {_Element} The BridgedEvent, encoded as an ASN.1 Element.
 */
export
function _encode_BridgedEvent (value: BridgedEvent, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BridgedEvent) { _cached_encoder_for_BridgedEvent = function (value: BridgedEvent, elGetter: $.ASN1Encoder<BridgedEvent>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_ConnectionID(value.bridgedConnection, $.BER),
            /* REQUIRED   */ _encode_SubjectDeviceID(value.bridgedAppearance, $.BER),
            ...
            /* IF_ABSENT  */ ((value.bridgedConnectionInfo === undefined) ? undefined : $._encode_implicit(_TagClass.context, 4, () => _encode_ConnectionInformation, $.BER)(value.bridgedConnectionInfo, $.BER)),
    ...
    return _cached_encoder_for_BridgedEvent(value, elGetter);
}
