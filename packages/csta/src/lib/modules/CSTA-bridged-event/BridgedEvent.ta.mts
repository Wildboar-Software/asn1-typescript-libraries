...
const _root_component_type_list_1_spec_for_BridgedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("bridgedConnection", false, $.hasTag(_TagClass.application, 11)),
    new $.ComponentSpec("bridgedAppearance", false, $.hasTag(_TagClass.application, 3)),
    ...
    new $.ComponentSpec("bridgedConnectionInfo", true, $.hasTag(_TagClass.context, 4)),
