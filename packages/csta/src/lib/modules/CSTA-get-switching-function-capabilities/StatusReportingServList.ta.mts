...
const _root_component_type_list_1_spec_for_StatusReportingServList: $.ComponentSpec[] = [
    new $.ComponentSpec("monitoringServices", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("snapshotServices", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("systemServices", true, $.hasTag(_TagClass.context, 2), undefined, undefined)
];
