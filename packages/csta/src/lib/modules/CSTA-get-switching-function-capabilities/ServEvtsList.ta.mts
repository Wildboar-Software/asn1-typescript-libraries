...
const _root_component_type_list_1_spec_for_ServEvtsList: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("systemServList", true, $.hasTag(_TagClass.context, 1)),
    ...
    new $.ComponentSpec("callControlEvtsList", true, $.hasTag(_TagClass.context, 5)),
    new $.ComponentSpec("callAssociatedServList", true, $.hasTag(_TagClass.context, 6)),
    new $.ComponentSpec("callAssociatedEvtsList", true, $.hasTag(_TagClass.context, 7)),
    new $.ComponentSpec("mediaServList", true, $.hasTag(_TagClass.context, 8)),
    new $.ComponentSpec("mediaEvtsList", true, $.hasTag(_TagClass.context, 9)),
    new $.ComponentSpec("routeingServList", true, $.hasTag(_TagClass.context, 10)),
    new $.ComponentSpec("physDevServList", true, $.hasTag(_TagClass.context, 11)),
    new $.ComponentSpec("physDevEvtsList", true, $.hasTag(_TagClass.context, 12)),
    new $.ComponentSpec("logicalServList", true, $.hasTag(_TagClass.context, 13)),
    new $.ComponentSpec("logicalEvtsList", true, $.hasTag(_TagClass.context, 14)),
    new $.ComponentSpec("deviceMaintEvtsList", true, $.hasTag(_TagClass.context, 15)),
    new $.ComponentSpec("iOServicesServList", true, $.hasTag(_TagClass.context, 16)),
    new $.ComponentSpec("dataCollectionServList", true, $.hasTag(_TagClass.context, 17)),
    new $.ComponentSpec("voiceUnitServList", true, $.hasTag(_TagClass.context, 18)),
    new $.ComponentSpec("voiceUnitEvtsList", true, $.hasTag(_TagClass.context, 19)),
    new $.ComponentSpec("cdrServList", true, $.hasTag(_TagClass.context, 20)),
    new $.ComponentSpec("vendorSpecificServList", true, $.hasTag(_TagClass.context, 21)),
    new $.ComponentSpec("vendorSpecificEvtsList", true, $.hasTag(_TagClass.context, 22)),
    new $.ComponentSpec("statusReportingServList", true, $.hasTag(_TagClass.context, 23)),
    new $.ComponentSpec("locationServList", true, $.hasTag(_TagClass.context, 24))
];
