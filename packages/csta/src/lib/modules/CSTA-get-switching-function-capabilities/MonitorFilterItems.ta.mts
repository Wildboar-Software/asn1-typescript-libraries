...
const _root_component_type_list_1_spec_for_MonitorFilterItems: $.ComponentSpec[] = [
    new $.ComponentSpec("deviceOnDeviceMonitorFilter", true, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("deviceOnConnectionMonitorFilter", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("callOnDeviceMonitorFilter", true, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("callOnConnectionMonitorFilter", true, $.hasTag(_TagClass.context, 3), undefined, undefined)
];
