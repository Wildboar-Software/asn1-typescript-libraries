...
const _root_component_type_list_1_spec_for_NetworkCapabilitiesChangedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("outboundConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("networkInterfaceUsed", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    new $.ComponentSpec("calledDevice", false, $.hasTag(_TagClass.application, 2), undefined, undefined),
    /* FIXME: progressIndicator COULD_NOT_RESOLVE_TYPE_DEF */,
    ...
    /* FIXME: networkCapability COULD_NOT_RESOLVE_TYPE_DEF */,
    ...
    new $.ComponentSpec("outboundConnectionInfo", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
