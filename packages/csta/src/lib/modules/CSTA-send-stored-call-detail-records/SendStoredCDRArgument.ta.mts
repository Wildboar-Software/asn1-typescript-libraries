...
// export { CDRTimePeriod, _decode_CDRTimePeriod, _encode_CDRTimePeriod } from "../CSTA-call-detail-record/CDRTimePeriod.ta.mjs";
...
const _root_component_type_list_1_spec_for_SendStoredCDRArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("timePeriod", true, $.hasTag(_TagClass.universal, 16), undefined, undefined),
