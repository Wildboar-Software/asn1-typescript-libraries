 ...
 * @description
 *
 * Snapshot Device (ECMA-269 §16.1.2 / ECMA-285 §14.1.2). Direction: CF→SF. ROSE
 * local CODE 74. Errors: `universalFailure`. If Dynamic Feature Availability is
 * supported, each connection
 * includes `servicesPermitted`.
 *
