 ...
 * @description
 *
 * Ordered list of messages to concatenate (ECMA-269 §26.1.3.1).
 *
...
class ConcatenateMessageArgument {
    constructor (
         ...
         * @description
         *
         * Messages in concatenation order (ECMA-269 §26.1.3.1).
         *
         * @public
         * @readonly
         */
...
const _root_component_type_list_1_spec_for_ConcatenateMessageArgument: $.ComponentSpec[] = [
    new $.ComponentSpec("messagesToConcatenate", false, $.hasTag(_TagClass.universal, 16)),
