...
import { AgentWorkingAfterCallEvent_pendingAgentState, _enum_for_AgentWorkingAfterCallEvent_pendingAgentState, AgentWorkingAfterCallEvent_pendingAgentState_notReady /* IMPORTED_LONG_ENUMERATION_ITEM */, notReady /* IMPORTED_SHORT_ENUMERATION_ITEM */, AgentWorkingAfterCallEvent_pendingAgentState_ready /* IMPORTED_LONG_ENUMERATION_ITEM */, ready /* IMPORTED_SHORT_ENUMERATION_ITEM */, AgentWorkingAfterCallEvent_pendingAgentState_null /* IMPORTED_LONG_ENUMERATION_ITEM */, null_ /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_AgentWorkingAfterCallEvent_pendingAgentState, _encode_AgentWorkingAfterCallEvent_pendingAgentState } from "../CSTA-agent-working-after-call-event/AgentWorkingAfterCallEvent-pendingAgentState.ta.mjs";
// export { AgentWorkingAfterCallEvent_pendingAgentState, _enum_for_AgentWorkingAfterCallEvent_pendingAgentState, AgentWorkingAfterCallEvent_pendingAgentState_notReady /* IMPORTED_LONG_ENUMERATION_ITEM */, notReady /* IMPORTED_SHORT_ENUMERATION_ITEM */, AgentWorkingAfterCallEvent_pendingAgentState_ready /* IMPORTED_LONG_ENUMERATION_ITEM */, ready /* IMPORTED_SHORT_ENUMERATION_ITEM */, AgentWorkingAfterCallEvent_pendingAgentState_null /* IMPORTED_LONG_ENUMERATION_ITEM */, null_ /* IMPORTED_SHORT_ENUMERATION_ITEM */, _decode_AgentWorkingAfterCallEvent_pendingAgentState, _encode_AgentWorkingAfterCallEvent_pendingAgentState } from "../CSTA-agent-working-after-call-event/AgentWorkingAfterCallEvent-pendingAgentState.ta.mjs";
...
const _root_component_type_list_1_spec_for_AgentWorkingAfterCallEvent: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("pendingAgentState", true, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("cause", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
