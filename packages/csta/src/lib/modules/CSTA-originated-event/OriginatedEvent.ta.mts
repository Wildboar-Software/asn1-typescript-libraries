...
const _root_component_type_list_1_spec_for_OriginatedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("originatedConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("callingDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    new $.ComponentSpec("calledDevice", false, $.hasTag(_TagClass.application, 2), undefined, undefined),
    new $.ComponentSpec("originatingDevice", true, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    ...
    new $.ComponentSpec("originatedConnectionInfo", true, $.hasTag(_TagClass.context, 6), undefined, undefined),
