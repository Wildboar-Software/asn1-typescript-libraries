...
const _root_component_type_list_1_spec_for_HeldEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("heldConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("holdingDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    ...
    new $.ComponentSpec("heldConnectionInfo", true, $.hasTag(_TagClass.context, 4), undefined, undefined),
