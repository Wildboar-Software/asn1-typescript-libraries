...
const _root_component_type_list_1_spec_for_RouteUsedRequestArgument: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("routeUsed", false, $.hasTag(_TagClass.application, 2), undefined, undefined),
    new $.ComponentSpec("callingDevice", true, $.hasTag(_TagClass.application, 1), undefined, undefined),
    new $.ComponentSpec("domain", true, $.hasTag(_TagClass.universal, 1), undefined, undefined),
    new $.ComponentSpec("correlatorData", true, $.hasTag(_TagClass.context, 1), undefined, undefined),
