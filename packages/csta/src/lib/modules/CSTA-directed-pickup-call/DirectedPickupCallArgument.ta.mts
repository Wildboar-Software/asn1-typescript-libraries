...
const _root_component_type_list_1_spec_for_DirectedPickupCallArgument: $.ComponentSpec[] = [
    new $.ComponentSpec("callToBePickedUp", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("requestingDevice", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
