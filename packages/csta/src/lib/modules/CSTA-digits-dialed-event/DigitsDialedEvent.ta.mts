...
const _root_component_type_list_1_spec_for_DigitsDialedEvent: $.ComponentSpec[] = [
    new $.ComponentSpec("dialingConnection", false, $.hasTag(_TagClass.application, 11), undefined, undefined),
    new $.ComponentSpec("dialingDevice", false, $.hasTag(_TagClass.application, 3), undefined, undefined),
    new $.ComponentSpec("dialingSequence", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
    ...
    new $.ComponentSpec("dialingConnectionInfo", true, $.hasTag(_TagClass.context, 2), undefined, undefined),
    ...
    new $.ComponentSpec("locationInfo", true, $.hasTag(_TagClass.context, 6), undefined, undefined),
