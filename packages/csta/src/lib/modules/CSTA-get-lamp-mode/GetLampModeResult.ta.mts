...
// export { LampModeList, _decode_LampModeList, _encode_LampModeList } from "../CSTA-get-lamp-mode/LampModeList.ta.mjs";
...
const _root_component_type_list_1_spec_for_GetLampModeResult: $.ComponentSpec[] = [
    new $.ComponentSpec("lampModeList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
