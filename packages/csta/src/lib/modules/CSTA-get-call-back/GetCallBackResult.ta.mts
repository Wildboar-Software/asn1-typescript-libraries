...
// export { CallBackList, _decode_CallBackList, _encode_CallBackList } from "../CSTA-get-call-back/CallBackList.ta.mjs";
...
const _root_component_type_list_1_spec_for_GetCallBackResult: $.ComponentSpec[] = [
    new $.ComponentSpec("callBackList", false, $.hasTag(_TagClass.universal, 16), undefined, undefined),
