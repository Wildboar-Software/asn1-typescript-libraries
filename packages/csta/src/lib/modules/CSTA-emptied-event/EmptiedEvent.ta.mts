 ...
 * @description
 *
 * Indicates data of a Listener, DTMF, or Prompt Queue subqueue was emptied.
 ...
 * alternative (ECMA-285 §24.2). (ECMA-269 §26.2.4, ECMA-285 §24.2.4).
 *
...
class EmptiedEvent {
    constructor (
         ...
         * @description
         *
         * Connection whose buffer/queue was emptied (ECMA-269 §26.2.4).
         *
         * @public
         * @readonly
         */
