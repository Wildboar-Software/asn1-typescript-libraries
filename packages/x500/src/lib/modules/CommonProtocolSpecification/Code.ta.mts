/* eslint-disable */
import { ASN1Element as _Element, INTEGER, OBJECT_IDENTIFIER } from "@wildboar/asn1";
 ...
 */
export function _decode_Code(el: _Element): Code {
 ...
 */
export function _encode_Code(value: Code, elGetter: $.ASN1Encoder<Code>): _Element {
