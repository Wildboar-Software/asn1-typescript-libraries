...
export { ub_universal_generation_qualifier_length } from "../MTSAbstractService/ub-universal-generation-qualifier-length.va.js";
export { ub_universal_given_name_length } from "../MTSAbstractService/ub-universal-given-name-length.va.js";
export { ub_universal_initials_length } from "../MTSAbstractService/ub-universal-initials-length.va.js";
export { ub_universal_surname_length } from "../MTSAbstractService/ub-universal-surname-length.va.js";
export {
    UniversalOrBMPString,
    _decode_UniversalOrBMPString,
    _encode_UniversalOrBMPString,
