 ...
 * @description
 *
 * DYN-PARMS of `dhModpGr14Hkdf256Algo`. `dhPublicKey` SIZE 256; `nonce`
 ...
 * salt=`nonce`, IKM=DH secret, info=empty. hmacWithSHA256. 6.4.6: certs of
 * both parties are not mixed into the shared secret.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
...
export class Payload14 {
    constructor(
         ...
         * @description
         *
         * SIZE 256. New DH pair per association; client new pair each rekey;
