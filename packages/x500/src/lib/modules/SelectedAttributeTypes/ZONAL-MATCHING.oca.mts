...
export { MAPPING_BASED_MATCHING } from "../InformationFramework/MAPPING-BASED-MATCHING.oca.mjs";
export { zonalMatch } from "../SelectedAttributeTypes/zonalMatch.oa.mjs";
export {
...
} from "../SelectedAttributeTypes/ZonalResult.ta.mjs";
export {
    ZonalSelect,
    _decode_ZonalSelect,
    _encode_ZonalSelect,
} from "../SelectedAttributeTypes/ZonalSelect.ta.mjs";
