...
import { id_at_postalCode } from "../SelectedAttributeTypes/id-at-postalCode.va.mjs";
import {
 ...
 * @description
 *
 * Postal code of the named object; if present, is part of the postal address. `caseIgnoreMatch` / `caseIgnoreSubstringsMatch`.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
