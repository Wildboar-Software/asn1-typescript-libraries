 ...
 * @description
 *
 * CHOICE of TeletexString (T.61), PrintableString, BMPString (UCS-2),
 * UniversalString (UCS-4), UTF8String. Each alternative is SIZE
 * (1..maxSize) — empty strings are forbidden. Matching uses character
 * content, not which alternative was encoded. Prefer `uTF8String` for new
 * values. TeletexString is deprecated.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
