...
export { id_soa_matchingRuleUse } from "../SchemaAdministration/id-soa-matchingRuleUse.va.mjs";
export {
    MatchingRuleUseDescription,
    _decode_MatchingRuleUseDescription,
    _encode_MatchingRuleUseDescription,
} from "../SchemaAdministration/MatchingRuleUseDescription.ta.mjs";
export { matchingRuleUseDescription } from "../SelectedAttributeTypes/matchingRuleUseDescription.oa.mjs";
