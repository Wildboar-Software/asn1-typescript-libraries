...
export { id_soa_objectClasses } from "../SchemaAdministration/id-soa-objectClasses.va.mjs";
export {
    ObjectClassDescription,
    _decode_ObjectClassDescription,
    _encode_ObjectClassDescription,
} from "../SchemaAdministration/ObjectClassDescription.ta.mjs";
export { objectClassDescription } from "../SelectedAttributeTypes/objectClassDescription.oa.mjs";
