...
export { id_soa_nameForms } from "../SchemaAdministration/id-soa-nameForms.va.mjs";
export {
    NameFormDescription,
    _decode_NameFormDescription,
    _encode_NameFormDescription,
} from "../SchemaAdministration/NameFormDescription.ta.mjs";
export { nameFormDescription } from "../SelectedAttributeTypes/nameFormDescription.oa.mjs";
