...
export { id_soa_ldapSyntaxes } from "../LdapSystemSchema/id-soa-ldapSyntaxes.va.mjs";
export {
    LdapSyntaxDescription,
    _decode_LdapSyntaxDescription,
    _encode_LdapSyntaxDescription,
} from "../LdapSystemSchema/LdapSyntaxDescription.ta.mjs";
export { ldapSyntaxDescription } from "../SelectedAttributeTypes/ldapSyntaxDescription.oa.mjs";
