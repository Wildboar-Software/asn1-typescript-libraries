...
export { ub_domain_defined_attribute_type_length } from "../PkiPmiExternalDataTypes/ub-domain-defined-attribute-type-length.va.js";
export { ub_domain_defined_attribute_value_length } from "../PkiPmiExternalDataTypes/ub-domain-defined-attribute-value-length.va.js";
export {
    UniversalOrBMPString,
    _decode_UniversalOrBMPString,
    _encode_UniversalOrBMPString,
