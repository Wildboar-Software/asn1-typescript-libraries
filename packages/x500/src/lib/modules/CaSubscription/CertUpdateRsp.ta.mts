 ...
 * @description
 *
 * Authorizer outcome of CertUpdateReq. `success` if at least one update was
 * processed; `failure` only if no per-item results can be returned.
 * Data-transfer WrPDU.
 *
 * ### ASN.1 Definition:
 *
...
export class CertUpdateRsp {
    constructor(
         ...
         * @description
         *
         * `success` if at least one update was processed; `failure` only if no per-item results can be returned.
         * @public
         * @readonly
         */
