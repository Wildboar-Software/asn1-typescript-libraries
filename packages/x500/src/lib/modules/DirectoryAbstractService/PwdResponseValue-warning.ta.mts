 ...
 * remaining grace binds. If `timeLeft` present and ≠ 0, `error` shall be
 * absent. Zero with `passwordExpired` ⇒ only change-password (master).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 ...
 */
export function _decode_PwdResponseValue_warning(el: _Element): PwdResponseValue_warning {
