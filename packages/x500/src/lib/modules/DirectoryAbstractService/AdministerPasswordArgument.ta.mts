...
} from "../DirectoryAbstractService/AdministerPasswordArgumentData.ta.mjs";
import {
 ...
 */
export function _decode_AdministerPasswordArgument(el: _Element): AdministerPasswordArgument {
