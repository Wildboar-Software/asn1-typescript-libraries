...
import {
    ...
    _decode_LinkId,
    _encode_LinkId,
} from "../DirectoryAbstractService/LinkId.ta.js";
import {
    SecurityParameters,
...
} from "../DirectoryAbstractService/CommonArgumentsSeq.ta.js";
 ...
 * @class
 */
export class LdapArgumentData extends CommonArgumentsSeq {
    constructor(
        /**
         * @summary `object`.
         * @public
