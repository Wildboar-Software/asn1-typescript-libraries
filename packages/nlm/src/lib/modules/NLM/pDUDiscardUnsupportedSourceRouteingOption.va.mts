 ...
 * @description
 *
 * X.233 | ISO/IEC 8473-1 Table 7 Reason for Discard code 179. Paired with
 ...
 * @constant
 */
export const pDUDiscardUnsupportedSourceRouteingOption: OBJECT_IDENTIFIER = _OID.fromParts(
