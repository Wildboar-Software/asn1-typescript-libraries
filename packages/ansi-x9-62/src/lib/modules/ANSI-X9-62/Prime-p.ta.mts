 ...
 */
export function _decode_Prime_p(el: _Element) {
    if (!_cached_decoder_for_Prime_p) {
        _cached_decoder_for_Prime_p = $._decodeInteger;
    }
...
export function _encode_Prime_p(
    value: Prime_p,
    elGetter: $.ASN1Encoder<Prime_p>
) {
    if (!_cached_encoder_for_Prime_p) {
        _cached_encoder_for_Prime_p = $._encodeInteger;
    }
