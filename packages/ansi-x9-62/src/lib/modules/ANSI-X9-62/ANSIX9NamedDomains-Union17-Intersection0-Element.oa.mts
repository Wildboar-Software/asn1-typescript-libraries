 ...
 * @description
 *
 * Information-object member for `ansix9p521r1` (later-module L.6.6.2). Not in
 * X9.62-1998 Annex J.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
 * ANSIX9NamedDomains-Union17-Intersection0-Element ::= {} -- REMOVED_FROM_UNNESTING --
 * ```
 *
 * @constant
 * @type {ECDOMAIN}
 * @implements {ECDOMAIN}
 */
export const ANSIX9NamedDomains_Union17_Intersection0_Element: ECDOMAIN = {
    class: "ECDOMAIN",
    decoderFor: {},
    encoderFor: {},
