...
} from "../ANSI-X9-62/ECPKAlgorithm.ta.mjs";

/**
 * @summary SubjectPublicKeyInfo
 * @description
 *
 * X.509-style encoding of an EC public key. `algorithm` is
 * `ECPKAlgorithm` (`AlgorithmIdentifier {{ ECPKAlgorithms }}`);
 * `subjectPublicKey` is the `ECPoint` octet string mapped
 * bit-for-bit into a BIT STRING. ANSI X9.62-1998 §6.4.
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
...
export class SubjectPublicKeyInfo {
    constructor(
         ...
         * @description
         *
         * Key type and domain parameters (`ECPKAlgorithms`).
         * ANSI X9.62-1998 §6.4.
         *
         * @public
         * @readonly
         ...
         * @description
         *
         * The `ECPoint` octet string mapped bit-for-bit into a
         * BIT STRING. ANSI X9.62-1998 §6.4.
         *
         * @public
         * @readonly
         */
 ...
 */
export function _decode_SubjectPublicKeyInfo(
    el: _Element
): SubjectPublicKeyInfo {
