 ...
 */
export function _decode_Trinomial(el: _Element) {
    if (!_cached_decoder_for_Trinomial) {
        _cached_decoder_for_Trinomial = $._decodeInteger;
    }
...
export function _encode_Trinomial(
    value: Trinomial,
    elGetter: $.ASN1Encoder<Trinomial>
) {
    if (!_cached_encoder_for_Trinomial) {
        _cached_encoder_for_Trinomial = $._encodeInteger;
    }
