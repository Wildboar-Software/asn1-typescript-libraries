 ...
 */
export
function _decode_GetRequest_PDU (el: _Element): GetRequest_PDU {
 ...
 */
export
function _encode_GetRequest_PDU (value: GetRequest_PDU, elGetter: $.ASN1Encoder<GetRequest_PDU>): _Element {
