...
const _root_component_type_list_1_spec_for_BulkPDU: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("non-repeaters", false, $.hasTag(_TagClass.universal, 2), undefined, undefined),
    new $.ComponentSpec("max-repetitions", false, $.hasTag(_TagClass.universal, 2), undefined, undefined),
