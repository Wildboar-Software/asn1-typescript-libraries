...
const _root_component_type_list_1_spec_for_DITContextUse: $.ComponentSpec[] = [
    new $.ComponentSpec("attributeType", false, $.hasTag(_TagClass.universal, 6)),
    new $.ComponentSpec("mandatoryContexts", true, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("optionalContexts", true, $.hasTag(_TagClass.context, 2))
];
