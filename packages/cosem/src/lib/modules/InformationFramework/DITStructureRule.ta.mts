...
const _root_component_type_list_1_spec_for_DITStructureRule: $.ComponentSpec[] = [
    new $.ComponentSpec("ruleIdentifier", false, $.hasTag(_TagClass.universal, 2)),
    new $.ComponentSpec("nameForm", false, $.hasTag(_TagClass.universal, 6)),
    new $.ComponentSpec("superiorStructureRules", true, $.hasTag(_TagClass.universal, 17))
];
