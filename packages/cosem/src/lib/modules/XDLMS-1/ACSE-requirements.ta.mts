 ...
 */
export
const ACSE_requirements_aSO_context_negotiation: number = 1; /* LONG_NAMED_BIT */
 ...
 */
export
const aSO_context_negotiation: number = ACSE_requirements_aSO_context_negotiation; /* SHORT_NAMED_BIT */
 ...
 */
export
const ACSE_requirements_higher_level_association: number = 2; /* LONG_NAMED_BIT */
 ...
 */
export
const higher_level_association: number = ACSE_requirements_higher_level_association; /* SHORT_NAMED_BIT */
 ...
 */
export
const ACSE_requirements_nested_association: number = 3; /* LONG_NAMED_BIT */
 ...
 */
export
const nested_association: number = ACSE_requirements_nested_association; /* SHORT_NAMED_BIT */
