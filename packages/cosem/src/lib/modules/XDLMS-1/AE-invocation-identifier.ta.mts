 ...
 */
export
type AE_invocation_identifier = INTEGER;
 ...
 */
export
function _decode_AE_invocation_identifier (el: _Element): AE_invocation_identifier {
    if (!_cached_decoder_for_AE_invocation_identifier) { _cached_decoder_for_AE_invocation_identifier = $._decodeInteger; }
 ...
 */
export
function _encode_AE_invocation_identifier (value: AE_invocation_identifier, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AE_invocation_identifier) { _cached_encoder_for_AE_invocation_identifier = $._encodeInteger; }
