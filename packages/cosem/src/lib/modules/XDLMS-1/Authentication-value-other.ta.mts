 ...
 */
export
class Authentication_value_other {
    constructor (
        /**
...
// FIXME: readonly other-mechanism-value: AnyType
    ) {}
     ...
     */
    public static _from_object (_o: { [_K in keyof (Authentication_value_other)]: (Authentication_value_other)[_K] }): Authentication_value_other {
        return new Authentication_value_other(_o.other_mechanism_name, _o.);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_Authentication_value_other: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_Authentication_value_other: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_Authentication_value_other: $.ComponentSpec[] = [
 ...
 */
export
function _decode_Authentication_value_other (el: _Element): Authentication_value_other {
    if (!_cached_decoder_for_Authentication_value_other) { _cached_decoder_for_Authentication_value_other = function (el: _Element): Authentication_value_other {
    const sequence: _Element[] = el.sequence;
    if (sequence.length < 2) {
        throw new _ConstructionError("Authentication-value-other contained only " + sequence.length.toString() + " elements.");
    }
    sequence[0].name = "other-mechanism-name";
    sequence[1].name = "other-mechanism-value";
    let other_mechanism_name!: OBJECT_IDENTIFIER;
    let other_mechanism_value!: /* FIXME: other-mechanism-value COULD_NOT_COMPILE_TYPE */;
 ...
 */
export
function _encode_Authentication_value_other (value: Authentication_value_other, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Authentication_value_other) { _cached_encoder_for_Authentication_value_other = function (value: Authentication_value_other, elGetter: $.ASN1Encoder<Authentication_value_other>): _Element {
