 ...
 */
export
type TelephoneNumber = PrintableString; // PrintableString
 ...
 */
export
function _decode_TelephoneNumber (el: _Element): TelephoneNumber {
    if (!_cached_decoder_for_TelephoneNumber) { _cached_decoder_for_TelephoneNumber = $._decodePrintableString; }
 ...
 */
export
function _encode_TelephoneNumber (value: TelephoneNumber, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TelephoneNumber) { _cached_encoder_for_TelephoneNumber = $._encodePrintableString; }
