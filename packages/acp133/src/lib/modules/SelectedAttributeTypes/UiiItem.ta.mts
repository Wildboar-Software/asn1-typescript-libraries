...
class UiiItem {
     ...
     * @returns {UiiItem}
     */
    public static _from_object (_o: { [_K in keyof (UiiItem)]: (UiiItem)[_K] }): UiiItem {
 ...
 */
export
const _root_component_type_list_1_spec_for_UiiItem: $.ComponentSpec[] = [
    new $.ComponentSpec("type", false, $.hasAnyTag),
    new $.ComponentSpec("length", true, $.hasTag(_TagClass.universal, 2))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_UiiItem: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_UiiItem: $.ComponentSpec[] = [
 ...
 */
export
function _decode_UiiItem (el: _Element): UiiItem {
    if (!_cached_decoder_for_UiiItem) { _cached_decoder_for_UiiItem = function (el: _Element): UiiItem {
    ...
    const callbacks: $.DecodingMap = {
        ...
        "length": (_el: _Element): void => { length = $._decodeInteger(_el); }
    };
 ...
 */
export
function _encode_UiiItem (value: UiiItem, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_UiiItem) { _cached_encoder_for_UiiItem = function (value: UiiItem, elGetter: $.ASN1Encoder<UiiItem>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encodeAny /* COULD_NOT_RESOLVE_OBJECT_CLASS_DEF */(value.type_, $.BER),
            /* IF_ABSENT  */ ((value.length === undefined) ? undefined : $._encodeInteger(value.length, $.BER))
        ],
