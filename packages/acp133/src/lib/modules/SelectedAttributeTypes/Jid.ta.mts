 ...
 */
export
type Jid = UTF8String; // UTF8String
 ...
 */
export
function _decode_Jid (el: _Element): Jid {
    if (!_cached_decoder_for_Jid) { _cached_decoder_for_Jid = $._decodeUTF8String; }
 ...
 */
export
function _encode_Jid (value: Jid, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Jid) { _cached_encoder_for_Jid = $._encodeUTF8String; }
