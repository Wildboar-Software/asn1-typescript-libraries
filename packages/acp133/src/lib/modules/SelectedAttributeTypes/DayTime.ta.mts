...
class DayTime {
    ...
    public static _from_object (_o: { [_K in keyof (DayTime)]: (DayTime)[_K] }): DayTime {
        return new DayTime(_o.hour, _o.minute, _o.second, _o._unrecognizedExtensionsList);
    }
...
const _root_component_type_list_1_spec_for_DayTime: $.ComponentSpec[] = [
    new $.ComponentSpec("hour", false, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("minute", true, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("second", true, $.hasTag(_TagClass.context, 2))
];
...
function _encode_DayTime (value: DayTime, elGetter: $.ASN1Encoder<any>): _Element {
    ...
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* REQUIRED   */ $._encode_explicit(_TagClass.context, 0, () => $._encodeInteger, $.BER)(value.hour, $.BER),
            /* IF_DEFAULT */ (value.minute === undefined || $.deepEq(value.minute, DayTime._default_value_for_minute) ? undefined : $._encode_explicit(_TagClass.context, 1, () => $._encodeInteger, $.BER)(value.minute, $.BER)),
            /* IF_DEFAULT */ (value.second === undefined || $.deepEq(value.second, DayTime._default_value_for_second) ? undefined : $._encode_explicit(_TagClass.context, 2, () => $._encodeInteger, $.BER)(value.second, $.BER))
        ],
