 ...
 */
export
function _decode_MRMappings (el: _Element): MRMappings {
    if (!_cached_decoder_for_MRMappings) { _cached_decoder_for_MRMappings = $._decodeSequenceOf<MRMapping>(() => _decode_MRMapping); }
 ...
 */
export
function _encode_MRMappings (value: MRMappings, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MRMappings) { _cached_encoder_for_MRMappings = $._encodeSequenceOf<MRMapping>(() => _encode_MRMapping, $.BER); }
