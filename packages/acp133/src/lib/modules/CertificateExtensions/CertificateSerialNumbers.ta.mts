 ...
 */
export
function _decode_CertificateSerialNumbers (el: _Element): CertificateSerialNumbers {
    if (!_cached_decoder_for_CertificateSerialNumbers) { _cached_decoder_for_CertificateSerialNumbers = $._decodeSequenceOf<CertificateSerialNumber>(() => _decode_CertificateSerialNumber); }
 ...
 */
export
function _encode_CertificateSerialNumbers (value: CertificateSerialNumbers, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_CertificateSerialNumbers) { _cached_encoder_for_CertificateSerialNumbers = $._encodeSequenceOf<CertificateSerialNumber>(() => _encode_CertificateSerialNumber, $.BER); }
