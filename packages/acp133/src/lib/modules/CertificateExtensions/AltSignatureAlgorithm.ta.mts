 ...
 */
export
function _decode_AltSignatureAlgorithm (el: _Element): AltSignatureAlgorithm {
    if (!_cached_decoder_for_AltSignatureAlgorithm) { _cached_decoder_for_AltSignatureAlgorithm = _decode_AlgorithmIdentifier; }
 ...
 */
export
function _encode_AltSignatureAlgorithm (value: AltSignatureAlgorithm, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AltSignatureAlgorithm) { _cached_encoder_for_AltSignatureAlgorithm = _encode_AlgorithmIdentifier; }
