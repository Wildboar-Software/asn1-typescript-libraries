...
class IssuingDistPointSyntax {
     ...
     */
    public static _from_object (_o: { [_K in keyof (IssuingDistPointSyntax)]: (IssuingDistPointSyntax)[_K] }): IssuingDistPointSyntax {
        return new IssuingDistPointSyntax(_o.distributionPoint, _o.onlyContainsUserPublicKeyCerts, _o.onlyContainsCACerts, _o.onlySomeReasons, _o.indirectCRL, _o.onlyContainsAttributeCerts, _o._unrecognizedExtensionsList);
    }
     ...
     * @method
     */
    public static get _default_value_for_onlyContainsUserPublicKeyCerts () { return false; }
    /**
 ...
 */
export
const _root_component_type_list_1_spec_for_IssuingDistPointSyntax: $.ComponentSpec[] = [
    new $.ComponentSpec("distributionPoint", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("onlyContainsUserPublicKeyCerts", true, $.hasTag(_TagClass.context, 1)),
 ...
 */
export
const _root_component_type_list_2_spec_for_IssuingDistPointSyntax: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_IssuingDistPointSyntax: $.ComponentSpec[] = [
 ...
 */
export
function _decode_IssuingDistPointSyntax (el: _Element): IssuingDistPointSyntax {
    if (!_cached_decoder_for_IssuingDistPointSyntax) { _cached_decoder_for_IssuingDistPointSyntax = function (el: _Element): IssuingDistPointSyntax {
    let distributionPoint: OPTIONAL<DistributionPointName>;
    let onlyContainsUserPublicKeyCerts: OPTIONAL<BOOLEAN> = IssuingDistPointSyntax._default_value_for_onlyContainsUserPublicKeyCerts;
    let onlyContainsCACerts: OPTIONAL<BOOLEAN> = IssuingDistPointSyntax._default_value_for_onlyContainsCACerts;
    let onlySomeReasons: OPTIONAL<ReasonFlags>;
    let indirectCRL: OPTIONAL<BOOLEAN> = IssuingDistPointSyntax._default_value_for_indirectCRL;
    ...
    const callbacks: $.DecodingMap = {
        ...
        "onlyContainsUserPublicKeyCerts": (_el: _Element): void => { onlyContainsUserPublicKeyCerts = $._decode_implicit<BOOLEAN>(() => $._decodeBoolean)(_el); },
 ...
 */
export
function _encode_IssuingDistPointSyntax (value: IssuingDistPointSyntax, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_IssuingDistPointSyntax) { _cached_encoder_for_IssuingDistPointSyntax = function (value: IssuingDistPointSyntax, elGetter: $.ASN1Encoder<IssuingDistPointSyntax>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            ...
            /* IF_DEFAULT */ (value.onlyContainsUserPublicKeyCerts === undefined || $.deepEq(value.onlyContainsUserPublicKeyCerts, IssuingDistPointSyntax._default_value_for_onlyContainsUserPublicKeyCerts) ? undefined : $._encode_implicit(_TagClass.context, 1, () => $._encodeBoolean, $.BER)(value.onlyContainsUserPublicKeyCerts, $.BER)),
            /* IF_DEFAULT */ (value.onlyContainsCACerts === undefined || $.deepEq(value.onlyContainsCACerts, IssuingDistPointSyntax._default_value_for_onlyContainsCACerts) ? undefined : $._encode_implicit(_TagClass.context, 2, () => $._encodeBoolean, $.BER)(value.onlyContainsCACerts, $.BER)),
            ...
            /* IF_DEFAULT */ (value.indirectCRL === undefined || $.deepEq(value.indirectCRL, IssuingDistPointSyntax._default_value_for_indirectCRL) ? undefined : $._encode_implicit(_TagClass.context, 4, () => $._encodeBoolean, $.BER)(value.indirectCRL, $.BER)),
            /* IF_ABSENT  */ ((value.onlyContainsAttributeCerts === undefined) ? undefined : $._encode_implicit(_TagClass.context, 5, () => $._encodeBoolean, $.BER)(value.onlyContainsAttributeCerts, $.BER))
        ],
