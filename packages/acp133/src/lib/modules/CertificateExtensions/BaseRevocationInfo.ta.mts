...
class BaseRevocationInfo {
     ...
     */
    public static _from_object (_o: { [_K in keyof (BaseRevocationInfo)]: (BaseRevocationInfo)[_K] }): BaseRevocationInfo {
        return new BaseRevocationInfo(_o.cRLStreamIdentifier, _o.cRLNumber, _o.baseThisUpdate, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_BaseRevocationInfo: $.ComponentSpec[] = [
    new $.ComponentSpec("cRLStreamIdentifier", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("cRLNumber", false, $.hasTag(_TagClass.context, 1)),
    new $.ComponentSpec("baseThisUpdate", false, $.hasTag(_TagClass.context, 2))
];
 ...
 */
export
const _root_component_type_list_2_spec_for_BaseRevocationInfo: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_BaseRevocationInfo: $.ComponentSpec[] = [
 ...
 */
export
function _decode_BaseRevocationInfo (el: _Element): BaseRevocationInfo {
    if (!_cached_decoder_for_BaseRevocationInfo) { _cached_decoder_for_BaseRevocationInfo = function (el: _Element): BaseRevocationInfo {
    ...
    const callbacks: $.DecodingMap = {
        "cRLStreamIdentifier": (_el: _Element): void => { cRLStreamIdentifier = $._decode_implicit<CRLStreamIdentifier>(() => _decode_CRLStreamIdentifier)(_el); },
        "cRLNumber": (_el: _Element): void => { cRLNumber = $._decode_implicit<CRLNumber>(() => _decode_CRLNumber)(_el); },
        "baseThisUpdate": (_el: _Element): void => { baseThisUpdate = $._decode_implicit<GeneralizedTime>(() => $._decodeGeneralizedTime)(_el); }
    };
 ...
 */
export
function _encode_BaseRevocationInfo (value: BaseRevocationInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_BaseRevocationInfo) { _cached_encoder_for_BaseRevocationInfo = function (value: BaseRevocationInfo, elGetter: $.ASN1Encoder<BaseRevocationInfo>): _Element {
    return $._encodeSequence(([] as (_Element | undefined)[]).concat(
        [
            /* IF_ABSENT  */ ((value.cRLStreamIdentifier === undefined) ? undefined : $._encode_implicit(_TagClass.context, 0, () => _encode_CRLStreamIdentifier, $.BER)(value.cRLStreamIdentifier, $.BER)),
            /* REQUIRED   */ $._encode_implicit(_TagClass.context, 1, () => _encode_CRLNumber, $.BER)(value.cRLNumber, $.BER),
            /* REQUIRED   */ $._encode_implicit(_TagClass.context, 2, () => $._encodeGeneralizedTime, $.BER)(value.baseThisUpdate, $.BER)
        ],
