...
const _root_component_type_list_1_spec_for_AltName: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("altNameValue", true, $.or($.hasTag(_TagClass.context, 0), $.hasTag(_TagClass.context, 1), $.hasTag(_TagClass.context, 2), $.hasAnyTag, $.hasAnyTag, $.hasTag(_TagClass.context, 5), $.hasTag(_TagClass.context, 6), $.hasTag(_TagClass.context, 7), $.hasTag(_TagClass.context, 8)))
];
