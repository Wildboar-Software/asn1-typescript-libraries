...
class AvlId {
    ...
    public static _from_object (_o: { [_K in keyof (AvlId)]: (AvlId)[_K] }): AvlId {
        return new AvlId(_o.issuer, _o.serialNumber, _o._unrecognizedExtensionsList);
    }
 ...
 */
export
const _root_component_type_list_1_spec_for_AvlId: $.ComponentSpec[] = [
 ...
 */
export
const _root_component_type_list_2_spec_for_AvlId: $.ComponentSpec[] = [
 ...
 */
export
const _extension_additions_list_spec_for_AvlId: $.ComponentSpec[] = [
 ...
 */
export
function _decode_AvlId (el: _Element): AvlId {
    if (!_cached_decoder_for_AvlId) { _cached_decoder_for_AvlId = function (el: _Element): AvlId {
    let issuer!: Name;
 ...
 */
export
function _encode_AvlId (value: AvlId, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AvlId) { _cached_encoder_for_AvlId = function (value: AvlId, elGetter: $.ASN1Encoder<AvlId>): _Element {
