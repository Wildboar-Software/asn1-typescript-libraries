...
import { tcg_at_platformVersion } from "../PlatformCertificateProfile/tcg-at-platformVersion.va.js";
export { tcg_at_platformVersion } from "../PlatformCertificateProfile/tcg-at-platformVersion.va.js";


/* START_OF_SYMBOL_DEFINITION platformVersion */
/**
 ...
 */
export
const platformVersion: ATTRIBUTE<UTF8String> = {
    class: "ATTRIBUTE",
    decoderFor: {
    ...
    "&id": tcg_at_platformVersion /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
...
/* END_OF_SYMBOL_DEFINITION platformVersion */
