...
export { TCGSpecificationVersion, _decode_TCGSpecificationVersion, _encode_TCGSpecificationVersion } from "../PlatformCertificateProfile/TCGSpecificationVersion.ta.mjs";
...
function _encode_TCGPlatformSpecification (value: TCGPlatformSpecification, elGetter: $.ASN1Encoder<TCGPlatformSpecification>) {
    if (!_cached_encoder_for_TCGPlatformSpecification) { _cached_encoder_for_TCGPlatformSpecification = function (value: TCGPlatformSpecification, elGetter: $.ASN1Encoder<TCGPlatformSpecification>): _Element {
