...
/* START_OF_SYMBOL_DEFINITION noSuchObjectInstance */
/**
 * @summary noSuchObjectInstance
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const noSuchObjectInstance: ERROR<ObjectInstance> = {
  class: 'ERROR',
  decoderFor: {
...
/* END_OF_SYMBOL_DEFINITION noSuchObjectInstance */
