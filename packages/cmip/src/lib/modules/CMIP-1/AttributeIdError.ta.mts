 ...
 * @description
 *
 * Per-attribute get failure in `GetInfoStatus`. Status
 * is `accessDenied` (2) or `noSuchAttribute` (5). ITU-T
 * Rec. X.711 (10/97)
...
export class AttributeIdError {
  constructor(
     ...
     * @description
     *
     * `accessDenied` (2) or `noSuchAttribute` (5).
     *
     * @public
     * @readonly
     */
 ...
 */
export function _decode_AttributeIdError(el: _Element): AttributeIdError {
