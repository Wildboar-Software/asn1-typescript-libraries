 ...
 * @description
 *
 * Argument of `m-Set` and `m-Set-Confirmed`. Applies
 * `modificationList` to the scoped, filtered set. For
...
export class SetArgument implements BaseManagedObjectId {
  constructor(
     ...
     * @description
     *
     * Modifications to apply. Default operator is
     * `replace`. Omit `attributeValue` when the operator
     * is `setToDefault`.
     *
     * @public
     * @readonly
