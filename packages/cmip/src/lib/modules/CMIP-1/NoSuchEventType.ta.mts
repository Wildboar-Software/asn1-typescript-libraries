 ...
 * @description
 *
 * Parameter of `noSuchEventType` (ROSE local:13): class
 * and unknown event type. ITU-T Rec. X.711 (10/97)
...
export class NoSuchEventType {
  constructor(
     ...
     * @description
     *
     * Class on which the unknown event was reported.
     *
     * @public
     * @readonly
     */
     ...
     * @description
     *
     * Event type that is not defined for the class.
     *
     * @public
     * @readonly
     */
