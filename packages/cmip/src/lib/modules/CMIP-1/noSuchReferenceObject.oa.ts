...
/* START_OF_SYMBOL_DEFINITION noSuchReferenceObject */
/**
 * @summary noSuchReferenceObject
 * @description
 *
 * ### ASN.1 Definition:
 *
 ...
 */
export const noSuchReferenceObject: ERROR<ObjectInstance> = {
  class: 'ERROR',
  decoderFor: {
...
/* END_OF_SYMBOL_DEFINITION noSuchReferenceObject */
