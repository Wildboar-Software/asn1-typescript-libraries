...
const _root_component_type_list_1_spec_for_RequestReportSMSEventArg: $.ComponentSpec[] = [
    new $.ComponentSpec("sMSEvents", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
...
function _encode_RequestReportSMSEventArg (value: RequestReportSMSEventArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RequestReportSMSEventArg) { _cached_encoder_for_RequestReportSMSEventArg = function (value: RequestReportSMSEventArg, elGetter: $.ASN1Encoder<RequestReportSMSEventArg>): _Element {
