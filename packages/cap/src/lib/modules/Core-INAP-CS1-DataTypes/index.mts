 ...
 * @description
 *
 * ASN.1 module `Core-INAP-CS1-DataTypes` (named `CS1-DataTypes` in CAP
 * IMPORTS). Imported by CAP V4 from ETS 300 374-1. This package carries
 * only the CS1 symbols CAP needs (e.g. `ServiceKey`, `LegID`,
 * `Duration`, `Integer4`). Per-type semantics are in that ETSI spec, not
 * 3GPP TS 29.078. (3GPP TS 29.078 V19.0.0 clause 2.1 Table 2-1).
 */
