...
import { VariablePart, _decode_VariablePart, _encode_VariablePart } from "../Core-INAP-CS1-DataTypes/VariablePart.ta.mjs";
// export { VariablePart, _decode_VariablePart, _encode_VariablePart } from "../Core-INAP-CS1-DataTypes/VariablePart.ta.mjs";
...
function _encode_MessageID_variableMessage (value: MessageID_variableMessage, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_MessageID_variableMessage) { _cached_encoder_for_MessageID_variableMessage = function (value: MessageID_variableMessage): _Element {
