...
function _encode_EventSpecificInformationBCSM_tNoAnswerSpecificInfo (value: EventSpecificInformationBCSM_tNoAnswerSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_tNoAnswerSpecificInfo) { _cached_encoder_for_EventSpecificInformationBCSM_tNoAnswerSpecificInfo = function (): _Element {
