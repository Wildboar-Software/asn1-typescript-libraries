...
function _encode_EventSpecificInformationBCSM_oAnswerSpecificInfo (value: EventSpecificInformationBCSM_oAnswerSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_oAnswerSpecificInfo) { _cached_encoder_for_EventSpecificInformationBCSM_oAnswerSpecificInfo = function (): _Element {
