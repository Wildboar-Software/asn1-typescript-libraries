...
function _encode_EventSpecificInformationBCSM_tAnswerSpecificInfo (value: EventSpecificInformationBCSM_tAnswerSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_tAnswerSpecificInfo) { _cached_encoder_for_EventSpecificInformationBCSM_tAnswerSpecificInfo = function (): _Element {
