...
const _root_component_type_list_1_spec_for_InitialDPArg: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("cause", true, $.hasTag(_TagClass.context, 17), undefined, undefined),
    new $.ComponentSpec("serviceInteractionIndicatorsTwo", true, $.hasTag(_TagClass.context, 32), undefined, undefined),
    new $.ComponentSpec("carrier", true, $.hasTag(_TagClass.context, 37), undefined, undefined),
    new $.ComponentSpec("cug-Index", true, $.hasTag(_TagClass.context, 45), undefined, undefined),
    new $.ComponentSpec("cug-Interlock", true, $.hasTag(_TagClass.context, 46), undefined, undefined),
    new $.ComponentSpec("cug-OutgoingAccess", true, $.hasTag(_TagClass.context, 47), undefined, undefined),
    new $.ComponentSpec("iMSI", true, $.hasTag(_TagClass.context, 50), undefined, undefined),
    new $.ComponentSpec("subscriberState", true, $.hasTag(_TagClass.context, 51), undefined, undefined),
    new $.ComponentSpec("locationInformation", true, $.hasTag(_TagClass.context, 52), undefined, undefined),
    new $.ComponentSpec("ext-basicServiceCode", true, $.hasTag(_TagClass.context, 53), undefined, undefined),
    new $.ComponentSpec("callReferenceNumber", true, $.hasTag(_TagClass.context, 54), undefined, undefined),
    new $.ComponentSpec("mscAddress", true, $.hasTag(_TagClass.context, 55), undefined, undefined),
    new $.ComponentSpec("calledPartyBCDNumber", true, $.hasTag(_TagClass.context, 56), undefined, undefined),
    new $.ComponentSpec("timeAndTimezone", true, $.hasTag(_TagClass.context, 57), undefined, undefined),
    new $.ComponentSpec("callForwardingSS-Pending", true, $.hasTag(_TagClass.context, 58), undefined, undefined),
    new $.ComponentSpec("initialDPArgExtension", true, $.hasTag(_TagClass.context, 59), undefined, undefined)
];
