...
const _root_component_type_list_1_spec_for_PlayToneArg: $.ComponentSpec[] = [
    new $.ComponentSpec("legOrCallSegment", false, $.hasTag(_TagClass.context, 0)),
...
function _encode_PlayToneArg (value: PlayToneArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_PlayToneArg) { _cached_encoder_for_PlayToneArg = function (value: PlayToneArg): _Element {
