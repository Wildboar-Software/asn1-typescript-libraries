...
function _encode_ContinueWithArgumentArgExtension (value: ContinueWithArgumentArgExtension, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ContinueWithArgumentArgExtension) { _cached_encoder_for_ContinueWithArgumentArgExtension = function (value: ContinueWithArgumentArgExtension, elGetter: $.ASN1Encoder<ContinueWithArgumentArgExtension>): _Element {
