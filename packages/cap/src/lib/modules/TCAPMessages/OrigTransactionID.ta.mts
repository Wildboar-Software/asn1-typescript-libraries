 ...
 */
export
type OrigTransactionID = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_OrigTransactionID (el: _Element): OrigTransactionID {
    if (!_cached_decoder_for_OrigTransactionID) { _cached_decoder_for_OrigTransactionID = $._decode_implicit<OrigTransactionID>(() => $._decodeOctetString); }
 ...
 */
export
function _encode_OrigTransactionID (value: OrigTransactionID, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_OrigTransactionID) { _cached_encoder_for_OrigTransactionID = $._encode_implicit(_TagClass.application, 8, () => $._encodeOctetString, $.BER); }
