 ...
 */
export
type DestTransactionID = OCTET_STRING; // OctetStringType
 ...
 */
export
function _decode_DestTransactionID (el: _Element): DestTransactionID {
    if (!_cached_decoder_for_DestTransactionID) { _cached_decoder_for_DestTransactionID = $._decode_implicit<DestTransactionID>(() => $._decodeOctetString); }
 ...
 */
export
function _encode_DestTransactionID (value: DestTransactionID, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DestTransactionID) { _cached_encoder_for_DestTransactionID = $._encode_implicit(_TagClass.application, 9, () => $._encodeOctetString, $.BER); }
