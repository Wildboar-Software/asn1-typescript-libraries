 ...
 */
export
type DialoguePortion = EXTERNAL; // ExternalType
 ...
 */
export
function _decode_DialoguePortion (el: _Element): DialoguePortion {
    if (!_cached_decoder_for_DialoguePortion) { _cached_decoder_for_DialoguePortion = $._decode_explicit<DialoguePortion>(() => $._decodeExternal); }
 ...
 */
export
function _encode_DialoguePortion (value: DialoguePortion, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_DialoguePortion) { _cached_encoder_for_DialoguePortion = $._encode_explicit(_TagClass.application, 11, () => $._encodeExternal, $.BER); }
