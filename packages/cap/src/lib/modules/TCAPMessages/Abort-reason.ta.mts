...
import { P_AbortCause, _decode_P_AbortCause, _encode_P_AbortCause } from "../TCAPMessages/P-AbortCause.ta.mjs";
// export { P_AbortCause, _decode_P_AbortCause, _encode_P_AbortCause } from "../TCAPMessages/P-AbortCause.ta.mjs";
...
function _decode_Abort_reason (el: _Element): Abort_reason {
    if (!_cached_decoder_for_Abort_reason) { _cached_decoder_for_Abort_reason = $._decode_inextensible_choice<Abort_reason>({
...
function _encode_Abort_reason (value: Abort_reason, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_Abort_reason) { _cached_encoder_for_Abort_reason = $._encode_choice<Abort_reason>({
