...
import { id_ac_cap3_sms_AC } from "../CAP-object-identifiers/id-ac-cap3-sms-AC.va.mjs";
// export { id_ac_cap3_sms_AC } from "../CAP-object-identifiers/id-ac-cap3-sms-AC.va.mjs";
 ...
 * @description
 * 
 * CAMEL MO-SMS application context. Contract `cap3SMS`; structured dialogue;
 * abstract syntaxes `dialogue-abstract-syntax` and `sms-AbstractSyntax`. Rel-6
 * uses the same AC version as Rel-5; the contract and abstract syntaxes are
 ...
 */
export
const cap3_sms_AC: APPLICATION_CONTEXT = {
    class: "APPLICATION-CONTEXT",
    decoderFor: {
    },
    encoderFor: {
    },
    "&associationContract": cap3SMS /* OBJECT_FIELD_SETTING */,
    ...
    "&applicationContextName": id_ac_cap3_sms_AC /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
