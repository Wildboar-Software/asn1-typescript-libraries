...
const _root_component_type_list_1_spec_for_SGSN_Capability: $.ComponentSpec[] = [
    new $.ComponentSpec("solsaSupportIndicator", true, $.hasTag(_TagClass.universal, 5), undefined, undefined),
...
const _extension_additions_list_spec_for_SGSN_Capability: $.ComponentSpec[] = [
    new $.ComponentSpec("superChargerSupportedInServingNetworkEntity", true, $.hasTag(_TagClass.context, 2), undefined, undefined),
    new $.ComponentSpec("gprsEnhancementsSupportIndicator", true, $.hasTag(_TagClass.context, 3), undefined, undefined),
    ...
    new $.ComponentSpec("smsCallBarringSupportIndicator", true, $.hasTag(_TagClass.context, 7), undefined, undefined),
    new $.ComponentSpec("supportedRAT-TypesIndicator", true, $.hasTag(_TagClass.context, 8), undefined, undefined),
    new $.ComponentSpec("supportedFeatures", true, $.hasTag(_TagClass.context, 9), undefined, undefined),
    new $.ComponentSpec("t-adsDataRetrieval", true, $.hasTag(_TagClass.context, 10), undefined, undefined),
    new $.ComponentSpec("homogeneousSupportOfIMSVoiceOverPSSessions", true, $.hasTag(_TagClass.context, 11), undefined, undefined),
    new $.ComponentSpec("cancellationTypeInitialAttach", true, $.hasTag(_TagClass.context, 12), undefined, undefined),
    new $.ComponentSpec("msisdn-lessOperation-Supported", true, $.hasTag(_TagClass.context, 14), undefined, undefined),
    new $.ComponentSpec("updateofHomogeneousSupportOfIMSVoiceOverPSSessions", true, $.hasTag(_TagClass.context, 15), undefined, undefined),
    new $.ComponentSpec("reset-ids-Supported", true, $.hasTag(_TagClass.context, 16), undefined, undefined),
    new $.ComponentSpec("ext-SupportedFeatures", true, $.hasTag(_TagClass.context, 17), undefined, undefined)
];
...
function _decode_SGSN_Capability (el: _Element): SGSN_Capability {
    ...
    let gprsEnhancementsSupportIndicator: OPTIONAL<NULL>;
    ...
    let smsCallBarringSupportIndicator: OPTIONAL<NULL>;
    let supportedRAT_TypesIndicator: OPTIONAL<SupportedRAT_Types>;
    let supportedFeatures: OPTIONAL<SupportedFeatures>;
    let t_adsDataRetrieval: OPTIONAL<NULL>;
    let homogeneousSupportOfIMSVoiceOverPSSessions: OPTIONAL<BOOLEAN>;
    let cancellationTypeInitialAttach: OPTIONAL<NULL>;
    let msisdn_lessOperation_Supported: OPTIONAL<NULL>;
    let updateofHomogeneousSupportOfIMSVoiceOverPSSessions: OPTIONAL<NULL>;
