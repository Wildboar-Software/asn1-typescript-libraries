...
let _cached_decoder_for_TypeOfUpdate: $.ASN1Decoder<TypeOfUpdate> | null = null;
 ...
 */
export
function _decode_TypeOfUpdate (el: _Element): TypeOfUpdate {
    if (!_cached_decoder_for_TypeOfUpdate) { _cached_decoder_for_TypeOfUpdate = $._decodeEnumerated; }
    return _cached_decoder_for_TypeOfUpdate(el);
}

let _cached_encoder_for_TypeOfUpdate: $.ASN1Encoder<TypeOfUpdate> | null = null;
 ...
 */
export
function _encode_TypeOfUpdate (value: TypeOfUpdate, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_TypeOfUpdate) { _cached_encoder_for_TypeOfUpdate = $._encodeEnumerated; }
    return _cached_encoder_for_TypeOfUpdate(value, elGetter);
}
