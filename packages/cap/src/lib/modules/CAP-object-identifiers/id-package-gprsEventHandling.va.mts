...
/**
 * @summary id_package_gprsEventHandling
 * @description
 *
 * OID of the gprsSSF/gsmSCF `gprsEventHandling` operation package
 * (`{id-package 54}`).
 ...
 */
export
const id_package_gprsEventHandling: OBJECT_IDENTIFIER = _OID.fromParts([
    54,
], id_package);
