 ...
 * @description
 *
 * OID of the gsmSSF/gsmSCF `assistConnectionEstablishment` operation package
 * (`{id-package 16}`).
 ...
 */
export
const id_package_assistConnectionEstablishment: OBJECT_IDENTIFIER = _OID.fromParts([
    16,
], id_package);
