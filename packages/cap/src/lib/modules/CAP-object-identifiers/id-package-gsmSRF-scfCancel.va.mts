...
/**
 * @summary id_package_gsmSRF_scfCancel
 * @description
 *
 * OID of the gsmSRF/gsmSCF `gsmSRF-scfCancel` operation package
 * (`{id-package 43}`).
 ...
 */
export
const id_package_gsmSRF_scfCancel: OBJECT_IDENTIFIER = _OID.fromParts([
    43,
], id_package);
