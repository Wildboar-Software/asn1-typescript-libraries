...
/**
 * @summary id_package_gprsChargeAdvice
 * @description
 *
 * OID of the gprsSSF/gsmSCF `gprsChargeAdvice` operation package
 * (`{id-package 60}`).
 ...
 */
export
const id_package_gprsChargeAdvice: OBJECT_IDENTIFIER = _OID.fromParts([
    60,
], id_package);
