...
/**
 * @summary id_package_smsBilling
 * @description
 *
 * OID of the SMS `smsBilling` operation package (`{id-package 66}`). Used for
 ...
 */
export
const id_package_smsBilling: OBJECT_IDENTIFIER = _OID.fromParts([
    66,
], id_package);
