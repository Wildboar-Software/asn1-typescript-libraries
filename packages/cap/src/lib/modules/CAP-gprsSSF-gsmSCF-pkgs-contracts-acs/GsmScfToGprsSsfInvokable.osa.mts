...
/**
 * @summary GsmScfToGprsSsfInvokable
 * @description
 * 
 * Operations that may be invoked in the gsmSCF-to-gprsSSF `TCMessage`:
 ...
 */
export
const GsmScfToGprsSsfInvokable: (OPERATION)[] = [ activityTestGPRS, applyChargingGPRS, cancelGPRS, furnishChargingInformationGPRS, releaseGPRS, requestReportGPRSEvent, sendChargingInformationGPRS, ];
