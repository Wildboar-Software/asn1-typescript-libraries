 ...
 * @description
 * 
 * gprsSSF-gsmSCF processing package: gsmSCF (consumer) invokes `continueGPRS`.
 * Used in `capGprsSsfToScf` (responder). Package OID
 * (`id-package-gprsContinue`) updated in Rel-6.
