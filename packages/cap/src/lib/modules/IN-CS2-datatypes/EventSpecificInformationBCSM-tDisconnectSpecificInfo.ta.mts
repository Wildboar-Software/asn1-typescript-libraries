...
const _root_component_type_list_1_spec_for_EventSpecificInformationBCSM_tDisconnectSpecificInfo: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("connectTime", true, $.hasTag(_TagClass.context, 1), undefined, undefined)
];
...
function _encode_EventSpecificInformationBCSM_tDisconnectSpecificInfo (value: EventSpecificInformationBCSM_tDisconnectSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_tDisconnectSpecificInfo) { _cached_encoder_for_EventSpecificInformationBCSM_tDisconnectSpecificInfo = function (value: EventSpecificInformationBCSM_tDisconnectSpecificInfo, elGetter: $.ASN1Encoder<EventSpecificInformationBCSM_tDisconnectSpecificInfo>): _Element {
