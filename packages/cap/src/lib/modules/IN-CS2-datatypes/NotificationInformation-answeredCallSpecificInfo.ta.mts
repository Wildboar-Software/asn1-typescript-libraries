...
function _encode_NotificationInformation_answeredCallSpecificInfo (value: NotificationInformation_answeredCallSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_NotificationInformation_answeredCallSpecificInfo) { _cached_encoder_for_NotificationInformation_answeredCallSpecificInfo = function (value: NotificationInformation_answeredCallSpecificInfo): _Element {
