 ...
 * 
 * ```asn1
 * NotificationInformation-calledNumberSpecificInfo ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
const _root_component_type_list_1_spec_for_NotificationInformation_calledNumberSpecificInfo: $.ComponentSpec[] = [
    new $.ComponentSpec("calledNumber", true, $.hasTag(_TagClass.context, 0), undefined, undefined)
];
...
function _encode_NotificationInformation_calledNumberSpecificInfo (value: NotificationInformation_calledNumberSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_NotificationInformation_calledNumberSpecificInfo) { _cached_encoder_for_NotificationInformation_calledNumberSpecificInfo = function (value: NotificationInformation_calledNumberSpecificInfo, elGetter: $.ASN1Encoder<NotificationInformation_calledNumberSpecificInfo>): _Element {
