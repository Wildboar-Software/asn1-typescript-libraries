...
function _encode_EventSpecificInformationBCSM_tAbandon (value: EventSpecificInformationBCSM_tAbandon, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_tAbandon) { _cached_encoder_for_EventSpecificInformationBCSM_tAbandon = function (value: EventSpecificInformationBCSM_tAbandon): _Element {
