 ...
 * 
 * ```asn1
 * EventSpecificInformationBCSM-tBusySpecificInfo {PARAMETERS-BOUND:bound} ::= SEQUENCE {
...
function _encode_EventSpecificInformationBCSM_tBusySpecificInfo (value: EventSpecificInformationBCSM_tBusySpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_tBusySpecificInfo) { _cached_encoder_for_EventSpecificInformationBCSM_tBusySpecificInfo = function (value: EventSpecificInformationBCSM_tBusySpecificInfo): _Element {
