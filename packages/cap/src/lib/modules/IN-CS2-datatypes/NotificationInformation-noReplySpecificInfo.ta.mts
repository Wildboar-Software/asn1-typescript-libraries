...
function _encode_NotificationInformation_noReplySpecificInfo (value: NotificationInformation_noReplySpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_NotificationInformation_noReplySpecificInfo) { _cached_encoder_for_NotificationInformation_noReplySpecificInfo = function (value: NotificationInformation_noReplySpecificInfo): _Element {
