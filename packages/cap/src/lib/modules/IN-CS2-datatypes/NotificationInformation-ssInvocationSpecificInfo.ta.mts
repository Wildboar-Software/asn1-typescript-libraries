...
const _root_component_type_list_1_spec_for_NotificationInformation_ssInvocationSpecificInfo: $.ComponentSpec[] = [
    new $.ComponentSpec("invokedService", false, $.hasTag(_TagClass.context, 0))
];
...
function _encode_NotificationInformation_ssInvocationSpecificInfo (value: NotificationInformation_ssInvocationSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_NotificationInformation_ssInvocationSpecificInfo) { _cached_encoder_for_NotificationInformation_ssInvocationSpecificInfo = function (value: NotificationInformation_ssInvocationSpecificInfo): _Element {
