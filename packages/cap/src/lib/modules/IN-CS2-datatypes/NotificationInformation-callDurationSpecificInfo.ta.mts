 ...
 * 
 * ```asn1
 * NotificationInformation-callDurationSpecificInfo {PARAMETERS-BOUND:bound} ::= SEQUENCE {
...
function _encode_NotificationInformation_callDurationSpecificInfo (value: NotificationInformation_callDurationSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_NotificationInformation_callDurationSpecificInfo) { _cached_encoder_for_NotificationInformation_callDurationSpecificInfo = function (value: NotificationInformation_callDurationSpecificInfo): _Element {
