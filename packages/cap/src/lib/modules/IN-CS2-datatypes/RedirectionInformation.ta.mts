...
function _decode_RedirectionInformation (el: _Element): RedirectionInformation {
    if (!_cached_decoder_for_RedirectionInformation) { _cached_decoder_for_RedirectionInformation = $._decodeOctetString; }
...
function _encode_RedirectionInformation (value: RedirectionInformation, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RedirectionInformation) { _cached_encoder_for_RedirectionInformation = $._encodeOctetString; }
