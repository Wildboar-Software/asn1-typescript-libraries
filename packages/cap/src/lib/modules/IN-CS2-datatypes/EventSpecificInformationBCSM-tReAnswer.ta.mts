 ...
 * 
 * ```asn1
 * EventSpecificInformationBCSM-tReAnswer ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_EventSpecificInformationBCSM_tReAnswer (value: EventSpecificInformationBCSM_tReAnswer, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_tReAnswer) { _cached_encoder_for_EventSpecificInformationBCSM_tReAnswer = function (value: EventSpecificInformationBCSM_tReAnswer, elGetter: $.ASN1Encoder<EventSpecificInformationBCSM_tReAnswer>): _Element {
