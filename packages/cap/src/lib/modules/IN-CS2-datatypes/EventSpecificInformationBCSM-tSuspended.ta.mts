 ...
 * 
 * ```asn1
 * EventSpecificInformationBCSM-tSuspended {PARAMETERS-BOUND:bound} ::= SEQUENCE {
...
function _encode_EventSpecificInformationBCSM_tSuspended (value: EventSpecificInformationBCSM_tSuspended, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_tSuspended) { _cached_encoder_for_EventSpecificInformationBCSM_tSuspended = function (value: EventSpecificInformationBCSM_tSuspended): _Element {
