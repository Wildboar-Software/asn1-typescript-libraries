 ...
 * 
 * ```asn1
 * EventSpecificInformationBCSM-origAttemptAuthorized {PARAMETERS-BOUND:bound} ::= SEQUENCE {
...
function _encode_EventSpecificInformationBCSM_origAttemptAuthorized (value: EventSpecificInformationBCSM_origAttemptAuthorized, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_origAttemptAuthorized) { _cached_encoder_for_EventSpecificInformationBCSM_origAttemptAuthorized = function (value: EventSpecificInformationBCSM_origAttemptAuthorized): _Element {
