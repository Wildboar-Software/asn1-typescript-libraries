 ...
 * 
 * ```asn1
 * EventSpecificInformationBCSM-tMidCallSpecificInfo {PARAMETERS-BOUND:bound} ::= SEQUENCE {
...
const _root_component_type_list_1_spec_for_EventSpecificInformationBCSM_tMidCallSpecificInfo: $.ComponentSpec[] = [
    new $.ComponentSpec("connectTime", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("tMidCallInfo", true, $.hasTag(_TagClass.context, 1))
];
...
function _encode_EventSpecificInformationBCSM_tMidCallSpecificInfo (value: EventSpecificInformationBCSM_tMidCallSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_tMidCallSpecificInfo) { _cached_encoder_for_EventSpecificInformationBCSM_tMidCallSpecificInfo = function (value: EventSpecificInformationBCSM_tMidCallSpecificInfo): _Element {
