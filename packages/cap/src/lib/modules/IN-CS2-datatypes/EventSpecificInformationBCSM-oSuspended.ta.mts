 ...
 * 
 * ```asn1
 * EventSpecificInformationBCSM-oSuspended {PARAMETERS-BOUND:bound} ::= SEQUENCE {
...
function _encode_EventSpecificInformationBCSM_oSuspended (value: EventSpecificInformationBCSM_oSuspended, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_oSuspended) { _cached_encoder_for_EventSpecificInformationBCSM_oSuspended = function (value: EventSpecificInformationBCSM_oSuspended): _Element {
