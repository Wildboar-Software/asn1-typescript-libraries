...
const _root_component_type_list_1_spec_for_ControlConditionByCallParty: $.ComponentSpec[] = [
    new $.ComponentSpec("endOfMessageSendingDigit", true, $.hasTag(_TagClass.context, 0)),
    new $.ComponentSpec("replayDigit", true, $.hasTag(_TagClass.context, 1))
];
...
function _encode_ControlConditionByCallParty (value: ControlConditionByCallParty, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ControlConditionByCallParty) { _cached_encoder_for_ControlConditionByCallParty = function (value: ControlConditionByCallParty): _Element {
