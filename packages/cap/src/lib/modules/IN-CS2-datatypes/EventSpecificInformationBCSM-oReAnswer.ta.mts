 ...
 * 
 * ```asn1
 * EventSpecificInformationBCSM-oReAnswer {PARAMETERS-BOUND:bound} ::= SEQUENCE {
...
function _encode_EventSpecificInformationBCSM_oReAnswer (value: EventSpecificInformationBCSM_oReAnswer, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_oReAnswer) { _cached_encoder_for_EventSpecificInformationBCSM_oReAnswer = function (value: EventSpecificInformationBCSM_oReAnswer): _Element {
