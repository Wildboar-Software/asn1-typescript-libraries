...
const _root_component_type_list_1_spec_for_UserInformation: $.ComponentSpec[] = [
    new $.ComponentSpec("infoToSend", false, $.hasTag(_TagClass.context, 0), undefined, undefined),
    new $.ComponentSpec("constraints", false, $.hasTag(_TagClass.context, 1), undefined, undefined),
    new $.ComponentSpec("errorInfo", true, $.hasTag(_TagClass.context, 2), undefined, undefined)
];
