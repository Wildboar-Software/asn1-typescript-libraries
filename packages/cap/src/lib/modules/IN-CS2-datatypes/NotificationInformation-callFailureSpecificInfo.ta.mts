 ...
 * 
 * ```asn1
 * NotificationInformation-callFailureSpecificInfo ::= SEQUENCE { -- REMOVED_FROM_UNNESTING -- }
 * ```
 * 
 * @class
 */
...
function _encode_NotificationInformation_callFailureSpecificInfo (value: NotificationInformation_callFailureSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_NotificationInformation_callFailureSpecificInfo) { _cached_encoder_for_NotificationInformation_callFailureSpecificInfo = function (value: NotificationInformation_callFailureSpecificInfo, elGetter: $.ASN1Encoder<NotificationInformation_callFailureSpecificInfo>): _Element {
