...
const _root_component_type_list_1_spec_for_EventSpecificInformationBCSM_oMidCallSpecificInfo: $.ComponentSpec[] = [
    ...
    new $.ComponentSpec("oMidCallInfo", true, $.hasTag(_TagClass.context, 1))
];
...
function _encode_EventSpecificInformationBCSM_oMidCallSpecificInfo (value: EventSpecificInformationBCSM_oMidCallSpecificInfo, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_EventSpecificInformationBCSM_oMidCallSpecificInfo) { _cached_encoder_for_EventSpecificInformationBCSM_oMidCallSpecificInfo = function (value: EventSpecificInformationBCSM_oMidCallSpecificInfo): _Element {
