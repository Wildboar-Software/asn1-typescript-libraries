...
import { assistHandoff_gsmSSF_scfAbstractSyntax } from "../CAP-gsmSSF-gsmSCF-pkgs-contracts-acs/assistHandoff-gsmSSF-scfAbstractSyntax.oa.mjs";
// export { assistHandoff_gsmSSF_scfAbstractSyntax } from "../CAP-gsmSSF-gsmSCF-pkgs-contracts-acs/assistHandoff-gsmSSF-scfAbstractSyntax.oa.mjs";
import { id_ac_CAP_gsmSSF_scfAssistHandoffAC } from "../CAP-object-identifiers/id-ac-CAP-gsmSSF-scfAssistHandoffAC.va.mjs";
// export { id_ac_CAP_gsmSSF_scfAssistHandoffAC } from "../CAP-object-identifiers/id-ac-CAP-gsmSSF-scfAssistHandoffAC.va.mjs";
import { type APPLICATION_CONTEXT } from "../TC-Notation-Extensions/APPLICATION-CONTEXT.oca.mjs";


/**
 * @summary capssf_scfAssistHandoffAC
 * @description
 * 
 * Assist-handoff gsmSSF-to-gsmSCF CS application context. Contract
 * `capAssistHandoffssfToScf`; structured dialogue; abstract syntaxes
 * `dialogue-abstract-syntax` and `assistHandoff-gsmSSF-scfAbstractSyntax`. CAP
 * V4 Rel-5 and Rel-6 share this AC name; the contract and abstract syntaxes are
 ...
 */
export
const capssf_scfAssistHandoffAC: APPLICATION_CONTEXT = {
    class: "APPLICATION-CONTEXT",
    decoderFor: {
    },
    encoderFor: {
    },
    "&associationContract": capAssistHandoffssfToScf /* OBJECT_FIELD_SETTING */,
    "&dialogueMode": structured /* OBJECT_FIELD_SETTING */,
    "&AbstractSyntaxes": [ dialogue_abstract_syntax, assistHandoff_gsmSSF_scfAbstractSyntax, ] /* OBJECT_FIELD_SETTING */,
    "&applicationContextName": id_ac_CAP_gsmSSF_scfAssistHandoffAC /* OBJECT_FIELD_SETTING *//* UNIQUE_OBJECT_FIELD_SETTING */,
