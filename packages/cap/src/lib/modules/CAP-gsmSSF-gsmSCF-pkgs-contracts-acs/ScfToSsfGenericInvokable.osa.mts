 ...
 */
export
const ScfToSsfGenericInvokable: (OPERATION)[] = [ activityTest, applyCharging, applyChargingReport, callInformationRequest, cancel, collectInformation, connect, connectToResource, continue_, continueWithArgument, disconnectForwardConnection, disconnectForwardConnectionWithArgument, disconnectLeg, establishTemporaryConnection, furnishChargingInformation, initiateCallAttempt, moveLeg, playTone, releaseCall, requestReportBCSMEvent, resetTimer, sendChargingInformation, splitLeg, playAnnouncement, promptAndCollectUserInformation, ];
