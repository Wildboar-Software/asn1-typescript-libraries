 ...
 * @description
 * 
 * gsmSCF-to-gsmSSF generic CS application context. Contract
 * `capScfToSsfGeneric`; structured dialogue; abstract syntaxes
 * `dialogue-abstract-syntax` and `scf-gsmSSFGenericAbstractSyntax`. CAP V4
