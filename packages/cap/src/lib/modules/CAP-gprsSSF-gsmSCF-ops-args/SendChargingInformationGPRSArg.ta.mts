...
const _root_component_type_list_1_spec_for_SendChargingInformationGPRSArg: $.ComponentSpec[] = [
    new $.ComponentSpec("sCIGPRSBillingChargingCharacteristics", false, $.hasTag(_TagClass.context, 0), undefined, undefined)
];
...
function _encode_SendChargingInformationGPRSArg (value: SendChargingInformationGPRSArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_SendChargingInformationGPRSArg) { _cached_encoder_for_SendChargingInformationGPRSArg = function (value: SendChargingInformationGPRSArg, elGetter: $.ASN1Encoder<SendChargingInformationGPRSArg>): _Element {
