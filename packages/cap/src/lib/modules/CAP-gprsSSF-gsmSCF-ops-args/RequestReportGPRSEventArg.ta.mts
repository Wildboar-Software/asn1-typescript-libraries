...
import { GPRSEvent, _decode_GPRSEvent, _encode_GPRSEvent } from "../CAP-datatypes/GPRSEvent.ta.mjs";
...
const _root_component_type_list_1_spec_for_RequestReportGPRSEventArg: $.ComponentSpec[] = [
    new $.ComponentSpec("gPRSEvent", false, $.hasTag(_TagClass.context, 0)),
...
function _encode_RequestReportGPRSEventArg (value: RequestReportGPRSEventArg, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_RequestReportGPRSEventArg) { _cached_encoder_for_RequestReportGPRSEventArg = function (value: RequestReportGPRSEventArg): _Element {
