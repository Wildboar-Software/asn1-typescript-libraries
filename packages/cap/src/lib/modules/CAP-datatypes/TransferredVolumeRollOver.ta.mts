...
export function _decode_TransferredVolumeRollOver (el: _Element): TransferredVolumeRollOver {
    ...
    "CONTEXT 0": [ "rO_VolumeIfNoTariffSwitch", $._decode_implicit<INTEGER>(() => (el: _Element): INTEGER => {
    const value = $._decodeInteger(el);
    if ((typeof value === "bigint" ? (value < 0n || value > 255n) : (value < 0 || value > 255))) {
        throw new ASN1OverflowError("TransferredVolumeRollOver.rO_VolumeIfNoTariffSwitch violates INTEGER constraint");
    }
    return value;
}) ],
