 ...
 */
export
function _decode_ConnectionAS (el: _Element): ConnectionAS {
    if (!_cached_decoder_for_ConnectionAS) { _cached_decoder_for_ConnectionAS = $._decode_inextensible_choice<ConnectionAS>({
 ...
 */
export
function _encode_ConnectionAS (value: ConnectionAS, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_ConnectionAS) { _cached_encoder_for_ConnectionAS = $._encode_choice<ConnectionAS>({
    "bind": _encode_Bind,
