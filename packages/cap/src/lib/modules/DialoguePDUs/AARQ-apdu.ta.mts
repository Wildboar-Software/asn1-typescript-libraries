...
import { AARQ_apdu_protocol_version, AARQ_apdu_protocol_version_version1 /* IMPORTED_LONG_NAMED_BIT */, version1 /* IMPORTED_SHORT_NAMED_BIT */, _decode_AARQ_apdu_protocol_version, _encode_AARQ_apdu_protocol_version } from "../DialoguePDUs/AARQ-apdu-protocol-version.ta.mjs";
// export { AARQ_apdu_protocol_version, AARQ_apdu_protocol_version_version1 /* IMPORTED_LONG_NAMED_BIT */, version1 /* IMPORTED_SHORT_NAMED_BIT */, _decode_AARQ_apdu_protocol_version, _encode_AARQ_apdu_protocol_version } from "../DialoguePDUs/AARQ-apdu-protocol-version.ta.mjs";
...
class AARQ_apdu {
    ...
    public static _from_object (_o: { [_K in keyof (AARQ_apdu)]: (AARQ_apdu)[_K] }): AARQ_apdu {
        return new AARQ_apdu(_o.protocol_version, _o.application_context_name, _o.user_information);
    }
