 ...
 */
export
type AARE_apdu_protocol_version = BIT_STRING;
 ...
 */
export
const AARE_apdu_protocol_version_version1: number = 0; /* LONG_NAMED_BIT */
 ...
 */
export
const version1: number = AARE_apdu_protocol_version_version1; /* SHORT_NAMED_BIT */
 ...
 */
export
function _decode_AARE_apdu_protocol_version (el: _Element): AARE_apdu_protocol_version {
    if (!_cached_decoder_for_AARE_apdu_protocol_version) { _cached_decoder_for_AARE_apdu_protocol_version = $._decodeBitString; }
 ...
 */
export
function _encode_AARE_apdu_protocol_version (value: AARE_apdu_protocol_version, elGetter: $.ASN1Encoder<any>): _Element {
    if (!_cached_encoder_for_AARE_apdu_protocol_version) { _cached_encoder_for_AARE_apdu_protocol_version = $._encodeBitString; }
