 ...
 */
export
function _decode_TrustAnchorList (el: _Element): TrustAnchorList {
 ...
 */
export
function _encode_TrustAnchorList (value: TrustAnchorList, elGetter: $.ASN1Encoder<TrustAnchorList>): _Element {
