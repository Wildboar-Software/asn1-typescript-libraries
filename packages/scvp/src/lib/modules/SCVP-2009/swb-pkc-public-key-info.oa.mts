 ...
 * @description
 *
 * WantBack information object for `id-swb-pkc-public-key-info`: The public key from the certificate that was the subject of the request.
 * Conformance: MUST for conforming servers as specified in
