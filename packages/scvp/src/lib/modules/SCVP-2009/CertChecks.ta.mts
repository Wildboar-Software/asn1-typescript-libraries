 ...
 * @description
 *
 * Sequence of check OIDs (`CertCheckSet` / `ACertCheckSet`, …)
 * naming work the server MUST perform ([RFC 5055 §3.2.2](https://datatracker.ietf.org/doc/html/rfc5055#section-3.2.2)).
 *
 * ### ASN.1 Definition:
 *
 * ```asn1
