...
import { id_swb_pkc_CAs_revocation_info } from '../SCVP-2009/id-swb-pkc-CAs-revocation-info.va.mjs';
import { type WANT_BACK } from '../SCVP-2009/WANT-BACK.oca.mjs';
/**
 * @summary swb_pkc_CAs_revocation_info
 * @description
 *
 * WantBack information object for `id-swb-pkc-CAs-revocation-info`: Proof of revocation status for each CA certificate in the path.
