...
import { id_swb_aa_revocation_info } from '../SCVP-2009/id-swb-aa-revocation-info.va';
export { id_swb_aa_revocation_info } from '../SCVP-2009/id-swb-aa-revocation-info.va';
