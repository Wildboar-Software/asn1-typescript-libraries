...
import { id_swb_ac_revocation_info } from '../SCVP-2009/id-swb-ac-revocation-info.va.js';
export { id_swb_ac_revocation_info } from '../SCVP-2009/id-swb-ac-revocation-info.va.js';
 ...
 *
 * ```asn1
 * swb-ac-revocation-info WANT-BACK ::= { RevInfoWantBack IDENTIFIED BY id-swb-ac-revocation-info }
 * ```
 *
 * @constant
 ...
 */
export const swb_ac_revocation_info: WANT_BACK<RevInfoWantBack> = {
