 ...
 * @description
 *
 * `SMIME-CAPS` object for AES-256 Key Wrap
 * ([RFC 5911 §4](https://datatracker.ietf.org/doc/html/rfc5911#section-4)): `IDENTIFIED BY id-aes256-wrap` (no capability `TYPE`).
 * Unnested from `kwa-aes256-wrap.&smimeCaps`.
 *
 * ### ASN.1 Definition:
 * 
 * ```asn1
